...
- subnet age: 534.8 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 131.45765553176204** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 20.556453361734146
- top_miner_usd_day: 131.45765553176204 (uid 25, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 235  |  gini: 0.3746573867654073  |  top1_share: 0.02326719050967683  |  top10_share: 0.13076711407343997
...
- net margin: 12.3373 USD/day  |  payback on registration: 1.74 days

## Score

- gate: **OK** 
- score: 26.3 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 10.23 / freshness 0.0 / resource 11.25 / registration 9.42
