...
- subnet age: 42.9 days  |  registered at block 8409860
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 5183.407946834671
- top_miner_usd_day: 5183.407946834671 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 3.2 (rank 88), confidence 0.85 - hardware from README keywords, not curated
