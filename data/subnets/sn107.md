...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (206.3754 USD), open=True
...
- **competitive_miner_usd_day: 35683.699409979854** (uid 82) <- the only figure quotable as achievable
- median_miner_usd_day: 121.51501196791105
- top_miner_usd_day: 35683.699409979854 (uid 82, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 120.5287 USD/day  |  payback on registration: 1.71 days

## Score

- gate: **OK** 
- score: 78.4 (rank 1), confidence 1.0 
- components: income 18.96 / freshness 35.0 / resource 15.0 / registration 9.43
