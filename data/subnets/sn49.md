...
- subnet age: 301.2 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 64.09505207617363** (uid 217) <- the only figure quotable as achievable
- median_miner_usd_day: 2991.7415546723378
- top_miner_usd_day: 5919.388057268502 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.48928800317392485  |  top1_share: 0.989288003173925  |  top10_share: 1.0
...
- net margin: 55.8759 USD/day  |  payback on registration: 0.21 days
...
- components: income 15.96 / freshness 21.0 / resource 11.25 / registration 9.93
