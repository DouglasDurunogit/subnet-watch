...
- subnet age: 214.8 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 613.2344570179042** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 0.09360928972949233
- top_miner_usd_day: 3985.789947392054 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1256 USD/day  |  payback on registration: [UNKNOWN] days
