...
- miner_burn: **0.0**
- registration cost: 0.000739195 TAO (0.15874212625 USD), open=True
...
- **competitive_miner_usd_day: 2103.0731130474605** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2103.0731130474605
- top_miner_usd_day: 2103.0731130474605 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2094.8539 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 30.9 (rank 62), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 30.21 / freshness 0.0 / resource 11.25 / registration 10.0
