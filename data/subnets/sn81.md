...
- miner_burn: **0.8712335505988449**
- registration cost: 0.0005 TAO (0.163575 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 38  |  free: 0
- subnet age: 548.7 days  |  registered at block 5203057
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 46.646652554637505** (uid 84) <- the only figure quotable as achievable
- median_miner_usd_day: 22.271146144507377
- top_miner_usd_day: 5006.273071916509 (uid 237, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 32  |  gini: 0.871675734867678  |  top1_share: 0.8714019718567809  |  top10_share: 0.9301913860993254
- owner_incentive_share: 0.8714019718567809 (independent check on miner_burn; disagreement 0.0002)
...
- latest release: (none) 
- last commit: 2026-09-26T18:16:53Z
- scoring-related commit: Merge pull request #281 from reliquadotai/fix/corpus-miner-long-context 2026-09-26T18:16:53Z
...
- net margin: 12.9998 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 56.7 (rank 24), confidence 0.85 - hardware requirement unknown
- components: income 10.42 / freshness 35.0 / resource 11.25 / registration 10.0
