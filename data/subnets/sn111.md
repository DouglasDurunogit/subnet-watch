...
- miner_burn: **0.0**
- registration cost: 0.639909683 TAO (149.34212181854 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 463.1 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3282.8737516808255** (uid 98) <- the only figure quotable as achievable
- median_miner_usd_day: 375.20397349397405
- top_miner_usd_day: 3282.8737516808255 (uid 98, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 17679 bytes, sha 9a0bd9f580cafeb0
- latest release: (none) 
- last commit: 2026-08-28T12:51:57Z
- scoring-related commit: docs(validator): enable paper reuse in launch profiles 2026-08-28T12:51:57Z
...
- net margin: 366.9848 USD/day  |  payback on registration: 0.41 days

## Score

- gate: **OK** 
- score: 67.5 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 23.34 / freshness 35.0 / resource 11.25 / registration 9.86
...
```bash
cp validator/agent_v1/validator.testnet.env.example 
```

_(truncated at 6000 of 17679 chars - read the full file at https://github.com/DeSciClaims/Claims)_
