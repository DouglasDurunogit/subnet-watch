...
- subnet age: 657.8 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7587.3853666287405** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 12.4146844100855
- top_miner_usd_day: 8329.24664313412 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 152  |  gini: 0.9190564256064293  |  top1_share: 0.3792065747063227  |  top10_share: 0.9240486992652337
...
- net margin: 4.1955 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 53.3 (rank 29), confidence 0.85 - hardware from README keywords, not curated
- components: income 6.51 / freshness 35.0 / resource 11.25 / registration 9.99
