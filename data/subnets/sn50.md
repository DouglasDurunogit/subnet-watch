...
- registration cost: 0.8 TAO (164.86400000000003 USD), open=True
...
- **competitive_miner_usd_day: 33.85822871682979** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 9.36080440994706
- top_miner_usd_day: 33.85822871682979 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.1416 USD/day  |  payback on registration: 144.41 days

## Score

- gate: **OK** 
- score: 41.9 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 3.01 / freshness 35.0 / resource 11.25 / registration 0.0
