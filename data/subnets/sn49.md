...
- miner_burn: **0.0**
- registration cost: 0.071613109 TAO (16.203898173429998 USD), open=True
...
- **competitive_miner_usd_day: 54.121069332436896** (uid 180) <- the only figure quotable as achievable
- median_miner_usd_day: 2707.4581355968853
- top_miner_usd_day: 5360.795201861333 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 45.9019 USD/day  |  payback on registration: 0.35 days
...
- components: income 15.2 / freshness 21.0 / resource 11.25 / registration 9.88
