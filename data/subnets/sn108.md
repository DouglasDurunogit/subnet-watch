...
- miner_burn: **0.6554738429840654**
- registration cost: 0.05 TAO (11.8005 USD), open=True
...
- **competitive_miner_usd_day: 127.33470379793894** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 126.51149004181053
- top_miner_usd_day: 1414.47880433004 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 106.0429 USD/day  |  payback on registration: 0.11 days
