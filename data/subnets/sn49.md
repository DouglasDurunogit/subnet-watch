...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (15.8005 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 328.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 65.74898654088592** (uid 219) <- the only figure quotable as achievable
- median_miner_usd_day: 3289.155789290397
- top_miner_usd_day: 6512.562592039908 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 57.5298 USD/day  |  payback on registration: 0.27 days
...
- components: income 16.07 / freshness 21.0 / resource 11.25 / registration 9.91
