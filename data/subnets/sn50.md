...
- registration cost: 0.8 TAO (158.256 USD), open=True
...
- **competitive_miner_usd_day: 36.63911143498029** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 10.864451157518971
- top_miner_usd_day: 36.63911143498029 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.6453 USD/day  |  payback on registration: 59.83 days

## Score

- gate: **OK** 
- score: 31.8 (rank 49), confidence 0.85 - hardware requirement unknown
- components: income 5.11 / freshness 21.0 / resource 11.25 / registration 0.0
