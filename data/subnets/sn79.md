...
- miner_burn: **0.0**
- registration cost: 0.108935854 TAO (24.6630773456 USD), open=True
...
- **competitive_miner_usd_day: 424.97841062893843** (uid 96) <- the only figure quotable as achievable
- median_miner_usd_day: 6.60419914615283
- top_miner_usd_day: 424.97841062893843 (uid 96, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.6179 USD/day  |  payback on registration: 4.39 days

## Score

- gate: **OK** 
- score: 31.0 (rank 59), confidence 1.0 
- components: income 7.46 / freshness 0.0 / resource 15.0 / registration 8.54
