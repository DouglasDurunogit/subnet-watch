...
- registration cost: 0.002011766 TAO (0.39959708058 USD), open=True
...
- **competitive_miner_usd_day: 2.0271407590133377** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.034255489292519
- top_miner_usd_day: 2445.6419002006623 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0273 USD/day  |  payback on registration: 14.64 days

## Score

- gate: **OK** 
- score: 41.2 (rank 42), confidence 1.0 
- components: income 0.11 / freshness 21.0 / resource 15.0 / registration 5.12
