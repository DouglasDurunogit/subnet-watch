...
- **competitive_miner_usd_day: 12880.70973596801** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.2900632618096273
- top_miner_usd_day: 12880.70973596801 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.9291 USD/day  |  payback on registration: [UNKNOWN] days
