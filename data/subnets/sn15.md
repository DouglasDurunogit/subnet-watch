...
- miner_burn: **0.0**
- registration cost: 0.346023135 TAO (67.90011978105 USD), open=True
...
- **competitive_miner_usd_day: 22.09357808509679** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 11.633344212949197
- top_miner_usd_day: 11869.139391450317 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.5493 USD/day  |  payback on registration: 6.44 days

## Score

- gate: **OK** 
- score: 67.5 (rank 13), confidence 1.0 
- components: income 9.66 / freshness 35.0 / resource 15.0 / registration 7.85
