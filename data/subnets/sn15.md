...
- miner_burn: **0.0**
- registration cost: 0.313438412 TAO (63.7533730008 USD), open=True
...
- **competitive_miner_usd_day: 21.435086491776733** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 11.209173670011687
- top_miner_usd_day: 11987.326305314076 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 79  |  gini: 0.9399967723886546  |  top1_share: 0.9307122681120696  |  top10_share: 0.945140850446599
...
- net margin: 10.1245 USD/day  |  payback on registration: 6.3 days

## Score

- gate: **OK** 
- score: 67.4 (rank 11), confidence 1.0 
- components: income 9.52 / freshness 35.0 / resource 15.0 / registration 7.9
