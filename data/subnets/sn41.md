...
- registration cost: 0.122177547 TAO (27.78439596327 USD), open=True
...
- **competitive_miner_usd_day: 25.220951012300397** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 10.732859434811939
- top_miner_usd_day: 2467.339756879391 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.6704 USD/day  |  payback on registration: 2.87 days

## Score

- gate: **OK** 
- score: 54.4 (rank 25), confidence 1.0 
- components: income 9.35 / freshness 21.0 / resource 15.0 / registration 9.04
