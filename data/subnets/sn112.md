...
- **competitive_miner_usd_day: 282.6842167211674** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 710.0585457495202
- top_miner_usd_day: 1137.4328747778732 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 274.465 USD/day  |  payback on registration: 0.71 days
...
- components: income 22.19 / freshness 21.0 / resource 11.25 / registration 9.76
