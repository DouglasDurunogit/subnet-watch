...
- miner_burn: **0.8234283751808107**
- registration cost: 0.1 TAO (21.727000000000004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 19  |  free: 0
- subnet age: 773.9 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 85.66361601215122** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 2.797366475771534
- top_miner_usd_day: 2474.6604447878567 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.8621446615891737  |  top1_share: 0.823510560371139  |  top10_share: 0.9997863508729092
- owner_incentive_share: 0.823510560371139 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.1143 USD/day  |  payback on registration: 190.09 days

## Score

- gate: **OK** 
- score: 15.4 (rank 79), confidence 1.0 
- components: income 0.43 / freshness 0.0 / resource 15.0 / registration 0.0
