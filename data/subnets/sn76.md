...
- subnet age: 176.5 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 190.44443127467522** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 96.71023002447531
- top_miner_usd_day: 476.10037304721226 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.5202865819230591  |  top1_share: 0.33933558163312016  |  top10_share: 1.0
...
- latest release: (none) 
- last commit: 2026-08-12T17:24:53Z
- scoring-related commit: Document the real agent size limits and stop rejecting tasks with no … 2026-08-08T21:44:42Z
...
- net margin: 39.5648 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.6 (rank 2), confidence 1.0 
- components: income 14.63 / freshness 35.0 / resource 15.0 / registration 10.0
