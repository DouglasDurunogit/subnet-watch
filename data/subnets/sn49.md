...
- subnet age: 293.7 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 60.85605094157537** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 3049.0370354779816
- top_miner_usd_day: 6037.2180200143885 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 52.6369 USD/day  |  payback on registration: 0.23 days

## Score

- gate: **OK** 
- score: 34.7 (rank 56), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 15.73 / freshness 21.0 / resource 11.25 / registration 9.92
