...
- subnet age: 1040.8 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1218.473330934065** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 13.81459391652713
- top_miner_usd_day: 1218.473330934065 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.8717 USD/day  |  payback on registration: 87.3 days

## Score

- gate: **OK** 
- score: 32.0 (rank 60), confidence 0.85 - hardware requirement unknown
- components: income 5.35 / freshness 21.0 / resource 11.25 / registration 0.0
