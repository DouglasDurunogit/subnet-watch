...
- miner_burn: **0.7686522274743766**
- registration cost: 0.1 TAO (19.504 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 24  |  free: 0
- subnet age: 741.0 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.146953615115716** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.8377462042634876
- top_miner_usd_day: 2373.6612704452473 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.9004091585983545  |  top1_share: 0.768748283124256  |  top10_share: 0.9972835210450813
- owner_incentive_share: 0.768748283124256 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.7101 USD/day  |  payback on registration: 27.47 days

## Score

- gate: **OK** 
- score: 18.0 (rank 65), confidence 1.0 
- components: income 2.12 / freshness 0.0 / resource 15.0 / registration 0.84
