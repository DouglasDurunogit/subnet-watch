...
- **competitive_miner_usd_day: 8.726839998227625** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 6.787542220843708
- top_miner_usd_day: 2552.3582872594075 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.6336 USD/day  |  payback on registration: [UNKNOWN] days
