...
- **competitive_miner_usd_day: 163.70216645762278** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 109.13121160856164
- top_miner_usd_day: 409.2875104127391 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.8681 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.0 (rank 2), confidence 1.0 
- components: income 14.03 / freshness 35.0 / resource 15.0 / registration 10.0
