...
- subnet age: 863.1 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 610.779645024212** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 443.282145288682
- top_miner_usd_day: 610.779645024212 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.27354538934582573  |  top1_share: 0.38076999374361004  |  top10_share: 1.0
...
- net margin: 6.0219 USD/day  |  payback on registration: 0.02 days

## Score

- gate: **OK** 
- score: 15.0 (rank 63), confidence 0.85 - hardware from README keywords, not curated
- components: income 7.7 / freshness 0.0 / resource 0.0 / registration 9.99
