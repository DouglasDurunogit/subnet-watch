...
- **competitive_miner_usd_day: 99.16024312658998** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 25.48252058001753
- top_miner_usd_day: 99.16024312658998 (uid 171, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 221  |  gini: 0.37976763241991085  |  top1_share: 0.01641674691612785  |  top10_share: 0.11496308524785619
...
- net margin: 11.0774 USD/day  |  payback on registration: 1.71 days

## Score

- gate: **OK** 
- score: 25.9 (rank 60), confidence 0.85 - hardware requirement unknown
- components: income 9.84 / freshness 0.0 / resource 11.25 / registration 9.43
