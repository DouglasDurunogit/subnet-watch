...
- miner_burn: **0.0**
- registration cost: 0.30297571 TAO (59.5529055576 USD), open=True
...
- **competitive_miner_usd_day: 21.9810424116922** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.797164964073335
- top_miner_usd_day: 12435.22017683108 (uid 13, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.8109 USD/day  |  payback on registration: 5.51 days

## Score

- gate: **OK** 
- score: 67.9 (rank 8), confidence 1.0 
- components: income 9.75 / freshness 35.0 / resource 15.0 / registration 8.16
