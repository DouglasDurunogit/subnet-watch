...
- subnet age: 301.3 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 64.96836643854036** (uid 217) <- the only figure quotable as achievable
- median_miner_usd_day: 3036.8309031264653
- top_miner_usd_day: 6008.693439814389 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.48930326242866284  |  top1_share: 0.989303262428663  |  top10_share: 1.0
...
- net margin: 56.7492 USD/day  |  payback on registration: 0.21 days

## Score

- gate: **OK** 
- score: 28.6 (rank 62), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 16.02 / freshness 10.5 / resource 11.25 / registration 9.93
