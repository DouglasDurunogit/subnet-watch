...
- registration cost: 0.8 TAO (165.936 USD), open=True
...
- **competitive_miner_usd_day: 32.51975807535507** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 9.69338942630776
- top_miner_usd_day: 32.51975807535507 (uid 157, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.4742 USD/day  |  payback on registration: 112.56 days

## Score

- gate: **OK** 
- score: 42.4 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 3.58 / freshness 35.0 / resource 11.25 / registration 0.0
