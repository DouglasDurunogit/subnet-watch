...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (23.332999766670003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 187.6 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 369.07160221880457** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 110.61762752637529
- top_miner_usd_day: 369.07160221880457 (uid 124, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.2874170801653291  |  top1_share: 0.20065925010300784  |  top10_share: 0.8882021700315891
...
- latest release: (none) 
- last commit: 2026-08-23T16:24:51Z
- scoring-related commit: sandbox: authenticate with the sandbox token, not a validator signature 2026-08-23T16:24:51Z
...
- net margin: 163.7192 USD/day  |  payback on registration: 0.14 days

## Score

- gate: **OK** 
- score: 80.1 (rank 1), confidence 1.0 
- components: income 20.16 / freshness 35.0 / resource 15.0 / registration 9.95
