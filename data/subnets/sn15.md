...
- miner_burn: **0.0**
- registration cost: 0.409030188 TAO (99.87290100396 USD), open=True
...
- **competitive_miner_usd_day: 48.11438357221226** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.567915246001032
- top_miner_usd_day: 26040.62133032849 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.5816 USD/day  |  payback on registration: 3.62 days

## Score

- gate: **OK** 
- score: 72.0 (rank 6), confidence 1.0 
- components: income 13.24 / freshness 35.0 / resource 15.0 / registration 8.79
