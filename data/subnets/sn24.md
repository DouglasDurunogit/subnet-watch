...
- subnet age: 865.9 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 912.9338378353161** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 659.9840619638458
- top_miner_usd_day: 912.9338378353161 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.27470511040239254  |  top1_share: 0.38157874658568963  |  top10_share: 1.0
...
- net margin: 222.7238 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 26.7 (rank 63), confidence 0.85 - hardware from README keywords, not curated
- components: income 21.37 / freshness 0.0 / resource 0.0 / registration 10.0
