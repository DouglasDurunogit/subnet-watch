...
- subnet age: 659.2 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7006.70671507975** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 11.46456235165395
- top_miner_usd_day: 7691.791778850206 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 3.2454 USD/day  |  payback on registration: 0.04 days

## Score

- gate: **OK** 
- score: 52.7 (rank 31), confidence 0.85 - hardware from README keywords, not curated
- components: income 5.71 / freshness 35.0 / resource 11.25 / registration 9.99
