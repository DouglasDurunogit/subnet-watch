...
- **competitive_miner_usd_day: 2071.3600220509393** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 96.36900684147268
- top_miner_usd_day: 2071.3600220509393 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 87.4328 USD/day  |  payback on registration: 0.0 days
