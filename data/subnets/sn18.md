...
- registration cost: 0.999999999 TAO (226.12999977387 USD), open=True
...
- **competitive_miner_usd_day: 1390.3325781813405** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.84994701330894
- top_miner_usd_day: 1390.3325781813405 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.4558 USD/day  |  payback on registration: [UNKNOWN] days
