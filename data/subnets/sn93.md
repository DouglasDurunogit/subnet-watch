...
- registration cost: 0.005 TAO (0.9657 USD), open=True
...
- **competitive_miner_usd_day: 48.08359535321073** (uid 152) <- the only figure quotable as achievable
- median_miner_usd_day: 1482.177957609272
- top_miner_usd_day: 2916.272319865333 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.8644 USD/day  |  payback on registration: 0.02 days
