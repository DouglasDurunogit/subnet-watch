...
- miner_burn: **0.0**
- registration cost: 0.190895446 TAO (36.6042017705 USD), open=True
...
- **competitive_miner_usd_day: 350.4698457254485** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 5.093192410060911
- top_miner_usd_day: 350.4698457254485 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.1069 USD/day  |  payback on registration: 8.91 days

## Score

- gate: **OK** 
- score: 28.5 (rank 60), confidence 1.0 
- components: income 6.44 / freshness 0.0 / resource 15.0 / registration 7.03
