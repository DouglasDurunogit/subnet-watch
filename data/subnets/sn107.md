...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (193.9707 USD), open=True
...
- **competitive_miner_usd_day: 31963.81051869333** (uid 11) <- the only figure quotable as achievable
- median_miner_usd_day: 114.35389500227703
- top_miner_usd_day: 31963.81051869333 (uid 11, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 113.3676 USD/day  |  payback on registration: 1.71 days

## Score

- gate: **OK** 
- score: 78.2 (rank 1), confidence 1.0 
- components: income 18.72 / freshness 35.0 / resource 15.0 / registration 9.43
