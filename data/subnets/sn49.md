...
- subnet age: 276.0 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 39.70513400331941** (uid 61) <- the only figure quotable as achievable
- median_miner_usd_day: 1986.287215094301
- top_miner_usd_day: 3932.8692961852826 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 31.486 USD/day  |  payback on registration: 0.0 days
...
- components: income 13.75 / freshness 35.0 / resource 11.25 / registration 10.0
