...
- miner_burn: **0.19253829889930785**
- registration cost: 0.1 TAO (19.912000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 37  |  free: 0
- subnet age: 547.1 days  |  registered at block 4878363
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4728.9880006805615** (uid 242) <- the only figure quotable as achievable
- median_miner_usd_day: 95.08499712705863
- top_miner_usd_day: 4728.9880006805615 (uid 242, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 26  |  gini: 0.7791905824673941  |  top1_share: 0.4599899268936677  |  top10_share: 0.9181941667556967
- owner_incentive_share: 0.19256421605286855 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 17534 bytes, sha 21940350682ebe60
- latest release: v0.4.1 2026-08-07T21:01:31Z
- last commit: 2026-08-07T20:52:58Z
...
- net margin: 86.8658 USD/day  |  payback on registration: 0.23 days

## Score

- gate: **OK** 
- score: 62.8 (rank 15), confidence 0.85 - hardware requirement unknown
- components: income 17.68 / freshness 35.0 / resource 11.25 / registration 9.92
...
matching route available to you. Run `gmcli sources` to se
```

_(truncated at 6000 of 17534 chars - read the full file at https://github.com/taostat/gm-miner)_
