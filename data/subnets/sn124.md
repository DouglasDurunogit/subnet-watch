...
- miner_burn: **0.0**
- registration cost: 0.601550199 TAO (135.98643798594 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 35  |  free: 0
- subnet age: 454.7 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 830.1184978603912** (uid 49) <- the only figure quotable as achievable
- median_miner_usd_day: 261.0043837905063
- top_miner_usd_day: 830.1184978603912 (uid 49, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 25  |  gini: 0.31218204850353315  |  top1_share: 0.11188779170037087  |  top10_share: 0.6315074556249142
...
- status: **ok** 
- README: 14145 bytes, sha a1c9d6468262b550
- latest release: (none) 
- last commit: 2026-09-16T16:26:50Z
- scoring-related commit: Keep the version on 5.1.5.6 so the merge does not trigger the validat… 2026-09-16T16:12:22Z
...
- net margin: 254.2572 USD/day  |  payback on registration: 0.53 days

## Score

- gate: **OK** 
- score: 54.4 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 21.89 / freshness 21.0 / resource 11.25 / registration 9.82
...
_(truncated at 6000 of 14145 chars - read the full file at https://github.com/swarm-subnet/swarm)_
