...
- miner_burn: **0.0**
- registration cost: 0.231147957 TAO (47.67657761082 USD), open=True
...
- **competitive_miner_usd_day: 20.169303883434143** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 10.177171684301632
- top_miner_usd_day: 11405.093707883916 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.9133 USD/day  |  payback on registration: 5.35 days

## Score

- gate: **OK** 
- score: 67.3 (rank 13), confidence 1.0 
- components: income 9.06 / freshness 35.0 / resource 15.0 / registration 8.22
