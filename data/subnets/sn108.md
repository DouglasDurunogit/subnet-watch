...
- registration cost: 0.05 TAO (9.527 USD), open=True
...
- **competitive_miner_usd_day: 157.3952065142801** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 157.3952065142801
- top_miner_usd_day: 1498.3227274779076 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 136.2893 USD/day  |  payback on registration: 0.07 days
...
- components: income 19.44 / freshness 35.0 / resource 11.25 / registration 9.98
