...
- miner_burn: **0.0**
- registration cost: 0.001189704 TAO (0.22974373944 USD), open=True
...
- **competitive_miner_usd_day: 3226.0431506536** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 3226.0431506536
- top_miner_usd_day: 3226.0431506536 (uid 110, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3217.824 USD/day  |  payback on registration: 0.0 days
