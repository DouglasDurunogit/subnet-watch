...
- subnet age: 1016.2 days  |  registered at block 1477264
- weights_version: 199  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3139.1289931670776** (uid 210) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7728037895536872
- top_miner_usd_day: 10527.90602508988 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.4464 USD/day  |  payback on registration: [UNKNOWN] days
