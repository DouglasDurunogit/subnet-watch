...
- subnet age: 610.9 days  |  registered at block 4531295
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 9827.183447580102** (uid 21) <- the only figure quotable as achievable
- median_miner_usd_day: 2153.54831003533
- top_miner_usd_day: 9827.183447580102 (uid 21, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 18  |  gini: 0.45919872626368985  |  top1_share: 0.1910146652627081  |  top10_share: 0.8642890933785041
...
- net margin: 2258.9977 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 37.6 (rank 48), confidence 0.85 - hardware from README keywords, not curated
- components: income 30.51 / freshness 0.0 / resource 3.75 / registration 10.0
