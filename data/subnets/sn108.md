...
- registration cost: 0.123349414 TAO (23.67445302902 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 9  |  free: 99
- subnet age: 245.5 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1801.6694000912355
- top_miner_usd_day: 1801.6694000912355 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 7130 bytes, sha 23be49d6febfdbc7
- latest release: (none) 
- last commit: 2026-08-18T14:59:09Z
- scoring-related commit: Burn 60% of miner emission, split the other 40% by score 2026-08-18T14:52:43Z
...
```bash
cp configs/mainnet.example.toml ~/prometheon-m
```
