...
- subnet age: 324.8 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4085.256518897107
- top_miner_usd_day: 4085.256518897107 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-09T16:17:51Z
- scoring-related commit: feat(proof): name the topic_id / custom_id hyphen-underscore mix-up (… 2026-09-09T01:28:41Z
