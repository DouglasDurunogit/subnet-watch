...
- miner_burn: **0.0**
- registration cost: 0.11906808 TAO (23.7135988128 USD), open=True
...
- **competitive_miner_usd_day: 675.9405115501842** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 1689.9028537657055
- top_miner_usd_day: 4393.871199527422 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 667.7213 USD/day  |  payback on registration: 0.04 days
...
- components: income 25.7 / freshness 35.0 / resource 11.25 / registration 9.99
