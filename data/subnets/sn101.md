...
- registration cost: 0.002365137 TAO (0.5559491032199999 USD), open=True
...
- **competitive_miner_usd_day: 2.2514783445347475** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 1.027848809461515
- top_miner_usd_day: 2893.639124541179 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0415 USD/day  |  payback on registration: 13.4 days

## Score

- gate: **OK** 
- score: 41.7 (rank 39), confidence 1.0 
- components: income 0.16 / freshness 21.0 / resource 15.0 / registration 5.53
