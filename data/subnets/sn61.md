...
- miner_burn: **0.0**
- registration cost: 0.000538988 TAO (0.106315383 USD), open=True
...
- **competitive_miner_usd_day: 775.9451187879946** (uid 75) <- the only figure quotable as achievable
- median_miner_usd_day: 26.866330216745418
- top_miner_usd_day: 775.9451187879946 (uid 75, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.6472 USD/day  |  payback on registration: 0.01 days
