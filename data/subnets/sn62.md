...
- subnet age: 625.7 days  |  registered at block 4474225
- weights_version: 6  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1840.6773331316135** (uid 107) <- the only figure quotable as achievable
- median_miner_usd_day: 369.6023958938912
- top_miner_usd_day: 1840.6773331316135 (uid 107, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 361.3832 USD/day  |  payback on registration: 0.0 days
