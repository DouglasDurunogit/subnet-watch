...
- registration cost: 0.1 TAO (22.094 USD), open=True
...
- **competitive_miner_usd_day: 189.28233649514846** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0476882093827407
- top_miner_usd_day: 2637.879351566811 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4625 USD/day  |  payback on registration: [UNKNOWN] days
