...
- **competitive_miner_usd_day: 267.14024810471153** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 26.232984839826315
- top_miner_usd_day: 1870.1040350306016 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.5044 USD/day  |  payback on registration: 1.25 days

## Score

- gate: **OK** 
- score: 67.6 (rank 9), confidence 1.0 
- components: income 11.73 / freshness 35.0 / resource 11.25 / registration 9.58
