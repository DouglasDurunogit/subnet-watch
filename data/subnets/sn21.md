...
- **competitive_miner_usd_day: 947.9755711160002** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 8.025023508492989
- top_miner_usd_day: 947.9755711160002 (uid 39, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.2064 USD/day  |  payback on registration: 5.46 days

## Score

- gate: **OK** 
- score: 64.7 (rank 17), confidence 1.0 
- components: income 6.52 / freshness 35.0 / resource 15.0 / registration 8.18
