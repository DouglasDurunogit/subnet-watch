...
- miner_burn: **0.3009988912381232**
- registration cost: 0.1 TAO (22.743000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 798.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 912.1942092903416** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 8.532782768281912
- top_miner_usd_day: 912.1942092903416 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.0543 USD/day  |  payback on registration: 418.84 days

## Score

- gate: **OK** 
- score: 50.2 (rank 29), confidence 1.0 
- components: income 0.21 / freshness 35.0 / resource 15.0 / registration 0.0
