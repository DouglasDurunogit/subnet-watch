...
- subnet age: 512.3 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 123.03740557382926** (uid 159) <- the only figure quotable as achievable
- median_miner_usd_day: 30.300256596540038
- top_miner_usd_day: 123.03740557382926 (uid 159, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.38849463195507195  |  top1_share: 0.016386676653571595  |  top10_share: 0.11817667650071081
...
- net margin: 25.5243 USD/day  |  payback on registration: 0.96 days

## Score

- gate: **OK** 
- score: 28.8 (rank 58), confidence 0.85 - hardware requirement unknown
- components: income 12.95 / freshness 0.0 / resource 11.25 / registration 9.68
