...
- miner_burn: **0.0**
- registration cost: 0.00118454 TAO (0.2618070308 USD), open=True
...
- **competitive_miner_usd_day: 3637.406280950422** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 3637.406280950422
- top_miner_usd_day: 3637.406280950422 (uid 110, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3629.1871 USD/day  |  payback on registration: 0.0 days
