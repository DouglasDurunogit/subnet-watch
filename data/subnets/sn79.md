...
- miner_burn: **0.0**
- registration cost: 0.057274585 TAO (12.71209414075 USD), open=True
...
- **competitive_miner_usd_day: 409.40274092987664** (uid 27) <- the only figure quotable as achievable
- median_miner_usd_day: 6.5974233087690415
- top_miner_usd_day: 409.40274092987664 (uid 27, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.6111 USD/day  |  payback on registration: 2.27 days

## Score

- gate: **OK** 
- score: 31.7 (rank 58), confidence 1.0 
- components: income 7.46 / freshness 0.0 / resource 15.0 / registration 9.24
