...
- **competitive_miner_usd_day: 65.00347769857225** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 65.00347769857225
- top_miner_usd_day: 6373.61579883268 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 56.7843 USD/day  |  payback on registration: 0.2 days
...
- components: income 16.02 / freshness 21.0 / resource 11.25 / registration 9.93
