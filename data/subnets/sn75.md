...
- miner_burn: **0.0**
- registration cost: 0.326987525 TAO (68.588903244 USD), open=True
...
- **competitive_miner_usd_day: 12354.510181397978** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.1966460069895444
- top_miner_usd_day: 12354.510181397978 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.0225 USD/day  |  payback on registration: [UNKNOWN] days
