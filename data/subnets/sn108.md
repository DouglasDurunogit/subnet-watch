...
- registration cost: 0.05 TAO (10.2065 USD), open=True
...
- **competitive_miner_usd_day: 356.7707390675741** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 356.7707390675741
- top_miner_usd_day: 1290.6617925508306 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 329.3092 USD/day  |  payback on registration: 0.03 days
...
- components: income 22.91 / freshness 35.0 / resource 11.25 / registration 9.99
