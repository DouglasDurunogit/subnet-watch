...
- **competitive_miner_usd_day: 300.5338735075158** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 20.541809971125417
- top_miner_usd_day: 2113.5684088189473 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.2427 USD/day  |  payback on registration: 1.73 days

## Score

- gate: **OK** 
- score: 65.9 (rank 10), confidence 1.0 
- components: income 10.2 / freshness 35.0 / resource 11.25 / registration 9.42
