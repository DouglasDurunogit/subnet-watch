...
- subnet age: 82.8 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1275.8667110894964** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 131.22020737354106
- top_miner_usd_day: 3607.936350000006 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 69.9915 USD/day  |  payback on registration: 0.34 days

## Score

- gate: **OK** 
- score: 76.7 (rank 2), confidence 1.0 
- components: income 16.84 / freshness 35.0 / resource 15.0 / registration 9.89
