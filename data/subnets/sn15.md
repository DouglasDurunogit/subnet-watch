...
- miner_burn: **0.0**
- registration cost: 0.314016414 TAO (60.39791706876 USD), open=True
...
- **competitive_miner_usd_day: 20.639193072463744** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 11.421689370198381
- top_miner_usd_day: 12408.563407886573 (uid 253, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.235 USD/day  |  payback on registration: 5.9 days

## Score

- gate: **OK** 
- score: 67.6 (rank 10), confidence 1.0 
- components: income 9.56 / freshness 35.0 / resource 15.0 / registration 8.03
