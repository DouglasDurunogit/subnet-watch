...
- miner_burn: **0.0**
- registration cost: 0.012452296 TAO (2.3925841534399996 USD), open=True
...
- **competitive_miner_usd_day: 10.74301651257086** (uid 119) <- the only figure quotable as achievable
- median_miner_usd_day: 8.741037057472354
- top_miner_usd_day: 10.74301651257086 (uid 119, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.2963 USD/day  |  payback on registration: 8.07 days

## Score

- gate: **OK** 
- score: 16.6 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 1.03 / freshness 0.0 / resource 11.25 / registration 7.31
