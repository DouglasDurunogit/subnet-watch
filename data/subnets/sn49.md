...
- **competitive_miner_usd_day: 64.7886813680391** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 64.7886813680391
- top_miner_usd_day: 6352.554936640572 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 56.5695 USD/day  |  payback on registration: 0.2 days
...
- components: income 16.01 / freshness 21.0 / resource 11.25 / registration 9.93
