...
- miner_burn: **0.0**
- registration cost: 0.005 TAO (0.99505 USD), open=True
...
- **competitive_miner_usd_day: 13.656180728890272** (uid 152) <- the only figure quotable as achievable
- median_miner_usd_day: 13.656180728890272
- top_miner_usd_day: 2936.847582116677 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.03 USD/day  |  payback on registration: 0.2 days
...
- components: income 7.1 / freshness 21.0 / resource 11.25 / registration 9.93
