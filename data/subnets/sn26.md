...
- **competitive_miner_usd_day: 8.76358094895384** (uid 101) <- the only figure quotable as achievable
- median_miner_usd_day: 4.746939680683329
- top_miner_usd_day: 1501.7217541746365 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.5142 USD/day  |  payback on registration: 12.43 days

## Score

- gate: **OK** 
- score: 20.7 (rank 51), confidence 1.0 
- components: income 3.64 / freshness 0.0 / resource 11.25 / registration 5.86
