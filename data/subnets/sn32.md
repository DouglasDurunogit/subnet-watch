...
- miner_burn: **0.0**
- registration cost: 0.009791574 TAO (1.85471994708 USD), open=True
...
- **competitive_miner_usd_day: 10.222662596529352** (uid 185) <- the only figure quotable as achievable
- median_miner_usd_day: 8.111460538550464
- top_miner_usd_day: 10.222662596529352 (uid 185, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.5244 USD/day  |  payback on registration: [UNKNOWN] days
