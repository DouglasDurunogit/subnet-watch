...
- miner_burn: **1.5199417248368263e-05**
- registration cost: 0.0005 TAO (0.11977 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 8  |  free: 0
- subnet age: 149.0 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3412.8025778238493** (uid 46) <- the only figure quotable as achievable
- median_miner_usd_day: 3412.8025778238493
- top_miner_usd_day: 3412.8025778238493 (uid 46, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 25206 bytes, sha 8c0cd8c1611fb5bf
- latest release: SN78 direct bootstrap cutover v1 inputs 2026-09-09T16:23:03Z
- last commit: 2026-09-10T18:36:43Z
- scoring-related commit: Expose Linux validator setup 2026-09-10T18:02:00Z
...
- net margin: 3404.5834 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 53.0 (rank 31), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
...
shared virtual-address region, so local
```

_(truncated at 6000 of 25206 chars - read the full file at https://github.com/Umi-BitSign/umi)_
