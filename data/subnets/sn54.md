...
- **competitive_miner_usd_day: 958.2509640880531** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9383986199504352
- top_miner_usd_day: 958.2509640880531 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.1783 USD/day  |  payback on registration: [UNKNOWN] days
