...
- subnet age: 608.2 days  |  registered at block 4474225
- weights_version: 6  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2230.5618182977146** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 700.5855207273228
- top_miner_usd_day: 2852.4963419278115 (uid 202, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 479.8621 USD/day  |  payback on registration: 0.0 days
