...
- subnet age: 1040.5 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1128.1484422065419** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 14.738488461108966
- top_miner_usd_day: 1128.1484422065419 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.0338 USD/day  |  payback on registration: 61.79 days

## Score

- gate: **OK** 
- score: 32.8 (rank 61), confidence 0.85 - hardware requirement unknown
- components: income 6.38 / freshness 21.0 / resource 11.25 / registration 0.0
