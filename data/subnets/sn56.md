...
- miner_burn: **0.7060327171348035**
- registration cost: 0.0005 TAO (0.09389499999999999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 35  |  free: 0
- subnet age: 611.9 days  |  registered at block 4312927
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 706.7360900996132** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8666291724090904
- top_miner_usd_day: 6683.010863032701 (uid 38, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 22  |  gini: 0.8788267252693589  |  top1_share: 0.7061166559838843  |  top10_share: 0.9989011995238531
- owner_incentive_share: 0.7061166559838843 (independent check on miner_burn; disagreement 0.0001)
...
- status: **ok** 
- README: 3606 bytes, sha f6492a03ad719819
- latest release: (none) 
- last commit: 2026-07-27T11:26:09Z
- scoring-related commit: feat(validator): downweight negative scoring GRPO reward templates (#… 2026-07-23T17:04:49Z
...
- net margin: 698.5169 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 40.1 (rank 30), confidence 0.85 - hardware requirement unknown
