...
- **competitive_miner_usd_day: 861.5907056379644** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 8.059431041662629
- top_miner_usd_day: 861.5907056379644 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.0034 USD/day  |  payback on registration: [UNKNOWN] days
