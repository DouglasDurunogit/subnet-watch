...
- **competitive_miner_usd_day: 308.1299078271043** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 770.3130151652346
- top_miner_usd_day: 1232.4961225033649 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 299.9107 USD/day  |  payback on registration: 0.75 days
...
- components: income 22.54 / freshness 35.0 / resource 11.25 / registration 9.75
