...
- subnet age: 837.8 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4365.4200772435615
- top_miner_usd_day: 4365.4200772435615 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-22T11:14:11Z
- scoring-related commit: fix(worker): pass leaders.last_score to rank_round 2026-08-20T15:19:13Z
