...
- subnet age: 130.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 26.329138642694073** (uid 132) <- the only figure quotable as achievable
- median_miner_usd_day: 24.1350437558029
- top_miner_usd_day: 1720.5454502777034 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.3998 USD/day  |  payback on registration: 1.91 days

## Score

- gate: **OK** 
- score: 51.9 (rank 29), confidence 1.0 
- components: income 10.25 / freshness 21.0 / resource 11.25 / registration 9.36
