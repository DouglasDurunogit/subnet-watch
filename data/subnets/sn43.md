...
- registration cost: 0.1 TAO (20.884 USD), open=True
...
- **competitive_miner_usd_day: 25.03933003952157** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.782479063735049
- top_miner_usd_day: 2580.5181423152253 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7907 USD/day  |  payback on registration: [UNKNOWN] days
