...
- registration cost: 0.1 TAO (19.6 USD), open=True
...
- **competitive_miner_usd_day: 16.64082680465908** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9734188381555454
- top_miner_usd_day: 2462.9814269235667 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.7777 USD/day  |  payback on registration: [UNKNOWN] days
