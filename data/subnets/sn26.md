...
- **competitive_miner_usd_day: 261.9148794325867** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 25.715933005015184
- top_miner_usd_day: 1833.4441186279585 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.0814 USD/day  |  payback on registration: 1.25 days

## Score

- gate: **OK** 
- score: 67.5 (rank 10), confidence 1.0 
- components: income 11.65 / freshness 35.0 / resource 11.25 / registration 9.58
