...
- miner_burn: **0.0**
- registration cost: 0.061587655 TAO (11.99296405815 USD), open=True
...
- **competitive_miner_usd_day: 148.02607559595748** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 6.860426865481685
- top_miner_usd_day: 148.02607559595748 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -8.1762 USD/day  |  payback on registration: [UNKNOWN] days
