...
- miner_burn: **0.0**
- registration cost: 0.147938702 TAO (28.495952779240003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 215  |  free: 0
- subnet age: 496.7 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 424.8522303230473** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 6.645927599647996
- top_miner_usd_day: 424.8522303230473 (uid 155, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 214  |  gini: 0.7285895658389545  |  top1_share: 0.09331152752728274  |  top10_share: 0.4812612722770764
...
- net margin: 5.6596 USD/day  |  payback on registration: 5.03 days

## Score

- gate: **OK** 
- score: 30.8 (rank 49), confidence 1.0 
- components: income 7.49 / freshness 0.0 / resource 15.0 / registration 8.32
