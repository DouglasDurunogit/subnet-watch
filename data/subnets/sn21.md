...
- **competitive_miner_usd_day: 599.54181747973** (uid 244) <- the only figure quotable as achievable
- median_miner_usd_day: 11.236036655846648
- top_miner_usd_day: 1199.08363495946 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 6.5044 USD/day  |  payback on registration: 3.7 days

## Score

- gate: **OK** 
- score: 66.7 (rank 11), confidence 1.0 
- components: income 7.96 / freshness 35.0 / resource 15.0 / registration 8.77
