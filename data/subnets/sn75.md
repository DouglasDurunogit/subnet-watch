...
- **competitive_miner_usd_day: 5.717462958739054** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 3.811641972492702
- top_miner_usd_day: 10785.387474074689 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.4942 USD/day  |  payback on registration: [UNKNOWN] days
