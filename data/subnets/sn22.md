...
- **competitive_miner_usd_day: 101.59352407482426** (uid 140) <- the only figure quotable as achievable
- median_miner_usd_day: 3.1573254487481806
- top_miner_usd_day: 1120.2585357839637 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.2263 USD/day  |  payback on registration: [UNKNOWN] days
