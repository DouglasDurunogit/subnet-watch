...
- miner_burn: **0.9505341190379113**
- registration cost: 0.999999999 TAO ([UNKNOWN] USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 4  |  free: 237
- subnet age: 27.7 days  |  registered at block 8884359
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 12) <- the only figure quotable as achievable
...
- gate: **OK** 
- score: 36.1 (rank 30), confidence 0.85 - hardware from README keywords, not curated
- components: income 0.0 / freshness 35.0 / resource 7.5 / registration 0.0
