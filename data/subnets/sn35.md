...
- subnet age: 809.4 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 887.7663342284113** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 326.65033569050416
- top_miner_usd_day: 887.7663342284113 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.3668121382285021  |  top1_share: 0.6546678060243538  |  top10_share: 1.0
...
- net margin: 506.4838 USD/day  |  payback on registration: 0.04 days
...
- components: income 24.61 / freshness 0.0 / resource 11.25 / registration 9.99
