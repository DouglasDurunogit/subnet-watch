...
- subnet age: 296.7 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 74.30062027522496** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 74.30062027522496
- top_miner_usd_day: 7285.204177001179 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 66.0814 USD/day  |  payback on registration: 0.18 days
...
- components: income 16.61 / freshness 21.0 / resource 11.25 / registration 9.94
