...
- subnet age: 128.1 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 368.1003296959436** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 24.096903576738534
- top_miner_usd_day: 1717.8265029981399 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 16.7567 USD/day  |  payback on registration: 1.41 days

## Score

- gate: **OK** 
- score: 53.1 (rank 28), confidence 1.0 
- components: income 11.36 / freshness 21.0 / resource 11.25 / registration 9.53
