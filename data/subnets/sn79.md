...
- miner_burn: **0.0**
- registration cost: 0.040516167 TAO (10.39685361387 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 216  |  free: 0
- subnet age: 535.9 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 252.08606377386133** (uid 208) <- the only figure quotable as achievable
- median_miner_usd_day: 3.8533865764249016
- top_miner_usd_day: 252.08606377386133 (uid 208, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 215  |  gini: 0.7370085649374429  |  top1_share: 0.09301330071854458  |  top10_share: 0.4876777251184834
...
- net margin: 2.8671 USD/day  |  payback on registration: 3.63 days

## Score

- gate: **OK** 
- score: 50.1 (rank 37), confidence 1.0 
- components: income 5.34 / freshness 21.0 / resource 15.0 / registration 8.79
