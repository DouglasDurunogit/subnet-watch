...
- **competitive_miner_usd_day: 566.3308900438169** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 110.75856791056862
- top_miner_usd_day: 566.3308900438169 (uid 24, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 109.1731 USD/day  |  payback on registration: 0.0 days
