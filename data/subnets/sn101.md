...
- registration cost: 0.011496382 TAO (2.4751710446 USD), open=True
...
- **competitive_miner_usd_day: 2.136283794640282** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 1.2461655468734982
- top_miner_usd_day: 2627.629067407547 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.2599 USD/day  |  payback on registration: 9.52 days

## Score

- gate: **OK** 
- score: 43.7 (rank 44), confidence 1.0 
- components: income 0.91 / freshness 21.0 / resource 15.0 / registration 6.83
