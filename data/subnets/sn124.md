...
- subnet age: 407.5 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 727.5642228279852** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 283.32892100415165
- top_miner_usd_day: 727.5642228279852 (uid 17, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.2920267073636018  |  top1_share: 0.11627623044639453  |  top10_share: 0.7173597863410912
...
- latest release: (none) 
- last commit: 2026-07-30T22:48:46Z
- scoring-related commit: Kill host workers when the validator process dies 2026-07-30T21:28:44Z
...
- net margin: 275.1097 USD/day  |  payback on registration: 0.36 days

## Score

- gate: **OK** 
- score: 66.6 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 22.2 / freshness 35.0 / resource 11.25 / registration 9.88
