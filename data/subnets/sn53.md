...
- subnet age: 645.1 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 565.4458897892941** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 91.38519430938088
- top_miner_usd_day: 1964.2377181617521 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 81.8061 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.7 (rank 30), confidence 0.85 - hardware from README keywords, not curated
