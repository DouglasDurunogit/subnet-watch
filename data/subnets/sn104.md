...
- tempo: 360.0  |  max_uids: 64  |  active: 17  |  free: 0
- subnet age: 450.2 days  |  registered at block 5528520
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2663.8115650232817
- top_miner_usd_day: 2663.8115650232817 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
