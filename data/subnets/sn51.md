...
- **competitive_miner_usd_day: 2202.7634965945945** (uid 77) <- the only figure quotable as achievable
- median_miner_usd_day: 48.56061596901738
- top_miner_usd_day: 32177.47815647014 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.3181 USD/day  |  payback on registration: 2.65 days

## Score

- gate: **OK** 
- score: 59.4 (rank 20), confidence 0.85 - hardware requirement unknown
- components: income 14.5 / freshness 35.0 / resource 11.25 / registration 9.12
