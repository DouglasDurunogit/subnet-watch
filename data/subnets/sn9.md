...
- subnet age: 1037.7 days  |  registered at block 1489797
- weights_version: 4062  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 203.4320908312551** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 10176.884458424023
- top_miner_usd_day: 20150.33682601679 (uid 128, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 195.2129 USD/day  |  payback on registration: 0.0 days
...
- components: income 20.85 / freshness 35.0 / resource 11.25 / registration 10.0
