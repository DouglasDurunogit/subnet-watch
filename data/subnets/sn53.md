...
- subnet age: 652.3 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 234.89209304200259** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 43.694034785591
- top_miner_usd_day: 12012.927080481444 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.7154 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.7 (rank 20), confidence 0.85 - hardware from README keywords, not curated
- components: income 14.01 / freshness 35.0 / resource 11.25 / registration 10.0
