...
- miner_burn: **0.0**
- registration cost: 0.288923798 TAO (56.97288372762 USD), open=True
...
- **competitive_miner_usd_day: 12271.805272759711** (uid 149) <- the only figure quotable as achievable
- median_miner_usd_day: 12.25479035722241
- top_miner_usd_day: 12271.805272759711 (uid 149, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.2685 USD/day  |  payback on registration: 5.06 days

## Score

- gate: **OK** 
- score: 68.2 (rank 13), confidence 1.0 
- components: income 9.9 / freshness 35.0 / resource 15.0 / registration 8.31
