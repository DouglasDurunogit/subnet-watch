...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9428 USD), open=True
...
- **competitive_miner_usd_day: 118.9479731612001** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 4.353263313863843
- top_miner_usd_day: 118.9479731612001 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.8412 USD/day  |  payback on registration: [UNKNOWN] days
