...
- **competitive_miner_usd_day: 6.488567407055872** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 5.365546125065433
- top_miner_usd_day: 2875.8079428926285 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.8536 USD/day  |  payback on registration: [UNKNOWN] days
