...
- **competitive_miner_usd_day: 312.3277072240206** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 780.807353521743
- top_miner_usd_day: 1249.2869998194653 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 304.1085 USD/day  |  payback on registration: 0.68 days
...
- components: income 22.6 / freshness 35.0 / resource 11.25 / registration 9.77
