...
- subnet age: 1030.8 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1209.2332723076975** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.9663434885677007
- top_miner_usd_day: 1209.2332723076975 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.2756 USD/day  |  payback on registration: [UNKNOWN] days
