...
- miner_burn: **0.8049872962292284**
- registration cost: 0.1 TAO (20.543000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 20  |  free: 0
- subnet age: 749.3 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21.34197937193364** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.661528896033683
- top_miner_usd_day: 2624.4167361002033 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.8760710034402921  |  top1_share: 0.8050850044257242  |  top10_share: 0.9995726887037206
- owner_incentive_share: 0.8050850044257242 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.2823 USD/day  |  payback on registration: 72.77 days

## Score

- gate: **OK** 
- score: 16.0 (rank 68), confidence 1.0 
- components: income 0.98 / freshness 0.0 / resource 15.0 / registration 0.0
