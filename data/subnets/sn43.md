...
- registration cost: 0.1 TAO (22.338 USD), open=True
...
- **competitive_miner_usd_day: 191.1818613447207** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0593190206435712
- top_miner_usd_day: 2667.4661815062877 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4566 USD/day  |  payback on registration: [UNKNOWN] days
