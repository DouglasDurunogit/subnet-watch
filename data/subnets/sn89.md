...
- miner_burn: **0.2000000011175871**
- registration cost: 0.05 TAO (10.173000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 62  |  free: 0
- subnet age: 486.3 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 253.17643884984713** (uid 191) <- the only figure quotable as achievable
- median_miner_usd_day: 0.045609158502944884
- top_miner_usd_day: 253.17643884984713 (uid 191, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 54  |  gini: 0.7987132550451326  |  top1_share: 0.16951171099642717  |  top10_share: 0.8281216599993894
...
- latest release: (none) 
- last commit: 2026-08-10T11:35:10Z
- scoring-related commit: hf: import time — hf_scoring_config() raised NameError on every bare … 2026-08-10T11:35:10Z
...
- net margin: -8.1736 USD/day  |  payback on registration: [UNKNOWN] days
