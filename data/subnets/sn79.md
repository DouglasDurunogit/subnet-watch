...
- miner_burn: **0.0**
- registration cost: 0.136134012 TAO (25.565967453600003 USD), open=True
...
- **competitive_miner_usd_day: 567.5123410507048** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 3.805032603826436
- top_miner_usd_day: 567.5123410507048 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 566.526 USD/day  |  payback on registration: 0.05 days

## Score

- gate: **OK** 
- score: 50.0 (rank 7), confidence 1.0 
- components: income 25.05 / freshness 0.0 / resource 15.0 / registration 9.98
