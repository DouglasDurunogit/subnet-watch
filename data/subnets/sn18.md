...
- registration cost: 0.999999999 TAO (222.92999977707 USD), open=True
...
- **competitive_miner_usd_day: 1357.5755053864148** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.735679341055796
- top_miner_usd_day: 1357.5755053864148 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.5681 USD/day  |  payback on registration: [UNKNOWN] days
