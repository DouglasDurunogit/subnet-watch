...
- subnet age: 294.2 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 848.3038589771755** (uid 94) <- the only figure quotable as achievable
- median_miner_usd_day: 272.91440649874477
- top_miner_usd_day: 1696.607717954351 (uid 109, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.5055035885228305  |  top1_share: 0.5088428730563227  |  top10_share: 1.0
...
- latest release: v3.3.13 — design screenshot egress proxy + gateway admin auth 2026-08-08T20:03:52Z
- last commit: 2026-08-08T21:10:09Z
- scoring-related commit: Merge pull request #101 from BaseIntelligence/fix/master-no-validator… 2026-08-08T21:01:32Z
...
- net margin: 254.8756 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 66.4 (rank 13), confidence 0.85 - hardware requirement unknown
- components: income 21.9 / freshness 35.0 / resource 11.25 / registration 10.0
