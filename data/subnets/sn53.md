...
- miner_burn: **0.0**
- registration cost: 0.000713977 TAO (0.15581834048 USD), open=True
...
- **competitive_miner_usd_day: 258.0850460263751** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 48.00832941064905
- top_miner_usd_day: 13199.068552397572 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 37.8559 USD/day  |  payback on registration: 0.0 days
