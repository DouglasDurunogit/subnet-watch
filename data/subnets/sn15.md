...
- miner_burn: **0.0**
- registration cost: 0.593883406 TAO (139.6813770912 USD), open=True
...
- **competitive_miner_usd_day: 41.211828414647066** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 24.435331891870383
- top_miner_usd_day: 21809.445479609683 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.2667 USD/day  |  payback on registration: 6.0 days

## Score

- gate: **OK** 
- score: 70.6 (rank 10), confidence 1.0 
- components: income 12.6 / freshness 35.0 / resource 15.0 / registration 8.0
