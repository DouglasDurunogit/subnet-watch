...
- registration cost: 0.1 TAO (23.172 USD), open=True
...
- **competitive_miner_usd_day: 185.47928183334395** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.215527136714464
- top_miner_usd_day: 2741.6958259045564 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2678 USD/day  |  payback on registration: [UNKNOWN] days
