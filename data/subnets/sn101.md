...
- registration cost: 0.001998114 TAO (0.3919300611 USD), open=True
...
- **competitive_miner_usd_day: 1.8973650946269185** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9486825473134592
- top_miner_usd_day: 2438.237887797414 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.0376 USD/day  |  payback on registration: [UNKNOWN] days
