...
- subnet age: 517.3 days  |  registered at block 5102795
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 11474.42780713846** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5298253593359402
- top_miner_usd_day: 11474.42780713846 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -7.6894 USD/day  |  payback on registration: [UNKNOWN] days
