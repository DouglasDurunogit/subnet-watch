...
- subnet age: 124.5 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 34.942441224663305** (uid 132) <- the only figure quotable as achievable
- median_miner_usd_day: 27.454775247949733
- top_miner_usd_day: 1957.2033562151453 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.0082 USD/day  |  payback on registration: 1.5 days

## Score

- gate: **OK** 
- score: 53.2 (rank 28), confidence 1.0 
- components: income 11.42 / freshness 21.0 / resource 11.25 / registration 9.5
