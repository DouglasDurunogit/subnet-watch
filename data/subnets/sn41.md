...
- miner_burn: **0.6514734316151589**
- registration cost: 0.1 TAO (19.572000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 82  |  free: 0
- subnet age: 758.7 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.547906619492004** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 13.956679422044642
- top_miner_usd_day: 1882.6744747070263 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 74  |  gini: 0.7312629600361489  |  top1_share: 0.6518665546988319  |  top10_share: 0.7366669211390182
- owner_incentive_share: 0.651866554698832 (independent check on miner_burn; disagreement 0.0004)
...
- net margin: 12.816 USD/day  |  payback on registration: 1.53 days

## Score

- gate: **OK** 
- score: 69.9 (rank 7), confidence 1.0 
- components: income 10.37 / freshness 35.0 / resource 15.0 / registration 9.49
