...
- **competitive_miner_usd_day: 12.922353407771814** (uid 170) <- the only figure quotable as achievable
- median_miner_usd_day: 8.846841948397628
- top_miner_usd_day: 12.922353407771814 (uid 170, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.462 USD/day  |  payback on registration: 0.25 days

## Score

- gate: **OK** 
- score: 19.3 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 1.5 / freshness 0.0 / resource 11.25 / registration 9.92
