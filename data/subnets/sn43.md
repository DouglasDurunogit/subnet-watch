...
- registration cost: 0.1 TAO (23.413 USD), open=True
...
- **competitive_miner_usd_day: 194.66810709627993** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.897456766596433
- top_miner_usd_day: 2745.7329788601287 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.2085 USD/day  |  payback on registration: [UNKNOWN] days
