...
- miner_burn: **0.0**
- registration cost: 0.276699036 TAO (52.95189451932 USD), open=True
...
- **competitive_miner_usd_day: 20.47442578628061** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 11.330507473961115
- top_miner_usd_day: 12309.503075877928 (uid 253, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.1454 USD/day  |  payback on registration: 5.22 days

## Score

- gate: **OK** 
- score: 67.8 (rank 9), confidence 1.0 
- components: income 9.52 / freshness 35.0 / resource 15.0 / registration 8.26
