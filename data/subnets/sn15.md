...
- miner_burn: **0.0**
- registration cost: 0.339403402 TAO (66.60112957446 USD), open=True
...
- **competitive_miner_usd_day: 21.937588332111236** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.773843279160616
- top_miner_usd_day: 12410.637127626671 (uid 13, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 66  |  gini: 0.94357377938032  |  top1_share: 0.9414063692711674  |  top10_share: 0.955512808769198
...
- net margin: 10.7875 USD/day  |  payback on registration: 6.17 days

## Score

- gate: **OK** 
- score: 67.7 (rank 8), confidence 1.0 
- components: income 9.74 / freshness 35.0 / resource 15.0 / registration 7.94
