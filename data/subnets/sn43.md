...
- registration cost: 0.1 TAO (22.353 USD), open=True
...
- **competitive_miner_usd_day: 178.92381334254412** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 12.773199735023901
- top_miner_usd_day: 2644.6959559893094 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2932 USD/day  |  payback on registration: [UNKNOWN] days
