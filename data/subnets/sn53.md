...
- **competitive_miner_usd_day: 271.7146980197673** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 50.543682902553485
- top_miner_usd_day: 13896.120604718813 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 40.2892 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.3 (rank 21), confidence 0.85 - hardware from README keywords, not curated
