...
- miner_burn: **0.8214503698982298**
- registration cost: 0.1 TAO (23.449 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 20  |  free: 0
- subnet age: 771.2 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 94.18829489472594** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.091410420049236
- top_miner_usd_day: 2684.191889395331 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.8614769484334706  |  top1_share: 0.8215392128435607  |  top10_share: 0.9997863476124347
- owner_incentive_share: 0.8215392128435607 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.2104 USD/day  |  payback on registration: 111.45 days

## Score

- gate: **OK** 
- score: 15.8 (rank 78), confidence 1.0 
- components: income 0.75 / freshness 0.0 / resource 15.0 / registration 0.0
