...
- subnet age: 163.4 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 150.31539390774734** (uid 61) <- the only figure quotable as achievable
- median_miner_usd_day: 90.19897179762168
- top_miner_usd_day: 1113.9548678373844 (uid 71, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 7  |  gini: 0.6191217376897655  |  top1_share: 0.6984221449063053  |  top10_share: 1.0
...
- latest release: (none) 
- last commit: 2026-08-01T05:18:26Z
- scoring-related commit: Carry a track's standing forward when a pass does not evaluate it 2026-08-01T05:18:26Z
...
- net margin: 74.1714 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 77.1 (rank 3), confidence 1.0 
- components: income 17.06 / freshness 35.0 / resource 15.0 / registration 10.0
