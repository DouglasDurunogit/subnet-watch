...
- registration cost: 0.999999999 TAO (220.93999977906 USD), open=True
...
- **competitive_miner_usd_day: 2076.0838445618847** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 4.681303230774171
- top_miner_usd_day: 2076.0838445618847 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.6014 USD/day  |  payback on registration: [UNKNOWN] days
