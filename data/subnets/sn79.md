...
- miner_burn: **0.0**
- registration cost: 0.03440593 TAO (8.9324675466 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 216  |  free: 0
- subnet age: 534.9 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 269.06867857203935** (uid 219) <- the only figure quotable as achievable
- median_miner_usd_day: 3.6813896429740867
- top_miner_usd_day: 269.06867857203935 (uid 219, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 215  |  gini: 0.7426203507744236  |  top1_share: 0.1005410692996668  |  top10_share: 0.49743221349310673
...
- net margin: 2.6951 USD/day  |  payback on registration: 3.31 days

## Score

- gate: **OK** 
- score: 50.1 (rank 35), confidence 1.0 
- components: income 5.16 / freshness 21.0 / resource 15.0 / registration 8.9
