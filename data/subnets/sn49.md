...
- subnet age: 269.6 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 186) <- the only figure quotable as achievable
...
- gate: **OK** 
- score: 9.6 (rank 46), confidence 0.85 - hardware requirement unknown
