...
- miner_burn: **0.0**
- registration cost: 0.150271776 TAO (33.49708158816 USD), open=True
...
- **competitive_miner_usd_day: 170.84520928669434** (uid 68) <- the only figure quotable as achievable
- median_miner_usd_day: 20.997735219593718
- top_miner_usd_day: 170.84520928669434 (uid 68, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 12.4604 USD/day  |  payback on registration: 2.69 days

## Score

- gate: **OK** 
- score: 26.0 (rank 70), confidence 0.85 - hardware requirement unknown
- components: income 10.27 / freshness 0.0 / resource 11.25 / registration 9.1
