...
- miner_burn: **0.1505648265592754**
- registration cost: 0.1 TAO (24.282 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 812.8 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 113.88405191955991** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 10.66934206550143
- top_miner_usd_day: 1138.762782641388 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.7628 USD/day  |  payback on registration: 31.83 days

## Score

- gate: **OK** 
- score: 52.2 (rank 31), confidence 1.0 
- components: income 2.24 / freshness 35.0 / resource 15.0 / registration 0.0
