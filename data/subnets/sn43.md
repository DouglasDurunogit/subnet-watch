...
- registration cost: 0.1 TAO (18.796000000000003 USD), open=True
...
- **competitive_miner_usd_day: 60.17221765586657** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.3249421881983063
- top_miner_usd_day: 2415.247241457773 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.5376 USD/day  |  payback on registration: 34.96 days

## Score

- gate: **OK** 
- score: 16.7 (rank 51), confidence 1.0 
