...
- subnet age: 512.5 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 107.84230664724467** (uid 165) <- the only figure quotable as achievable
- median_miner_usd_day: 8.881843907014645
- top_miner_usd_day: 107.84230664724467 (uid 165, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 78  |  gini: 0.6382414841527615  |  top1_share: 0.06795449339543407  |  top10_share: 0.4390623806978697
...
- status: **ok** 
- README: 22587 bytes, sha 0ec962c965208efb
- latest release: (none) 
- last commit: 2026-09-05T18:46:25Z
- scoring-related commit: weights: the validator was setting them on the pre-causal rule 2026-09-02T16:19:10Z
...
- net margin: 0.4082 USD/day  |  payback on registration: 28.5 days

## Score

- gate: **OK** 
- score: 40.9 (rank 45), confidence 0.85 - hardware requirement unknown
- components: income 1.35 / freshness 35.0 / resource 11.25 / registration 0.5
...
_(truncated at 6000 of 22587 chars - read the full file at https://github.com/DeltaCompute24/InfiniteQuant-Subnet)_
