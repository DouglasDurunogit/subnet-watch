...
- miner_burn: **0.4044398998375982**
- registration cost: 0.1 TAO (20.42 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 102  |  free: 0
- subnet age: 165.5 days  |  registered at block 7692872
- weights_version: 1000  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 310.047901383315** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 19.76400964993243
- top_miner_usd_day: 2046.192624069567 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 96  |  gini: 0.6402189502807432  |  top1_share: 0.4047586322750111  |  top10_share: 0.6105129732288755
- owner_incentive_share: 0.4047586322750111 (independent check on miner_burn; disagreement 0.0003)
...
- net margin: 11.4676 USD/day  |  payback on registration: 1.78 days

## Score

- gate: **OK** 
- score: 65.6 (rank 10), confidence 1.0 
- components: income 9.97 / freshness 35.0 / resource 11.25 / registration 9.41
