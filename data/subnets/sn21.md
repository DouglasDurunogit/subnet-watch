...
- miner_burn: **0.4512536593247205**
- registration cost: 0.1 TAO (19.94 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 100  |  free: 0
- subnet age: 790.4 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 34.296908630555016** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.395746159353184
- top_miner_usd_day: 844.4864130081374 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.4094 USD/day  |  payback on registration: 2.69 days

## Score

- gate: **OK** 
- score: 67.5 (rank 12), confidence 1.0 
- components: income 8.41 / freshness 35.0 / resource 15.0 / registration 9.1
