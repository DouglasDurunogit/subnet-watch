...
- **competitive_miner_usd_day: 381.44877081542614** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.13594639280559
- top_miner_usd_day: 763.0557666063025 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.3871 USD/day  |  payback on registration: 14.72 days

## Score

- gate: **OK** 
- score: 58.5 (rank 20), confidence 1.0 
- components: income 3.44 / freshness 35.0 / resource 15.0 / registration 5.09
