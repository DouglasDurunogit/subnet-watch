...
- **competitive_miner_usd_day: 9.263918482061941** (uid 2) <- the only figure quotable as achievable
- median_miner_usd_day: 6.652064813110556
- top_miner_usd_day: 2578.062812109326 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.5875 USD/day  |  payback on registration: [UNKNOWN] days
