...
- miner_burn: **0.0**
- registration cost: 0.578451823 TAO (108.62746784116999 USD), open=True
...
- **competitive_miner_usd_day: 5.436881686992534** (uid 84) <- the only figure quotable as achievable
- median_miner_usd_day: 5.260232101494582
- top_miner_usd_day: 5.436881686992534 (uid 84, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.7823 USD/day  |  payback on registration: [UNKNOWN] days
