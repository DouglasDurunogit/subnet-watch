...
- miner_burn: **7.005874067544937e-07**
- registration cost: 0.8 TAO (159.776 USD), open=True
...
- **competitive_miner_usd_day: 31.354992273679823** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 7.925845269180177
- top_miner_usd_day: 31.354992273679823 (uid 254, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 235  |  gini: 0.34589982506640093  |  top1_share: 0.011005303945095763  |  top10_share: 0.0941717744524097
...
- net margin: -0.2933 USD/day  |  payback on registration: [UNKNOWN] days
