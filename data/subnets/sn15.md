...
- miner_burn: **0.0**
- registration cost: 0.394998327 TAO (96.36379185492 USD), open=True
...
- **competitive_miner_usd_day: 48.68633696878595** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.907512575216664
- top_miner_usd_day: 26350.175786043732 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.9212 USD/day  |  payback on registration: 3.45 days

## Score

- gate: **OK** 
- score: 72.1 (rank 6), confidence 1.0 
- components: income 13.29 / freshness 35.0 / resource 15.0 / registration 8.85
