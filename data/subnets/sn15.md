...
- miner_burn: **0.0**
- registration cost: 0.253650763 TAO (49.8170098532 USD), open=True
...
- **competitive_miner_usd_day: 10632.544521772426** (uid 94) <- the only figure quotable as achievable
- median_miner_usd_day: 10.175674005816369
- top_miner_usd_day: 10632.544521772426 (uid 94, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.0169 USD/day  |  payback on registration: 5.52 days

## Score

- gate: **OK** 
- score: 67.3 (rank 10), confidence 1.0 
- components: income 9.1 / freshness 35.0 / resource 15.0 / registration 8.16
