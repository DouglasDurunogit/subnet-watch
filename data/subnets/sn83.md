...
- miner_burn: **0.0**
- registration cost: 0.159821677 TAO (37.22087035653 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 251  |  free: 0
- subnet age: 509.1 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 163.90646499805914** (uid 127) <- the only figure quotable as achievable
- median_miner_usd_day: 25.340072565667466
- top_miner_usd_day: 163.90646499805914 (uid 127, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.33119826897924143  |  top1_share: 0.022607684777288303  |  top10_share: 0.124464635340186
...
- net margin: 14.1821 USD/day  |  payback on registration: 2.62 days

## Score

- gate: **OK** 
- score: 26.5 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 10.74 / freshness 0.0 / resource 11.25 / registration 9.13
