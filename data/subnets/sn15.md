...
- miner_burn: **0.0**
- registration cost: 0.312519763 TAO (61.657024042269995 USD), open=True
...
- **competitive_miner_usd_day: 21.80339548439635** (uid 183) <- the only figure quotable as achievable
- median_miner_usd_day: 12.328088100990463
- top_miner_usd_day: 12345.20478529597 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.2399 USD/day  |  payback on registration: 5.49 days

## Score

- gate: **OK** 
- score: 68.1 (rank 12), confidence 1.0 
- components: income 9.89 / freshness 35.0 / resource 15.0 / registration 8.17
