...
- **competitive_miner_usd_day: 912.7505954351143** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 336.62114678791653
- top_miner_usd_day: 912.7505954351143 (uid 4, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 328.402 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 37.5 (rank 54), confidence 0.85 - hardware requirement unknown
- components: income 22.9 / freshness 0.0 / resource 11.25 / registration 10.0
