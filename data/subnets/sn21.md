...
- **competitive_miner_usd_day: 745.1931298583922** (uid 154) <- the only figure quotable as achievable
- median_miner_usd_day: 6.988408122660553
- top_miner_usd_day: 745.1931298583922 (uid 154, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.6829 USD/day  |  payback on registration: 5.4 days

## Score

- gate: **OK** 
- score: 64.3 (rank 15), confidence 1.0 
- components: income 6.1 / freshness 35.0 / resource 15.0 / registration 8.2
