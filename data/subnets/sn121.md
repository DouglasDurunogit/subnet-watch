...
- **competitive_miner_usd_day: 1031.9126983685362** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 1386.2202110299206
- top_miner_usd_day: 1740.527723691305 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1023.6935 USD/day  |  payback on registration: 0.0 days
