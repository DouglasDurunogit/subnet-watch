...
- **competitive_miner_usd_day: 1044.0780996492663** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 754.791723842662
- top_miner_usd_day: 1044.0780996492663 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 317.5314 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 27.9 (rank 56), confidence 0.85 - hardware from README keywords, not curated
- components: income 22.77 / freshness 0.0 / resource 0.0 / registration 10.0
