...
- miner_burn: **0.0**
- registration cost: 0.287585664 TAO (56.73777565056 USD), open=True
...
- **competitive_miner_usd_day: 21.903570323239204** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 13.741390815994409
- top_miner_usd_day: 12755.110239081005 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 64  |  gini: 0.9439238045984029  |  top1_share: 0.9423825590449  |  top10_share: 0.95651974779011
...
- net margin: 12.6518 USD/day  |  payback on registration: 4.48 days

## Score

- gate: **OK** 
- score: 68.8 (rank 10), confidence 1.0 
- components: income 10.32 / freshness 35.0 / resource 15.0 / registration 8.51
