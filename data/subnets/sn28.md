...
- subnet age: 560.3 days  |  registered at block 4878363
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1822.2544719102077** (uid 33) <- the only figure quotable as achievable
- median_miner_usd_day: 24.817776119114527
- top_miner_usd_day: 2698.655342026998 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 14.9317 USD/day  |  payback on registration: 1.58 days

## Score

- gate: **OK** 
- score: 56.7 (rank 22), confidence 0.85 - hardware requirement unknown
- components: income 10.93 / freshness 35.0 / resource 11.25 / registration 9.47
