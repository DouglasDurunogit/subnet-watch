...
- **competitive_miner_usd_day: 701.8772896166199** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 2.6767316956231766
- top_miner_usd_day: 906.6090253075698 (uid 84, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.5424 USD/day  |  payback on registration: [UNKNOWN] days
