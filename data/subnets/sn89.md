...
- subnet age: 500.1 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 112.09497237596882** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 3.497443945499365
- top_miner_usd_day: 112.09497237596882 (uid 218, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 72  |  gini: 0.6899532321797892  |  top1_share: 0.06778237566614241  |  top10_share: 0.5444883873627632
...
- latest release: (none) 
- last commit: 2026-08-23T15:48:41Z
- scoring-related commit: Scoring: build the qualified-win as-of window from RESOLVED outcomes 2026-08-21T18:27:38Z
...
- net margin: -4.7217 USD/day  |  payback on registration: [UNKNOWN] days
