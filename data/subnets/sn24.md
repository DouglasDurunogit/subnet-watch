...
- **competitive_miner_usd_day: [UNKNOWN]** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 0.0 (rank 93), confidence 0.85 - hardware from README keywords, not curated
