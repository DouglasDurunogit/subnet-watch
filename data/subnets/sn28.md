...
- subnet age: 544.3 days  |  registered at block 4878363
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3805.8349471575534** (uid 242) <- the only figure quotable as achievable
- median_miner_usd_day: 76.60280587526506
- top_miner_usd_day: 3805.8349471575534 (uid 242, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 68.3836 USD/day  |  payback on registration: 0.29 days

## Score

- gate: **OK** 
- score: 62.0 (rank 16), confidence 0.85 - hardware requirement unknown
- components: income 16.75 / freshness 35.0 / resource 11.25 / registration 9.9
