...
- **competitive_miner_usd_day: 9.779427996318736** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 8.605896636760491
- top_miner_usd_day: 2442.2752300886564 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.2889 USD/day  |  payback on registration: 345.1 days

## Score

- gate: **OK** 
- score: 40.2 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 1.0 / freshness 35.0 / resource 11.25 / registration 0.0
