...
- **competitive_miner_usd_day: 24.723610999400172** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.510742915359122
- top_miner_usd_day: 2372.970197890219 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.2762 USD/day  |  payback on registration: 1.98 days

## Score

- gate: **OK** 
- score: 55.2 (rank 24), confidence 1.0 
- components: income 9.91 / freshness 21.0 / resource 15.0 / registration 9.34
