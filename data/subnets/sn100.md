...
- subnet age: 323.9 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3895.760689417223
- top_miner_usd_day: 3895.760689417223 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-08T22:31:19Z
- scoring-related commit: fix(eval): install host cc for triton jit on scoring image (#239) 2026-09-08T09:44:43Z
