...
- subnet age: 733.8 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.09939442605296** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 355.30111080214124
- top_miner_usd_day: 1630.3561700552739 (uid 22, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.5014089593538114  |  top1_share: 0.46497184624540305  |  top10_share: 1.0
...
- net margin: 26.8802 USD/day  |  payback on registration: 0.01 days
...
- components: income 13.15 / freshness 0.0 / resource 11.25 / registration 10.0
