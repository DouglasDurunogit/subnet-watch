...
- subnet age: 335.0 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3017.1319006774797
- top_miner_usd_day: 3017.1319006774797 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 3117 bytes, sha aa392e6f5a620d68
- latest release: ctx CLI v3.3.31 2026-09-10T00:55:44Z
- last commit: 2026-09-19T06:33:26Z
- scoring-related commit: feat(bounty): python subnet with production bounty validator 2026-09-19T01:21:57Z
