...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (2.1587 USD), open=True
...
- **competitive_miner_usd_day: 621.0012167345631** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 4.949460404791879
- top_miner_usd_day: 621.0012167345631 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.2697 USD/day  |  payback on registration: [UNKNOWN] days
