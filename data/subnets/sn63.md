...
- **competitive_miner_usd_day: 0.07006250696915493** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07006250696915493
- top_miner_usd_day: 4591.266144195692 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- required: multi-GPU (~85 GB VRAM)  |  basis: **README stated VRAM (explicit)**
