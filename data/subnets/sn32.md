...
- miner_burn: **0.0**
- registration cost: 0.013141223 TAO (2.8551935212100004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 238  |  free: 0
- subnet age: 897.9 days  |  registered at block 2515294
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 10.840394945030798** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 9.095963574566074
- top_miner_usd_day: 11.08959942652576 (uid 157, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 233  |  gini: 0.10578486808579379  |  top1_share: 0.005501723152054647  |  top10_share: 0.05374998068215186
...
- net margin: 0.721 USD/day  |  payback on registration: 3.96 days

## Score

- gate: **OK** 
- score: 18.8 (rank 77), confidence 0.85 - hardware requirement unknown
- components: income 2.14 / freshness 0.0 / resource 11.25 / registration 8.68
