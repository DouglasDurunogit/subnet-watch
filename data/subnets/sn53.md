...
- miner_burn: **0.0**
- registration cost: 0.000582154 TAO (0.11612807991999999 USD), open=True
...
- **competitive_miner_usd_day: 574.2827093955159** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 92.81336717503287
- top_miner_usd_day: 1994.9349337443082 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 83.213 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.8 (rank 24), confidence 0.85 - hardware from README keywords, not curated
