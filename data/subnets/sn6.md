...
- miner_burn: **0.0**
- registration cost: 0.2 TAO (40.552 USD), open=True
...
- **competitive_miner_usd_day: 515.9576799549461** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 14.848876937349809
- top_miner_usd_day: 515.9576799549461 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.7288 USD/day  |  payback on registration: 4.17 days

## Score

- gate: **OK** 
- score: 68.0 (rank 11), confidence 1.0 
- components: income 9.37 / freshness 35.0 / resource 15.0 / registration 8.61
- freshness basis: WEIGHTS_VERSION_BUMP 0.3d ago
