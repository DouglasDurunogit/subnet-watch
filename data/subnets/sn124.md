...
- miner_burn: **0.0**
- registration cost: 0.576601262 TAO (132.61829025999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 37  |  free: 0
- subnet age: 432.2 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 847.962684071222** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 287.5914197796139
- top_miner_usd_day: 847.962684071222 (uid 144, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 25  |  gini: 0.30497970147431386  |  top1_share: 0.10485027929550379  |  top10_share: 0.6276059949329995
...
- status: **ok** 
- README: 13819 bytes, sha 1cd2e1294efd740c
- latest release: (none) 
- last commit: 2026-08-25T13:38:38Z
- scoring-related commit: Rename the office challenge family to cf_interceptor_office 2026-08-24T16:42:42Z
...
- net margin: 279.3722 USD/day  |  payback on registration: 0.47 days

## Score

- gate: **OK** 
- score: 66.6 (rank 13), confidence 0.85 - hardware requirement unknown
- components: income 22.26 / freshness 35.0 / resource 11.25 / registration 9.84
...
The drone sees the world through a single depth camera and knows its own position and speed. Fifty times a second, your model looks at that and decides where to fly next: a direction, a speed, a turn. No map, no GPS, no list of obstacles. Just like a real pilot, it has to read what is
```

_(truncated at 6000 of 13819 chars - read the full file at https://github.com/swarm-subnet/swarm)_
