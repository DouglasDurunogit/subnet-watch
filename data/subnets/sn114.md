...
- miner_burn: **0.0**
- registration cost: 0.108611039 TAO (21.85797159875 USD), open=True
...
- **competitive_miner_usd_day: 1629.2613803931806** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 1629.2613803931806
- top_miner_usd_day: 4236.19892697359 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1132.2538 USD/day  |  payback on registration: 0.02 days
...
- components: income 27.78 / freshness 35.0 / resource 11.25 / registration 9.99
