...
- subnet age: 620.5 days  |  registered at block 4531295
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6736.528886289352** (uid 177) <- the only figure quotable as achievable
- median_miner_usd_day: 2873.7357664448155
- top_miner_usd_day: 6736.528886289352 (uid 177, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 17  |  gini: 0.36049991830813455  |  top1_share: 0.13533559197875653  |  top10_share: 0.8412843756676739
...
- net margin: 2703.2326 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 38.2 (rank 58), confidence 0.85 - hardware from README keywords, not curated
