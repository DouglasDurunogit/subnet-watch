...
- miner_burn: **0.0**
- registration cost: 0.614426611 TAO (121.15878342308999 USD), open=True
...
- **competitive_miner_usd_day: 24.425395673842566** (uid 92) <- the only figure quotable as achievable
- median_miner_usd_day: 9.052394449296916
- top_miner_usd_day: 2825.6326153213668 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.6725 USD/day  |  payback on registration: 180.16 days

## Score

- gate: **OK** 
- score: 11.3 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 2.03 / freshness 0.0 / resource 11.25 / registration 0.0
