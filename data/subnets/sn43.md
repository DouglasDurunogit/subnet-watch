...
- registration cost: 0.1 TAO (18.781000000000002 USD), open=True
...
- **competitive_miner_usd_day: 68.06899587103649** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 2.819156809622086
- top_miner_usd_day: 2285.1084752831925 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.6506 USD/day  |  payback on registration: 28.87 days

## Score

- gate: **OK** 
- score: 17.4 (rank 59), confidence 1.0 
- components: income 1.98 / freshness 0.0 / resource 15.0 / registration 0.38
