...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (14.631 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 327.2 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 56.98654816125161** (uid 220) <- the only figure quotable as achievable
- median_miner_usd_day: 2850.806448243865
- top_miner_usd_day: 5644.626348326478 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 48.7674 USD/day  |  payback on registration: 0.3 days
...
- components: income 15.43 / freshness 35.0 / resource 11.25 / registration 9.9
