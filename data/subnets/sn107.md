...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (186.3873 USD), open=True
...
- **competitive_miner_usd_day: 25765.968813790634** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 91.76944401640804
- top_miner_usd_day: 25765.968813790634 (uid 17, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 90.7831 USD/day  |  payback on registration: 2.05 days

## Score

- gate: **OK** 
- score: 42.2 (rank 8), confidence 1.0 
- components: income 17.85 / freshness 0.0 / resource 15.0 / registration 9.32
