...
- registration cost: 0.1 TAO (19.556 USD), open=True
...
- **competitive_miner_usd_day: 17.27671269416344** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9700827983353804
- top_miner_usd_day: 2430.7965205336213 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7784 USD/day  |  payback on registration: [UNKNOWN] days
