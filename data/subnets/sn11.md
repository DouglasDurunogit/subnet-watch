...
- miner_burn: **0.0**
- registration cost: 0.023287144 TAO (7.20411086784 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 865.5 days  |  registered at block 2918568
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7250.585530834014** (uid 232) <- the only figure quotable as achievable
- median_miner_usd_day: 7250.585530834014
- top_miner_usd_day: 7250.585530834014 (uid 232, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 7242.3664 USD/day  |  payback on registration: 0.0 days
...
- components: income 35.11 / freshness 35.0 / resource 11.25 / registration 10.0
