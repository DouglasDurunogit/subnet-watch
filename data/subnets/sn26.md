...
- subnet age: 118.6 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1742.2904181962556** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 24.440072461727567
- top_miner_usd_day: 1742.2904181962556 (uid 126, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 21.4812 USD/day  |  payback on registration: 1.03 days

## Score

- gate: **OK** 
- score: 54.2 (rank 26), confidence 1.0 
- components: income 12.29 / freshness 21.0 / resource 11.25 / registration 9.66
