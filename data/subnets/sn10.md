...
- subnet age: 820.5 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3856.3560048477866
- top_miner_usd_day: 3856.3560048477866 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 2849 bytes, sha 57d1cd8fc6bebdca
- latest release: (none) 
- last commit: 2026-08-04T21:16:12Z
- scoring-related commit: feat: build miner images from baseline engine image, add --no-bench s… 2026-08-04T21:16:12Z
