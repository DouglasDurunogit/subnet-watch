...
- subnet age: 420.9 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 719.6486721830065** (uid 206) <- the only figure quotable as achievable
- median_miner_usd_day: 228.4747046716382
- top_miner_usd_day: 719.6486721830065 (uid 206, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 220.2555 USD/day  |  payback on registration: 0.45 days
