...
- miner_burn: **0.9505211480427533**
- registration cost: 0.999999999 TAO (284.54999971545004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 4  |  free: 233
- subnet age: 32.2 days  |  registered at block 8884359
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 871.146390047728** (uid 12) <- the only figure quotable as achievable
- median_miner_usd_day: 8804.705047098674
- top_miner_usd_day: 16738.26370414962 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 15435 bytes, sha 967fd2e1be08749a
- latest release: (none) 
- last commit: 2026-09-21T13:19:02Z
...
- net margin: 856.3519 USD/day  |  payback on registration: 0.33 days
...
- components: income 26.68 / freshness 21.0 / resource 7.5 / registration 9.89
...
_(truncated at 6000 of 15435 chars - read the full file at https://github.com/EpagoFoundation/epago)_
