...
- miner_burn: **0.0**
- registration cost: 0.155951648 TAO (30.695962875840003 USD), open=True
...
- **competitive_miner_usd_day: 35.41079159625511** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 32.12767184560894
- top_miner_usd_day: 35.41079159625511 (uid 13, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 23.9085 USD/day  |  payback on registration: 1.28 days

## Score

- gate: **OK** 
- score: 28.5 (rank 57), confidence 0.85 - hardware requirement unknown
- components: income 12.7 / freshness 0.0 / resource 11.25 / registration 9.57
