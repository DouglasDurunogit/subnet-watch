...
- miner_burn: **0.0**
- registration cost: 0.241480771 TAO (50.01791209723 USD), open=True
...
- **competitive_miner_usd_day: 20.41855776286465** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 11.15458248156495
- top_miner_usd_day: 11605.303238108181 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.1683 USD/day  |  payback on registration: 4.92 days

## Score

- gate: **OK** 
- score: 67.9 (rank 12), confidence 1.0 
- components: income 9.53 / freshness 35.0 / resource 15.0 / registration 8.36
