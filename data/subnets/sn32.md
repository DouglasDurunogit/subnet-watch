...
- miner_burn: **0.0**
- registration cost: 0.014245794 TAO (2.81938509054 USD), open=True
...
- **competitive_miner_usd_day: 11.450804594179537** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 8.268446989841799
- top_miner_usd_day: 11.450804594179537 (uid 254, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 239  |  gini: 0.16760529749000752  |  top1_share: 0.006170854579141592  |  top10_share: 0.06007013030762399
...
- net margin: -0.0644 USD/day  |  payback on registration: [UNKNOWN] days
