...
- registration cost: 0.1 TAO (19.542 USD), open=True
...
- **competitive_miner_usd_day: 17.248242274622957** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.968484191890594
- top_miner_usd_day: 2426.9291482881245 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7788 USD/day  |  payback on registration: [UNKNOWN] days
