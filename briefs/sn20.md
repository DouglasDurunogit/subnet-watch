# sn20 — ChronoSeek · challenge brief
...
**sn20 "ChronoSeek"** (υ), 937.2 days old. Snapshot 2026-07-28T06:37:33Z b8718699.

- on-chain repo: `https://github.com/chronoseek/bittensor-subnet`
- resolved: `https://github.com/chronoseek/bittensor-subnet` — **ok**

On-chain description: _Decentralized Video Moment Retrieval subnet on Bittensor. Search videos by meaning, not timestamps._ [VERIFIED: pack sn20, 2026-07-28]

## ¶2 — INPUT (what the validator hands you)

From README §2. Architecture Overview [VERIFIED: README §2. Architecture Overview]:
...
- cheapest satisfying machine: **RTX 4090 (24 GB)** — $250.0/mo, 24 GB VRAM, 8 vCPU, 32 GB RAM, 1000 Mbps [margin:20.rtx4090]
...
**Miners earn nothing here.** `miner_burn` is 1.000 — 100.0% of miner emission is withheld by owner-controlled hotkeys and destroyed. [VERIFIED: pack sn20, 2026-07-28]
...
_Assembled from `data/subnets/sn20.md` and the repo README. Every claim is either quoted with a [VERIFIED] tag or marked [UNKNOWN]. Regenerate when this subnet appears in ALARMS.md under NEW SINCE LAST RUN._
