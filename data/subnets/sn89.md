...
- miner_burn: **0.0**
- registration cost: 0.059808539 TAO (18.28047994535 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 124  |  free: 0
- subnet age: 530.1 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 171.79016580772094** (uid 142) <- the only figure quotable as achievable
- median_miner_usd_day: 1.7778317943713406
- top_miner_usd_day: 171.79016580772094 (uid 142, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 116  |  gini: 0.7402221760972361  |  top1_share: 0.09152713273038375  |  top10_share: 0.47958934245905643
...
- status: **ok** 
- README: 22784 bytes, sha 760274087099fc4c
- latest release: (none) 
- last commit: 2026-09-21T00:00:31Z
...
- net margin: -6.4413 USD/day  |  payback on registration: [UNKNOWN] days
...
_(truncated at 6000 of 22784 chars - read the full file at https://github.com/DeltaCompute24/InfiniteQuant-Subnet)_
