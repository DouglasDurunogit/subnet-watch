...
- **competitive_miner_usd_day: 9.43496019597401** (uid 2) <- the only figure quotable as achievable
- median_miner_usd_day: 5.925155003071678
- top_miner_usd_day: 2356.173739820197 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.294 USD/day  |  payback on registration: [UNKNOWN] days
