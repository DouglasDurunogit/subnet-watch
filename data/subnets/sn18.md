...
- registration cost: 0.999999999 TAO (198.4999998015 USD), open=True
...
- **competitive_miner_usd_day: 1025.1434074183833** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 2.6094418885564847
- top_miner_usd_day: 1025.1434074183833 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.6291 USD/day  |  payback on registration: [UNKNOWN] days
