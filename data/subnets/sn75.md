...
- **competitive_miner_usd_day: 5.5059360525466206** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 3.6706240350310795
- top_miner_usd_day: 10386.364400214534 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.632 USD/day  |  payback on registration: [UNKNOWN] days
