...
- subnet age: 522.3 days  |  registered at block 5128460
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 833.6303920997336** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 248.42044670127385
- top_miner_usd_day: 833.6303920997336 (uid 4, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 240.2013 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 36.5 (rank 56), confidence 0.85 - hardware requirement unknown
- components: income 21.67 / freshness 0.0 / resource 11.25 / registration 10.0
