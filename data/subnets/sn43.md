...
- registration cost: 0.1 TAO (24.248 USD), open=True
...
- **competitive_miner_usd_day: 192.34227689488327** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 4.295751577775171
- top_miner_usd_day: 2871.4951421638134 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.081 USD/day  |  payback on registration: 22.43 days

## Score

- gate: **OK** 
- score: 20.4 (rank 71), confidence 1.0 
- components: income 2.89 / freshness 0.0 / resource 15.0 / registration 2.52
