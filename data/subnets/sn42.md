...
- subnet age: 724.3 days  |  registered at block 3613591
- weights_version: 283  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1653.737671712978
- top_miner_usd_day: 1653.737671712978 (uid 11, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
