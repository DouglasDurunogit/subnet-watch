...
- subnet age: 865.5 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 952.2653757234447** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 688.4178728961278
- top_miner_usd_day: 952.2653757234447 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 251.1576 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 27.1 (rank 59), confidence 0.85 - hardware from README keywords, not curated
- components: income 21.84 / freshness 0.0 / resource 0.0 / registration 10.0
