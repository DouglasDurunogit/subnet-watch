...
- **competitive_miner_usd_day: 621.7718126908931** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 451.2904141446946
- top_miner_usd_day: 621.7718126908931 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.2735301298582393  |  top1_share: 0.38075473425602363  |  top10_share: 1.0
...
- net margin: 14.0301 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 17.6 (rank 62), confidence 0.85 - hardware from README keywords, not curated
- components: income 10.7 / freshness 0.0 / resource 0.0 / registration 10.0
