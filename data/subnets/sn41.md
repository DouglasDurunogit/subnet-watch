...
- **competitive_miner_usd_day: 24.81171900576492** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.630061783055035
- top_miner_usd_day: 2377.5406244078354 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.4196 USD/day  |  payback on registration: 1.96 days

## Score

- gate: **OK** 
- score: 55.3 (rank 23), confidence 1.0 
- components: income 9.95 / freshness 21.0 / resource 15.0 / registration 9.35
