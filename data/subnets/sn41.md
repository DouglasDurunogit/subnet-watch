...
- registration cost: 0.105545685 TAO (23.680229886600003 USD), open=True
...
- **competitive_miner_usd_day: 24.881489682501925** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 10.488273819887631
- top_miner_usd_day: 2440.188269827986 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.4269 USD/day  |  payback on registration: 2.51 days

## Score

- gate: **OK** 
- score: 54.4 (rank 26), confidence 1.0 
- components: income 9.26 / freshness 21.0 / resource 15.0 / registration 9.16
