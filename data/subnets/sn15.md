...
- miner_burn: **0.0**
- registration cost: 0.341582799 TAO (67.52408770632 USD), open=True
...
- **competitive_miner_usd_day: 21.9706519950312** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 11.568617643401385
- top_miner_usd_day: 11803.10088504747 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.4851 USD/day  |  payback on registration: 6.44 days

## Score

- gate: **OK** 
- score: 67.5 (rank 11), confidence 1.0 
- components: income 9.64 / freshness 35.0 / resource 15.0 / registration 7.85
