...
- registration cost: 0.8 TAO (169.824 USD), open=True
...
- **competitive_miner_usd_day: 45.84594005721414** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.270247778247306
- top_miner_usd_day: 45.84594005721414 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.0511 USD/day  |  payback on registration: 55.66 days

## Score

- gate: **OK** 
- score: 32.1 (rank 58), confidence 0.85 - hardware requirement unknown
- components: income 5.53 / freshness 21.0 / resource 11.25 / registration 0.0
