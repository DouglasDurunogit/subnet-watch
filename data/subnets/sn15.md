...
- miner_burn: **0.0**
- registration cost: 0.464230827 TAO (117.66394541142 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 91  |  free: 0
- subnet age: 231.7 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 48.186198339327326** (uid 35) <- the only figure quotable as achievable
- median_miner_usd_day: 26.406036689951378
- top_miner_usd_day: 23248.105995585218 (uid 104, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 78  |  gini: 0.932860602003285  |  top1_share: 0.9208031147415834  |  top10_share: 0.9373845331704712
...
- latest release: shoppingbench-final 2026-09-10T05:53:33Z
- last commit: 2026-09-10T05:32:47Z
- scoring-related commit: compose: forward SUBTENSOR_CHAIN_ENDPOINT to the validator (#274) 2026-09-08T20:21:13Z
...
- net margin: 25.227 USD/day  |  payback on registration: 4.66 days

## Score

- gate: **OK** 
- score: 71.4 (rank 6), confidence 1.0 
- components: income 12.9 / freshness 35.0 / resource 15.0 / registration 8.45
