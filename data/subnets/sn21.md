...
- miner_burn: **0.15056314319372177**
- registration cost: 0.1 TAO (23.454 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 812.6 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 109.85194325002682** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 10.291589905164628
- top_miner_usd_day: 1098.444448238664 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.7008 USD/day  |  payback on registration: 33.47 days

## Score

- gate: **OK** 
- score: 52.1 (rank 29), confidence 1.0 
- components: income 2.1 / freshness 35.0 / resource 15.0 / registration 0.0
