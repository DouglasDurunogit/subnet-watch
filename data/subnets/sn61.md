...
- **competitive_miner_usd_day: 207.9190981060253** (uid 95) <- the only figure quotable as achievable
- median_miner_usd_day: 79.88334503103385
- top_miner_usd_day: 207.9190981060253 (uid 95, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 71.6642 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 62.2 (rank 15), confidence 0.85 - hardware requirement unknown
- components: income 16.93 / freshness 35.0 / resource 11.25 / registration 10.0
