...
- registration cost: 0.8 TAO (165.208 USD), open=True
...
- **competitive_miner_usd_day: 47.11787644685536** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 14.509474828591728
- top_miner_usd_day: 47.11787644685536 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6.2903 USD/day  |  payback on registration: 26.26 days

## Score

- gate: **OK** 
- score: 35.1 (rank 55), confidence 0.85 - hardware requirement unknown
- components: income 7.85 / freshness 21.0 / resource 11.25 / registration 1.25
