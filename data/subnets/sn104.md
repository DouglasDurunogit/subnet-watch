...
- registration cost: 0.5 TAO (98.25 USD), open=True
...
- **competitive_miner_usd_day: 9.561269813999706** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 8.520325116507802
- top_miner_usd_day: 2407.049675674426 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1084 USD/day  |  payback on registration: 906.37 days

## Score

- gate: **OK** 
- score: 39.7 (rank 37), confidence 0.85 - hardware requirement unknown
- components: income 0.41 / freshness 35.0 / resource 11.25 / registration 0.0
