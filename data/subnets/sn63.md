...
- subnet age: 559.0 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.08916879766922205** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 0.08916879766922205
- top_miner_usd_day: 5842.963804871114 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.13 USD/day  |  payback on registration: [UNKNOWN] days
