...
- miner_burn: **0.45059937611222267**
- registration cost: 0.1 TAO (19.365000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 782.8 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 22.61185177724091** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.652962944310228
- top_miner_usd_day: 864.9326204429071 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-07T00:21:30Z
- scoring-related commit: feat(scoring): wire one-payer into the daily allocation, from the rec… 2026-08-06T15:51:01Z
...
- net margin: 4.6667 USD/day  |  payback on registration: 4.15 days

## Score

- gate: **OK** 
- score: 65.5 (rank 15), confidence 1.0 
- components: income 6.85 / freshness 35.0 / resource 15.0 / registration 8.62
