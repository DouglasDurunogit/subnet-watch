...
- miner_burn: **0.0**
- registration cost: 0.557672752 TAO (104.42979953951999 USD), open=True
...
- **competitive_miner_usd_day: 5.4562345493971804** (uid 84) <- the only figure quotable as achievable
- median_miner_usd_day: 5.2789561705359
- top_miner_usd_day: 5.4562345493971804 (uid 84, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.7629 USD/day  |  payback on registration: [UNKNOWN] days
