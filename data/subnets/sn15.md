...
- miner_burn: **0.0**
- registration cost: 0.276710248 TAO (54.235208608 USD), open=True
...
- **competitive_miner_usd_day: 21.905593268765646** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.756671616722846
- top_miner_usd_day: 12392.536727753804 (uid 13, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.7704 USD/day  |  payback on registration: 5.04 days

## Score

- gate: **OK** 
- score: 68.1 (rank 8), confidence 1.0 
- components: income 9.74 / freshness 35.0 / resource 15.0 / registration 8.32
