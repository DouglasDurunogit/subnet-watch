...
- miner_burn: **0.15056632086634636**
- registration cost: 0.1 TAO (23.021 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 30  |  free: 0
- subnet age: 801.8 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1164.2667949689417** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 10.908295283602103
- top_miner_usd_day: 1164.2667949689417 (uid 39, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6.2859 USD/day  |  payback on registration: 3.66 days

## Score

- gate: **OK** 
- score: 66.6 (rank 14), confidence 1.0 
- components: income 7.84 / freshness 35.0 / resource 15.0 / registration 8.78
