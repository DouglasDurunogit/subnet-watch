...
- **competitive_miner_usd_day: 106.25533016428457** (uid 147) <- the only figure quotable as achievable
- median_miner_usd_day: 2.6147844112016343
- top_miner_usd_day: 1013.793515065779 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.7232 USD/day  |  payback on registration: [UNKNOWN] days
