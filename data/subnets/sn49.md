...
- subnet age: 304.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 55.193225810578056** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 2761.093786465972
- top_miner_usd_day: 5466.994347121365 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 46.974 USD/day  |  payback on registration: 0.23 days
