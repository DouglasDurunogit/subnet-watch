...
- registration cost: 0.8 TAO (152.544 USD), open=True
...
- **competitive_miner_usd_day: 43.43272956913834** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 9.89151191015573
- top_miner_usd_day: 43.43272956913834 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.6723 USD/day  |  payback on registration: 91.22 days

## Score

- gate: **OK** 
- score: 30.7 (rank 57), confidence 0.85 - hardware requirement unknown
- components: income 3.88 / freshness 21.0 / resource 11.25 / registration 0.0
