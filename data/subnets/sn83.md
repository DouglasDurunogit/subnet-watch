...
- miner_burn: **0.0**
- registration cost: 0.176063286 TAO (35.93979857118 USD), open=True
...
- **competitive_miner_usd_day: 75.7478755326713** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 20.517075401018804
- top_miner_usd_day: 132.24276087860457 (uid 153, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.1587 USD/day  |  payback on registration: 3.54 days

## Score

- gate: **OK** 
- score: 25.2 (rank 69), confidence 0.85 - hardware requirement unknown
- components: income 9.53 / freshness 0.0 / resource 11.25 / registration 8.82
