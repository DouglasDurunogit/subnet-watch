...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (177.2596 USD), open=True
...
- **competitive_miner_usd_day: 3653.437374444292** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 623.4819974829911
- top_miner_usd_day: 3653.437374444292 (uid 130, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 622.4957 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 72.5 (rank 4), confidence 0.85 - hardware from README keywords, not curated
- components: income 25.42 / freshness 35.0 / resource 15.0 / registration 9.91
