...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (116.345 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 73  |  free: 0
- subnet age: 709.0 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1690.2352145640878** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 41.08542353095295
- top_miner_usd_day: 51867.003045447665 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 63  |  gini: 0.9288381398313452  |  top1_share: 0.8288266279868692  |  top10_share: 0.9315214901900908
...
- last commit: 2026-09-14T14:51:23Z
- scoring-related commit: DAH-3457 - [P1] validator: a UUID listed twice in the scrape is one c… 2026-09-14T14:51:23Z
...
- net margin: 32.3885 USD/day  |  payback on registration: 3.59 days

## Score

- gate: **OK** 
- score: 58.6 (rank 20), confidence 0.85 - hardware requirement unknown
- components: income 13.86 / freshness 35.0 / resource 11.25 / registration 8.8
