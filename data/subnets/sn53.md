...
- subnet age: 638.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1946.37758595093** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 86.81380590891558
- top_miner_usd_day: 1946.37758595093 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 77.3889 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.6 (rank 26), confidence 0.85 - hardware from README keywords, not curated
