...
- registration cost: 0.1 TAO (24.417 USD), open=True
...
- **competitive_miner_usd_day: 202.91524659667203** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0275558862837868
- top_miner_usd_day: 2864.0686645166734 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4725 USD/day  |  payback on registration: [UNKNOWN] days
