...
- miner_burn: **0.45058464305475354**
- registration cost: 0.114435489 TAO (21.959025984209998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 781.9 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 23.595007426287754** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.898751856571939
- top_miner_usd_day: 902.509034055507 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 142  |  gini: 0.7081487365944577  |  top1_share: 0.45111369122185224  |  top10_share: 0.5572580891564057
...
- last commit: 2026-08-05T20:21:36Z
- scoring-related commit: Merge pull request #6 from ippcteam/docs/daily-miner-validator-docs 2026-08-05T20:21:36Z
...
- net margin: 4.9125 USD/day  |  payback on registration: 4.47 days

## Score

- gate: **OK** 
- score: 65.5 (rank 16), confidence 1.0 
- components: income 7.02 / freshness 35.0 / resource 15.0 / registration 8.51
