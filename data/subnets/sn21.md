...
- miner_burn: **0.15083608124405146**
...
- **competitive_miner_usd_day: 1160.775377490829** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 10.852261767407594
- top_miner_usd_day: 1160.775377490829 (uid 39, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7825572300648604  |  top1_share: 0.44645555131629144  |  top10_share: 0.9986875238458603
- owner_incentive_share: 0.1508584509729111 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 6.2353 USD/day  |  payback on registration: 3.72 days

## Score

- gate: **OK** 
- score: 66.6 (rank 14), confidence 1.0 
- components: income 7.82 / freshness 35.0 / resource 15.0 / registration 8.76
