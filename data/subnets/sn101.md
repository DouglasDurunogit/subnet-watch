...
- registration cost: 0.002950219 TAO (0.66548089983 USD), open=True
...
- **competitive_miner_usd_day: 2.2454083897330466** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0291455119609796
- top_miner_usd_day: 2761.1506292498557 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 249  |  gini: 0.9216874530578629  |  top1_share: 0.9023711608139304  |  top10_share: 0.9089755545703322
- owner_incentive_share: 0.9023711608139304 (independent check on miner_burn; disagreement 0.0017)
...
- net margin: 0.0428 USD/day  |  payback on registration: 15.55 days

## Score

- gate: **OK** 
- score: 41.0 (rank 39), confidence 1.0 
- components: income 0.17 / freshness 21.0 / resource 15.0 / registration 4.82
