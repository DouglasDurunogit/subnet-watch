...
- subnet age: 1017.4 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1117.1173704258288** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 3.9184328526398584
- top_miner_usd_day: 1117.1173704258288 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.3222 USD/day  |  payback on registration: [UNKNOWN] days
