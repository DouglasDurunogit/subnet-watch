...
- subnet age: 498.3 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 118.0068770244507** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 5.230122237290565
- top_miner_usd_day: 118.0068770244507 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.9891 USD/day  |  payback on registration: [UNKNOWN] days
