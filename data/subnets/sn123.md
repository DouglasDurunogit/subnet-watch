...
- **competitive_miner_usd_day: 109.25850188480632** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 2.563550020760355
- top_miner_usd_day: 588.3603652647091 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.7069 USD/day  |  payback on registration: [UNKNOWN] days
