...
- **competitive_miner_usd_day: 35.4875172441625** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.687202389495232
- top_miner_usd_day: 873.8025478304523 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.7009 USD/day  |  payback on registration: 2.64 days

## Score

- gate: **OK** 
- score: 67.7 (rank 13), confidence 1.0 
- components: income 8.55 / freshness 35.0 / resource 15.0 / registration 9.12
