...
- **competitive_miner_usd_day: 240.70242102178966** (uid 2) <- the only figure quotable as achievable
- median_miner_usd_day: 240.70242102178966
- top_miner_usd_day: 1820.113835438806 (uid 14, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 187.2545 USD/day  |  payback on registration: 0.0 days
...
- components: income 20.69 / freshness 21.0 / resource 11.25 / registration 10.0
