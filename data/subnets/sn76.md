...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (23.36599976634 USD), open=True
...
- **competitive_miner_usd_day: 369.62209196654436** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 110.78261954826611
- top_miner_usd_day: 369.62209196654436 (uid 124, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 163.9648 USD/day  |  payback on registration: 0.14 days

## Score

- gate: **OK** 
- score: 80.1 (rank 1), confidence 1.0 
- components: income 20.17 / freshness 35.0 / resource 15.0 / registration 9.95
