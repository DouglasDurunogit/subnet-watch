...
- **competitive_miner_usd_day: 0.07014564123940771** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07014564123940771
- top_miner_usd_day: 4596.714016059626 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- required: multi-GPU (~96 GB VRAM)  |  basis: **README stated VRAM (explicit)**
- cheapest satisfying machine: h200-141 at 78.9041 USD/day
- net margin: -78.834 USD/day  |  payback on registration: [UNKNOWN] days

## Score

- gate: **OK** 
- score: 0.0 (rank 89), confidence 1.0 
