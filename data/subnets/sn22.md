...
- registration cost: 0.000671328 TAO (0.13209049728 USD), open=True
...
- **competitive_miner_usd_day: 53.164669894037104** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 5.5084505195766225
- top_miner_usd_day: 1004.0738628043284 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.9913 USD/day  |  payback on registration: [UNKNOWN] days
