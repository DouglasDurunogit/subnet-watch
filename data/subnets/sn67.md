...
- registration cost: 0.066395666 TAO (16.09962109168 USD), open=True
...
- **competitive_miner_usd_day: 465.7975815110762** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 21.287609699472952
- top_miner_usd_day: 465.7975815110762 (uid 171, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 20.3013 USD/day  |  payback on registration: 0.79 days

## Score

- gate: **OK** 
- score: 71.8 (rank 6), confidence 1.0 
- components: income 12.08 / freshness 35.0 / resource 15.0 / registration 9.74
