...
- **competitive_miner_usd_day: 596.9184371737695** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 96.47166661394256
- top_miner_usd_day: 2073.566596088967 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 86.8169 USD/day  |  payback on registration: 0.0 days
