...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9545 USD), open=True
...
- **competitive_miner_usd_day: 872.5189765846304** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 3.103724304868492
- top_miner_usd_day: 872.5189765846304 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.1155 USD/day  |  payback on registration: [UNKNOWN] days
