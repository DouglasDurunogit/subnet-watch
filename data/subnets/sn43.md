...
- registration cost: 0.1 TAO (19.657 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 23  |  free: 0
- subnet age: 748.7 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.281775732926308** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.047012030522693
- top_miner_usd_day: 2490.7375918366934 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.5847 USD/day  |  payback on registration: 33.62 days

## Score

- gate: **OK** 
- score: 16.8 (rank 65), confidence 1.0 
- components: income 1.82 / freshness 0.0 / resource 15.0 / registration 0.0
