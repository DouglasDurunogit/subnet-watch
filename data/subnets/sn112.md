...
- miner_burn: **0.8077644656877965**
- registration cost: 0.99 TAO (231.2937 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 13  |  free: 0
- subnet age: 457.7 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 448.27430773228383** (uid 105) <- the only figure quotable as achievable
- median_miner_usd_day: 1165.9473123879777
- top_miner_usd_day: 1883.620317043672 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-26T08:44:42Z
- scoring-related commit: fix(964): optimizeYield can be scored — four defects between plan and… 2026-08-26T08:41:08Z
...
- net margin: 440.0551 USD/day  |  payback on registration: 0.53 days

## Score

- gate: **OK** 
- score: 48.1 (rank 36), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 24.05 / freshness 35.0 / resource 11.25 / registration 9.82
