...
- subnet age: 865.8 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 912.6580359909362** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 659.7846775024456
- top_miner_usd_day: 912.6580359909362 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 222.5244 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 26.7 (rank 62), confidence 0.85 - hardware from README keywords, not curated
