...
- miner_burn: **0.0**
- registration cost: 0.00061088 TAO (0.11917047039999999 USD), open=True
...
- **competitive_miner_usd_day: 42.63610384531875** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 42.63610384531875
- top_miner_usd_day: 4180.486255355581 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.4169 USD/day  |  payback on registration: 0.0 days
...
- components: income 14.09 / freshness 21.0 / resource 11.25 / registration 10.0
