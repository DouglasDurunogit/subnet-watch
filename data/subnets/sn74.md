...
- miner_burn: **0.639464057283476**
- registration cost: 0.15 TAO ([UNKNOWN] USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 21  |  free: 0
- subnet age: 555.2 days  |  registered at block 5086205
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 230) <- the only figure quotable as achievable
...
- earners: 10  |  gini: 0.724968335596893  |  top1_share: 0.6394988631334788  |  top10_share: 1.0
- owner_incentive_share: 0.6394988631334788 (independent check on miner_burn; disagreement 0.0)
...
- gate: **OK** 
- score: 27.4 (rank 53), confidence 0.85 - hardware from README keywords, not curated
