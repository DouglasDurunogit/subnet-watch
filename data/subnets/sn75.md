...
- **competitive_miner_usd_day: 5.827592657388561** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 3.8850617715923734
- top_miner_usd_day: 10993.1354701544 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.4224 USD/day  |  payback on registration: [UNKNOWN] days
