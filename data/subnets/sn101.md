...
- registration cost: 0.022742829 TAO (4.74961240836 USD), open=True
...
- **competitive_miner_usd_day: 2.0715593818684814** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1652521523010206
- top_miner_usd_day: 2548.6654020050664 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1574 USD/day  |  payback on registration: 30.18 days

## Score

- gate: **OK** 
- score: 36.6 (rank 52), confidence 1.0 
- components: income 0.58 / freshness 21.0 / resource 15.0 / registration 0.0
