...
- subnet age: 285.8 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 40.91224086522026** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2046.673887680416
- top_miner_usd_day: 4052.4355344956125 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 32.6931 USD/day  |  payback on registration: 0.31 days
...
- components: income 13.89 / freshness 21.0 / resource 11.25 / registration 9.9
