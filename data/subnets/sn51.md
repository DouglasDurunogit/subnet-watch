...
- subnet age: 686.2 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4360.360622944851** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 90.28663149747148
- top_miner_usd_day: 37514.901517837774 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 53.8529 USD/day  |  payback on registration: 2.09 days

## Score

- gate: **OK** 
- score: 60.7 (rank 16), confidence 0.85 - hardware requirement unknown
- components: income 15.82 / freshness 35.0 / resource 11.25 / registration 9.3
