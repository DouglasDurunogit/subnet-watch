...
- registration cost: 0.8 TAO (154.4 USD), open=True
...
- **competitive_miner_usd_day: 34.88553294579796** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 9.525630552864595
- top_miner_usd_day: 34.88553294579796 (uid 240, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 235  |  gini: 0.47091895014298024  |  top1_share: 0.012764461293873057  |  top10_share: 0.12724715665892133
...
- net margin: 1.3065 USD/day  |  payback on registration: 118.18 days

## Score

- gate: **OK** 
- score: 12.4 (rank 66), confidence 0.85 - hardware requirement unknown
