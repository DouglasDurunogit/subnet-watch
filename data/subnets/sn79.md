...
- miner_burn: **0.0**
- registration cost: 0.169917153 TAO (31.912140504929997 USD), open=True
...
- **competitive_miner_usd_day: 599.7826639615023** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 3.6873234363644887
- top_miner_usd_day: 599.7826639615023 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.701 USD/day  |  payback on registration: 11.81 days

## Score

- gate: **OK** 
- score: 26.2 (rank 42), confidence 1.0 
- components: income 5.17 / freshness 0.0 / resource 15.0 / registration 6.06
