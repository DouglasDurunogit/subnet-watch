...
- subnet age: 429.8 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1498.7751094435314** (uid 127) <- the only figure quotable as achievable
- median_miner_usd_day: 999.173241869671
- top_miner_usd_day: 1498.7751094435314 (uid 127, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.250007629627369  |  top1_share: 0.750007629627369  |  top10_share: 1.0
...
- net margin: 1490.5559 USD/day  |  payback on registration: 0.13 days

## Score

- gate: **OK** 
- score: 30.0 (rank 45), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 28.86 / freshness 0.0 / resource 11.25 / registration 9.96
