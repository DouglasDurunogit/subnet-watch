...
- subnet age: 289.3 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 36.93876118213379** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 1847.896775045768
- top_miner_usd_day: 3658.8547889094016 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 28.7196 USD/day  |  payback on registration: 0.34 days
