...
- **competitive_miner_usd_day: 23.414078639383835** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7669351384769273
- top_miner_usd_day: 2370.145374715431 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8284 USD/day  |  payback on registration: [UNKNOWN] days
