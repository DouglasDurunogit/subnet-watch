...
- miner_burn: **0.0**
- registration cost: 0.224679743 TAO (46.34469058861 USD), open=True
...
- **competitive_miner_usd_day: 20.60372324761472** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 10.396374115768896
- top_miner_usd_day: 11650.743909082392 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 71  |  gini: 0.9462731287801622  |  top1_share: 0.941022000335883  |  top10_share: 0.9553580970701843
...
- net margin: 9.1265 USD/day  |  payback on registration: 5.08 days

## Score

- gate: **OK** 
- score: 67.5 (rank 12), confidence 1.0 
- components: income 9.14 / freshness 35.0 / resource 15.0 / registration 8.31
