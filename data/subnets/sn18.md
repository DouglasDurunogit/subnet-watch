...
- registration cost: 0.999999999 TAO (236.00999976399 USD), open=True
...
- **competitive_miner_usd_day: 1046.915361964533** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.282917112217825
- top_miner_usd_day: 1046.915361964533 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.9587 USD/day  |  payback on registration: [UNKNOWN] days
