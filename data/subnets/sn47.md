...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (11.836500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 13  |  free: 106
- subnet age: 239.0 days  |  registered at block 7340355
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1916.807091502083** (uid 149) <- the only figure quotable as achievable
- median_miner_usd_day: 1916.807091502083
- top_miner_usd_day: 1916.807091502083 (uid 149, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1908.5879 USD/day  |  payback on registration: 0.01 days
...
- components: income 29.84 / freshness 21.0 / resource 11.25 / registration 10.0
