...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (108.605 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 73  |  free: 0
- subnet age: 710.0 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1563.318644664053** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 44.91788781851645
- top_miner_usd_day: 47150.57106596623 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 63  |  gini: 0.9233283676387942  |  top1_share: 0.8173656808708796  |  top10_share: 0.9249125914164008
...
- last commit: 2026-09-16T06:18:33Z
- scoring-related commit: DAH-2662 - [P1] validator matches GPU bans against the kernel's GPU U… 2026-09-16T06:18:33Z
...
- net margin: 35.818 USD/day  |  payback on registration: 3.03 days

## Score

- gate: **OK** 
- score: 59.1 (rank 18), confidence 0.85 - hardware requirement unknown
- components: income 14.24 / freshness 35.0 / resource 11.25 / registration 8.99
