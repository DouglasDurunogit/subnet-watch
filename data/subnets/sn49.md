...
- **competitive_miner_usd_day: 36.07560864145405** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 1804.7167455794283
- top_miner_usd_day: 3573.3578825174027 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.8564 USD/day  |  payback on registration: 0.34 days
...
- components: income 13.28 / freshness 21.0 / resource 11.25 / registration 9.89
