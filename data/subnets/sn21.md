...
- miner_burn: **0.45125930407084525**
...
- **competitive_miner_usd_day: 35.077649888965915** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.58686849904744
- top_miner_usd_day: 863.739667082755 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.6006 USD/day  |  payback on registration: 2.68 days

## Score

- gate: **OK** 
- score: 67.6 (rank 11), confidence 1.0 
- components: income 8.5 / freshness 35.0 / resource 15.0 / registration 9.11
