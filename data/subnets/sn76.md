...
- miner_burn: **0.0**
- registration cost: 0.023090279 TAO (4.35113217476 USD), open=True
...
- **competitive_miner_usd_day: 301.7940466215573** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 241.43023200581834
- top_miner_usd_day: 1036.4957488082277 (uid 71, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 180.0801 USD/day  |  payback on registration: 0.02 days

## Score

- gate: **OK** 
- score: 80.5 (rank 2), confidence 1.0 
- components: income 20.54 / freshness 35.0 / resource 15.0 / registration 9.99
