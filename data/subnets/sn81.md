...
- **competitive_miner_usd_day: 501.564381972449** (uid 132) <- the only figure quotable as achievable
- median_miner_usd_day: 50.068480056604926
- top_miner_usd_day: 501.564381972449 (uid 132, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 41.105 USD/day  |  payback on registration: 0.0 days
