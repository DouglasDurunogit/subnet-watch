...
- registration cost: 0.1 TAO (20.5 USD), open=True
...
- **competitive_miner_usd_day: 31.23529864453213** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 10.386976295284889
- top_miner_usd_day: 2587.8197027799274 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.8977 USD/day  |  payback on registration: 22.84 days

## Score

- gate: **OK** 
- score: 19.9 (rank 66), confidence 1.0 
- components: income 2.53 / freshness 0.0 / resource 15.0 / registration 2.39
