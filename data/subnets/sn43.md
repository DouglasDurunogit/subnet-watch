...
- registration cost: 0.1 TAO (23.521 USD), open=True
...
- **competitive_miner_usd_day: 195.4564793036249** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.961177093116067
- top_miner_usd_day: 2758.7390123886103 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.257 USD/day  |  payback on registration: [UNKNOWN] days
