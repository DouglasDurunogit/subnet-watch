...
- **competitive_miner_usd_day: 12864.352512783043** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 46.79088305638163
- top_miner_usd_day: 12864.352512783043 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 144  |  gini: 0.7663467576328431  |  top1_share: 0.6257064304261494  |  top10_share: 0.7043378646708416
...
- net margin: 38.5717 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.2 (rank 18), confidence 0.85 - hardware from README keywords, not curated
