...
- subnet age: 282.0 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3026.920619114265
- top_miner_usd_day: 3026.920619114265 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-07-28T22:19:37Z
- scoring-related commit: feat(agent-challenge): NO_PHALA host pipeline with unattested weight … 2026-07-28T20:25:29Z
