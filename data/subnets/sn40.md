...
- **competitive_miner_usd_day: 3284.0799122979397** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 3284.0799122979397
- top_miner_usd_day: 3284.0799122979397 (uid 124, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3275.8607 USD/day  |  payback on registration: 0.06 days
...
- components: income 31.97 / freshness 0.0 / resource 11.25 / registration 9.98
