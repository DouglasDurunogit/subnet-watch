...
- subnet age: 282.4 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3175.9555398476878
- top_miner_usd_day: 3175.9555398476878 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-07-29T10:11:17Z
- scoring-related commit: fix(proxy+agent-challenge): unblock miner env routes and engage env g… 2026-07-29T10:11:17Z
