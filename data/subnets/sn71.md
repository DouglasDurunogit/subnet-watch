...
- subnet age: 546.1 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2951.373654711866
- top_miner_usd_day: 2951.373654711866 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 12664 bytes, sha 41894cf17af42923
- latest release: v2-cutover-legacy-final-certfix-20260720 2026-07-20T19:10:50Z
- last commit: 2026-09-02T11:01:44Z
- scoring-related commit: Repair validator supersession test driver 2026-09-02T11:01:44Z
...
For each candidate, the gateway extracts the runtime app from `/app` and gives the resea
```

_(truncated at 6000 of 12664 chars - read the full file at https://github.com/leadpoet/leadpoet)_
