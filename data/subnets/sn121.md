...
- **competitive_miner_usd_day: 1053.03443644434** (uid 185) <- the only figure quotable as achievable
- median_miner_usd_day: 1343.0687547768357
- top_miner_usd_day: 1633.1030731093313 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.10797448652607788  |  top1_share: 0.607974486526078  |  top10_share: 1.0
...
- net margin: 1044.8153 USD/day  |  payback on registration: 0.0 days
