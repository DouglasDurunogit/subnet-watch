...
- subnet age: 173.9 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 194.28955223412592** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 99.2126173926711
- top_miner_usd_day: 485.734821544445 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 64.1343 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.5 (rank 2), confidence 1.0 
- components: income 16.5 / freshness 35.0 / resource 15.0 / registration 10.0
