...
- **competitive_miner_usd_day: 238.52687738900582** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 44.37016820344803
- top_miner_usd_day: 12198.818392310392 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.3643 USD/day  |  payback on registration: 0.0 days
