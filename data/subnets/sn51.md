...
- **competitive_miner_usd_day: 1320.2032732815392** (uid 85) <- the only figure quotable as achievable
- median_miner_usd_day: 84.40643878357382
- top_miner_usd_day: 37395.659493891726 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 49  |  gini: 0.9124656732712322  |  top1_share: 0.791365149155751  |  top10_share: 0.936612622515343
...
- net margin: 66.8088 USD/day  |  payback on registration: 1.53 days

## Score

- gate: **OK** 
- score: 61.5 (rank 16), confidence 0.85 - hardware requirement unknown
- components: income 16.66 / freshness 35.0 / resource 11.25 / registration 9.49
