...
- subnet age: 671.8 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1866.3774524265268** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 0.48183230990745496
- top_miner_usd_day: 5432.1774618966465 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 68  |  gini: 0.9438539606382701  |  top1_share: 0.34414444664906363  |  top10_share: 0.9977411132648545
...
- last commit: 2026-09-03T17:49:41Z
- scoring-related commit: tee_miner: stop dropping the thinking-token count on the way out 2026-09-03T05:50:55Z
...
- net margin: -7.7373 USD/day  |  payback on registration: [UNKNOWN] days

## Score

- gate: **OK** 
- score: 27.4 (rank 73), confidence 0.85 - hardware from README keywords, not curated
