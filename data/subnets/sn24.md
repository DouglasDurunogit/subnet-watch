...
- subnet age: 858.7 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2213.816201851735** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 1605.79500992054
- top_miner_usd_day: 2213.816201851735 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1168.5347 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 32.2 (rank 23), confidence 0.85 - hardware from README keywords, not curated
- components: income 27.9 / freshness 0.0 / resource 0.0 / registration 10.0
