...
- miner_burn: **0.0**
- registration cost: 0.001731932 TAO (0.35345268256 USD), open=True
...
- **competitive_miner_usd_day: 3409.259204451403** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 3409.259204451403
- top_miner_usd_day: 3409.259204451403 (uid 110, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3401.04 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 45.4 (rank 37), confidence 0.85 - hardware requirement unknown
- components: income 32.12 / freshness 0.0 / resource 11.25 / registration 10.0
