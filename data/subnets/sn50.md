...
- registration cost: 0.8 TAO (158.712 USD), open=True
...
- **competitive_miner_usd_day: 33.17821200865927** (uid 38) <- the only figure quotable as achievable
- median_miner_usd_day: 9.295063286472637
- top_miner_usd_day: 33.17821200865927 (uid 38, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.0759 USD/day  |  payback on registration: 147.52 days

## Score

- gate: **OK** 
- score: 41.8 (rank 35), confidence 0.85 - hardware requirement unknown
- components: income 2.89 / freshness 35.0 / resource 11.25 / registration 0.0
