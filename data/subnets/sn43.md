...
- registration cost: 0.1 TAO (19.643 USD), open=True
...
- **competitive_miner_usd_day: 13.271973122441976** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.045501233924749
- top_miner_usd_day: 2489.137152705731 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.5835 USD/day  |  payback on registration: 33.66 days
