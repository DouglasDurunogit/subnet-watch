...
- subnet age: 492.1 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 185.3811298205305** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 7.5940303648391465
- top_miner_usd_day: 185.3811298205305 (uid 218, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.4005 USD/day  |  payback on registration: [UNKNOWN] days
