...
- subnet age: 577.0 days  |  registered at block 4742549
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1223.3511186276887** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 2.102435136868853
- top_miner_usd_day: 1223.3511186276887 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.0467 USD/day  |  payback on registration: [UNKNOWN] days
