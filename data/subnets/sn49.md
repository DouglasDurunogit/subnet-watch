...
- miner_burn: **0.0**
- registration cost: 0.071889411 TAO (16.486398624630002 USD), open=True
...
- **competitive_miner_usd_day: 53.73281457966738** (uid 180) <- the only figure quotable as achievable
- median_miner_usd_day: 2717.072739709816
- top_miner_usd_day: 5380.412664839965 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.49011200292977697  |  top1_share: 0.990112002929777  |  top10_share: 1.0
...
- net margin: 45.5136 USD/day  |  payback on registration: 0.36 days
...
- components: income 15.17 / freshness 21.0 / resource 11.25 / registration 9.88
