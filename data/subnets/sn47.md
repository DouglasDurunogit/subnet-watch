...
- subnet age: 230.2 days  |  registered at block 7340355
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2260.179343728518
- top_miner_usd_day: 2260.179343728518 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 11974 bytes, sha 6f361bb25c97b2eb
- latest release: (none) 
- last commit: 2026-09-04T19:22:55Z
- scoring-related commit: fix extraction and verifier 2026-09-04T19:22:55Z
...
exact equality. There is no model judge, n
```

_(truncated at 6000 of 11974 chars - read the full file at https://github.com/center196/feval)_
