...
- **competitive_miner_usd_day: 1742.0057266256501** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 53.64143884913472
- top_miner_usd_day: 34695.95316560596 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.7171 USD/day  |  payback on registration: 2.58 days

## Score

- gate: **OK** 
- score: 59.4 (rank 23), confidence 0.85 - hardware requirement unknown
- components: income 14.54 / freshness 35.0 / resource 11.25 / registration 9.14
