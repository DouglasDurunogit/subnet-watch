...
- miner_burn: **0.0**
- registration cost: 0.304407351 TAO (59.67601709004 USD), open=True
...
- **competitive_miner_usd_day: 12378.76149782168** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 11.743603198342118
- top_miner_usd_day: 12378.76149782168 (uid 13, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10.8577 USD/day  |  payback on registration: 5.5 days

## Score

- gate: **OK** 
- score: 67.9 (rank 9), confidence 1.0 
- components: income 9.77 / freshness 35.0 / resource 15.0 / registration 8.17
