...
- miner_burn: **0.15056568244472146**
- registration cost: 0.1 TAO (23.338 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 804.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 30.33504409302437** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 11.375641534884139
- top_miner_usd_day: 1214.1477074281802 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826492537313432  |  top1_share: 0.4471202270854317  |  top10_share: 0.9986875438757133
...
- net margin: 0.402 USD/day  |  payback on registration: 58.05 days

## Score

- gate: **OK** 
- score: 51.3 (rank 34), confidence 1.0 
- components: income 1.33 / freshness 35.0 / resource 15.0 / registration 0.0
