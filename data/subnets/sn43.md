...
- registration cost: 0.1 TAO (19.193 USD), open=True
...
- **competitive_miner_usd_day: 23.55272018851287** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7699927753936899
- top_miner_usd_day: 2379.3682633518424 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8278 USD/day  |  payback on registration: [UNKNOWN] days
