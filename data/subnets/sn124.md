...
- miner_burn: **0.0**
- registration cost: 0.560186537 TAO (108.48012289005 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 37  |  free: 0
- subnet age: 413.7 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 615.6655552716481** (uid 198) <- the only figure quotable as achievable
- median_miner_usd_day: 219.58618684092104
- top_miner_usd_day: 615.6655552716481 (uid 198, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 23  |  gini: 0.28137551216760937  |  top1_share: 0.10487600152613508  |  top10_share: 0.6435711560473102
...
- net margin: 211.367 USD/day  |  payback on registration: 0.51 days

## Score

- gate: **OK** 
- score: 65.7 (rank 14), confidence 0.85 - hardware requirement unknown
- components: income 21.17 / freshness 35.0 / resource 11.25 / registration 9.83
