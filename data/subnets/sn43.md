...
- registration cost: 0.1 TAO (19.848 USD), open=True
...
- **competitive_miner_usd_day: 23.146373300861182** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7466572032535864
- top_miner_usd_day: 2478.855248726704 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.8463 USD/day  |  payback on registration: [UNKNOWN] days
