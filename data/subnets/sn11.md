...
- miner_burn: **0.0**
- registration cost: 0.030848074 TAO (8.16795303372 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 9  |  free: 0
- subnet age: 859.2 days  |  registered at block 2918568
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6582.211767110746** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 6582.211767110746
- top_miner_usd_day: 6582.211767110746 (uid 17, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 7060 bytes, sha 27902eaca0f7ee7b
- latest release: v0.7.0 2026-09-19T11:00:33Z
- last commit: 2026-09-19T20:43:16Z
...
- net margin: 6573.9926 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 54.6 (rank 24), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 34.72 / freshness 35.0 / resource 11.25 / registration 10.0
...
- **[Validator operations](docs/VALIDATOR_OPERATIONS.md)**: deplo
```

_(truncated at 6000 of 7060 chars - read the full file at https://github.com/trajectoryRL/trajectoryRL)_
