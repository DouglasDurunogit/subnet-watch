...
- registration cost: 0.002279255 TAO (0.51203463575 USD), open=True
...
- **competitive_miner_usd_day: 2.236250364647466** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0249480837967553
- top_miner_usd_day: 2749.889120277431 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0386 USD/day  |  payback on registration: 13.27 days

## Score

- gate: **OK** 
- score: 41.7 (rank 39), confidence 1.0 
- components: income 0.15 / freshness 21.0 / resource 15.0 / registration 5.58
