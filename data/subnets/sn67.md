...
- miner_burn: **0.05217852024361491**
- registration cost: 0.060387541 TAO (15.302202889400002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 152  |  free: 0
- subnet age: 250.0 days  |  registered at block 7236936
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 727.7155689445804** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 16.184600727967986
- top_miner_usd_day: 727.7155689445804 (uid 204, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 145  |  gini: 0.42846895877224145  |  top1_share: 0.20682172438032945  |  top10_share: 0.3742779424799046
- owner_incentive_share: 0.0522479293376937 (independent check on miner_burn; disagreement 0.0001)
...
- latest release: (none) 
- last commit: 2026-09-10T07:28:03Z
- scoring-related commit: chore(validator): bump repo-owned validator version to 20260910.post3 2026-09-10T07:28:03Z
...
- net margin: 15.1983 USD/day  |  payback on registration: 1.01 days

## Score

- gate: **OK** 
- score: 70.7 (rank 7), confidence 1.0 
- components: income 11.0 / freshness 35.0 / resource 15.0 / registration 9.66
