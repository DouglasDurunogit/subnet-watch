...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.965 USD), open=True
...
- **competitive_miner_usd_day: 266.78114948990185** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 3.085224177774375
- top_miner_usd_day: 959.7769449505755 (uid 252, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.2247 USD/day  |  payback on registration: [UNKNOWN] days
