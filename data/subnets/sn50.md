...
- registration cost: 0.8 TAO (157.20000000000002 USD), open=True
...
- **competitive_miner_usd_day: 47.21994370968606** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.343206136880454
- top_miner_usd_day: 47.21994370968606 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.124 USD/day  |  payback on registration: 50.32 days

## Score

- gate: **OK** 
- score: 32.2 (rank 51), confidence 0.85 - hardware requirement unknown
- components: income 5.6 / freshness 21.0 / resource 11.25 / registration 0.0
