...
- **competitive_miner_usd_day: 875.0071851825658** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 0.873829415101342
- top_miner_usd_day: 875.0071851825658 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.336 USD/day  |  payback on registration: [UNKNOWN] days
