...
- subnet age: 835.2 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4021.8333312176023
- top_miner_usd_day: 4021.8333312176023 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 3311 bytes, sha 28c97f8dd07fe964
- latest release: (none) 
- last commit: 2026-08-19T21:05:23Z
- scoring-related commit: feat(bench): harness round mode with a single batched scorer 2026-08-19T20:15:33Z
