...
- miner_burn: **0.0**
- registration cost: 0.033933962 TAO (6.77729089064 USD), open=True
...
- **competitive_miner_usd_day: 1929.2023179334972** (uid 100) <- the only figure quotable as achievable
- median_miner_usd_day: 478.8770902215425
- top_miner_usd_day: 1929.2023179334972 (uid 100, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.4262890452138617  |  top1_share: 0.5008926800238048  |  top10_share: 1.0
...
- net margin: 470.6579 USD/day  |  payback on registration: 0.01 days
