...
- subnet age: 671.0 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4076.1748443559086** (uid 79) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5415764092680408
- top_miner_usd_day: 6105.732438087893 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.6776 USD/day  |  payback on registration: [UNKNOWN] days
