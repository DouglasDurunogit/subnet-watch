...
- registration cost: 0.1 TAO (24.765 USD), open=True
...
- **competitive_miner_usd_day: 214.51541394752374** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.062234262445387
- top_miner_usd_day: 2951.2222234719525 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.6509 USD/day  |  payback on registration: [UNKNOWN] days
