...
- registration cost: 0.1 TAO (23.669 USD), open=True
...
- **competitive_miner_usd_day: 196.6333186301846** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 14.048981443052378
- top_miner_usd_day: 2776.298903751855 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.2524 USD/day  |  payback on registration: [UNKNOWN] days
