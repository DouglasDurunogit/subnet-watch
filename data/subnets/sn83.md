...
- **competitive_miner_usd_day: 83.20358984554755** (uid 248) <- the only figure quotable as achievable
- median_miner_usd_day: 28.05041297754223
- top_miner_usd_day: 83.20358984554755 (uid 248, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.7988 USD/day  |  payback on registration: 1.12 days

## Score

- gate: **OK** 
- score: 27.4 (rank 39), confidence 0.85 - hardware requirement unknown
