...
- miner_burn: **0.0**
- registration cost: 0.059923806 TAO (12.6768811593 USD), open=True
...
- **competitive_miner_usd_day: 4216.983466341796** (uid 70) <- the only figure quotable as achievable
- median_miner_usd_day: 3243.841050816293
- top_miner_usd_day: 4216.983466341796 (uid 70, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3235.6219 USD/day  |  payback on registration: 0.0 days
...
- components: income 31.92 / freshness 35.0 / resource 11.25 / registration 10.0
