...
- **competitive_miner_usd_day: 16.73547175992327** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.903993626921063
- top_miner_usd_day: 2440.875509981939 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7545 USD/day  |  payback on registration: [UNKNOWN] days
