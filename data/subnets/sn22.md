...
- **competitive_miner_usd_day: 65.74402247130318** (uid 8) <- the only figure quotable as achievable
- median_miner_usd_day: 6.68583279369185
- top_miner_usd_day: 984.2745893585064 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.5762 USD/day  |  payback on registration: [UNKNOWN] days
