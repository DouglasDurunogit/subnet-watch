...
- miner_burn: **0.0**
- registration cost: 0.121497382 TAO (28.105989378060002 USD), open=True
...
- **competitive_miner_usd_day: 9186.075201635214** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 9186.075201635214
- top_miner_usd_day: 9186.075201635214 (uid 42, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9177.856 USD/day  |  payback on registration: 0.0 days
...
- components: income 36.04 / freshness 35.0 / resource 11.25 / registration 10.0
