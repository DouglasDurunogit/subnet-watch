...
- **competitive_miner_usd_day: 190.94555011013128** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 96.96470487323923
- top_miner_usd_day: 477.3531419672838 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.6715 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.6 (rank 2), confidence 1.0 
- components: income 14.64 / freshness 35.0 / resource 15.0 / registration 10.0
