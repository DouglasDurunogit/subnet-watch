...
- subnet age: 702.3 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2795.8361876310723** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 39.671318731905956
- top_miner_usd_day: 50957.8089111332 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 63  |  gini: 0.9235348917466908  |  top1_share: 0.7844753878099426  |  top10_share: 0.9243007206546965
...
- last commit: 2026-09-08T12:48:39Z
- scoring-related commit: [P1] feat: run the miners tests and ruff format on every PR (#1289) 2026-09-07T11:34:42Z
...
- net margin: 24.5097 USD/day  |  payback on registration: 5.15 days

## Score

- gate: **OK** 
- score: 57.2 (rank 21), confidence 0.85 - hardware requirement unknown
- components: income 12.79 / freshness 35.0 / resource 11.25 / registration 8.28
