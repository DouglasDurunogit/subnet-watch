...
- miner_burn: **0.0**
- registration cost: 0.10341296 TAO (19.72602212 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 218  |  free: 0
- subnet age: 498.8 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 400.13582794408615** (uid 229) <- the only figure quotable as achievable
- median_miner_usd_day: 5.903860856602066
- top_miner_usd_day: 400.13582794408615 (uid 229, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 217  |  gini: 0.7312368257664223  |  top1_share: 0.09224652087475149  |  top10_share: 0.4851200489371463
...
- net margin: 4.9176 USD/day  |  payback on registration: 4.01 days

## Score

- gate: **OK** 
- score: 30.7 (rank 53), confidence 1.0 
- components: income 7.02 / freshness 0.0 / resource 15.0 / registration 8.66
