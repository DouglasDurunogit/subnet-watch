...
- registration cost: 0.001531581 TAO (0.29594739662999997 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 13  |  free: 0
- subnet age: 220.1 days  |  registered at block 7151800
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4512.1803453856555
- top_miner_usd_day: 4512.1803453856555 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-07-30T05:46:55Z
- scoring-related commit: validator: robust set_weights success detection; send User-Agent to p… 2026-07-29T13:25:31Z
