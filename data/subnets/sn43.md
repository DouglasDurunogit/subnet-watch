...
- **competitive_miner_usd_day: 14.660587720205966** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.896164342361024
- top_miner_usd_day: 2440.2247648862703 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4776 USD/day  |  payback on registration: [UNKNOWN] days
