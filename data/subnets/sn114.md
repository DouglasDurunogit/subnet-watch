...
- **competitive_miner_usd_day: 1589.9717409976056** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 0.0970797253020885
- top_miner_usd_day: 4133.848862813533 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1221 USD/day  |  payback on registration: [UNKNOWN] days
