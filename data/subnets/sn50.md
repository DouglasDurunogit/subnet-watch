...
- registration cost: 0.8 TAO (171.8 USD), open=True
...
- **competitive_miner_usd_day: 48.16980473075595** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 10.133282092750491
- top_miner_usd_day: 48.16980473075595 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.9141 USD/day  |  payback on registration: 89.75 days

## Score

- gate: **OK** 
- score: 31.0 (rank 61), confidence 0.85 - hardware requirement unknown
- components: income 4.22 / freshness 21.0 / resource 11.25 / registration 0.0
