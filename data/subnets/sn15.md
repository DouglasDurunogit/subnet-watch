...
- miner_burn: **0.0**
- registration cost: 0.382549968 TAO (78.40744144128001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 98  |  free: 0
- subnet age: 210.4 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 15719.641780733837** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 17.361548195824692
- top_miner_usd_day: 15719.641780733837 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.3752 USD/day  |  payback on registration: 4.79 days

## Score

- gate: **OK** 
- score: 69.7 (rank 6), confidence 1.0 
- components: income 11.28 / freshness 35.0 / resource 15.0 / registration 8.4
