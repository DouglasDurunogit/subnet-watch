...
- subnet age: 1015.6 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1601.8793855863503** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 5.126276199599771
- top_miner_usd_day: 1601.8793855863503 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.1631 USD/day  |  payback on registration: [UNKNOWN] days
