...
- subnet age: 523.1 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 95.58192210035673** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 22.778869285599033
- top_miner_usd_day: 95.58192210035673 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 238  |  gini: 0.3861954138022734  |  top1_share: 0.014722519492432348  |  top10_share: 0.12643326708454364
...
- net margin: 14.5597 USD/day  |  payback on registration: 1.58 days

## Score

- gate: **OK** 
- score: 26.8 (rank 79), confidence 0.85 - hardware requirement unknown
- components: income 10.84 / freshness 0.0 / resource 11.25 / registration 9.47
