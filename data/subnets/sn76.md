...
- subnet age: 175.7 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 191.98614582878457** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 97.49313330057561
- top_miner_usd_day: 479.954572770622 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.893 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.7 (rank 3), confidence 1.0 
- components: income 14.66 / freshness 35.0 / resource 15.0 / registration 10.0
