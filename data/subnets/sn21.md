...
- **competitive_miner_usd_day: 1002.7834568918323** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.378610158396919
- top_miner_usd_day: 1002.7834568918323 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8.3923 USD/day  |  payback on registration: 2.88 days

## Score

- gate: **OK** 
- score: 67.9 (rank 13), confidence 1.0 
- components: income 8.85 / freshness 35.0 / resource 15.0 / registration 9.04
