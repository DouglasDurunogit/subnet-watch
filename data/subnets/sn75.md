...
- miner_burn: **0.0**
- registration cost: 0.109498766 TAO (24.52553360868 USD), open=True
...
- **competitive_miner_usd_day: 11816.061797091768** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.009441116955142
- top_miner_usd_day: 11816.061797091768 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.2097 USD/day  |  payback on registration: [UNKNOWN] days
