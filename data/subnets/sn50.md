...
- registration cost: 0.8 TAO (154.912 USD), open=True
...
- **competitive_miner_usd_day: 36.39439588694757** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 8.621906998274596
- top_miner_usd_day: 36.39439588694757 (uid 240, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 238  |  gini: 0.49423948629167347  |  top1_share: 0.013422613587720907  |  top10_share: 0.1337369290038525
...
- net margin: 0.4027 USD/day  |  payback on registration: 384.68 days

## Score

- gate: **OK** 
- score: 10.7 (rank 69), confidence 0.85 - hardware requirement unknown
- components: income 1.34 / freshness 0.0 / resource 11.25 / registration 0.0
