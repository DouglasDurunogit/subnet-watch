...
- subnet age: 653.8 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 339.1765255423869** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 47.76682637600723
- top_miner_usd_day: 13132.671426128429 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.2271 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.2 (rank 20), confidence 0.85 - hardware from README keywords, not curated
