...
- registration cost: 0.8 TAO (164.28 USD), open=True
...
- **competitive_miner_usd_day: 33.2870274869922** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 9.160554646619207
- top_miner_usd_day: 33.2870274869922 (uid 157, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.9414 USD/day  |  payback on registration: 174.51 days
