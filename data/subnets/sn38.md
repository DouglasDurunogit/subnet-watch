...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (174.01839999999999 USD), open=True
- tempo: 1440.0  |  max_uids: 256  |  active: 15  |  free: 0
- subnet age: 228.3 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1633.7857622539145** (uid 131) <- the only figure quotable as achievable
- median_miner_usd_day: 620.2276721989666
- top_miner_usd_day: 3636.1095729404415 (uid 130, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.539742005056131  |  top1_share: 0.5304207169126063  |  top10_share: 1.0
...
- net margin: 422.3669 USD/day  |  payback on registration: 0.41 days

## Score

- gate: **OK** 
- score: 71.2 (rank 6), confidence 0.85 - hardware from README keywords, not curated
- components: income 23.89 / freshness 35.0 / resource 15.0 / registration 9.86
