...
- miner_burn: **0.7632538080215454**
- registration cost: 0.1 TAO (19.3 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 25  |  free: 0
- subnet age: 741.2 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.393134727780247** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.8601576010805898
- top_miner_usd_day: 2326.0805762112504 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.899378844070021  |  top1_share: 0.7633807975825282  |  top10_share: 0.9972833966698716
- owner_incentive_share: 0.7633807975825282 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.6878 USD/day  |  payback on registration: 28.06 days

## Score

- gate: **OK** 
- score: 17.7 (rank 64), confidence 1.0 
- components: income 2.07 / freshness 0.0 / resource 15.0 / registration 0.65
