...
- subnet age: 818.6 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1029.0514676100552** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 377.30785562873615
- top_miner_usd_day: 1029.0514676100552 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 576.6033 USD/day  |  payback on registration: 0.04 days
