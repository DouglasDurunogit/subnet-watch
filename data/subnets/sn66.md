...
- subnet age: 537.9 days  |  registered at block 4958013
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1831.3816493326772
- top_miner_usd_day: 1831.3816493326772 (uid 121, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-12T12:10:58Z
- scoring-related commit: Merge pull request #38 from conjectures-io/feat/api-retired-task-results 2026-08-11T11:34:05Z
