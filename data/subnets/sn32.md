...
- miner_burn: **0.0**
- registration cost: 0.01132813 TAO (2.2501064619 USD), open=True
...
- **competitive_miner_usd_day: 10.566885503723254** (uid 44) <- the only figure quotable as achievable
- median_miner_usd_day: 9.136561222832537
- top_miner_usd_day: 10.566885503723254 (uid 44, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.786 USD/day  |  payback on registration: 2.86 days

## Score

- gate: **OK** 
- score: 19.2 (rank 74), confidence 0.85 - hardware requirement unknown
- components: income 2.29 / freshness 0.0 / resource 11.25 / registration 9.05
