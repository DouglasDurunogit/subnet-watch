...
- miner_burn: **0.15056617674417794**
- registration cost: 0.120774215 TAO (28.2201030769 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 30  |  free: 0
- subnet age: 801.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1185.8109044205403** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 11.110147220405429
- top_miner_usd_day: 1185.8109044205403 (uid 39, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-26T10:23:53Z
- scoring-related commit: feat(rewards): publish the allocation audit with the daily vector; qu… 2026-08-26T10:23:53Z
...
- net margin: 6.4205 USD/day  |  payback on registration: 4.4 days

## Score

- gate: **OK** 
- score: 66.5 (rank 13), confidence 1.0 
- components: income 7.92 / freshness 35.0 / resource 15.0 / registration 8.53
