...
- subnet age: 668.1 days  |  registered at block 4312927
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6122.868636545543** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 80.82918463344535
- top_miner_usd_day: 6122.868636545543 (uid 148, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 18  |  gini: 0.7714376312032205  |  top1_share: 0.40345816927631784  |  top10_share: 0.9992674663492355
...
- latest release: (none) 
- last commit: 2026-09-22T00:09:48Z
- scoring-related commit: Keep prep-failed task rows when replacing tournament tasks (#1383) 2026-09-21T13:49:51Z
...
- net margin: 72.61 USD/day  |  payback on registration: 0.0 days
