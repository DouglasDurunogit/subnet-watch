...
- registration cost: 0.1 TAO (23.464 USD), open=True
...
- **competitive_miner_usd_day: 183.78219065985553** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.376439342252857
- top_miner_usd_day: 2784.5235529456063 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.5201 USD/day  |  payback on registration: 45.11 days

## Score

- gate: **OK** 
- score: 16.7 (rank 75), confidence 1.0 
- components: income 1.65 / freshness 0.0 / resource 15.0 / registration 0.0
