...
- subnet age: 66.4 days  |  registered at block 8409860
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3474.7060442726256** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 3474.7060442726256
- top_miner_usd_day: 3474.7060442726256 (uid 124, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3466.4869 USD/day  |  payback on registration: 0.06 days
...
- components: income 32.2 / freshness 0.0 / resource 11.25 / registration 9.98
