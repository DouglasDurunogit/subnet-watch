...
- miner_burn: **0.0**
- registration cost: 0.072809774 TAO (14.995901053039999 USD), open=True
...
- **competitive_miner_usd_day: 702.2245979281445** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 1755.6150752108638
- top_miner_usd_day: 4564.727788485452 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 694.0054 USD/day  |  payback on registration: 0.02 days
...
- components: income 25.85 / freshness 35.0 / resource 11.25 / registration 9.99
