...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (129.755 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 446.2 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 788.8795357134101** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 304.1728717462417
- top_miner_usd_day: 788.8795357134101 (uid 151, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 25  |  gini: 0.30043801413244187  |  top1_share: 0.09289867680051278  |  top10_share: 0.6251850495245944
...
- status: **ok** 
- README: 13861 bytes, sha e8bb816fe750b8c5
- latest release: (none) 
- last commit: 2026-09-08T16:48:01Z
- scoring-related commit: Read the RPC ping timeout from the constant, not the evaluator module 2026-09-08T12:21:58Z
...
- net margin: 295.9537 USD/day  |  payback on registration: 0.44 days

## Score

- gate: **OK** 
- score: 54.9 (rank 25), confidence 0.85 - hardware requirement unknown
- components: income 22.49 / freshness 21.0 / resource 11.25 / registration 9.85
...
_(truncated at 6000 of 13861 chars - read the full file at https://github.com/swarm-subnet/swarm)_
