...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.922 USD), open=True
...
- **competitive_miner_usd_day: 636.4441510316398** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 2.969537652984952
- top_miner_usd_day: 636.4441510316398 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.2496 USD/day  |  payback on registration: [UNKNOWN] days
