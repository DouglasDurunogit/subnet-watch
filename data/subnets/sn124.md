...
- subnet age: 408.6 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 699.468437763536** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 272.3878271222485
- top_miner_usd_day: 699.468437763536 (uid 17, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 232.2202 USD/day  |  payback on registration: 0.42 days
