...
- miner_burn: **0.0**
- registration cost: 0.208930628 TAO (41.472729658 USD), open=True
...
- **competitive_miner_usd_day: 68.61534837155838** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 19.49622312350486
- top_miner_usd_day: 144.04491065036115 (uid 153, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.0056 USD/day  |  payback on registration: 4.61 days

## Score

- gate: **OK** 
- score: 24.5 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 9.1 / freshness 0.0 / resource 11.25 / registration 8.46
