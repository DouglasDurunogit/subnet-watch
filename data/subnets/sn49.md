...
- miner_burn: **0.0**
- registration cost: 0.000543017 TAO (0.10772914263 USD), open=True
...
- **competitive_miner_usd_day: 43.14078100973762** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 43.14078100973762
- top_miner_usd_day: 4229.970043951725 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.9216 USD/day  |  payback on registration: 0.0 days
