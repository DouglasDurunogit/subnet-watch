...
- subnet age: 973.2 days  |  registered at block 1907637
- weights_version: 1030  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7.555664999853022** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 5.650875504091755
- top_miner_usd_day: 2977.439953807627 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.5683 USD/day  |  payback on registration: [UNKNOWN] days
