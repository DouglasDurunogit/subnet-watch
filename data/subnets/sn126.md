...
- subnet age: 175.4 days  |  registered at block 7525773
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 147.08677289117776** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 735.5685593028586
- top_miner_usd_day: 2059.663803299721 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 138.8676 USD/day  |  payback on registration: 0.28 days
...
- components: income 19.52 / freshness 35.0 / resource 11.25 / registration 9.91
