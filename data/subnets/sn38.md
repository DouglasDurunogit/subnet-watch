...
- miner_burn: **0.0**
- registration cost: 0.846822776 TAO (176.87587322312 USD), open=True
...
- **competitive_miner_usd_day: 3673.118071080838** (uid 116) <- the only figure quotable as achievable
- median_miner_usd_day: 174.13835123037728
- top_miner_usd_day: 3673.118071080838 (uid 116, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 218.3277 USD/day  |  payback on registration: 0.81 days

## Score

- gate: **OK** 
- score: 65.7 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 21.29 / freshness 35.0 / resource 11.25 / registration 9.73
