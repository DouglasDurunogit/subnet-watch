...
- miner_burn: **0.0**
- registration cost: 0.349146022 TAO (68.69098836828 USD), open=True
...
- **competitive_miner_usd_day: 15295.687639760177** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 16.736275207217826
- top_miner_usd_day: 15295.687639760177 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.75 USD/day  |  payback on registration: 4.36 days

## Score

- gate: **OK** 
- score: 69.7 (rank 7), confidence 1.0 
- components: income 11.13 / freshness 35.0 / resource 15.0 / registration 8.55
