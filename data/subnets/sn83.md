...
- **competitive_miner_usd_day: 71.91768298119119** (uid 216) <- the only figure quotable as achievable
- median_miner_usd_day: 23.109674308746644
- top_miner_usd_day: 78.31873329888883 (uid 248, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.2896 USD/day  |  payback on registration: 2.12 days

## Score

- gate: **OK** 
- score: 25.3 (rank 66), confidence 0.85 - hardware requirement unknown
- components: income 9.21 / freshness 0.0 / resource 11.25 / registration 9.29
