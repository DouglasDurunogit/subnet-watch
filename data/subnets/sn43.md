...
- registration cost: 0.1 TAO (23.257 USD), open=True
...
- **competitive_miner_usd_day: 27.963206034723378** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0336593670423038
- top_miner_usd_day: 2871.5601247681016 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7687 USD/day  |  payback on registration: [UNKNOWN] days
