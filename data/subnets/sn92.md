...
- subnet age: 86.6 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 359.39869073198116** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 205.11035138675885
- top_miner_usd_day: 1994.35901635906 (uid 10, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 15.7688 USD/day  |  payback on registration: 1.39 days

## Score

- gate: **OK** 
- score: 70.7 (rank 7), confidence 1.0 
- components: income 11.14 / freshness 35.0 / resource 15.0 / registration 9.54
