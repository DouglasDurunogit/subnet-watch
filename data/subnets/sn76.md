...
- subnet age: 171.5 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 206.34409581008396** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 130.85352508128707
- top_miner_usd_day: 515.8962674781508 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 68.1633 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.7 (rank 2), confidence 1.0 
- components: income 16.73 / freshness 35.0 / resource 15.0 / registration 10.0
