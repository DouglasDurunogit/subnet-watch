...
- registration cost: 0.8 TAO (169.752 USD), open=True
...
- **competitive_miner_usd_day: 46.04137854116711** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 12.318088118470149
- top_miner_usd_day: 46.04137854116711 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.0989 USD/day  |  payback on registration: 41.41 days

## Score

- gate: **OK** 
- score: 32.9 (rank 56), confidence 0.85 - hardware requirement unknown
- components: income 6.43 / freshness 21.0 / resource 11.25 / registration 0.0
