...
- **competitive_miner_usd_day: 9.39150799970097** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 7.014881485490929
- top_miner_usd_day: 2393.186234438085 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.2043 USD/day  |  payback on registration: [UNKNOWN] days
