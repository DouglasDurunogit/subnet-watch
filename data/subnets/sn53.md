...
- subnet age: 653.5 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12833.024423377978** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 46.67693492208761
- top_miner_usd_day: 12833.024423377978 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 144  |  gini: 0.7663467576328429  |  top1_share: 0.6257064304261494  |  top10_share: 0.7043378646708416
...
- last commit: 2026-08-22T04:00:05Z
- scoring-related commit: fix(validator): reuse one chain connection instead of leaking one per… 2026-08-22T01:50:29Z
...
- net margin: 38.4578 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.2 (rank 19), confidence 0.85 - hardware from README keywords, not curated
- components: income 14.52 / freshness 35.0 / resource 11.25 / registration 10.0
