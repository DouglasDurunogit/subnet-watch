...
- subnet age: 503.8 days  |  registered at block 5102795
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3.172461994551316** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 2.247160579473849
- top_miner_usd_day: 8332.735800521912 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.972 USD/day  |  payback on registration: [UNKNOWN] days
