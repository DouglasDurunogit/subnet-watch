...
- **competitive_miner_usd_day: 5.687692238724653** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.55049733221606
- top_miner_usd_day: 914.0879786595681 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.3038 USD/day  |  payback on registration: [UNKNOWN] days
