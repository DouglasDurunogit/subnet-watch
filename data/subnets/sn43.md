...
- registration cost: 0.1 TAO (19.689 USD), open=True
...
- **competitive_miner_usd_day: 11.29273101976811** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.2771350615993318
- top_miner_usd_day: 2464.650163100419 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4751 USD/day  |  payback on registration: [UNKNOWN] days
