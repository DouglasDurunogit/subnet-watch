...
- registration cost: 0.1 TAO (22.376 USD), open=True
...
- **competitive_miner_usd_day: 191.69849876872334** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.061061801302897
- top_miner_usd_day: 2671.6525621758083 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4558 USD/day  |  payback on registration: [UNKNOWN] days
