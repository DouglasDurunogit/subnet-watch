...
- **competitive_miner_usd_day: 480.6177005056353** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 1201.5259168740486
- top_miner_usd_day: 1922.4341332424615 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 472.3985 USD/day  |  payback on registration: 0.49 days
...
- components: income 24.33 / freshness 35.0 / resource 11.25 / registration 9.84
