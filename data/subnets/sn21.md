...
- miner_burn: **0.15056635439395905**
...
- **competitive_miner_usd_day: 1198.1718468989438** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 11.225959859845725
- top_miner_usd_day: 1198.1718468989438 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10.2397 USD/day  |  payback on registration: 2.3 days

## Score

- gate: **OK** 
- score: 68.8 (rank 11), confidence 1.0 
- components: income 9.56 / freshness 35.0 / resource 15.0 / registration 9.23
