...
- registration cost: 0.05 TAO (12.028 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 313.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 51.966082966995664** (uid 112) <- the only figure quotable as achievable
- median_miner_usd_day: 2599.652886380988
- top_miner_usd_day: 5147.3396897949815 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 43.7469 USD/day  |  payback on registration: 0.27 days
...
- components: income 15.01 / freshness 10.5 / resource 11.25 / registration 9.91
