...
- miner_burn: **0.0**
- registration cost: 0.154912825 TAO (32.77180812875 USD), open=True
...
- **competitive_miner_usd_day: 12724.356913190697** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.262405177904621
- top_miner_usd_day: 12724.356913190697 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.9568 USD/day  |  payback on registration: [UNKNOWN] days
