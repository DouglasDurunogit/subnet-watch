...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (106.005 USD), open=True
...
- **competitive_miner_usd_day: 29.29612477177175** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 9.80428080011485
- top_miner_usd_day: 3078.660888864636 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.9015 USD/day  |  payback on registration: [UNKNOWN] days
