...
- subnet age: 111.4 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 401.56569649001517** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 26.287642491487762
- top_miner_usd_day: 1874.0004843115923 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 20.939 USD/day  |  payback on registration: 1.11 days

## Score

- gate: **OK** 
- score: 68.1 (rank 10), confidence 1.0 
- components: income 12.2 / freshness 35.0 / resource 11.25 / registration 9.63
