...
- miner_burn: **0.5**
- registration cost: 0.001280891 TAO (0.25365484473 USD), open=True
...
- **competitive_miner_usd_day: 1839.9758302558614** (uid 61) <- the only figure quotable as achievable
- median_miner_usd_day: 1839.9758302558614
- top_miner_usd_day: 1839.9758302558614 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1831.7567 USD/day  |  payback on registration: 0.0 days
...
- components: income 29.68 / freshness 35.0 / resource 11.25 / registration 10.0
