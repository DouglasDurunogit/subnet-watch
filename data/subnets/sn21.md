...
- **competitive_miner_usd_day: 22.781822131963978** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.695455532990994
- top_miner_usd_day: 871.4046965476222 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.7092 USD/day  |  payback on registration: 4.11 days

## Score

- gate: **OK** 
- score: 65.5 (rank 13), confidence 1.0 
- components: income 6.88 / freshness 35.0 / resource 15.0 / registration 8.63
