...
- registration cost: 0.000627578 TAO (0.12589842258 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 448.8 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3660.146581342581
- top_miner_usd_day: 3660.146581342581 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 15420 bytes, sha 9ac982178f31c1b8
- latest release: (none) 
- last commit: 2026-08-15T01:34:10Z
...
_(truncated at 6000 of 15420 chars - read the full file at https://github.com/DeSciClaims/Claims)_
