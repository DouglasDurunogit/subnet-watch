...
- **competitive_miner_usd_day: 13.181121984445394** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.0314990872084295
- top_miner_usd_day: 2471.8619474844713 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.5728 USD/day  |  payback on registration: 34.06 days

## Score

- gate: **OK** 
- score: 16.8 (rank 64), confidence 1.0 
- components: income 1.79 / freshness 0.0 / resource 15.0 / registration 0.0
