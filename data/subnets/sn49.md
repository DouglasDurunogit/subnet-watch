...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (14.774500000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 327.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 59.19204209993259** (uid 220) <- the only figure quotable as achievable
- median_miner_usd_day: 2961.13838700533
- top_miner_usd_day: 5863.084731910728 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 50.9729 USD/day  |  payback on registration: 0.29 days
...
- components: income 15.61 / freshness 35.0 / resource 11.25 / registration 9.9
