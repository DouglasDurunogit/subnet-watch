...
- subnet age: 726.2 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 26.7740382728586** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 239.9444345979848
- top_miner_usd_day: 1065.1570829223658 (uid 22, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.4667088845823222  |  top1_share: 0.3976317275265897  |  top10_share: 1.0
...
- net margin: 18.5549 USD/day  |  payback on registration: 0.01 days
...
- components: income 11.74 / freshness 0.0 / resource 11.25 / registration 10.0
