...
- miner_burn: **0.0**
- registration cost: 0.000555817 TAO (0.11001285881 USD), open=True
...
- **competitive_miner_usd_day: 43.15213460420094** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 43.15213460420094
- top_miner_usd_day: 4231.083268222285 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.933 USD/day  |  payback on registration: 0.0 days
