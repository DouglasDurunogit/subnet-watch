...
- **competitive_miner_usd_day: 10624.986522502342** (uid 207) <- the only figure quotable as achievable
- median_miner_usd_day: 1918.2240369843603
- top_miner_usd_day: 10624.986522502342 (uid 207, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10595.3975 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 42.8 (rank 24), confidence 0.85 - hardware from README keywords, not curated
- components: income 36.61 / freshness 0.0 / resource 3.75 / registration 10.0
