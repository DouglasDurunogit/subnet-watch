...
- miner_burn: **0.0**
- registration cost: 0.13545286 TAO (25.9216138182 USD), open=True
...
- **competitive_miner_usd_day: 342.0822179847782** (uid 95) <- the only figure quotable as achievable
- median_miner_usd_day: 5.358686200340473
- top_miner_usd_day: 342.0822179847782 (uid 95, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.3724 USD/day  |  payback on registration: 5.93 days

## Score

- gate: **OK** 
- score: 29.7 (rank 58), confidence 1.0 
- components: income 6.64 / freshness 0.0 / resource 15.0 / registration 8.02
