...
- registration cost: 0.99 TAO (232.3431 USD), open=True
...
- **competitive_miner_usd_day: 481.35866676217125** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 1203.3783042493378
- top_miner_usd_day: 1925.3979417365038 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 473.1395 USD/day  |  payback on registration: 0.49 days
...
- components: income 24.34 / freshness 35.0 / resource 11.25 / registration 9.84
