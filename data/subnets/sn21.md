...
- **competitive_miner_usd_day: 34.533989689347244** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.4537826550109
- top_miner_usd_day: 850.324015897899 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.4675 USD/day  |  payback on registration: 2.63 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 1.0 
- components: income 8.44 / freshness 35.0 / resource 15.0 / registration 9.12
