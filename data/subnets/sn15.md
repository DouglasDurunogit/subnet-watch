...
- miner_burn: **0.0**
- registration cost: 0.349195926 TAO (68.54017635528 USD), open=True
...
- **competitive_miner_usd_day: 21.912088677640494** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.760157684788707
- top_miner_usd_day: 12396.211341449758 (uid 13, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.7739 USD/day  |  payback on registration: 6.36 days

## Score

- gate: **OK** 
- score: 67.6 (rank 10), confidence 1.0 
- components: income 9.74 / freshness 35.0 / resource 15.0 / registration 7.88
