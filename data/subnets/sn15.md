...
- miner_burn: **0.0**
- registration cost: 0.40684708 TAO (92.0003302004 USD), open=True
...
- **competitive_miner_usd_day: 41.5140426896765** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 23.936024613867538
- top_miner_usd_day: 22744.45938855844 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.9497 USD/day  |  payback on registration: 4.01 days

## Score

- gate: **OK** 
- score: 71.2 (rank 5), confidence 1.0 
- components: income 12.54 / freshness 35.0 / resource 15.0 / registration 8.66
