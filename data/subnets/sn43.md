...
- registration cost: 0.1 TAO (19.238 USD), open=True
...
- **competitive_miner_usd_day: 11.74115315218028** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.6773075931686112
- top_miner_usd_day: 2457.814726523071 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.458 USD/day  |  payback on registration: 42.0 days

## Score

- gate: **OK** 
- score: 16.5 (rank 66), confidence 1.0 
- components: income 1.49 / freshness 0.0 / resource 15.0 / registration 0.0
