...
- subnet age: 818.1 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1043.6581409850082** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 382.6634795041605
- top_miner_usd_day: 1043.6581409850082 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 584.9044 USD/day  |  payback on registration: 0.04 days

## Score

- gate: **OK** 
- score: 27.8 (rank 62), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 25.17 / freshness 0.0 / resource 11.25 / registration 9.99
