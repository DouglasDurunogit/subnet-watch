...
- **competitive_miner_usd_day: 944.0895389908344** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 682.5073438817407
- top_miner_usd_day: 944.0895389908344 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 245.2471 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 27.0 (rank 59), confidence 0.85 - hardware from README keywords, not curated
- components: income 21.75 / freshness 0.0 / resource 0.0 / registration 10.0
