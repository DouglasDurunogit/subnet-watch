...
- registration cost: 0.124831765 TAO (28.6139371733 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 14  |  free: 121
- subnet age: 228.9 days  |  registered at block 7340355
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2142.5489463318036
- top_miner_usd_day: 2142.5489463318036 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- on-chain URL: `center196/feval`
- resolved URL: `(none)`
- status: **unparsable** - not a github URL: 'center196/feval'
