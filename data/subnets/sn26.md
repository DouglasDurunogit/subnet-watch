...
- subnet age: 126.3 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1803.11613895644** (uid 64) <- the only figure quotable as achievable
- median_miner_usd_day: 25.293308528108927
- top_miner_usd_day: 1803.11613895644 (uid 64, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.7356 USD/day  |  payback on registration: 1.43 days

## Score

- gate: **OK** 
- score: 53.3 (rank 28), confidence 1.0 
- components: income 11.58 / freshness 21.0 / resource 11.25 / registration 9.52
