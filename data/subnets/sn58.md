...
- subnet age: 78.6 days  |  registered at block 8511017
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4385.5215508268475** (uid 37) <- the only figure quotable as achievable
- median_miner_usd_day: 4385.5215508268475
- top_miner_usd_day: 4385.5215508268475 (uid 37, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4377.3024 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 32.6 (rank 58), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 33.12 / freshness 0.0 / resource 11.25 / registration 10.0
