...
- miner_burn: **0.0**
- registration cost: 0.051369285 TAO (10.98840375435 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 219.0 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4264.706388889496** (uid 70) <- the only figure quotable as achievable
- median_miner_usd_day: 3280.551077417239
- top_miner_usd_day: 4264.706388889496 (uid 70, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3272.3319 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 52.9 (rank 28), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
