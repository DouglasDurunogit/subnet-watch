...
- subnet age: 660.5 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 8136.446854698839** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 12.127317661289764
- top_miner_usd_day: 8136.446854698839 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 152  |  gini: 0.9190564256064293  |  top1_share: 0.37920657470632263  |  top10_share: 0.9240486992652337
...
- net margin: 3.9081 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 53.1 (rank 31), confidence 0.85 - hardware from README keywords, not curated
- components: income 6.28 / freshness 35.0 / resource 11.25 / registration 9.99
