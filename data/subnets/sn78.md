...
- subnet age: 145.7 days  |  registered at block 7966145
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3755.2255360397203
- top_miner_usd_day: 3755.2255360397203 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 23829 bytes, sha d3b46d29d68fb18d
- latest release: (none) 
- last commit: 2026-09-07T06:51:38Z
- scoring-related commit: Harden macOS validator audit origin 2026-09-07T06:42:21Z
...
`component_test_no_weight` and `shadow_rehearsal_no_weight` remain local enginee
```

_(truncated at 6000 of 23829 chars - read the full file at https://github.com/Umi-BitSign/umi)_
