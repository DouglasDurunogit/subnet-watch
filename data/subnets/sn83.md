...
- **competitive_miner_usd_day: 94.00832078325814** (uid 137) <- the only figure quotable as achievable
- median_miner_usd_day: 30.204839529638903
- top_miner_usd_day: 94.00832078325814 (uid 137, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 25.1532 USD/day  |  payback on registration: 0.96 days

## Score

- gate: **OK** 
- score: 28.7 (rank 58), confidence 0.85 - hardware requirement unknown
- components: income 12.89 / freshness 0.0 / resource 11.25 / registration 9.68
