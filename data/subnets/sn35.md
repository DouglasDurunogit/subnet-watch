...
- subnet age: 807.3 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 909.3864585980036** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 334.6555733612718
- top_miner_usd_day: 909.3864585980036 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.36681213822850234  |  top1_share: 0.6546525467696157  |  top10_share: 1.0
...
- net margin: 519.0096 USD/day  |  payback on registration: 0.04 days
...
- components: income 24.7 / freshness 0.0 / resource 11.25 / registration 9.99
