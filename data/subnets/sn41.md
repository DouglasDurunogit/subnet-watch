...
- subnet age: 759.5 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.40372744948403** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 11.101898853512596
- top_miner_usd_day: 2013.5571450490334 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.6733 USD/day  |  payback on registration: 2.03 days

## Score

- gate: **OK** 
- score: 68.7 (rank 11), confidence 1.0 
- components: income 9.35 / freshness 35.0 / resource 15.0 / registration 9.32
