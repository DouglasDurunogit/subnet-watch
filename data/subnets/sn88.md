...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9238 USD), open=True
...
- **competitive_miner_usd_day: 302.6463535938791** (uid 174) <- the only figure quotable as achievable
- median_miner_usd_day: 2.005908868855352
- top_miner_usd_day: 330.96202201359205 (uid 252, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.3297 USD/day  |  payback on registration: [UNKNOWN] days
