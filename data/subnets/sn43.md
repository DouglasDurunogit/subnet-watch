...
- **competitive_miner_usd_day: 23.54804749866628** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9337233534287401
- top_miner_usd_day: 2397.6649291630397 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8041 USD/day  |  payback on registration: [UNKNOWN] days
