...
- miner_burn: **0.0**
- registration cost: 0.396968805 TAO (92.8748216178 USD), open=True
...
- **competitive_miner_usd_day: 46.715233066389224** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.197483022054758
- top_miner_usd_day: 25449.701430248857 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 82  |  gini: 0.9329192877367996  |  top1_share: 0.9233482463239224  |  top10_share: 0.9379609411980273
...
- net margin: 27.2112 USD/day  |  payback on registration: 3.41 days

## Score

- gate: **OK** 
- score: 72.1 (rank 6), confidence 1.0 
- components: income 13.19 / freshness 35.0 / resource 15.0 / registration 8.86
