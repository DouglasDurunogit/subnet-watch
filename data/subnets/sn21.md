...
- **competitive_miner_usd_day: 5.634579651164237** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.470651408916902
- top_miner_usd_day: 905.514513806434 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.3102 USD/day  |  payback on registration: [UNKNOWN] days
