...
- miner_burn: **0.45059951627627015**
...
- **competitive_miner_usd_day: 22.516481278308557** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.629120319577139
- top_miner_usd_day: 861.2845753218287 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.6428 USD/day  |  payback on registration: 4.3 days

## Score

- gate: **OK** 
- score: 65.4 (rank 15), confidence 1.0 
- components: income 6.83 / freshness 35.0 / resource 15.0 / registration 8.57
