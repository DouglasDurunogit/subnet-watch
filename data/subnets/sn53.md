...
- **competitive_miner_usd_day: 593.2099922627673** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 95.87232198186138
- top_miner_usd_day: 2060.684254026794 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 86.2265 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.9 (rank 19), confidence 0.85 - hardware from README keywords, not curated
