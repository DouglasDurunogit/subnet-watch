...
- miner_burn: **0.0**
- registration cost: 0.041513356 TAO (10.52488114668 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 254  |  free: 0
- subnet age: 855.0 days  |  registered at block 2943950
- weights_version: 2388  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 20.65265422001915** (uid 115) <- the only figure quotable as achievable
- median_miner_usd_day: 14.310087822500577
- top_miner_usd_day: 20.65265422001915 (uid 115, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.10095152730995882  |  top1_share: 0.006022438934914861  |  top10_share: 0.05754944819785393
...
- net margin: 6.0909 USD/day  |  payback on registration: 1.73 days

## Score

- gate: **OK** 
- score: 42.0 (rank 42), confidence 0.85 - hardware requirement unknown
- components: income 7.74 / freshness 21.0 / resource 11.25 / registration 9.42
