...
- miner_burn: **0.0**
- registration cost: 0.2 TAO (40.25 USD), open=True
...
- **competitive_miner_usd_day: 466.9266831543893** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 23.767211867879833
- top_miner_usd_day: 466.9266831543893 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 21.1579 USD/day  |  payback on registration: 1.9 days

## Score

- gate: **OK** 
- score: 57.6 (rank 20), confidence 1.0 
- components: income 12.24 / freshness 21.0 / resource 15.0 / registration 9.37
