...
- **competitive_miner_usd_day: 1345.406743918484** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 78.35350077738907
- top_miner_usd_day: 43707.450226392255 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 58.767 USD/day  |  payback on registration: 1.9 days

## Score

- gate: **OK** 
- score: 61.0 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 16.16 / freshness 35.0 / resource 11.25 / registration 9.37
