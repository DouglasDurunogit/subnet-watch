...
- miner_burn: **0.8015333223156631**
- registration cost: 0.0005 TAO (0.11498000000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 6  |  free: 163
- subnet age: 38.6 days  |  registered at block 8618670
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5487.781905795659** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 13825.784230909303
- top_miner_usd_day: 22163.786556022944 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.3015381328775901  |  top1_share: 0.8015381328775902  |  top10_share: 1.0
- owner_incentive_share: 0.8015381328775903 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 82888 bytes, sha bb4233b6f33d94aa
- latest release: v1.1.5 2026-08-21T22:02:10Z
- last commit: 2026-08-21T22:02:06Z
- scoring-related commit: fix(validator): fall back to CoinGecko TAO/USD when Taostats 429s 2026-08-21T22:02:06Z
...
- net margin: 5408.8778 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 47.4 (rank 36), confidence 0.6 - hardware from README keywords, not curated; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 33.95 / freshness 35.0 / resource 0.0 / registration 10.0
...
- **[Protecting Agentic AI Workloads with Confidential Computing](https://confidentialcomputing.io/2026/01/20/protecting-agentic-ai-workloads-with-confidential-computing/)** (January 2026) — Mike Bursell, CCC Executive Director, on why an agent running in infrastructure its owner does not control needs hardware-rooted isolation and remote attestation to get identity int
```

_(truncated at 6000 of 82888 chars - read the full file at https://github.com/KubeTEE-AI/kubetee-subnet)_
