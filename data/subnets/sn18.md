...
- subnet age: 1032.8 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1051.617061776939** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 15.221670899058026
- top_miner_usd_day: 1051.617061776939 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6.6188 USD/day  |  payback on registration: 35.66 days

## Score

- gate: **OK** 
- score: 46.1 (rank 44), confidence 0.85 - hardware requirement unknown
- components: income 8.02 / freshness 35.0 / resource 11.25 / registration 0.0
