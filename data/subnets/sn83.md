...
- miner_burn: **0.0**
- registration cost: 0.169496826 TAO (33.423079118939995 USD), open=True
...
- **competitive_miner_usd_day: 69.26790039476467** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 28.900786121289194
- top_miner_usd_day: 69.26790039476467 (uid 193, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.7473 USD/day  |  payback on registration: 2.12 days

## Score

- gate: **OK** 
- score: 26.9 (rank 65), confidence 0.85 - hardware requirement unknown
- components: income 11.13 / freshness 0.0 / resource 11.25 / registration 9.29
