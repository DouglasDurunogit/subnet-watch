...
- registration cost: 0.1 TAO (19.392 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 25  |  free: 0
- subnet age: 748.0 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12.25764674650552** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.7376740598494418
- top_miner_usd_day: 2455.709159877499 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.5635 USD/day  |  payback on registration: 34.41 days

## Score

- gate: **OK** 
- score: 16.8 (rank 64), confidence 1.0 
- components: income 1.77 / freshness 0.0 / resource 15.0 / registration 0.0
