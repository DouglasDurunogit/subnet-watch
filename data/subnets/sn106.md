...
- subnet age: 491.2 days  |  registered at block 5558480
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 530.0242615993125** (uid 30) <- the only figure quotable as achievable
- median_miner_usd_day: 53.142673318494936
- top_miner_usd_day: 599.0478631669307 (uid 204, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.6447843745980395  |  top1_share: 0.33244311505181073  |  top10_share: 0.9795046316785447
...
- net margin: 19.8028 USD/day  |  payback on registration: 0.01 days
