...
- subnet age: 107.4 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 398.4103860981081** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 26.08108682137666
- top_miner_usd_day: 1859.2754884908045 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 20.7512 USD/day  |  payback on registration: 1.11 days

## Score

- gate: **OK** 
- score: 68.0 (rank 8), confidence 1.0 
- components: income 12.16 / freshness 35.0 / resource 11.25 / registration 9.63
