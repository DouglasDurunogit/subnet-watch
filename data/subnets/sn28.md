...
- **competitive_miner_usd_day: 2024.3816007023845** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 28.355876577727493
- top_miner_usd_day: 3173.008339863496 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 41  |  gini: 0.8317625633060775  |  top1_share: 0.33988643995359913  |  top10_share: 0.9195311069051835
- owner_incentive_share: 0.33988643995359913 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 20.1367 USD/day  |  payback on registration: 0.98 days
