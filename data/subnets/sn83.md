...
- miner_burn: **0.0**
- registration cost: 0.136217037 TAO (27.16440151854 USD), open=True
...
- **competitive_miner_usd_day: 44.75636543396496** (uid 37) <- the only figure quotable as achievable
- median_miner_usd_day: 35.85270550188895
- top_miner_usd_day: 45.137270671700826 (uid 243, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 248  |  gini: 0.3623992166624177  |  top1_share: 0.00724560143077699  |  top10_share: 0.07062168483162384
...
- net margin: 8.255 USD/day  |  payback on registration: 3.29 days

## Score

- gate: **OK** 
- score: 24.6 (rank 66), confidence 0.85 - hardware requirement unknown
- components: income 8.79 / freshness 0.0 / resource 11.25 / registration 8.9
