...
- miner_burn: **0.8562165265902877**
- registration cost: 0.0005 TAO (0.10250000000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 7  |  free: 164
- subnet age: 27.1 days  |  registered at block 8618670
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2180.843960188493** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 7584.346640150324
- top_miner_usd_day: 12987.849320112155 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.3562273018585773  |  top1_share: 0.8562273018585773  |  top10_share: 1.0
- owner_incentive_share: 0.8562273018585772 (independent check on miner_burn; disagreement 0.0)
...
- latest release: v1.0.2 — proxy version header + owner miner UID hardcode 2026-08-09T18:13:35Z
- last commit: 2026-08-09T18:13:35Z
- scoring-related commit: feat(validator): v1.0.2 — proxy version header + hardcode owner miner… 2026-08-09T18:13:35Z
...
- net margin: 2101.9399 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 45.1 (rank 33), confidence 0.6 - hardware from README keywords, not curated; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 30.22 / freshness 35.0 / resource 0.0 / registration 10.0
