...
- subnet age: 331.8 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2979.1696463813555
- top_miner_usd_day: 2979.1696463813555 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-13T17:22:28Z
- scoring-related commit: docs(proof): keep miner tbench rebake pin after skew-hint copy 2026-09-13T09:53:24Z
