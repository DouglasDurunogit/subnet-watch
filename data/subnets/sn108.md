...
- miner_burn: **0.655088922707364**
- registration cost: 0.05 TAO (12.092500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 13  |  free: 88
- subnet age: 250.8 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 205.12231868170363** (uid 161) <- the only figure quotable as achievable
- median_miner_usd_day: 205.12231868170363
- top_miner_usd_day: 1518.8179136468123 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.46827094746158426  |  top1_share: 0.6551050615720324  |  top10_share: 1.0
- owner_incentive_share: 0.6551050615720324 (independent check on miner_burn; disagreement 0.0)
...
- latest release: (none) 
- last commit: 2026-08-21T13:19:16Z
- scoring-related commit: fix(evaluation): reuse the prefix cache the pinned transformers returns 2026-08-21T13:19:16Z
...
- net margin: 192.3394 USD/day  |  payback on registration: 0.06 days

## Score

- gate: **OK** 
- score: 65.5 (rank 14), confidence 0.85 - hardware requirement unknown
- components: income 20.79 / freshness 35.0 / resource 11.25 / registration 9.98
