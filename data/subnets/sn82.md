...
- miner_burn: **0.0**
- registration cost: 1.175e-06 TAO (0.00022023025 USD), open=True
...
- **competitive_miner_usd_day: 2942.9766102656445** (uid 22) <- the only figure quotable as achievable
- median_miner_usd_day: 2942.9766102656445
- top_miner_usd_day: 2942.9766102656445 (uid 22, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2934.7574 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 44.9 (rank 16), confidence 0.85 - hardware requirement unknown
