...
- **competitive_miner_usd_day: 334.9493054560006** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 10.40767072656008
- top_miner_usd_day: 3350.7622826973916 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.1814 USD/day  |  payback on registration: [UNKNOWN] days
