...
- subnet age: 566.1 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.08498905749280224** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 2784.8364468666505
- top_miner_usd_day: 5569.587904675808 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1342 USD/day  |  payback on registration: [UNKNOWN] days
