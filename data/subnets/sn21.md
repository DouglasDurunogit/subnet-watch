...
- miner_burn: **0.3009981291834265**
- registration cost: 0.1 TAO (22.468000000000004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 797.9 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 871.9060462599815** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 8.15592207373899
- top_miner_usd_day: 871.9060462599815 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.0083 USD/day  |  payback on registration: 2706.99 days

## Score

- gate: **OK** 
- score: 50.0 (rank 31), confidence 1.0 
- components: income 0.03 / freshness 35.0 / resource 15.0 / registration 0.0
