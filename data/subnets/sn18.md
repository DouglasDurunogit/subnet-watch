...
- miner_burn: **0.17300759511999786**
- registration cost: 0.999999999 TAO (223.00999977698999 USD), open=True
- tempo: 1800.0  |  max_uids: 257  |  active: 43  |  free: 0
- subnet age: 1025.3 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1065.16130894248** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 3.7800619101882584
- top_miner_usd_day: 1065.16130894248 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 35  |  gini: 0.8715055392874043  |  top1_share: 0.3784703673743494  |  top10_share: 0.971183931378684
- owner_incentive_share: 0.17304903921000014 (independent check on miner_burn; disagreement 0.0)
...
- net margin: -4.4606 USD/day  |  payback on registration: [UNKNOWN] days
