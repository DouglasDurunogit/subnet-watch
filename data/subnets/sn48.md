...
- subnet age: 723.9 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 27.807440625281238** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 333.85910393467435
- top_miner_usd_day: 977.0388374812558 (uid 206, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.3902130733116649  |  top1_share: 0.3511818473135672  |  top10_share: 1.0
...
- net margin: 19.5883 USD/day  |  payback on registration: 0.01 days
...
- components: income 11.95 / freshness 0.0 / resource 11.25 / registration 10.0
