...
- miner_burn: **0.0**
- registration cost: 0.060998571 TAO (11.87825173083 USD), open=True
...
- **competitive_miner_usd_day: 16.946086554630067** (uid 134) <- the only figure quotable as achievable
- median_miner_usd_day: 13.09037584978446
- top_miner_usd_day: 16.946086554630067 (uid 134, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 245  |  gini: 0.08583514302123918  |  top1_share: 0.005442010486570769  |  top10_share: 0.05160738034455875
...
- net margin: 4.8712 USD/day  |  payback on registration: 2.44 days

## Score

- gate: **OK** 
- score: 23.3 (rank 69), confidence 0.85 - hardware requirement unknown
- components: income 6.99 / freshness 0.0 / resource 11.25 / registration 9.19
