...
- **competitive_miner_usd_day: 1652.49454801594** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 40.59830066872512
- top_miner_usd_day: 2804.8755161127174 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 31.7504 USD/day  |  payback on registration: 0.75 days

## Score

- gate: **OK** 
- score: 59.3 (rank 21), confidence 0.85 - hardware requirement unknown
- components: income 13.78 / freshness 35.0 / resource 11.25 / registration 9.75
