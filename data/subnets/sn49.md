...
- **competitive_miner_usd_day: 36.882268179959** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 1845.0706587064376
- top_miner_usd_day: 3653.2590492329164 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 28.6631 USD/day  |  payback on registration: 0.34 days
...
- components: income 13.39 / freshness 21.0 / resource 11.25 / registration 9.89
