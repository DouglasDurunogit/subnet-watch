...
- **competitive_miner_usd_day: 1613.8658875280207** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 5.352321847273938
- top_miner_usd_day: 1613.8658875280207 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.9608 USD/day  |  payback on registration: [UNKNOWN] days
