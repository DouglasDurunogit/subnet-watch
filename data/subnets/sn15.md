...
- miner_burn: **0.0**
- registration cost: 0.300857872 TAO (59.18776915856 USD), open=True
...
- **competitive_miner_usd_day: 21.780130417974252** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 11.468298759906798
- top_miner_usd_day: 11700.748647376506 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.3856 USD/day  |  payback on registration: 5.7 days

## Score

- gate: **OK** 
- score: 67.7 (rank 12), confidence 1.0 
- components: income 9.61 / freshness 35.0 / resource 15.0 / registration 8.1
