...
- **competitive_miner_usd_day: 26.140601442993187** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.504895035004093
- top_miner_usd_day: 893.7423224838182 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.5186 USD/day  |  payback on registration: 3.39 days

## Score

- gate: **OK** 
- score: 31.3 (rank 29), confidence 1.0 
- components: income 7.4 / freshness 0.0 / resource 15.0 / registration 8.87
