...
- subnet age: 649.9 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 237.26896705124526** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 44.13617489467608
- top_miner_usd_day: 12134.485936647017 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-18T15:05:58Z
- scoring-related commit: miner: tee_miner, a pure gateway leg with provider-assigned identity … 2026-08-18T15:05:58Z
...
- net margin: 34.1397 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.8 (rank 17), confidence 0.85 - hardware from README keywords, not curated
- components: income 14.06 / freshness 35.0 / resource 11.25 / registration 10.0
