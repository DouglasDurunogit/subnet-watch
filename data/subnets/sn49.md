...
- **competitive_miner_usd_day: 41.41707282006365** (uid 59) <- the only figure quotable as achievable
- median_miner_usd_day: 41.41707282006365
- top_miner_usd_day: 4060.959798050303 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.1979 USD/day  |  payback on registration: 0.0 days
...
- components: income 13.95 / freshness 21.0 / resource 11.25 / registration 10.0
