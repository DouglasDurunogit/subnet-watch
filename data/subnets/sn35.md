...
- subnet age: 822.1 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1462.3668166369087** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 831.2782728300328
- top_miner_usd_day: 1462.3668166369087 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 823.0591 USD/day  |  payback on registration: 0.03 days
