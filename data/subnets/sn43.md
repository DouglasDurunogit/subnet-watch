...
- **competitive_miner_usd_day: 12.75583959597077** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.896930604213142
- top_miner_usd_day: 2347.3081090944456 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 18  |  gini: 0.8944981974924291  |  top1_share: 0.7666727711137564  |  top10_share: 0.9972987821628058
- owner_incentive_share: 0.7666727711137563 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.6958 USD/day  |  payback on registration: 27.77 days

## Score

- gate: **OK** 
- score: 17.8 (rank 64), confidence 1.0 
- components: income 2.09 / freshness 0.0 / resource 15.0 / registration 0.74
