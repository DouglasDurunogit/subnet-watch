...
- subnet age: 1024.6 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1115.4881854918938** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.7209418128547855
- top_miner_usd_day: 1115.4881854918938 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.54 USD/day  |  payback on registration: [UNKNOWN] days
