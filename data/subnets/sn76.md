...
- subnet age: 170.8 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 206.69380277702274** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 131.04800868573457
- top_miner_usd_day: 516.7585634838483 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 68.2725 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.7 (rank 2), confidence 1.0 
- components: income 16.74 / freshness 35.0 / resource 15.0 / registration 10.0
