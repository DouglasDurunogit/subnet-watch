...
- **competitive_miner_usd_day: 1406.3670823711238** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 19.301772545557306
- top_miner_usd_day: 35746.21717600848 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.4203 USD/day  |  payback on registration: 11.68 days

## Score

- gate: **OK** 
- score: 52.0 (rank 26), confidence 0.85 - hardware requirement unknown
- components: income 8.86 / freshness 35.0 / resource 11.25 / registration 6.11
