...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (98.54 USD), open=True
...
- **competitive_miner_usd_day: 22.51033513685882** (uid 175) <- the only figure quotable as achievable
- median_miner_usd_day: 10.17293991761889
- top_miner_usd_day: 2855.2412111333956 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.5784 USD/day  |  payback on registration: [UNKNOWN] days
