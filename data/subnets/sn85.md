...
- subnet age: 490.9 days  |  registered at block 5258781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 799.5660462936977** (uid 23) <- the only figure quotable as achievable
- median_miner_usd_day: 160.5266222158885
- top_miner_usd_day: 799.5660462936977 (uid 23, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.4492667592437163  |  top1_share: 0.24067998351925043  |  top10_share: 1.0
...
- net margin: 467.8856 USD/day  |  payback on registration: 0.0 days
