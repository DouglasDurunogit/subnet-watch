...
- miner_burn: **0.7737064799293876**
- registration cost: 0.1 TAO (19.521 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 25  |  free: 0
- subnet age: 741.6 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.40659761076786** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.7875463481023812
- top_miner_usd_day: 2385.15131668903 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.9014817617277018  |  top1_share: 0.773835141858584  |  top10_share: 0.9974054912015627
- owner_incentive_share: 0.773835141858584 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.6131 USD/day  |  payback on registration: 31.84 days

## Score

- gate: **OK** 
- score: 16.9 (rank 63), confidence 1.0 
- components: income 1.89 / freshness 0.0 / resource 15.0 / registration 0.0
