...
- subnet age: 456.3 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 398.56209955237193** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 996.3900447114191
- top_miner_usd_day: 1594.2179898704665 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 390.3429 USD/day  |  payback on registration: 0.61 days
...
- components: income 23.58 / freshness 35.0 / resource 11.25 / registration 9.8
