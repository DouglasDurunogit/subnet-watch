...
- **competitive_miner_usd_day: 10.692078292310827** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 16.868570121364165
- top_miner_usd_day: 3295.7552786657902 (uid 59, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.3431 USD/day  |  payback on registration: 0.05 days
