...
- miner_burn: **0.0**
- registration cost: 0.122553932 TAO (23.52055062944 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 225  |  free: 0
- subnet age: 493.2 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 732.2172299539467** (uid 203) <- the only figure quotable as achievable
- median_miner_usd_day: 3.267307524197215
- top_miner_usd_day: 732.2172299539467 (uid 203, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 224  |  gini: 0.8392076952564431  |  top1_share: 0.16447257771050258  |  top10_share: 0.7018026696023117
...
- net margin: 2.281 USD/day  |  payback on registration: 10.31 days

## Score

- gate: **OK** 
- score: 26.3 (rank 48), confidence 1.0 
- components: income 4.69 / freshness 0.0 / resource 15.0 / registration 6.56
