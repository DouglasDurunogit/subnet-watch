...
- subnet age: 193.7 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3206.7916613107127** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 801.6979153276782
- top_miner_usd_day: 3206.7916613107127 (uid 126, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 793.4787 USD/day  |  payback on registration: 0.03 days
