...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (144.975 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 83  |  free: 0
- subnet age: 718.0 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2146.0402151228845** (uid 246) <- the only figure quotable as achievable
- median_miner_usd_day: 34.082785453758845
- top_miner_usd_day: 60334.75713240062 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 73  |  gini: 0.9353231562359994  |  top1_share: 0.7838427947598253  |  top10_share: 0.9319479646990564
...
- last commit: 2026-09-24T06:27:30Z
- scoring-related commit: DAH-3521 - [P1] validator: a custom build reaches the node's own DNS … 2026-09-24T06:27:30Z
...
- net margin: 23.5131 USD/day  |  payback on registration: 6.17 days

## Score

- gate: **OK** 
- score: 56.8 (rank 22), confidence 0.85 - hardware requirement unknown
- components: income 12.64 / freshness 35.0 / resource 11.25 / registration 7.94
