...
- **competitive_miner_usd_day: 186.11003358481057** (uid 80) <- the only figure quotable as achievable
- median_miner_usd_day: 29.700126781964563
- top_miner_usd_day: 2134.535198721193 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 21.3195 USD/day  |  payback on registration: 1.08 days

## Score

- gate: **OK** 
- score: 54.2 (rank 28), confidence 1.0 
- components: income 12.27 / freshness 21.0 / resource 11.25 / registration 9.64
