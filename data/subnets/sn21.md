...
- **competitive_miner_usd_day: 5.385831085884518** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.096699399113058
- top_miner_usd_day: 865.6107721233598 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.34 USD/day  |  payback on registration: [UNKNOWN] days
