...
- miner_burn: **0.0**
- registration cost: 0.257270284 TAO (52.3159122514 USD), open=True
...
- **competitive_miner_usd_day: 23.905485514740107** (uid 131) <- the only figure quotable as achievable
- median_miner_usd_day: 11.739300922417016
- top_miner_usd_day: 12891.673389328462 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.753 USD/day  |  payback on registration: 4.87 days

## Score

- gate: **OK** 
- score: 68.1 (rank 9), confidence 1.0 
- components: income 9.73 / freshness 35.0 / resource 15.0 / registration 8.38
