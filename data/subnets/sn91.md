...
- **competitive_miner_usd_day: 2516.4956600070864** (uid 81) <- the only figure quotable as achievable
- median_miner_usd_day: 629.1053988315682
- top_miner_usd_day: 2516.4956600070864 (uid 81, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 620.8862 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 69.4 (rank 6), confidence 0.85 - hardware requirement unknown
- components: income 25.41 / freshness 35.0 / resource 11.25 / registration 9.99
