...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (24.7899997521 USD), open=True
...
- **competitive_miner_usd_day: 148.19301248360836** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 99.34177606755159
- top_miner_usd_day: 331.51755430514487 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 87.7378 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 77.6 (rank 1), confidence 1.0 
- components: income 17.72 / freshness 35.0 / resource 15.0 / registration 9.91
