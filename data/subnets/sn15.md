...
- miner_burn: **0.0**
- registration cost: 0.33946023 TAO (68.8119832233 USD), open=True
...
- **competitive_miner_usd_day: 20.838048859183974** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 10.80137394994399
- top_miner_usd_day: 11643.307593759093 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.7195 USD/day  |  payback on registration: 7.08 days

## Score

- gate: **OK** 
- score: 67.0 (rank 11), confidence 1.0 
- components: income 9.37 / freshness 35.0 / resource 15.0 / registration 7.64
