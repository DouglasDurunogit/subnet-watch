...
- **competitive_miner_usd_day: 382.4201042615483** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 20.685485038166153
- top_miner_usd_day: 2004.84915819367 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.3916 USD/day  |  payback on registration: 1.54 days

## Score

- gate: **OK** 
- score: 66.0 (rank 11), confidence 1.0 
- components: income 10.25 / freshness 35.0 / resource 11.25 / registration 9.49
