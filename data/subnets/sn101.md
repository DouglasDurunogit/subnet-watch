...
- miner_burn: **0.0**
- registration cost: 0.031700101 TAO (5.9323569011399995 USD), open=True
...
- **competitive_miner_usd_day: 18.27311673318235** (uid 73) <- the only figure quotable as achievable
- median_miner_usd_day: 11.243436570860535
- top_miner_usd_day: 18.27311673318235 (uid 73, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.2868 USD/day  |  payback on registration: 0.34 days

## Score

- gate: **OK** 
- score: 36.4 (rank 39), confidence 1.0 
- components: income 11.48 / freshness 0.0 / resource 15.0 / registration 9.89
