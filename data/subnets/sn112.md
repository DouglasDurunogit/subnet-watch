...
- registration cost: 0.99 TAO (227.4822 USD), open=True
...
- **competitive_miner_usd_day: 485.47893714235** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 1213.6788230215443
- top_miner_usd_day: 1941.8787089007387 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 477.2598 USD/day  |  payback on registration: 0.48 days
...
- components: income 24.37 / freshness 35.0 / resource 11.25 / registration 9.84
