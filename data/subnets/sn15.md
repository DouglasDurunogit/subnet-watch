...
- miner_burn: **0.0**
- registration cost: 0.272263776 TAO (53.99807469408 USD), open=True
...
- **competitive_miner_usd_day: 20.243383471821804** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 10.385735868152057
- top_miner_usd_day: 10831.266333953632 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.1354 USD/day  |  payback on registration: 5.91 days

## Score

- gate: **OK** 
- score: 67.2 (rank 12), confidence 1.0 
- components: income 9.15 / freshness 35.0 / resource 15.0 / registration 8.03
