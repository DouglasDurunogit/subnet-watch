...
- miner_burn: **0.0**
- registration cost: 0.2 TAO (39.396 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 34  |  free: 0
- subnet age: 781.1 days  |  registered at block 3219949
- weights_version: 3000  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 548.187604867805** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 15.66779617060496
- top_miner_usd_day: 548.187604867805 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 7.4828 USD/day  |  payback on registration: 5.26 days

## Score

- gate: **OK** 
- score: 66.7 (rank 15), confidence 1.0 
- components: income 8.45 / freshness 35.0 / resource 15.0 / registration 8.25
- freshness basis: WEIGHTS_VERSION_BUMP 1.0d ago
