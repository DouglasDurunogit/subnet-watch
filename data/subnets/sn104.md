...
- **competitive_miner_usd_day: 8.648692216014618** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 7.457094621808159
- top_miner_usd_day: 2399.877554731808 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.7621 USD/day  |  payback on registration: [UNKNOWN] days
