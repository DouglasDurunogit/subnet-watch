...
- subnet age: 864.5 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 675.0226110571924** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 487.99173203976636
- top_miner_usd_day: 675.0226110571924 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 50.7315 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 21.7 (rank 61), confidence 0.85 - hardware from README keywords, not curated
- components: income 15.59 / freshness 0.0 / resource 0.0 / registration 10.0
