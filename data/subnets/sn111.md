...
- subnet age: 436.8 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2867.8865876901164
- top_miner_usd_day: 2867.8865876901164 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 9486 bytes, sha 37424d755c6ef92d
- latest release: (none) 
- last commit: 2026-08-02T01:43:21Z
...
_(truncated at 6000 of 9486 chars - read the full file at https://github.com/DeSciClaims/Claims)_
