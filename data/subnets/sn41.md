...
- **competitive_miner_usd_day: 23.348277506101358** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 12.568219401533772
- top_miner_usd_day: 2355.9280539143365 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.5819 USD/day  |  payback on registration: 1.99 days

## Score

- gate: **OK** 
- score: 55.3 (rank 26), confidence 1.0 
- components: income 10.0 / freshness 21.0 / resource 15.0 / registration 9.34
