...
- subnet age: 95.4 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 341.16725573030635** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 125.08309152106041
- top_miner_usd_day: 1137.235754681073 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 112.7303 USD/day  |  payback on registration: 0.21 days

## Score

- gate: **OK** 
- score: 78.6 (rank 3), confidence 1.0 
- components: income 18.7 / freshness 35.0 / resource 15.0 / registration 9.93
