...
- miner_burn: **0.15056046098470688**
- registration cost: 0.1 TAO (25.884 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 813.0 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 122.62459733925397** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 11.488208863353313
- top_miner_usd_day: 1226.162270595721 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.897 USD/day  |  payback on registration: 28.86 days

## Score

- gate: **OK** 
- score: 52.9 (rank 32), confidence 1.0 
- components: income 2.53 / freshness 35.0 / resource 15.0 / registration 0.38
