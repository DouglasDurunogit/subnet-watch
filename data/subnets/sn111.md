...
- miner_burn: **0.0**
- registration cost: 0.778956445 TAO (169.24386680515002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 467.3 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2802.1574989668047** (uid 233) <- the only figure quotable as achievable
- median_miner_usd_day: 320.2622785691885
- top_miner_usd_day: 2802.1574989668047 (uid 233, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.5920192879923092  |  top1_share: 0.7000137335388278  |  top10_share: 1.0
...
- status: **ok** 
- README: 24722 bytes, sha 8a4be0333a4bb83c
- latest release: (none) 
- last commit: 2026-09-01T22:03:12Z
- scoring-related commit: docs(validator): update bucket policy and production setup 2026-09-01T22:03:12Z
...
- net margin: 312.0431 USD/day  |  payback on registration: 0.54 days

## Score

- gate: **OK** 
- score: 67.0 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 22.7 / freshness 35.0 / resource 11.25 / registration 9.82
...
The default profiles use Hermes. Install it expli
```

_(truncated at 6000 of 24722 chars - read the full file at https://github.com/DeSciClaims/Claims)_
