...
- miner_burn: **0.7257180635351688**
- registration cost: 0.0005 TAO (0.11651500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 16  |  free: 0
- subnet age: 636.6 days  |  registered at block 4312927
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1133.8343937617044** (uid 221) <- the only figure quotable as achievable
- median_miner_usd_day: 786.8102265401747
- top_miner_usd_day: 8339.627270787643 (uid 38, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 730.3689 USD/day  |  payback on registration: 0.0 days
