...
- subnet age: 325.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 64.80028718819167** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 3241.6961989243914
- top_miner_usd_day: 6418.592110660591 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 3338 bytes, sha cf71ad10dac7df67
- latest release: (none) 
- last commit: 2026-09-18T06:54:26Z
- scoring-related commit: Enhance tournament reward structure to support podium placements with… 2026-09-18T01:53:42Z
...
- net margin: 56.5811 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 43.3 (rank 45), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 16.01 / freshness 35.0 / resource 11.25 / registration 9.91
