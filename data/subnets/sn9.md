...
- **competitive_miner_usd_day: 2626.1142140415727** (uid 21) <- the only figure quotable as achievable
- median_miner_usd_day: 2626.1142140415727
- top_miner_usd_day: 14944.665009019358 (uid 209, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- required: 24GB consumer (~16 GB VRAM)  |  basis: **README stated VRAM (explicit)**
- cheapest satisfying machine: rtx4090 at 8.2192 USD/day
- net margin: 2617.895 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 52.3 (rank 4), confidence 1.0 
- components: income 31.09 / freshness 0.0 / resource 11.25 / registration 10.0
