...
- **competitive_miner_usd_day: 94.56943927903384** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 20.72238709301538
- top_miner_usd_day: 94.56943927903384 (uid 57, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.2065 USD/day  |  payback on registration: 2.15 days

## Score

- gate: **OK** 
- score: 25.3 (rank 68), confidence 0.85 - hardware requirement unknown
- components: income 9.18 / freshness 0.0 / resource 11.25 / registration 9.28
