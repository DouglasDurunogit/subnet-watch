...
- **competitive_miner_usd_day: 28.033948022777015** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.052784232190492
- top_miner_usd_day: 2267.7764923273708 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.0028 USD/day  |  payback on registration: 3.79 days

## Score

- gate: **OK** 
- score: 65.8 (rank 10), confidence 1.0 
- components: income 7.08 / freshness 35.0 / resource 15.0 / registration 8.74
