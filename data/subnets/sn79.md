...
- miner_burn: **0.0**
- registration cost: 0.216019583 TAO (42.562338438489995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 226  |  free: 0
- subnet age: 512.5 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 303.1657718257083** (uid 92) <- the only figure quotable as achievable
- median_miner_usd_day: 5.757140250466622
- top_miner_usd_day: 303.1657718257083 (uid 92, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 225  |  gini: 0.7245209696821413  |  top1_share: 0.07086060309499052  |  top10_share: 0.4744785613799009
...
- net margin: 4.7708 USD/day  |  payback on registration: 8.92 days

## Score

- gate: **OK** 
- score: 29.0 (rank 56), confidence 1.0 
- components: income 6.92 / freshness 0.0 / resource 15.0 / registration 7.03
