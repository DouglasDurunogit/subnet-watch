...
- subnet age: 650.0 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 234.9034690666689** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 43.69615092501081
- top_miner_usd_day: 12013.508876799115 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.7174 USD/day  |  payback on registration: 0.0 days
