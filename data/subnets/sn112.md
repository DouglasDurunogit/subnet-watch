...
- registration cost: 0.99 TAO (221.2947 USD), open=True
...
- **competitive_miner_usd_day: 303.4078219276021** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 758.5079805525091
- top_miner_usd_day: 1213.6081391774162 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 295.1886 USD/day  |  payback on registration: 0.75 days
...
- components: income 22.48 / freshness 35.0 / resource 11.25 / registration 9.75
