...
- registration cost: 0.010869424 TAO (2.62833541744 USD), open=True
...
- **competitive_miner_usd_day: 2.317925975137408** (uid 11) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0581835973453384
- top_miner_usd_day: 2987.6554128667844 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 227  |  gini: 0.9255190241864482  |  top1_share: 0.9063407624812743  |  top10_share: 0.91266929591244
- owner_incentive_share: 0.9063407624812743 (independent check on miner_burn; disagreement 0.0016)
...
- net margin: 0.0719 USD/day  |  payback on registration: 36.56 days

## Score

- gate: **OK** 
- score: 36.3 (rank 50), confidence 1.0 
- components: income 0.27 / freshness 21.0 / resource 15.0 / registration 0.0
