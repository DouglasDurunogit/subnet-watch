...
- miner_burn: **0.0**
- registration cost: 0.03147507 TAO (8.290533437999999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 216  |  free: 0
- subnet age: 545.8 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 256.53657834257433** (uid 31) <- the only figure quotable as achievable
- median_miner_usd_day: 3.3207383299812485
- top_miner_usd_day: 256.53657834257433 (uid 31, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 215  |  gini: 0.7431974629245608  |  top1_share: 0.10272674471922477  |  top10_share: 0.5085898572432979
...
- net margin: 2.3344 USD/day  |  payback on registration: 3.55 days

## Score

- gate: **OK** 
- score: 49.6 (rank 33), confidence 1.0 
- components: income 4.76 / freshness 21.0 / resource 15.0 / registration 8.82
