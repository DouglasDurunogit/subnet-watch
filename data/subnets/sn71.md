...
- subnet age: 559.3 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2916.0634422098956
- top_miner_usd_day: 2916.0634422098956 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
_(truncated at 6000 of 16875 chars - read the full file at https://github.com/leadpoet/leadpoet)_
