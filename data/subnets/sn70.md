...
- miner_burn: **0.0**
- registration cost: 0.9 TAO (178.596 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 143.9 days  |  registered at block 7787562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 50.27792488957518** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 100.5796443484308
- top_miner_usd_day: 402.40185838620476 (uid 26, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 29.5428 USD/day  |  payback on registration: 6.05 days

## Score

- gate: **OK** 
- score: 19.6 (rank 71), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 13.51 / freshness 0.0 / resource 11.25 / registration 7.98
