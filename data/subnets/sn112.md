...
- **competitive_miner_usd_day: 249.80239004050773** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 642.385411588237
- top_miner_usd_day: 1034.9684331359663 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 241.5832 USD/day  |  payback on registration: 0.8 days
