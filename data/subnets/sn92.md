...
- subnet age: 99.6 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 592.8595475824874** (uid 44) <- the only figure quotable as achievable
- median_miner_usd_day: 197.6097973198393
- top_miner_usd_day: 592.8595475824874 (uid 44, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 196.6235 USD/day  |  payback on registration: 0.12 days

## Score

- gate: **OK** 
- score: 80.8 (rank 1), confidence 1.0 
- components: income 20.88 / freshness 35.0 / resource 15.0 / registration 9.96
