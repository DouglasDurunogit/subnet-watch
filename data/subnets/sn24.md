...
- subnet age: 866.0 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 917.0703767492151** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 662.9744755532248
- top_miner_usd_day: 917.0703767492151 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 225.7142 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 26.7 (rank 63), confidence 0.85 - hardware from README keywords, not curated
- components: income 21.42 / freshness 0.0 / resource 0.0 / registration 10.0
