...
- **competitive_miner_usd_day: 3565.641046501599** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 1800.819374076633
- top_miner_usd_day: 3565.641046501599 (uid 90, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3557.4219 USD/day  |  payback on registration: 0.0 days
...
- components: income 32.3 / freshness 21.0 / resource 11.25 / registration 10.0
