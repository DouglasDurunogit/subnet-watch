...
- miner_burn: **0.0**
- registration cost: 0.415145781 TAO (79.67892974733 USD), open=True
...
- **competitive_miner_usd_day: 12379.499659911558** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.394937111262962
- top_miner_usd_day: 12379.499659911558 (uid 253, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10.3087 USD/day  |  payback on registration: 7.73 days

## Score

- gate: **OK** 
- score: 67.0 (rank 12), confidence 1.0 
- components: income 9.58 / freshness 35.0 / resource 15.0 / registration 7.42
