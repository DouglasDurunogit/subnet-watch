...
- **competitive_miner_usd_day: 112.86334623364299** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 2.557443643197678
- top_miner_usd_day: 592.8619354685525 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.6876 USD/day  |  payback on registration: [UNKNOWN] days
