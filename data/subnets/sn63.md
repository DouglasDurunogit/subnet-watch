...
- subnet age: 567.0 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.08568506546018878** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 2807.642539934005
- top_miner_usd_day: 5615.19939480255 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1335 USD/day  |  payback on registration: [UNKNOWN] days
