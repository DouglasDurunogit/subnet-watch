...
- subnet age: 325.9 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3446.444389842219
- top_miner_usd_day: 3446.444389842219 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-10T21:13:14Z
- scoring-related commit: fix(proof): tbench agent network, custom Python harness, <1h tasks (#… 2026-09-10T20:16:11Z
