...
- miner_burn: **0.0**
- registration cost: 0.000834556 TAO (0.20264688792 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 25  |  free: 0
- subnet age: 629.8 days  |  registered at block 4474225
- weights_version: 6  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2152.6943259332666** (uid 107) <- the only figure quotable as achievable
- median_miner_usd_day: 432.25445664529735
- top_miner_usd_day: 2152.6943259332666 (uid 107, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.38517297684994434  |  top1_share: 0.2642494162889713  |  top10_share: 0.9140991011613179
...
- latest release: v0.3.0 2026-09-05T01:37:41Z
- last commit: 2026-09-05T01:59:48Z
- scoring-related commit: test: :white_check_mark: Add tests validating the new endpoint 2026-09-04T10:45:00Z
...
- net margin: 424.0353 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 68.1 (rank 10), confidence 0.85 - hardware requirement unknown
- components: income 23.91 / freshness 35.0 / resource 11.25 / registration 10.0
