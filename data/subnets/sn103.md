...
- miner_burn: **0.0**
- registration cost: 0.959996623 TAO (180.26816586694 USD), open=True
...
- **competitive_miner_usd_day: 5.184868508276512** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 5.16594563050908
- top_miner_usd_day: 5.184868508276512 (uid 36, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.0343 USD/day  |  payback on registration: [UNKNOWN] days
