...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (2.2300999999999997 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 113  |  free: 0
- subnet age: 512.1 days  |  registered at block 5299805
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 351.1400908244625** (uid 54) <- the only figure quotable as achievable
- median_miner_usd_day: 4.828742117053202
- top_miner_usd_day: 351.1400908244625 (uid 54, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 101  |  gini: 0.7900948064293758  |  top1_share: 0.1421481040301767  |  top10_share: 0.6734319879048883
...
- net margin: -3.4659 USD/day  |  payback on registration: [UNKNOWN] days
