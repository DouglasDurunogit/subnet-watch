...
- miner_burn: **0.30638294224627316**
- registration cost: 0.75 TAO (245.36249999999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 110  |  free: 0
- subnet age: 164.9 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 50.77867650249478** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 29.55013281416084
- top_miner_usd_day: 1136.6045337983169 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 20.963 USD/day  |  payback on registration: 11.7 days

## Score

- gate: **OK** 
- score: 54.9 (rank 26), confidence 0.85 - hardware requirement unknown
- components: income 12.2 / freshness 35.0 / resource 11.25 / registration 6.1
