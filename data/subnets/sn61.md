...
- miner_burn: **0.0**
- registration cost: 0.000575468 TAO (0.1269770142 USD), open=True
...
- **competitive_miner_usd_day: 285.11617522814953** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 27.05687144758135
- top_miner_usd_day: 285.11617522814953 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.8377 USD/day  |  payback on registration: 0.01 days
