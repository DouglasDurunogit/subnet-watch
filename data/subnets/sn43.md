...
- **competitive_miner_usd_day: 16.66794248762923** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9028468847465835
- top_miner_usd_day: 2437.8254883365053 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7548 USD/day  |  payback on registration: [UNKNOWN] days
