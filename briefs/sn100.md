...
**sn100 "BASE"** (დ), 281.3 days old. Snapshot 2026-07-28T06:37:33Z b8718699.

- on-chain repo: `https://github.com/BaseIntelligence/base`
- resolved: `https://github.com/BaseIntelligence/base` — **ok**

On-chain description: _Verifiable AI research network_ [VERIFIED: pack sn100, 2026-07-28]
...
- cheapest satisfying machine: **RTX 4090 (24 GB)** — $250.0/mo, 24 GB VRAM, 8 vCPU, 32 GB RAM, 1000 Mbps [margin:100.rtx4090]
...
**Miners earn nothing here.** `miner_burn` is 1.000 — 100.0% of miner emission is withheld by owner-controlled hotkeys and destroyed. [VERIFIED: pack sn100, 2026-07-28]
...
_Assembled from `data/subnets/sn100.md` and the repo README. Every claim is either quoted with a [VERIFIED] tag or marked [UNKNOWN]. Regenerate when this subnet appears in ALARMS.md under NEW SINCE LAST RUN._
