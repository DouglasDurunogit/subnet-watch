...
- **competitive_miner_usd_day: 6.505609794878896** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 5.431868372423156
- top_miner_usd_day: 2908.07073957101 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.7873 USD/day  |  payback on registration: [UNKNOWN] days
