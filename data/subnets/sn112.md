...
- subnet age: 445.7 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 289.93539905049164** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 724.8274372997225
- top_miner_usd_day: 1159.7194755489531 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 281.7162 USD/day  |  payback on registration: 0.7 days
...
- components: income 22.3 / freshness 21.0 / resource 11.25 / registration 9.77
