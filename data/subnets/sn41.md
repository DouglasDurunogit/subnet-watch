...
- subnet age: 782.2 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 120.0870745622368** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 43.87582529270211
- top_miner_usd_day: 120.0870745622368 (uid 234, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 85  |  gini: 0.22492545570811684  |  top1_share: 0.032887504580432395  |  top10_share: 0.20011909124221325
...
- net margin: 42.8895 USD/day  |  payback on registration: 0.61 days

## Score

- gate: **OK** 
- score: 60.7 (rank 19), confidence 1.0 
- components: income 14.94 / freshness 21.0 / resource 15.0 / registration 9.8
