...
- miner_burn: **0.0**
- registration cost: 0.077914354 TAO (15.45742869006 USD), open=True
...
- **competitive_miner_usd_day: 1762.1653991606968** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 1762.1653991606968
- top_miner_usd_day: 4581.759110544357 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1225.2858 USD/day  |  payback on registration: 0.01 days
...
- components: income 28.09 / freshness 35.0 / resource 11.25 / registration 10.0
