...
- miner_burn: **0.0**
- registration cost: 0.464902792 TAO (102.49246952432 USD), open=True
...
- **competitive_miner_usd_day: 37.51553193866696** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 18.929855565382415
- top_miner_usd_day: 21448.558893154568 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.5994 USD/day  |  payback on registration: 5.82 days

## Score

- gate: **OK** 
- score: 69.6 (rank 7), confidence 1.0 
- components: income 11.55 / freshness 35.0 / resource 15.0 / registration 8.06
