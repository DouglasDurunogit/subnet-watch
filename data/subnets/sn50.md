...
- registration cost: 0.8 TAO (168.376 USD), open=True
...
- **competitive_miner_usd_day: 44.41675647002019** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.611229716477881
- top_miner_usd_day: 44.41675647002019 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.3921 USD/day  |  payback on registration: 49.64 days

## Score

- gate: **OK** 
- score: 32.4 (rank 56), confidence 0.85 - hardware requirement unknown
- components: income 5.85 / freshness 21.0 / resource 11.25 / registration 0.0
