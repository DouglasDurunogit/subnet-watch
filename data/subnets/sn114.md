...
- subnet age: 196.0 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1722.3410467905558** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 1722.3410467905558
- top_miner_usd_day: 4478.212877381268 (uid 121, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1197.409 USD/day  |  payback on registration: 0.01 days
...
- components: income 28.0 / freshness 0.0 / resource 11.25 / registration 10.0
