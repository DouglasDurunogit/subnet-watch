...
- subnet age: 525.8 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 132.60257867691854** (uid 85) <- the only figure quotable as achievable
- median_miner_usd_day: 24.931932430102822
- top_miner_usd_day: 132.60257867691854 (uid 85, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 239  |  gini: 0.3851866766024048  |  top1_share: 0.018373866919396506  |  top10_share: 0.13317231996820494
...
- net margin: 16.7128 USD/day  |  payback on registration: 1.56 days

## Score

- gate: **OK** 
- score: 27.3 (rank 75), confidence 0.85 - hardware requirement unknown
- components: income 11.35 / freshness 0.0 / resource 11.25 / registration 9.48
