...
- miner_burn: **0.0**
- registration cost: 0.120078604 TAO (23.6134574766 USD), open=True
...
- **competitive_miner_usd_day: 2668.759097250362** (uid 31) <- the only figure quotable as achievable
- median_miner_usd_day: 785.4253975144193
- top_miner_usd_day: 2668.759097250362 (uid 31, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.44281136509292907  |  top1_share: 0.47788933988464005  |  top10_share: 1.0
...
- net margin: 777.2062 USD/day  |  payback on registration: 0.03 days
