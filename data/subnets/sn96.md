...
- **competitive_miner_usd_day: 209.04049478526503** (uid 189) <- the only figure quotable as achievable
- median_miner_usd_day: 32.84288028473379
- top_miner_usd_day: 2347.4670594866748 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 24.6237 USD/day  |  payback on registration: 0.98 days

## Score

- gate: **OK** 
- score: 68.7 (rank 11), confidence 1.0 
- components: income 12.81 / freshness 35.0 / resource 11.25 / registration 9.67
