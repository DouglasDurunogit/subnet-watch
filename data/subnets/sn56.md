...
- subnet age: 666.9 days  |  registered at block 4312927
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1966.8861895509128** (uid 12) <- the only figure quotable as achievable
- median_miner_usd_day: 491.7215473877282
- top_miner_usd_day: 5718.9437133291585 (uid 148, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 9  |  gini: 0.5658489276818972  |  top1_share: 0.45575511574321337  |  top10_share: 1.0
...
- status: **ok** 
- README: 3888 bytes, sha 13549c984ad47938
- latest release: (none) 
- last commit: 2026-09-20T21:53:45Z
- scoring-related commit: Update autoupdate_validator_steps.sh to ensure proper package managem… 2026-09-17T15:30:38Z
...
- net margin: 472.1093 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 68.5 (rank 5), confidence 0.85 - hardware requirement unknown
- components: income 24.33 / freshness 35.0 / resource 11.25 / registration 10.0
