...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (10.8975 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 19  |  free: 80
- subnet age: 260.6 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 47.199922940456105** (uid 172) <- the only figure quotable as achievable
- median_miner_usd_day: 154.99058465558804
- top_miner_usd_day: 660.026671118276 (uid 168, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 37.776 USD/day  |  payback on registration: 0.29 days
...
- components: income 14.45 / freshness 35.0 / resource 11.25 / registration 9.9
