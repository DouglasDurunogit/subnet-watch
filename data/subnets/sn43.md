...
- registration cost: 0.1 TAO (22.21 USD), open=True
...
- **competitive_miner_usd_day: 183.58380742482106** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.10961540158489
- top_miner_usd_day: 2608.542910000914 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.2484 USD/day  |  payback on registration: [UNKNOWN] days
