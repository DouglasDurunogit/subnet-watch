...
- subnet age: 679.6 days  |  registered at block 4165565
- weights_version: 2000  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4214.115815865675** (uid 170) <- the only figure quotable as achievable
- median_miner_usd_day: 4214.115815865675
- top_miner_usd_day: 4214.115815865675 (uid 56, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4205.8966 USD/day  |  payback on registration: 0.06 days
...
- components: income 32.96 / freshness 21.0 / resource 11.25 / registration 9.98
