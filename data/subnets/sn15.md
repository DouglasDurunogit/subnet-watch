...
- miner_burn: **0.0**
- registration cost: 0.25104889 TAO (47.02145709700001 USD), open=True
...
- **competitive_miner_usd_day: 10519.496767980574** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 10.573926487934859
- top_miner_usd_day: 10519.496767980574 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.5876 USD/day  |  payback on registration: 4.9 days

## Score

- gate: **OK** 
- score: 32.7 (rank 23), confidence 1.0 
- components: income 9.32 / freshness 0.0 / resource 15.0 / registration 8.37
