...
- miner_burn: **0.0**
- registration cost: 0.383365914 TAO (74.92886789129999 USD), open=True
...
- **competitive_miner_usd_day: 21.882970610644236** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.744530098373284
- top_miner_usd_day: 12379.738529676755 (uid 13, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.7582 USD/day  |  payback on registration: 6.96 days

## Score

- gate: **OK** 
- score: 67.4 (rank 11), confidence 1.0 
- components: income 9.73 / freshness 35.0 / resource 15.0 / registration 7.68
