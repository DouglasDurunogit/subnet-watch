...
- tempo: 360.0  |  max_uids: 256  |  active: 14  |  free: 127
- subnet age: 228.4 days  |  registered at block 7340355
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1845.9912754479724
- top_miner_usd_day: 1845.9912754479724 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 8011 bytes, sha e0c89eba4fae5ee9
- latest release: (none) 
- last commit: 2026-08-29T06:50:23Z
...
math tooling, and the instruct
```

_(truncated at 6000 of 8011 chars - read the full file at https://github.com/center196/feval)_
