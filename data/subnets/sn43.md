...
- registration cost: 0.1 TAO (24.14 USD), open=True
...
- **competitive_miner_usd_day: 200.61326346555194** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0158987222402684
- top_miner_usd_day: 2831.790954067847 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4784 USD/day  |  payback on registration: [UNKNOWN] days
