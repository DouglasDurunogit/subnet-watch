...
- miner_burn: **0.0**
- registration cost: 0.221243486 TAO (44.908002788279994 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 83  |  free: 0
- subnet age: 199.5 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 20.712899303861843** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 10.626617903720424
- top_miner_usd_day: 11082.481800573245 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.3701 USD/day  |  payback on registration: 4.79 days

## Score

- gate: **OK** 
- score: 67.6 (rank 14), confidence 1.0 
- components: income 9.24 / freshness 35.0 / resource 15.0 / registration 8.4
