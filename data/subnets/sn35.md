...
- subnet age: 827.7 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1392.1325263994224** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 791.3537895760089
- top_miner_usd_day: 1392.1325263994224 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 783.1346 USD/day  |  payback on registration: 0.03 days
...
- components: income 26.32 / freshness 35.0 / resource 11.25 / registration 9.99
