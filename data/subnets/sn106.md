...
- **competitive_miner_usd_day: 285.802469065683** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 46.61567168876065
- top_miner_usd_day: 335.4205937893666 (uid 204, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.1377 USD/day  |  payback on registration: 0.0 days
