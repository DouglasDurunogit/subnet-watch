...
- **competitive_miner_usd_day: 8.590608042621152** (uid 59) <- the only figure quotable as achievable
- median_miner_usd_day: 6.476688786059928
- top_miner_usd_day: 2808.0943588115656 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.7875 USD/day  |  payback on registration: [UNKNOWN] days
