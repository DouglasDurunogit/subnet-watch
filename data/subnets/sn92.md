...
- subnet age: 82.5 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1212.2869504279283** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 124.68116273333192
- top_miner_usd_day: 3428.1434863557397 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 66.4545 USD/day  |  payback on registration: 0.35 days

## Score

- gate: **OK** 
- score: 76.5 (rank 1), confidence 1.0 
- components: income 16.64 / freshness 35.0 / resource 15.0 / registration 9.88
