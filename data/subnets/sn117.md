...
- tempo: 360.0  |  max_uids: 256  |  active: 9  |  free: 129
- subnet age: 417.8 days  |  registered at block 5710859
- weights_version: 1030  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1772.9043876846188
- top_miner_usd_day: 1772.9043876846188 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 9.6 (rank 85), confidence 0.85 - hardware from README keywords, not curated
