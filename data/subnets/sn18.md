...
- registration cost: 0.999999999 TAO (192.12999980787 USD), open=True
...
- **competitive_miner_usd_day: 982.1963854342634** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 2.7229589136105217
- top_miner_usd_day: 982.1963854342634 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.5542 USD/day  |  payback on registration: [UNKNOWN] days
