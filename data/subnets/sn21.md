...
- miner_burn: **0.15055559994652867**
- registration cost: 0.1 TAO (25.340000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 42  |  free: 0
- subnet age: 816.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 30.600403978322365** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 11.475151491870886
- top_miner_usd_day: 1224.8104319137528 (uid 110, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826530690107742  |  top1_share: 0.447135488203156  |  top10_share: 0.9986875438757135
...
- last commit: 2026-09-09T09:54:52Z
...
- net margin: 0.4141 USD/day  |  payback on registration: 61.19 days

## Score

- gate: **OK** 
- score: 51.4 (rank 32), confidence 1.0 
- components: income 1.37 / freshness 35.0 / resource 15.0 / registration 0.0
