...
- miner_burn: **0.0**
- registration cost: 0.096511836 TAO (18.602656389 USD), open=True
...
- **competitive_miner_usd_day: 380.75325809983195** (uid 117) <- the only figure quotable as achievable
- median_miner_usd_day: 6.253621094262183
- top_miner_usd_day: 380.75325809983195 (uid 117, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 214  |  gini: 0.7312885130165654  |  top1_share: 0.08517957891839824  |  top10_share: 0.480375517942602
...
- net margin: 5.2673 USD/day  |  payback on registration: 3.53 days

## Score

- gate: **OK** 
- score: 31.1 (rank 49), confidence 1.0 
- components: income 7.25 / freshness 0.0 / resource 15.0 / registration 8.82
