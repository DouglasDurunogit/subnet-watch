...
- miner_burn: **0.0**
- registration cost: 0.000564149 TAO (0.1107988636 USD), open=True
...
- **competitive_miner_usd_day: 42.79843186733265** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 42.79843186733265
- top_miner_usd_day: 4196.4025798713055 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.5793 USD/day  |  payback on registration: 0.0 days
