...
- **competitive_miner_usd_day: 242.33712771153674** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 45.07894135957426
- top_miner_usd_day: 12393.683441576904 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 35.0445 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.8 (rank 16), confidence 0.85 - hardware from README keywords, not curated
