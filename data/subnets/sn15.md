...
- miner_burn: **0.0**
- registration cost: 0.453535411 TAO (105.68735682533 USD), open=True
...
- **competitive_miner_usd_day: 44.48152189630947** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 26.41090362593374
- top_miner_usd_day: 24074.829413486492 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 25.4246 USD/day  |  payback on registration: 4.16 days

## Score

- gate: **OK** 
- score: 71.5 (rank 6), confidence 1.0 
- components: income 12.93 / freshness 35.0 / resource 15.0 / registration 8.61
