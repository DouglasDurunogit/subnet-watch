...
- **competitive_miner_usd_day: 905.6874048858971** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 8.471917277212833
- top_miner_usd_day: 905.6874048858971 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.0469 USD/day  |  payback on registration: 481.77 days

## Score

- gate: **OK** 
- score: 50.2 (rank 31), confidence 1.0 
- components: income 0.18 / freshness 35.0 / resource 15.0 / registration 0.0
