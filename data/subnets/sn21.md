...
- **competitive_miner_usd_day: 1156.1943203421679** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 10.832662329644517
- top_miner_usd_day: 1156.1943203421679 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.8464 USD/day  |  payback on registration: 2.34 days

## Score

- gate: **OK** 
- score: 68.6 (rank 12), confidence 1.0 
- components: income 9.42 / freshness 35.0 / resource 15.0 / registration 9.22
