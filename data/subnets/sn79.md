...
- miner_burn: **0.0**
- registration cost: 0.135813039 TAO (25.432349683139996 USD), open=True
...
- **competitive_miner_usd_day: 677.1368755721197** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 3.2880395664920465
- top_miner_usd_day: 677.1368755721197 (uid 13, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 676.1506 USD/day  |  payback on registration: 0.04 days

## Score

- gate: **OK** 
- score: 50.7 (rank 4), confidence 1.0 
- components: income 25.75 / freshness 0.0 / resource 15.0 / registration 9.99
