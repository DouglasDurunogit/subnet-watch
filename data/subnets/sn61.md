...
- miner_burn: **0.0**
- registration cost: 0.006404657 TAO (1.31628510664 USD), open=True
...
- **competitive_miner_usd_day: 263.8892547188489** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 28.82620718082665
- top_miner_usd_day: 263.8892547188489 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 20.607 USD/day  |  payback on registration: 0.06 days
