...
- miner_burn: **0.45060967886820436**
...
- **competitive_miner_usd_day: 23.11573467240363** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.778933668100907
- top_miner_usd_day: 884.2067938809316 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.7926 USD/day  |  payback on registration: 4.32 days

## Score

- gate: **OK** 
- score: 65.5 (rank 14), confidence 1.0 
- components: income 6.94 / freshness 35.0 / resource 15.0 / registration 8.56
