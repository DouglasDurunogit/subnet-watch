...
- **competitive_miner_usd_day: 65.86773946913027** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 65.86773946913027
- top_miner_usd_day: 6453.833570301549 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 54.9375 USD/day  |  payback on registration: 0.2 days
...
- components: income 15.9 / freshness 21.0 / resource 11.25 / registration 9.93
