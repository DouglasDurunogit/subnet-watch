...
- miner_burn: **0.011721120215952396**
- registration cost: 0.005 TAO (1.1842000000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 16  |  free: 0
- subnet age: 510.6 days  |  registered at block 5370681
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 4278.393420283272** (uid 153) <- the only figure quotable as achievable
- median_miner_usd_day: 4278.393420283272
- top_miner_usd_day: 9059.821902169364 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.29903052868231295  |  top1_share: 0.5859248634296701  |  top10_share: 1.0
- owner_incentive_share: 0.5859248634296701 (independent check on miner_burn; disagreement 0.5742)  <- the two burn measures DISAGREE; the burn picture is shifting, treat both as provisional
...
- status: **ok** 
- README: 4329 bytes, sha cbe914d8947358c8
- latest release: (none) 
- last commit: 2026-09-06T20:55:58Z
- scoring-related commit: chore: scope validator deploy to code/config paths (#171) 2026-09-06T20:14:30Z
...
- net margin: 3193.0846 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 52.9 (rank 29), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 31.87 / freshness 35.0 / resource 11.25 / registration 10.0
