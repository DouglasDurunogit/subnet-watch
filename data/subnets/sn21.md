...
- **competitive_miner_usd_day: 24.795388689853105** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.170148805924094
- top_miner_usd_day: 847.7784459339704 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.1838 USD/day  |  payback on registration: 3.7 days

## Score

- gate: **OK** 
- score: 31.0 (rank 46), confidence 1.0 
- components: income 7.2 / freshness 0.0 / resource 15.0 / registration 8.77
