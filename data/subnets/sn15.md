...
- miner_burn: **0.0**
- registration cost: 0.208111008 TAO (39.060355091519995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 92  |  free: 0
- subnet age: 187.8 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 9969.985598795682** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 9.840420067901647
- top_miner_usd_day: 9969.985598795682 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 81  |  gini: 0.9392672971837854  |  top1_share: 0.9282049715995846  |  top10_share: 0.9434282049715995
...
- latest release: v1.2.1 2026-07-27T21:01:04Z
- last commit: 2026-07-27T21:01:04Z
- scoring-related commit: fix(validator): bump container to Python 3.11 (fromisoformat Z-suffix… 2026-07-21T05:57:16Z
...
- net margin: 9961.7664 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 49.0 (rank 3), confidence 0.85 - hardware requirement unknown
- components: income 36.37 / freshness 0.0 / resource 11.25 / registration 10.0
