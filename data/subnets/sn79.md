...
- miner_burn: **0.0**
- registration cost: 0.158961716 TAO (31.412424698760002 USD), open=True
...
- **competitive_miner_usd_day: 418.5960794206384** (uid 92) <- the only figure quotable as achievable
- median_miner_usd_day: 5.913328535567624
- top_miner_usd_day: 418.5960794206384 (uid 92, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.927 USD/day  |  payback on registration: 6.38 days

## Score

- gate: **OK** 
- score: 29.9 (rank 55), confidence 1.0 
- components: income 7.03 / freshness 0.0 / resource 15.0 / registration 7.87
