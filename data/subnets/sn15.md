...
- miner_burn: **0.0**
- registration cost: 0.262449055 TAO (49.3299243778 USD), open=True
...
- **competitive_miner_usd_day: 10674.957214273041** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 10.730191313822884
- top_miner_usd_day: 10674.957214273041 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.7439 USD/day  |  payback on registration: 5.06 days

## Score

- gate: **OK** 
- score: 32.7 (rank 21), confidence 1.0 
- components: income 9.38 / freshness 0.0 / resource 15.0 / registration 8.31
