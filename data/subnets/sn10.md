...
- subnet age: 834.1 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3873.1617926839904
- top_miner_usd_day: 3873.1617926839904 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 3225 bytes, sha b4ae09820ea6239f
- latest release: (none) 
- last commit: 2026-08-18T21:17:52Z
- scoring-related commit: feat: better miner commit patch logs (#83) 2026-08-17T16:31:51Z
