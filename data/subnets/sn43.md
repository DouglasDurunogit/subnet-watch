...
- registration cost: 0.1 TAO (19.235 USD), open=True
...
- **competitive_miner_usd_day: 23.290784181737727** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7688220021156142
- top_miner_usd_day: 2380.001569608019 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.828 USD/day  |  payback on registration: [UNKNOWN] days
