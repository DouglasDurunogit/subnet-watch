...
- miner_burn: **0.0**
- registration cost: 0.383339829 TAO (80.30202737892 USD), open=True
...
- **competitive_miner_usd_day: 18531.489282394563** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 19.619124496679216
- top_miner_usd_day: 18531.489282394563 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.6328 USD/day  |  payback on registration: 4.31 days

## Score

- gate: **OK** 
- score: 70.3 (rank 4), confidence 1.0 
- components: income 11.76 / freshness 35.0 / resource 15.0 / registration 8.56
