...
- registration cost: 0.8 TAO (157.16 USD), open=True
...
- **competitive_miner_usd_day: 45.96259441552658** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 12.063427628897108
- top_miner_usd_day: 45.96259441552658 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.8442 USD/day  |  payback on registration: 40.88 days

## Score

- gate: **OK** 
- score: 32.7 (rank 53), confidence 0.85 - hardware requirement unknown
- components: income 6.23 / freshness 21.0 / resource 11.25 / registration 0.0
