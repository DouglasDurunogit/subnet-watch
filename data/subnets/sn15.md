...
- miner_burn: **0.0**
- registration cost: 0.209752213 TAO (39.39356312353 USD), open=True
...
- **competitive_miner_usd_day: 11213.304572383062** (uid 215) <- the only figure quotable as achievable
- median_miner_usd_day: 11.795718156352992
- top_miner_usd_day: 11213.304572383062 (uid 215, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10.8094 USD/day  |  payback on registration: 3.64 days

## Score

- gate: **OK** 
- score: 68.5 (rank 7), confidence 1.0 
- components: income 9.75 / freshness 35.0 / resource 15.0 / registration 8.79
