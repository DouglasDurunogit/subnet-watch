...
- subnet age: 429.2 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1642.9436886694032** (uid 127) <- the only figure quotable as achievable
- median_miner_usd_day: 1095.284650294609
- top_miner_usd_day: 1642.9436886694032 (uid 127, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1634.7245 USD/day  |  payback on registration: 0.12 days
...
- components: income 29.23 / freshness 0.0 / resource 11.25 / registration 9.96
