...
- miner_burn: **0.0**
- registration cost: 0.172414974 TAO (33.75195531024 USD), open=True
...
- **competitive_miner_usd_day: 413.533747000469** (uid 92) <- the only figure quotable as achievable
- median_miner_usd_day: 5.910487178543525
- top_miner_usd_day: 413.533747000469 (uid 92, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.9242 USD/day  |  payback on registration: 6.85 days

## Score

- gate: **OK** 
- score: 29.7 (rank 54), confidence 1.0 
- components: income 7.03 / freshness 0.0 / resource 15.0 / registration 7.72
