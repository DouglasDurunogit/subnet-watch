...
- subnet age: 302.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 61.29525238316834** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 3066.35348830424
- top_miner_usd_day: 6071.411724225311 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 53.0761 USD/day  |  payback on registration: 0.22 days
...
- components: income 15.76 / freshness 10.5 / resource 11.25 / registration 9.93
