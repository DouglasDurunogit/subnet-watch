...
- **competitive_miner_usd_day: 5.416330591705809** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.1425503228644
- top_miner_usd_day: 870.548761569569 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.3363 USD/day  |  payback on registration: [UNKNOWN] days
