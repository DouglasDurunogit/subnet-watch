...
- subnet age: 33.7 days  |  registered at block 8884359
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 8561.878305064007
- top_miner_usd_day: 8561.878305064007 (uid 23, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 24.2 (rank 79), confidence 0.85 - hardware from README keywords, not curated
