...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9715 USD), open=True
...
- **competitive_miner_usd_day: 872.5515956209058** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 2.6099346440500653
- top_miner_usd_day: 872.5515956209058 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.6092 USD/day  |  payback on registration: [UNKNOWN] days
