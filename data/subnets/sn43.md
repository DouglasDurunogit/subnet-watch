...
- registration cost: 0.1 TAO (22.052000000000003 USD), open=True
...
- **competitive_miner_usd_day: 181.8121569357931** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0457560382502478
- top_miner_usd_day: 2656.6685183148793 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.4883 USD/day  |  payback on registration: [UNKNOWN] days
