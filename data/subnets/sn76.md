...
- subnet age: 170.6 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 198.1909534350987** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 125.65703198762802
- top_miner_usd_day: 495.5004505050459 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 65.4234 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.6 (rank 3), confidence 1.0 
- components: income 16.57 / freshness 35.0 / resource 15.0 / registration 10.0
