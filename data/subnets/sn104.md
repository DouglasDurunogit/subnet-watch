...
- miner_burn: **0.9881105402018875**
- registration cost: 0.5 TAO (142.275 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 16  |  free: 0
- subnet age: 498.3 days  |  registered at block 5528520
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 42.02208756143058** (uid 26) <- the only figure quotable as achievable
- median_miner_usd_day: 1767.5709154369654
- top_miner_usd_day: 3493.1197433125 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.488113040559099  |  top1_share: 0.988113040559099  |  top10_share: 1.0
- owner_incentive_share: 0.9881130405590991 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 10828 bytes, sha 4c3f8847bfc11502
- latest release: (none) 
- last commit: 2026-09-21T07:43:52Z
- scoring-related commit: Merge pull request #13 from taostatus/feat/scoring-mech 2026-09-18T10:58:29Z
...
- net margin: 41.0358 USD/day  |  payback on registration: 3.47 days

## Score

- gate: **OK** 
- score: 62.6 (rank 11), confidence 0.85 - income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 14.77 / freshness 35.0 / resource 15.0 / registration 8.84
...
_(truncated at 6000 of 10828 chars - read the full file at https://github.com/taostatus/taostatus-subnet)_
