...
- registration cost: 0.280615403 TAO (53.86973891391 USD), open=True
...
- median_miner_usd_day: 1793.889525128892
- top_miner_usd_day: 1793.889525128892 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 7131 bytes, sha 6a4142533bb1a8f7
- latest release: (none) 
- last commit: 2026-08-18T10:36:25Z
- scoring-related commit: docs(miner): drop the second artefact that was never built 2026-08-15T20:13:27Z
...
```bash
cp configs/testnet.example.toml ~/prometheon-
```

_(truncated at 6000 of 7131 chars - read the full file at https://github.com/BitSpaceorganization/prometheon_v2)_
