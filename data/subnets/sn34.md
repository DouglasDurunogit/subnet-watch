...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (122.275 USD), open=True
...
- **competitive_miner_usd_day: 352.9471338472537** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 12.045977264411388
- top_miner_usd_day: 3530.140559431671 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -17.9446 USD/day  |  payback on registration: [UNKNOWN] days
