...
- miner_burn: **0.6223874816205353**
- registration cost: 0.1 TAO (23.514 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 100  |  free: 0
- subnet age: 771.1 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 34.63388868534836** (uid 167) <- the only figure quotable as achievable
- median_miner_usd_day: 13.72874866806602
- top_miner_usd_day: 2121.0916692162 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 92  |  gini: 0.7682134802592142  |  top1_share: 0.6228221533387287  |  top10_share: 0.7053856372825972
- owner_incentive_share: 0.6228221533387287 (independent check on miner_burn; disagreement 0.0004)
...
- net margin: 12.6904 USD/day  |  payback on registration: 1.85 days

## Score

- gate: **OK** 
- score: 55.7 (rank 25), confidence 1.0 
- components: income 10.34 / freshness 21.0 / resource 15.0 / registration 9.38
