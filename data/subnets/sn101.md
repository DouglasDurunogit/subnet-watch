...
- registration cost: 0.028013024 TAO (5.88637673312 USD), open=True
...
- **competitive_miner_usd_day: 2.084348092174992** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1941577611419225
- top_miner_usd_day: 2564.790327421328 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1861 USD/day  |  payback on registration: 31.63 days

## Score

- gate: **OK** 
- score: 36.7 (rank 51), confidence 1.0 
- components: income 0.67 / freshness 21.0 / resource 15.0 / registration 0.0
