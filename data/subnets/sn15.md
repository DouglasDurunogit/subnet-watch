...
- miner_burn: **0.0**
- registration cost: 0.442021263 TAO (103.17660320946 USD), open=True
...
- **competitive_miner_usd_day: 41.63211553991086** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 24.684528682956003
- top_miner_usd_day: 22031.86291404132 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.514 USD/day  |  payback on registration: 4.39 days

## Score

- gate: **OK** 
- score: 71.2 (rank 7), confidence 1.0 
- components: income 12.64 / freshness 35.0 / resource 15.0 / registration 8.54
