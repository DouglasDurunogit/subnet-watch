...
- miner_burn: **0.0**
- registration cost: 0.000508509 TAO (0.09974404035 USD), open=True
...
- **competitive_miner_usd_day: 42.73735573191529** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 42.73735573191529
- top_miner_usd_day: 4190.4140414821295 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.5182 USD/day  |  payback on registration: 0.0 days
...
- components: income 14.1 / freshness 21.0 / resource 11.25 / registration 10.0
