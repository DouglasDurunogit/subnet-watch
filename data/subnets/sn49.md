...
- **competitive_miner_usd_day: 40.791655647299** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2040.641497091674
- top_miner_usd_day: 4040.491338536049 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 32.5725 USD/day  |  payback on registration: 0.31 days
...
- components: income 13.88 / freshness 21.0 / resource 11.25 / registration 9.9
