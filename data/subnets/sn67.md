...
- registration cost: 0.042567308 TAO (9.18900477796 USD), open=True
...
- **competitive_miner_usd_day: 755.756687080857** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 24.470188167195758
- top_miner_usd_day: 755.756687080857 (uid 193, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 23.4839 USD/day  |  payback on registration: 0.39 days

## Score

- gate: **OK** 
- score: 72.5 (rank 2), confidence 1.0 
- components: income 12.63 / freshness 35.0 / resource 15.0 / registration 9.87
