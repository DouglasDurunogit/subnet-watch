...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (192.856 USD), open=True
...
- **competitive_miner_usd_day: 118.3576197591146** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 7.207024873839742
- top_miner_usd_day: 118.3576197591146 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -1.0122 USD/day  |  payback on registration: [UNKNOWN] days
