...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (98.755 USD), open=True
...
- **competitive_miner_usd_day: 27.241683023320945** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 10.093531956848
- top_miner_usd_day: 2863.632695499296 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.604 USD/day  |  payback on registration: [UNKNOWN] days
