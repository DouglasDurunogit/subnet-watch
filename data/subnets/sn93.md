...
- miner_burn: **0.005070991814136505**
- registration cost: 0.005 TAO (1.4011500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 16  |  free: 0
- subnet age: 523.2 days  |  registered at block 5370681
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 10889.716082453415** (uid 153) <- the only figure quotable as achievable
- median_miner_usd_day: 3775.8289200942622
- top_miner_usd_day: 10889.716082453415 (uid 153, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.47708568580177224  |  top1_share: 0.7310708944975127  |  top10_share: 1.0
- owner_incentive_share: 0.2534867397076327 (independent check on miner_burn; disagreement 0.2484)  <- the two burn measures DISAGREE; the burn picture is shifting, treat both as provisional
...
- status: **ok** 
- README: 4920 bytes, sha ca79decc2f55d815
- latest release: (none) 
- last commit: 2026-09-17T21:13:10Z
- scoring-related commit: docs: replace CLAUDE.md with AGENTS.md + on-chain liveness verificati… 2026-09-17T21:13:10Z
...
- net margin: 5551.6503 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 54.2 (rank 27), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 34.06 / freshness 35.0 / resource 11.25 / registration 10.0
