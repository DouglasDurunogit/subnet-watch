...
- **competitive_miner_usd_day: 41.89637530776669** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.16621456440478
- top_miner_usd_day: 41.89637530776669 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.947 USD/day  |  payback on registration: 53.25 days

## Score

- gate: **OK** 
- score: 32.0 (rank 51), confidence 0.85 - hardware requirement unknown
- components: income 5.42 / freshness 21.0 / resource 11.25 / registration 0.0
