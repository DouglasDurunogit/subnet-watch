...
- miner_burn: **0.0**
- registration cost: 0.488171336 TAO (112.17200958608001 USD), open=True
...
- **competitive_miner_usd_day: 40.40288799793132** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 23.9556946536407
- top_miner_usd_day: 21381.351347577816 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.7906 USD/day  |  payback on registration: 4.92 days

## Score

- gate: **OK** 
- score: 70.9 (rank 10), confidence 1.0 
- components: income 12.52 / freshness 35.0 / resource 15.0 / registration 8.36
