...
- registration cost: 0.999999999 TAO (224.76999977523002 USD), open=True
...
- **competitive_miner_usd_day: 1419.857804457462** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.1691218899670375
- top_miner_usd_day: 1419.857804457462 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.0729 USD/day  |  payback on registration: [UNKNOWN] days
