...
- subnet age: 54.2 days  |  registered at block 8409860
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4057.9540955146367** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 4057.9540955146367
- top_miner_usd_day: 4057.9540955146367 (uid 124, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4049.7349 USD/day  |  payback on registration: 0.05 days
...
- components: income 32.81 / freshness 0.0 / resource 11.25 / registration 9.98
