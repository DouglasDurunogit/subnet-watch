...
- **competitive_miner_usd_day: 10.872729750213507** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 9.128990073292474
- top_miner_usd_day: 10.872729750213507 (uid 50, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.773 USD/day  |  payback on registration: 0.16 days

## Score

- gate: **OK** 
- score: 19.9 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 2.26 / freshness 0.0 / resource 11.25 / registration 9.95
