...
- miner_burn: **0.0**
- registration cost: 0.144840168 TAO (28.4321249784 USD), open=True
...
- **competitive_miner_usd_day: 393.7917461053468** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 6.5567039823013555
- top_miner_usd_day: 393.7917461053468 (uid 39, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 211  |  gini: 0.7180745067952035  |  top1_share: 0.09273669566280901  |  top10_share: 0.48270168626072074
...
- net margin: 5.5704 USD/day  |  payback on registration: 5.1 days

## Score

- gate: **OK** 
- score: 30.7 (rank 56), confidence 1.0 
- components: income 7.44 / freshness 0.0 / resource 15.0 / registration 8.3
