...
- subnet age: 195.3 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3149.694868800858** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 787.4237172002145
- top_miner_usd_day: 3149.694868800858 (uid 126, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 779.2045 USD/day  |  payback on registration: 0.03 days
