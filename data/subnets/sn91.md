...
- miner_burn: **0.0**
- registration cost: 0.128769138 TAO (24.557562307980003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 9  |  free: 0
- subnet age: 152.1 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2985.5752519908533** (uid 22) <- the only figure quotable as achievable
- median_miner_usd_day: 1780.1080300071678
- top_miner_usd_day: 2985.5752519908533 (uid 22, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.2708212530899994  |  top1_share: 0.5416425061799982  |  top10_share: 1.0
...
- status: **ok** 
- README: 19316 bytes, sha fc2428d62c92b978
- latest release: worker-v0.4.0 2026-07-23T23:18:27Z
- last commit: 2026-07-28T05:23:51Z
- scoring-related commit: Merge pull request #167 from TensorLink-AI/fix/validator-restart-reen… 2026-07-28T05:23:51Z
...
- net margin: 2374.6225 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 31.2 (rank 41), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
...
_(truncated at 6000 of 19316 chars - read the full file at https://github.com/TensorLink-AI/cascade)_
