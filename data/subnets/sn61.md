...
- **competitive_miner_usd_day: 438.7975374275994** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 24.999462572246
- top_miner_usd_day: 438.7975374275994 (uid 34, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.7803 USD/day  |  payback on registration: 0.01 days
