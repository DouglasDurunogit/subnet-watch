...
- miner_burn: **0.30096166022121906**
- registration cost: 0.1 TAO (20.408 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 795.4 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 381.18555173801053** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.131022226391352
- top_miner_usd_day: 762.5292192681806 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.3854 USD/day  |  payback on registration: 14.73 days

## Score

- gate: **OK** 
- score: 58.5 (rank 19), confidence 1.0 
- components: income 3.43 / freshness 35.0 / resource 15.0 / registration 5.09
