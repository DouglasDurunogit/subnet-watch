...
- **competitive_miner_usd_day: 342.688905395982** (uid 66) <- the only figure quotable as achievable
- median_miner_usd_day: 257.5008432011106
- top_miner_usd_day: 592.815556095817 (uid 112, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.34925762592892107  |  top1_share: 0.18216776280652494  |  top10_share: 1.0
...
- net margin: 150.8598 USD/day  |  payback on registration: 0.0 days
