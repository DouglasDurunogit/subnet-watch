...
- subnet age: 438.9 days  |  registered at block 5740660
- weights_version: 11901  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1834.4273683571091
- top_miner_usd_day: 1834.4273683571091 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
