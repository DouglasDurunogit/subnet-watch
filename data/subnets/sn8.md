...
- subnet age: 1034.0 days  |  registered at block 1477264
- weights_version: 199  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 492.7154196721821** (uid 68) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5983186638399297
- top_miner_usd_day: 18622.66841201781 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.6209 USD/day  |  payback on registration: [UNKNOWN] days
