...
- miner_burn: **0.0**
- registration cost: 0.000759543 TAO (0.18124974609 USD), open=True
...
- **competitive_miner_usd_day: 2233.22386400506** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2233.22386400506
- top_miner_usd_day: 2233.22386400506 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2225.0047 USD/day  |  payback on registration: 0.0 days
