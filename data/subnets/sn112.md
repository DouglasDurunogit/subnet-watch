...
- miner_burn: **0.2510500755161047**
- registration cost: 1.09642947 TAO (211.77535213049998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 14  |  free: 0
- subnet age: 433.3 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1430.5412065829585** (uid 134) <- the only figure quotable as achievable
- median_miner_usd_day: 955.0251358156513
- top_miner_usd_day: 1430.5412065829585 (uid 134, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.24895474105044735  |  top1_share: 0.7489547410504471  |  top10_share: 1.0
- owner_incentive_share: 0.2510452589495529 (independent check on miner_burn; disagreement 0.0)
...
- latest release: (none) 
- last commit: 2026-07-28T13:58:43Z
- scoring-related commit: fix(score): resolve /apps/{id}/score contract per-chain — Base dry-ru… 2026-07-28T12:46:39Z
...
- net margin: 1422.322 USD/day  |  payback on registration: 0.15 days

## Score

- gate: **OK** 
- score: 29.9 (rank 49), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 28.68 / freshness 0.0 / resource 11.25 / registration 9.95
