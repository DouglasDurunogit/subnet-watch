...
- **competitive_miner_usd_day: 207.311356496315** (uid 96) <- the only figure quotable as achievable
- median_miner_usd_day: 160.8015043432287
- top_miner_usd_day: 5478.968746080437 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 106.0725 USD/day  |  payback on registration: 0.01 days
