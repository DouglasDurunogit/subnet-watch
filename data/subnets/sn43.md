...
- registration cost: 0.1 TAO (22.557000000000002 USD), open=True
...
- **competitive_miner_usd_day: 193.10713166621218** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.069704501448287
- top_miner_usd_day: 2693.515934646787 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4514 USD/day  |  payback on registration: [UNKNOWN] days
