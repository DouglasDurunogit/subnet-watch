...
- miner_burn: **0.0**
- registration cost: 0.254128466 TAO (52.10141809932 USD), open=True
...
- **competitive_miner_usd_day: 20.12013194624198** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 10.152360156360634
- top_miner_usd_day: 11377.288556317162 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.8892 USD/day  |  payback on registration: 5.86 days

## Score

- gate: **OK** 
- score: 67.1 (rank 13), confidence 1.0 
- components: income 9.05 / freshness 35.0 / resource 15.0 / registration 8.05
