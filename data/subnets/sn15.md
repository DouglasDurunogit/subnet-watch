...
- miner_burn: **0.0**
- registration cost: 0.469364497 TAO (113.1637802267 USD), open=True
...
- **competitive_miner_usd_day: 42.429506027897055** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 23.843129493552773
- top_miner_usd_day: 22796.284689961827 (uid 146, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.2936 USD/day  |  payback on registration: 5.08 days

## Score

- gate: **OK** 
- score: 70.7 (rank 4), confidence 1.0 
- components: income 12.44 / freshness 35.0 / resource 15.0 / registration 8.31
