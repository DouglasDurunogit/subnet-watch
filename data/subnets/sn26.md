...
- subnet age: 124.3 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1981.4372319580236** (uid 64) <- the only figure quotable as achievable
- median_miner_usd_day: 27.794717242119468
- top_miner_usd_day: 1981.4372319580236 (uid 64, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.7822 USD/day  |  payback on registration: 1.31 days

## Score

- gate: **OK** 
- score: 53.8 (rank 25), confidence 1.0 
- components: income 11.98 / freshness 21.0 / resource 11.25 / registration 9.56
