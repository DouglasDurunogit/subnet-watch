...
- miner_burn: **0.0**
- registration cost: 0.014124691 TAO (2.6930135860599997 USD), open=True
...
- **competitive_miner_usd_day: 10.44150374616436** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 8.072303847238478
- top_miner_usd_day: 10.44150374616436 (uid 36, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 238  |  gini: 0.10947809049290291  |  top1_share: 0.005663193856665794  |  top10_share: 0.053492559363506255
...
- net margin: -0.1611 USD/day  |  payback on registration: [UNKNOWN] days
