...
- subnet age: 138.1 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 299.34041847256873** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 28.486872217002112
- top_miner_usd_day: 2095.4742333855993 (uid 126, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.7804907825662311  |  top1_share: 0.7004791844707605  |  top10_share: 1.0
...
- latest release: (none) 
- last commit: 2026-09-21T17:56:26Z
- scoring-related commit: feat: report model evaluations in the training/evaluations API schema 2026-09-21T13:03:03Z
...
- net margin: 25.528 USD/day  |  payback on registration: 1.14 days

## Score

- gate: **OK** 
- score: 68.8 (rank 6), confidence 1.0 
- components: income 12.95 / freshness 35.0 / resource 11.25 / registration 9.62
