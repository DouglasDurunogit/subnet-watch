...
- subnet age: 526.1 days  |  registered at block 5128460
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 149.02974706704498** (uid 135) <- the only figure quotable as achievable
- median_miner_usd_day: 149.02974706704498
- top_miner_usd_day: 1076.3040187738286 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.466 USD/day  |  payback on registration: 0.26 days

## Score

- gate: **OK** 
- score: 19.3 (rank 70), confidence 0.85 - hardware requirement unknown
- components: income 1.51 / freshness 0.0 / resource 11.25 / registration 9.91
