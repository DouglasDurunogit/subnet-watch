...
- subnet age: 447.0 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 253.86002590037003** (uid 107) <- the only figure quotable as achievable
- median_miner_usd_day: 634.6403806116903
- top_miner_usd_day: 1015.4207353230105 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 245.6408 USD/day  |  payback on registration: 0.8 days
...
- components: income 21.76 / freshness 21.0 / resource 11.25 / registration 9.73
