...
- miner_burn: **0.997685419395566**  <- 100% burn: miners earn NOTHING here
- registration cost: 0.125313859 TAO (29.25577352214 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 21  |  free: 0
- subnet age: 235.7 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 8.438621551218734** (uid 8) <- the only figure quotable as achievable
- median_miner_usd_day: 5.400717792779989
- top_miner_usd_day: 22069.695715333382 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 11  |  gini: 0.9074316347043621  |  top1_share: 0.9978024325850412  |  top10_share: 0.9999236955758694
- owner_incentive_share: 0.9978024325850413 (independent check on miner_burn; disagreement 0.0001)
...
- status: **ok** 
- README: 6639 bytes, sha 632801f2d754856d
- latest release: v2.0.14: feat: capture per-episode wall time (#304) 2026-09-14T04:22:12Z
- last commit: 2026-09-14T04:22:12Z
- scoring-related commit: fix: reject any generated evaluation infrastructure error (#303) 2026-09-14T04:01:53Z
...
- net margin: 4.0769 USD/day  |  payback on registration: 7.18 days
...
|---|--------|------------|----------|
| Getting started | [Quickstart](https://docs.oroagent
```

_(truncated at 6000 of 6639 chars - read the full file at https://github.com/ORO-AI/oro)_
