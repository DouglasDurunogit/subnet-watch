...
- subnet age: 197.5 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2811.0358805627056** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 702.7589701406764
- top_miner_usd_day: 2811.0358805627056 (uid 126, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 22727 bytes, sha f0f5a42cddae425a
- latest release: worker-v0.7.0 2026-08-27T23:57:57Z
- last commit: 2026-09-13T00:03:38Z
- scoring-related commit: provision: pin the Lium pull by digest and verify worker CODE before … 2026-09-12T23:55:31Z
...
- net margin: 1045.9193 USD/day  |  payback on registration: 0.02 days

## Score

- gate: **OK** 
- score: 71.2 (rank 3), confidence 0.85 - hardware requirement unknown
- components: income 27.47 / freshness 35.0 / resource 11.25 / registration 9.99
...
_(truncated at 6000 of 22727 chars - read the full file at https://github.com/TensorLink-AI/cascade)_
