...
- **competitive_miner_usd_day: 21.195818585297275** (uid 194) <- the only figure quotable as achievable
- median_miner_usd_day: 9.266513652868657
- top_miner_usd_day: 2809.564334889304 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.429 USD/day  |  payback on registration: [UNKNOWN] days
