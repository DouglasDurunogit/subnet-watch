...
- miner_burn: **0.0**
- registration cost: 0.001240965 TAO (0.29256990839999997 USD), open=True
...
- **competitive_miner_usd_day: 319.9107118444121** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 45.0535879629654
- top_miner_usd_day: 12386.712959079714 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 36.532 USD/day  |  payback on registration: 0.01 days
