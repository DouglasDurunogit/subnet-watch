...
- subnet age: 664.4 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7799.822741957162** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 1.203351369916637
- top_miner_usd_day: 7799.822741957162 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -7.0158 USD/day  |  payback on registration: [UNKNOWN] days
