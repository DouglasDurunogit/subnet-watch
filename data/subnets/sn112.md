...
- **competitive_miner_usd_day: 250.3608931556534** (uid 38) <- the only figure quotable as achievable
- median_miner_usd_day: 636.2319982962073
- top_miner_usd_day: 1022.1031034367612 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 242.1417 USD/day  |  payback on registration: 0.81 days
