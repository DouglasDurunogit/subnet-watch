...
- registration cost: 0.1 TAO (22.478 USD), open=True
...
- **competitive_miner_usd_day: 192.47355975435266** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0659137011712567
- top_miner_usd_day: 2683.9199417539303 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4533 USD/day  |  payback on registration: [UNKNOWN] days
