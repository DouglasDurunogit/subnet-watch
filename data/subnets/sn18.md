...
- registration cost: 0.999999999 TAO (225.94999977404999 USD), open=True
...
- **competitive_miner_usd_day: 1734.9440583383393** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.925798421244999
- top_miner_usd_day: 1734.9440583383393 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.3365 USD/day  |  payback on registration: [UNKNOWN] days
