...
- miner_burn: **0.0**
- registration cost: 0.343938173 TAO (68.60190798658 USD), open=True
...
- **competitive_miner_usd_day: 15322.264499556732** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 16.922665114688726
- top_miner_usd_day: 15322.264499556732 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.9364 USD/day  |  payback on registration: 4.3 days

## Score

- gate: **OK** 
- score: 69.7 (rank 7), confidence 1.0 
- components: income 11.18 / freshness 35.0 / resource 15.0 / registration 8.57
