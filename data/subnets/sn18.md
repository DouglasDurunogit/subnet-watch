...
- registration cost: 0.999999999 TAO (210.61999978938002 USD), open=True
...
- **competitive_miner_usd_day: 1559.8174333293075** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.128674762295435
- top_miner_usd_day: 1559.8174333293075 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.1521 USD/day  |  payback on registration: [UNKNOWN] days
