...
- registration cost: 0.115765168 TAO (22.92497621904 USD), open=True
...
- **competitive_miner_usd_day: 250.395977277315** (uid 147) <- the only figure quotable as achievable
- median_miner_usd_day: 27.49968336180775
- top_miner_usd_day: 2336.454578962481 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 19.0455 USD/day  |  payback on registration: 1.2 days

## Score

- gate: **OK** 
- score: 67.7 (rank 11), confidence 1.0 
- components: income 11.84 / freshness 35.0 / resource 11.25 / registration 9.6
