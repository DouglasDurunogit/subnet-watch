...
- subnet age: 200.1 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 613.2909491599165** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 1073.2825583650117
- top_miner_usd_day: 3986.5315535504055 (uid 121, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.5249835960508447  |  top1_share: 0.6499931332305862  |  top10_share: 1.0
...
- net margin: 298.4731 USD/day  |  payback on registration: 0.03 days
...
- components: income 22.52 / freshness 0.0 / resource 11.25 / registration 9.99
