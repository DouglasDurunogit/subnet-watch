...
- miner_burn: **0.0**
- registration cost: 0.236338399 TAO (47.15660075247 USD), open=True
...
- **competitive_miner_usd_day: 21.93769804583138** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 11.472007234976044
- top_miner_usd_day: 12242.241825998031 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.3851 USD/day  |  payback on registration: 4.54 days

## Score

- gate: **OK** 
- score: 68.1 (rank 8), confidence 1.0 
- components: income 9.61 / freshness 35.0 / resource 15.0 / registration 8.49
