...
- miner_burn: **0.0**
- registration cost: 0.000771194 TAO (0.16443398468 USD), open=True
...
- **competitive_miner_usd_day: 2088.0890058074506** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2088.0890058074506
- top_miner_usd_day: 2088.0890058074506 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2079.8698 USD/day  |  payback on registration: 0.0 days
