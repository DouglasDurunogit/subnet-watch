...
- registration cost: 0.99 TAO (224.00730000000001 USD), open=True
...
- **competitive_miner_usd_day: 299.1589447827042** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 747.8859497745378
- top_miner_usd_day: 1196.6129547663718 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 290.9398 USD/day  |  payback on registration: 0.77 days
...
- components: income 22.42 / freshness 21.0 / resource 11.25 / registration 9.74
