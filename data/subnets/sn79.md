...
- miner_burn: **0.0**
- registration cost: 0.096650599 TAO (23.578880132040002 USD), open=True
...
- **competitive_miner_usd_day: 431.7633998569222** (uid 65) <- the only figure quotable as achievable
- median_miner_usd_day: 6.763019626077454
- top_miner_usd_day: 431.7633998569222 (uid 65, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 226  |  gini: 0.7370971297156157  |  top1_share: 0.08639011635907708  |  top10_share: 0.47757679546184306
...
- net margin: 5.7767 USD/day  |  payback on registration: 4.08 days

## Score

- gate: **OK** 
- score: 31.2 (rank 56), confidence 1.0 
- components: income 7.56 / freshness 0.0 / resource 15.0 / registration 8.64
