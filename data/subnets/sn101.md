...
- registration cost: 0.003217365 TAO (0.7466217219 USD), open=True
...
- **competitive_miner_usd_day: 2.309006774943881** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1063990796606098
- top_miner_usd_day: 2842.82027872622 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1201 USD/day  |  payback on registration: 6.22 days

## Score

- gate: **OK** 
- score: 44.4 (rank 37), confidence 1.0 
- components: income 0.45 / freshness 21.0 / resource 15.0 / registration 7.93
