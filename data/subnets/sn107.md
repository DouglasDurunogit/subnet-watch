...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (185.91209999999998 USD), open=True
- tempo: 360.0  |  max_uids: 90  |  active: 28  |  free: 0
- subnet age: 175.2 days  |  registered at block 7457580
- weights_version: 13  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24467.056984372324** (uid 61) <- the only figure quotable as achievable
- median_miner_usd_day: 87.84177610900888
- top_miner_usd_day: 24467.056984372324 (uid 61, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.9015939994200863  |  top1_share: 0.8968974621148533  |  top10_share: 0.9876844659453355
...
- status: **ok** 
- README: 35385 bytes, sha c96979c44b79b5cd
- latest release: v0.2.0: Minos 🧬 — Miner onboarding (demo/practice), AI assistant, round-only scoring 2026-07-25T04:51:19Z
- last commit: 2026-07-25T04:47:31Z
- scoring-related commit: Add practice mode and make --demo score your config 2026-07-11T08:55:34Z
...
- net margin: 24466.0707 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 64.9 (rank 2), confidence 1.0 
- components: income 39.91 / freshness 0.0 / resource 15.0 / registration 10.0
...
_(truncated at 6000 of 35385 chars - read the full file at https://github.com/minos-protocol/minos_subnet)_
