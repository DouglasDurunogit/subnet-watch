...
- subnet age: 326.8 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3460.802326175456
- top_miner_usd_day: 3460.802326175456 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-11T17:48:56Z
- scoring-related commit: fix(proof): bind keyword-only miner setup 2026-09-11T14:04:31Z
