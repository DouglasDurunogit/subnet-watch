...
- subnet age: 286.7 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 36.233533077863186** (uid 119) <- the only figure quotable as achievable
- median_miner_usd_day: 1812.6170662020509
- top_miner_usd_day: 3589.0005993262384 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 28.0144 USD/day  |  payback on registration: 0.36 days
...
- components: income 13.3 / freshness 21.0 / resource 11.25 / registration 9.88
