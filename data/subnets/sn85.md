...
- **competitive_miner_usd_day: 430.77361983252314** (uid 223) <- the only figure quotable as achievable
- median_miner_usd_day: 286.9847475673818
- top_miner_usd_day: 737.8429167085917 (uid 102, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.35472081063345984  |  top1_share: 0.21836133620229212  |  top10_share: 1.0
...
- net margin: 135.3377 USD/day  |  payback on registration: 0.0 days
