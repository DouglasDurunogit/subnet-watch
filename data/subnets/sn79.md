...
- miner_burn: **0.0**
- registration cost: 0.062199597 TAO (14.70087475095 USD), open=True
...
- **competitive_miner_usd_day: 295.5133882692689** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 4.0542241656483275
- top_miner_usd_day: 295.5133882692689 (uid 196, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 225  |  gini: 0.7429444945503461  |  top1_share: 0.09136768729840868  |  top10_share: 0.4751975786110644
...
- net margin: 3.0679 USD/day  |  payback on registration: 4.79 days

## Score

- gate: **OK** 
- score: 49.9 (rank 33), confidence 1.0 
- components: income 5.54 / freshness 21.0 / resource 15.0 / registration 8.4
