...
- miner_burn: **0.1505604237318039**
- registration cost: 0.1 TAO (27.039 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 813.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 32.000922909248686** (uid 163) <- the only figure quotable as achievable
- median_miner_usd_day: 12.000346090968257
- top_miner_usd_day: 1280.8238243103385 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.2378 USD/day  |  payback on registration: 113.7 days

## Score

- gate: **OK** 
- score: 50.8 (rank 31), confidence 1.0 
- components: income 0.84 / freshness 35.0 / resource 15.0 / registration 0.0
