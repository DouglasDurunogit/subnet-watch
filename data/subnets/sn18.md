...
- registration cost: 0.999999999 TAO (224.78999977521 USD), open=True
...
- **competitive_miner_usd_day: 1377.2594574079721** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.804343577092001
- top_miner_usd_day: 1377.2594574079721 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.5006 USD/day  |  payback on registration: [UNKNOWN] days
