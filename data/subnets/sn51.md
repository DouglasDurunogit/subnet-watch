...
- subnet age: 704.7 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2118.6351325788282** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 49.500820854645525
- top_miner_usd_day: 55686.86027765975 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 62  |  gini: 0.9275131826899681  |  top1_share: 0.8158915320487373  |  top10_share: 0.9303294958316792
...
- latest release: executor-v1.125 2026-09-10T09:15:06Z
- last commit: 2026-09-10T12:28:28Z
- scoring-related commit: DAH-2748, hide a node the validator cannot reach on one availability … 2026-09-10T12:28:28Z
...
- net margin: 39.7185 USD/day  |  payback on registration: 2.98 days

## Score

- gate: **OK** 
- score: 59.4 (rank 22), confidence 0.85 - hardware requirement unknown
- components: income 14.64 / freshness 35.0 / resource 11.25 / registration 9.01
