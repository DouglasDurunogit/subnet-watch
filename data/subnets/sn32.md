...
- miner_burn: **0.0**
- registration cost: 0.01084389 TAO (2.0290002579000004 USD), open=True
...
- **competitive_miner_usd_day: 11.495039723651976** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 9.31546076306342
- top_miner_usd_day: 11.495039723651976 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.0963 USD/day  |  payback on registration: 1.85 days

## Score

- gate: **OK** 
- score: 20.0 (rank 54), confidence 0.85 - hardware requirement unknown
- components: income 2.92 / freshness 0.0 / resource 11.25 / registration 9.38
