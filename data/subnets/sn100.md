...
- miner_burn: **0.0**
- registration cost: 0.006277222 TAO (1.2533729167399998 USD), open=True
...
- **competitive_miner_usd_day: 1804.673010809233** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 451.1269457545221
- top_miner_usd_day: 1804.673010809233 (uid 56, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 442.9078 USD/day  |  payback on registration: 0.0 days
