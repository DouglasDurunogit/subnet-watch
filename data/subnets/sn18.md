...
- subnet age: 1026.4 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1260.281417894239** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.55180647546452
- top_miner_usd_day: 1260.281417894239 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.7111 USD/day  |  payback on registration: [UNKNOWN] days
