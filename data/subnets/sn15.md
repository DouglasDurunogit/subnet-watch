...
- miner_burn: **0.0**
- registration cost: 0.257709963 TAO (50.92606578843 USD), open=True
...
- **competitive_miner_usd_day: 22.157456460122397** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 13.7707556504499
- top_miner_usd_day: 12782.160350070231 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.6809 USD/day  |  payback on registration: 4.02 days

## Score

- gate: **OK** 
- score: 69.0 (rank 9), confidence 1.0 
- components: income 10.33 / freshness 35.0 / resource 15.0 / registration 8.66
