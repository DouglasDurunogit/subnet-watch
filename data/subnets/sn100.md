...
- subnet age: 326.0 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3415.4535375459027
- top_miner_usd_day: 3415.4535375459027 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-11T00:30:47Z
- scoring-related commit: fix(proof): harvest scored runs when vsock drops done (#278) 2026-09-11T00:30:47Z
