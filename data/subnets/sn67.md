...
- miner_burn: **0.006969313370063901**
- registration cost: 0.032023591 TAO (7.63314315076 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 123  |  free: 0
- subnet age: 238.2 days  |  registered at block 7236936
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 503.4051751396535** (uid 223) <- the only figure quotable as achievable
- median_miner_usd_day: 27.68698104736245
- top_miner_usd_day: 503.4051751396535 (uid 223, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 116  |  gini: 0.39188315501782633  |  top1_share: 0.12664008920252331  |  top10_share: 0.32190807863263526
...
- net margin: 26.7007 USD/day  |  payback on registration: 0.29 days

## Score

- gate: **OK** 
- score: 73.0 (rank 4), confidence 1.0 
- components: income 13.12 / freshness 35.0 / resource 15.0 / registration 9.9
