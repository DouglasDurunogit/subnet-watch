...
- subnet age: 246.4 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1617.567848925472** (uid 128) <- the only figure quotable as achievable
- median_miner_usd_day: 170.73154123449658
- top_miner_usd_day: 3600.144317546463 (uid 168, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 118.4308 USD/day  |  payback on registration: 1.46 days

## Score

- gate: **OK** 
- score: 66.6 (rank 10), confidence 0.85 - hardware from README keywords, not curated
