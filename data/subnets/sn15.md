...
- miner_burn: **0.0**
- registration cost: 0.247257079 TAO (48.62310458535 USD), open=True
...
- **competitive_miner_usd_day: 10608.606012690194** (uid 94) <- the only figure quotable as achievable
- median_miner_usd_day: 10.152764112130313
- top_miner_usd_day: 10608.606012690194 (uid 94, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8.9944 USD/day  |  payback on registration: 5.41 days

## Score

- gate: **OK** 
- score: 67.3 (rank 11), confidence 1.0 
- components: income 9.09 / freshness 35.0 / resource 15.0 / registration 8.2
