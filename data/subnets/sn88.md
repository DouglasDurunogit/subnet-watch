...
- **competitive_miner_usd_day: 315.1560212241203** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.628877507757628
- top_miner_usd_day: 878.8403782656634 (uid 252, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.6124 USD/day  |  payback on registration: [UNKNOWN] days
