...
- miner_burn: **0.45126549038104713**
...
- **competitive_miner_usd_day: 35.716805712492544** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.743331290152211
- top_miner_usd_day: 879.4780144342566 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.757 USD/day  |  payback on registration: 2.46 days

## Score

- gate: **OK** 
- score: 67.8 (rank 9), confidence 1.0 
- components: income 8.57 / freshness 35.0 / resource 15.0 / registration 9.18
