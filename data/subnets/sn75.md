...
- subnet age: 530.2 days  |  registered at block 5102795
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12699.182277365346** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.2579989206317777
- top_miner_usd_day: 12699.182277365346 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.9612 USD/day  |  payback on registration: [UNKNOWN] days
