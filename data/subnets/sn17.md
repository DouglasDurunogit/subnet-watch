...
- subnet age: 816.4 days  |  registered at block 2840556
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 5593.151995437919
- top_miner_usd_day: 5593.151995437919 (uid 230, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 0.0 (rank 90), confidence 0.85 - hardware from README keywords, not curated
