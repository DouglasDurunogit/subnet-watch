...
- **competitive_miner_usd_day: 234.09698917184582** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 43.54613156879528
- top_miner_usd_day: 11972.26362225301 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.5734 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.7 (rank 18), confidence 0.85 - hardware from README keywords, not curated
