...
- registration cost: 0.1 TAO (23.021 USD), open=True
...
- **competitive_miner_usd_day: 178.8907665047314** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.1598938812801554
- top_miner_usd_day: 2735.550712642437 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.4407 USD/day  |  payback on registration: 52.24 days

## Score

- gate: **OK** 
- score: 16.4 (rank 72), confidence 1.0 
- components: income 1.44 / freshness 0.0 / resource 15.0 / registration 0.0
