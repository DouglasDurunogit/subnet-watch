...
- **competitive_miner_usd_day: 1396.9863432491766** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 34.4934899567698
- top_miner_usd_day: 35495.12783820677 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.9576 USD/day  |  payback on registration: 4.27 days

## Score

- gate: **OK** 
- score: 57.3 (rank 21), confidence 0.85 - hardware requirement unknown
- components: income 12.55 / freshness 35.0 / resource 11.25 / registration 8.58
