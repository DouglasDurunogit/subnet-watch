...
- subnet age: 311.3 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 59.5806379649768** (uid 135) <- the only figure quotable as achievable
- median_miner_usd_day: 2980.5782659517486
- top_miner_usd_day: 5901.5758939385205 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 51.3615 USD/day  |  payback on registration: 0.26 days

## Score

- gate: **OK** 
- score: 28.4 (rank 67), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 15.63 / freshness 10.5 / resource 11.25 / registration 9.91
