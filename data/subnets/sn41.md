...
- miner_burn: **0.7035846882499754**
- registration cost: 0.1 TAO (23.504 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 94  |  free: 0
- subnet age: 767.9 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 23.779956467524457** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 12.80258621223082
- top_miner_usd_day: 2404.5395016690463 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 86  |  gini: 0.7778447680809906  |  top1_share: 0.7039971906681324  |  top10_share: 0.7616953707096616
- owner_incentive_share: 0.7039971906681325 (independent check on miner_burn; disagreement 0.0004)
...
- net margin: 11.7902 USD/day  |  payback on registration: 1.99 days

## Score

- gate: **OK** 
- score: 55.4 (rank 27), confidence 1.0 
- components: income 10.07 / freshness 21.0 / resource 15.0 / registration 9.34
