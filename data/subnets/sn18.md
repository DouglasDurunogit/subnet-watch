...
- registration cost: 0.999999999 TAO (231.32999976867 USD), open=True
...
- **competitive_miner_usd_day: 1418.7378338438002** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.1224631030169743
- top_miner_usd_day: 1418.7378338438002 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.1195 USD/day  |  payback on registration: [UNKNOWN] days
