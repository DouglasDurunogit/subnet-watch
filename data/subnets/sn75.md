...
- **competitive_miner_usd_day: 5.313478422366841** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 3.6530164153772033
- top_miner_usd_day: 10331.228561288826 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.6492 USD/day  |  payback on registration: [UNKNOWN] days
