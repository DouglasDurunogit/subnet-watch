...
- subnet age: 1037.8 days  |  registered at block 1489797
- weights_version: 4062  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 198.42480538576885** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 9926.390226069449
- top_miner_usd_day: 19654.35564675313 (uid 128, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 190.2056 USD/day  |  payback on registration: 0.0 days
...
- components: income 20.75 / freshness 35.0 / resource 11.25 / registration 10.0
