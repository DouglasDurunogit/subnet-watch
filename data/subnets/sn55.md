...
- miner_burn: **0.02050595683977008**
- registration cost: 0.010217632 TAO (2.64473186688 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 17  |  free: 0
- subnet age: 598.2 days  |  registered at block 4703386
- weights_version: 1002  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 753.2362764022756** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 100.41370643345611
- top_miner_usd_day: 753.2362764022756 (uid 254, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.5238272546925071  |  top1_share: 0.301403937128033  |  top10_share: 1.0
- owner_incentive_share: 0.02049443003204639 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 117.2884 USD/day  |  payback on registration: 0.02 days

## Score

- gate: **OK** 
- score: 51.9 (rank 34), confidence 0.85 - hardware requirement unknown
- components: income 18.85 / freshness 21.0 / resource 11.25 / registration 9.99
