...
- **competitive_miner_usd_day: 55.742717604229114** (uid 64) <- the only figure quotable as achievable
- median_miner_usd_day: 8.97373294765052
- top_miner_usd_day: 1196.110624147818 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.649 USD/day  |  payback on registration: 0.19 days

## Score

- gate: **OK** 
- score: 19.7 (rank 72), confidence 0.85 - hardware requirement unknown
- components: income 1.98 / freshness 0.0 / resource 11.25 / registration 9.94
