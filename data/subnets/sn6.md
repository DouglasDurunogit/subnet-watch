...
- subnet age: 780.6 days  |  registered at block 3219949
- weights_version: 3000  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 552.0683830765703** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 15.778713019906805
- top_miner_usd_day: 552.0683830765703 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 7.5427 USD/day  |  payback on registration: 5.35 days

## Score

- gate: **OK** 
- score: 66.7 (rank 15), confidence 1.0 
- components: income 8.47 / freshness 35.0 / resource 15.0 / registration 8.22
- freshness basis: WEIGHTS_VERSION_BUMP 0.5d ago
