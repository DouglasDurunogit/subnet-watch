...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (192.52800000000002 USD), open=True
...
- **competitive_miner_usd_day: 120.54342983986284** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 6.36583385297121
- top_miner_usd_day: 120.54342983986284 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -1.8533 USD/day  |  payback on registration: [UNKNOWN] days
