...
- **competitive_miner_usd_day: 34.41099317931829** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.423673600932204
- top_miner_usd_day: 847.3241476202999 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.4374 USD/day  |  payback on registration: 2.69 days

## Score

- gate: **OK** 
- score: 67.5 (rank 14), confidence 1.0 
- components: income 8.42 / freshness 35.0 / resource 15.0 / registration 9.1
