...
- miner_burn: **0.0**
- registration cost: 0.213814546 TAO (42.10649854378 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 89  |  free: 0
- subnet age: 196.5 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 20.028272722605948** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 9.57491985422828
- top_miner_usd_day: 10744.641255869601 (uid 74, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.5008 USD/day  |  payback on registration: 4.95 days

## Score

- gate: **OK** 
- score: 67.2 (rank 12), confidence 1.0 
- components: income 8.89 / freshness 35.0 / resource 15.0 / registration 8.35
