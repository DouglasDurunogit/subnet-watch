...
- subnet age: 174.7 days  |  registered at block 7525773
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 794.1551942351006** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 794.1551942351006
- top_miner_usd_day: 2223.712102810291 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 468.2594 USD/day  |  payback on registration: 0.08 days
...
- components: income 24.3 / freshness 35.0 / resource 11.25 / registration 9.97
