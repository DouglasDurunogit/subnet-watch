...
- registration cost: 0.000502878 TAO (0.09651234575999999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 451.9 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3534.5100046938364
- top_miner_usd_day: 3534.5100046938364 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 17387 bytes, sha 6f60940463665429
- latest release: (none) 
- last commit: 2026-08-17T11:55:09Z
- scoring-related commit: feat: add adaptive miner selection and run assignment snapshots 2026-08-17T11:55:09Z
...
_(truncated at 6000 of 17387 chars - read the full file at https://github.com/DeSciClaims/Claims)_
