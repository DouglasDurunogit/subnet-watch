...
- miner_burn: **0.0**
- registration cost: 0.116783561 TAO (25.57793553022 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 186.4 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3320.2850722034073** (uid 23) <- the only figure quotable as achievable
- median_miner_usd_day: 830.0712680508518
- top_miner_usd_day: 3320.2850722034073 (uid 23, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.46451612903225836  |  top1_share: 0.5161290322580645  |  top10_share: 1.0
...
- status: **ok** 
- README: 22346 bytes, sha e03211e370e4b3c7
- latest release: worker-v0.7.0 2026-08-27T23:57:57Z
- last commit: 2026-08-31T05:05:09Z
- scoring-related commit: validator: multi-horizon calibration telemetry — groundwork for the s… 2026-08-31T05:05:09Z
...
- net margin: 821.8521 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 70.3 (rank 8), confidence 0.85 - hardware requirement unknown
...
compete in that round — deploy defaults to a timed revea
```

_(truncated at 6000 of 22346 chars - read the full file at https://github.com/TensorLink-AI/cascade)_
