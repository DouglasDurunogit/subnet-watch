...
- registration cost: 0.036692978 TAO (7.0358785315 USD), open=True
...
- **competitive_miner_usd_day: 4.703998936584054** (uid 100) <- the only figure quotable as achievable
- median_miner_usd_day: 4.276362669621867
- top_miner_usd_day: 2523.695429477345 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 242  |  gini: 0.7356591932108327  |  top1_share: 0.7226142190250249  |  top10_share: 0.7345833014463917
- owner_incentive_share: 0.7226142190250249 (independent check on miner_burn; disagreement 0.0022)
...
- net margin: -3.9428 USD/day  |  payback on registration: [UNKNOWN] days
