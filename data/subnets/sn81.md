...
- miner_burn: **0.0076124221086502075**
- registration cost: 0.0005 TAO (0.09963 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 63  |  free: 0
- subnet age: 510.8 days  |  registered at block 5203057
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 222.1272010815506** (uid 170) <- the only figure quotable as achievable
- median_miner_usd_day: 52.704004220285334
- top_miner_usd_day: 222.1272010815506 (uid 170, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 57  |  gini: 0.4768244556127359  |  top1_share: 0.05546141515914815  |  top10_share: 0.4411724295855278
- owner_incentive_share: 0.007602473093656973 (independent check on miner_burn; disagreement 0.0)
...
- latest release: (none) 
- last commit: 2026-08-19T13:11:10Z
- scoring-related commit: Merge pull request #184 from reliquadotai/perf/pi-old-from-verify-log… 2026-08-19T13:11:10Z
...
- net margin: 44.2708 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.6 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 15.06 / freshness 35.0 / resource 11.25 / registration 10.0
