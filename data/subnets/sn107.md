...
- **competitive_miner_usd_day: [UNKNOWN]** (uid 9) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 9, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.9037352155665779  |  top1_share: 0.9014269362838611  |  top10_share: 0.9882182373140023
...
- gate: **OK** 
- score: 15.0 (rank 26), confidence 1.0 
