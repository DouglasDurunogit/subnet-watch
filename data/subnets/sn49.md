...
- subnet age: 325.2 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 65.60340858605706** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 3281.8731131898203
- top_miner_usd_day: 6498.142817793583 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 57.3842 USD/day  |  payback on registration: 0.27 days
...
- components: income 16.06 / freshness 35.0 / resource 11.25 / registration 9.91
