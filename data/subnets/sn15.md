...
- miner_burn: **0.0**
- registration cost: 0.671639363 TAO (157.59346013432 USD), open=True
...
- **competitive_miner_usd_day: 40.91875018778899** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 24.261559845857192
- top_miner_usd_day: 21654.347444511342 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.0942 USD/day  |  payback on registration: 6.82 days

## Score

- gate: **OK** 
- score: 70.3 (rank 9), confidence 1.0 
- components: income 12.57 / freshness 35.0 / resource 15.0 / registration 7.73
