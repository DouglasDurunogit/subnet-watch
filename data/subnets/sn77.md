...
- subnet age: 556.0 days  |  registered at block 5128460
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 764.1547655977853** (uid 101) <- the only figure quotable as achievable
- median_miner_usd_day: 173.1860759521426
- top_miner_usd_day: 1366.8506865049999 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.6390942492575336  |  top1_share: 0.29880970547840685  |  top10_share: 0.9994811536700748
...
- net margin: 4.0665 USD/day  |  payback on registration: 0.04 days

## Score

- gate: **OK** 
- score: 23.5 (rank 78), confidence 0.85 - hardware requirement unknown
- components: income 6.41 / freshness 0.0 / resource 11.25 / registration 9.99
