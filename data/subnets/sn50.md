...
- registration cost: 0.8 TAO (164.41600000000003 USD), open=True
...
- **competitive_miner_usd_day: 46.195897058392354** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 14.51442052755556
- top_miner_usd_day: 46.195897058392354 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6.2952 USD/day  |  payback on registration: 26.12 days

## Score

- gate: **OK** 
- score: 35.2 (rank 53), confidence 0.85 - hardware requirement unknown
- components: income 7.85 / freshness 21.0 / resource 11.25 / registration 1.29
