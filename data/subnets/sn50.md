...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (149.776 USD), open=True
...
- **competitive_miner_usd_day: 39.36162389898333** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 9.194595126570077
- top_miner_usd_day: 39.36162389898333 (uid 240, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.9754 USD/day  |  payback on registration: 153.55 days

## Score

- gate: **OK** 
- score: 11.8 (rank 57), confidence 0.85 - hardware requirement unknown
- components: income 2.69 / freshness 0.0 / resource 11.25 / registration 0.0
