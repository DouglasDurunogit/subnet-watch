...
- subnet age: 777.9 days  |  registered at block 3493948
- weights_version: 404020  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2979.1511064600545** (uid 20) <- the only figure quotable as achievable
- median_miner_usd_day: 11.25137518976824
- top_miner_usd_day: 2979.1511064600545 (uid 12, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 98  |  gini: 0.8731040781736954  |  top1_share: 0.3416347284359683  |  top10_share: 0.8599654914415721
...
- net margin: -18.4042 USD/day  |  payback on registration: [UNKNOWN] days
