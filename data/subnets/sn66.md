...
- subnet age: 560.3 days  |  registered at block 4958013
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1941.5074830962353
- top_miner_usd_day: 1941.5074830962353 (uid 121, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
