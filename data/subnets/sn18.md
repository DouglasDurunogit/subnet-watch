...
- **competitive_miner_usd_day: 1602.9355818796678** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.186204036247945
- top_miner_usd_day: 1602.9355818796678 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.053 USD/day  |  payback on registration: [UNKNOWN] days
