...
- subnet age: 527.0 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 104.63490071246017** (uid 223) <- the only figure quotable as achievable
- median_miner_usd_day: 24.296029577196638
- top_miner_usd_day: 104.63490071246017 (uid 223, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.38852014189356  |  top1_share: 0.01481311625773905  |  top10_share: 0.12064511197737524
...
- net margin: 16.0769 USD/day  |  payback on registration: 1.61 days

## Score

- gate: **OK** 
- score: 27.1 (rank 75), confidence 0.85 - hardware requirement unknown
- components: income 11.21 / freshness 0.0 / resource 11.25 / registration 9.46
