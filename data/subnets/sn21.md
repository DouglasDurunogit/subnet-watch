...
- **competitive_miner_usd_day: 1010.8032470993204** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.455576712059102
- top_miner_usd_day: 1010.8032470993204 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.1668 USD/day  |  payback on registration: 146.38 days

## Score

- gate: **OK** 
- score: 50.6 (rank 28), confidence 1.0 
- components: income 0.61 / freshness 35.0 / resource 15.0 / registration 0.0
