...
- subnet age: 835.7 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4164.691032578927
- top_miner_usd_day: 4164.691032578927 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-20T13:30:51Z
- scoring-related commit: feat(api): public read API for rounds, leader, and score progress 2026-08-20T12:49:41Z
