...
- registration cost: 0.1 TAO (18.716 USD), open=True
...
- **competitive_miner_usd_day: 58.033332120736375** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.2189645391850608
- top_miner_usd_day: 2424.7540169527006 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 57.047 USD/day  |  payback on registration: 0.33 days
