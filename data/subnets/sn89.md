...
- subnet age: 484.4 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 129.15967581691652** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 0.03299097722015747
- top_miner_usd_day: 1177.5799408963007 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1862 USD/day  |  payback on registration: [UNKNOWN] days
