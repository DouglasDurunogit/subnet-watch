...
- miner_burn: **0.0**
- registration cost: 0.497921268 TAO (115.80154929876 USD), open=True
...
- **competitive_miner_usd_day: 21747.7224026069** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 23.279897832242817
- top_miner_usd_day: 21747.7224026069 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.2936 USD/day  |  payback on registration: 5.19 days

## Score

- gate: **OK** 
- score: 70.7 (rank 5), confidence 1.0 
- components: income 12.44 / freshness 35.0 / resource 15.0 / registration 8.27
