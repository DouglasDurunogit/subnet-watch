...
- **competitive_miner_usd_day: 314.2282273946813** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 20.477045692818617
- top_miner_usd_day: 1976.3866850063305 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.8505 USD/day  |  payback on registration: 1.6 days

## Score

- gate: **OK** 
- score: 65.8 (rank 9), confidence 1.0 
- components: income 10.09 / freshness 35.0 / resource 11.25 / registration 9.47
