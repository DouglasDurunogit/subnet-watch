...
- subnet age: 776.7 days  |  registered at block 3219949
- weights_version: 2018  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 451.30693352765553** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 28.633372807013565
- top_miner_usd_day: 451.30693352765553 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.9485 USD/day  |  payback on registration: 1.77 days

## Score

- gate: **OK** 
- score: 58.0 (rank 21), confidence 1.0 
- components: income 12.54 / freshness 21.0 / resource 15.0 / registration 9.41
