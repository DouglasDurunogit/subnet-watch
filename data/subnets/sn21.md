...
- **competitive_miner_usd_day: 1007.3062515464526** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.423254914902513
- top_miner_usd_day: 1007.3062515464526 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.1629 USD/day  |  payback on registration: 142.63 days

## Score

- gate: **OK** 
- score: 50.6 (rank 29), confidence 1.0 
- components: income 0.6 / freshness 35.0 / resource 15.0 / registration 0.0
