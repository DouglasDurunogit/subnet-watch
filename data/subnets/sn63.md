...
- **competitive_miner_usd_day: 0.07434190100279893** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07434190100279893
- top_miner_usd_day: 4870.881353703387 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1448 USD/day  |  payback on registration: [UNKNOWN] days
