...
- miner_burn: **0.4506572247482836**
- registration cost: 0.1 TAO (19.022000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 779.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21.555150797702602** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.3887876994256505
- top_miner_usd_day: 824.5962027312835 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 142  |  gini: 0.7081667377049146  |  top1_share: 0.4511541223018285  |  top10_share: 0.557293655764501
- owner_incentive_share: 0.45115412230182855 (independent check on miner_burn; disagreement 0.0005)
...
- last commit: 2026-08-03T14:18:21Z
- scoring-related commit: fix(validator): resolve scoring to weekly (WR-) releases only 2026-08-03T12:15:33Z
...
- net margin: 4.4025 USD/day  |  payback on registration: 4.32 days

## Score

- gate: **OK** 
- score: 65.2 (rank 15), confidence 1.0 
- components: income 6.66 / freshness 35.0 / resource 15.0 / registration 8.56
