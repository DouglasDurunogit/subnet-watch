...
- **competitive_miner_usd_day: 988.8357707480546** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.24893053646714
- top_miner_usd_day: 988.8357707480546 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.1416 USD/day  |  payback on registration: 167.15 days

## Score

- gate: **OK** 
- score: 50.5 (rank 27), confidence 1.0 
- components: income 0.52 / freshness 35.0 / resource 15.0 / registration 0.0
