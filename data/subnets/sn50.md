...
- miner_burn: **0.0**
- registration cost: 1.061854411 TAO (198.73667156276002 USD), open=True
...
- **competitive_miner_usd_day: 38.502073268803315** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 9.570640789736741
- top_miner_usd_day: 38.502073268803315 (uid 240, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 30.2829 USD/day  |  payback on registration: 6.56 days

## Score

- gate: **OK** 
- score: 27.8 (rank 63), confidence 0.85 - hardware requirement unknown
- components: income 13.6 / freshness 0.0 / resource 11.25 / registration 7.81
