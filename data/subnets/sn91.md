...
- subnet age: 203.3 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1259.8300342031273** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 629.9150171015636
- top_miner_usd_day: 2519.6600684062546 (uid 165, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 471.45 USD/day  |  payback on registration: 0.05 days

## Score

- gate: **OK** 
- score: 71.7 (rank 3), confidence 0.85 - hardware from README keywords, not curated
- components: income 24.32 / freshness 35.0 / resource 15.0 / registration 9.98
