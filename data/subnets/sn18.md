...
- subnet age: 1045.6 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2316.30402918751** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 9.740996968691421
- top_miner_usd_day: 2316.30402918751 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.5076 USD/day  |  payback on registration: [UNKNOWN] days
