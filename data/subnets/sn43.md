...
- miner_burn: **0.8049488088581711**
- registration cost: 0.1 TAO (19.132 USD), open=True
...
- **competitive_miner_usd_day: 11.676290845384008** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.668041549340572
- top_miner_usd_day: 2444.236883633718 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.9069441298512282  |  top1_share: 0.8050544821902755  |  top10_share: 0.9974208711045996
- owner_incentive_share: 0.8050544821902756 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.4501 USD/day  |  payback on registration: 42.51 days

## Score

- gate: **OK** 
- score: 16.5 (rank 66), confidence 1.0 
- components: income 1.47 / freshness 0.0 / resource 15.0 / registration 0.0
