...
- miner_burn: **0.4512654575519264**
- registration cost: 0.1 TAO (19.243000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 100  |  free: 0
- subnet age: 793.4 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.95970791390349** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.802792778257807
- top_miner_usd_day: 885.4591524878167 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.8165 USD/day  |  payback on registration: 2.46 days

## Score

- gate: **OK** 
- score: 67.8 (rank 10), confidence 1.0 
- components: income 8.6 / freshness 35.0 / resource 15.0 / registration 9.18
