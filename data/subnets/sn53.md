...
- **competitive_miner_usd_day: 12222.103401008335** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 44.45486163188678
- top_miner_usd_day: 12222.103401008335 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 35.1914 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.9 (rank 17), confidence 0.85 - hardware from README keywords, not curated
