...
- subnet age: 209.6 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2657.206993951756** (uid 87) <- the only figure quotable as achievable
- median_miner_usd_day: 664.301748487939
- top_miner_usd_day: 2657.206993951756 (uid 87, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-24T22:37:58Z
- scoring-related commit: trainer: verify harvested funded checkpoints against in-memory tensor… 2026-09-24T22:23:56Z
...
- net margin: 663.3154 USD/day  |  payback on registration: 0.05 days

## Score

- gate: **OK** 
- score: 72.8 (rank 2), confidence 0.85 - hardware from README keywords, not curated
- components: income 25.67 / freshness 35.0 / resource 15.0 / registration 9.98
