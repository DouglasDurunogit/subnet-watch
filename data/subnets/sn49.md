...
- **competitive_miner_usd_day: 36.00690433963051** (uid 119) <- the only figure quotable as achievable
- median_miner_usd_day: 1801.2797473231644
- top_miner_usd_day: 3566.5525903066987 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.7877 USD/day  |  payback on registration: 0.36 days
