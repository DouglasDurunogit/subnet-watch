...
- miner_burn: **0.7073745827656239**
- registration cost: 0.001706219 TAO (0.32952207546999995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 248  |  free: 0
- subnet age: 951.5 days  |  registered at block 1907637
- weights_version: 1030  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6.4063102674831205** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 5.17000477726708
- top_miner_usd_day: 2605.0642549975005 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 239  |  gini: 0.7619682267295915  |  top1_share: 0.7086817605063214  |  top10_share: 0.7242138412853714
- owner_incentive_share: 0.7086817605063214 (independent check on miner_burn; disagreement 0.0013)
...
- latest release: Decrease burn, update the OnDemand incentive 2026-07-24T19:04:09Z
- last commit: 2026-07-28T21:54:48Z
- scoring-related commit: fix(od): treat scraper ERRORS as "no evidence", not as miner failures 2026-07-27T16:11:26Z
...
- net margin: -3.0773 USD/day  |  payback on registration: [UNKNOWN] days
