...
- registration cost: 0.002632407 TAO (0.62006346885 USD), open=True
...
- **competitive_miner_usd_day: 2.3427486967905335** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1225670838787971
- top_miner_usd_day: 2877.6275086265223 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 242  |  gini: 0.9265759052532323  |  top1_share: 0.9014861930827803  |  top10_share: 0.9080914956729151
- owner_incentive_share: 0.9014861930827803 (independent check on miner_burn; disagreement 0.0018)
...
- net margin: 0.1363 USD/day  |  payback on registration: 4.55 days

## Score

- gate: **OK** 
- score: 45.0 (rank 38), confidence 1.0 
- components: income 0.5 / freshness 21.0 / resource 15.0 / registration 8.48
