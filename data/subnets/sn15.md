...
- miner_burn: **0.0**
- registration cost: 0.276051521 TAO (54.44012045641001 USD), open=True
...
- **competitive_miner_usd_day: 22.01163898822032** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 13.809188610534449
- top_miner_usd_day: 12839.638210194815 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.7191 USD/day  |  payback on registration: 4.28 days

## Score

- gate: **OK** 
- score: 68.9 (rank 9), confidence 1.0 
- components: income 10.34 / freshness 35.0 / resource 15.0 / registration 8.57
