...
- miner_burn: **0.0**
- registration cost: 0.515675252 TAO (122.91635306672 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 123  |  free: 0
- subnet age: 758.0 days  |  registered at block 3493948
- weights_version: 404020  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 22.811795923637266** (uid 66) <- the only figure quotable as achievable
- median_miner_usd_day: 10.949662043345887
- top_miner_usd_day: 3436.7599972954085 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 118  |  gini: 0.8583780271890498  |  top1_share: 0.40264202810018324  |  top10_share: 0.8632101405009163
...
- net margin: -18.7697 USD/day  |  payback on registration: [UNKNOWN] days
