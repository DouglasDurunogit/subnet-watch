...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9224 USD), open=True
...
- **competitive_miner_usd_day: 774.4032627264555** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 3.578244423401625
- top_miner_usd_day: 774.4032627264555 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.6409 USD/day  |  payback on registration: [UNKNOWN] days
