...
- subnet age: 863.7 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1911.1113211003733** (uid 142) <- the only figure quotable as achievable
- median_miner_usd_day: 150.67532024195293
- top_miner_usd_day: 1911.1113211003733 (uid 142, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.5924049602750736  |  top1_share: 0.9084902493362225  |  top10_share: 1.0
...
- net margin: -286.585 USD/day  |  payback on registration: [UNKNOWN] days

## Score

- gate: **OK** 
- score: 0.0 (rank 97), confidence 0.85 - hardware from README keywords, not curated
- components: income 0.0 / freshness 0.0 / resource 0.0 / registration 0.0
