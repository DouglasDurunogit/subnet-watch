...
- miner_burn: **0.0**
- registration cost: 0.327026432 TAO (74.37562142976 USD), open=True
...
- **competitive_miner_usd_day: 23099.358657872715** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 20.386801986312133
- top_miner_usd_day: 23099.358657872715 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.4005 USD/day  |  payback on registration: 3.83 days

## Score

- gate: **OK** 
- score: 70.6 (rank 5), confidence 1.0 
- components: income 11.91 / freshness 35.0 / resource 15.0 / registration 8.72
