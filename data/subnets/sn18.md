...
- registration cost: 0.999999999 TAO (208.50999979149 USD), open=True
...
- **competitive_miner_usd_day: 1514.843037085612** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.26373190977052
- top_miner_usd_day: 1514.843037085612 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.9961 USD/day  |  payback on registration: [UNKNOWN] days
