...
- subnet age: 1037.6 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1436.564065354173** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 17.402280141282258
- top_miner_usd_day: 1436.564065354173 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8.3461 USD/day  |  payback on registration: 26.37 days

## Score

- gate: **OK** 
- score: 35.9 (rank 56), confidence 0.85 - hardware requirement unknown
- components: income 8.83 / freshness 21.0 / resource 11.25 / registration 1.21
