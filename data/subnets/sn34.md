...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (102.465 USD), open=True
...
- **competitive_miner_usd_day: 29.893506983402602** (uid 35) <- the only figure quotable as achievable
- median_miner_usd_day: 9.02445493838569
- top_miner_usd_day: 2975.475598872492 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.7902 USD/day  |  payback on registration: [UNKNOWN] days
