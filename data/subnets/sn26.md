...
- **competitive_miner_usd_day: 8.756538653649066** (uid 97) <- the only figure quotable as achievable
- median_miner_usd_day: 4.743125104059911
- top_miner_usd_day: 1495.7262587764315 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.5106 USD/day  |  payback on registration: 12.39 days

## Score

- gate: **OK** 
- score: 20.8 (rank 53), confidence 1.0 
- components: income 3.64 / freshness 0.0 / resource 11.25 / registration 5.87
