...
- subnet age: 301.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 61.12862141101899** (uid 217) <- the only figure quotable as achievable
- median_miner_usd_day: 3058.01761492345
- top_miner_usd_day: 6054.906608435881 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 52.9094 USD/day  |  payback on registration: 0.22 days
...
- components: income 15.75 / freshness 10.5 / resource 11.25 / registration 9.93
