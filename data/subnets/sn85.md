...
- **competitive_miner_usd_day: 554.7212982331719** (uid 112) <- the only figure quotable as achievable
- median_miner_usd_day: 241.47571338182553
- top_miner_usd_day: 554.7212982331719 (uid 23, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.3483869983213794  |  top1_share: 0.1755074011902945  |  top10_share: 1.0
...
- net margin: 539.1708 USD/day  |  payback on registration: 0.0 days
