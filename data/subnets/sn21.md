...
- miner_burn: **0.15055933175608516**
- registration cost: 0.1 TAO (26.475 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 813.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 31.799293937101563** (uid 163) <- the only figure quotable as achievable
- median_miner_usd_day: 11.924735226413087
- top_miner_usd_day: 1272.7537073349752 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.782650705837467  |  top1_share: 0.4471270507439909  |  top10_share: 0.9986875238458603
...
- net margin: 0.2301 USD/day  |  payback on registration: 115.06 days

## Score

- gate: **OK** 
- score: 50.8 (rank 30), confidence 1.0 
- components: income 0.82 / freshness 35.0 / resource 15.0 / registration 0.0
