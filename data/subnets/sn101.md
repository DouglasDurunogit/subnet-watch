...
- registration cost: 0.002297315 TAO (0.5133580099 USD), open=True
...
- **competitive_miner_usd_day: 2.1317317694598925** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0658658847299463
- top_miner_usd_day: 2736.2630940817257 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 245  |  gini: 0.9201651317086317  |  top1_share: 0.9023872111505074  |  top10_share: 0.9087143905122875
- owner_incentive_share: 0.9023872111505075 (independent check on miner_burn; disagreement 0.0014)
...
- net margin: 0.0796 USD/day  |  payback on registration: 6.45 days

## Score

- gate: **OK** 
- score: 44.2 (rank 41), confidence 1.0 
- components: income 0.3 / freshness 21.0 / resource 15.0 / registration 7.85
