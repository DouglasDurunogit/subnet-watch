...
- **competitive_miner_usd_day: 11710.518796150829** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 1.8101398578153816
- top_miner_usd_day: 11710.518796150829 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.409 USD/day  |  payback on registration: [UNKNOWN] days
