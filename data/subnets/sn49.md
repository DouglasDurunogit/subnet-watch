...
- subnet age: 308.2 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 53.85711700625788** (uid 117) <- the only figure quotable as achievable
- median_miner_usd_day: 2694.2536686168737
- top_miner_usd_day: 5334.65022022749 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 45.6379 USD/day  |  payback on registration: 0.26 days
...
- components: income 15.18 / freshness 10.5 / resource 11.25 / registration 9.91
