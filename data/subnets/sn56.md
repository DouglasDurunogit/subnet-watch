...
- miner_burn: **0.7288789402227849**
- registration cost: 0.0005 TAO (0.10987999999999999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 16  |  free: 0
- subnet age: 637.8 days  |  registered at block 4312927
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1060.0745566956266** (uid 221) <- the only figure quotable as achievable
- median_miner_usd_day: 718.083290802172
- top_miner_usd_day: 7831.206518663777 (uid 38, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.5621473150931591  |  top1_share: 0.7288999435398958  |  top10_share: 1.0
- owner_incentive_share: 0.7288999435398958 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 709.8641 USD/day  |  payback on registration: 0.0 days
