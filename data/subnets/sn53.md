...
- **competitive_miner_usd_day: 218.43266025079998** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 40.632292605954056
- top_miner_usd_day: 11171.153467133609 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 30.7769 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.4 (rank 19), confidence 0.85 - hardware from README keywords, not curated
- components: income 13.66 / freshness 35.0 / resource 11.25 / registration 10.0
