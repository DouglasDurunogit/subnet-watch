...
- registration cost: 0.99 TAO (238.2534 USD), open=True
...
- **competitive_miner_usd_day: 404.31639040585816** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 1010.7755523330095
- top_miner_usd_day: 1617.2347142601607 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 396.0972 USD/day  |  payback on registration: 0.6 days
...
- components: income 23.64 / freshness 35.0 / resource 11.25 / registration 9.8
