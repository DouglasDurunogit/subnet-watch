...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (10.863500000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 86  |  free: 0
- subnet age: 509.3 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 80.52051614550153** (uid 165) <- the only figure quotable as achievable
- median_miner_usd_day: 9.784365507720306
- top_miner_usd_day: 80.52051614550153 (uid 165, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 78  |  gini: 0.6300586963237567  |  top1_share: 0.05365950493991173  |  top10_share: 0.42959671385160414
...
- latest release: (none) 
- last commit: 2026-08-30T03:49:09Z
- scoring-related commit: scoring: the points qualify gate, and the variance that made it too l… 2026-08-30T01:06:31Z
...
- net margin: 1.4048 USD/day  |  payback on registration: 7.73 days

## Score

- gate: **OK** 
- score: 48.6 (rank 34), confidence 0.85 - hardware requirement unknown
- components: income 3.47 / freshness 35.0 / resource 11.25 / registration 7.42
