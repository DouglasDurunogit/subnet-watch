...
- registration cost: 0.8 TAO (153.096 USD), open=True
...
- **competitive_miner_usd_day: 43.52074555932404** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 9.991319042574908
- top_miner_usd_day: 43.52074555932404 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.7721 USD/day  |  payback on registration: 86.39 days

## Score

- gate: **OK** 
- score: 30.8 (rank 56), confidence 0.85 - hardware requirement unknown
- components: income 4.03 / freshness 21.0 / resource 11.25 / registration 0.0
