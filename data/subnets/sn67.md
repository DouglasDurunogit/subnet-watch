...
- miner_burn: **0.08629923593252897**
- registration cost: 0.015126133 TAO (2.83191462026 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 65  |  free: 0
- subnet age: 206.0 days  |  registered at block 7236936
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 921.3209498613277** (uid 232) <- the only figure quotable as achievable
- median_miner_usd_day: 9.8343247457108
- top_miner_usd_day: 921.3209498613277 (uid 232, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 60  |  gini: 0.7558466767410033  |  top1_share: 0.19019125974997328  |  top10_share: 0.8309037900874635
- owner_incentive_share: 0.08631874589776074 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 7924 bytes, sha 5b18aa9b1fcc7e26
- latest release: (none) 
- last commit: 2026-07-28T09:37:00Z
- scoring-related commit: chore(validator): bump repo-owned validator version to 20260728.post5 2026-07-28T09:37:00Z
...
- net margin: 1.6151 USD/day  |  payback on registration: 1.75 days

## Score

- gate: **OK** 
- score: 50.5 (rank 3), confidence 0.85 - hardware requirement unknown
- components: income 3.8 / freshness 35.0 / resource 11.25 / registration 9.42
...
`GET /v1/weights` still uses latest champion weights for champion emission and the latest terminal source batch with finalized tasks and artifacts for participant emission. For a failed terminal
```

_(truncated at 6000 of 7924 chars - read the full file at https://github.com/harnyx/harnyx)_
