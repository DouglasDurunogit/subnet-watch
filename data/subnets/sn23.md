...
- subnet age: 983.8 days  |  registered at block 2063528
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 987.7627327840181** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 2469.3691512271253
- top_miner_usd_day: 3950.975569670232 (uid 188, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 986.7764 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 62.2 (rank 15), confidence 0.85 - income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 27.24 / freshness 21.0 / resource 15.0 / registration 9.99
