...
- subnet age: 636.2 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1601.706036275231** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 81.43306154313397
- top_miner_usd_day: 1949.853654788908 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 72.5045 USD/day  |  payback on registration: 0.0 days
