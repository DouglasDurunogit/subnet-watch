...
- miner_burn: **0.0**
- registration cost: 0.161931868 TAO (30.43671390928 USD), open=True
...
- **competitive_miner_usd_day: 600.2671737934585** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 3.6903020894097787
- top_miner_usd_day: 600.2671737934585 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.704 USD/day  |  payback on registration: 11.26 days

## Score

- gate: **OK** 
- score: 26.4 (rank 40), confidence 1.0 
- components: income 5.17 / freshness 0.0 / resource 15.0 / registration 6.25
