...
- **competitive_miner_usd_day: 712.315371931977** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 6.662813853105227
- top_miner_usd_day: 712.315371931977 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.4457 USD/day  |  payback on registration: 5.52 days

## Score

- gate: **OK** 
- score: 64.1 (rank 11), confidence 1.0 
- components: income 5.89 / freshness 35.0 / resource 15.0 / registration 8.16
