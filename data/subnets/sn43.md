...
- **competitive_miner_usd_day: 34.29964874633325** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 15.819644089375307
- top_miner_usd_day: 2485.3943538253693 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.0042 USD/day  |  payback on registration: 6.66 days

## Score

- gate: **OK** 
- score: 28.3 (rank 60), confidence 1.0 
- components: income 5.48 / freshness 0.0 / resource 15.0 / registration 7.78
