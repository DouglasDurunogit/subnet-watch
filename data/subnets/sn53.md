...
- miner_burn: **0.0**
- registration cost: 0.000594625 TAO (0.1437684325 USD), open=True
...
- **competitive_miner_usd_day: 327.9448918246431** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 46.18505565394312
- top_miner_usd_day: 12697.790636669662 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 37.6559 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.1 (rank 20), confidence 0.85 - hardware from README keywords, not curated
