...
- miner_burn: **0.0**
- registration cost: 0.016181475 TAO (3.29050294125 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 242  |  free: 0
- subnet age: 874.6 days  |  registered at block 2515294
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 11.532066644170762** (uid 89) <- the only figure quotable as achievable
- median_miner_usd_day: 8.852899646030078
- top_miner_usd_day: 11.532066644170762 (uid 89, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 237  |  gini: 0.15181678253179332  |  top1_share: 0.006075296861096622  |  top10_share: 0.056748795679788896
...
- net margin: 0.6046 USD/day  |  payback on registration: 5.44 days

## Score

- gate: **OK** 
- score: 18.1 (rank 66), confidence 0.85 - hardware requirement unknown
- components: income 1.87 / freshness 0.0 / resource 11.25 / registration 8.19
