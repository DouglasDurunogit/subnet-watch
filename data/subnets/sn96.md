...
- **competitive_miner_usd_day: 151.12777476641998** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 31.15649603977361
- top_miner_usd_day: 2128.476672828004 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.8247 USD/day  |  payback on registration: 0.87 days

## Score

- gate: **OK** 
- score: 68.5 (rank 11), confidence 1.0 
- components: income 12.52 / freshness 35.0 / resource 11.25 / registration 9.71
