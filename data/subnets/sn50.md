...
- **competitive_miner_usd_day: 65.63223650513493** (uid 170) <- the only figure quotable as achievable
- median_miner_usd_day: 6.8812193952961165
- top_miner_usd_day: 65.63223650513493 (uid 170, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -1.338 USD/day  |  payback on registration: [UNKNOWN] days
