...
- miner_burn: **0.0**
- registration cost: 0.278281394 TAO (55.213811383540005 USD), open=True
...
- **competitive_miner_usd_day: 22.967058392084116** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 11.991649956928876
- top_miner_usd_day: 12354.65142850642 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.9037 USD/day  |  payback on registration: 5.06 days

## Score

- gate: **OK** 
- score: 68.1 (rank 12), confidence 1.0 
- components: income 9.78 / freshness 35.0 / resource 15.0 / registration 8.31
