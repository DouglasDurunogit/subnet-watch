...
- miner_burn: **0.0**
- registration cost: 0.118355678 TAO (26.43829135164 USD), open=True
...
- **competitive_miner_usd_day: 441.76785574730786** (uid 143) <- the only figure quotable as achievable
- median_miner_usd_day: 20.06105832201855
- top_miner_usd_day: 441.76785574730786 (uid 143, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.3446 USD/day  |  payback on registration: 1.72 days

## Score

- gate: **OK** 
- score: 27.0 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 11.04 / freshness 0.0 / resource 11.25 / registration 9.43
