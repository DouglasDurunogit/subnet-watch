...
- miner_burn: **0.0**
- registration cost: 0.15251939 TAO (32.7535390025 USD), open=True
...
- **competitive_miner_usd_day: 18.5911616632695** (uid 72) <- the only figure quotable as achievable
- median_miner_usd_day: 14.249818967176344
- top_miner_usd_day: 18.5911616632695 (uid 72, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6.0306 USD/day  |  payback on registration: 5.43 days

## Score

- gate: **OK** 
- score: 52.8 (rank 30), confidence 0.85 - hardware requirement unknown
- components: income 7.7 / freshness 35.0 / resource 11.25 / registration 8.19
