...
- **competitive_miner_usd_day: 62.408117797287396** (uid 212) <- the only figure quotable as achievable
- median_miner_usd_day: 5.670874630895065
- top_miner_usd_day: 983.1130848806473 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 87  |  gini: 0.7873925666390924  |  top1_share: 0.5268068471605051  |  top10_share: 0.7004443630033441
- owner_incentive_share: 0.5268068471605052 (independent check on miner_burn; disagreement 0.0004)
...
- net margin: -2.5483 USD/day  |  payback on registration: [UNKNOWN] days
