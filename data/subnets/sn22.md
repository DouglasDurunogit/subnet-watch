...
- **competitive_miner_usd_day: 54.60336318190815** (uid 72) <- the only figure quotable as achievable
- median_miner_usd_day: 5.670008507802252
- top_miner_usd_day: 1013.4844894753413 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -3.0807 USD/day  |  payback on registration: [UNKNOWN] days
