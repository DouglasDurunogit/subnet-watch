...
- miner_burn: **0.0**
- registration cost: 0.490917512 TAO (112.6164772528 USD), open=True
...
- **competitive_miner_usd_day: 21265.538402692284** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 22.76374289672604
- top_miner_usd_day: 21265.538402692284 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 21.7774 USD/day  |  payback on registration: 5.17 days

## Score

- gate: **OK** 
- score: 70.6 (rank 6), confidence 1.0 
- components: income 12.35 / freshness 35.0 / resource 15.0 / registration 8.28
