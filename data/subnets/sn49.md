...
- **competitive_miner_usd_day: 44.52289708487824** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 44.52289708487824
- top_miner_usd_day: 4365.487052644482 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 36.3037 USD/day  |  payback on registration: 0.0 days
...
- components: income 14.3 / freshness 21.0 / resource 11.25 / registration 10.0
