...
- miner_burn: **0.9505236509721726**
- registration cost: 0.999999999 TAO (270.31999972968 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 4  |  free: 236
- subnet age: 30.1 days  |  registered at block 8884359
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 854.2043655667176** (uid 12) <- the only figure quotable as achievable
- median_miner_usd_day: 8633.471451734928
- top_miner_usd_day: 16412.73853790314 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 839.4098 USD/day  |  payback on registration: 0.32 days
...
- components: income 26.6 / freshness 35.0 / resource 7.5 / registration 9.89
