...
- subnet age: 570.0 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1116.6200011128706** (uid 207) <- the only figure quotable as achievable
- median_miner_usd_day: 1861.0522673685368
- top_miner_usd_day: 2605.484533624203 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-26T08:19:27Z
- scoring-related commit: Bind protected verifier manifest to alias fix 2026-09-26T08:19:27Z
...
- net margin: 1108.4008 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.4 (rank 34), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
