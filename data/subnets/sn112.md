...
- **competitive_miner_usd_day: 297.83635286488476** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 744.5795204336368
- top_miner_usd_day: 1191.322688002389 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 289.6172 USD/day  |  payback on registration: 0.76 days
...
- components: income 22.4 / freshness 21.0 / resource 11.25 / registration 9.75
