...
- **competitive_miner_usd_day: 948.0019589294294** (uid 132) <- the only figure quotable as achievable
- median_miner_usd_day: 487.91218019249936
- top_miner_usd_day: 953.6282667793332 (uid 2, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 479.693 USD/day  |  payback on registration: 0.0 days
