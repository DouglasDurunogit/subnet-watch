...
- miner_burn: **0.0**
- registration cost: 0.541144075 TAO (120.62642575824998 USD), open=True
...
- **competitive_miner_usd_day: 21650.23963149602** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 19.107852943487938
- top_miner_usd_day: 21650.23963149602 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.1216 USD/day  |  payback on registration: 6.66 days

## Score

- gate: **OK** 
- score: 69.4 (rank 8), confidence 1.0 
- components: income 11.66 / freshness 35.0 / resource 15.0 / registration 7.78
