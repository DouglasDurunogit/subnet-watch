...
- subnet age: 864.7 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1015.6285497648577** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 734.2247903852763
- top_miner_usd_day: 1015.6285497648577 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.274705110402393  |  top1_share: 0.38157874658568963  |  top10_share: 1.0
...
- net margin: 296.9645 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 27.6 (rank 60), confidence 0.85 - hardware from README keywords, not curated
- components: income 22.5 / freshness 0.0 / resource 0.0 / registration 10.0
