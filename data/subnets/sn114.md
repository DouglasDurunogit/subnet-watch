...
- subnet age: 213.4 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1534.4001804806308** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 0.09369238447094282
- top_miner_usd_day: 3989.3280383882743 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1255 USD/day  |  payback on registration: [UNKNOWN] days
