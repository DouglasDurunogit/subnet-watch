...
- subnet age: 218.3 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 642.8146374140173** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 0.09810968214499653
- top_miner_usd_day: 4177.804594780388 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1211 USD/day  |  payback on registration: [UNKNOWN] days
