...
- miner_burn: **0.0**
- registration cost: 0.182548446 TAO (34.90143739074 USD), open=True
...
- **competitive_miner_usd_day: 85.44535286334623** (uid 94) <- the only figure quotable as achievable
- median_miner_usd_day: 19.997848542485293
- top_miner_usd_day: 111.16985803390686 (uid 71, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.8246 USD/day  |  payback on registration: 4.46 days

## Score

- gate: **OK** 
- score: 24.1 (rank 70), confidence 0.85 - hardware requirement unknown
- components: income 8.6 / freshness 0.0 / resource 11.25 / registration 8.51
