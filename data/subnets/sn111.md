...
- subnet age: 435.8 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2969.540829438235
- top_miner_usd_day: 2969.540829438235 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 9309 bytes, sha aba269f1f49bd09b
- latest release: (none) 
- last commit: 2026-08-02T00:51:57Z
- scoring-related commit: Wire production Silver run metadata into validator 2026-08-01T20:30:47Z
...
python -m neurons.miner \
  ...
  --axon.external_ip <PUBLIC_IP> \
  --axon.port 8091 \
  --axon.external_port 809
```

_(truncated at 6000 of 9309 chars - read the full file at https://github.com/DeSciClaims/Claims)_
