...
- registration cost: 0.8 TAO (158.304 USD), open=True
...
- **competitive_miner_usd_day: 36.860603042215544** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.286600202476691
- top_miner_usd_day: 36.860603042215544 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.0674 USD/day  |  payback on registration: 51.61 days

## Score

- gate: **OK** 
- score: 32.1 (rank 51), confidence 0.85 - hardware requirement unknown
- components: income 5.54 / freshness 21.0 / resource 11.25 / registration 0.0
