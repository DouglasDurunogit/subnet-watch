...
- **competitive_miner_usd_day: 136.62636136528008** (uid 6) <- the only figure quotable as achievable
- median_miner_usd_day: 136.62636136528008
- top_miner_usd_day: 3404.150785729576 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-25T15:53:19Z
- scoring-related commit: Score entity extraction with dataset-level micro-F1 2026-08-25T15:53:19Z
...
- net margin: 84.0984 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 65.8 (rank 16), confidence 0.85 - income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 17.55 / freshness 35.0 / resource 15.0 / registration 9.91
