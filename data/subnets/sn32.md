...
- **competitive_miner_usd_day: 10.938502215893264** (uid 71) <- the only figure quotable as achievable
- median_miner_usd_day: 8.345322811263397
- top_miner_usd_day: 10.938502215893264 (uid 71, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 250  |  gini: 0.08783421748635534  |  top1_share: 0.005320206081545918  |  top10_share: 0.051214627509134546
...
- net margin: 0.0161 USD/day  |  payback on registration: 6.74 days

## Score

- gate: **OK** 
- score: 16.2 (rank 77), confidence 0.85 - hardware requirement unknown
- components: income 0.06 / freshness 0.0 / resource 11.25 / registration 7.75
