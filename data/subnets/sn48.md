...
- subnet age: 719.9 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 29.275477931442147** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 363.9352477605346
- top_miner_usd_day: 1002.6404918989493 (uid 10, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.3927327015712665  |  top1_share: 0.3428453708931651  |  top10_share: 1.0
...
- net margin: 21.0563 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 20.1 (rank 76), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 12.22 / freshness 0.0 / resource 11.25 / registration 10.0
