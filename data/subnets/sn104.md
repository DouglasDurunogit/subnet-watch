...
- **competitive_miner_usd_day: 8.187417346099373** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 7.726154397023351
- top_miner_usd_day: 2399.8358083052676 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.5315 USD/day  |  payback on registration: [UNKNOWN] days
