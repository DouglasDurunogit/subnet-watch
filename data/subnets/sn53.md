...
- subnet age: 629.2 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2158.208042414946** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 131.75505373798566
- top_miner_usd_day: 2360.3602870274894 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 93.6787 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 63.1 (rank 12), confidence 0.85 - hardware from README keywords, not curated
