...
- registration cost: 0.1 TAO (24.247 USD), open=True
...
- **competitive_miner_usd_day: 194.43219421542386** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 4.456744578812533
- top_miner_usd_day: 2867.1365485575184 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.1884 USD/day  |  payback on registration: 20.4 days

## Score

- gate: **OK** 
- score: 21.3 (rank 70), confidence 1.0 
- components: income 3.09 / freshness 0.0 / resource 15.0 / registration 3.2
