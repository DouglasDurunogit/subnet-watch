...
- registration cost: 0.1 TAO (18.827 USD), open=True
...
- **competitive_miner_usd_day: 60.2701660411676** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.3303545318220014
- top_miner_usd_day: 2419.1787829003124 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.5401 USD/day  |  payback on registration: 34.86 days

## Score

- gate: **OK** 
- score: 16.7 (rank 53), confidence 1.0 
- components: income 1.71 / freshness 0.0 / resource 15.0 / registration 0.0
