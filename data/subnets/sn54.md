...
- **competitive_miner_usd_day: 1016.368078914813** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 1.2832930289328448
- top_miner_usd_day: 1016.368078914813 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.7905 USD/day  |  payback on registration: [UNKNOWN] days
