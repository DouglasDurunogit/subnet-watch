...
- registration cost: 0.8 TAO (162.12800000000001 USD), open=True
...
- **competitive_miner_usd_day: 43.68429059983064** (uid 115) <- the only figure quotable as achievable
- median_miner_usd_day: 10.12425619051869
- top_miner_usd_day: 43.68429059983064 (uid 115, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.9051 USD/day  |  payback on registration: 85.1 days

## Score

- gate: **OK** 
- score: 31.0 (rank 55), confidence 0.85 - hardware requirement unknown
- components: income 4.21 / freshness 21.0 / resource 11.25 / registration 0.0
