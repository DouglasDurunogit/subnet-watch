...
- registration cost: 0.1 TAO (23.032 USD), open=True
...
- **competitive_miner_usd_day: 180.34722416469768** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.3142690332783
- top_miner_usd_day: 2733.4051436305094 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.4924 USD/day  |  payback on registration: 46.77 days
