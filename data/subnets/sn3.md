...
- subnet age: 671.9 days  |  registered at block 4165565
- weights_version: 2000  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3980.6669846211053** (uid 92) <- the only figure quotable as achievable
- median_miner_usd_day: 3980.6669846211053
- top_miner_usd_day: 3980.6669846211053 (uid 92, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3972.4478 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 75.6 (rank 3), confidence 0.85 - hardware requirement unknown
- components: income 32.73 / freshness 35.0 / resource 11.25 / registration 10.0
