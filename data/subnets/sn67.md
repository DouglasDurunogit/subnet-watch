...
- registration cost: 0.060542178 TAO (12.62062242588 USD), open=True
...
- **competitive_miner_usd_day: 876.0902634970649** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 16.31429989160084
- top_miner_usd_day: 876.0902634970649 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.328 USD/day  |  payback on registration: 0.82 days

## Score

- gate: **OK** 
- score: 70.8 (rank 3), confidence 1.0 
- components: income 11.03 / freshness 35.0 / resource 15.0 / registration 9.73
