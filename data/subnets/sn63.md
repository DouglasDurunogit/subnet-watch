...
- miner_burn: **4.213512875139713e-05**
- registration cost: 0.0005 TAO (0.11693 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 17  |  free: 0
- subnet age: 581.0 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3344.1137330763027** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 0.10209163918293754
- top_miner_usd_day: 3344.1137330763027 (uid 110, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 9  |  gini: 0.8886447184579278  |  top1_share: 0.9997558295690392  |  top10_share: 1.0
- owner_incentive_share: 3.052130387010133e-05 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 12239 bytes, sha 27a675cd0aa2cea1
- latest release: (none) 
- last commit: 2026-09-14T21:17:39Z
- scoring-related commit: Fix issue with migrated validator db 2026-09-10T15:05:19Z
...
- net margin: -8.1171 USD/day  |  payback on registration: [UNKNOWN] days
...
- **Battle-tested**: The tr
```

_(truncated at 6000 of 12239 chars - read the full file at https://github.com/qbittensor-labs/enigma)_
