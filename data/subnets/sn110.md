...
- subnet age: 457.4 days  |  registered at block 5606062
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 7715.437078976283
- top_miner_usd_day: 7715.437078976283 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
