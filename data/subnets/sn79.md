...
- miner_burn: **0.0**
- registration cost: 0.12786996 TAO (28.2029983776 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 228  |  free: 0
- subnet age: 527.9 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 410.7690222232799** (uid 101) <- the only figure quotable as achievable
- median_miner_usd_day: 4.969507432182309
- top_miner_usd_day: 410.7690222232799 (uid 101, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 227  |  gini: 0.7536796751071859  |  top1_share: 0.09603301994955288  |  top10_share: 0.49259344187113047
...
- net margin: 3.9832 USD/day  |  payback on registration: 7.08 days

## Score

- gate: **OK** 
- score: 64.0 (rank 17), confidence 1.0 
- components: income 6.34 / freshness 35.0 / resource 15.0 / registration 7.64
