...
- registration cost: 0.059519919 TAO (15.395422248540001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 461.3 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 5136.716732420959
- top_miner_usd_day: 5136.716732420959 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 17375 bytes, sha fcef56e71b855ab9
- latest release: (none) 
- last commit: 2026-08-27T11:02:51Z
- scoring-related commit: docs(validator): add mainnet profile and streamline setup 2026-08-26T19:54:44Z
...
_(truncated at 6000 of 17375 chars - read the full file at https://github.com/DeSciClaims/Claims)_
