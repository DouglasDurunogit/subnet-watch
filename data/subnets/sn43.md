...
- registration cost: 0.1 TAO (19.703000000000003 USD), open=True
...
- **competitive_miner_usd_day: 17.393020142003046** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9766134304333262
- top_miner_usd_day: 2447.2072350601193 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.777 USD/day  |  payback on registration: [UNKNOWN] days
