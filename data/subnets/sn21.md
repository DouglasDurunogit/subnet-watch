...
- miner_burn: **0.4512560034636408**
- registration cost: 0.1 TAO (20.374000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 99  |  free: 0
- subnet age: 787.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.26109961587741** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.631776259007456
- top_miner_usd_day: 868.2568683932908 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.6455 USD/day  |  payback on registration: 2.66 days

## Score

- gate: **OK** 
- score: 67.6 (rank 13), confidence 1.0 
- components: income 8.52 / freshness 35.0 / resource 15.0 / registration 9.11
