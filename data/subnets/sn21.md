...
- **competitive_miner_usd_day: 26.15596194112429** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.508717381182549
- top_miner_usd_day: 894.2674950703838 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.5224 USD/day  |  payback on registration: 3.39 days

## Score

- gate: **OK** 
- score: 31.3 (rank 29), confidence 1.0 
