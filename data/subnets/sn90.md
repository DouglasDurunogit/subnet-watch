...
- miner_burn: **0.6563773697707802**
- registration cost: 0.0005 TAO (0.11603000000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 8  |  free: 158
- subnet age: 62.6 days  |  registered at block 8618670
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5305.362635172999** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 5305.362635172999
- top_miner_usd_day: 15201.850103381732 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.3612327631371475  |  top1_share: 0.6563868585292906  |  top10_share: 1.0
- owner_incentive_share: 0.6563868585292906 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 88043 bytes, sha 76512afd64a63eb0
- latest release: v1.1.6 — subtensor v445 / typed metagraph APIs 2026-08-23T12:38:07Z
- last commit: 2026-09-14T14:40:13Z
- scoring-related commit: docs: BTLABS (UID 97) live — first production miner on KubeTEE 2026-09-14T14:40:13Z
...
- net margin: 3900.1179 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 46.6 (rank 40), confidence 0.6 - hardware from README keywords, not curated; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 32.66 / freshness 35.0 / resource 0.0 / registration 10.0
...
_(truncated at 6000 of 88043 chars - read the full file at https://github.com/KubeTEE-AI/kubetee-subnet)_
