...
- subnet age: 304.0 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 58.69797854821613** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 2936.422386396028
- top_miner_usd_day: 5814.146794243839 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 50.4788 USD/day  |  payback on registration: 0.22 days
...
- components: income 15.57 / freshness 10.5 / resource 11.25 / registration 9.93
