...
- registration cost: 0.014461274 TAO (3.04944884838 USD), open=True
...
- **competitive_miner_usd_day: 5.613009139314382** (uid 118) <- the only figure quotable as achievable
- median_miner_usd_day: 4.73597646129651
- top_miner_usd_day: 2760.957339245463 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -3.4832 USD/day  |  payback on registration: [UNKNOWN] days
