...
- subnet age: 290.3 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3588.797005197292
- top_miner_usd_day: 3588.797005197292 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: v3.3.1 — prod validator trust-root roll 2026-08-06T06:57:19Z
- last commit: 2026-08-06T07:26:30Z
- scoring-related commit: chore(pins): promote prod validator to v3.3.1 digest 2026-08-06T07:02:07Z
