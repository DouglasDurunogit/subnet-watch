...
- subnet age: 676.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4481.50420340728** (uid 168) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5712197059979963
- top_miner_usd_day: 6439.93096542141 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.648 USD/day  |  payback on registration: [UNKNOWN] days
