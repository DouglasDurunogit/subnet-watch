...
- miner_burn: **0.0**
- registration cost: 0.255929447 TAO (47.96885625121 USD), open=True
...
- **competitive_miner_usd_day: 10530.173997290996** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 10.584658963101056
- top_miner_usd_day: 10530.173997290996 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.5984 USD/day  |  payback on registration: 5.0 days

## Score

- gate: **OK** 
- score: 32.7 (rank 23), confidence 1.0 
- components: income 9.32 / freshness 0.0 / resource 15.0 / registration 8.33
