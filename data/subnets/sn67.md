...
- miner_burn: **0.0**
- registration cost: 0.04034257 TAO (8.1867177301 USD), open=True
...
- **competitive_miner_usd_day: 748.8998039546688** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 18.225437706861403
- top_miner_usd_day: 748.8998039546688 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.2391 USD/day  |  payback on registration: 0.47 days

## Score

- gate: **OK** 
- score: 71.3 (rank 4), confidence 1.0 
- components: income 11.47 / freshness 35.0 / resource 15.0 / registration 9.84
