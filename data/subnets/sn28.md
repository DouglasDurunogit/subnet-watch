...
- **competitive_miner_usd_day: 1459.30509504843** (uid 44) <- the only figure quotable as achievable
- median_miner_usd_day: 34.41341075516313
- top_miner_usd_day: 1496.0127331872711 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 25.1354 USD/day  |  payback on registration: 0.88 days

## Score

- gate: **OK** 
- score: 58.5 (rank 21), confidence 0.85 - hardware requirement unknown
- components: income 12.89 / freshness 35.0 / resource 11.25 / registration 9.71
