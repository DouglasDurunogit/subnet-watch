...
**sn68 "NOVA"** (ظ), 520.3 days old. Snapshot 2026-07-28T06:37:33Z b8718699.

- on-chain repo: `https://github.com/metanova-labs/nova/`
- resolved: `https://github.com/metanova-labs/nova` — **ok**

On-chain description: _Accelerating drug discovery._ [VERIFIED: pack sn68, 2026-07-28]

## ¶2 — INPUT (what the validator hands you)

From README §GitHub configs - FOR MINERS [VERIFIED: README §GitHub configs - FOR MINERS]:
...
- cheapest satisfying machine: **RTX 4090 (24 GB)** — $250.0/mo, 24 GB VRAM, 8 vCPU, 32 GB RAM, 1000 Mbps [margin:68.rtx4090]
...
- registration: **0.127422 TAO** (~$23.9158), open=True
- `miner_burn`: **0**
- achievable income (`competitive_miner_usd_day`): **$6323.11/day** (uid 42)
- machine cost: $8.2192/day
- **net margin: $6314.89/day**, payback on registration 0 days
...
**BUILD-CANDIDATE** (score 47.4, rank 7, confidence 0.85 — hardware requirement unknown)
...
_Assembled from `data/subnets/sn68.md` and the repo README. Every claim is either quoted with a [VERIFIED] tag or marked [UNKNOWN]. Regenerate when this subnet appears in ALARMS.md under NEW SINCE LAST RUN._
