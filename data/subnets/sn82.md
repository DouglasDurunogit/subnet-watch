...
- miner_burn: **0.0**
- registration cost: 0.002277321 TAO (0.53257428906 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 9  |  free: 0
- subnet age: 143.4 days  |  registered at block 8026517
- weights_version: 1778428951  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1527.0724707537868** (uid 51) <- the only figure quotable as achievable
- median_miner_usd_day: 1527.0724707537868
- top_miner_usd_day: 1527.0724707537868 (uid 51, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1518.8533 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 42.7 (rank 41), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 28.94 / freshness 21.0 / resource 11.25 / registration 10.0
