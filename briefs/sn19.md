# sn19 — blockmachine · challenge brief
...
**sn19 "blockmachine"** (t), 939.3 days old. Snapshot 2026-07-28T06:37:33Z b8718699.

- on-chain repo: `https://github.com/taostat/blockmachine/`
- resolved: `https://github.com/taostat/blockmachine` — **ok**

On-chain description: _Harnessing Bittensor's incentive layer to forge self-optimizing infrastructure._ [VERIFIED: pack sn19, 2026-07-28]
...
- cheapest satisfying machine: **RTX 4090 (24 GB)** — $250.0/mo, 24 GB VRAM, 8 vCPU, 32 GB RAM, 1000 Mbps [margin:19.rtx4090]
...
- `miner_burn`: **0.860895**
- achievable income (`competitive_miner_usd_day`): **$334.324/day** (uid 237)
- machine cost: $8.2192/day
- **net margin: $326.105/day**, payback on registration 0.06 days

> The headline top miner earns $4,757/day but is owner=True / validator-permitted=False — **not achievable**. The competitive figure above is 14x lower. [VERIFIED: pack sn19, 2026-07-28]

## ¶9 — COMPETITIVE SHAPE

- earners: **29**, gini 0.935311, top-1 share 0.86112, top-10 share 0.986965
- shape: **highly concentrated** — the top miner takes 86% of miner emission

**(display only — not scored)**

## ¶10 — VERDICT

**BUILD-CANDIDATE** (score 37.5, rank 38, confidence 0.85 — hardware requirement unknown)
...
_Assembled from `data/subnets/sn19.md` and the repo README. Every claim is either quoted with a [VERIFIED] tag or marked [UNKNOWN]. Regenerate when this subnet appears in ALARMS.md under NEW SINCE LAST RUN._
