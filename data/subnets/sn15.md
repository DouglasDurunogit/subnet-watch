...
- miner_burn: **0.0**
- registration cost: 0.218634049 TAO (43.55846158227 USD), open=True
...
- **competitive_miner_usd_day: 20.34430809392358** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 10.437514587317317
- top_miner_usd_day: 10885.266272410538 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 70  |  gini: 0.9455005452562704  |  top1_share: 0.9394045801526717  |  top10_share: 0.9543816793893131
...
- net margin: 9.1859 USD/day  |  payback on registration: 4.74 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 1.0 
- components: income 9.17 / freshness 35.0 / resource 15.0 / registration 8.42
