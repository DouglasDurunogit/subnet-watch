...
- **competitive_miner_usd_day: 290.6517179974838** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 726.6182073413864
- top_miner_usd_day: 1162.5846966852891 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 282.4325 USD/day  |  payback on registration: 0.71 days
...
- components: income 22.31 / freshness 21.0 / resource 11.25 / registration 9.76
