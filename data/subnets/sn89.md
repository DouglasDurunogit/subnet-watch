...
- **competitive_miner_usd_day: 129.13662898974587** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 0.03304417323176711
- top_miner_usd_day: 1179.0161009094504 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
