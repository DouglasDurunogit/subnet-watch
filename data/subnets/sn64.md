...
- **competitive_miner_usd_day: 4276.196718053712** (uid 241) <- the only figure quotable as achievable
- median_miner_usd_day: 1824.5305562854305
- top_miner_usd_day: 13172.841202516878 (uid 21, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 15  |  gini: 0.5164881224884277  |  top1_share: 0.2686097970395239  |  top10_share: 0.9211048374790173
...
- net margin: 1559.9528 USD/day  |  payback on registration: 0.0 days
