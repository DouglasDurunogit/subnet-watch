...
- miner_burn: **0.8220613733865321**
- registration cost: 0.1 TAO (21.802000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 19  |  free: 0
- subnet age: 773.3 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 86.66297896748848** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 2.8074570987874656
- top_miner_usd_day: 2479.4448570979857 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.86169764430634  |  top1_share: 0.8221496482366047  |  top10_share: 0.9997863476124346
- owner_incentive_share: 0.8221496482366047 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.1183 USD/day  |  payback on registration: 184.29 days

## Score

- gate: **OK** 
- score: 15.4 (rank 81), confidence 1.0 
- components: income 0.44 / freshness 0.0 / resource 15.0 / registration 0.0
