...
- miner_burn: **0.0**
- registration cost: 0.02 TAO (3.8468 USD), open=True
...
- **competitive_miner_usd_day: 4106.094780032414** (uid 163) <- the only figure quotable as achievable
- median_miner_usd_day: 4106.094780032414
- top_miner_usd_day: 4106.094780032414 (uid 163, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4105.1085 USD/day  |  payback on registration: 0.0 days
