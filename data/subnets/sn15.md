...
- miner_burn: **0.0**
- registration cost: 0.154829687 TAO (39.40105874776 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 72  |  free: 0
- subnet age: 241.8 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 19.650384084308453** (uid 55) <- the only figure quotable as achievable
- median_miner_usd_day: 10.285747919130207
- top_miner_usd_day: 19506.076576189313 (uid 75, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.1459 USD/day  |  payback on registration: 4.31 days

## Score

- gate: **OK** 
- score: 67.7 (rank 10), confidence 1.0 
- components: income 9.15 / freshness 35.0 / resource 15.0 / registration 8.56
