...
- miner_burn: **0.0**
- registration cost: 0.145556066 TAO (31.64097762708 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 224  |  free: 0
- subnet age: 516.1 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 388.3133973153969** (uid 27) <- the only figure quotable as achievable
- median_miner_usd_day: 5.698931438333256
- top_miner_usd_day: 388.3133973153969 (uid 27, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 223  |  gini: 0.7317570197421015  |  top1_share: 0.09061726130422819  |  top10_share: 0.47817114555626894
...
- net margin: 4.7126 USD/day  |  payback on registration: 6.71 days

## Score

- gate: **OK** 
- score: 29.6 (rank 63), confidence 1.0 
- components: income 6.88 / freshness 0.0 / resource 15.0 / registration 7.76
