...
- miner_burn: **0.30096254986710846**
- registration cost: 0.1 TAO (20.736000000000004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 795.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 386.0736325088291** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.222465914280816
- top_miner_usd_day: 772.3074083860458 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7804530713468141  |  top1_share: 0.3679969477298741  |  top10_share: 0.9989164441053033
- owner_incentive_share: 0.30099961846623424 (independent check on miner_burn; disagreement 0.0)
...
- last commit: 2026-08-18T17:28:33Z
- scoring-related commit: validator: daily-stream API path crashed on unbound _vol after the ss… 2026-08-18T17:28:33Z
...
- net margin: 1.4158 USD/day  |  payback on registration: 14.65 days

## Score

- gate: **OK** 
- score: 58.6 (rank 18), confidence 1.0 
- components: income 3.48 / freshness 35.0 / resource 15.0 / registration 5.12
