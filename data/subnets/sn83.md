...
- **competitive_miner_usd_day: 98.95935111970273** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 21.07815400984181
- top_miner_usd_day: 98.95935111970273 (uid 57, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8.8687 USD/day  |  payback on registration: 2.22 days

## Score

- gate: **OK** 
- score: 25.1 (rank 67), confidence 0.85 - hardware requirement unknown
- components: income 9.04 / freshness 0.0 / resource 11.25 / registration 9.26
