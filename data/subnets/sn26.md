...
- **competitive_miner_usd_day: 272.2128465957621** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 26.727031856022712
- top_miner_usd_day: 1905.531460019372 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.9087 USD/day  |  payback on registration: 1.24 days

## Score

- gate: **OK** 
- score: 67.7 (rank 11), confidence 1.0 
- components: income 11.81 / freshness 35.0 / resource 11.25 / registration 9.59
