...
- miner_burn: **0.0**
- registration cost: 0.102836376 TAO (22.824533653199996 USD), open=True
...
- **competitive_miner_usd_day: 107.8703030149599** (uid 107) <- the only figure quotable as achievable
- median_miner_usd_day: 23.137704564423323
- top_miner_usd_day: 107.8703030149599 (uid 107, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.0242 USD/day  |  payback on registration: 1.52 days

## Score

- gate: **OK** 
- score: 26.9 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 10.96 / freshness 0.0 / resource 11.25 / registration 9.49
