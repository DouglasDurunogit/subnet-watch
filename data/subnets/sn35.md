...
- subnet age: 833.7 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1433.2078882304136** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 814.9291629556625
- top_miner_usd_day: 1433.2078882304136 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 806.71 USD/day  |  payback on registration: 0.03 days
...
- components: income 26.44 / freshness 21.0 / resource 11.25 / registration 9.99
