...
- registration cost: 0.001937169 TAO (0.37565581248 USD), open=True
...
- **competitive_miner_usd_day: 1.7071348643928286** (uid 191) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9992984572055581
- top_miner_usd_day: 2460.689175997253 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 243  |  gini: 0.9177918024540348  |  top1_share: 0.9035700634508065  |  top10_share: 0.9090436510970109
- owner_incentive_share: 0.9035700634508065 (independent check on miner_burn; disagreement 0.0018)
...
- net margin: 0.013 USD/day  |  payback on registration: 28.9 days

## Score

- gate: **OK** 
- score: 36.4 (rank 43), confidence 1.0 
- components: income 0.05 / freshness 21.0 / resource 15.0 / registration 0.37
