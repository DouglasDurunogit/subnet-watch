...
- **competitive_miner_usd_day: 94.55640871338481** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.513297546490836
- top_miner_usd_day: 590.701861105341 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.7572 USD/day  |  payback on registration: [UNKNOWN] days
