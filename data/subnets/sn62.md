...
- subnet age: 603.5 days  |  registered at block 4474225
- weights_version: 6  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1939.266544133028** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 676.2983792365983
- top_miner_usd_day: 2479.869628598483 (uid 202, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 533.5819 USD/day  |  payback on registration: 0.0 days
