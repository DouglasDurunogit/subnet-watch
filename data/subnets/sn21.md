...
- miner_burn: **0.15056318463757634**
- registration cost: 0.1 TAO (23.461000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 48  |  free: 0
- subnet age: 818.8 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 130.43060589163983** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 34.17078303738613
- top_miner_usd_day: 815.3003425132938 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 52.4146 USD/day  |  payback on registration: 0.45 days

## Score

- gate: **OK** 
- score: 75.6 (rank 2), confidence 1.0 
- components: income 15.71 / freshness 35.0 / resource 15.0 / registration 9.85
