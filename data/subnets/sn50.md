...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (150.24800000000002 USD), open=True
...
- **competitive_miner_usd_day: 39.69622288634037** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 9.296229776934316
- top_miner_usd_day: 39.69622288634037 (uid 240, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.0771 USD/day  |  payback on registration: 139.49 days

## Score

- gate: **OK** 
- score: 12.0 (rank 55), confidence 0.85 - hardware requirement unknown
