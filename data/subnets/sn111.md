...
- subnet age: 457.5 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4768.311146105819
- top_miner_usd_day: 4768.311146105819 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 19707 bytes, sha 1dae1c3cd0dae1f2
- latest release: (none) 
- last commit: 2026-08-23T16:36:27Z
...
Start a miner neuron after the wallet
```

_(truncated at 6000 of 19707 chars - read the full file at https://github.com/DeSciClaims/Claims)_
