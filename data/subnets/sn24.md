...
- subnet age: 865.3 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 922.322990409436** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 666.771729150067
- top_miner_usd_day: 922.322990409436 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 229.5115 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 26.8 (rank 59), confidence 0.85 - hardware from README keywords, not curated
- components: income 21.49 / freshness 0.0 / resource 0.0 / registration 10.0
