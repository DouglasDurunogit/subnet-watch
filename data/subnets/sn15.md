...
- miner_burn: **0.0**
- registration cost: 0.417787549 TAO (107.20846294889 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 91  |  free: 0
- subnet age: 231.3 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 49.195348030695506** (uid 35) <- the only figure quotable as achievable
- median_miner_usd_day: 26.940309635857062
- top_miner_usd_day: 23520.842508453632 (uid 104, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 78  |  gini: 0.9322040633362108  |  top1_share: 0.9197954042293305  |  top10_share: 0.936621116115734
...
- latest release: v1.2.13: compose: forward SUBTENSOR_CHAIN_ENDPOINT to the validator (#274) 2026-09-08T20:21:13Z
- last commit: 2026-09-08T20:21:13Z
...
- net margin: 25.5636 USD/day  |  payback on registration: 4.19 days

## Score

- gate: **OK** 
- score: 71.6 (rank 7), confidence 1.0 
- components: income 12.95 / freshness 35.0 / resource 15.0 / registration 8.6
