...
- miner_burn: **0.0**
- registration cost: 0.126 TAO (30.3156 USD), open=True
...
- **competitive_miner_usd_day: 1450.437499130104** (uid 81) <- the only figure quotable as achievable
- median_miner_usd_day: 725.218749565052
- top_miner_usd_day: 2900.874998260208 (uid 106, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 535.6949 USD/day  |  payback on registration: 0.06 days
