...
- miner_burn: **0.0**
- registration cost: 0.386338181 TAO (74.08034620675 USD), open=True
...
- **competitive_miner_usd_day: 102.77682600641525** (uid 21) <- the only figure quotable as achievable
- median_miner_usd_day: 19.476391405130293
- top_miner_usd_day: 135.32891680560013 (uid 84, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.6512 USD/day  |  payback on registration: 8.56 days

## Score

- gate: **OK** 
- score: 23.2 (rank 70), confidence 0.85 - hardware requirement unknown
- components: income 8.95 / freshness 0.0 / resource 11.25 / registration 7.15
