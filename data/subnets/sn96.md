...
- **competitive_miner_usd_day: 217.63617826862648** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 42.32024125084903
- top_miner_usd_day: 2147.0167312663357 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.9502 USD/day  |  payback on registration: 0.58 days

## Score

- gate: **OK** 
- score: 70.1 (rank 6), confidence 1.0 
- components: income 14.04 / freshness 35.0 / resource 11.25 / registration 9.81
