...
- miner_burn: **0.0**
- registration cost: 0.338088952 TAO (65.01788635912 USD), open=True
...
- **competitive_miner_usd_day: 14610.644794904496** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 15.698165391156458
- top_miner_usd_day: 14610.644794904496 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 14.7119 USD/day  |  payback on registration: 4.42 days

## Score

- gate: **OK** 
- score: 69.4 (rank 6), confidence 1.0 
- components: income 10.88 / freshness 35.0 / resource 15.0 / registration 8.53
