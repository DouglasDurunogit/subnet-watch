...
- registration cost: 0.1 TAO (18.726 USD), open=True
...
- **competitive_miner_usd_day: 58.064328812736235** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.2206838485669866
- top_miner_usd_day: 2426.0491235869804 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 57.078 USD/day  |  payback on registration: 0.33 days
