...
- subnet age: 512.7 days  |  registered at block 5102795
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5.2170942900363935** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 3.586752324400021
- top_miner_usd_day: 10144.150744386074 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.7139 USD/day  |  payback on registration: [UNKNOWN] days
