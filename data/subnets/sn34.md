...
- miner_burn: **0.8360794296022505**
- registration cost: 0.5 TAO (118.77 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 148  |  free: 0
- subnet age: 765.6 days  |  registered at block 3493948
- weights_version: 404020  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 27.466922637421714** (uid 175) <- the only figure quotable as achievable
- median_miner_usd_day: 8.214406770070044
- top_miner_usd_day: 7032.558996026218 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 144  |  gini: 0.8869320872607283  |  top1_share: 0.8370430345712584  |  top10_share: 0.8610886203577812
- owner_incentive_share: 0.8370430345712584 (independent check on miner_burn; disagreement 0.001)
...
- status: **ok** 
- README: 6110 bytes, sha 4da996a2ce2b0189
- latest release: Release 4.9.8 2026-08-20T23:57:40Z
- last commit: 2026-09-05T19:20:14Z
- scoring-related commit: burn discriminator incentive until KoTH ships (#436) 2026-09-04T18:44:10Z
...
- net margin: -21.3746 USD/day  |  payback on registration: [UNKNOWN] days

## Score

- gate: **OK** 
- score: 38.8 (rank 54), confidence 1.0 
...
Contributions are welcome and can be made via a pull request to the `testne
```

_(truncated at 6000 of 6110 chars - read the full file at https://github.com/BitMind-AI/bitmind-subnet)_
