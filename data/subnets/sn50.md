...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (192.48000000000002 USD), open=True
...
- **competitive_miner_usd_day: 120.50555244241032** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 6.363833567934639
- top_miner_usd_day: 120.50555244241032 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -1.8553 USD/day  |  payback on registration: [UNKNOWN] days
