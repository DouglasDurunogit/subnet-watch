...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9673 USD), open=True
...
- **competitive_miner_usd_day: 750.8187730023078** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 2.770069837559676
- top_miner_usd_day: 750.8187730023078 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.579 USD/day  |  payback on registration: [UNKNOWN] days
