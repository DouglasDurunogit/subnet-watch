...
- subnet age: 192.3 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3505.3105355468115** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 876.3276338867029
- top_miner_usd_day: 3505.3105355468115 (uid 90, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 868.1085 USD/day  |  payback on registration: 0.03 days
