...
- registration cost: 0.077580128 TAO (17.45242559488 USD), open=True
...
- **competitive_miner_usd_day: 924.2892992259993** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 14.39308981724093
- top_miner_usd_day: 924.2892992259993 (uid 25, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 13.4068 USD/day  |  payback on registration: 1.3 days

## Score

- gate: **OK** 
- score: 70.1 (rank 6), confidence 1.0 
- components: income 10.54 / freshness 35.0 / resource 15.0 / registration 9.57
