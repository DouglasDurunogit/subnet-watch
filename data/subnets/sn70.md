...
- miner_burn: **0.0**
- registration cost: 0.9 TAO (179.577 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 143.2 days  |  registered at block 7787562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 50.59458299325965** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 101.21311041765665
- top_miner_usd_day: 404.9362471796074 (uid 26, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 29.7806 USD/day  |  payback on registration: 6.03 days
...
- components: income 13.54 / freshness 0.0 / resource 11.25 / registration 7.99
