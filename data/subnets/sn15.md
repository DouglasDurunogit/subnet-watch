...
- miner_burn: **0.0**
- registration cost: 0.448370864 TAO (101.3093967208 USD), open=True
...
- **competitive_miner_usd_day: 22477.941259961462** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 19.838357606115096
- top_miner_usd_day: 22477.941259961462 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.8521 USD/day  |  payback on registration: 5.37 days

## Score

- gate: **OK** 
- score: 70.0 (rank 5), confidence 1.0 
- components: income 11.8 / freshness 35.0 / resource 15.0 / registration 8.21
