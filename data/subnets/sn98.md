...
- miner_burn: **0.0**
- registration cost: 0.121240192 TAO (26.33458210432 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 504.5 days  |  registered at block 5445992
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1632.9099144872666** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 1632.9099144872666
- top_miner_usd_day: 1632.9099144872666 (uid 60, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-09-09T19:57:24Z
...
- net margin: 1631.9236 USD/day  |  payback on registration: 0.02 days

## Score

- gate: **OK** 
- score: 55.0 (rank 22), confidence 0.85 - income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 29.22 / freshness 10.5 / resource 15.0 / registration 9.99
