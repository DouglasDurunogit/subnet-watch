...
- **competitive_miner_usd_day: 1701.5358811214262** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.8502030331721153
- top_miner_usd_day: 1701.5358811214262 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.4113 USD/day  |  payback on registration: [UNKNOWN] days
