...
- miner_burn: **0.0**
- registration cost: 0.012698881 TAO (2.9601091611 USD), open=True
...
- **competitive_miner_usd_day: 229.05906170011588** (uid 255) <- the only figure quotable as achievable
- median_miner_usd_day: 3.011496563613983
- top_miner_usd_day: 696.3043362239162 (uid 252, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.2772 USD/day  |  payback on registration: [UNKNOWN] days
