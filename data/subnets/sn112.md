...
- subnet age: 457.1 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 483.8133222795207** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 1209.5148494036055
- top_miner_usd_day: 1935.2163765276907 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-25T14:18:43Z
- scoring-related commit: fix(dedup): a waitlisted miner could never resubmit that solver again… 2026-08-24T07:39:41Z
...
- net margin: 475.5941 USD/day  |  payback on registration: 0.49 days
...
- components: income 24.36 / freshness 35.0 / resource 11.25 / registration 9.84
