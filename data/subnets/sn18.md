...
- subnet age: 1041.2 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1275.10568791309** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 14.557073110888185
- top_miner_usd_day: 1275.10568791309 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.5439 USD/day  |  payback on registration: 76.28 days

## Score

- gate: **OK** 
- score: 32.5 (rank 62), confidence 0.85 - hardware requirement unknown
