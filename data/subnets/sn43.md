...
- **competitive_miner_usd_day: 16.212085150777384** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.8064894882294797
- top_miner_usd_day: 2318.1892158313017 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.8993065512552043  |  top1_share: 0.7638081284434474  |  top10_share: 0.9973291821192558
- owner_incentive_share: 0.7638081284434473 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.6349 USD/day  |  payback on registration: 30.29 days

## Score

- gate: **OK** 
- score: 16.9 (rank 64), confidence 1.0 
- components: income 1.94 / freshness 0.0 / resource 15.0 / registration 0.0
