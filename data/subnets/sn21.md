...
- miner_burn: **0.1505551734007895**
- registration cost: 0.1 TAO (25.661 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 42  |  free: 0
- subnet age: 816.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 31.143125986535274** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 11.678672244950727
- top_miner_usd_day: 1246.5333992889305 (uid 110, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.439 USD/day  |  payback on registration: 58.45 days

## Score

- gate: **OK** 
- score: 51.4 (rank 32), confidence 1.0 
- components: income 1.44 / freshness 35.0 / resource 15.0 / registration 0.0
