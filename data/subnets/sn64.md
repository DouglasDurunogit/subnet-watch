...
- subnet age: 632.3 days  |  registered at block 4531295
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 207) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 207, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 17  |  gini: 0.40296635693055105  |  top1_share: 0.1478627130801044  |  top10_share: 0.8736551345246997
...
- gate: **OK** 
- score: 3.2 (rank 92), confidence 0.85 - hardware from README keywords, not curated
