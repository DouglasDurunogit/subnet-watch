...
- miner_burn: **0.0**
- registration cost: 0.413889136 TAO (97.34258589584 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 91  |  free: 0
- subnet age: 219.6 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 37.54209789398499** (uid 149) <- the only figure quotable as achievable
- median_miner_usd_day: 19.521890904872198
- top_miner_usd_day: 23176.989555830576 (uid 230, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 77  |  gini: 0.9501849551318979  |  top1_share: 0.942606305824872  |  top10_share: 0.9558744942362012
...
- net margin: 18.1602 USD/day  |  payback on registration: 5.36 days

## Score

- gate: **OK** 
- score: 69.9 (rank 6), confidence 1.0 
- components: income 11.66 / freshness 35.0 / resource 15.0 / registration 8.21
