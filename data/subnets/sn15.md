...
- miner_burn: **0.0**
- registration cost: 0.461975692 TAO (99.209279857 USD), open=True
...
- **competitive_miner_usd_day: 19206.343982368715** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 20.67078994708116
- top_miner_usd_day: 19206.343982368715 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.6845 USD/day  |  payback on registration: 5.04 days

## Score

- gate: **OK** 
- score: 70.3 (rank 4), confidence 1.0 
- components: income 11.97 / freshness 35.0 / resource 15.0 / registration 8.32
