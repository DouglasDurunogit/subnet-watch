...
- subnet age: 738.1 days  |  registered at block 3493948
- weights_version: 404020  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 301.3104942365183** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 11.364819627192405
- top_miner_usd_day: 3013.333380950654 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -18.2813 USD/day  |  payback on registration: [UNKNOWN] days
