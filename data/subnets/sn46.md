...
- **competitive_miner_usd_day: 1.8143650992483984** (uid 247) <- the only figure quotable as achievable
- median_miner_usd_day: 1651.425033529785
- top_miner_usd_day: 3301.0357019603216 (uid 238, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.4048 USD/day  |  payback on registration: [UNKNOWN] days
