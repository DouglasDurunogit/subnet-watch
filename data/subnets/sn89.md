...
- **competitive_miner_usd_day: 114.42902687986577** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 7.68333688730733
- top_miner_usd_day: 114.42902687986577 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.5358 USD/day  |  payback on registration: [UNKNOWN] days
