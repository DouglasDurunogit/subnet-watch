...
- miner_burn: **0.45076591963879764**
- registration cost: 0.1 TAO (19.229 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 134  |  free: 0
- subnet age: 777.9 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 25.128157505216837** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.252955860673171
- top_miner_usd_day: 859.1270517408626 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.2667 USD/day  |  payback on registration: 3.65 days

## Score

- gate: **OK** 
- score: 31.0 (rank 49), confidence 1.0 
- components: income 7.25 / freshness 0.0 / resource 15.0 / registration 8.78
