...
- subnet age: 863.0 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 620.9231277320572** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 450.61342396664634
- top_miner_usd_day: 620.9231277320572 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.27356827857720534  |  top1_share: 0.3807852532311965  |  top10_share: 1.0
...
- net margin: 13.3531 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 17.4 (rank 62), confidence 0.85 - hardware from README keywords, not curated
- components: income 10.52 / freshness 0.0 / resource 0.0 / registration 10.0
