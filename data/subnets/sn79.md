...
- miner_burn: **0.0**
- registration cost: 0.131031753 TAO (25.13057990787 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 218  |  free: 0
- subnet age: 495.7 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 318.6325774780042** (uid 30) <- the only figure quotable as achievable
- median_miner_usd_day: 6.532330745562727
- top_miner_usd_day: 318.6325774780042 (uid 30, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 217  |  gini: 0.7081829171991549  |  top1_share: 0.07383679148636872  |  top10_share: 0.43690463448571126
...
- net margin: 5.546 USD/day  |  payback on registration: 4.53 days

## Score

- gate: **OK** 
- score: 30.9 (rank 50), confidence 1.0 
- components: income 7.42 / freshness 0.0 / resource 15.0 / registration 8.49
