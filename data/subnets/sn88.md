...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9994 USD), open=True
...
- **competitive_miner_usd_day: 683.970800869246** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 2.9729906417347194
- top_miner_usd_day: 683.970800869246 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.4749 USD/day  |  payback on registration: [UNKNOWN] days
