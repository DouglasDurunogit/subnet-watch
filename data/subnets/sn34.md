...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (115.665 USD), open=True
...
- **competitive_miner_usd_day: 335.70011562600314** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 11.393689931182134
- top_miner_usd_day: 3358.146890443056 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -18.5136 USD/day  |  payback on registration: [UNKNOWN] days
