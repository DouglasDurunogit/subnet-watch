...
- subnet age: 499.5 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 120.43321255288157** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 4.46342388628004
- top_miner_usd_day: 120.43321255288157 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.7558 USD/day  |  payback on registration: [UNKNOWN] days
