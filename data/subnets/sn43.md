...
- registration cost: 0.1 TAO (21.219 USD), open=True
...
- **competitive_miner_usd_day: 25.54088035165548** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8447372878952202
- top_miner_usd_day: 2620.0272340500755 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7875 USD/day  |  payback on registration: [UNKNOWN] days
