...
- subnet age: 1009.6 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1446.2830533681536** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 3.9649504803417486
- top_miner_usd_day: 1446.2830533681536 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.3312 USD/day  |  payback on registration: [UNKNOWN] days
