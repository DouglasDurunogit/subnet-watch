...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9912 USD), open=True
...
- **competitive_miner_usd_day: 692.8282217243793** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 4.419806775846057
- top_miner_usd_day: 692.8282217243793 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.8464 USD/day  |  payback on registration: [UNKNOWN] days
