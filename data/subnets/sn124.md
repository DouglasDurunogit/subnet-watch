...
- subnet age: 443.2 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 859.5017487108095** (uid 175) <- the only figure quotable as achievable
- median_miner_usd_day: 284.20595580940955
- top_miner_usd_day: 859.5017487108095 (uid 175, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 25  |  gini: 0.31021427263292845  |  top1_share: 0.10670899212502288  |  top10_share: 0.6287161955924547
...
- net margin: 275.9868 USD/day  |  payback on registration: 0.43 days

## Score

- gate: **OK** 
- score: 66.6 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 22.21 / freshness 35.0 / resource 11.25 / registration 9.86
