...
- registration cost: 0.0001 TAO (0.020421 USD), open=True
...
- median_miner_usd_day: 2317.600544363875
- top_miner_usd_day: 2317.600544363875 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 7536 bytes, sha 5b02a23b3910396f
- latest release: (none) 
- last commit: 2026-08-20T03:10:23Z
...
mt inspect readiness
```

_(truncated at 6000 of 7536 chars - read the full file at https://github.com/microtensor-io/microtensor-subnet)_
