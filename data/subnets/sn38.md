...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (142.0504 USD), open=True
...
- **competitive_miner_usd_day: 3033.004588145726** (uid 168) <- the only figure quotable as achievable
- median_miner_usd_day: 143.8292629880769
- top_miner_usd_day: 3033.004588145726 (uid 168, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 142.843 USD/day  |  payback on registration: 0.99 days

## Score

- gate: **OK** 
- score: 67.4 (rank 11), confidence 0.85 - hardware from README keywords, not curated
