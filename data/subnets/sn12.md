...
- subnet age: 915.0 days  |  registered at block 2256433
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.332192505720526** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 14.347558160129703
- top_miner_usd_day: 2804.263352146951 (uid 21, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.2348 USD/day  |  payback on registration: 0.42 days
