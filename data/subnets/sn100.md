...
- subnet age: 325.8 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3482.3375753041873
- top_miner_usd_day: 3482.3375753041873 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-10T12:59:31Z
- scoring-related commit: fix(proof): fail closed on incomplete harbor evaluate (#267) 2026-09-10T11:36:06Z
