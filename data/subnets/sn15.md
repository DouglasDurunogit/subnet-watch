...
- miner_burn: **0.0**
- registration cost: 0.287897219 TAO (55.296418853329996 USD), open=True
...
- **competitive_miner_usd_day: 21.15649901906418** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.077223543000587
- top_miner_usd_day: 12334.238928114417 (uid 13, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.0909 USD/day  |  payback on registration: 5.48 days

## Score

- gate: **OK** 
- score: 67.7 (rank 11), confidence 1.0 
- components: income 9.5 / freshness 35.0 / resource 15.0 / registration 8.17
