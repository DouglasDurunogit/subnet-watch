...
- miner_burn: **0.0**
- registration cost: 0.162734548 TAO (37.86670197412 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 254  |  free: 0
- subnet age: 851.0 days  |  registered at block 2943950
- weights_version: 2388  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 18.424605237381865** (uid 154) <- the only figure quotable as achievable
- median_miner_usd_day: 12.562230843669452
- top_miner_usd_day: 18.424605237381865 (uid 154, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 245  |  gini: 0.10484089221479387  |  top1_share: 0.006094933201994706  |  top10_share: 0.05779412670073262
...
- net margin: 4.3431 USD/day  |  payback on registration: 8.72 days

## Score

- gate: **OK** 
- score: 39.1 (rank 53), confidence 0.85 - hardware requirement unknown
- components: income 6.62 / freshness 21.0 / resource 11.25 / registration 7.09
