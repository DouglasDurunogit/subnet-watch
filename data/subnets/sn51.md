...
- **competitive_miner_usd_day: 3553.094538440677** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 19.423086813401934
- top_miner_usd_day: 22432.867060432112 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.9378 USD/day  |  payback on registration: 8.59 days

## Score

- gate: **OK** 
- score: 24.0 (rank 43), confidence 0.85 - hardware requirement unknown
