...
- subnet age: 662.4 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2889.042820855575** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 24.26818544574912
- top_miner_usd_day: 24930.19896965292 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 39  |  gini: 0.9048752938303264  |  top1_share: 0.674252831455872  |  top10_share: 0.9747840156302471
...
- net margin: 15.4846 USD/day  |  payback on registration: 6.25 days

## Score

- gate: **OK** 
- score: 55.5 (rank 17), confidence 0.85 - hardware requirement unknown
- components: income 11.07 / freshness 35.0 / resource 11.25 / registration 7.92
