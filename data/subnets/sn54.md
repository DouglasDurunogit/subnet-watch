...
- **competitive_miner_usd_day: 1190.635628427258** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 2.0719318340333386
- top_miner_usd_day: 1190.635628427258 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.024 USD/day  |  payback on registration: [UNKNOWN] days
