...
- registration cost: 0.8 TAO (152.27200000000002 USD), open=True
...
- **competitive_miner_usd_day: 41.64002233961437** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 8.919660328937848
- top_miner_usd_day: 41.64002233961437 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.9246 USD/day  |  payback on registration: 164.69 days

## Score

- gate: **OK** 
- score: 29.6 (rank 59), confidence 0.85 - hardware requirement unknown
- components: income 2.59 / freshness 21.0 / resource 11.25 / registration 0.0
