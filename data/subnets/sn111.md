...
- registration cost: 0.000596921 TAO (0.12466098164000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 454.3 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4038.4372846199635
- top_miner_usd_day: 4038.4372846199635 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 18160 bytes, sha 753e9c308f5a9e37
- latest release: (none) 
- last commit: 2026-08-20T07:12:31Z
- scoring-related commit: fix(scoring): handle missing claim assessments safely 2026-08-20T07:12:31Z
...
_(truncated at 6000 of 18160 chars - read the full file at https://github.com/DeSciClaims/Claims)_
