...
- subnet age: 137.0 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1818.408336604444** (uid 64) <- the only figure quotable as achievable
- median_miner_usd_day: 27.331642447788735
- top_miner_usd_day: 1818.408336604444 (uid 64, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.7732977262322598  |  top1_share: 0.6822676636654967  |  top10_share: 1.0
...
- net margin: 24.3727 USD/day  |  payback on registration: 1.08 days

## Score

- gate: **OK** 
- score: 44.2 (rank 40), confidence 1.0 
- components: income 12.77 / freshness 10.5 / resource 11.25 / registration 9.64
