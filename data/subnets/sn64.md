...
- **competitive_miner_usd_day: 8108.117578176805** (uid 207) <- the only figure quotable as achievable
- median_miner_usd_day: 2326.2844305075514
- top_miner_usd_day: 10402.78260865804 (uid 21, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1961.6803 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 37.1 (rank 53), confidence 0.85 - hardware from README keywords, not curated
