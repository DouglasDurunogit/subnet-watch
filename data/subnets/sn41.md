...
- **competitive_miner_usd_day: 25.213570870072495** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.632100265227086
- top_miner_usd_day: 2426.325214470852 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.418 USD/day  |  payback on registration: 1.99 days

## Score

- gate: **OK** 
- score: 55.3 (rank 22), confidence 1.0 
- components: income 9.95 / freshness 21.0 / resource 15.0 / registration 9.34
