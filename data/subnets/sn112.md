...
- registration cost: 0.99 TAO (240.05519999999999 USD), open=True
...
- **competitive_miner_usd_day: 561.671096601458** (uid 158) <- the only figure quotable as achievable
- median_miner_usd_day: 1409.8572715137102
- top_miner_usd_day: 2258.0434464259624 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 553.4519 USD/day  |  payback on registration: 0.43 days
...
- components: income 24.96 / freshness 35.0 / resource 11.25 / registration 9.86
