...
- registration cost: 0.1 TAO (23.0 USD), open=True
...
- **competitive_miner_usd_day: 179.33222942134876** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.309652161382075
- top_miner_usd_day: 2732.143318083683 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.4903 USD/day  |  payback on registration: 46.91 days
