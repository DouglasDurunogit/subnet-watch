...
- subnet age: 74.6 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2470.1083450642805
- top_miner_usd_day: 2470.1083450642805 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-20T22:23:11Z
- scoring-related commit: Drop the task generator in favour of uploaded corpora 2026-08-20T21:18:03Z
