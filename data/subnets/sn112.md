...
- **competitive_miner_usd_day: 493.8695763236007** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 1234.6551008923036
- top_miner_usd_day: 1975.4406254610067 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-25T20:33:24Z
- scoring-related commit: fix(anchor): a validator with no archive for a chain could not pin it… 2026-08-25T20:30:12Z
...
- net margin: 485.6504 USD/day  |  payback on registration: 0.47 days
...
- components: income 24.44 / freshness 35.0 / resource 11.25 / registration 9.84
