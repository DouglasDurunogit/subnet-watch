...
- miner_burn: **0.0**
- registration cost: 0.9 TAO (180.225 USD), open=True
...
- **competitive_miner_usd_day: 50.70098971899809** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 101.42597422726215
- top_miner_usd_day: 405.78787867147946 (uid 26, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 29.8606 USD/day  |  payback on registration: 6.04 days
...
- components: income 13.55 / freshness 0.0 / resource 11.25 / registration 7.99
