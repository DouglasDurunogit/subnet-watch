...
- subnet age: 192.4 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3469.771172516862** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 867.4427931292155
- top_miner_usd_day: 3469.771172516862 (uid 90, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-07T10:56:43Z
- scoring-related commit: receipt: publish every duelled challenger's diagnostics (cohort_stats) 2026-09-04T21:55:54Z
...
- net margin: 859.2236 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 70.5 (rank 8), confidence 0.85 - hardware requirement unknown
- components: income 26.69 / freshness 35.0 / resource 11.25 / registration 9.99
