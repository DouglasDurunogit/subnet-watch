...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (99.97 USD), open=True
...
- **competitive_miner_usd_day: 290.4796698350972** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 10.130450957099674
- top_miner_usd_day: 2905.2371527404107 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.4586 USD/day  |  payback on registration: [UNKNOWN] days
