...
- miner_burn: **0.0**
- registration cost: 0.467883153 TAO (113.13882522693 USD), open=True
...
- **competitive_miner_usd_day: 47.159116570506825** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 28.040555798679737
- top_miner_usd_day: 25759.499070147744 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 26.8418 USD/day  |  payback on registration: 4.22 days

## Score

- gate: **OK** 
- score: 71.7 (rank 7), confidence 1.0 
- components: income 13.14 / freshness 35.0 / resource 15.0 / registration 8.59
