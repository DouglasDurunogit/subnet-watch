...
- subnet age: 823.2 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3678.4363264015983
- top_miner_usd_day: 3678.4363264015983 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-07T21:04:54Z
- scoring-related commit: feat: default miner --api-base to https://api.pareton.ai (#53) 2026-08-06T20:28:19Z
