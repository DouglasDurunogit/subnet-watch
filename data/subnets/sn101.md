...
- registration cost: 0.009029616 TAO (1.9040751259200002 USD), open=True
...
- **competitive_miner_usd_day: 2.0486151272120274** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1332764533513342
- top_miner_usd_day: 2575.4579153527034 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.147 USD/day  |  payback on registration: 12.95 days

## Score

- gate: **OK** 
- score: 42.2 (rank 43), confidence 1.0 
- components: income 0.54 / freshness 21.0 / resource 15.0 / registration 5.68
