...
- miner_burn: **9.166542440652847e-07**
- registration cost: 0.8 TAO (224.18400000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 254  |  free: 0
- subnet age: 607.6 days  |  registered at block 4763204
- weights_version: 100  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 99.3948862106051** (uid 38) <- the only figure quotable as achievable
- median_miner_usd_day: 9.17801587535775
- top_miner_usd_day: 99.3948862106051 (uid 38, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 246  |  gini: 0.46239601289996735  |  top1_share: 0.030126559060895088  |  top10_share: 0.2002017608217168
...
- net margin: 0.858 USD/day  |  payback on registration: 261.29 days

## Score

- gate: **OK** 
- score: 41.4 (rank 46), confidence 0.85 - hardware requirement unknown
- components: income 2.45 / freshness 35.0 / resource 11.25 / registration 0.0
