...
- **competitive_miner_usd_day: 23.493209604775515** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 12.71487157568653
- top_miner_usd_day: 2339.2306014715955 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.7031 USD/day  |  payback on registration: 1.96 days

## Score

- gate: **OK** 
- score: 55.4 (rank 26), confidence 1.0 
- components: income 10.04 / freshness 21.0 / resource 15.0 / registration 9.35
