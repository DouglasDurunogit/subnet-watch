...
- **competitive_miner_usd_day: 1255.968856673386** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 5.127043177621403
- top_miner_usd_day: 1255.968856673386 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.1593 USD/day  |  payback on registration: [UNKNOWN] days
