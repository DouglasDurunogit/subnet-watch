...
- subnet age: 485.1 days  |  registered at block 5258781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 569.0639896245797** (uid 215) <- the only figure quotable as achievable
- median_miner_usd_day: 305.09720168145645
- top_miner_usd_day: 569.0639896245797 (uid 215, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.34738665323749807  |  top1_share: 0.18622289368066047  |  top10_share: 1.0
...
- net margin: 425.5621 USD/day  |  payback on registration: 0.0 days
