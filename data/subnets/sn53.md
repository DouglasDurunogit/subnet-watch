...
- **competitive_miner_usd_day: 310.3094330518479** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 43.70142299123379
- top_miner_usd_day: 12014.958341180483 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 35.1889 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.9 (rank 23), confidence 0.85 - hardware from README keywords, not curated
