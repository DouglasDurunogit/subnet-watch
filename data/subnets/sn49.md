...
- subnet age: 323.2 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 53.919425601408456** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 2697.370715544048
- top_miner_usd_day: 5340.822005486687 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 45.7002 USD/day  |  payback on registration: 0.29 days
...
- components: income 15.18 / freshness 35.0 / resource 11.25 / registration 9.9
