...
- subnet age: 117.6 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 382.23559653745787** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 25.022238695000425
- top_miner_usd_day: 1783.7920402400146 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 19.7886 USD/day  |  payback on registration: 1.16 days

## Score

- gate: **OK** 
- score: 53.8 (rank 28), confidence 1.0 
- components: income 11.99 / freshness 21.0 / resource 11.25 / registration 9.61
