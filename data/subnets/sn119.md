...
- subnet age: 425.0 days  |  registered at block 5740660
- weights_version: 11901  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1801.0890063777945
- top_miner_usd_day: 1801.0890063777945 (uid 35, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 6.8 (rank 86), confidence 0.6 - hardware requirement unknown; no README readable; repo dead
