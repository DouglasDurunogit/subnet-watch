...
- **competitive_miner_usd_day: 24.394619732318155** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.17276799520101
- top_miner_usd_day: 2356.6086168773827 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.941 USD/day  |  payback on registration: 2.02 days

## Score

- gate: **OK** 
- score: 55.1 (rank 22), confidence 1.0 
- components: income 9.8 / freshness 21.0 / resource 15.0 / registration 9.33
