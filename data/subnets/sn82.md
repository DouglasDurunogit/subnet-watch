...
- miner_burn: **0.0**
- registration cost: 0.00063 TAO (0.14385420000000002 USD), open=True
...
- **competitive_miner_usd_day: 2256.3215408392834** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2256.3215408392834
- top_miner_usd_day: 2256.3215408392834 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2248.1024 USD/day  |  payback on registration: 0.0 days
