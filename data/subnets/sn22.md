...
- **competitive_miner_usd_day: 96.52921177437051** (uid 223) <- the only figure quotable as achievable
- median_miner_usd_day: 17.451868604921902
- top_miner_usd_day: 1057.5311423281037 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 52  |  gini: 0.7424265286974616  |  top1_share: 0.5268139282824736  |  top10_share: 0.7480116628757231
- owner_incentive_share: 0.5268139282824736 (independent check on miner_burn; disagreement 0.0002)
...
- net margin: 8.9722 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 25.8 (rank 67), confidence 0.85 - hardware requirement unknown
- components: income 9.08 / freshness 0.0 / resource 11.25 / registration 10.0
