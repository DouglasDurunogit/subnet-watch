...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (24.676999753230003 USD), open=True
...
- **competitive_miner_usd_day: 147.52874015816403** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 98.89647846885772
- top_miner_usd_day: 330.0315332503516 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 87.3401 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 77.6 (rank 1), confidence 1.0 
- components: income 17.7 / freshness 35.0 / resource 15.0 / registration 9.91
