...
- registration cost: 0.1 TAO (19.889 USD), open=True
...
- **competitive_miner_usd_day: 23.10055558475795** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7481961322998524
- top_miner_usd_day: 2486.162223115872 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.846 USD/day  |  payback on registration: [UNKNOWN] days
