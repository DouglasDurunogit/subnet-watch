...
- subnet age: 311.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 58.49173915766865** (uid 135) <- the only figure quotable as achievable
- median_miner_usd_day: 2926.1050640905783
- top_miner_usd_day: 5793.718389023488 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 50.2726 USD/day  |  payback on registration: 0.26 days
...
- components: income 15.55 / freshness 10.5 / resource 11.25 / registration 9.91
