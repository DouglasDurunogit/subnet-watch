...
- miner_burn: **0.15056652342900634**
- registration cost: 0.1 TAO (23.397000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 29  |  free: 0
- subnet age: 801.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 594.7984128218314** (uid 244) <- the only figure quotable as achievable
- median_miner_usd_day: 11.145618425803312
- top_miner_usd_day: 1189.596825643663 (uid 39, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.5764 USD/day  |  payback on registration: 5.11 days

## Score

- gate: **OK** 
- score: 65.1 (rank 14), confidence 1.0 
- components: income 6.79 / freshness 35.0 / resource 15.0 / registration 8.3
