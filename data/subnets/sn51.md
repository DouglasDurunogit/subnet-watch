...
- **competitive_miner_usd_day: 1411.9439936047686** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 19.37831321085579
- top_miner_usd_day: 35887.967848807995 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.4863 USD/day  |  payback on registration: 11.64 days

## Score

- gate: **OK** 
- score: 52.1 (rank 25), confidence 0.85 - hardware requirement unknown
- components: income 8.89 / freshness 35.0 / resource 11.25 / registration 6.12
