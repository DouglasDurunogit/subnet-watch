...
- registration cost: 0.1 TAO (20.887 USD), open=True
...
- **competitive_miner_usd_day: 24.683565417206097** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.933702447126955
- top_miner_usd_day: 2617.418974680664 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.0117 USD/day  |  payback on registration: 20.65 days

## Score

- gate: **OK** 
- score: 20.9 (rank 66), confidence 1.0 
- components: income 2.76 / freshness 0.0 / resource 15.0 / registration 3.12
