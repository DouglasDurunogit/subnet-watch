...
- subnet age: 1038.6 days  |  registered at block 1489797
- weights_version: 4062  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 199.6216567613892** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 9986.263858168611
- top_miner_usd_day: 19772.90605957583 (uid 128, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.490005188146611  |  top1_share: 0.9900051881466109  |  top10_share: 1.0
...
- net margin: 191.4025 USD/day  |  payback on registration: 0.0 days
...
- components: income 20.78 / freshness 35.0 / resource 11.25 / registration 10.0
