...
- **competitive_miner_usd_day: 677.29130257156** (uid 132) <- the only figure quotable as achievable
- median_miner_usd_day: 129.23367764342257
- top_miner_usd_day: 677.29130257156 (uid 132, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 130.008 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 34.4 (rank 55), confidence 0.85 - hardware requirement unknown
- components: income 19.26 / freshness 0.0 / resource 11.25 / registration 10.0
