...
- miner_burn: **0.0**
- registration cost: 0.190080366 TAO (36.57716482938 USD), open=True
...
- **competitive_miner_usd_day: 94.77312895945276** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 20.000524794928072
- top_miner_usd_day: 94.77312895945276 (uid 34, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 243  |  gini: 0.40785475701354645  |  top1_share: 0.015791485133379194  |  top10_share: 0.12805931361308567
...
- net margin: 8.3409 USD/day  |  payback on registration: 4.39 days

## Score

- gate: **OK** 
- score: 24.3 (rank 68), confidence 0.85 - hardware requirement unknown
- components: income 8.83 / freshness 0.0 / resource 11.25 / registration 8.54
