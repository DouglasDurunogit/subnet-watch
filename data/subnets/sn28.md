...
- **competitive_miner_usd_day: 2397.067661938763** (uid 41) <- the only figure quotable as achievable
- median_miner_usd_day: 16.802558888391918
- top_miner_usd_day: 2397.067661938763 (uid 41, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8.5834 USD/day  |  payback on registration: 2.29 days

## Score

- gate: **OK** 
- score: 54.8 (rank 22), confidence 0.85 - hardware requirement unknown
- components: income 8.93 / freshness 35.0 / resource 11.25 / registration 9.24
