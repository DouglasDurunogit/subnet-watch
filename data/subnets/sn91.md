...
- subnet age: 209.8 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2617.288685611834** (uid 87) <- the only figure quotable as achievable
- median_miner_usd_day: 654.3221714029585
- top_miner_usd_day: 2617.288685611834 (uid 87, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 653.3359 USD/day  |  payback on registration: 0.05 days

## Score

- gate: **OK** 
- score: 72.8 (rank 2), confidence 0.85 - hardware from README keywords, not curated
- components: income 25.61 / freshness 35.0 / resource 15.0 / registration 9.98
