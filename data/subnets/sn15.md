...
- miner_burn: **0.0**
- registration cost: 0.26324972 TAO (51.7101424996 USD), open=True
...
- **competitive_miner_usd_day: 10713.128053200346** (uid 94) <- the only figure quotable as achievable
- median_miner_usd_day: 10.252794938098273
- top_miner_usd_day: 10713.128053200346 (uid 94, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.0927 USD/day  |  payback on registration: 5.69 days

## Score

- gate: **OK** 
- score: 67.2 (rank 11), confidence 1.0 
- components: income 9.13 / freshness 35.0 / resource 15.0 / registration 8.1
