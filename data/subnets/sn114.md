...
- miner_burn: **0.0**
- registration cost: 0.074064135 TAO (15.334979151750002 USD), open=True
...
- **competitive_miner_usd_day: 724.1498803097749** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 1810.4299540843956
- top_miner_usd_day: 4707.250488563327 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 715.9307 USD/day  |  payback on registration: 0.02 days
...
- components: income 25.97 / freshness 35.0 / resource 11.25 / registration 9.99
