...
- **competitive_miner_usd_day: 334.9876689233751** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 47.176902334199326
- top_miner_usd_day: 12970.481906848827 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.6411 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.2 (rank 22), confidence 0.85 - hardware from README keywords, not curated
