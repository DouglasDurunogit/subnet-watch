...
- **competitive_miner_usd_day: 31.064114408363338** (uid 109) <- the only figure quotable as achievable
- median_miner_usd_day: 16.445707627957063
- top_miner_usd_day: 2265.208121252073 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 15.3788 USD/day  |  payback on registration: 1.57 days

## Score

- gate: **OK** 
- score: 56.5 (rank 23), confidence 1.0 
- components: income 11.04 / freshness 21.0 / resource 15.0 / registration 9.48
