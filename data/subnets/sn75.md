...
- **competitive_miner_usd_day: 3.144243150387785** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 2.263855068279205
- top_miner_usd_day: 7912.676542539884 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.0749 USD/day  |  payback on registration: [UNKNOWN] days
