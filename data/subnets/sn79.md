...
- miner_burn: **0.0**
- registration cost: 0.028841759 TAO (6.874721675240001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 228  |  free: 0
- subnet age: 524.7 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 462.83145945310713** (uid 128) <- the only figure quotable as achievable
- median_miner_usd_day: 5.412822353871393
- top_miner_usd_day: 462.83145945310713 (uid 128, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 227  |  gini: 0.7532639693416954  |  top1_share: 0.10063277596062725  |  top10_share: 0.49721823128419895
...
- net margin: 4.4265 USD/day  |  payback on registration: 1.55 days

## Score

- gate: **OK** 
- score: 66.2 (rank 13), confidence 1.0 
- components: income 6.68 / freshness 35.0 / resource 15.0 / registration 9.48
