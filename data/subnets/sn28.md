...
- miner_burn: **0.34172196383588016**
- registration cost: 0.1 TAO (28.773000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 77  |  free: 0
- subnet age: 591.0 days  |  registered at block 4878363
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 746.1833460409064** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 60.53692049009117
- top_miner_usd_day: 5894.190423717833 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 65  |  gini: 0.7230099895372311  |  top1_share: 0.34185659547834585  |  top10_share: 0.6526325430869984
- owner_incentive_share: 0.34185659547834585 (independent check on miner_burn; disagreement 0.0001)
...
- status: **ok** 
- README: 22886 bytes, sha 820e831336b7d03d
- latest release: v0.4.21-dev 2026-09-23T20:38:35Z
- last commit: 2026-09-23T21:19:12Z
- scoring-related commit: feat(image): route Chutes -TEE requests through the attestation verif… 2026-09-23T20:17:29Z
...
- net margin: 52.3177 USD/day  |  payback on registration: 0.55 days

## Score

- gate: **OK** 
- score: 61.0 (rank 16), confidence 0.85 - hardware requirement unknown
- components: income 15.71 / freshness 35.0 / resource 11.25 / registration 9.82
...
deploy time and stay inside the TEE — gm neve
```

_(truncated at 6000 of 22886 chars - read the full file at https://github.com/taostat/gm-miner)_
