...
- subnet age: 285.7 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 41.09435068450797** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2055.7841051591954
- top_miner_usd_day: 4070.473859633883 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 32.8752 USD/day  |  payback on registration: 0.31 days
...
- components: income 13.91 / freshness 21.0 / resource 11.25 / registration 9.9
