...
- miner_burn: **0.0**
- registration cost: 0.000587663 TAO (0.11665698212999999 USD), open=True
...
- **competitive_miner_usd_day: 43.2011912247547** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 43.2011912247547
- top_miner_usd_day: 4235.893288591484 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.982 USD/day  |  payback on registration: 0.0 days
...
- components: income 14.15 / freshness 21.0 / resource 11.25 / registration 10.0
