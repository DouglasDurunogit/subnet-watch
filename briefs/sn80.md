...
**sn80 "unknown"** (ى), 217.6 days old. Snapshot 2026-07-28T06:37:33Z b8718699.

- on-chain repo: `https://github.com/opentensor/subtensor`
- resolved: `https://github.com/RaoFoundation/subtensor` — **redirected** (https://github.com/opentensor/subtensor -> https://github.com/RaoFoundation/subtensor)

On-chain description: _unknown_ [VERIFIED: pack sn80, 2026-07-28]
...
From README §Chain architecture (high level) [VERIFIED: README §Chain architecture (high level)]:
...
- cheapest satisfying machine: **RTX 4090 (24 GB)** — $250.0/mo, 24 GB VRAM, 8 vCPU, 32 GB RAM, 1000 Mbps [margin:80.rtx4090]
...
**Miners earn nothing here.** `miner_burn` is 1.000 — 100.0% of miner emission is withheld by owner-controlled hotkeys and destroyed. [VERIFIED: pack sn80, 2026-07-28]
...
_Assembled from `data/subnets/sn80.md` and the repo README. Every claim is either quoted with a [VERIFIED] tag or marked [UNKNOWN]. Regenerate when this subnet appears in ALARMS.md under NEW SINCE LAST RUN._
