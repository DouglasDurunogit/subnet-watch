...
- subnet age: 121.3 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 246.20686914205174** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 24.177341720267094
- top_miner_usd_day: 1723.5607988741765 (uid 45, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 16.8226 USD/day  |  payback on registration: 1.32 days

## Score

- gate: **OK** 
- score: 53.2 (rank 25), confidence 1.0 
- components: income 11.38 / freshness 21.0 / resource 11.25 / registration 9.56
