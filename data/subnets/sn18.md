...
- subnet age: 1023.7 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1343.9496241835961** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.815571957258215
- top_miner_usd_day: 1343.9496241835961 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.4036 USD/day  |  payback on registration: [UNKNOWN] days
