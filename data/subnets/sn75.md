...
- miner_burn: **0.0**
- registration cost: 0.138234354 TAO (29.09418448638 USD), open=True
...
- **competitive_miner_usd_day: 12318.964576019485** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.095062002724402
- top_miner_usd_day: 12318.964576019485 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.1241 USD/day  |  payback on registration: [UNKNOWN] days
