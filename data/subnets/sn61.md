...
- miner_burn: **0.0**
- registration cost: 0.017196084 TAO (3.2939098902 USD), open=True
...
- **competitive_miner_usd_day: 320.66743953969313** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 26.503493841131974
- top_miner_usd_day: 320.66743953969313 (uid 34, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 82  |  gini: 0.5884432631601291  |  top1_share: 0.06899974043027499  |  top10_share: 0.5483639472920769
...
- net margin: 18.2843 USD/day  |  payback on registration: 0.18 days

## Score

- gate: **OK** 
- score: 45.8 (rank 37), confidence 0.85 - hardware requirement unknown
- components: income 11.69 / freshness 21.0 / resource 11.25 / registration 9.94
