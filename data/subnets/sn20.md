...
- miner_burn: **0.7534723042044789**
- registration cost: 0.2 TAO (43.504000000000005 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 987.7 days  |  registered at block 1970929
- weights_version: 1022  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 406.93734178333136** (uid 170) <- the only figure quotable as achievable
- median_miner_usd_day: 825.3352239548416
- top_miner_usd_day: 1243.7331061263517 (uid 240, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.2534714804528948  |  top1_share: 0.7534714804528947  |  top10_share: 1.0
- owner_incentive_share: 0.7534714804528947 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 5245 bytes, sha 5b75aaa7a16811b0
- latest release: (none) 
- last commit: 2026-09-15T20:46:41Z
- scoring-related commit: Derive semantic verdicts from validated field decisions 2026-09-15T10:27:48Z
...
- net margin: 398.7182 USD/day  |  payback on registration: 0.11 days
...
- components: income 23.66 / freshness 35.0 / resource 11.25 / registration 9.96
