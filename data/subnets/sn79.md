...
- miner_burn: **0.0**
- registration cost: 0.169957713 TAO (32.84092888299 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 217  |  free: 0
- subnet age: 502.4 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 370.56459206762787** (uid 20) <- the only figure quotable as achievable
- median_miner_usd_day: 6.559850076341678
- top_miner_usd_day: 370.56459206762787 (uid 20, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 216  |  gini: 0.7195088579137963  |  top1_share: 0.08464184695359682  |  top10_share: 0.468358688173687
...
- net margin: 5.5735 USD/day  |  payback on registration: 5.89 days

## Score

- gate: **OK** 
- score: 30.5 (rank 55), confidence 1.0 
- components: income 7.44 / freshness 0.0 / resource 15.0 / registration 8.04
