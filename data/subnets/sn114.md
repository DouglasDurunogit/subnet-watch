...
- miner_burn: **0.0**
- registration cost: 0.25 TAO (58.345 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 40  |  free: 0
- subnet age: 227.5 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2940.305402057948** (uid 147) <- the only figure quotable as achievable
- median_miner_usd_day: 0.12826319150488344
- top_miner_usd_day: 5460.548851937402 (uid 70, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 31  |  gini: 0.9447143857203195  |  top1_share: 0.6497115648750115  |  top10_share: 0.9996795165277904
...
- net margin: -8.0909 USD/day  |  payback on registration: [UNKNOWN] days
