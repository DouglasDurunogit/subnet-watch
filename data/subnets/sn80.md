...
- **competitive_miner_usd_day: 609.5745354020739** (uid 231) <- the only figure quotable as achievable
- median_miner_usd_day: 391.8389384340845
- top_miner_usd_day: 8428.049040800044 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 165.8842 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 53.1 (rank 24), confidence 0.85 - hardware requirement unknown
- components: income 20.21 / freshness 21.0 / resource 11.25 / registration 10.0
