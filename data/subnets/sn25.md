...
- subnet age: 848.5 days  |  registered at block 2998801
- weights_version: 20502  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 6703.292086200391
- top_miner_usd_day: 6703.292086200391 (uid 1, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-20T09:26:09Z
- scoring-related commit: sim-testnet: lock owned archive verifier serialization 2026-09-20T07:16:52Z
