...
- miner_burn: **0.0**
- registration cost: 0.451205261 TAO (110.03993905268 USD), open=True
...
- **competitive_miner_usd_day: 48.04411624327278** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.526194019443224
- top_miner_usd_day: 26002.591020700598 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.5399 USD/day  |  payback on registration: 4.0 days

## Score

- gate: **OK** 
- score: 71.9 (rank 6), confidence 1.0 
- components: income 13.24 / freshness 35.0 / resource 15.0 / registration 8.67
