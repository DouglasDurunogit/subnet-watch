...
- miner_burn: **0.0**
- registration cost: 0.002601842 TAO (0.5443053464 USD), open=True
...
- **competitive_miner_usd_day: 10.533810259601639** (uid 185) <- the only figure quotable as achievable
- median_miner_usd_day: 8.814004502931983
- top_miner_usd_day: 10.625942710851799 (uid 23, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.4106 USD/day  |  payback on registration: 1.33 days

## Score

- gate: **OK** 
- score: 18.8 (rank 75), confidence 0.85 - hardware requirement unknown
- components: income 1.36 / freshness 0.0 / resource 11.25 / registration 9.56
