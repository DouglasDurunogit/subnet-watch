...
- miner_burn: **0.0025820150040090084**
- registration cost: 0.000524649 TAO (0.1222956819 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 43  |  free: 0
- subnet age: 517.2 days  |  registered at block 5203057
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 305.06147920767506** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 106.83383168802601
- top_miner_usd_day: 305.06147920767506 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 37  |  gini: 0.35380835380835407  |  top1_share: 0.06725074790890774  |  top10_share: 0.4912998351547713
...
- latest release: (none) 
- last commit: 2026-08-26T00:40:39Z
- scoring-related commit: fix(validator): close submission ingress races 2026-08-26T00:35:18Z
...
- net margin: 100.2417 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 63.3 (rank 18), confidence 0.85 - hardware requirement unknown
- components: income 18.24 / freshness 35.0 / resource 11.25 / registration 10.0
