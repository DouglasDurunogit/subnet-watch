...
- miner_burn: **0.8218799659516662**
- registration cost: 0.1 TAO (23.911 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 20  |  free: 0
- subnet age: 770.8 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 95.84188710670803** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.15235915152037
- top_miner_usd_day: 2738.535746129655 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.8616178181395573  |  top1_share: 0.8219665176186916  |  top10_share: 0.9997863476124346
- owner_incentive_share: 0.8219665176186916 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.2848 USD/day  |  payback on registration: 83.96 days

## Score

- gate: **OK** 
- score: 16.0 (rank 80), confidence 1.0 
- components: income 0.99 / freshness 0.0 / resource 15.0 / registration 0.0
