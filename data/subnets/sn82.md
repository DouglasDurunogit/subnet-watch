...
- **competitive_miner_usd_day: 2510.815472226495** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2510.815472226495
- top_miner_usd_day: 2510.815472226495 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2502.5963 USD/day  |  payback on registration: 0.0 days
...
- components: income 30.91 / freshness 0.0 / resource 11.25 / registration 10.0
