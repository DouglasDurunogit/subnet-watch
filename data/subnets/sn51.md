...
- subnet age: 693.6 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2501.042650845014** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 50.85959011707664
- top_miner_usd_day: 39823.05906167101 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 59  |  gini: 0.8916591497529638  |  top1_share: 0.6813685078318219  |  top10_share: 0.8896674910689749
...
- net margin: 36.3945 USD/day  |  payback on registration: 3.27 days

## Score

- gate: **OK** 
- score: 59.0 (rank 25), confidence 0.85 - hardware requirement unknown
- components: income 14.3 / freshness 35.0 / resource 11.25 / registration 8.91
