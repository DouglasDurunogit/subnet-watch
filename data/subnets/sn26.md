...
- subnet age: 107.1 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 389.4276714880727** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 25.493052553669862
- top_miner_usd_day: 1817.3555444398623 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 20.2166 USD/day  |  payback on registration: 1.11 days

## Score

- gate: **OK** 
- score: 67.9 (rank 11), confidence 1.0 
- components: income 12.07 / freshness 35.0 / resource 11.25 / registration 9.63
