...
- **competitive_miner_usd_day: 30.047657143247797** (uid 189) <- the only figure quotable as achievable
- median_miner_usd_day: 15.692148347941684
- top_miner_usd_day: 2299.1804272795107 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 14.6791 USD/day  |  payback on registration: 1.64 days

## Score

- gate: **OK** 
- score: 56.3 (rank 24), confidence 1.0 
- components: income 10.87 / freshness 21.0 / resource 15.0 / registration 9.45
