...
- miner_burn: **0.0**
- registration cost: 0.596411086 TAO (133.79289892238 USD), open=True
...
- **competitive_miner_usd_day: 20878.518728566767** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 22.349456825480708
- top_miner_usd_day: 20878.518728566767 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 21.3632 USD/day  |  payback on registration: 6.26 days

## Score

- gate: **OK** 
- score: 70.2 (rank 6), confidence 1.0 
- components: income 12.27 / freshness 35.0 / resource 15.0 / registration 7.91
