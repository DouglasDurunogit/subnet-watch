...
- subnet age: 323.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.105689996732735** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 2706.688769653346
- top_miner_usd_day: 5359.271849309958 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 45.8865 USD/day  |  payback on registration: 0.28 days
...
- components: income 15.2 / freshness 35.0 / resource 11.25 / registration 9.91
