...
- miner_burn: **0.0**
- registration cost: 0.044119809 TAO (11.926466768880001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 213  |  free: 0
- subnet age: 545.5 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 254.98311562306694** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.5425316436300056
- top_miner_usd_day: 254.98311562306694 (uid 138, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 212  |  gini: 0.7357266696764573  |  top1_share: 0.09849399892974542  |  top10_share: 0.5020258390031344
...
- status: **ok** 
- README: 43854 bytes, sha 4aa8f514d80fbe99
- latest release: (none) 
- last commit: 2026-09-18T11:46:53Z
...
- net margin: 2.5562 USD/day  |  payback on registration: 4.67 days

## Score

- gate: **OK** 
- score: 49.5 (rank 33), confidence 1.0 
- components: income 5.01 / freshness 21.0 / resource 15.0 / registration 8.44
...
- The Python validator, which receives state updates from the simulator, forwards these to miners, submits instructions received in response back to the simulator, and calculates miner scores based on their
```

_(truncated at 6000 of 43854 chars - read the full file at https://github.com/taos-im/sn-79)_
