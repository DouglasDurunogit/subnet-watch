...
- registration cost: 0.999999999 TAO (190.45999980954002 USD), open=True
...
- **competitive_miner_usd_day: 1594.7638309993647** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.003974133926336
- top_miner_usd_day: 1594.7638309993647 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.2915 USD/day  |  payback on registration: [UNKNOWN] days
