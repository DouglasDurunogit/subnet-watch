...
- miner_burn: **0.7736233547329903**
- registration cost: 0.1 TAO (19.071 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 24  |  free: 0
- subnet age: 738.9 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 67.16963225415336** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 2.748688527594309
- top_miner_usd_day: 2342.113607739561 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 18  |  gini: 0.8962517550821076  |  top1_share: 0.7737470239912094  |  top10_share: 0.9975123618826691
- owner_incentive_share: 0.7737470239912093 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.6306 USD/day  |  payback on registration: 30.24 days

## Score

- gate: **OK** 
- score: 16.9 (rank 59), confidence 1.0 
- components: income 1.93 / freshness 0.0 / resource 15.0 / registration 0.0
