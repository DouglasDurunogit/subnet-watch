...
- subnet age: 457.2 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 466.28833019808684** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 1165.7030377356155
- top_miner_usd_day: 1865.1177452731445 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 458.0692 USD/day  |  payback on registration: 0.5 days
...
- components: income 24.21 / freshness 35.0 / resource 11.25 / registration 9.83
