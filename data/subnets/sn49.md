...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (14.3 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 326.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 55.5849832690379** (uid 220) <- the only figure quotable as achievable
- median_miner_usd_day: 2780.691827139793
- top_miner_usd_day: 5505.798671010549 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 47.3658 USD/day  |  payback on registration: 0.3 days
...
- components: income 15.32 / freshness 35.0 / resource 11.25 / registration 9.9
