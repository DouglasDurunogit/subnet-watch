...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (96.635 USD), open=True
...
- **competitive_miner_usd_day: 281.0777872395938** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 11.578185237469977
- top_miner_usd_day: 2810.991295165292 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -18.2776 USD/day  |  payback on registration: [UNKNOWN] days
