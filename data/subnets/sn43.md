...
- **competitive_miner_usd_day: 10.861722568689537** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 3.272442055951334
- top_miner_usd_day: 2485.060004956973 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.4293 USD/day  |  payback on registration: [UNKNOWN] days
