...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (192.0374 USD), open=True
- tempo: 1440.0  |  max_uids: 256  |  active: 20  |  free: 0
- subnet age: 241.9 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1330.2011197105032** (uid 128) <- the only figure quotable as achievable
- median_miner_usd_day: 140.40047066396107
- top_miner_usd_day: 2960.5657688491538 (uid 168, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 97.2159 USD/day  |  payback on registration: 1.98 days

## Score

- gate: **OK** 
- score: 65.8 (rank 15), confidence 0.85 - hardware from README keywords, not curated
