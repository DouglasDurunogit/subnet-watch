...
- subnet age: 107.6 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 269.0215541444761** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 26.417727772313498
- top_miner_usd_day: 1883.2740385813663 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.6556 USD/day  |  payback on registration: 1.24 days

## Score

- gate: **OK** 
- score: 67.6 (rank 9), confidence 1.0 
- components: income 11.76 / freshness 35.0 / resource 11.25 / registration 9.59
