...
- miner_burn: **0.0**
- registration cost: 0.537434332 TAO (114.73685553868 USD), open=True
...
- **competitive_miner_usd_day: 18547.52060607846** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 19.96636093133767
- top_miner_usd_day: 18547.52060607846 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.9801 USD/day  |  payback on registration: 6.05 days

## Score

- gate: **OK** 
- score: 69.8 (rank 4), confidence 1.0 
- components: income 11.83 / freshness 35.0 / resource 15.0 / registration 7.98
