...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (235.719 USD), open=True
...
- **competitive_miner_usd_day: 43389.94452047965** (uid 82) <- the only figure quotable as achievable
- median_miner_usd_day: 154.17859935611213
- top_miner_usd_day: 43389.94452047965 (uid 82, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 153.1923 USD/day  |  payback on registration: 1.54 days

## Score

- gate: **OK** 
- score: 65.4 (rank 15), confidence 1.0 
- components: income 19.9 / freshness 21.0 / resource 15.0 / registration 9.49
