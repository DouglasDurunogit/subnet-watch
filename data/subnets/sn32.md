...
- miner_burn: **0.0**
- registration cost: 0.019073573 TAO (4.41667656388 USD), open=True
...
- **competitive_miner_usd_day: 14.37175171443948** (uid 73) <- the only figure quotable as achievable
- median_miner_usd_day: 9.658613738803437
- top_miner_usd_day: 14.37175171443948 (uid 73, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.1241 USD/day  |  payback on registration: 3.93 days

## Score

- gate: **OK** 
- score: 19.5 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 2.98 / freshness 0.0 / resource 11.25 / registration 8.69
