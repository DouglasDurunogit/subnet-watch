...
- miner_burn: **0.1505637955851853**
- registration cost: 0.1 TAO (23.615000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 812.2 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 111.00767673394756** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 10.39986596022819
- top_miner_usd_day: 1110.000994181295 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826492537313432  |  top1_share: 0.4471202270854317  |  top10_share: 0.9986875438757135
...
- net margin: 0.7186 USD/day  |  payback on registration: 32.86 days

## Score

- gate: **OK** 
- score: 52.1 (rank 29), confidence 1.0 
- components: income 2.14 / freshness 35.0 / resource 15.0 / registration 0.0
