...
- miner_burn: **0.0**
- registration cost: 0.109571003 TAO (24.16259758156 USD), open=True
...
- **competitive_miner_usd_day: 433.39585157245233** (uid 27) <- the only figure quotable as achievable
- median_miner_usd_day: 6.340434210431296
- top_miner_usd_day: 433.39585157245233 (uid 27, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.3541 USD/day  |  payback on registration: 4.51 days

## Score

- gate: **OK** 
- score: 30.8 (rank 59), confidence 1.0 
- components: income 7.3 / freshness 0.0 / resource 15.0 / registration 8.5
