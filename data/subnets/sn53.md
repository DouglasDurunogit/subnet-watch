...
- miner_burn: **0.0**
- registration cost: 0.000508724 TAO (0.09725276708 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 43  |  free: 0
- subnet age: 631.7 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2396.21032962215** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 133.75619920485715
- top_miner_usd_day: 2396.21032962215 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 95.2264 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 63.1 (rank 13), confidence 0.85 - hardware from README keywords, not curated
