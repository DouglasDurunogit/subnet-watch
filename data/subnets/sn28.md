...
- miner_burn: **0.1281133231241256**
- registration cost: 0.182039292 TAO (48.26225709504 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 58  |  free: 0
- subnet age: 576.6 days  |  registered at block 4878363
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4012.5000520511544** (uid 91) <- the only figure quotable as achievable
- median_miner_usd_day: 62.621540417222455
- top_miner_usd_day: 5649.357539067997 (uid 72, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 47  |  gini: 0.8160097849411028  |  top1_share: 0.3470256903420799  |  top10_share: 0.8562531483262352
- owner_incentive_share: 0.12814641815878247 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 20903 bytes, sha c1b915bb1af0c16c
- latest release: v0.4.15 2026-09-08T22:55:49Z
- last commit: 2026-09-08T22:39:20Z
- scoring-related commit: fix(miner): render node secret last and pin C locale 2026-09-08T21:50:27Z
...
- net margin: 52.5386 USD/day  |  payback on registration: 0.92 days

## Score

- gate: **OK** 
- score: 60.9 (rank 17), confidence 0.85 - hardware requirement unknown
- components: income 15.72 / freshness 35.0 / resource 11.25 / registration 9.69
...
For direct upstreams, each existing 
```

_(truncated at 6000 of 20903 chars - read the full file at https://github.com/taostat/gm-miner)_
