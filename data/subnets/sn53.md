...
- subnet age: 661.8 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7135.938485195161** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 11.67601485659669
- top_miner_usd_day: 7833.659264869087 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 3.4568 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 40.9 (rank 45), confidence 0.85 - hardware from README keywords, not curated
- components: income 5.9 / freshness 21.0 / resource 11.25 / registration 9.99
