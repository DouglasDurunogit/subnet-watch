...
- registration cost: 0.1 TAO (19.768 USD), open=True
...
- **competitive_miner_usd_day: 10.871399787284867** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.1929433047312825
- top_miner_usd_day: 2498.089032666231 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.5197 USD/day  |  payback on registration: [UNKNOWN] days
