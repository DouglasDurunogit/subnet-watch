...
- registration cost: 0.1 TAO (19.922 USD), open=True
...
- **competitive_miner_usd_day: 36.26007128627828** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 4.73369076844364
- top_miner_usd_day: 2495.601773123487 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.1498 USD/day  |  payback on registration: 132.99 days
