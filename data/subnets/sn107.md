...
- miner_burn: **0.0**
- registration cost: 1.163865336 TAO (228.83920236432 USD), open=True
- tempo: 360.0  |  max_uids: 90  |  active: 27  |  free: 0
- subnet age: 186.2 days  |  registered at block 7457580
- weights_version: 20  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 34036.74908145089** (uid 69) <- the only figure quotable as achievable
- median_miner_usd_day: 148.53074738939432
- top_miner_usd_day: 34036.74908145089 (uid 69, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 147.5444 USD/day  |  payback on registration: 1.55 days

## Score

- gate: **OK** 
- score: 79.2 (rank 1), confidence 1.0 
- components: income 19.75 / freshness 35.0 / resource 15.0 / registration 9.48
