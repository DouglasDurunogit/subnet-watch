...
- registration cost: 0.1 TAO (18.704 USD), open=True
...
- **competitive_miner_usd_day: 57.996133948809764** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.2169012491415883
- top_miner_usd_day: 2423.1997995140964 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 57.0098 USD/day  |  payback on registration: 0.33 days

## Score

- gate: **OK** 
- score: 40.9 (rank 29), confidence 1.0 
- components: income 16.04 / freshness 0.0 / resource 15.0 / registration 9.89
