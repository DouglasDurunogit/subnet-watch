...
- **competitive_miner_usd_day: 261.8020594673965** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 55.14643585623715
- top_miner_usd_day: 1599.6293354301572 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 46.6594 USD/day  |  payback on registration: 0.78 days

## Score

- gate: **OK** 
- score: 48.7 (rank 30), confidence 0.85 - hardware requirement unknown
- components: income 15.26 / freshness 21.0 / resource 11.25 / registration 9.74
