...
- miner_burn: **0.0**
- registration cost: 0.301177427 TAO (59.69938957994 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 96  |  free: 0
- subnet age: 205.7 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 22.954424904525922** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 11.98505371121265
- top_miner_usd_day: 12347.85550660631 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 83  |  gini: 0.9397571965292346  |  top1_share: 0.928129723787275  |  top10_share: 0.942909929305422
...
- net margin: 10.8972 USD/day  |  payback on registration: 5.48 days

## Score

- gate: **OK** 
- score: 68.0 (rank 12), confidence 1.0 
- components: income 9.78 / freshness 35.0 / resource 15.0 / registration 8.17
