...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (142.3094 USD), open=True
...
- **competitive_miner_usd_day: 3025.720834851488** (uid 168) <- the only figure quotable as achievable
- median_miner_usd_day: 143.4838573555923
- top_miner_usd_day: 3025.720834851488 (uid 168, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 142.4976 USD/day  |  payback on registration: 1.0 days
