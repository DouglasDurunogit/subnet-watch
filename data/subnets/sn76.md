...
- subnet age: 178.2 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 157.97576768516987** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 105.40693349283197
- top_miner_usd_day: 396.5860789128029 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.5041141461925833  |  top1_share: 0.2921867846787731  |  top10_share: 1.0
...
- net margin: 31.7605 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 73.8 (rank 2), confidence 1.0 
- components: income 13.78 / freshness 35.0 / resource 15.0 / registration 10.0
