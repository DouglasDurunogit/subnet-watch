...
- miner_burn: **0.0**
- registration cost: 0.099909341 TAO (20.88704682946 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 253  |  free: 0
- subnet age: 825.4 days  |  registered at block 2943950
- weights_version: 2388  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 18.041242208355694** (uid 66) <- the only figure quotable as achievable
- median_miner_usd_day: 13.95455198436352
- top_miner_usd_day: 18.041242208355694 (uid 66, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.10355188732587783  |  top1_share: 0.005574033013057403  |  top10_share: 0.05346144370534615
...
- net margin: 5.7354 USD/day  |  payback on registration: 3.64 days

## Score

- gate: **OK** 
- score: 53.2 (rank 25), confidence 0.85 - hardware requirement unknown
- components: income 7.53 / freshness 35.0 / resource 11.25 / registration 8.79
