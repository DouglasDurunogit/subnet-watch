...
- miner_burn: **0.5157800305169076**
- registration cost: 0.0005 TAO (0.11184999999999999 USD), open=True
...
- **competitive_miner_usd_day: 1254.101318165473** (uid 216) <- the only figure quotable as achievable
- median_miner_usd_day: 769.5817886859138
- top_miner_usd_day: 2652.1853629050343 (uid 248, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.4570591466764329  |  top1_share: 0.5157938106573888  |  top10_share: 1.0
- owner_incentive_share: 0.5157938106573888 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 501.1344 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 68.7 (rank 8), confidence 0.85 - hardware requirement unknown
- components: income 24.56 / freshness 35.0 / resource 11.25 / registration 10.0
