...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (21.099999789 USD), open=True
...
- **competitive_miner_usd_day: 125.78956869667573** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 84.3235383077273
- top_miner_usd_day: 281.3995712249494 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 74.3247 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 77.0 (rank 1), confidence 1.0 
- components: income 17.07 / freshness 35.0 / resource 15.0 / registration 9.91
