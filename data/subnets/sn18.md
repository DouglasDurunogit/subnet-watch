...
- registration cost: 0.999999999 TAO (209.1999997908 USD), open=True
...
- **competitive_miner_usd_day: 1114.9474820169862** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 2.954264111626357
- top_miner_usd_day: 1114.9474820169862 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.3059 USD/day  |  payback on registration: [UNKNOWN] days
