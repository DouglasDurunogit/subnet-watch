...
- registration cost: 0.1 TAO (22.597 USD), open=True
...
- **competitive_miner_usd_day: 187.98358593726195** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.413099316077261
- top_miner_usd_day: 2649.837848095935 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.2356 USD/day  |  payback on registration: [UNKNOWN] days
