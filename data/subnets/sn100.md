...
- miner_burn: **0.0**
- registration cost: 0.000540014 TAO (0.10569694022 USD), open=True
...
- **competitive_miner_usd_day: 1057.4137777637563** (uid 102) <- the only figure quotable as achievable
- median_miner_usd_day: 329.14841752260577
- top_miner_usd_day: 1057.4137777637563 (uid 102, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- latest release: v3.3.8 — Design one-prompt / one-attempt / admin reject 2026-08-08T05:06:18Z
- last commit: 2026-08-08T05:18:07Z
...
- net margin: 320.9292 USD/day  |  payback on registration: 0.0 days
