...
- subnet age: 311.8 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 57.844419448044434** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 2893.7222779451486
- top_miner_usd_day: 5729.600136442253 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 49.6252 USD/day  |  payback on registration: 0.26 days
...
- components: income 15.5 / freshness 10.5 / resource 11.25 / registration 9.91
