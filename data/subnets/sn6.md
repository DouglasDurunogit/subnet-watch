...
- miner_burn: **0.0**
- registration cost: 0.2 TAO (39.788000000000004 USD), open=True
...
- **competitive_miner_usd_day: 547.4931896846476** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 15.647949031685968
- top_miner_usd_day: 547.4931896846476 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 7.472 USD/day  |  payback on registration: 5.32 days
...
- freshness basis: WEIGHTS_VERSION_BUMP 0.8d ago
