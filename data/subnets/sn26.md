...
- subnet age: 110.6 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 281.340095951396** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 27.627399930523925
- top_miner_usd_day: 1969.5094707270462 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 19.6453 USD/day  |  payback on registration: 1.24 days

## Score

- gate: **OK** 
- score: 67.8 (rank 10), confidence 1.0 
- components: income 11.96 / freshness 35.0 / resource 11.25 / registration 9.59
