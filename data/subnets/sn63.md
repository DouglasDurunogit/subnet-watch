...
- **competitive_miner_usd_day: 0.074721563915913** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 0.074721563915913
- top_miner_usd_day: 4895.75686777062 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1445 USD/day  |  payback on registration: [UNKNOWN] days
