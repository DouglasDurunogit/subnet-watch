...
- registration cost: 0.8 TAO (162.72000000000003 USD), open=True
...
- **competitive_miner_usd_day: 37.23559177612328** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 8.975643841022558
- top_miner_usd_day: 37.23559177612328 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.7565 USD/day  |  payback on registration: 215.1 days

## Score

- gate: **OK** 
- score: 41.2 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 2.23 / freshness 35.0 / resource 11.25 / registration 0.0
