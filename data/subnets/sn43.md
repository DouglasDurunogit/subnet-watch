...
- registration cost: 0.1 TAO (23.576 USD), open=True
...
- **competitive_miner_usd_day: 183.46477578165624** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.288273363938647
- top_miner_usd_day: 2800.8781786615186 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.4752 USD/day  |  payback on registration: 49.61 days

## Score

- gate: **OK** 
- score: 16.5 (rank 72), confidence 1.0 
- components: income 1.54 / freshness 0.0 / resource 15.0 / registration 0.0
