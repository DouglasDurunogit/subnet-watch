...
- **competitive_miner_usd_day: 5.930262687221109** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.9151615731224
- top_miner_usd_day: 953.1513541747581 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2747 USD/day  |  payback on registration: [UNKNOWN] days
