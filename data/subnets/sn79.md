...
- miner_burn: **0.0**
- registration cost: 0.094693332 TAO (21.37891356564 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 217  |  free: 0
- subnet age: 530.0 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 415.5876884978291** (uid 127) <- the only figure quotable as achievable
- median_miner_usd_day: 5.478744694961794
- top_miner_usd_day: 415.5876884978291 (uid 127, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 216  |  gini: 0.7540790561273596  |  top1_share: 0.09565881993274228  |  top10_share: 0.5010088657902781
...
- net margin: 4.4924 USD/day  |  payback on registration: 4.76 days

## Score

- gate: **OK** 
- score: 65.1 (rank 15), confidence 1.0 
- components: income 6.73 / freshness 35.0 / resource 15.0 / registration 8.41
