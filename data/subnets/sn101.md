...
- registration cost: 0.002614428 TAO (0.518963958 USD), open=True
...
- **competitive_miner_usd_day: 2.0260020834023944** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9923275510542338
- top_miner_usd_day: 2445.549902591865 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.006 USD/day  |  payback on registration: 86.49 days
