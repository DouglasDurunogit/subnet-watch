...
- **competitive_miner_usd_day: 223.11259047812086** (uid 111) <- the only figure quotable as achievable
- median_miner_usd_day: 62.22521012267202
- top_miner_usd_day: 1405.6977757509908 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.7489840237589362  |  top1_share: 0.6305203723485426  |  top10_share: 0.9979856554249962
...
- net margin: 24.2373 USD/day  |  payback on registration: 1.24 days

## Score

- gate: **OK** 
- score: 58.3 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 12.75 / freshness 35.0 / resource 11.25 / registration 9.59
