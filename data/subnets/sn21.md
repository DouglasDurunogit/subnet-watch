...
- **competitive_miner_usd_day: 964.6365870725677** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.02258701666863
- top_miner_usd_day: 964.6365870725677 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.114 USD/day  |  payback on registration: 206.32 days

## Score

- gate: **OK** 
- score: 50.4 (rank 29), confidence 1.0 
- components: income 0.43 / freshness 35.0 / resource 15.0 / registration 0.0
