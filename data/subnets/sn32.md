...
- miner_burn: **0.0**
- registration cost: 0.017805703 TAO (3.5166263425 USD), open=True
...
- **competitive_miner_usd_day: 10.683936353088164** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 8.233753616113278
- top_miner_usd_day: 10.911860328620712 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.0567 USD/day  |  payback on registration: [UNKNOWN] days
