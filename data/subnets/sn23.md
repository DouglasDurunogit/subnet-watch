...
- subnet age: 928.4 days  |  registered at block 2063528
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 581.9920778631684** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 581.9920778631684
- top_miner_usd_day: 581.9920778631684 (uid 19, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 581.0058 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 85.1 (rank 1), confidence 1.0 
- components: income 25.15 / freshness 35.0 / resource 15.0 / registration 9.99
