...
- **competitive_miner_usd_day: 191.64594921026756** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 107.33067335069403
- top_miner_usd_day: 255.54089140056573 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 98.6758 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 78.2 (rank 1), confidence 1.0 
- components: income 18.18 / freshness 35.0 / resource 15.0 / registration 10.0
