...
- miner_burn: **0.30894255521707237**
- registration cost: 0.0005 TAO (0.132375 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 14  |  free: 0
- subnet age: 258.9 days  |  registered at block 7151800
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1370.9353284814258** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 1370.9353284814258
- top_miner_usd_day: 5540.704927042942 (uid 2, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.5031862296282734  |  top1_share: 0.5105902459866934  |  top10_share: 1.0
- owner_incentive_share: 0.3089483000671428 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 6645 bytes, sha e95a1f8ec3c8b5b2
- latest release: (none) 
- last commit: 2026-09-07T10:21:25Z
...
- net margin: 383.4057 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 67.8 (rank 13), confidence 0.85 - hardware requirement unknown
...
| Path | Purpose |
|---|---|
| `miner.py` | Miner training entry point (reference sample; its default LoRA output must be merged into the base model befo
```

_(truncated at 6000 of 6645 chars - read the full file at https://github.com/openroboto-ai/openroboto-subnet)_
