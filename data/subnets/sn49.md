...
- subnet age: 293.9 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 58.415812878660056** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 2922.306779534433
- top_miner_usd_day: 5786.197746190206 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 50.1966 USD/day  |  payback on registration: 0.23 days
...
- components: income 15.55 / freshness 21.0 / resource 11.25 / registration 9.92
