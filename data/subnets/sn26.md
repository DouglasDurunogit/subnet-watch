...
- subnet age: 104.5 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 338.48051376364396** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 51.70177939126261
- top_miner_usd_day: 1579.5986865100103 (uid 45, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.3426 USD/day  |  payback on registration: 0.49 days

## Score

- gate: **OK** 
- score: 70.7 (rank 3), confidence 1.0 
- components: income 14.6 / freshness 35.0 / resource 11.25 / registration 9.84
