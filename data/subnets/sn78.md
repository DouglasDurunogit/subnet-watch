...
- subnet age: 146.2 days  |  registered at block 7966145
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3692.8518988821693
- top_miner_usd_day: 3692.8518988821693 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-09-07T23:46:59Z
- scoring-related commit: Fix pilot deployment validation 2026-09-07T23:46:59Z
