...
- **competitive_miner_usd_day: 8.868572322100125** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 7.863758709251342
- top_miner_usd_day: 2727.457333207058 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.5302 USD/day  |  payback on registration: [UNKNOWN] days
