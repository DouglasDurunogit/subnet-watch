...
- miner_burn: **0.0**
- registration cost: 0.120656594 TAO (24.06857737112 USD), open=True
...
- **competitive_miner_usd_day: 67.4350516327972** (uid 84) <- the only figure quotable as achievable
- median_miner_usd_day: 27.392517447455
- top_miner_usd_day: 67.4350516327972 (uid 84, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 237  |  gini: 0.35254158489779375  |  top1_share: 0.01083799565868721  |  top10_share: 0.09589103916353296
...
- net margin: 14.9408 USD/day  |  payback on registration: 1.61 days

## Score

- gate: **OK** 
- score: 26.9 (rank 63), confidence 0.85 - hardware requirement unknown
- components: income 10.94 / freshness 0.0 / resource 11.25 / registration 9.46
