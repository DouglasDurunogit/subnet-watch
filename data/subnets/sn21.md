...
- **competitive_miner_usd_day: 387.3723237360232** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.246761158326965
- top_miner_usd_day: 774.9053295376411 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.4239 USD/day  |  payback on registration: 14.5 days

## Score

- gate: **OK** 
- score: 58.7 (rank 21), confidence 1.0 
- components: income 3.5 / freshness 35.0 / resource 15.0 / registration 5.17
