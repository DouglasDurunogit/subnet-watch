...
- **competitive_miner_usd_day: 10901.613575797388** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 0.840551256461062
- top_miner_usd_day: 10901.613575797388 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -7.3786 USD/day  |  payback on registration: [UNKNOWN] days
