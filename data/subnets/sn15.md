...
- miner_burn: **0.0**
- registration cost: 0.302380655 TAO (57.6579432954 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 81  |  free: 0
- subnet age: 209.3 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 20.560277417687523** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 11.378017600079502
- top_miner_usd_day: 12361.118243595143 (uid 253, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.1921 USD/day  |  payback on registration: 5.66 days

## Score

- gate: **OK** 
- score: 67.7 (rank 9), confidence 1.0 
- components: income 9.54 / freshness 35.0 / resource 15.0 / registration 8.11
