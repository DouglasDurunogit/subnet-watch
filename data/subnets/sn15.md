...
- miner_burn: **0.0**
- registration cost: 0.456961985 TAO (107.5414335499 USD), open=True
...
- **competitive_miner_usd_day: 46.764290646397235** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.48370430280559
- top_miner_usd_day: 25689.32537172587 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.4974 USD/day  |  payback on registration: 3.91 days

## Score

- gate: **OK** 
- score: 71.9 (rank 5), confidence 1.0 
- components: income 13.23 / freshness 35.0 / resource 15.0 / registration 8.7
