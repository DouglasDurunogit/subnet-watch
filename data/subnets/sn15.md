...
- miner_burn: **0.0**
- registration cost: 0.477319865 TAO (110.8527654476 USD), open=True
...
- **competitive_miner_usd_day: 41.28788210340486** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 24.480425671930316
- top_miner_usd_day: 21849.693360916914 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.3114 USD/day  |  payback on registration: 4.76 days

## Score

- gate: **OK** 
- score: 71.0 (rank 7), confidence 1.0 
- components: income 12.6 / freshness 35.0 / resource 15.0 / registration 8.41
