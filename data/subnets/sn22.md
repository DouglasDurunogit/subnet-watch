...
- **competitive_miner_usd_day: 68.70678286953172** (uid 161) <- the only figure quotable as achievable
- median_miner_usd_day: 4.144312624616304
- top_miner_usd_day: 1063.7858462729391 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.0749 USD/day  |  payback on registration: [UNKNOWN] days
