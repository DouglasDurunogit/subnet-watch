...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (148.885 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 83  |  free: 0
- subnet age: 718.6 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2364.8390027943583** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 33.207368143551676
- top_miner_usd_day: 59190.947738447154 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 73  |  gini: 0.9236875466561418  |  top1_share: 0.7620509062037164  |  top10_share: 0.9124639274426275
...
- latest release: executor-v1.135 2026-09-24T09:47:53Z
- last commit: 2026-09-24T12:38:05Z
- scoring-related commit: Validator: pull a present image when the registry tag moved (#1468) 2026-09-24T12:38:05Z
...
- net margin: 24.9882 USD/day  |  payback on registration: 5.96 days

## Score

- gate: **OK** 
- score: 57.1 (rank 23), confidence 0.85 - hardware requirement unknown
- components: income 12.87 / freshness 35.0 / resource 11.25 / registration 8.01
