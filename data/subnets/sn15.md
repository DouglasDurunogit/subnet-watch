...
- miner_burn: **0.0**
- registration cost: 0.480436478 TAO (100.44005009068 USD), open=True
...
- **competitive_miner_usd_day: 18150.79284295027** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 19.53928445689485
- top_miner_usd_day: 18150.79284295027 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.553 USD/day  |  payback on registration: 5.41 days

## Score

- gate: **OK** 
- score: 69.9 (rank 4), confidence 1.0 
- components: income 11.74 / freshness 35.0 / resource 15.0 / registration 8.2
