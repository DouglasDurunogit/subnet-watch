...
- miner_burn: **0.0**
- registration cost: 0.000546224 TAO (0.10816873872 USD), open=True
...
- **competitive_miner_usd_day: 43.09361594164622** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 43.09361594164622
- top_miner_usd_day: 4225.345491023428 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.8744 USD/day  |  payback on registration: 0.0 days
