...
- miner_burn: **0.0**
- registration cost: 0.399776566 TAO (83.6332576072 USD), open=True
...
- **competitive_miner_usd_day: 18406.84745685626** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 19.776605585236812
- top_miner_usd_day: 18406.84745685626 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.7903 USD/day  |  payback on registration: 4.45 days

## Score

- gate: **OK** 
- score: 70.3 (rank 4), confidence 1.0 
- components: income 11.79 / freshness 35.0 / resource 15.0 / registration 8.52
