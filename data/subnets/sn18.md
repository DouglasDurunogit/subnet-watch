...
- subnet age: 1035.5 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1101.4090391742195** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 13.149842184355476
- top_miner_usd_day: 1101.4090391742195 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.1153 USD/day  |  payback on registration: 57.53 days

## Score

- gate: **OK** 
- score: 44.8 (rank 40), confidence 0.85 - hardware requirement unknown
- components: income 6.45 / freshness 35.0 / resource 11.25 / registration 0.0
