...
- subnet age: 688.4 days  |  registered at block 3919107
- weights_version: 62  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2776.542561322126
- top_miner_usd_day: 2776.542561322126 (uid 238, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-19T01:46:55Z
- scoring-related commit: Merge pull request #18 from instant-subnet/dan/p4-5-run-once-validator 2026-08-19T01:46:55Z
