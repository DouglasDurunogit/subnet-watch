...
- miner_burn: **0.0**
- registration cost: 0.092496916 TAO (18.099796522880002 USD), open=True
...
- **competitive_miner_usd_day: 409.44114375958117** (uid 232) <- the only figure quotable as achievable
- median_miner_usd_day: 5.411414422726993
- top_miner_usd_day: 409.44114375958117 (uid 232, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 228  |  gini: 0.7390108814307592  |  top1_share: 0.09253936706925547  |  top10_share: 0.4827090658920654
...
- net margin: 4.4251 USD/day  |  payback on registration: 4.09 days

## Score

- gate: **OK** 
- score: 30.3 (rank 54), confidence 1.0 
- components: income 6.68 / freshness 0.0 / resource 15.0 / registration 8.64
