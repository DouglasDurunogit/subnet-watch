...
- miner_burn: **0.0**
- registration cost: 0.246678325 TAO (50.7318643195 USD), open=True
...
- **competitive_miner_usd_day: 21.148859479680695** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 10.850284428705748
- top_miner_usd_day: 11296.433412164053 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.6801 USD/day  |  payback on registration: 5.24 days

## Score

- gate: **OK** 
- score: 67.6 (rank 13), confidence 1.0 
- components: income 9.36 / freshness 35.0 / resource 15.0 / registration 8.25
