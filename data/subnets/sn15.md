...
- miner_burn: **0.0**
- registration cost: 0.41787241 TAO (84.8030268854 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 93  |  free: 0
- subnet age: 201.1 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 20.814046726294297** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 10.78893247739108
- top_miner_usd_day: 11629.896346956217 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.7072 USD/day  |  payback on registration: 8.74 days

## Score

- gate: **OK** 
- score: 66.5 (rank 11), confidence 1.0 
- components: income 9.37 / freshness 35.0 / resource 15.0 / registration 7.09
