...
- subnet age: 293.6 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 55.32745206446528** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 2797.7077496857005
- top_miner_usd_day: 5540.0880473069365 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.49011200292977675  |  top1_share: 0.9901120029297769  |  top10_share: 1.0
...
- net margin: 47.1083 USD/day  |  payback on registration: 0.24 days
...
- components: income 15.3 / freshness 21.0 / resource 11.25 / registration 9.92
