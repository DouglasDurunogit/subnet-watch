...
- miner_burn: **0.0**
- registration cost: 0.2 TAO (39.544000000000004 USD), open=True
...
- **competitive_miner_usd_day: 473.1416531242776** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 17.05494732329647
- top_miner_usd_day: 473.1416531242776 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.6453 USD/day  |  payback on registration: 2.53 days

## Score

- gate: **OK** 
- score: 56.3 (rank 26), confidence 1.0 
- components: income 11.11 / freshness 21.0 / resource 15.0 / registration 9.16
