...
- subnet age: 282.2 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3007.3756554820516
- top_miner_usd_day: 3007.3756554820516 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-07-29T03:04:45Z
- scoring-related commit: fix(master): allowlist public FE agent-challenge reads on proxy 2026-07-29T02:56:56Z
