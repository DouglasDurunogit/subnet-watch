...
- registration cost: 0.014012729 TAO (2.956685819 USD), open=True
...
- **competitive_miner_usd_day: 2.0938570238410614** (uid 30) <- the only figure quotable as achievable
- median_miner_usd_day: 1.177794575910597
- top_miner_usd_day: 2576.9272880497265 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1915 USD/day  |  payback on registration: 15.44 days

## Score

- gate: **OK** 
- score: 41.5 (rank 43), confidence 1.0 
- components: income 0.69 / freshness 21.0 / resource 15.0 / registration 4.85
