...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (164.9682 USD), open=True
...
- **competitive_miner_usd_day: 1544.1678435126953** (uid 118) <- the only figure quotable as achievable
- median_miner_usd_day: 162.98429523237783
- top_miner_usd_day: 3436.781394272348 (uid 168, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 113.012 USD/day  |  payback on registration: 1.46 days

## Score

- gate: **OK** 
- score: 66.5 (rank 11), confidence 0.85 - hardware from README keywords, not curated
- components: income 18.71 / freshness 35.0 / resource 15.0 / registration 9.51
