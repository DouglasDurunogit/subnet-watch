...
- **competitive_miner_usd_day: 11.705763527793831** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 16.983808689879442
- top_miner_usd_day: 3319.158796731363 (uid 82, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.9972 USD/day  |  payback on registration: 0.06 days
