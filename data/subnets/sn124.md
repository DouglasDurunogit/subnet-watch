...
- subnet age: 419.6 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 471.5436973644192** (uid 103) <- the only figure quotable as achievable
- median_miner_usd_day: 230.18394786699687
- top_miner_usd_day: 688.2039861156073 (uid 206, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 23  |  gini: 0.2902921221571586  |  top1_share: 0.11183517741320109  |  top10_share: 0.6497214803510111
...
- latest release: (none) 
- last commit: 2026-08-11T14:19:50Z
- scoring-related commit: Merge per-process validator session and version 5.1.1.1 2026-08-11T14:19:50Z
...
- net margin: 221.9648 USD/day  |  payback on registration: 0.45 days

## Score

- gate: **OK** 
- score: 65.8 (rank 15), confidence 0.85 - hardware requirement unknown
