...
- registration cost: 0.1 TAO (23.289 USD), open=True
...
- **competitive_miner_usd_day: 28.001681443981283** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0350816097969735
- top_miner_usd_day: 2875.511189995456 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7684 USD/day  |  payback on registration: [UNKNOWN] days
