...
- registration cost: 0.999999999 TAO (190.47999980952 USD), open=True
...
- **competitive_miner_usd_day: 1601.607335611445** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.021156123459547
- top_miner_usd_day: 1601.607335611445 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.2746 USD/day  |  payback on registration: [UNKNOWN] days
