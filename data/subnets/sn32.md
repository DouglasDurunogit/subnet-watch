...
- miner_burn: **0.0**
- registration cost: 0.033982076 TAO (10.46342102116 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 233  |  free: 0
- subnet age: 921.0 days  |  registered at block 2515294
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12.967269660955768** (uid 150) <- the only figure quotable as achievable
- median_miner_usd_day: 11.060318240226978
- top_miner_usd_day: 12.967269660955768 (uid 150, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 228  |  gini: 0.05789772461163056  |  top1_share: 0.005216484089723526  |  top10_share: 0.05127497008192949
...
- net margin: 2.8411 USD/day  |  payback on registration: 3.68 days

## Score

- gate: **OK** 
- score: 21.5 (rank 81), confidence 0.85 - hardware requirement unknown
- components: income 5.32 / freshness 0.0 / resource 11.25 / registration 8.77
