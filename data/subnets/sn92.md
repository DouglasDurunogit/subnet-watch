...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO ([UNKNOWN] USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 16  |  free: 0
- subnet age: 101.7 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 44, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-16T22:46:41Z
...
- gate: **OK** 
- score: 50.0 (rank 3), confidence 1.0 
