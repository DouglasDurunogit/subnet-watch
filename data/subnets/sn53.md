...
- subnet age: 653.9 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 335.4170819507359** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 47.237377325765266
- top_miner_usd_day: 12987.108470805197 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.7012 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.2 (rank 21), confidence 0.85 - hardware from README keywords, not curated
