...
- **competitive_miner_usd_day: 8.671404368253702** (uid 2) <- the only figure quotable as achievable
- median_miner_usd_day: 7.703024184996944
- top_miner_usd_day: 2747.954839115281 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.5162 USD/day  |  payback on registration: [UNKNOWN] days
