...
- miner_burn: **0.0**
- registration cost: 0.462630747 TAO (108.98192507079 USD), open=True
...
- **competitive_miner_usd_day: 21380.643876489263** (uid 249) <- the only figure quotable as achievable
- median_miner_usd_day: 24.128828022186614
- top_miner_usd_day: 21380.643876489263 (uid 249, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 23.3213 USD/day  |  payback on registration: 4.67 days

## Score

- gate: **OK** 
- score: 71.0 (rank 8), confidence 1.0 
- components: income 12.61 / freshness 35.0 / resource 15.0 / registration 8.44
