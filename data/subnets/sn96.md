...
- **competitive_miner_usd_day: 462.4721311866628** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 23.426015118130824
- top_miner_usd_day: 2258.5234139163736 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 14.9513 USD/day  |  payback on registration: 1.51 days

## Score

- gate: **OK** 
- score: 66.7 (rank 10), confidence 1.0 
- components: income 10.94 / freshness 35.0 / resource 11.25 / registration 9.5
