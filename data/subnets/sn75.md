...
- subnet age: 527.3 days  |  registered at block 5102795
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 11638.422178608354** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 1.9791399060800157
- top_miner_usd_day: 11638.422178608354 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.24 USD/day  |  payback on registration: [UNKNOWN] days
