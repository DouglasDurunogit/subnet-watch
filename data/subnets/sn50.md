...
- registration cost: 0.8 TAO (156.832 USD), open=True
...
- **competitive_miner_usd_day: 42.51812539191719** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.301113938592367
- top_miner_usd_day: 42.51812539191719 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.0819 USD/day  |  payback on registration: 50.89 days

## Score

- gate: **OK** 
- score: 32.1 (rank 52), confidence 0.85 - hardware requirement unknown
