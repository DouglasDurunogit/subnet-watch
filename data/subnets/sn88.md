...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9728 USD), open=True
...
- **competitive_miner_usd_day: 877.7052793056879** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 2.6253500964552803
- top_miner_usd_day: 877.7052793056879 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.5938 USD/day  |  payback on registration: [UNKNOWN] days
