...
- registration cost: 0.1 TAO (22.398 USD), open=True
...
- **competitive_miner_usd_day: 26.98356009615033** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9955099841298182
- top_miner_usd_day: 2765.055178551731 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7767 USD/day  |  payback on registration: [UNKNOWN] days
