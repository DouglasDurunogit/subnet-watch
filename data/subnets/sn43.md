...
- registration cost: 0.1 TAO (22.195 USD), open=True
...
- **competitive_miner_usd_day: 190.20001197862402** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0524901848619512
- top_miner_usd_day: 2649.9196925812357 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4601 USD/day  |  payback on registration: [UNKNOWN] days
