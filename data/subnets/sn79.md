...
- miner_burn: **0.0**
- registration cost: 0.110974266 TAO (25.86033320598 USD), open=True
...
- **competitive_miner_usd_day: 445.0380582435378** (uid 65) <- the only figure quotable as achievable
- median_miner_usd_day: 6.32579179777604
- top_miner_usd_day: 445.0380582435378 (uid 65, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 227  |  gini: 0.7364194476601527  |  top1_share: 0.09144430002293753  |  top10_share: 0.482712745622754
...
- net margin: 5.3395 USD/day  |  payback on registration: 4.84 days

## Score

- gate: **OK** 
- score: 30.7 (rank 58), confidence 1.0 
- components: income 7.29 / freshness 0.0 / resource 15.0 / registration 8.39
