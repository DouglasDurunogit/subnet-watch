...
- miner_burn: **0.0**
- registration cost: 0.162747348 TAO (48.090213860519995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 69  |  free: 0
- subnet age: 246.4 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 22.177835005052163** (uid 173) <- the only figure quotable as achievable
- median_miner_usd_day: 10.592398808383123
- top_miner_usd_day: 21060.667943230506 (uid 142, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 57  |  gini: 0.9629276690749833  |  top1_share: 0.9713147288715193  |  top10_share: 0.9797264289203711
...
- latest release: v2.0.30: fix(validator): lower default sandbox max workers to 30 2026-09-24T18:59:25Z
- last commit: 2026-09-24T18:59:25Z
- scoring-related commit: fix(validator): lower default sandbox max workers to 30 2026-09-24T18:59:25Z
...
- net margin: 9.4406 USD/day  |  payback on registration: 5.09 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 1.0 
- components: income 9.27 / freshness 35.0 / resource 15.0 / registration 8.3
