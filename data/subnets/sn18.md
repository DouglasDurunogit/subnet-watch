...
- **competitive_miner_usd_day: 975.9501815017253** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 2.705642461497115
- top_miner_usd_day: 975.9501815017253 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.5711 USD/day  |  payback on registration: [UNKNOWN] days
