...
- subnet age: 271.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 42.62509488519709** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 2132.361044432448
- top_miner_usd_day: 4222.096993979699 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.4059 USD/day  |  payback on registration: 0.0 days
...
- components: income 14.09 / freshness 35.0 / resource 11.25 / registration 10.0
