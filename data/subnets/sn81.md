...
- miner_burn: **0.0021533644758164883**
- registration cost: 0.0005 TAO (0.11051000000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 59  |  free: 0
- subnet age: 512.3 days  |  registered at block 5203057
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 197.38790041625418** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 78.92784949193698
- top_miner_usd_day: 197.38790041625418 (uid 204, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 53  |  gini: 0.42753431795132935  |  top1_share: 0.044132688109667674  |  top10_share: 0.3961866670737479
- owner_incentive_share: 0.0021524417237852446 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 7703 bytes, sha 928d77147f12bcfb
- latest release: (none) 
- last commit: 2026-08-20T11:16:03Z
- scoring-related commit: feat(validator): pipelined window collection behind a flag (default off) 2026-08-19T18:29:14Z
...
- net margin: 67.1924 USD/day  |  payback on registration: 0.0 days
...
_(truncated at 6000 of 7703 chars - read the full file at https://github.com/reliquadotai/reliquary)_
