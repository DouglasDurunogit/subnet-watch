...
- **competitive_miner_usd_day: 202.6163135886137** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 113.08912550674617
- top_miner_usd_day: 269.0107062108433 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 103.6222 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 78.4 (rank 1), confidence 1.0 
- components: income 18.37 / freshness 35.0 / resource 15.0 / registration 10.0
