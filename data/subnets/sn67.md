...
- registration cost: 0.050444877 TAO (12.19807570737 USD), open=True
...
- **competitive_miner_usd_day: 167.10822172361333** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 20.322318539281916
- top_miner_usd_day: 167.10822172361333 (uid 193, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.336 USD/day  |  payback on registration: 0.63 days

## Score

- gate: **OK** 
- score: 71.7 (rank 8), confidence 1.0 
- components: income 11.9 / freshness 35.0 / resource 15.0 / registration 9.79
