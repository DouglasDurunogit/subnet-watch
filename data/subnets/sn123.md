...
- subnet age: 424.8 days  |  registered at block 5794330
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 76.72558652303468** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.108100354346665
- top_miner_usd_day: 628.4455649749048 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.1111 USD/day  |  payback on registration: [UNKNOWN] days
