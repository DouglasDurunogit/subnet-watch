...
- miner_burn: **0.1505606505088508**
- registration cost: 0.1 TAO (22.709000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 31  |  free: 0
- subnet age: 807.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 107.08073073972723** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 20.125620441181237
- top_miner_usd_day: 1071.1363366142944 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.7516476305296178  |  top1_share: 0.44712866451996885  |  top10_share: 0.9987333465594335
- owner_incentive_share: 0.15056388969432447 (independent check on miner_burn; disagreement 0.0)
...
- last commit: 2026-08-31T13:15:27Z
- scoring-related commit: fix(reporting): tenure rows state how many days the miner actually has 2026-08-30T13:48:48Z
...
- net margin: 4.0405 USD/day  |  payback on registration: 5.62 days

## Score

- gate: **OK** 
- score: 64.5 (rank 12), confidence 1.0 
- components: income 6.39 / freshness 35.0 / resource 15.0 / registration 8.13
