...
- registration cost: 0.8 TAO (159.736 USD), open=True
...
- **competitive_miner_usd_day: 36.79771892287268** (uid 115) <- the only figure quotable as achievable
- median_miner_usd_day: 9.08118513263696
- top_miner_usd_day: 36.79771892287268 (uid 115, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.862 USD/day  |  payback on registration: 185.31 days

## Score

- gate: **OK** 
- score: 29.5 (rank 53), confidence 0.85 - hardware requirement unknown
- components: income 2.46 / freshness 21.0 / resource 11.25 / registration 0.0
