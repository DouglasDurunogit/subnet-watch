...
- subnet age: 785.5 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 95.35662768555568** (uid 167) <- the only figure quotable as achievable
- median_miner_usd_day: 42.474779851581715
- top_miner_usd_day: 95.35662768555568 (uid 167, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 82  |  gini: 0.3226316765564823  |  top1_share: 0.029239319632332735  |  top10_share: 0.2501297828808746
...
- net margin: 41.4885 USD/day  |  payback on registration: 0.56 days

## Score

- gate: **OK** 
- score: 50.1 (rank 34), confidence 1.0 
- components: income 14.81 / freshness 10.5 / resource 15.0 / registration 9.81
