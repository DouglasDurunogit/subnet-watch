...
- miner_burn: **0.0**
- registration cost: 0.165357236 TAO (34.53320516624 USD), open=True
...
- **competitive_miner_usd_day: 114.59068845260869** (uid 176) <- the only figure quotable as achievable
- median_miner_usd_day: 21.261164320910847
- top_miner_usd_day: 137.84820623088206 (uid 217, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.0475 USD/day  |  payback on registration: 3.44 days

## Score

- gate: **OK** 
- score: 25.2 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 9.49 / freshness 0.0 / resource 11.25 / registration 8.85
