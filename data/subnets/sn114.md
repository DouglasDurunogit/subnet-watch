...
- miner_burn: **0.0**
- registration cost: 0.057011871 TAO (11.20340277021 USD), open=True
...
- **competitive_miner_usd_day: 1721.833671596895** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 1721.833671596895
- top_miner_usd_day: 4476.893664714212 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1197.0539 USD/day  |  payback on registration: 0.01 days
...
- components: income 28.0 / freshness 35.0 / resource 11.25 / registration 10.0
