...
- **competitive_miner_usd_day: 29.825285401310794** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.24625374324206
- top_miner_usd_day: 2494.122205004514 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.1447 USD/day  |  payback on registration: 3.99 days

## Score

- gate: **OK** 
- score: 51.8 (rank 29), confidence 1.0 
- components: income 7.17 / freshness 21.0 / resource 15.0 / registration 8.67
