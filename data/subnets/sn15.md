...
- miner_burn: **0.0**
- registration cost: 0.309235293 TAO (62.68508624403001 USD), open=True
...
- **competitive_miner_usd_day: 12916.29720926171** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 10.8368688063766
- top_miner_usd_day: 12916.29720926171 (uid 104, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.7464 USD/day  |  payback on registration: 6.43 days

## Score

- gate: **OK** 
- score: 67.2 (rank 14), confidence 1.0 
- components: income 9.38 / freshness 35.0 / resource 15.0 / registration 7.86
