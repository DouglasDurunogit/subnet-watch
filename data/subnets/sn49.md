...
- registration cost: 0.05 TAO (11.8 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 313.6 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 51.058092762575484** (uid 112) <- the only figure quotable as achievable
- median_miner_usd_day: 2554.2298100020016
- top_miner_usd_day: 5057.401527241428 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 42.8389 USD/day  |  payback on registration: 0.28 days
...
- components: income 14.93 / freshness 10.5 / resource 11.25 / registration 9.91
