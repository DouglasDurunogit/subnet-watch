...
- miner_burn: **0.0**
- registration cost: 0.106958695 TAO (24.81548682695 USD), open=True
...
- **competitive_miner_usd_day: 9212.92425804532** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 9212.92425804532
- top_miner_usd_day: 9212.92425804532 (uid 42, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9204.7051 USD/day  |  payback on registration: 0.0 days
...
- components: income 36.05 / freshness 35.0 / resource 11.25 / registration 10.0
