...
- **competitive_miner_usd_day: 4037.796320700258** (uid 38) <- the only figure quotable as achievable
- median_miner_usd_day: 2038.777595198172
- top_miner_usd_day: 4037.796320700258 (uid 38, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4023.0018 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 42.7 (rank 21), confidence 0.85 - hardware from README keywords, not curated
- components: income 32.78 / freshness 0.0 / resource 7.5 / registration 10.0
