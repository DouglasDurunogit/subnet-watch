...
- miner_burn: **0.15056645963340998**
...
- **competitive_miner_usd_day: 602.7498475416402** (uid 244) <- the only figure quotable as achievable
- median_miner_usd_day: 11.294616229789082
- top_miner_usd_day: 1205.4996950832804 (uid 39, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.6507 USD/day  |  payback on registration: 5.07 days

## Score

- gate: **OK** 
- score: 65.2 (rank 13), confidence 1.0 
- components: income 6.84 / freshness 35.0 / resource 15.0 / registration 8.31
