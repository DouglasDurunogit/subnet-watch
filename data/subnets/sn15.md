...
- miner_burn: **0.0**
- registration cost: 0.389769179 TAO (94.18382441356 USD), open=True
...
- **competitive_miner_usd_day: 46.90556921337918** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 27.889797910657894
- top_miner_usd_day: 25621.00510789543 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 26.6922 USD/day  |  payback on registration: 3.53 days

## Score

- gate: **OK** 
- score: 71.9 (rank 7), confidence 1.0 
- components: income 13.12 / freshness 35.0 / resource 15.0 / registration 8.82
