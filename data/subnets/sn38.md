...
- subnet age: 238.6 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 5341.436378280202
- top_miner_usd_day: 5341.436378280202 (uid 131, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 42.5 (rank 42), confidence 0.85 - hardware from README keywords, not curated
