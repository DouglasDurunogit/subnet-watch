...
- miner_burn: **0.0**
- registration cost: 0.128876256 TAO (24.637273859519997 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 217  |  free: 0
- subnet age: 496.9 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 370.7832031560666** (uid 76) <- the only figure quotable as achievable
- median_miner_usd_day: 6.21750600067149
- top_miner_usd_day: 370.7832031560666 (uid 76, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 216  |  gini: 0.7259706310701601  |  top1_share: 0.08251284246575342  |  top10_share: 0.46894875244618395
...
- net margin: 5.2312 USD/day  |  payback on registration: 4.71 days

## Score

- gate: **OK** 
- score: 30.7 (rank 49), confidence 1.0 
- components: income 7.23 / freshness 0.0 / resource 15.0 / registration 8.43
