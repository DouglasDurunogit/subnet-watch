...
- subnet age: 535.9 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 89.5187531224541** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 20.804306496885037
- top_miner_usd_day: 89.5187531224541 (uid 104, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 236  |  gini: 0.3845694103771813  |  top1_share: 0.01476680373603192  |  top10_share: 0.1257624164972408
...
- net margin: 12.5851 USD/day  |  payback on registration: 1.82 days

## Score

- gate: **OK** 
- score: 26.3 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 10.31 / freshness 0.0 / resource 11.25 / registration 9.39
