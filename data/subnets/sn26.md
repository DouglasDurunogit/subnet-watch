...
- subnet age: 125.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 33.796936375218394** (uid 132) <- the only figure quotable as achievable
- median_miner_usd_day: 26.554735723385885
- top_miner_usd_day: 1893.0410980180322 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 16.3536 USD/day  |  payback on registration: 1.59 days

## Score

- gate: **OK** 
- score: 53.0 (rank 29), confidence 1.0 
- components: income 11.27 / freshness 21.0 / resource 11.25 / registration 9.47
