...
- **competitive_miner_usd_day: 3182.232735916117** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 24.10376588389585
- top_miner_usd_day: 23559.0207749198 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 13.2064 USD/day  |  payback on registration: 7.11 days

## Score

- gate: **OK** 
- score: 54.7 (rank 15), confidence 0.85 - hardware requirement unknown
- components: income 10.48 / freshness 35.0 / resource 11.25 / registration 7.63
