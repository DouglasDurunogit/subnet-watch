...
- **competitive_miner_usd_day: 744.6407446954183** (uid 154) <- the only figure quotable as achievable
- median_miner_usd_day: 6.96373275531111
- top_miner_usd_day: 744.6407446954183 (uid 154, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.6459 USD/day  |  payback on registration: 5.45 days

## Score

- gate: **OK** 
- score: 64.3 (rank 15), confidence 1.0 
- components: income 6.07 / freshness 35.0 / resource 15.0 / registration 8.18
