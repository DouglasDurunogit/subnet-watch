...
- **competitive_miner_usd_day: 226.078647751724** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 42.05457991886002
- top_miner_usd_day: 11562.187022658394 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 32.1419 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.6 (rank 20), confidence 0.85 - hardware from README keywords, not curated
- components: income 13.83 / freshness 35.0 / resource 11.25 / registration 10.0
