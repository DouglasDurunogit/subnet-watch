...
- miner_burn: **0.5327259283512831**
- registration cost: 0.0005 TAO (0.130605 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 134  |  free: 0
- subnet age: 973.4 days  |  registered at block 2009702
- weights_version: 1000910  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 96.91308773307316** (uid 217) <- the only figure quotable as achievable
- median_miner_usd_day: 6.3549565726605355
- top_miner_usd_day: 1289.9083945623527 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 124  |  gini: 0.7476801905121371  |  top1_share: 0.5332763071471123  |  top10_share: 0.6604090610536607
- owner_incentive_share: 0.5332763071471123 (independent check on miner_burn; disagreement 0.0006)
...
- net margin: -1.9012 USD/day  |  payback on registration: [UNKNOWN] days
