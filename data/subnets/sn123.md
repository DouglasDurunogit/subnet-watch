...
- **competitive_miner_usd_day: 83.43004989601961** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.217976786601749
- top_miner_usd_day: 656.7404891756495 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.0134 USD/day  |  payback on registration: [UNKNOWN] days
