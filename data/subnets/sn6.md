...
- miner_burn: **0.0**
- registration cost: 0.2 TAO (40.744 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 33  |  free: 0
- subnet age: 776.5 days  |  registered at block 3219949
- weights_version: 2018  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 458.51566545682675** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 31.60928410300498
- top_miner_usd_day: 458.51566545682675 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 18  |  gini: 0.6748892687327459  |  top1_share: 0.2608967706489226  |  top10_share: 0.9679201513949088
...
- net margin: 24.4272 USD/day  |  payback on registration: 1.67 days

## Score

- gate: **OK** 
- score: 58.2 (rank 20), confidence 1.0 
- components: income 12.78 / freshness 21.0 / resource 15.0 / registration 9.44
