...
- subnet age: 292.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4999.635866383528** (uid 38) <- the only figure quotable as achievable
- median_miner_usd_day: 4999.635866383528
- top_miner_usd_day: 4999.635866383528 (uid 38, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4991.4167 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 45.5 (rank 39), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 33.64 / freshness 21.0 / resource 11.25 / registration 10.0
