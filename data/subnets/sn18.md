...
- subnet age: 1015.9 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1604.3099206402846** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 5.3206298642285565
- top_miner_usd_day: 1604.3099206402846 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.9919 USD/day  |  payback on registration: [UNKNOWN] days
