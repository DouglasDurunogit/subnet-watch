...
- miner_burn: **0.0**
- registration cost: 0.111255041 TAO (24.498360028199997 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 228  |  free: 0
- subnet age: 528.3 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 409.2499285908006** (uid 101) <- the only figure quotable as achievable
- median_miner_usd_day: 4.949553560296124
- top_miner_usd_day: 409.2499285908006 (uid 101, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 227  |  gini: 0.7610408919930451  |  top1_share: 0.09605625191073067  |  top10_share: 0.4892081932130847
...
- net margin: 3.9633 USD/day  |  payback on registration: 6.18 days

## Score

- gate: **OK** 
- score: 64.3 (rank 16), confidence 1.0 
- components: income 6.33 / freshness 35.0 / resource 15.0 / registration 7.94
