...
- miner_burn: **0.0**
- registration cost: 0.010459595 TAO (2.0762296075 USD), open=True
...
- **competitive_miner_usd_day: 256.1446125560343** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 27.90158649471334
- top_miner_usd_day: 256.1446125560343 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.6824 USD/day  |  payback on registration: 0.11 days

## Score

- gate: **OK** 
- score: 46.1 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 11.97 / freshness 21.0 / resource 11.25 / registration 9.96
