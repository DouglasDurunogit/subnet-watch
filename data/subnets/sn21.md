...
- miner_burn: **0.45122748077847064**
- registration cost: 0.1 TAO (19.630000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 100  |  free: 0
- subnet age: 793.0 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.66359858060043** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.73030639691634
- top_miner_usd_day: 878.10847096331 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.744 USD/day  |  payback on registration: 2.53 days

## Score

- gate: **OK** 
- score: 67.7 (rank 8), confidence 1.0 
- components: income 8.56 / freshness 35.0 / resource 15.0 / registration 9.16
