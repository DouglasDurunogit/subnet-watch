...
- subnet age: 863.8 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 803.4053673272089** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 580.8190926394178
- top_miner_usd_day: 803.4053673272089 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.27471274014618574  |  top1_share: 0.3815787465856897  |  top10_share: 1.0
...
- net margin: 143.5588 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 25.2 (rank 59), confidence 0.85 - hardware from README keywords, not curated
