...
- miner_burn: **0.01942634442821145**
- registration cost: 0.0005 TAO (0.15101499999999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 9  |  free: 157
- subnet age: 73.0 days  |  registered at block 8618670
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 10937.486112329954** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 7752.4515323127935
- top_miner_usd_day: 10937.486112329954 (uid 56, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.36960966826380215  |  top1_share: 0.5738395336771752  |  top10_share: 1.0
- owner_incentive_share: 0.019425031281472212 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 89885 bytes, sha 07ed705183ecf44a
- latest release: v1.2.0 2026-09-15T15:54:08Z
- last commit: 2026-09-24T08:59:28Z
- scoring-related commit: docs: client-facing attestation of inference — API + verification gui… 2026-09-18T17:37:57Z
...
- net margin: 9266.0647 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 48.6 (rank 39), confidence 0.6 - hardware from README keywords, not curated; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 36.08 / freshness 35.0 / resource 0.0 / registration 10.0
...
_(truncated at 6000 of 89885 chars - read the full file at https://github.com/KubeTEE-AI/kubetee-subnet)_
