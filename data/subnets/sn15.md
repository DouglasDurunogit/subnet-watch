...
- miner_burn: **0.0**
- registration cost: 0.469699388 TAO (103.54523008459999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 90  |  free: 0
- subnet age: 213.8 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 40.048916574255315** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 22.369665113548017
- top_miner_usd_day: 21970.258350956115 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 77  |  gini: 0.9372052788802163  |  top1_share: 0.9297350942820063  |  top10_share: 0.9442552866631041
...
- last commit: 2026-08-21T23:12:18Z
- scoring-related commit: chore: remove dead BackendClient top-miner and race-history methods (… 2026-08-21T23:12:08Z
...
- net margin: 21.3834 USD/day  |  payback on registration: 4.84 days

## Score

- gate: **OK** 
- score: 70.7 (rank 6), confidence 1.0 
- components: income 12.28 / freshness 35.0 / resource 15.0 / registration 8.39
