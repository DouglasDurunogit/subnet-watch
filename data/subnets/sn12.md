...
- **competitive_miner_usd_day: 8.460349875118796** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 14.028641374559223
- top_miner_usd_day: 2742.75046640267 (uid 190, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.3847 USD/day  |  payback on registration: [UNKNOWN] days
