...
- subnet age: 716.0 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 330.49532113345924** (uid 255) <- the only figure quotable as achievable
- median_miner_usd_day: 348.83946543659033
- top_miner_usd_day: 1294.916153594791 (uid 206, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.45942887081432193  |  top1_share: 0.39425615357617  |  top10_share: 1.0
...
- net margin: 170.11 USD/day  |  payback on registration: 0.0 days
