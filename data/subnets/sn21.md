...
- miner_burn: **0.4507728342432529**
- registration cost: 0.1 TAO (19.521 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 134  |  free: 0
- subnet age: 776.6 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 25.292037000990035** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.29373605927414
- top_miner_usd_day: 864.759334544267 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.3074 USD/day  |  payback on registration: 3.68 days

## Score

- gate: **OK** 
- score: 31.0 (rank 46), confidence 1.0 
- components: income 7.27 / freshness 0.0 / resource 15.0 / registration 8.77
