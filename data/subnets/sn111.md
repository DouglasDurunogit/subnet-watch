...
- miner_burn: **0.0**
- registration cost: 0.970327102 TAO (227.53200214798002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 8  |  free: 0
- subnet age: 464.7 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3309.916751718895** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 607.9195969744854
- top_miner_usd_day: 3309.916751718895 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 17714 bytes, sha aad5ddc431f6acc7
- latest release: (none) 
- last commit: 2026-08-30T21:57:12Z
- scoring-related commit: feat(selection): expand miner pool with provisional performance 2026-08-30T21:57:12Z
...
- net margin: 599.7004 USD/day  |  payback on registration: 0.38 days

## Score

- gate: **OK** 
- score: 69.2 (rank 9), confidence 0.85 - hardware requirement unknown
- components: income 25.27 / freshness 35.0 / resource 11.25 / registration 9.87
...
```bash
cp validator/agent_v1/validator.testnet.env.ex
```

_(truncated at 6000 of 17714 chars - read the full file at https://github.com/DeSciClaims/Claims)_
