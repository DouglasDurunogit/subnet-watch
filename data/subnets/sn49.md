...
- **competitive_miner_usd_day: 66.61588181953978** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 66.61588181953978
- top_miner_usd_day: 6531.814341951333 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 58.3459 USD/day  |  payback on registration: 0.2 days
...
- components: income 16.13 / freshness 21.0 / resource 11.25 / registration 9.93
