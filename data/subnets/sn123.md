...
- **competitive_miner_usd_day: 75.81551630771462** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.1845538517539853
- top_miner_usd_day: 623.6096411128034 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.0346 USD/day  |  payback on registration: [UNKNOWN] days
