...
- subnet age: 629.1 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1916.5872848340957** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 117.00450361787033
- top_miner_usd_day: 2096.107708264425 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 82.2708 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 62.7 (rank 11), confidence 0.85 - hardware from README keywords, not curated
