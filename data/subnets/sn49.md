...
- **competitive_miner_usd_day: 42.17554640824054** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2109.8719529142268
- top_miner_usd_day: 4177.568359420213 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.9564 USD/day  |  payback on registration: 0.29 days
...
- components: income 14.04 / freshness 21.0 / resource 11.25 / registration 9.9
