...
- subnet age: 308.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 52.86564649588029** (uid 117) <- the only figure quotable as achievable
- median_miner_usd_day: 2644.654410275587
- top_miner_usd_day: 5236.443174055295 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 44.6465 USD/day  |  payback on registration: 0.26 days

## Score

- gate: **OK** 
- score: 28.1 (rank 68), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 15.09 / freshness 10.5 / resource 11.25 / registration 9.91
