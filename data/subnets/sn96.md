...
- **competitive_miner_usd_day: 194.70139154816522** (uid 189) <- the only figure quotable as achievable
- median_miner_usd_day: 28.30011496531603
- top_miner_usd_day: 2252.7911336354273 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 19.9535 USD/day  |  payback on registration: 1.19 days

## Score

- gate: **OK** 
- score: 67.9 (rank 11), confidence 1.0 
- components: income 12.02 / freshness 35.0 / resource 11.25 / registration 9.6
