...
- miner_burn: **0.4506025486625731**
- registration cost: 0.1 TAO (20.652 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 784.6 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 23.797912347527628** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.949478086881907
- top_miner_usd_day: 910.3009736042628 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.9632 USD/day  |  payback on registration: 4.16 days

## Score

- gate: **OK** 
- score: 65.7 (rank 16), confidence 1.0 
- components: income 7.05 / freshness 35.0 / resource 15.0 / registration 8.61
