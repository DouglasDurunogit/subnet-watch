...
- subnet age: 496.2 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 126.43466209927776** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 0.046051597923612374
- top_miner_usd_day: 132.78978261273627 (uid 218, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-20T11:37:34Z
- scoring-related commit: build_hf_scoreboard: HF status speaks the LF vocabulary 2026-08-20T11:37:34Z
