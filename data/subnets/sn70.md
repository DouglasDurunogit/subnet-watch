...
- miner_burn: **0.0**
- registration cost: 0.9 TAO (179.847 USD), open=True
...
- **competitive_miner_usd_day: 50.517049820157474** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 101.05800737804336
- top_miner_usd_day: 404.315706594223 (uid 26, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 29.7224 USD/day  |  payback on registration: 6.05 days
...
- components: income 13.53 / freshness 0.0 / resource 11.25 / registration 7.98
