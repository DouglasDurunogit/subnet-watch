...
- **competitive_miner_usd_day: 303.45795710485334** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 29.60352444850224
- top_miner_usd_day: 2300.5169559626643 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 21.3843 USD/day  |  payback on registration: 1.08 days

## Score

- gate: **OK** 
- score: 68.2 (rank 8), confidence 1.0 
- components: income 12.28 / freshness 35.0 / resource 11.25 / registration 9.64
