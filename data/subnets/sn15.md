...
- miner_burn: **0.0**
- registration cost: 0.261402974 TAO (52.79294462904 USD), open=True
...
- **competitive_miner_usd_day: 21.32336464367766** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 11.052936718970532
- top_miner_usd_day: 11914.478901454537 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.9688 USD/day  |  payback on registration: 5.3 days

## Score

- gate: **OK** 
- score: 67.7 (rank 9), confidence 1.0 
- components: income 9.46 / freshness 35.0 / resource 15.0 / registration 8.23
