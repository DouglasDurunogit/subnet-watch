...
- subnet age: 106.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 249.41670736919716** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 24.492545580967246
- top_miner_usd_day: 1746.0311359460627 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.0805 USD/day  |  payback on registration: 1.24 days

## Score

- gate: **OK** 
- score: 67.3 (rank 10), confidence 1.0 
- components: income 11.43 / freshness 35.0 / resource 11.25 / registration 9.59
