...
- miner_burn: **0.0**
- registration cost: 0.000577677 TAO (0.12821541015 USD), open=True
...
- **competitive_miner_usd_day: 2192.522155084272** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2192.522155084272
- top_miner_usd_day: 2192.522155084272 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2184.303 USD/day  |  payback on registration: 0.0 days
...
- components: income 30.37 / freshness 0.0 / resource 11.25 / registration 10.0
