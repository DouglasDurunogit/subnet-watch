...
- registration cost: 0.000790972 TAO (0.14855245132 USD), open=True
...
- **competitive_miner_usd_day: 6.988090141142307** (uid 105) <- the only figure quotable as achievable
- median_miner_usd_day: 5.213337089423626
- top_miner_usd_day: 2553.5368752259847 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -3.0058 USD/day  |  payback on registration: [UNKNOWN] days
