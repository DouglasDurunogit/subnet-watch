...
- subnet age: 722.8 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 28.296712936586786** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 367.44685783532657
- top_miner_usd_day: 1125.561158549362 (uid 206, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.3840380673350323  |  top1_share: 0.39757068957624403  |  top10_share: 1.0
...
- net margin: 20.0775 USD/day  |  payback on registration: 0.01 days
