...
- **competitive_miner_usd_day: 22.849211407903287** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.712302851975822
- top_miner_usd_day: 873.9823363523008 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.726 USD/day  |  payback on registration: 4.12 days

## Score

- gate: **OK** 
- score: 65.5 (rank 14), confidence 1.0 
- components: income 6.89 / freshness 35.0 / resource 15.0 / registration 8.63
