...
- registration cost: 0.99 TAO (240.24329999999998 USD), open=True
...
- **competitive_miner_usd_day: 436.749338657594** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 1091.8566857246801
- top_miner_usd_day: 1746.9640327917662 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 428.5302 USD/day  |  payback on registration: 0.56 days
...
- components: income 23.95 / freshness 35.0 / resource 11.25 / registration 9.81
