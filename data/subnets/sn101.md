...
- registration cost: 0.005954883 TAO (1.29959366592 USD), open=True
...
- **competitive_miner_usd_day: 2.1652968431265163** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.3082001760556037
- top_miner_usd_day: 2665.1195310815538 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.3219 USD/day  |  payback on registration: 4.04 days

## Score

- gate: **OK** 
- score: 45.8 (rank 38), confidence 1.0 
- components: income 1.1 / freshness 21.0 / resource 15.0 / registration 8.65
