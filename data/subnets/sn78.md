...
- subnet age: 142.9 days  |  registered at block 7966145
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3670.9882375321645
- top_miner_usd_day: 3670.9882375321645 (uid 98, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 21902 bytes, sha f1332d89319922b1
- latest release: (none) 
- last commit: 2026-09-04T05:15:37Z
- scoring-related commit: Expose replay-verified public miner solutions 2026-09-03T21:48:59Z
...
the `ffmpeg` package with your operating-system package manager
```

_(truncated at 6000 of 21902 chars - read the full file at https://github.com/Umi-BitSign/umi)_
