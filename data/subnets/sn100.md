...
- miner_burn: **0.5**
- registration cost: 0.000553704 TAO (0.10916274360000001 USD), open=True
...
- **competitive_miner_usd_day: 1686.9140232024474** (uid 77) <- the only figure quotable as achievable
- median_miner_usd_day: 1686.9140232024474
- top_miner_usd_day: 1686.9140232024474 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1678.6948 USD/day  |  payback on registration: 0.0 days
