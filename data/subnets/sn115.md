...
- subnet age: 429.3 days  |  registered at block 5683635
- weights_version: 68200  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2082.549650581399** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 2082.549650581399
- top_miner_usd_day: 2082.549650581399 (uid 155, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2074.3305 USD/day  |  payback on registration: 0.0 days
