...
- **competitive_miner_usd_day: 2648.138311947219** (uid 249) <- the only figure quotable as achievable
- median_miner_usd_day: 40.37248279094895
- top_miner_usd_day: 2648.138311947219 (uid 249, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 32.1533 USD/day  |  payback on registration: 0.61 days
