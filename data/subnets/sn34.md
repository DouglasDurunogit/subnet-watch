...
- **competitive_miner_usd_day: 19.912616836633127** (uid 96) <- the only figure quotable as achievable
- median_miner_usd_day: 9.264158635225037
- top_miner_usd_day: 2808.5308506213837 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.5379 USD/day  |  payback on registration: [UNKNOWN] days
