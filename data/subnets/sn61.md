...
- miner_burn: **0.0**
- registration cost: 0.000653458 TAO (0.12894686714 USD), open=True
...
- **competitive_miner_usd_day: 762.8927103826558** (uid 75) <- the only figure quotable as achievable
- median_miner_usd_day: 26.449579092180038
- top_miner_usd_day: 762.8927103826558 (uid 75, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.2304 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 57.7 (rank 21), confidence 0.85 - hardware requirement unknown
- components: income 11.68 / freshness 35.0 / resource 11.25 / registration 10.0
