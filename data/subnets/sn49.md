...
- subnet age: 307.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.032435089172786** (uid 117) <- the only figure quotable as achievable
- median_miner_usd_day: 2703.0241230029387
- top_miner_usd_day: 5352.015810916705 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 45.8133 USD/day  |  payback on registration: 0.25 days
...
- components: income 15.19 / freshness 10.5 / resource 11.25 / registration 9.92
