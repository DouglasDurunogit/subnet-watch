...
- **competitive_miner_usd_day: 382.94941424013575** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.1640196541522005
- top_miner_usd_day: 766.057675922714 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.3964 USD/day  |  payback on registration: 14.68 days

## Score

- gate: **OK** 
- score: 58.6 (rank 21), confidence 1.0 
- components: income 3.45 / freshness 35.0 / resource 15.0 / registration 5.11
