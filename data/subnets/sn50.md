...
- miner_burn: **1.8184073269367218e-07**
- registration cost: 0.8 TAO (156.06400000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 244  |  free: 0
- subnet age: 552.4 days  |  registered at block 4763204
- weights_version: 100  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 32.774791723838064** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 9.501759541904521
- top_miner_usd_day: 32.774791723838064 (uid 240, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 235  |  gini: 0.4565270366354004  |  top1_share: 0.011969914697159629  |  top10_share: 0.11933225303451861
...
- latest release: v1.11.0 migrate price feeds from Pyth to Binance + Hyperliquid, replace SPYX with SP500, remove miner burn 2026-07-22T16:26:10Z
...
- net margin: 1.2826 USD/day  |  payback on registration: 121.68 days

## Score

- gate: **OK** 
- score: 12.3 (rank 65), confidence 0.85 - hardware requirement unknown
