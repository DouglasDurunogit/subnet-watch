...
- **competitive_miner_usd_day: 10925.584215348** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 1.009680481972861
- top_miner_usd_day: 10925.584215348 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -7.2095 USD/day  |  payback on registration: [UNKNOWN] days
