...
- subnet age: 568.4 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1012.7167972263593** (uid 58) <- the only figure quotable as achievable
- median_miner_usd_day: 1687.8784992225894
- top_miner_usd_day: 2363.04020121882 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-24T20:11:33Z
- scoring-related commit: chore(release): bind verifier cache and semantic fixes 2026-09-24T20:11:33Z
...
- net margin: 1004.4976 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.1 (rank 37), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
