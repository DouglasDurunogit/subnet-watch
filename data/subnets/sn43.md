...
- registration cost: 0.1 TAO (22.343000000000004 USD), open=True
...
- **competitive_miner_usd_day: 184.2113650651381** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0595559206704737
- top_miner_usd_day: 2691.7261338975763 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.4818 USD/day  |  payback on registration: [UNKNOWN] days
