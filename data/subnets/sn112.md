...
- subnet age: 458.2 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 461.2341473514636** (uid 105) <- the only figure quotable as achievable
- median_miner_usd_day: 1153.0677734237743
- top_miner_usd_day: 1844.9013994960849 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 453.015 USD/day  |  payback on registration: 0.51 days
...
- components: income 24.17 / freshness 35.0 / resource 11.25 / registration 9.83
