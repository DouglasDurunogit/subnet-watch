...
- **competitive_miner_usd_day: 115.83505214776389** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 4.831493311689838
- top_miner_usd_day: 115.83505214776389 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.3877 USD/day  |  payback on registration: [UNKNOWN] days
