...
- subnet age: 654.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 332.2970030396948** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 46.79797112751846
- top_miner_usd_day: 12866.301256636196 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.2647 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.1 (rank 22), confidence 0.85 - hardware from README keywords, not curated
