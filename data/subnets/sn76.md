...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (22.37599977624 USD), open=True
...
- **competitive_miner_usd_day: 133.8629014023389** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 89.73552903740863
- top_miner_usd_day: 299.4601495802834 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 79.1583 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 77.2 (rank 1), confidence 1.0 
- components: income 17.32 / freshness 35.0 / resource 15.0 / registration 9.91
