...
- registration cost: 0.099999999 TAO (25.589999744100002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 15  |  free: 0
- subnet age: 92.8 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 395.9162827582431** (uid 203) <- the only figure quotable as achievable
- median_miner_usd_day: 145.15587823608425
- top_miner_usd_day: 1319.7343679694152 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-08T01:05:23Z
- scoring-related commit: cost is total task latency for every system; empty profile responses … 2026-09-08T00:30:17Z
...
- net margin: 130.9791 USD/day  |  payback on registration: 0.2 days

## Score

- gate: **OK** 
- score: 79.2 (rank 2), confidence 1.0 
- components: income 19.29 / freshness 35.0 / resource 15.0 / registration 9.93
