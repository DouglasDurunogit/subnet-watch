...
- **competitive_miner_usd_day: 12537.647615632388** (uid 21) <- the only figure quotable as achievable
- median_miner_usd_day: 2027.816304709278
- top_miner_usd_day: 12537.647615632388 (uid 21, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1693.952 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 36.7 (rank 48), confidence 0.85 - hardware from README keywords, not curated
