...
- **competitive_miner_usd_day: 144.00631159664377** (uid 102) <- the only figure quotable as achievable
- median_miner_usd_day: 139.363637072196
- top_miner_usd_day: 1499.8896763054297 (uid 14, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 80.7283 USD/day  |  payback on registration: 0.0 days
