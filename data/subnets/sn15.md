...
- miner_burn: **0.0**
- registration cost: 0.234121531 TAO (46.339674630830004 USD), open=True
...
- **competitive_miner_usd_day: 20.09842024992342** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 10.136594560830945
- top_miner_usd_day: 10767.684956678539 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 69  |  gini: 0.9463790022023355  |  top1_share: 0.9406690382765622  |  top10_share: 0.9556468235186344
...
- net margin: 8.9755 USD/day  |  payback on registration: 5.16 days

## Score

- gate: **OK** 
- score: 67.4 (rank 11), confidence 1.0 
- components: income 9.09 / freshness 35.0 / resource 15.0 / registration 8.28
