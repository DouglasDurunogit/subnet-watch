...
- miner_burn: **0.15056979469954967**
- registration cost: 0.1 TAO (25.866000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 29  |  free: 0
- subnet age: 802.8 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1254.505087506845** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 11.75375952353843
- top_miner_usd_day: 1254.505087506845 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-27T12:19:47Z
- scoring-related commit: perf(rewards): per-day fingerprint index — the one-payer check stops … 2026-08-27T12:19:47Z
...
- net margin: 0.9405 USD/day  |  payback on registration: 27.5 days

## Score

- gate: **OK** 
- score: 53.5 (rank 29), confidence 1.0 
- components: income 2.62 / freshness 35.0 / resource 15.0 / registration 0.83
