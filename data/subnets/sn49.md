...
- miner_burn: **0.0**
- registration cost: 0.000587686 TAO (0.11555082132000001 USD), open=True
...
- **competitive_miner_usd_day: 42.71167609775288** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 42.71167609775288
- top_miner_usd_day: 4190.113238188255 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.6473685013657242  |  top1_share: 0.9805288938397448  |  top10_share: 1.0
...
- net margin: 33.384 USD/day  |  payback on registration: 0.0 days
...
- components: income 13.97 / freshness 21.0 / resource 11.25 / registration 10.0
