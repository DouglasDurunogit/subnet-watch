...
- miner_burn: **0.0**
- registration cost: 0.291752197 TAO (55.85887563762 USD), open=True
...
- **competitive_miner_usd_day: 12147.979354926147** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.181830007764075
- top_miner_usd_day: 12147.979354926147 (uid 253, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10.0974 USD/day  |  payback on registration: 5.53 days

## Score

- gate: **OK** 
- score: 67.7 (rank 9), confidence 1.0 
- components: income 9.51 / freshness 35.0 / resource 15.0 / registration 8.16
