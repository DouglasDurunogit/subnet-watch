...
- **competitive_miner_usd_day: 79.20877973289782** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 7.668664130766785
- top_miner_usd_day: 1163.7964684851675 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 116  |  gini: 0.7656145161069463  |  top1_share: 0.5215199926688456  |  top10_share: 0.6545346244310719
- owner_incentive_share: 0.5215199926688456 (independent check on miner_burn; disagreement 0.0005)
...
- net margin: -0.5505 USD/day  |  payback on registration: [UNKNOWN] days
