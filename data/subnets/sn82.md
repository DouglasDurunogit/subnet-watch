...
- miner_burn: **0.0**
- registration cost: 0.000988685 TAO (0.19677797555 USD), open=True
...
- **competitive_miner_usd_day: 2617.40537354734** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2617.40537354734
- top_miner_usd_day: 2617.40537354734 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2609.1862 USD/day  |  payback on registration: 0.0 days
