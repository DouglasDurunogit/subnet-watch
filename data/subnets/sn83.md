...
- miner_burn: **0.0**
- registration cost: 0.22433511 TAO (44.135689541400005 USD), open=True
...
- **competitive_miner_usd_day: 291.7657478576566** (uid 117) <- the only figure quotable as achievable
- median_miner_usd_day: 18.200178483725203
- top_miner_usd_day: 291.7657478576566 (uid 117, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 7.5887 USD/day  |  payback on registration: 5.82 days

## Score

- gate: **OK** 
- score: 23.6 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 8.49 / freshness 0.0 / resource 11.25 / registration 8.06
