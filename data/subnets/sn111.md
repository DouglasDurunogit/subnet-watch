...
- subnet age: 442.1 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2863.213936846412
- top_miner_usd_day: 2863.213936846412 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
