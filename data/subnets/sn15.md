...
- miner_burn: **0.0**
- registration cost: 0.289336753 TAO (60.36432677839 USD), open=True
...
- **competitive_miner_usd_day: 20.557923210520322** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 11.230717309450917
- top_miner_usd_day: 11684.514429209068 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.2444 USD/day  |  payback on registration: 5.89 days

## Score

- gate: **OK** 
- score: 67.6 (rank 11), confidence 1.0 
- components: income 9.56 / freshness 35.0 / resource 15.0 / registration 8.04
