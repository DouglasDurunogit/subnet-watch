...
- **competitive_miner_usd_day: 24.93294801200897** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.20437942428464
- top_miner_usd_day: 852.4817328967094 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.2181 USD/day  |  payback on registration: 3.71 days

## Score

- gate: **OK** 
- score: 31.0 (rank 46), confidence 1.0 
- components: income 7.22 / freshness 0.0 / resource 15.0 / registration 8.76
