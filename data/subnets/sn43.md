...
- miner_burn: **0.804841491393745**
- registration cost: 0.1 TAO (19.155 USD), open=True
...
- **competitive_miner_usd_day: 16.90683129493095** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 3.8424616579388524
- top_miner_usd_day: 2384.360472329232 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.8691682508676768  |  top1_share: 0.8049230863142474  |  top10_share: 0.9998779147845196
...
- net margin: -0.7603 USD/day  |  payback on registration: [UNKNOWN] days
