...
- subnet age: 679.7 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5033.8539036671855** (uid 79) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9239254641175623
- top_miner_usd_day: 8964.232828023296 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.2953 USD/day  |  payback on registration: [UNKNOWN] days
