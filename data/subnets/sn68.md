...
- miner_burn: **0.0**
- registration cost: 0.111427436 TAO (25.06114463076 USD), open=True
...
- **competitive_miner_usd_day: 8750.963533558923** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 8750.963533558923
- top_miner_usd_day: 8750.963533558923 (uid 42, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8742.7444 USD/day  |  payback on registration: 0.0 days
