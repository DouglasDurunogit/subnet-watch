...
- **competitive_miner_usd_day: 3801.522656523685** (uid 11) <- the only figure quotable as achievable
- median_miner_usd_day: 66.07934563280435
- top_miner_usd_day: 3801.522656523685 (uid 11, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 57.8602 USD/day  |  payback on registration: 0.34 days
