...
- **competitive_miner_usd_day: 3656.594583628638** (uid 11) <- the only figure quotable as achievable
- median_miner_usd_day: 97.1352134044265
- top_miner_usd_day: 3656.594583628638 (uid 11, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 88.916 USD/day  |  payback on registration: 0.23 days
