...
- subnet age: 823.7 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1441.774205527236** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 819.5724614005335
- top_miner_usd_day: 1441.774205527236 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 811.3533 USD/day  |  payback on registration: 0.03 days
...
- components: income 26.46 / freshness 35.0 / resource 11.25 / registration 9.99
