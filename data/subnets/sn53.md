...
- miner_burn: **0.0**
- registration cost: 0.002220718 TAO (0.43472775568 USD), open=True
...
- **competitive_miner_usd_day: 602.923110873525** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 97.44211892905456
- top_miner_usd_day: 2094.4255443619995 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 87.7729 USD/day  |  payback on registration: 0.0 days
