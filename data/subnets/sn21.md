...
- subnet age: 829.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 46.02782060154057
- top_miner_usd_day: 1219.633319602287 (uid 218, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.7056313524402529  |  top1_share: 0.4029698135091414  |  top10_share: 0.9397033238714403
...
- last commit: 2026-09-21T16:31:00Z
- scoring-related commit: verify: the grouping recheck narrows to the same rows the run read 2026-09-21T16:31:00Z
...
- gate: **OK** 
- score: 50.0 (rank 41), confidence 1.0 
