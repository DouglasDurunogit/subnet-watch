...
- miner_burn: **0.0**
- registration cost: 0.001401054 TAO (0.33487992708000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 744.3 days  |  registered at block 3550319
- weights_version: 2027  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 28761.46376932028
- top_miner_usd_day: 28761.46376932028 (uid 6, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-22T10:30:38Z
- scoring-related commit: Merge pull request #54 from score-technologies/hardening-latency-loop 2026-08-22T10:30:38Z
