...
- **competitive_miner_usd_day: 7.444021992029276** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 5.535298404329462
- top_miner_usd_day: 2931.9266789460953 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.6839 USD/day  |  payback on registration: [UNKNOWN] days
