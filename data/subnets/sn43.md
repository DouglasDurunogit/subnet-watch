...
- registration cost: 0.1 TAO (22.743000000000002 USD), open=True
...
- **competitive_miner_usd_day: 194.7000714752423** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0785284887839854
- top_miner_usd_day: 2715.734734758076 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.447 USD/day  |  payback on registration: [UNKNOWN] days
