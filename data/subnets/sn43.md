...
- registration cost: 0.1 TAO (23.303 USD), open=True
...
- **competitive_miner_usd_day: 201.85151180691773** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 0.999525338632118
- top_miner_usd_day: 2776.9970303006444 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.6707 USD/day  |  payback on registration: [UNKNOWN] days
