...
- registration cost: 0.1 TAO (22.364 USD), open=True
...
- **competitive_miner_usd_day: 184.5277289499323** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0605041893674272
- top_miner_usd_day: 2693.8826417912396 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.456 USD/day  |  payback on registration: [UNKNOWN] days
