...
- subnet age: 325.0 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3835.214502082428
- top_miner_usd_day: 3835.214502082428 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 5829 bytes, sha 15f1b73034e4a5b6
- latest release: ctx CLI v3.3.30 2026-09-09T23:19:27Z
- last commit: 2026-09-09T22:40:23Z
- scoring-related commit: feat(proof): continuous leaf emitter with ChallengeInternal cover (#256) 2026-09-09T22:40:23Z
