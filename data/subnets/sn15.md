...
- miner_burn: **0.0**
- registration cost: 0.44766539 TAO (105.20136665 USD), open=True
...
- **competitive_miner_usd_day: 25393.28410526585** (uid 129) <- the only figure quotable as achievable
- median_miner_usd_day: 27.385979993000845
- top_miner_usd_day: 25393.28410526585 (uid 129, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 26.3997 USD/day  |  payback on registration: 3.98 days

## Score

- gate: **OK** 
- score: 71.7 (rank 5), confidence 1.0 
- components: income 13.08 / freshness 35.0 / resource 15.0 / registration 8.67
