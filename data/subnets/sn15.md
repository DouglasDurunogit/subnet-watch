...
- miner_burn: **0.0**
- registration cost: 0.213599002 TAO (40.214284106540006 USD), open=True
...
- **competitive_miner_usd_day: 10795.815168730465** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 10.851674608518577
- top_miner_usd_day: 10795.815168730465 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.8654 USD/day  |  payback on registration: 4.08 days

## Score

- gate: **OK** 
- score: 33.1 (rank 22), confidence 1.0 
- components: income 9.42 / freshness 0.0 / resource 15.0 / registration 8.64
