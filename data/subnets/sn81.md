...
- miner_burn: **0.0023140772245824337**
- registration cost: 0.0005 TAO (0.11216500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 60  |  free: 0
- subnet age: 512.8 days  |  registered at block 5203057
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 253.11061998013656** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 74.21834439525956
- top_miner_usd_day: 253.11061998013656 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 54  |  gini: 0.48317721503959343  |  top1_share: 0.05632469891471921  |  top10_share: 0.46027505991177325
- owner_incentive_share: 0.0023048860531497566 (independent check on miner_burn; disagreement 0.0)
...
- latest release: (none) 
- last commit: 2026-08-21T12:22:34Z
- scoring-related commit: verify short (<CHALLENGE_K) completions at full coverage instead of h… 2026-08-21T12:10:41Z
...
- net margin: 65.9992 USD/day  |  payback on registration: 0.0 days
