...
- miner_burn: **0.451249877223745**
- registration cost: 0.1 TAO (20.088 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 100  |  free: 0
- subnet age: 789.0 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.09221975397303** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.59043514377025
- top_miner_usd_day: 864.0692111278022 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.6041 USD/day  |  payback on registration: 2.64 days

## Score

- gate: **OK** 
- score: 67.6 (rank 13), confidence 1.0 
- components: income 8.5 / freshness 35.0 / resource 15.0 / registration 9.12
