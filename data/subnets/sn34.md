...
- **competitive_miner_usd_day: 22.393464581417312** (uid 48) <- the only figure quotable as achievable
- median_miner_usd_day: 9.233324258688656
- top_miner_usd_day: 2799.2892028410574 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.5149 USD/day  |  payback on registration: [UNKNOWN] days
