...
- miner_burn: **0.45059815631248057**
- registration cost: 0.1 TAO (19.249000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 782.9 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 22.728088294383014** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.682022073595753
- top_miner_usd_day: 869.3493772601504 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 142  |  gini: 0.7081487365944574  |  top1_share: 0.45111369122185224  |  top10_share: 0.5572580891564057
...
- last commit: 2026-08-07T14:45:16Z
- scoring-related commit: fix(scoring): group copies by behaviour, because byte-equality was ev… 2026-08-07T14:45:16Z
...
- net margin: 4.6957 USD/day  |  payback on registration: 4.1 days

## Score

- gate: **OK** 
- score: 65.5 (rank 16), confidence 1.0 
- components: income 6.87 / freshness 35.0 / resource 15.0 / registration 8.63
