...
- registration cost: 0.040284649 TAO (9.32065923913 USD), open=True
...
- **competitive_miner_usd_day: 7.048573561572355** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 5.382547083382524
- top_miner_usd_day: 3030.4380858858303 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.8366 USD/day  |  payback on registration: [UNKNOWN] days
