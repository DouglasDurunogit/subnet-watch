...
- miner_burn: **0.15057176584377885**
- registration cost: 0.1 TAO (24.474000000000004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 803.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1241.9198151036437** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 11.635845083143908
- top_miner_usd_day: 1241.9198151036437 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.9212 USD/day  |  payback on registration: 26.57 days

## Score

- gate: **OK** 
- score: 53.7 (rank 27), confidence 1.0 
- components: income 2.58 / freshness 35.0 / resource 15.0 / registration 1.14
