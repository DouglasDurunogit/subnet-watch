...
- **competitive_miner_usd_day: 23.973494600493854** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 12.955888571330723
- top_miner_usd_day: 2325.173939071303 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.9186 USD/day  |  payback on registration: 1.93 days

## Score

- gate: **OK** 
- score: 55.5 (rank 27), confidence 1.0 
- components: income 10.11 / freshness 21.0 / resource 15.0 / registration 9.36
