...
- **competitive_miner_usd_day: 5.517701410652756** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.294944454014644
- top_miner_usd_day: 886.8049707201109 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.3242 USD/day  |  payback on registration: [UNKNOWN] days
