...
- miner_burn: **0.4512389041483402**
- registration cost: 0.1 TAO (19.803 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 100  |  free: 0
- subnet age: 791.2 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.13858784519844** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.601785867184295
- top_miner_usd_day: 865.1816662534245 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.6155 USD/day  |  payback on registration: 2.6 days

## Score

- gate: **OK** 
- score: 67.6 (rank 13), confidence 1.0 
- components: income 8.51 / freshness 35.0 / resource 15.0 / registration 9.13
