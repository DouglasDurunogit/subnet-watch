...
- miner_burn: **0.0**
- registration cost: 1.117744769 TAO (214.83054460179997 USD), open=True
...
- **competitive_miner_usd_day: 33464.334428142494** (uid 72) <- the only figure quotable as achievable
- median_miner_usd_day: 115.79550883455293
- top_miner_usd_day: 33464.334428142494 (uid 72, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 114.8092 USD/day  |  payback on registration: 1.87 days

## Score

- gate: **OK** 
- score: 64.1 (rank 15), confidence 1.0 
- components: income 18.77 / freshness 21.0 / resource 15.0 / registration 9.38
