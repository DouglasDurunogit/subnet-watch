...
- miner_burn: **0.0**
- registration cost: 0.446463347 TAO (103.73575867545 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 92  |  free: 0
- subnet age: 214.1 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 44.176146234485984** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 26.03237188817924
- top_miner_usd_day: 23945.83783835397 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 25.0461 USD/day  |  payback on registration: 4.14 days

## Score

- gate: **OK** 
- score: 71.5 (rank 6), confidence 1.0 
- components: income 12.88 / freshness 35.0 / resource 15.0 / registration 8.62
