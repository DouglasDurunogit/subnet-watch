...
- miner_burn: **0.1505548155400902**
- registration cost: 0.1 TAO (25.262 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 42  |  free: 0
- subnet age: 816.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 30.71225280644364** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 11.517094802416366
- top_miner_usd_day: 1229.287288218569 (uid 110, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826530690107745  |  top1_share: 0.4471354882031561  |  top10_share: 0.9986875438757135
...
- net margin: 0.4192 USD/day  |  payback on registration: 60.26 days

## Score

- gate: **OK** 
- score: 51.4 (rank 32), confidence 1.0 
- components: income 1.38 / freshness 35.0 / resource 15.0 / registration 0.0
