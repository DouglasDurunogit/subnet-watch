...
- **competitive_miner_usd_day: 380.7604086678421** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.123068869636502
- top_miner_usd_day: 761.6787567784701 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.3828 USD/day  |  payback on registration: 14.77 days

## Score

- gate: **OK** 
- score: 58.5 (rank 20), confidence 1.0 
- components: income 3.43 / freshness 35.0 / resource 15.0 / registration 5.08
