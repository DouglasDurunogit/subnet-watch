...
- subnet age: 1040.0 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1548.901800023369** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 15.814487667264464
- top_miner_usd_day: 1548.901800023369 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6.9694 USD/day  |  payback on registration: 34.79 days

## Score

- gate: **OK** 
- score: 34.4 (rank 61), confidence 0.85 - hardware requirement unknown
- components: income 8.2 / freshness 21.0 / resource 11.25 / registration 0.0
