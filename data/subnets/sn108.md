...
- subnet age: 238.3 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2025.1341262798844
- top_miner_usd_day: 2025.1341262798844 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-10T23:54:26Z
- scoring-related commit: merge: the canonical miner script and the subnet-published image 2026-08-10T14:25:47Z
