...
- **competitive_miner_usd_day: 149.100599985142** (uid 135) <- the only figure quotable as achievable
- median_miner_usd_day: 149.100599985142
- top_miner_usd_day: 1076.6980798927061 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.6651 USD/day  |  payback on registration: [UNKNOWN] days
