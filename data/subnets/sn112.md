...
- subnet age: 454.3 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 300.1991054424068** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 750.4863117442087
- top_miner_usd_day: 1200.7735180460106 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 291.9799 USD/day  |  payback on registration: 0.76 days
...
- components: income 22.44 / freshness 35.0 / resource 11.25 / registration 9.75
