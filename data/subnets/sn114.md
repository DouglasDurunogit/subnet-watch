...
- miner_burn: **0.0**
- registration cost: 0.25 TAO (60.3225 USD), open=True
...
- **competitive_miner_usd_day: 5128.360860073446** (uid 70) <- the only figure quotable as achievable
- median_miner_usd_day: 0.1204094963741975
- top_miner_usd_day: 5128.360860073446 (uid 70, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -8.0988 USD/day  |  payback on registration: [UNKNOWN] days
