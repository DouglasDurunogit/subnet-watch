...
- subnet age: 1042.5 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1523.5946756523142** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 11.91224884120746
- top_miner_usd_day: 1523.5946756523142 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.2193 USD/day  |  payback on registration: 81.31 days

## Score

- gate: **OK** 
- score: 32.2 (rank 59), confidence 0.85 - hardware requirement unknown
- components: income 5.69 / freshness 21.0 / resource 11.25 / registration 0.0
