...
- **competitive_miner_usd_day: 1386.57383222632** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 3.72009607679094
- top_miner_usd_day: 1386.57383222632 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.5808 USD/day  |  payback on registration: [UNKNOWN] days
