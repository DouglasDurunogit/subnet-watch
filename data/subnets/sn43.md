...
- registration cost: 0.1 TAO (18.791 USD), open=True
...
- **competitive_miner_usd_day: 60.156211000818715** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.3240577068756316
- top_miner_usd_day: 2414.604751768089 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.5372 USD/day  |  payback on registration: 34.98 days
