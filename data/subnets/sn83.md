...
- **competitive_miner_usd_day: 99.1902243844546** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 21.127329577144266
- top_miner_usd_day: 99.1902243844546 (uid 57, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8.9085 USD/day  |  payback on registration: 2.21 days

## Score

- gate: **OK** 
- score: 25.1 (rank 68), confidence 0.85 - hardware requirement unknown
- components: income 9.06 / freshness 0.0 / resource 11.25 / registration 9.26
