...
- **competitive_miner_usd_day: 4760.052010734867** (uid 87) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07265036646420736
- top_miner_usd_day: 4760.052010734867 (uid 87, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -8.1465 USD/day  |  payback on registration: [UNKNOWN] days
