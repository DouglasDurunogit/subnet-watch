...
- miner_burn: **0.21265463531017303**
- registration cost: 0.05 TAO (12.707500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 19  |  free: 83
- subnet age: 254.8 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 68.9888478727065** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 132.0362349296041
- top_miner_usd_day: 665.9189282358587 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 11  |  gini: 0.5402161397278138  |  top1_share: 0.29931329162215775  |  top10_share: 0.9910270105295284
- owner_incentive_share: 0.2126659545246452 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 7782 bytes, sha 32e8078b62e65818
- latest release: (none) 
- last commit: 2026-08-27T17:17:43Z
- scoring-related commit: fix(validator): a rate-limited mirror cycle killed the scheduler and … 2026-08-27T17:17:43Z
...
- net margin: 18.4325 USD/day  |  payback on registration: 0.69 days

## Score

- gate: **OK** 
- score: 57.6 (rank 23), confidence 0.85 - hardware requirement unknown
- components: income 11.72 / freshness 35.0 / resource 11.25 / registration 9.77
...
**Local mode requires those GPUs.** Every eligible model 
```

_(truncated at 6000 of 7782 chars - read the full file at https://github.com/BitSpaceorganization/prometheon_v2)_
