...
- subnet age: 625.1 days  |  registered at block 4531295
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 8842.510725114396** (uid 177) <- the only figure quotable as achievable
- median_miner_usd_day: 3349.0050851134815
- top_miner_usd_day: 8842.510725114396 (uid 177, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.39418513261911303  |  top1_share: 0.1566248512041022  |  top10_share: 0.8825962213472514
...
- net margin: 3319.416 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 38.9 (rank 58), confidence 0.85 - hardware from README keywords, not curated
- components: income 32.03 / freshness 0.0 / resource 3.75 / registration 10.0
