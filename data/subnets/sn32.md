...
- miner_burn: **0.0**
- registration cost: 0.001560683 TAO (0.34406817418 USD), open=True
...
- **competitive_miner_usd_day: 10.69629068390075** (uid 96) <- the only figure quotable as achievable
- median_miner_usd_day: 8.261112113214413
- top_miner_usd_day: 10.69629068390075 (uid 96, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.0814 USD/day  |  payback on registration: [UNKNOWN] days
