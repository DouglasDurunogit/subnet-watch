...
- subnet age: 789.7 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 79.26142824825595** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 38.57422267506567
- top_miner_usd_day: 79.26142824825595 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 91  |  gini: 0.33288766509105483  |  top1_share: 0.024629714460222933  |  top10_share: 0.21119254848068408
...
- net margin: 37.5879 USD/day  |  payback on registration: 0.58 days

## Score

- gate: **OK** 
- score: 49.7 (rank 29), confidence 1.0 
- components: income 14.43 / freshness 10.5 / resource 15.0 / registration 9.81
