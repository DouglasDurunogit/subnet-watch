...
- subnet age: 171.9 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 203.55295715953804** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 129.08351886918442
- top_miner_usd_day: 508.9179335152739 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.5058294800775229  |  top1_share: 0.3277785407987303  |  top10_share: 1.0
...
- net margin: 67.228 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.7 (rank 2), confidence 1.0 
- components: income 16.68 / freshness 35.0 / resource 15.0 / registration 10.0
