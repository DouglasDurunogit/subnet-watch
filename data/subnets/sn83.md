...
- miner_burn: **0.0**
- registration cost: 0.10826881 TAO (24.4655029957 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 250  |  free: 0
- subnet age: 521.7 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 293.68163785348725** (uid 166) <- the only figure quotable as achievable
- median_miner_usd_day: 20.519241072732733
- top_miner_usd_day: 293.68163785348725 (uid 166, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 241  |  gini: 0.41285012910979213  |  top1_share: 0.04551431017612524  |  top10_share: 0.1756207191780822
...
- net margin: 12.3001 USD/day  |  payback on registration: 1.99 days

## Score

- gate: **OK** 
- score: 26.2 (rank 75), confidence 0.85 - hardware requirement unknown
- components: income 10.22 / freshness 0.0 / resource 11.25 / registration 9.34
