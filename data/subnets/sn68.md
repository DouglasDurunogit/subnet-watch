...
- miner_burn: **0.0**
- registration cost: 0.112883314 TAO (24.88625540444 USD), open=True
...
- **competitive_miner_usd_day: 8622.778551987873** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 8622.778551987873
- top_miner_usd_day: 8622.778551987873 (uid 42, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8614.5594 USD/day  |  payback on registration: 0.0 days
...
- components: income 35.79 / freshness 35.0 / resource 11.25 / registration 10.0
