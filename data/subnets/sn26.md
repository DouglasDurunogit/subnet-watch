...
- subnet age: 120.8 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1804.4022433863238** (uid 64) <- the only figure quotable as achievable
- median_miner_usd_day: 25.311349427106848
- top_miner_usd_day: 1804.4022433863238 (uid 64, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.3524 USD/day  |  payback on registration: 1.03 days

## Score

- gate: **OK** 
- score: 54.4 (rank 24), confidence 1.0 
- components: income 12.45 / freshness 21.0 / resource 11.25 / registration 9.66
