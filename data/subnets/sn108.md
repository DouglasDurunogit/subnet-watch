...
- registration cost: 0.05 TAO (11.535 USD), open=True
...
- **competitive_miner_usd_day: 412.815277746718** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 68.87653364340558
- top_miner_usd_day: 1476.1842701392065 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 58.6426 USD/day  |  payback on registration: 0.2 days
