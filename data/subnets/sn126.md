...
- subnet age: 218.0 days  |  registered at block 7525773
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3606.4487443296257
- top_miner_usd_day: 3606.4487443296257 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- on-chain URL: `https://github.com/attelierai/attelierai_subnet/`
- resolved URL: `https://github.com/attelierai/attelierai_subnet`
