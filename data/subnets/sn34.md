...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (115.685 USD), open=True
...
- **competitive_miner_usd_day: 334.8586750282913** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 10.857192535046988
- top_miner_usd_day: 3349.602627947011 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.0493 USD/day  |  payback on registration: [UNKNOWN] days
