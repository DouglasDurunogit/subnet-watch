...
- **competitive_miner_usd_day: 23.292832563605696** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.823208140901424
- top_miner_usd_day: 890.9810176208241 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.8369 USD/day  |  payback on registration: 4.06 days

## Score

- gate: **OK** 
- score: 65.6 (rank 14), confidence 1.0 
- components: income 6.97 / freshness 35.0 / resource 15.0 / registration 8.65
