...
- subnet age: 176.9 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 191.38118657126094** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 97.1859268962772
- top_miner_usd_day: 478.4422086323924 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.7642 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.6 (rank 2), confidence 1.0 
- components: income 14.65 / freshness 35.0 / resource 15.0 / registration 10.0
