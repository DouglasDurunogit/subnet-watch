...
- subnet age: 568.7 days  |  registered at block 4848444
- weights_version: 29  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6844.292365639555** (uid 209) <- the only figure quotable as achievable
- median_miner_usd_day: 6844.292365639555
- top_miner_usd_day: 6844.292365639555 (uid 209, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6836.0732 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 54.7 (rank 25), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 34.88 / freshness 35.0 / resource 11.25 / registration 10.0
