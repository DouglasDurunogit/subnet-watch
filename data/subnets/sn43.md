...
- registration cost: 0.1 TAO (21.776 USD), open=True
...
- **competitive_miner_usd_day: 26.235349117352666** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9933772966764602
- top_miner_usd_day: 2688.180849657442 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7825 USD/day  |  payback on registration: [UNKNOWN] days
