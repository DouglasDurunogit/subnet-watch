...
- subnet age: 513.0 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 81.24846511343237** (uid 9) <- the only figure quotable as achievable
- median_miner_usd_day: 28.08324255899641
- top_miner_usd_day: 81.24846511343237 (uid 9, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 247  |  gini: 0.38150164228430894  |  top1_share: 0.011588087812633768  |  top10_share: 0.10322265027823642
...
- net margin: 24.5803 USD/day  |  payback on registration: 0.94 days

## Score

- gate: **OK** 
- score: 28.7 (rank 62), confidence 0.85 - hardware requirement unknown
- components: income 12.81 / freshness 0.0 / resource 11.25 / registration 9.69
