...
- subnet age: 324.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 72.67510661478836** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 3635.6415548805653
- top_miner_usd_day: 7198.608003146342 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 64.4559 USD/day  |  payback on registration: 0.24 days
...
- components: income 16.52 / freshness 35.0 / resource 11.25 / registration 9.92
