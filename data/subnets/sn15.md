...
- miner_burn: **0.0**
- registration cost: 0.445131154 TAO (99.23308816122 USD), open=True
...
- **competitive_miner_usd_day: 40.04407359402176** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 23.08847486502156
- top_miner_usd_day: 21939.101725647204 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.1022 USD/day  |  payback on registration: 4.49 days

## Score

- gate: **OK** 
- score: 70.9 (rank 5), confidence 1.0 
- components: income 12.4 / freshness 35.0 / resource 15.0 / registration 8.5
