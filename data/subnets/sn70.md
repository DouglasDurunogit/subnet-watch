...
- miner_burn: **0.0**
- registration cost: 0.9 TAO (178.875 USD), open=True
...
- **competitive_miner_usd_day: 50.35245788439228** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 100.72874561160728
- top_miner_usd_day: 402.9983868963086 (uid 26, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 29.5988 USD/day  |  payback on registration: 6.04 days

## Score

- gate: **OK** 
- score: 19.6 (rank 69), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 13.51 / freshness 0.0 / resource 11.25 / registration 7.99
