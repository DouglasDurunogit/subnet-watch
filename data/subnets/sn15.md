...
- miner_burn: **0.0**
- registration cost: 0.804721488 TAO (196.754403816 USD), open=True
...
- **competitive_miner_usd_day: 26222.44784718436** (uid 129) <- the only figure quotable as achievable
- median_miner_usd_day: 28.543087342318962
- top_miner_usd_day: 26222.44784718436 (uid 129, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 81  |  gini: 0.936313804528728  |  top1_share: 0.9258088650695494  |  top10_share: 0.9404211137068083
...
- net margin: 27.5568 USD/day  |  payback on registration: 7.14 days

## Score

- gate: **OK** 
- score: 70.9 (rank 7), confidence 1.0 
- components: income 13.24 / freshness 35.0 / resource 15.0 / registration 7.62
