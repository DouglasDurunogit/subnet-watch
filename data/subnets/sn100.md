...
- subnet age: 282.7 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3171.6511969362405
- top_miner_usd_day: 3171.6511969362405 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-07-29T13:21:57Z
- scoring-related commit: fix(agent-challenge): allow PyPI index for agent dependency install 2026-07-29T13:14:35Z
