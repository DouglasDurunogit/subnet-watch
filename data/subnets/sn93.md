...
- miner_burn: **0.0**
- registration cost: 0.005 TAO (1.0543500000000001 USD), open=True
...
- **competitive_miner_usd_day: 222.8110399213364** (uid 153) <- the only figure quotable as achievable
- median_miner_usd_day: 191.14391388898258
- top_miner_usd_day: 5813.722972936793 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 151.2576 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 52.8 (rank 30), confidence 0.85 - hardware requirement unknown
- components: income 19.85 / freshness 21.0 / resource 11.25 / registration 10.0
