...
- miner_burn: **0.0**
- registration cost: 0.017991527 TAO (4.12401781894 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 239  |  free: 0
- subnet age: 899.1 days  |  registered at block 2515294
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 11.334257810896725** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 9.332195177632913
- top_miner_usd_day: 11.334257810896725 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 234  |  gini: 0.08880306393761717  |  top1_share: 0.005397508842072889  |  top10_share: 0.05309856989081962
...
- net margin: 0.7578 USD/day  |  payback on registration: 5.44 days

## Score

- gate: **OK** 
- score: 18.4 (rank 80), confidence 0.85 - hardware requirement unknown
- components: income 2.23 / freshness 0.0 / resource 11.25 / registration 8.19
