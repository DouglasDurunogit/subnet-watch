...
- registration cost: 0.999999999 TAO (205.17999979482002 USD), open=True
...
- **competitive_miner_usd_day: 1606.921049148477** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.196612426551104
- top_miner_usd_day: 1606.921049148477 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.0426 USD/day  |  payback on registration: [UNKNOWN] days
