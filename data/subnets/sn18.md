...
- registration cost: 0.999999999 TAO (190.67999980932 USD), open=True
...
- **competitive_miner_usd_day: 1603.2846791944066** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.025367430606937
- top_miner_usd_day: 1603.2846791944066 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.2705 USD/day  |  payback on registration: [UNKNOWN] days
