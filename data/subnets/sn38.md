...
- subnet age: 250.7 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 794.9333322777036** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 167.76392564513787
- top_miner_usd_day: 3537.5674537552677 (uid 131, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 89.6394 USD/day  |  payback on registration: 1.89 days

## Score

- gate: **OK** 
- score: 65.6 (rank 10), confidence 0.85 - hardware from README keywords, not curated
