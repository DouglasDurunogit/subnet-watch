...
- miner_burn: **0.0**
- registration cost: 0.348640533 TAO (68.91228775277999 USD), open=True
...
- **competitive_miner_usd_day: 21.122875818675645** (uid 183) <- the only figure quotable as achievable
- median_miner_usd_day: 11.943308289998843
- top_miner_usd_day: 11959.890734566778 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.8583 USD/day  |  payback on registration: 6.35 days

## Score

- gate: **OK** 
- score: 67.7 (rank 13), confidence 1.0 
- components: income 9.77 / freshness 35.0 / resource 15.0 / registration 7.88
