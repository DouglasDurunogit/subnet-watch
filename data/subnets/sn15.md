...
- miner_burn: **0.0**
- registration cost: 0.303986398 TAO (60.037313605 USD), open=True
...
- **competitive_miner_usd_day: 22.073120152186338** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 13.84775934075841
- top_miner_usd_day: 12875.500869149373 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.7573 USD/day  |  payback on registration: 4.71 days

## Score

- gate: **OK** 
- score: 68.8 (rank 9), confidence 1.0 
- components: income 10.36 / freshness 35.0 / resource 15.0 / registration 8.43
