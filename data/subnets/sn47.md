...
- tempo: 360.0  |  max_uids: 256  |  active: 14  |  free: 140
- subnet age: 223.3 days  |  registered at block 7340355
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2418.8797513560826
- top_miner_usd_day: 2418.8797513560826 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 7496 bytes, sha 5d85d890cd470191
- latest release: (none) 
- last commit: 2026-08-28T18:14:35Z
- scoring-related commit: revise incentive 2026-08-28T17:03:23Z
...
- Validators independently read finalized chain state, derive the evaluation
  pool from pinned public dataset revisions, audit miners,
```

_(truncated at 6000 of 7496 chars - read the full file at https://github.com/center196/feval)_
