...
- miner_burn: **0.4507764356676489**
- registration cost: 0.1 TAO (19.192 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 135  |  free: 0
- subnet age: 773.4 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.752659085703186** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.159515860446974
- top_miner_usd_day: 846.3174792254143 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.1732 USD/day  |  payback on registration: 3.71 days

## Score

- gate: **OK** 
- score: 31.0 (rank 34), confidence 1.0 
- components: income 7.19 / freshness 0.0 / resource 15.0 / registration 8.76
