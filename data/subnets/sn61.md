...
- miner_burn: **0.0**
- registration cost: 0.00057103 TAO (0.1292297993 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 97  |  free: 0
- subnet age: 618.0 days  |  registered at block 4457976
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 315.13016599046625** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 22.75653687568452
- top_miner_usd_day: 315.13016599046625 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 14.5374 USD/day  |  payback on registration: 0.01 days
