...
- **competitive_miner_usd_day: 302.68925800313593** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 29.93353604075333
- top_miner_usd_day: 2214.159345176956 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 21.2113 USD/day  |  payback on registration: 1.06 days

## Score

- gate: **OK** 
- score: 68.1 (rank 9), confidence 1.0 
- components: income 12.25 / freshness 35.0 / resource 11.25 / registration 9.65
