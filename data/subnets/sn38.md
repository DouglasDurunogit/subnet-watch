...
- miner_burn: **0.0**
- registration cost: 0.755887283 TAO (201.23231248026002 USD), open=True
- tempo: 1440.0  |  max_uids: 256  |  active: 17  |  free: 0
- subnet age: 254.0 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 946.970457178718** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 199.8500690756965
- top_miner_usd_day: 4214.154486873237 (uid 131, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-09-14T12:58:13Z
- scoring-related commit: Update validator image to the latest version in docker-compose.valida… 2026-09-14T12:58:13Z
...
- net margin: 106.9723 USD/day  |  payback on registration: 1.88 days

## Score

- gate: **OK** 
- score: 66.2 (rank 10), confidence 0.85 - hardware from README keywords, not curated
- components: income 18.49 / freshness 35.0 / resource 15.0 / registration 9.37
