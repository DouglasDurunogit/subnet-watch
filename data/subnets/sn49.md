...
- subnet age: 279.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 41.51943120971434** (uid 59) <- the only figure quotable as achievable
- median_miner_usd_day: 41.51943120971434
- top_miner_usd_day: 4070.9960772236404 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.3003 USD/day  |  payback on registration: 0.0 days
...
- components: income 13.96 / freshness 21.0 / resource 11.25 / registration 10.0
