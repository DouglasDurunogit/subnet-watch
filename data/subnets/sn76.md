...
- registration cost: 0.002209252 TAO (0.41361615944 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 74
- subnet age: 159.1 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1898.279714016243
- top_miner_usd_day: 1898.279714016243 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-07-28T08:08:04Z
- scoring-related commit: Read served ground truth so findings are scored, not just verdicts 2026-07-28T08:08:04Z
