...
- miner_burn: **0.70753563195467**
- registration cost: 0.009149581 TAO (1.7767571343900002 USD), open=True
...
- **competitive_miner_usd_day: 9.247047521056746** (uid 137) <- the only figure quotable as achievable
- median_miner_usd_day: 4.905445941048395
- top_miner_usd_day: 2614.4335332704827 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 228  |  gini: 0.7557537914851509  |  top1_share: 0.7090233496949402  |  top10_share: 0.7312262030368366
- owner_incentive_share: 0.7090233496949402 (independent check on miner_burn; disagreement 0.0015)
...
- net margin: -3.3137 USD/day  |  payback on registration: [UNKNOWN] days
