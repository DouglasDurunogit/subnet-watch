...
- **competitive_miner_usd_day: 24.332517394419323** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.331625320278532
- top_miner_usd_day: 2231.4099640847303 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.2981 USD/day  |  payback on registration: 1.87 days

## Score

- gate: **OK** 
- score: 55.3 (rank 22), confidence 1.0 
- components: income 9.91 / freshness 21.0 / resource 15.0 / registration 9.38
