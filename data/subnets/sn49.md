...
- miner_burn: **0.0**
- registration cost: 0.000530523 TAO (0.10515496383 USD), open=True
...
- **competitive_miner_usd_day: 43.10950486685628** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 43.10950486685628
- top_miner_usd_day: 4226.90340620475 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.8903 USD/day  |  payback on registration: 0.0 days
