...
- subnet age: 78.9 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 126.59557664111027** (uid 6) <- the only figure quotable as achievable
- median_miner_usd_day: 126.59557664111027
- top_miner_usd_day: 3154.2260760392232 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-25T05:37:51Z
- scoring-related commit: Correct the validator setup path end to end 2026-08-24T20:51:06Z
...
- net margin: 77.8517 USD/day  |  payback on registration: 0.31 days

## Score

- gate: **OK** 
- score: 65.6 (rank 15), confidence 0.85 - income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 17.25 / freshness 35.0 / resource 15.0 / registration 9.9
