...
- subnet age: 615.7 days  |  registered at block 4474225
- weights_version: 6  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1226.0476609507307** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 939.6431163205868
- top_miner_usd_day: 3006.716246265649 (uid 107, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.35185354737634533  |  top1_share: 0.3884819630104377  |  top10_share: 1.0
...
- net margin: 906.6809 USD/day  |  payback on registration: 0.0 days
...
- components: income 26.9 / freshness 35.0 / resource 11.25 / registration 10.0
