...
- registration cost: 0.5 TAO (97.78 USD), open=True
...
- **competitive_miner_usd_day: 9.4393198479673** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 8.825380345660484
- top_miner_usd_day: 2395.668680438985 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.6062 USD/day  |  payback on registration: 161.3 days

## Score

- gate: **OK** 
- score: 40.9 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 1.87 / freshness 35.0 / resource 11.25 / registration 0.0
