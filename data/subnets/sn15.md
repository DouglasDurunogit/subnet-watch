...
- miner_burn: **0.0**
- registration cost: 0.279884688 TAO (55.08690429216 USD), open=True
...
- **competitive_miner_usd_day: 21.79231326916397** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 13.56879882797002
- top_miner_usd_day: 12711.08627175349 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.4797 USD/day  |  payback on registration: 4.41 days

## Score

- gate: **OK** 
- score: 68.8 (rank 10), confidence 1.0 
- components: income 10.27 / freshness 35.0 / resource 15.0 / registration 8.53
