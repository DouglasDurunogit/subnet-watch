...
- miner_burn: **0.9881743281148374**
- registration cost: 0.5 TAO (112.235 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 34  |  free: 0
- subnet age: 492.3 days  |  registered at block 5528520
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2.2597253012120677** (uid 8) <- the only figure quotable as achievable
- median_miner_usd_day: 1.9120752548717495
- top_miner_usd_day: 2814.2271251248753 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 21  |  gini: 0.9425565531606248  |  top1_share: 0.9883703183663501  |  top10_share: 0.9950703580476785
- owner_incentive_share: 0.9883703183663503 (independent check on miner_burn; disagreement 0.0002)
...
- latest release: (none) 
- last commit: 2026-09-15T05:08:06Z
- scoring-related commit: fix: burn the full allocation when no miner has earned a score 2026-09-10T11:48:51Z
...
- net margin: 0.9258 USD/day  |  payback on registration: 121.23 days

## Score

- gate: **OK** 
- score: 52.6 (rank 30), confidence 1.0 
- components: income 2.59 / freshness 35.0 / resource 15.0 / registration 0.0
