...
- **competitive_miner_usd_day: 375.0847367025874** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.016891332871532
- top_miner_usd_day: 750.3250585788526 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.165 USD/day  |  payback on registration: 127.24 days

## Score

- gate: **OK** 
- score: 50.6 (rank 31), confidence 1.0 
