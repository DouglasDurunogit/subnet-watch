...
- miner_burn: **0.0**
- registration cost: 0.347455925 TAO (68.073564826 USD), open=True
...
- **competitive_miner_usd_day: 12589.499091396505** (uid 41) <- the only figure quotable as achievable
- median_miner_usd_day: 13.417306227105179
- top_miner_usd_day: 12589.499091396505 (uid 41, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 12.431 USD/day  |  payback on registration: 5.48 days

## Score

- gate: **OK** 
- score: 68.4 (rank 11), confidence 1.0 
- components: income 10.26 / freshness 35.0 / resource 15.0 / registration 8.17
