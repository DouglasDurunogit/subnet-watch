...
- subnet age: 456.1 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 419.07098833896845** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 1047.6614843139528
- top_miner_usd_day: 1676.2519802889371 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 410.8518 USD/day  |  payback on registration: 0.58 days
...
- components: income 23.78 / freshness 35.0 / resource 11.25 / registration 9.81
