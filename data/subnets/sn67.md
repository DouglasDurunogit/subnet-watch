...
- miner_burn: **0.6368892132304609**
- registration cost: 0.022476724 TAO (4.21865632756 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 65  |  free: 0
- subnet age: 205.8 days  |  registered at block 7236936
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 909.1603043413578** (uid 232) <- the only figure quotable as achievable
- median_miner_usd_day: 9.933277720493566
- top_miner_usd_day: 3164.8484389157284 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 60  |  gini: 0.8362719659737274  |  top1_share: 0.6370463078848561  |  top10_share: 0.8680362648432491
- owner_incentive_share: 0.6370463078848561 (independent check on miner_burn; disagreement 0.0002)
...
- status: **ok** 
- README: 7501 bytes, sha 57ed3fbc882e85a6
- latest release: (none) 
- last commit: 2026-07-28T05:32:10Z
- scoring-related commit: chore(validator): bump repo-owned validator version to 20260728.post1 2026-07-28T05:32:10Z
...
- net margin: 900.9411 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 40.9 (rank 29), confidence 0.85 - hardware requirement unknown
...
`GET /v1/weights` still uses latest champion weights for champion emission. It also uses the latest terminal source batch with artifacts for participant emission. Failed terminal batches give each distinct participating miner hotkey fixed `0.004` compensation. Success
```

_(truncated at 6000 of 7501 chars - read the full file at https://github.com/harnyx/harnyx)_
