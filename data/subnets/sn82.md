...
- miner_burn: **0.0**
- registration cost: 0.000519564 TAO (0.13448394576 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 9  |  free: 0
- subnet age: 136.6 days  |  registered at block 8026517
- weights_version: 1778428951  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2707.224437673074** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2707.224437673074
- top_miner_usd_day: 2707.224437673074 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2699.0053 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 44.1 (rank 45), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 31.21 / freshness 21.0 / resource 11.25 / registration 10.0
