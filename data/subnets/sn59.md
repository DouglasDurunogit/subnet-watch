...
- **competitive_miner_usd_day: 1013.9084410204983** (uid 231) <- the only figure quotable as achievable
- median_miner_usd_day: 0.49800726245036503
- top_miner_usd_day: 1013.9084410204983 (uid 231, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -7.7212 USD/day  |  payback on registration: [UNKNOWN] days
