...
- registration cost: 0.8 TAO (158.984 USD), open=True
...
- **competitive_miner_usd_day: 37.5412814081679** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.071033230806794
- top_miner_usd_day: 37.5412814081679 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.8519 USD/day  |  payback on registration: 55.75 days

## Score

- gate: **OK** 
- score: 31.9 (rank 51), confidence 0.85 - hardware requirement unknown
- components: income 5.33 / freshness 21.0 / resource 11.25 / registration 0.0
