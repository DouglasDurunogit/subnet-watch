...
- miner_burn: **5.948822945356369e-07**
- registration cost: 0.8 TAO (162.68 USD), open=True
...
- **competitive_miner_usd_day: 36.11670948183872** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 8.907311172821576
- top_miner_usd_day: 36.11670948183872 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 238  |  gini: 0.3507037060352347  |  top1_share: 0.012459868521632778  |  top10_share: 0.10276716098455893
...
- net margin: 0.6881 USD/day  |  payback on registration: 236.42 days
