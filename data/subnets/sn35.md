...
- subnet age: 821.0 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1429.024133912626** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 812.3247193226414
- top_miner_usd_day: 1429.024133912626 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 804.1055 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 49.6 (rank 39), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 26.43 / freshness 35.0 / resource 11.25 / registration 9.99
