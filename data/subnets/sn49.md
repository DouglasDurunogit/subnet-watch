...
- subnet age: 304.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.6829090434588** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 2735.5647032473507
- top_miner_usd_day: 5416.446497451242 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 46.4637 USD/day  |  payback on registration: 0.24 days
...
- components: income 15.25 / freshness 10.5 / resource 11.25 / registration 9.92
