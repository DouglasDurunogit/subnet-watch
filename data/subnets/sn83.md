...
- miner_burn: **0.0**
- registration cost: 0.154675082 TAO (34.10894908264 USD), open=True
...
- **competitive_miner_usd_day: 112.64040386983574** (uid 65) <- the only figure quotable as achievable
- median_miner_usd_day: 21.27069952146665
- top_miner_usd_day: 112.64040386983574 (uid 65, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 14.8328 USD/day  |  payback on registration: 2.3 days

## Score

- gate: **OK** 
- score: 26.7 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 10.91 / freshness 0.0 / resource 11.25 / registration 9.23
