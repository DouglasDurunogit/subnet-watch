...
- registration cost: 0.066651085 TAO (12.863659405 USD), open=True
...
- **competitive_miner_usd_day: 426.8036935140066** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 20.97417493974683
- top_miner_usd_day: 426.8036935140066 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.9879 USD/day  |  payback on registration: 0.64 days

## Score

- gate: **OK** 
- score: 71.8 (rank 2), confidence 1.0 
- components: income 12.02 / freshness 35.0 / resource 15.0 / registration 9.79
