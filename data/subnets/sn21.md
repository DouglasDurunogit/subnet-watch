...
- miner_burn: **0.3010419176425785**
- registration cost: 0.1 TAO (22.631 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 798.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 962.6206159474667** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.005225011248857
- top_miner_usd_day: 962.6206159474667 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-23T04:37:38Z
...
- net margin: 0.1119 USD/day  |  payback on registration: 202.24 days

## Score

- gate: **OK** 
- score: 50.4 (rank 29), confidence 1.0 
- components: income 0.42 / freshness 35.0 / resource 15.0 / registration 0.0
