...
- subnet age: 430.2 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1369.9372498881114** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 920.8700994355177
- top_miner_usd_day: 1369.9372498881114 (uid 83, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1361.7181 USD/day  |  payback on registration: 0.14 days
...
- components: income 28.51 / freshness 0.0 / resource 11.25 / registration 9.95
