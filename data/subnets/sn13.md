...
- registration cost: 0.029288256 TAO (6.80541916416 USD), open=True
...
- **competitive_miner_usd_day: 7.518639314642851** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 5.496820339276705
- top_miner_usd_day: 2987.995718219241 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -2.7224 USD/day  |  payback on registration: [UNKNOWN] days
