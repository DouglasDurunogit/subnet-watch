...
- miner_burn: **0.0**
- registration cost: 0.43815169 TAO (101.7432039349 USD), open=True
...
- **competitive_miner_usd_day: 22735.39119405909** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 18.164771411497973
- top_miner_usd_day: 22735.39119405909 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.1785 USD/day  |  payback on registration: 5.92 days

## Score

- gate: **OK** 
- score: 69.5 (rank 8), confidence 1.0 
- components: income 11.46 / freshness 35.0 / resource 15.0 / registration 8.03
