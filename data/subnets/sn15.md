...
- miner_burn: **0.0**
- registration cost: 0.319597072 TAO (72.09151153104 USD), open=True
...
- **competitive_miner_usd_day: 23074.308574622184** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 20.36469353323631
- top_miner_usd_day: 23074.308574622184 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.3784 USD/day  |  payback on registration: 3.72 days

## Score

- gate: **OK** 
- score: 70.7 (rank 4), confidence 1.0 
- components: income 11.91 / freshness 35.0 / resource 15.0 / registration 8.76
