...
- subnet age: 725.8 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 26.05977132749184** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 281.1356732997863
- top_miner_usd_day: 900.9689233346265 (uid 206, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.4083436338018136  |  top1_share: 0.3460957409470327  |  top10_share: 1.0
...
- net margin: 17.8406 USD/day  |  payback on registration: 0.01 days
...
- components: income 11.6 / freshness 0.0 / resource 11.25 / registration 10.0
