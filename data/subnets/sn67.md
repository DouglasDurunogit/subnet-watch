...
- registration cost: 0.04838217 TAO (9.603860745 USD), open=True
...
- **competitive_miner_usd_day: 300.7581164420552** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 23.38029881856551
- top_miner_usd_day: 300.7581164420552 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.394 USD/day  |  payback on registration: 0.43 days

## Score

- gate: **OK** 
- score: 72.3 (rank 4), confidence 1.0 
- components: income 12.45 / freshness 35.0 / resource 15.0 / registration 9.86
