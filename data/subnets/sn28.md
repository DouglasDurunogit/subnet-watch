...
- **competitive_miner_usd_day: 426.99483721110033** (uid 41) <- the only figure quotable as achievable
- median_miner_usd_day: 20.048110787066374
- top_miner_usd_day: 8184.566422436314 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.8289 USD/day  |  payback on registration: 1.67 days

## Score

- gate: **OK** 
- score: 55.9 (rank 15), confidence 0.85 - hardware requirement unknown
- components: income 10.08 / freshness 35.0 / resource 11.25 / registration 9.44
