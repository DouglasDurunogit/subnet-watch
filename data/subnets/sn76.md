...
- subnet age: 178.1 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 178.40568105992145** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 101.55891790928406
- top_miner_usd_day: 382.6571019591614 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.5025331522485539  |  top1_share: 0.28331629305214323  |  top10_share: 1.0
...
- latest release: (none) 
- last commit: 2026-08-16T07:37:40Z
- scoring-related commit: Match CWEs numerically, draw tasks per validator, break ties determin… 2026-08-16T07:37:40Z
...
- net margin: 31.5991 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 73.8 (rank 2), confidence 1.0 
- components: income 13.76 / freshness 35.0 / resource 15.0 / registration 10.0
