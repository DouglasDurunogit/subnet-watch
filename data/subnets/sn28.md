...
- miner_burn: **0.0004388177767395973**
- registration cost: 0.1 TAO (25.923000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 81  |  free: 0
- subnet age: 576.7 days  |  registered at block 4878363
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4230.127365909741** (uid 91) <- the only figure quotable as achievable
- median_miner_usd_day: 18.14825734294706
- top_miner_usd_day: 4230.127365909741 (uid 91, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 70  |  gini: 0.8727162879564481  |  top1_share: 0.26512259916333325  |  top10_share: 0.8686524779382576
- owner_incentive_share: 0.00042749396928150476 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 22650 bytes, sha 14595460013ff397
- latest release: v0.4.16-dev 2026-09-09T14:02:08Z
- last commit: 2026-09-09T13:49:46Z
...
- net margin: 9.9291 USD/day  |  payback on registration: 2.61 days

## Score

- gate: **OK** 
- score: 55.1 (rank 25), confidence 0.85 - hardware requirement unknown
- components: income 9.45 / freshness 35.0 / resource 11.25 / registration 9.13
...
Each flag replaces the stored value; omi
```

_(truncated at 6000 of 22650 chars - read the full file at https://github.com/taostat/gm-miner)_
