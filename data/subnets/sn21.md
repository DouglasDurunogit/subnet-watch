...
- miner_burn: **0.15051749674603343**
- registration cost: 0.1 TAO (22.251 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 35  |  free: 0
- subnet age: 810.9 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 52.30773625519728** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 9.801005871707613
- top_miner_usd_day: 1046.1547251039456 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826554321119541  |  top1_share: 0.447143925404795  |  top10_share: 0.9986875639049552
...
- last commit: 2026-09-04T14:12:08Z
- scoring-related commit: fix(validator): reference loop uses bt.Wallet 2026-09-04T14:12:08Z
...
- net margin: 0.2098 USD/day  |  payback on registration: 106.06 days

## Score

- gate: **OK** 
- score: 50.8 (rank 33), confidence 1.0 
- components: income 0.75 / freshness 35.0 / resource 15.0 / registration 0.0
