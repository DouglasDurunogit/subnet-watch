...
- subnet age: 282.3 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3239.2140111397907
- top_miner_usd_day: 3239.2140111397907 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-07-29T06:57:07Z
- scoring-related commit: fix(agent-challenge): copy golden digest into docker build context 2026-07-29T06:48:23Z
