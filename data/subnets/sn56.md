...
- subnet age: 629.4 days  |  registered at block 4312927
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 964.3986512060583** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 586.953999861042
- top_miner_usd_day: 6465.583664374361 (uid 38, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 511.3819 USD/day  |  payback on registration: 0.0 days
