...
- registration cost: 0.1 TAO (18.775000000000002 USD), open=True
...
- **competitive_miner_usd_day: 59.460252974068275** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.2751574562908057
- top_miner_usd_day: 2419.28039369898 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 58.474 USD/day  |  payback on registration: 0.32 days

## Score

- gate: **OK** 
- score: 41.0 (rank 30), confidence 1.0 
- components: income 16.14 / freshness 0.0 / resource 15.0 / registration 9.89
