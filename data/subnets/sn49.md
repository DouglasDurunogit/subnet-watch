...
- **competitive_miner_usd_day: 66.7264183781067** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 66.7264183781067
- top_miner_usd_day: 6543.162024438802 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 58.2016 USD/day  |  payback on registration: 0.2 days
...
- components: income 16.12 / freshness 21.0 / resource 11.25 / registration 9.93
