...
- **competitive_miner_usd_day: 4599.510049867966** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 97.56782852822269
- top_miner_usd_day: 36104.97494686881 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 52.7607 USD/day  |  payback on registration: 2.14 days

## Score

- gate: **OK** 
- score: 60.6 (rank 18), confidence 0.85 - hardware requirement unknown
- components: income 15.74 / freshness 35.0 / resource 11.25 / registration 9.29
