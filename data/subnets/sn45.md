...
- miner_burn: **0.7792285659816116**
- registration cost: 0.000996859 TAO (0.18720015160999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 134  |  free: 0
- subnet age: 706.4 days  |  registered at block 3633154
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 15.658326488990264** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 2.412685129274309
- top_miner_usd_day: 1232.0617881152184 (uid 189, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 123  |  gini: 0.8749131722615144  |  top1_share: 0.779943183553777  |  top10_share: 0.8363930720591379
- owner_incentive_share: 0.7799431835537771 (independent check on miner_burn; disagreement 0.0007)
...
- latest release: (none) 
- last commit: 2026-07-24T18:32:55Z
...
- required: 24GB consumer (~8 GB VRAM)  |  basis: **README keywords (GUESS)**
- cheapest satisfying machine: rtx4090 at 8.2192 USD/day
- net margin: 7.4391 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 25.2 (rank 70), confidence 0.85 - hardware from README keywords, not curated
- components: income 8.42 / freshness 0.0 / resource 11.25 / registration 9.99
