...
- subnet age: 171.6 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 204.04615240348625** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 129.39627962916927
- top_miner_usd_day: 510.1510077376883 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 67.3933 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.7 (rank 2), confidence 1.0 
- components: income 16.69 / freshness 35.0 / resource 15.0 / registration 10.0
