...
- registration cost: 0.1 TAO (20.934 USD), open=True
...
- **competitive_miner_usd_day: 25.198781606277223** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.833422737950803
- top_miner_usd_day: 2584.934159054823 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7902 USD/day  |  payback on registration: [UNKNOWN] days
