...
- miner_burn: **0.00220703799277544**
- registration cost: 0.0005 TAO (0.11727 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 43  |  free: 0
- subnet age: 528.4 days  |  registered at block 5203057
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 250.56815097981462** (uid 190) <- the only figure quotable as achievable
- median_miner_usd_day: 132.561396503558
- top_miner_usd_day: 250.56815097981462 (uid 190, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 38  |  gini: 0.31402164455909487  |  top1_share: 0.05360768091829102  |  top10_share: 0.4421565185535695
...
- net margin: 124.3422 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 52.1 (rank 28), confidence 0.85 - hardware requirement unknown
- components: income 19.08 / freshness 21.0 / resource 11.25 / registration 10.0
