...
- miner_burn: **0.7983807804994285**
- registration cost: 0.1 TAO (19.615000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 23  |  free: 0
- subnet age: 748.6 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.253417034959101** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.0426413351370662
- top_miner_usd_day: 2485.4194719931734 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 17  |  gini: 0.8954186521687606  |  top1_share: 0.7985013124961846  |  top10_share: 0.9980770404737195
- owner_incentive_share: 0.7985013124961846 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.5813 USD/day  |  payback on registration: 33.74 days

## Score

- gate: **OK** 
- score: 16.8 (rank 65), confidence 1.0 
- components: income 1.81 / freshness 0.0 / resource 15.0 / registration 0.0
