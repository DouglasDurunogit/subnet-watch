...
- **competitive_miner_usd_day: 2519.632404571282** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 47.419328061616206
- top_miner_usd_day: 43859.03364661161 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.7729 USD/day  |  payback on registration: 3.01 days

## Score

- gate: **OK** 
- score: 59.3 (rank 25), confidence 0.85 - hardware requirement unknown
- components: income 14.55 / freshness 35.0 / resource 11.25 / registration 9.0
