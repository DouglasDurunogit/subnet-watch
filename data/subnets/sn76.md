...
- subnet age: 179.7 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 190.37641072381746** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 106.60885921009718
- top_miner_usd_day: 253.84165028255865 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.25684180006409174  |  top1_share: 0.20062260609482535  |  top10_share: 1.0
...
- net margin: 98.0056 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 78.2 (rank 1), confidence 1.0 
- components: income 18.15 / freshness 35.0 / resource 15.0 / registration 10.0
