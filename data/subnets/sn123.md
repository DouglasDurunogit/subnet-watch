...
- **competitive_miner_usd_day: 84.70223676978044** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.1382486480970635
- top_miner_usd_day: 623.517904169293 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.1844 USD/day  |  payback on registration: [UNKNOWN] days
