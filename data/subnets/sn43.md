...
- miner_burn: **0.7963921381160617**
- registration cost: 0.1 TAO (20.223 USD), open=True
...
- **competitive_miner_usd_day: 36.278103860214415** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 16.00080607344556
- top_miner_usd_day: 2507.8020113489406 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 11  |  gini: 0.8364918258398906  |  top1_share: 0.7964686851422292  |  top10_share: 0.9999694786961298
- owner_incentive_share: 0.7964686851422292 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 3.2421 USD/day  |  payback on registration: 6.24 days

## Score

- gate: **OK** 
- score: 28.6 (rank 57), confidence 1.0 
- components: income 5.71 / freshness 0.0 / resource 15.0 / registration 7.92
