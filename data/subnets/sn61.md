...
- miner_burn: **0.0**
- registration cost: 0.001289694 TAO (0.25372150062 USD), open=True
...
- **competitive_miner_usd_day: 754.8920919661247** (uid 75) <- the only figure quotable as achievable
- median_miner_usd_day: 24.896208413264585
- top_miner_usd_day: 754.8920919661247 (uid 75, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.677 USD/day  |  payback on registration: 0.02 days
