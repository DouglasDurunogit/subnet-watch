...
- miner_burn: **0.0**
- registration cost: 0.038145052 TAO (7.16402221612 USD), open=True
...
- **competitive_miner_usd_day: 36.027983826110436** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 19.36864410491697
- top_miner_usd_day: 36.027983826110436 (uid 88, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.1495 USD/day  |  payback on registration: 0.64 days

## Score

- gate: **OK** 
- score: 26.3 (rank 41), confidence 0.85 - hardware requirement unknown
- components: income 9.86 / freshness 0.0 / resource 11.25 / registration 9.79
