...
- **competitive_miner_usd_day: 75.67183551595164** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 52.02438691721675
- top_miner_usd_day: 1589.4550285983357 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.6065 USD/day  |  payback on registration: 0.49 days

## Score

- gate: **OK** 
- score: 70.7 (rank 3), confidence 1.0 
- components: income 14.63 / freshness 35.0 / resource 11.25 / registration 9.84
