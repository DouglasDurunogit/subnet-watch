...
- **competitive_miner_usd_day: 960.0093753490908** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 694.0162154232261
- top_miner_usd_day: 960.0093753490908 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.27470511040239276  |  top1_share: 0.38157874658568963  |  top10_share: 1.0
...
- net margin: 256.7559 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 27.1 (rank 63), confidence 0.85 - hardware from README keywords, not curated
- components: income 21.93 / freshness 0.0 / resource 0.0 / registration 10.0
