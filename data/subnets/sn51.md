...
- subnet age: 664.2 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6908.651103285902** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 24.5900171708711
- top_miner_usd_day: 14462.36126165884 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 41  |  gini: 0.8564574170331867  |  top1_share: 0.3860243612052386  |  top10_share: 0.9463931373446898
...
- net margin: 15.799 USD/day  |  payback on registration: 6.18 days

## Score

- gate: **OK** 
- score: 55.5 (rank 17), confidence 0.85 - hardware requirement unknown
- components: income 11.14 / freshness 35.0 / resource 11.25 / registration 7.94
