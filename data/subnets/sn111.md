...
- subnet age: 441.1 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2795.8086967691866
- top_miner_usd_day: 2795.8086967691866 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 10851 bytes, sha 133a78ba2a4d255e
- latest release: (none) 
- last commit: 2026-08-06T17:12:01Z
- scoring-related commit: Update validator artifact hydration and batch post-pass 2026-08-06T17:12:01Z
...
For batch tasks, miners return
```

_(truncated at 6000 of 10851 chars - read the full file at https://github.com/DeSciClaims/Claims)_
