...
- **competitive_miner_usd_day: 527.6311471252002** (uid 68) <- the only figure quotable as achievable
- median_miner_usd_day: 0.6153132911081051
- top_miner_usd_day: 19110.707851881085 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.6039 USD/day  |  payback on registration: [UNKNOWN] days
