...
- miner_burn: **0.663910592906177**
- registration cost: 0.05 TAO (9.511000000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 46  |  free: 0
- subnet age: 480.0 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 173.33649880835992** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 0.03202817790250553
- top_miner_usd_day: 1393.5139923601128 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 39  |  gini: 0.8905739499576779  |  top1_share: 0.6640263724188452  |  top10_share: 0.9468125696320376
- owner_incentive_share: 0.6640263724188452 (independent check on miner_burn; disagreement 0.0001)
...
- status: **ok** 
- README: 13842 bytes, sha 3e6bc003030b1630
- latest release: (none) 
- last commit: 2026-08-04T03:10:03Z
- scoring-related commit: closers feed: per-key display-label overrides (SN89_CLOSERS_MINER_LAB… 2026-08-03T19:58:12Z
...
- net margin: -8.1871 USD/day  |  payback on registration: [UNKNOWN] days
...
_(truncated at 6000 of 13842 chars - read the full file at https://github.com/DeltaCompute24/InfiniteQuant-Subnet)_
