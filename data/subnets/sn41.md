...
- **competitive_miner_usd_day: 24.511534904871983** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 10.877306900526012
- top_miner_usd_day: 2431.253532701443 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.7908 USD/day  |  payback on registration: 2.29 days

## Score

- gate: **OK** 
- score: 54.6 (rank 25), confidence 1.0 
- components: income 9.4 / freshness 21.0 / resource 15.0 / registration 9.24
