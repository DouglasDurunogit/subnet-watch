...
- miner_burn: **0.0**
- registration cost: 0.005 TAO (1.01915 USD), open=True
...
- **competitive_miner_usd_day: 43.135016553722515** (uid 153) <- the only figure quotable as achievable
- median_miner_usd_day: 43.135016553722515
- top_miner_usd_day: 3090.511180469211 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.6529638559119437  |  top1_share: 0.9828638569292276  |  top10_share: 1.0
...
- net margin: 18.7222 USD/day  |  payback on registration: 0.05 days
...
- components: income 11.78 / freshness 21.0 / resource 11.25 / registration 9.98
