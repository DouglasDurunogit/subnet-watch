...
- miner_burn: **0.0**
- registration cost: 0.267036588 TAO (50.178845251080006 USD), open=True
...
- **competitive_miner_usd_day: 10671.960851895064** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 10.72717944774081
- top_miner_usd_day: 10671.960851895064 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.7409 USD/day  |  payback on registration: 5.15 days

## Score

- gate: **OK** 
- score: 32.7 (rank 22), confidence 1.0 
- components: income 9.38 / freshness 0.0 / resource 15.0 / registration 8.28
