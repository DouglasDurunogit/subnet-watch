...
- subnet age: 480.9 days  |  registered at block 5258781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 506.2911018748957** (uid 66) <- the only figure quotable as achievable
- median_miner_usd_day: 308.3109607092885
- top_miner_usd_day: 506.57730374141624 (uid 112, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.31084100169390627  |  top1_share: 0.16206565032275785  |  top10_share: 1.0
...
- net margin: 483.1179 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 68.6 (rank 2), confidence 0.85 - hardware requirement unknown
