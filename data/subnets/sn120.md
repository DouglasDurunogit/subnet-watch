...
- miner_burn: **0.0**
- registration cost: 0.820261518 TAO (158.56475404458 USD), open=True
...
- **competitive_miner_usd_day: 6348.097606329948** (uid 96) <- the only figure quotable as achievable
- median_miner_usd_day: 6348.097606329948
- top_miner_usd_day: 6348.097606329948 (uid 58, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 6339.8784 USD/day  |  payback on registration: 0.03 days
