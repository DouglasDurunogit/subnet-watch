...
- miner_burn: **0.0**
- registration cost: 0.000855631 TAO (0.16855930700000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 18  |  free: 0
- subnet age: 292.6 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1984.8196979528714** (uid 102) <- the only figure quotable as achievable
- median_miner_usd_day: 330.78645678243055
- top_miner_usd_day: 1984.8196979528714 (uid 102, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.4000122077763537  |  top1_share: 0.6000122077763534  |  top10_share: 1.0
...
- latest release: v3.3.11: Site arena UID + sealed weight enrichment 2026-08-08T12:22:39Z
- last commit: 2026-08-08T12:24:53Z
- scoring-related commit: fix(prism): keep challenge-agentic under loc-cap after TokenMix scree… 2026-08-08T11:56:16Z
...
- net margin: 322.5673 USD/day  |  payback on registration: 0.0 days
