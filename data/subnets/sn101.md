...
- registration cost: 0.001129895 TAO (0.26314124655 USD), open=True
...
- **competitive_miner_usd_day: 2.359205665705094** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1073822512493299
- top_miner_usd_day: 2843.4205918274642 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1211 USD/day  |  payback on registration: 2.17 days

## Score

- gate: **OK** 
- score: 45.7 (rank 39), confidence 1.0 
- components: income 0.45 / freshness 21.0 / resource 15.0 / registration 9.28
