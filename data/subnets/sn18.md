...
- registration cost: 0.999999999 TAO (217.75999978224 USD), open=True
...
- **competitive_miner_usd_day: 1153.5048367609877** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.21954556941007
- top_miner_usd_day: 1153.5048367609877 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.0645 USD/day  |  payback on registration: [UNKNOWN] days
