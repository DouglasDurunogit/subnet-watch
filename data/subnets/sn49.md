...
- subnet age: 278.6 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 40.447414867508385** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 2023.4205236086223
- top_miner_usd_day: 4006.3936323497364 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 32.2282 USD/day  |  payback on registration: 0.0 days
...
- components: income 13.84 / freshness 21.0 / resource 11.25 / registration 10.0
