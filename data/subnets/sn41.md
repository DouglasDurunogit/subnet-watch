...
- **competitive_miner_usd_day: 28.24999945964085** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.117971007596994
- top_miner_usd_day: 2290.7830108937032 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 76  |  gini: 0.8784826412383295  |  top1_share: 0.8146853146853147  |  top10_share: 0.8759275658838978
- owner_incentive_share: 0.8146853146853147 (independent check on miner_burn; disagreement 0.0005)
...
- net margin: 5.0673 USD/day  |  payback on registration: 3.78 days

## Score

- gate: **OK** 
- score: 65.9 (rank 9), confidence 1.0 
- components: income 7.12 / freshness 35.0 / resource 15.0 / registration 8.74
