...
- miner_burn: **0.05825891438871622**
- registration cost: 0.066129589 TAO (15.389016656190002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 137  |  free: 0
- subnet age: 234.7 days  |  registered at block 7236936
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 254.29817833919688** (uid 101) <- the only figure quotable as achievable
- median_miner_usd_day: 15.66434851688664
- top_miner_usd_day: 254.29817833919688 (uid 101, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 130  |  gini: 0.49871749826379275  |  top1_share: 0.06671147706267853  |  top10_share: 0.31230809184094344
- owner_incentive_share: 0.058309527810452025 (independent check on miner_burn; disagreement 0.0001)
...
- status: **ok** 
- README: 9200 bytes, sha e7a4f1a55b35aa3d
- latest release: (none) 
- last commit: 2026-08-24T13:59:31Z
- scoring-related commit: chore(validator): bump repo-owned validator version to 20260824.post4 2026-08-24T11:27:42Z
...
- net margin: 14.678 USD/day  |  payback on registration: 1.05 days

## Score

- gate: **OK** 
- score: 70.5 (rank 8), confidence 1.0 
- components: income 10.87 / freshness 35.0 / resource 15.0 / registration 9.65
...
Data versions 1 through 7 retain their historical 20% relative score, cost, and runtime thresh
```

_(truncated at 6000 of 9200 chars - read the full file at https://github.com/harnyx/harnyx)_
