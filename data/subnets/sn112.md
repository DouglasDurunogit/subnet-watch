...
- subnet age: 458.9 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 496.33042004093073** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 1240.8071163104585
- top_miner_usd_day: 1985.2838125799863 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-27T09:19:56Z
- scoring-related commit: fix(sandbox): scoring JS had no RPC for chain 964, and the wrong one … 2026-08-27T08:40:42Z
...
- net margin: 488.1112 USD/day  |  payback on registration: 0.52 days

## Score

- gate: **OK** 
- score: 48.3 (rank 38), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 24.46 / freshness 35.0 / resource 11.25 / registration 9.83
