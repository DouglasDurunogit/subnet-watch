...
- **competitive_miner_usd_day: 80.56458049222145** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.250541030094745
- top_miner_usd_day: 645.9531594888961 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.0285 USD/day  |  payback on registration: [UNKNOWN] days
