...
- **competitive_miner_usd_day: 382.75394841275954** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.160362980510808
- top_miner_usd_day: 765.6666631887233 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.3952 USD/day  |  payback on registration: 14.73 days

## Score

- gate: **OK** 
- score: 58.5 (rank 18), confidence 1.0 
- components: income 3.45 / freshness 35.0 / resource 15.0 / registration 5.09
