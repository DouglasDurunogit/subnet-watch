...
- miner_burn: **0.0**
- registration cost: 0.066114853 TAO (15.931034978880001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 81  |  free: 0
- subnet age: 500.4 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 113.94487849748815** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 7.269480378919866
- top_miner_usd_day: 113.94487849748815 (uid 218, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 74  |  gini: 0.6786189946532009  |  top1_share: 0.06690081698098801  |  top10_share: 0.5219210506222799
...
- latest release: (none) 
- last commit: 2026-08-24T13:22:26Z
- scoring-related commit: HF scoreboard: pick the tick dir by newest window, not by list order 2026-08-24T13:22:26Z
...
- net margin: -0.9497 USD/day  |  payback on registration: [UNKNOWN] days
