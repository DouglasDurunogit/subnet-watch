...
- subnet age: 718.7 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2172.4564209467244** (uid 9) <- the only figure quotable as achievable
- median_miner_usd_day: 61.19595551962605
- top_miner_usd_day: 58266.78757177317 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 73  |  gini: 0.919171179538024  |  top1_share: 0.7560085509238051  |  top10_share: 0.9062452282791266
...
- net margin: 48.2694 USD/day  |  payback on registration: 3.06 days

## Score

- gate: **OK** 
- score: 60.0 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 15.39 / freshness 35.0 / resource 11.25 / registration 8.98
