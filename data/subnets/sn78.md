...
- subnet age: 125.2 days  |  registered at block 7966145
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1220.269706038447** (uid 98) <- the only figure quotable as achievable
- median_miner_usd_day: 1220.269706038447
- top_miner_usd_day: 1220.269706038447 (uid 98, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1212.0505 USD/day  |  payback on registration: 0.0 days
...
- components: income 28.05 / freshness 0.0 / resource 11.25 / registration 10.0
