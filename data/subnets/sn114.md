...
- **competitive_miner_usd_day: 603.5519697974983** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 0.09213127305716656
- top_miner_usd_day: 3922.857475501096 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.127 USD/day  |  payback on registration: [UNKNOWN] days
