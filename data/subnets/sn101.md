...
- registration cost: 0.001589261 TAO (0.32155517813 USD), open=True
...
- **competitive_miner_usd_day: 1.896633365381924** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1207378977256823
- top_miner_usd_day: 2550.0235597559968 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1344 USD/day  |  payback on registration: 2.39 days

## Score

- gate: **OK** 
- score: 45.7 (rank 31), confidence 1.0 
- components: income 0.5 / freshness 21.0 / resource 15.0 / registration 9.2
