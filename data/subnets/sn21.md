...
- **competitive_miner_usd_day: 23.040450557952** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.760112639488
- top_miner_usd_day: 881.327078984874 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.7738 USD/day  |  payback on registration: 4.14 days

## Score

- gate: **OK** 
- score: 65.5 (rank 13), confidence 1.0 
- components: income 6.93 / freshness 35.0 / resource 15.0 / registration 8.62
