...
- miner_burn: **0.0**
- registration cost: 0.000548411 TAO (0.13308289736999998 USD), open=True
...
- **competitive_miner_usd_day: 333.8168962304275** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 47.01202035759329
- top_miner_usd_day: 12925.150429186639 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.4773 USD/day  |  payback on registration: 0.0 days
