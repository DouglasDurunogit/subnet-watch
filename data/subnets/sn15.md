...
- miner_burn: **0.0**
- registration cost: 0.310474187 TAO (63.647208335 USD), open=True
...
- **competitive_miner_usd_day: 21.4977224094758** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 11.241928232478172
- top_miner_usd_day: 12022.35472398547 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.157 USD/day  |  payback on registration: 6.27 days

## Score

- gate: **OK** 
- score: 67.4 (rank 11), confidence 1.0 
- components: income 9.53 / freshness 35.0 / resource 15.0 / registration 7.91
