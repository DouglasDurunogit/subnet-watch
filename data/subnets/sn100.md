...
- miner_burn: **0.0**
- registration cost: 0.033939439 TAO (7.064494227850001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 6  |  free: 0
- subnet age: 304.6 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3336.9176275688205** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 3336.9176275688205
- top_miner_usd_day: 3336.9176275688205 (uid 88, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- latest release: v3.3.26: fix(validator): persist last sealed bundle across restarts 2026-08-20T09:24:56Z
- last commit: 2026-08-20T13:12:07Z
- scoring-related commit: Merge pull request #183 from BaseIntelligence/fix/validator-public-we… 2026-08-20T09:41:45Z
...
- net margin: 3328.6984 USD/day  |  payback on registration: 0.0 days
