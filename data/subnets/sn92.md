...
- subnet age: 88.3 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 545.6791861481757** (uid 38) <- the only figure quotable as achievable
- median_miner_usd_day: 200.10304905248168
- top_miner_usd_day: 545.6791861481757 (uid 38, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 199.1167 USD/day  |  payback on registration: 0.11 days

## Score

- gate: **OK** 
- score: 80.9 (rank 1), confidence 1.0 
- components: income 20.93 / freshness 35.0 / resource 15.0 / registration 9.96
