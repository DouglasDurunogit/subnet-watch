...
- registration cost: 0.1 TAO (21.1 USD), open=True
...
- **competitive_miner_usd_day: 25.343662076022493** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8398484508623439
- top_miner_usd_day: 2605.358103125143 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7887 USD/day  |  payback on registration: [UNKNOWN] days
