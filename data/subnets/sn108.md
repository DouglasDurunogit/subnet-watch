...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (10.855 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 19  |  free: 80
- subnet age: 260.9 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 47.802441048193785** (uid 172) <- the only figure quotable as achievable
- median_miner_usd_day: 150.49653845698165
- top_miner_usd_day: 658.3936467240015 (uid 168, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.38279566610712634  |  top1_share: 0.3280940027468335  |  top10_share: 1.0
...
- latest release: (none) 
- last commit: 2026-09-01T13:01:55Z
- scoring-related commit: docs(scoring): the split section still described the two-to-one pool 2026-09-01T13:01:55Z
...
- net margin: 39.0474 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 42.4 (rank 42), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 14.58 / freshness 35.0 / resource 11.25 / registration 9.91
