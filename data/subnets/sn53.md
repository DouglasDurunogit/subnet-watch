...
- miner_burn: **0.0**
- registration cost: 0.000531771 TAO (0.1027381572 USD), open=True
...
- **competitive_miner_usd_day: 2389.844184453057** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 133.4008416759801
- top_miner_usd_day: 2389.844184453057 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 98.0023 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 63.2 (rank 11), confidence 0.85 - hardware from README keywords, not curated
