...
- **competitive_miner_usd_day: 1623.3341771752853** (uid 127) <- the only figure quotable as achievable
- median_miner_usd_day: 1082.2117756200805
- top_miner_usd_day: 1623.3341771752853 (uid 127, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1615.115 USD/day  |  payback on registration: 0.12 days
...
- components: income 29.18 / freshness 0.0 / resource 11.25 / registration 9.96
