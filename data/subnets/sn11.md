...
- miner_burn: **0.0**
- registration cost: 0.022192751 TAO (4.94698612541 USD), open=True
...
- **competitive_miner_usd_day: 4608.254816240385** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 4608.254816240385
- top_miner_usd_day: 4608.254816240385 (uid 53, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4607.2685 USD/day  |  payback on registration: 0.0 days
