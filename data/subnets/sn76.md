...
- subnet age: 176.8 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 192.39704065773955** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 97.70179119179421
- top_miner_usd_day: 480.9817867460545 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.9805 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.7 (rank 2), confidence 1.0 
- components: income 14.67 / freshness 35.0 / resource 15.0 / registration 10.0
