...
- miner_burn: **0.0**
- registration cost: 0.497534585 TAO (105.6166417038 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 95  |  free: 0
- subnet age: 211.2 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 18377.69438145138** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 19.783543412569188
- top_miner_usd_day: 18377.69438145138 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.7972 USD/day  |  payback on registration: 5.62 days

## Score

- gate: **OK** 
- score: 69.9 (rank 4), confidence 1.0 
- components: income 11.79 / freshness 35.0 / resource 15.0 / registration 8.13
