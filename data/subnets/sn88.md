...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (2.4163 USD), open=True
...
- **competitive_miner_usd_day: 700.7135605604556** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 5.594016486062325
- top_miner_usd_day: 700.7135605604556 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.6252 USD/day  |  payback on registration: [UNKNOWN] days
