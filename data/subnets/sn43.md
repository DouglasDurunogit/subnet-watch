...
- registration cost: 0.1 TAO (23.201 USD), open=True
...
- **competitive_miner_usd_day: 27.95082976220551** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.031195661129912
- top_miner_usd_day: 2864.390179339651 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7692 USD/day  |  payback on registration: [UNKNOWN] days
