...
- registration cost: 0.1 TAO (22.905 USD), open=True
...
- **competitive_miner_usd_day: 27.54022048776502** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.018023714528279
- top_miner_usd_day: 2827.855558177553 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.772 USD/day  |  payback on registration: [UNKNOWN] days
