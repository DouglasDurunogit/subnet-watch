...
- **competitive_miner_usd_day: 379.33994027221627** (uid 181) <- the only figure quotable as achievable
- median_miner_usd_day: 60.68556345250696
- top_miner_usd_day: 379.33994027221627 (uid 181, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 378.3536 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 41.2 (rank 30), confidence 0.85 - hardware from README keywords, not curated
- components: income 23.46 / freshness 0.0 / resource 15.0 / registration 10.0
