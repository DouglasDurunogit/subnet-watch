...
- **competitive_miner_usd_day: 131.3958210434402** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 2.4776584260016095
- top_miner_usd_day: 612.4345365260754 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.7682 USD/day  |  payback on registration: [UNKNOWN] days
