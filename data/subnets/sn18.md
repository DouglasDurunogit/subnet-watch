...
- subnet age: 1035.7 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1280.4421477865856** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 13.918739377435868
- top_miner_usd_day: 1280.4421477865856 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.6791 USD/day  |  payback on registration: 40.86 days

## Score

- gate: **OK** 
- score: 45.7 (rank 39), confidence 0.85 - hardware requirement unknown
- components: income 7.5 / freshness 35.0 / resource 11.25 / registration 0.0
