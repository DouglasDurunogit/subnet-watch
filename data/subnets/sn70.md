...
- miner_burn: **0.0**
- registration cost: 0.9 TAO (179.109 USD), open=True
...
- **competitive_miner_usd_day: 50.09040837712386** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 100.20452257931973
- top_miner_usd_day: 400.9010607050309 (uid 26, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 29.402 USD/day  |  payback on registration: 6.09 days

## Score

- gate: **OK** 
- score: 19.6 (rank 72), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 13.49 / freshness 0.0 / resource 11.25 / registration 7.97
