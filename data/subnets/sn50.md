...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (185.096 USD), open=True
...
- **competitive_miner_usd_day: 111.84845429348228** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 8.04156334147519
- top_miner_usd_day: 111.84845429348228 (uid 151, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.1776 USD/day  |  payback on registration: [UNKNOWN] days
