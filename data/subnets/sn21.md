...
- miner_burn: **0.45059548621065915**
- registration cost: 0.1 TAO (19.642 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 781.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 23.535909267723** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.88397731693075
- top_miner_usd_day: 900.2485294904046 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.8977 USD/day  |  payback on registration: 4.01 days

## Score

- gate: **OK** 
- score: 65.7 (rank 14), confidence 1.0 
- components: income 7.01 / freshness 35.0 / resource 15.0 / registration 8.66
