...
- miner_burn: **0.9417378990910947**
- registration cost: 0.15 TAO (33.501 USD), open=True
...
- **competitive_miner_usd_day: 125.47540997601423** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 1076.860334909392
- top_miner_usd_day: 2028.2452598427697 (uid 53, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 117.2562 USD/day  |  payback on registration: 0.29 days
...
- components: income 18.85 / freshness 35.0 / resource 11.25 / registration 9.9
