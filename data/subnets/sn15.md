...
- miner_burn: **0.0**
- registration cost: 0.199165223 TAO (62.93820212023 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 69  |  free: 0
- subnet age: 247.3 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.216327445838996** (uid 236) <- the only figure quotable as achievable
- median_miner_usd_day: 14.529796467503393
- top_miner_usd_day: 21924.079079322866 (uid 142, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 57  |  gini: 0.9597234931961944  |  top1_share: 0.9674090582973333  |  top10_share: 0.9764765146773727
...
- status: **ok** 
- README: 6354 bytes, sha 196f8f3325a33457
- latest release: v2.0.31: fix(proxy): re-resolve Backend host for allowlist fetch (#334) 2026-09-25T17:39:29Z
- last commit: 2026-09-25T18:07:06Z
- scoring-related commit: refactor(validator): simplify session call orchestration 2026-09-25T18:07:06Z
...
- net margin: 13.1975 USD/day  |  payback on registration: 4.77 days

## Score

- gate: **OK** 
- score: 68.9 (rank 7), confidence 1.0 
- components: income 10.48 / freshness 35.0 / resource 15.0 / registration 8.41
...
| Reference | [Agent Interface](https://docs.oroagents.com/docs/miners/agent-interface) | [Configuration](https://docs.oroa
```

_(truncated at 6000 of 6354 chars - read the full file at https://github.com/ORO-AI/oro)_
