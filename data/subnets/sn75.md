...
- subnet age: 529.2 days  |  registered at block 5102795
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12550.171258490878** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.231469270426499
- top_miner_usd_day: 12550.171258490878 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.9877 USD/day  |  payback on registration: [UNKNOWN] days
