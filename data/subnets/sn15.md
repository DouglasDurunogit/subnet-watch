...
- miner_burn: **0.0**
- registration cost: 0.488426852 TAO (115.93299759072 USD), open=True
...
- **competitive_miner_usd_day: 25469.58284992536** (uid 129) <- the only figure quotable as achievable
- median_miner_usd_day: 27.468266155203192
- top_miner_usd_day: 25469.58284992536 (uid 129, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 26.482 USD/day  |  payback on registration: 4.38 days

## Score

- gate: **OK** 
- score: 71.6 (rank 6), confidence 1.0 
- components: income 13.09 / freshness 35.0 / resource 15.0 / registration 8.54
