...
- **competitive_miner_usd_day: 321.36621206519914** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 803.4032708278309
- top_miner_usd_day: 1285.4403295904626 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 313.147 USD/day  |  payback on registration: 0.73 days
...
- components: income 22.71 / freshness 35.0 / resource 11.25 / registration 9.76
