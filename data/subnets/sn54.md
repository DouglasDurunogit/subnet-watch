...
- subnet age: 576.5 days  |  registered at block 4742549
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1164.40766505232** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 2.026466524629864
- top_miner_usd_day: 1164.40766505232 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.0694 USD/day  |  payback on registration: [UNKNOWN] days
