...
- miner_burn: **0.0**
- registration cost: 0.2 TAO (40.634 USD), open=True
...
- **competitive_miner_usd_day: 512.2437793364644** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 14.74199364946814
- top_miner_usd_day: 512.2437793364644 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.6517 USD/day  |  payback on registration: 4.21 days

## Score

- gate: **OK** 
- score: 67.9 (rank 11), confidence 1.0 
- components: income 9.34 / freshness 35.0 / resource 15.0 / registration 8.6
