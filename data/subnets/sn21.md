...
- miner_burn: **0.1505169146694243**
- registration cost: 0.1 TAO (22.997 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 35  |  free: 0
- subnet age: 810.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 53.58048149024915** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 10.039482709265112
- top_miner_usd_day: 1071.609629804983 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.2389 USD/day  |  payback on registration: 96.26 days

## Score

- gate: **OK** 
- score: 50.8 (rank 33), confidence 1.0 
- components: income 0.85 / freshness 35.0 / resource 15.0 / registration 0.0
