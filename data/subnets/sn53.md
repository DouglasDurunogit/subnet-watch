...
- subnet age: 658.2 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7205.224252827747** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 11.789382096786214
- top_miner_usd_day: 7909.719491097862 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 152  |  gini: 0.9190564256064293  |  top1_share: 0.3792065747063227  |  top10_share: 0.9240486992652338
...
- net margin: 3.5702 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 52.9 (rank 29), confidence 0.85 - hardware from README keywords, not curated
