...
- registration cost: 0.8 TAO (152.952 USD), open=True
...
- **competitive_miner_usd_day: 43.03575877362906** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 9.770644606747728
- top_miner_usd_day: 43.03575877362906 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.5515 USD/day  |  payback on registration: 98.58 days

## Score

- gate: **OK** 
- score: 30.6 (rank 57), confidence 0.85 - hardware requirement unknown
- components: income 3.7 / freshness 21.0 / resource 11.25 / registration 0.0
