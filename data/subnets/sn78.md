...
- miner_burn: **0.0**
- registration cost: 0.75 TAO (195.03750000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 242  |  free: 0
- subnet age: 159.1 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12.238317363636126** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 12.238317363636126
- top_miner_usd_day: 12.238317363636126 (uid 1, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 238  |  gini: 0.17056375299959492  |  top1_share: 0.005090030876463575  |  top10_share: 0.05090030876463575
...
- status: **ok** 
- README: 3949 bytes, sha 4db265c658752d02
- latest release: Open competition miner bundle v1 (feed config + pinned artifacts) 2026-09-20T17:08:55Z
- last commit: 2026-09-20T08:21:48Z
- scoring-related commit: Reuse validated reserved publications across a signing round 2026-09-20T06:21:53Z
...
- net margin: 4.0191 USD/day  |  payback on registration: 48.53 days

## Score

- gate: **OK** 
- score: 44.7 (rank 37), confidence 0.85 - hardware requirement unknown
- components: income 6.37 / freshness 35.0 / resource 11.25 / registration 0.0
