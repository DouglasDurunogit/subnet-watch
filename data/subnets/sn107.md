...
- subnet age: 183.6 days  |  registered at block 7457580
- weights_version: 20  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 28515.460567406644** (uid 8) <- the only figure quotable as achievable
- median_miner_usd_day: 99.73155788420213
- top_miner_usd_day: 28515.460567406644 (uid 8, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.8999496383115102  |  top1_share: 0.8966974941244698  |  top10_share: 0.9868906998748589
...
- net margin: 98.7453 USD/day  |  payback on registration: 1.98 days

## Score

- gate: **OK** 
- score: 77.5 (rank 2), confidence 1.0 
- components: income 18.18 / freshness 35.0 / resource 15.0 / registration 9.34
