...
- **competitive_miner_usd_day: 32.236041753688916** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.144438897802583
- top_miner_usd_day: 2391.522478831684 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.1136 USD/day  |  payback on registration: 3.88 days

## Score

- gate: **OK** 
- score: 65.9 (rank 12), confidence 1.0 
- components: income 7.15 / freshness 35.0 / resource 15.0 / registration 8.71
