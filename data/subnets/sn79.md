...
- miner_burn: **0.0**
- registration cost: 0.094377867 TAO (22.217493670470002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 220  |  free: 0
- subnet age: 520.8 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 443.1200606251551** (uid 235) <- the only figure quotable as achievable
- median_miner_usd_day: 6.724896481419619
- top_miner_usd_day: 443.1200606251551 (uid 235, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 219  |  gini: 0.7334933555463097  |  top1_share: 0.09367309191519284  |  top10_share: 0.48848193949769947
...
- net margin: 5.7386 USD/day  |  payback on registration: 3.87 days

## Score

- gate: **OK** 
- score: 31.2 (rank 58), confidence 1.0 
- components: income 7.54 / freshness 0.0 / resource 15.0 / registration 8.71
