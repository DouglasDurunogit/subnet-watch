...
- subnet age: 645.5 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 578.0951492563636** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 93.42951907173553
- top_miner_usd_day: 2008.1785319526011 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 83.82 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.8 (rank 29), confidence 0.85 - hardware from README keywords, not curated
- components: income 17.54 / freshness 21.0 / resource 11.25 / registration 10.0
