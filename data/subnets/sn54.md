...
- **competitive_miner_usd_day: 948.3565034921804** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5363307323877995
- top_miner_usd_day: 948.3565034921804 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.6008 USD/day  |  payback on registration: [UNKNOWN] days
