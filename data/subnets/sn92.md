...
- miner_burn: **0.0**
- registration cost: 0.000294563 TAO (0.056397031980000005 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 4  |  free: 22
- subnet age: 73.1 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2354.8865503256293
- top_miner_usd_day: 2354.8865503256293 (uid 159, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-19T07:50:37Z
- scoring-related commit: Declare pynacl for token verification 2026-08-19T07:50:37Z
