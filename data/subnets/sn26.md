...
- subnet age: 118.8 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1728.5314935078854** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 24.247068406337455
- top_miner_usd_day: 1728.5314935078854 (uid 45, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 21.2882 USD/day  |  payback on registration: 1.02 days

## Score

- gate: **OK** 
- score: 54.2 (rank 28), confidence 1.0 
- components: income 12.26 / freshness 21.0 / resource 11.25 / registration 9.66
