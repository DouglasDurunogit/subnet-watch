...
- registration cost: 0.1 TAO (24.396 USD), open=True
...
- **competitive_miner_usd_day: 202.78667995212083** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0266312067919787
- top_miner_usd_day: 2861.437306214885 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.473 USD/day  |  payback on registration: [UNKNOWN] days
