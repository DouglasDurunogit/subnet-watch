...
- miner_burn: **0.0**
- registration cost: 0.200051558 TAO (50.16092765292 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 62  |  free: 0
- subnet age: 240.3 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 19774.190217683128** (uid 37) <- the only figure quotable as achievable
- median_miner_usd_day: 9.412313336132081
- top_miner_usd_day: 19774.190217683128 (uid 37, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 50  |  gini: 0.9645079151846365  |  top1_share: 0.9781702718793412  |  top10_share: 0.9849787045659244
...
- latest release: v2.0.26: fix(proxy): fail over user-simulator from Mistral Small to Qwen on 429 2026-09-18T18:33:03Z
- last commit: 2026-09-18T18:33:03Z
- scoring-related commit: validator: strict > infra boundary — 3/10 not infra, matches Backend … 2026-09-18T18:17:14Z
...
- net margin: 8.426 USD/day  |  payback on registration: 5.95 days

## Score

- gate: **OK** 
- score: 66.9 (rank 9), confidence 1.0 
- components: income 8.86 / freshness 35.0 / resource 15.0 / registration 8.02
