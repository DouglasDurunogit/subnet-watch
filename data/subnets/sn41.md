...
- **competitive_miner_usd_day: 23.73503833475154** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 12.778403313994524
- top_miner_usd_day: 2399.1647411484714 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.7661 USD/day  |  payback on registration: 1.99 days

## Score

- gate: **OK** 
- score: 55.4 (rank 26), confidence 1.0 
- components: income 10.06 / freshness 21.0 / resource 15.0 / registration 9.34
