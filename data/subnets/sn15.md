...
- miner_burn: **0.0**
- registration cost: 0.30767315 TAO (64.1529285065 USD), open=True
...
- **competitive_miner_usd_day: 15992.295389130368** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 17.662680297240865
- top_miner_usd_day: 15992.295389130368 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.6764 USD/day  |  payback on registration: 3.85 days

## Score

- gate: **OK** 
- score: 70.1 (rank 7), confidence 1.0 
- components: income 11.35 / freshness 35.0 / resource 15.0 / registration 8.72
