...
- subnet age: 295.8 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 72.32422432988264** (uid 120) <- the only figure quotable as achievable
- median_miner_usd_day: 72.32422432988264
- top_miner_usd_day: 7091.417800210768 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 64.105 USD/day  |  payback on registration: 0.18 days
...
- components: income 16.5 / freshness 21.0 / resource 11.25 / registration 9.94
