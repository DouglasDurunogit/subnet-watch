...
- **competitive_miner_usd_day: 7.453779605630157** (uid 2) <- the only figure quotable as achievable
- median_miner_usd_day: 6.812594263210358
- top_miner_usd_day: 2501.9052061220536 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.4066 USD/day  |  payback on registration: [UNKNOWN] days
