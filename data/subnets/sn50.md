...
- registration cost: 0.8 TAO (156.736 USD), open=True
...
- **competitive_miner_usd_day: 42.12893709146003** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.239017870934058
- top_miner_usd_day: 42.12893709146003 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.0198 USD/day  |  payback on registration: 51.9 days

## Score

- gate: **OK** 
- score: 32.1 (rank 51), confidence 0.85 - hardware requirement unknown
- components: income 5.5 / freshness 21.0 / resource 11.25 / registration 0.0
