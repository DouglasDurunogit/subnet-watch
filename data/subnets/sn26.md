...
- subnet age: 116.4 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 269.3696887236983** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 26.451914343613588
- top_miner_usd_day: 1885.711140013877 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.6836 USD/day  |  payback on registration: 1.22 days

## Score

- gate: **OK** 
- score: 53.6 (rank 29), confidence 1.0 
- components: income 11.77 / freshness 21.0 / resource 11.25 / registration 9.59
