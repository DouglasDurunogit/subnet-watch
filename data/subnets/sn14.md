...
- subnet age: 587.9 days  |  registered at block 4848444
- weights_version: 29  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 887.3811542600208** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 568.5950673304754
- top_miner_usd_day: 887.3811542600208 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 473.5997 USD/day  |  payback on registration: 0.0 days
