...
- miner_burn: **0.0**
- registration cost: 0.005 TAO (1.1868 USD), open=True
...
- **competitive_miner_usd_day: 126.92814672549055** (uid 153) <- the only figure quotable as achievable
- median_miner_usd_day: 68.4277439050829
- top_miner_usd_day: 9147.193894578117 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.7405238582088416  |  top1_share: 0.9842216898356554  |  top10_share: 1.0
...
- net margin: 1.7082 USD/day  |  payback on registration: 0.69 days

## Score

- gate: **OK** 
- score: 39.1 (rank 45), confidence 0.85 - hardware requirement unknown
- components: income 3.94 / freshness 21.0 / resource 11.25 / registration 9.77
