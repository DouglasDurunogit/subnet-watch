...
- registration cost: 0.1 TAO (23.07 USD), open=True
...
- **competitive_miner_usd_day: 26.713022375958747** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9713826318530453
- top_miner_usd_day: 2873.673619231926 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.8244 USD/day  |  payback on registration: [UNKNOWN] days
