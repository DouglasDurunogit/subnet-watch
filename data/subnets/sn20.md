...
- miner_burn: **0.7980024230200797**
- registration cost: 0.000599225 TAO (0.13885840924999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 982.4 days  |  registered at block 1970929
- weights_version: 1022  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 363.18792226351866** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 899.0389551113332
- top_miner_usd_day: 1434.8899879591474 (uid 240, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.29801324503311255  |  top1_share: 0.7980132450331126  |  top10_share: 1.0
...
- status: **ok** 
- README: 6149 bytes, sha e7db9b44b2a16bf6
- latest release: (none) 
- last commit: 2026-09-11T09:44:50Z
- scoring-related commit: Add scorer v1.1.0 and signed round feedback 2026-09-11T09:44:50Z
...
- net margin: 362.2016 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.0 (rank 34), confidence 0.6 - hardware from README keywords, not curated; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 23.28 / freshness 35.0 / resource 15.0 / registration 10.0
...
| `witness/recompose/`, `witness/
```

_(truncated at 6000 of 6149 chars - read the full file at https://github.com/witnessvision/witness_subnet)_
