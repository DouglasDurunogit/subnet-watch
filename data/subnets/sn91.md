...
- subnet age: 198.4 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2726.2486017831047** (uid 165) <- the only figure quotable as achievable
- median_miner_usd_day: 681.5621504457762
- top_miner_usd_day: 2726.2486017831047 (uid 165, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-13T11:58:41Z
- scoring-related commit: pool: publish packs mv_channels iff effective_block >= [scoring] mv_s… 2026-09-13T10:23:14Z
...
- net margin: 1014.124 USD/day  |  payback on registration: 0.02 days

## Score

- gate: **OK** 
- score: 71.0 (rank 2), confidence 0.85 - hardware requirement unknown
- components: income 27.34 / freshness 35.0 / resource 11.25 / registration 9.99
