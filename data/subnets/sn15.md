...
- miner_burn: **0.0**
- registration cost: 0.262613455 TAO (52.24169460315 USD), open=True
...
- **competitive_miner_usd_day: 22.99854494802507** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 12.008089840119286
- top_miner_usd_day: 12371.588966465948 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.92 USD/day  |  payback on registration: 4.78 days

## Score

- gate: **OK** 
- score: 68.2 (rank 12), confidence 1.0 
- components: income 9.79 / freshness 35.0 / resource 15.0 / registration 8.41
