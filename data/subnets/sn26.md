...
- subnet age: 127.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 362.7438865055567** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 23.746255439097222
- top_miner_usd_day: 1692.8294048378336 (uid 126, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 20.7874 USD/day  |  payback on registration: 1.16 days

## Score

- gate: **OK** 
- score: 54.0 (rank 30), confidence 1.0 
- components: income 12.17 / freshness 21.0 / resource 11.25 / registration 9.61
