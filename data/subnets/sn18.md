...
- subnet age: 1017.1 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1355.5081150372196** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.110985547500387
- top_miner_usd_day: 1355.5081150372196 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.1082 USD/day  |  payback on registration: [UNKNOWN] days
