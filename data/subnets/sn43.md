...
- registration cost: 0.1 TAO (20.699 USD), open=True
...
- **competitive_miner_usd_day: 23.932797194986012** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.503430668931591
- top_miner_usd_day: 2619.0891658362307 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.4156 USD/day  |  payback on registration: 49.81 days
