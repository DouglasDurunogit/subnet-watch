...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (98.84 USD), open=True
...
- **competitive_miner_usd_day: 21.91232724059498** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 9.437487474909718
- top_miner_usd_day: 2861.8367191157263 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.2058 USD/day  |  payback on registration: [UNKNOWN] days
