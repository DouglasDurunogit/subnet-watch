...
- subnet age: 288.0 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 36.517173319847394** (uid 119) <- the only figure quotable as achievable
- median_miner_usd_day: 1826.8064399563966
- top_miner_usd_day: 3617.095706592945 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 28.298 USD/day  |  payback on registration: 0.35 days
...
- components: income 13.34 / freshness 21.0 / resource 11.25 / registration 9.88
