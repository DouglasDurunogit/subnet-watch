...
- subnet age: 662.3 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2750.5321102287426** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 17.948007244559495
- top_miner_usd_day: 25698.74199807723 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 38  |  gini: 0.9123582228156129  |  top1_share: 0.6993452081139245  |  top10_share: 0.9785551841506783
...
- last commit: 2026-07-30T09:35:22Z
- scoring-related commit: DAH-2340, publish structured zero-incentive reasons on MACHINE_SPEC_C… 2026-07-30T09:35:22Z
...
- net margin: 8.6071 USD/day  |  payback on registration: 11.26 days

## Score

- gate: **OK** 
- score: 52.2 (rank 20), confidence 0.85 - hardware requirement unknown
- components: income 8.94 / freshness 35.0 / resource 11.25 / registration 6.25
