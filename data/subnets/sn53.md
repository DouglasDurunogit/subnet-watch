...
- subnet age: 648.9 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2036.7075853128733** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 94.75681925576372
- top_miner_usd_day: 2036.7075853128733 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 85.8326 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 62.8 (rank 15), confidence 0.85 - hardware from README keywords, not curated
