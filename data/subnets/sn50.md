...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (179.832 USD), open=True
...
- **competitive_miner_usd_day: 65.16939596485399** (uid 170) <- the only figure quotable as achievable
- median_miner_usd_day: 6.42656601194246
- top_miner_usd_day: 65.16939596485399 (uid 170, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -1.7926 USD/day  |  payback on registration: [UNKNOWN] days
