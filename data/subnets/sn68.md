...
- miner_burn: **0.0**
- registration cost: 0.09512215 TAO (18.754283094 USD), open=True
...
- **competitive_miner_usd_day: 8158.090222665794** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 8158.090222665794
- top_miner_usd_day: 8158.090222665794 (uid 42, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8149.871 USD/day  |  payback on registration: 0.0 days
