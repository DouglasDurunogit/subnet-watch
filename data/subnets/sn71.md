...
- subnet age: 568.1 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1024.8348694957926** (uid 58) <- the only figure quotable as achievable
- median_miner_usd_day: 1708.0754917990153
- top_miner_usd_day: 2391.3161141022374 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-24T17:22:54Z
- scoring-related commit: chore(release): bind verifier evidence reuse source 2026-09-24T17:22:54Z
...
- net margin: 1016.6157 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.2 (rank 37), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 27.35 / freshness 35.0 / resource 11.25 / registration 10.0
