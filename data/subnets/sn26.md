...
- subnet age: 107.7 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 264.98014040984555** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 26.020863780518173
- top_miner_usd_day: 1854.9822922571727 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.3309 USD/day  |  payback on registration: 1.25 days

## Score

- gate: **OK** 
- score: 67.5 (rank 9), confidence 1.0 
- components: income 11.7 / freshness 35.0 / resource 11.25 / registration 9.58
