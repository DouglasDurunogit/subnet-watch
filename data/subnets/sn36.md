...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (30.297999697020003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 4  |  free: 227
- subnet age: 36.3 days  |  registered at block 8884359
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 5695.494381134676
- top_miner_usd_day: 5695.494381134676 (uid 23, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 24.2 (rank 76), confidence 0.85 - hardware from README keywords, not curated
- components: income 0.0 / freshness 21.0 / resource 7.5 / registration 0.0
