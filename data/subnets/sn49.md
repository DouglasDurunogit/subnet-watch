...
- **competitive_miner_usd_day: 36.02594760771874** (uid 119) <- the only figure quotable as achievable
- median_miner_usd_day: 1802.232404980336
- top_miner_usd_day: 3568.4388623529535 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.8068 USD/day  |  payback on registration: 0.35 days
...
- components: income 13.27 / freshness 21.0 / resource 11.25 / registration 9.88
