...
- **competitive_miner_usd_day: 10804.820326049936** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8334737515852029
- top_miner_usd_day: 10804.820326049936 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 93  |  gini: 0.9824413721226557  |  top1_share: 0.9903135121921409  |  top10_share: 0.9930177840249345
...
- net margin: -7.3857 USD/day  |  payback on registration: [UNKNOWN] days
