...
- miner_burn: **0.0**
- registration cost: 0.266010611 TAO (53.26862485275 USD), open=True
...
- **competitive_miner_usd_day: 23.237877970013255** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 11.514263859015578
- top_miner_usd_day: 12647.058072490727 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.528 USD/day  |  payback on registration: 5.06 days

## Score

- gate: **OK** 
- score: 68.0 (rank 11), confidence 1.0 
- components: income 9.66 / freshness 35.0 / resource 15.0 / registration 8.31
