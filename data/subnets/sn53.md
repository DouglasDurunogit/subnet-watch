...
- subnet age: 670.7 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4207.3115430145435** (uid 79) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5589997399873173
- top_miner_usd_day: 6302.163068617016 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.6602 USD/day  |  payback on registration: [UNKNOWN] days
