...
- subnet age: 612.2 days  |  registered at block 4312927
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 708.0987050100151** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8683000674555673
- top_miner_usd_day: 6695.8959701836075 (uid 38, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.3509 USD/day  |  payback on registration: [UNKNOWN] days
