...
- registration cost: 0.1 TAO (20.592 USD), open=True
...
- **competitive_miner_usd_day: 22.789153119901265** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.7676104992440265
- top_miner_usd_day: 2608.485362251455 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.9086 USD/day  |  payback on registration: 22.66 days

## Score

- gate: **OK** 
- score: 20.0 (rank 67), confidence 1.0 
- components: income 2.55 / freshness 0.0 / resource 15.0 / registration 2.45
