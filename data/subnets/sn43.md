...
- miner_burn: **0.8224152685143054**
- registration cost: 0.1 TAO (23.002000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 20  |  free: 0
- subnet age: 772.1 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 91.27268627920223** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 2.9630834821880456
- top_miner_usd_day: 2618.0056943607688 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.8618197313849487  |  top1_share: 0.8225006485876051  |  top10_share: 0.9997863476124346
- owner_incentive_share: 0.8225006485876051 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.1795 USD/day  |  payback on registration: 128.14 days

## Score

- gate: **OK** 
- score: 15.7 (rank 79), confidence 1.0 
- components: income 0.65 / freshness 0.0 / resource 15.0 / registration 0.0
