...
- miner_burn: **0.0**
- registration cost: 0.000603845 TAO (0.11339605254999999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 47  |  free: 0
- subnet age: 627.1 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2617.0180709384435** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 107.90694262938999
- top_miner_usd_day: 2617.0180709384435 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 38  |  gini: 0.6964150726649492  |  top1_share: 0.1817543538318299  |  top10_share: 0.8199703893645924
...
- status: **ok** 
- README: 4913 bytes, sha 43c68a3df7e5638e
- latest release: v0.4.4 2026-07-23T23:03:26Z
- last commit: 2026-07-25T00:42:08Z
- scoring-related commit: miner: parse tool-call arguments back to a dict before templating 2026-07-25T00:42:08Z
...
- net margin: 2616.0318 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 47.7 (rank 7), confidence 0.85 - hardware from README keywords, not curated
- components: income 31.09 / freshness 0.0 / resource 15.0 / registration 10.0
