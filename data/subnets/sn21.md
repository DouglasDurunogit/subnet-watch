...
- miner_burn: **0.30137950950302184**
- registration cost: 0.1 TAO (23.958000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 33  |  free: 0
- subnet age: 800.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 993.6565381051809** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.259970223395696
- top_miner_usd_day: 993.6565381051809 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7807125143075162  |  top1_share: 0.36847004959938956  |  top10_share: 0.9989164441053032
- owner_incentive_share: 0.30141167493323157 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 8.2737 USD/day  |  payback on registration: 2.9 days

## Score

- gate: **OK** 
- score: 67.8 (rank 13), confidence 1.0 
- components: income 8.8 / freshness 35.0 / resource 15.0 / registration 9.03
