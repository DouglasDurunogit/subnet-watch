...
- subnet age: 247.6 days  |  registered at block 7340355
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1985.0882252999254
- top_miner_usd_day: 1985.0882252999254 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 21.0 (rank 82), confidence 0.85 - hardware from README keywords, not curated
