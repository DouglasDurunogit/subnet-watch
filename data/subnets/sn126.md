...
- subnet age: 170.6 days  |  registered at block 7525773
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 161.94753999544295** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 161.94753999544295
- top_miner_usd_day: 2915.698368886209 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 153.7284 USD/day  |  payback on registration: 0.25 days
...
- components: income 19.91 / freshness 35.0 / resource 11.25 / registration 9.92
