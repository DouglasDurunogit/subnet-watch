...
- subnet age: 632.0 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2239.1469549649064** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 124.98893876501333
- top_miner_usd_day: 2239.1469549649064 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 34  |  gini: 0.6045520205915125  |  top1_share: 0.131515086766075  |  top10_share: 0.759695364844859
...
- net margin: 88.4459 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 62.9 (rank 13), confidence 0.85 - hardware from README keywords, not curated
