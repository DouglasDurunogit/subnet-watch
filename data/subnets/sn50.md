...
- miner_burn: **0.0**
- registration cost: 1.088768397 TAO (203.64324097487997 USD), open=True
...
- **competitive_miner_usd_day: 38.4773797926959** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 9.56450261665645
- top_miner_usd_day: 38.4773797926959 (uid 240, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 30.2582 USD/day  |  payback on registration: 6.73 days

## Score

- gate: **OK** 
- score: 27.7 (rank 66), confidence 0.85 - hardware requirement unknown
- components: income 13.6 / freshness 0.0 / resource 11.25 / registration 7.76
