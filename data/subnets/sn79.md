...
- miner_burn: **0.0**
- registration cost: 0.119509101 TAO (28.366680213360002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 230  |  free: 0
- subnet age: 519.6 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 445.6946316771501** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 6.684305424253209
- top_miner_usd_day: 445.6946316771501 (uid 234, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 229  |  gini: 0.7442508178593621  |  top1_share: 0.09174157646914939  |  top10_share: 0.48350455573900813
...
- net margin: 5.698 USD/day  |  payback on registration: 4.98 days

## Score

- gate: **OK** 
- score: 30.9 (rank 56), confidence 1.0 
- components: income 7.51 / freshness 0.0 / resource 15.0 / registration 8.34
