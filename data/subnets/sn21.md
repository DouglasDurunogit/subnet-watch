...
- **competitive_miner_usd_day: 581.3124168080309** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 7.253183261446707
- top_miner_usd_day: 833.0583191740769 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.4536 USD/day  |  payback on registration: 4.31 days

## Score

- gate: **OK** 
- score: 65.3 (rank 12), confidence 1.0 
- components: income 6.7 / freshness 35.0 / resource 15.0 / registration 8.56
