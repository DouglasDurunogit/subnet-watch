...
- registration cost: 0.056676542 TAO (12.866141799420001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 460.4 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4152.236800099373
- top_miner_usd_day: 4152.236800099373 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 25648 bytes, sha 7690a439a45c08c2
- latest release: (none) 
- last commit: 2026-08-26T10:46:32Z
- scoring-related commit: feat(batch): reuse canonical miner artifacts across validators 2026-08-26T10:46:32Z
...
_(truncated at 6000 of 25648 chars - read the full file at https://github.com/DeSciClaims/Claims)_
