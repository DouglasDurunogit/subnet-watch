...
- registration cost: 0.1 TAO (19.271 USD), open=True
...
- **competitive_miner_usd_day: 22.60315694628118** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.2734172927482355
- top_miner_usd_day: 2406.258412214871 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.7134 USD/day  |  payback on registration: [UNKNOWN] days
