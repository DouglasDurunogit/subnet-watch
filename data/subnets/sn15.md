...
- miner_burn: **0.0**
- registration cost: 0.555018792 TAO (128.76990993192 USD), open=True
...
- **competitive_miner_usd_day: 40.0335853442627** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 23.028168560859065
- top_miner_usd_day: 21512.56079003822 (uid 146, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 21.6876 USD/day  |  payback on registration: 5.94 days

## Score

- gate: **OK** 
- score: 70.4 (rank 5), confidence 1.0 
- components: income 12.33 / freshness 35.0 / resource 15.0 / registration 8.02
