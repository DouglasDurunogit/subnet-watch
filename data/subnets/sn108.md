...
- miner_burn: **0.8352124337106943**
- registration cost: 0.068179131 TAO (13.075393743180001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 94
- subnet age: 246.1 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 157.082344859875** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 157.082344859875
- top_miner_usd_day: 1506.5537315411357 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.5050280011597212  |  top1_share: 0.8352280530419788  |  top10_share: 1.0
- owner_incentive_share: 0.8352280530419789 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 7218 bytes, sha 2a99164bfa1198ff
- latest release: (none) 
- last commit: 2026-08-19T06:09:29Z
- scoring-related commit: docs(validator): tell operators to re-post weights between cycles (#4) 2026-08-19T05:41:54Z
...
- net margin: 140.3856 USD/day  |  payback on registration: 0.09 days

## Score

- gate: **OK** 
- score: 45.5 (rank 37), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 19.56 / freshness 35.0 / resource 11.25 / registration 9.97
...
A validator runs **one cycle per day**, starting at 04:00 UTC 
```

_(truncated at 6000 of 7218 chars - read the full file at https://github.com/BitSpaceorganization/prometheon_v2)_
