...
- miner_burn: **0.0**
- registration cost: 0.1865312 TAO (36.433273984 USD), open=True
...
- **competitive_miner_usd_day: 61.369243978176705** (uid 26) <- the only figure quotable as achievable
- median_miner_usd_day: 26.680255538312025
- top_miner_usd_day: 69.00547767500596 (uid 193, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 206  |  gini: 0.2746675094854205  |  top1_share: 0.011325080238422741  |  top10_share: 0.09770747363594681
...
- net margin: 15.5276 USD/day  |  payback on registration: 2.35 days

## Score

- gate: **OK** 
- score: 26.8 (rank 68), confidence 0.85 - hardware requirement unknown
- components: income 11.08 / freshness 0.0 / resource 11.25 / registration 9.22
