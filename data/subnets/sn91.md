...
- subnet age: 177.5 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2839.930428069656** (uid 106) <- the only figure quotable as achievable
- median_miner_usd_day: 709.982607017414
- top_miner_usd_day: 2839.930428069656 (uid 106, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 701.7634 USD/day  |  payback on registration: 0.03 days
