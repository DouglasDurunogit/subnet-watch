...
- miner_burn: **0.0**
- registration cost: 0.75 TAO (215.385 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 243  |  free: 0
- subnet age: 162.0 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 15.683169547952234** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 15.683169547952234
- top_miner_usd_day: 15.683169547952234 (uid 1, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 239  |  gini: 0.17625952360164598  |  top1_share: 0.005105862569747  |  top10_share: 0.05105862569747
...
- net margin: 7.464 USD/day  |  payback on registration: 28.86 days

## Score

- gate: **OK** 
- score: 46.8 (rank 44), confidence 0.85 - hardware requirement unknown
- components: income 8.44 / freshness 35.0 / resource 11.25 / registration 0.38
