...
- **competitive_miner_usd_day: 57.82123159829157** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 2892.5622836354505
- top_miner_usd_day: 5727.303335672609 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 49.6021 USD/day  |  payback on registration: 0.23 days
...
- components: income 15.5 / freshness 21.0 / resource 11.25 / registration 9.92
