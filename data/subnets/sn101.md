...
- registration cost: 0.002065293 TAO (0.41710657428000003 USD), open=True
...
- **competitive_miner_usd_day: 1.8931762024162346** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.051764556897908
- top_miner_usd_day: 2484.983083291549 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0655 USD/day  |  payback on registration: 6.37 days

## Score

- gate: **OK** 
- score: 44.1 (rank 36), confidence 1.0 
- components: income 0.25 / freshness 21.0 / resource 15.0 / registration 7.88
