...
- miner_burn: **0.5749676383566111**
- registration cost: 0.099999999 TAO (23.57599976424 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 38  |  free: 0
- subnet age: 198.3 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 88.33316875532509** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 16.783462058383627
- top_miner_usd_day: 602.8606771781648 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 21  |  gini: 0.684201499414246  |  top1_share: 0.575056467859105  |  top10_share: 0.8842103656675416
- owner_incentive_share: 0.575056467859105 (independent check on miner_burn; disagreement 0.0001)
...
- status: **ok** 
- README: 7174 bytes, sha dc280a9e3871ccc2
- latest release: (none) 
- last commit: 2026-09-03T05:42:35Z
- scoring-related commit: ci: run the non-scoring tests on every push 2026-09-03T05:42:35Z
...
- net margin: 15.7972 USD/day  |  payback on registration: 1.49 days

## Score

- gate: **OK** 
- score: 70.6 (rank 6), confidence 1.0 
- components: income 11.14 / freshness 35.0 / resource 15.0 / registration 9.5
...
verdict:      { decision: ALLOW|WARN|BLOCK, risk_score, confidence, summ
```

_(truncated at 6000 of 7174 chars - read the full file at https://github.com/praxi-labs/phylax-subnet)_
