...
- registration cost: 0.00858382 TAO (2.0921344486 USD), open=True
...
- **competitive_miner_usd_day: 2.384697362045945** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1162413184044848
- top_miner_usd_day: 3000.1522344207815 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 242  |  gini: 0.9214474041658189  |  top1_share: 0.904446517888554  |  top10_share: 0.9106413570521742
- owner_incentive_share: 0.9044465178885541 (independent check on miner_burn; disagreement 0.0022)
...
- net margin: 0.1299 USD/day  |  payback on registration: 16.11 days

## Score

- gate: **OK** 
- score: 41.1 (rank 38), confidence 1.0 
- components: income 0.48 / freshness 21.0 / resource 15.0 / registration 4.63
