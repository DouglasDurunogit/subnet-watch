...
- subnet age: 788.0 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 80.77089569908438** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 40.03427004215488
- top_miner_usd_day: 80.77089569908438 (uid 234, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 87  |  gini: 0.35691756174259925  |  top1_share: 0.024585407568029804  |  top10_share: 0.23153040344501113
...
- net margin: 39.048 USD/day  |  payback on registration: 0.61 days

## Score

- gate: **OK** 
- score: 49.9 (rank 33), confidence 1.0 
- components: income 14.58 / freshness 10.5 / resource 15.0 / registration 9.8
