...
- miner_burn: **0.45123422192409635**
...
- **competitive_miner_usd_day: 35.3459476871065** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.652546727734645
- top_miner_usd_day: 870.2872764824532 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.6662 USD/day  |  payback on registration: 2.57 days

## Score

- gate: **OK** 
- score: 67.7 (rank 6), confidence 1.0 
