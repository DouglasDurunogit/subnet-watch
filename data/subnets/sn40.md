...
- subnet age: 47.3 days  |  registered at block 8409860
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4316.021099481677** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 4316.021099481677
- top_miner_usd_day: 4316.021099481677 (uid 124, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4307.8019 USD/day  |  payback on registration: 0.04 days
...
- components: income 33.05 / freshness 0.0 / resource 11.25 / registration 9.99
