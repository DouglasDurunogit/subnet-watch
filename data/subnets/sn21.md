...
- subnet age: 827.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 40.156541039115076
- top_miner_usd_day: 1064.5111978471439 (uid 44, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.7056208412184846  |  top1_share: 0.40295159025700505  |  top10_share: 0.9397167450094621
...
- last commit: 2026-09-20T18:12:24Z
- scoring-related commit: admission: report the gate score per horizon and publish the gate num… 2026-09-20T12:01:04Z
