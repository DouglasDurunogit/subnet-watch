...
- subnet age: 303.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 58.30508780266756** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 2916.767651954211
- top_miner_usd_day: 5775.230216105754 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 50.0859 USD/day  |  payback on registration: 0.23 days
...
- components: income 15.54 / freshness 10.5 / resource 11.25 / registration 9.92
