...
- **competitive_miner_usd_day: 890.8776995818685** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 299.97183437165626
- top_miner_usd_day: 890.8776995818685 (uid 4, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 291.7527 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 37.1 (rank 54), confidence 0.85 - hardware requirement unknown
- components: income 22.43 / freshness 0.0 / resource 11.25 / registration 10.0
