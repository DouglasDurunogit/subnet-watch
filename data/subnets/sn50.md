...
- registration cost: 0.8 TAO (158.0 USD), open=True
...
- **competitive_miner_usd_day: 45.75440308183141** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.248748475512492
- top_miner_usd_day: 45.75440308183141 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.0296 USD/day  |  payback on registration: 52.15 days
