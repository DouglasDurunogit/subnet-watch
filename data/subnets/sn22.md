...
- **competitive_miner_usd_day: 51.33180890721726** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 4.671904266901111
- top_miner_usd_day: 1002.7148455372377 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -3.5768 USD/day  |  payback on registration: [UNKNOWN] days
