...
- miner_burn: **0.0**
- registration cost: 0.294151538 TAO (59.00974003818 USD), open=True
...
- **competitive_miner_usd_day: 23.044876997038823** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 12.134249392246105
- top_miner_usd_day: 12380.197371524237 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.046 USD/day  |  payback on registration: 5.34 days

## Score

- gate: **OK** 
- score: 68.1 (rank 11), confidence 1.0 
- components: income 9.83 / freshness 35.0 / resource 15.0 / registration 8.22
