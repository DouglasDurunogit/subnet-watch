...
- **competitive_miner_usd_day: 8.554345890862068** (uid 2) <- the only figure quotable as achievable
- median_miner_usd_day: 6.90585215147719
- top_miner_usd_day: 2781.632692730164 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.3133 USD/day  |  payback on registration: [UNKNOWN] days
