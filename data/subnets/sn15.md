...
- miner_burn: **0.0**
- registration cost: 0.305512065 TAO (60.23170361475 USD), open=True
...
- **competitive_miner_usd_day: 21.299856049627547** (uid 183) <- the only figure quotable as achievable
- median_miner_usd_day: 12.142908589040001
- top_miner_usd_day: 12101.105133241668 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.9575 USD/day  |  payback on registration: 5.5 days

## Score

- gate: **OK** 
- score: 68.0 (rank 12), confidence 1.0 
- components: income 9.8 / freshness 35.0 / resource 15.0 / registration 8.17
