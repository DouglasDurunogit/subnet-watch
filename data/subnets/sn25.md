...
- registration cost: 0.000653469 TAO (0.13021023293999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 15  |  free: 0
- subnet age: 816.9 days  |  registered at block 2998801
- weights_version: 20502  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 7080.101489265189
- top_miner_usd_day: 7080.101489265189 (uid 1, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
