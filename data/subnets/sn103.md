...
- miner_burn: **0.0**
- registration cost: 0.556600032 TAO (104.16212998847999 USD), open=True
...
- **competitive_miner_usd_day: 5.452738083809614** (uid 84) <- the only figure quotable as achievable
- median_miner_usd_day: 5.275573308523381
- top_miner_usd_day: 5.452738083809614 (uid 84, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.7664 USD/day  |  payback on registration: [UNKNOWN] days
