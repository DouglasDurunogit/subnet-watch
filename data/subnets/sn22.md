...
- **competitive_miner_usd_day: 105.90117905206259** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 2.4082132814567956
- top_miner_usd_day: 1100.5233669597374 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.811 USD/day  |  payback on registration: [UNKNOWN] days
