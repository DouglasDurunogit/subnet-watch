...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (14.359000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 326.3 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.897931602557776** (uid 220) <- the only figure quotable as achievable
- median_miner_usd_day: 2746.321411940474
- top_miner_usd_day: 5437.74489227839 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 46.6788 USD/day  |  payback on registration: 0.31 days

## Score

- gate: **OK** 
- score: 42.8 (rank 48), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 15.26 / freshness 35.0 / resource 11.25 / registration 9.9
