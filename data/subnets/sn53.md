...
- **competitive_miner_usd_day: 596.2237527923305** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 96.35939439067967
- top_miner_usd_day: 2071.153411575859 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 86.7063 USD/day  |  payback on registration: 0.0 days
