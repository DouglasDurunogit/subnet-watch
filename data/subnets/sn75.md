...
- **competitive_miner_usd_day: 12283.739509897327** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.089071345220634
- top_miner_usd_day: 12283.739509897327 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.1301 USD/day  |  payback on registration: [UNKNOWN] days
