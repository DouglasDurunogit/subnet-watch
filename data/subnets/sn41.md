...
- subnet age: 763.1 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.660630283150027** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.54579637705885
- top_miner_usd_day: 2258.7221950605567 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.5116 USD/day  |  payback on registration: 1.86 days

## Score

- gate: **OK** 
- score: 55.4 (rank 22), confidence 1.0 
- components: income 9.98 / freshness 21.0 / resource 15.0 / registration 9.38
