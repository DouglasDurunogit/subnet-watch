...
- miner_burn: **0.45123903709463775**
- registration cost: 0.1 TAO (19.950000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 126  |  free: 0
- subnet age: 786.2 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 26.581488807001314** (uid 81) <- the only figure quotable as achievable
- median_miner_usd_day: 6.427836258504015
- top_miner_usd_day: 830.0329519660357 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 118  |  gini: 0.7067778493805499  |  top1_share: 0.45153458543289055  |  top10_share: 0.5809894640403115
- owner_incentive_share: 0.45153458543289055 (independent check on miner_burn; disagreement 0.0003)
...
- last commit: 2026-08-09T17:00:05Z
- scoring-related commit: docs: separate weekly-era scoring from the daily stream, and require … 2026-08-08T14:21:46Z
...
- net margin: 5.4415 USD/day  |  payback on registration: 3.67 days

## Score

- gate: **OK** 
- score: 66.1 (rank 10), confidence 1.0 
- components: income 7.36 / freshness 35.0 / resource 15.0 / registration 8.78
