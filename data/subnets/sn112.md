...
- miner_burn: **0.8076474803965539**
- registration cost: 0.99 TAO (191.8026 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 13  |  free: 0
- subnet age: 439.4 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 283.4981177293359** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 736.9601605424156
- top_miner_usd_day: 1190.4222033554954 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.30765709402752783  |  top1_share: 0.8076570940275277  |  top10_share: 1.0
- owner_incentive_share: 0.8076570940275277 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 275.2789 USD/day  |  payback on registration: 0.7 days
...
- components: income 22.2 / freshness 35.0 / resource 11.25 / registration 9.77
