...
- miner_burn: **0.0**
- registration cost: 0.465292579 TAO (113.40576027966999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 93  |  free: 0
- subnet age: 214.4 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 48.19470510927448** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.61560615863173
- top_miner_usd_day: 26084.093210793675 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.6293 USD/day  |  payback on registration: 4.1 days

## Score

- gate: **OK** 
- score: 71.9 (rank 6), confidence 1.0 
- components: income 13.25 / freshness 35.0 / resource 15.0 / registration 8.63
