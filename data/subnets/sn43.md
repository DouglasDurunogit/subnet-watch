...
- registration cost: 0.1 TAO (21.349000000000004 USD), open=True
...
- **competitive_miner_usd_day: 24.592021209485672** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7997405271377453
- top_miner_usd_day: 2661.5864580973634 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.8364 USD/day  |  payback on registration: [UNKNOWN] days
