...
- miner_burn: **0.0**
- registration cost: 0.485268626 TAO (111.76706994032 USD), open=True
...
- **competitive_miner_usd_day: 40.46962530111816** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 23.99526455907006
- top_miner_usd_day: 21416.668964662527 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.8299 USD/day  |  payback on registration: 4.9 days

## Score

- gate: **OK** 
- score: 70.9 (rank 9), confidence 1.0 
- components: income 12.53 / freshness 35.0 / resource 15.0 / registration 8.37
