...
- subnet age: 326.5 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3594.0045685278687
- top_miner_usd_day: 3594.0045685278687 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-11T11:11:15Z
- scoring-related commit: fix(proof): retain failed experiment vms for rca + log evaluate refus… 2026-09-11T04:22:33Z
