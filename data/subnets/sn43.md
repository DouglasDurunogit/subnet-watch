...
- miner_burn: **0.799478797474876**
- registration cost: 0.1 TAO (19.272000000000002 USD), open=True
...
- **competitive_miner_usd_day: 23.513960820374855** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.3189649202918197
- top_miner_usd_day: 2382.914795477562 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 13  |  gini: 0.8576942445916491  |  top1_share: 0.7995391353446566  |  top10_share: 0.9998779166475912
- owner_incentive_share: 0.7995391353446566 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: -0.6907 USD/day  |  payback on registration: [UNKNOWN] days
