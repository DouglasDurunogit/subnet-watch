...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (174.8028 USD), open=True
- tempo: 1440.0  |  max_uids: 256  |  active: 15  |  free: 0
- subnet age: 231.8 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 685.4729315166642** (uid 140) <- the only figure quotable as achievable
- median_miner_usd_day: 520.3135336016262
- top_miner_usd_day: 3050.358933118388 (uid 130, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 270.6228 USD/day  |  payback on registration: 0.65 days

## Score

- gate: **OK** 
- score: 57.7 (rank 25), confidence 0.85 - hardware from README keywords, not curated
- components: income 22.14 / freshness 21.0 / resource 15.0 / registration 9.78
