...
- miner_burn: **0.7050063484348357**
- registration cost: 0.019728483 TAO (3.87901432746 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 244  |  free: 0
- subnet age: 957.0 days  |  registered at block 1907637
- weights_version: 1030  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6.596479671699755** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 4.975310938824392
- top_miner_usd_day: 2582.80130332095 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 235  |  gini: 0.7565945642871903  |  top1_share: 0.7120049314224072  |  top10_share: 0.7276005547850208
- owner_incentive_share: 0.7120049314224072 (independent check on miner_burn; disagreement 0.007)
...
- net margin: -3.2439 USD/day  |  payback on registration: [UNKNOWN] days
