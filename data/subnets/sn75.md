...
- **competitive_miner_usd_day: 5.601883194823957** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 3.8512946964414696
- top_miner_usd_day: 10891.461401536477 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.4554 USD/day  |  payback on registration: [UNKNOWN] days
