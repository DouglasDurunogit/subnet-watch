...
- **competitive_miner_usd_day: 23.093574831247544** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.773393707811886
- top_miner_usd_day: 883.3591512522539 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.7871 USD/day  |  payback on registration: 4.32 days

## Score

- gate: **OK** 
- score: 65.5 (rank 14), confidence 1.0 
- components: income 6.93 / freshness 35.0 / resource 15.0 / registration 8.56
