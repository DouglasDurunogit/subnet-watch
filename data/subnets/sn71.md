...
- subnet age: 554.1 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3251.886184597477
- top_miner_usd_day: 3251.886184597477 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 9042 bytes, sha 5f4187a69996d6c4
- latest release: v2-cutover-legacy-final-certfix-20260720 2026-07-20T19:10:50Z
- last commit: 2026-09-10T14:52:50Z
- scoring-related commit: docs: state midnight continuous evaluation timing 2026-09-10T06:18:11Z
...
Do not include keys or `.env` files in the source directory. Placeholder-only `.env.example`, `.env.sample`, and `.env.template` files are allowed. Source limits are 10 MiB compressed, 50 MiB unpacked, and 1,000 files. Each hotkey can have one accepte
```

_(truncated at 6000 of 9042 chars - read the full file at https://github.com/leadpoet/leadpoet)_
