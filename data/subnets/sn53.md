...
- subnet age: 672.0 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1898.4822737934699** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 0.4901206334822434
- top_miner_usd_day: 5525.620021878812 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.7291 USD/day  |  payback on registration: [UNKNOWN] days
