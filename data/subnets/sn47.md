...
- subnet age: 250.7 days  |  registered at block 7340355
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1801.0759899771826
- top_miner_usd_day: 1801.0759899771826 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 19.3 (rank 80), confidence 0.6 - hardware requirement unknown; no README readable; repo unparsable
