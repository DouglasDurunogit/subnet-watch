...
- **competitive_miner_usd_day: 1450.3502820897122** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 16.739961704636563
- top_miner_usd_day: 35865.03315294975 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.5208 USD/day  |  payback on registration: 11.59 days

## Score

- gate: **OK** 
- score: 52.1 (rank 27), confidence 0.85 - hardware requirement unknown
- components: income 8.9 / freshness 35.0 / resource 11.25 / registration 6.14
