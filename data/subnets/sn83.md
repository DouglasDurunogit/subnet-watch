...
- miner_burn: **0.0**
- registration cost: 0.167702904 TAO (38.83328445024 USD), open=True
...
- **competitive_miner_usd_day: 128.44711765117046** (uid 241) <- the only figure quotable as achievable
- median_miner_usd_day: 24.476618127519178
- top_miner_usd_day: 128.44711765117046 (uid 241, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 13.4459 USD/day  |  payback on registration: 2.89 days

## Score

- gate: **OK** 
- score: 26.2 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 10.55 / freshness 0.0 / resource 11.25 / registration 9.04
