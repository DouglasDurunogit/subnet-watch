...
- **competitive_miner_usd_day: 1084.8744015576526** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.438207048867196
- top_miner_usd_day: 1084.8744015576526 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.8042 USD/day  |  payback on registration: [UNKNOWN] days
