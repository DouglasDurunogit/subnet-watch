...
- registration cost: 0.1 TAO (20.851 USD), open=True
...
- **competitive_miner_usd_day: 25.19827848820191** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8334060978588179
- top_miner_usd_day: 2580.372350635229 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8147 USD/day  |  payback on registration: [UNKNOWN] days
