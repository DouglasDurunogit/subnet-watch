...
- miner_burn: **0.0**
- registration cost: 0.200487268 TAO (39.46190896044 USD), open=True
...
- **competitive_miner_usd_day: 67.55758401705262** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 28.758888196148092
- top_miner_usd_day: 67.55758401705262 (uid 193, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.4112 USD/day  |  payback on registration: 2.4 days

## Score

- gate: **OK** 
- score: 27.0 (rank 68), confidence 0.85 - hardware requirement unknown
- components: income 11.29 / freshness 0.0 / resource 11.25 / registration 9.2
