...
- subnet age: 511.4 days  |  registered at block 5160047
- weights_version: 20250427  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1903.6944252557676
- top_miner_usd_day: 1903.6944252557676 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
