...
- **competitive_miner_usd_day: 910.3704219371949** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 8.51572282518926
- top_miner_usd_day: 910.3704219371949 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.0522 USD/day  |  payback on registration: 432.13 days

## Score

- gate: **OK** 
- score: 50.2 (rank 29), confidence 1.0 
- components: income 0.2 / freshness 35.0 / resource 15.0 / registration 0.0
