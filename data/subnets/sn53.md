...
- subnet age: 660.1 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7993.759318269884** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 11.914642876892755
- top_miner_usd_day: 7993.759318269884 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.6955 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 53.0 (rank 32), confidence 0.85 - hardware from README keywords, not curated
- components: income 6.11 / freshness 35.0 / resource 11.25 / registration 9.99
