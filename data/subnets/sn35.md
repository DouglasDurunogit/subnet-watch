...
- subnet age: 830.3 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1606.8745287278393** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 913.5500595614662
- top_miner_usd_day: 1606.8745287278393 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 905.3309 USD/day  |  payback on registration: 0.03 days
...
- components: income 26.9 / freshness 21.0 / resource 11.25 / registration 9.99
