...
- miner_burn: **0.0**
- registration cost: 0.923466809 TAO (192.44124832750998 USD), open=True
...
- **competitive_miner_usd_day: 3666.5413314166894** (uid 116) <- the only figure quotable as achievable
- median_miner_usd_day: 173.82655548098302
- top_miner_usd_day: 3666.5413314166894 (uid 116, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 217.922 USD/day  |  payback on registration: 0.88 days

## Score

- gate: **OK** 
- score: 65.7 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 21.29 / freshness 35.0 / resource 11.25 / registration 9.71
