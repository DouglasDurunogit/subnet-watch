...
- miner_burn: **0.0**
- registration cost: 0.14749909 TAO (35.1608330742 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 85  |  free: 0
- subnet age: 151.5 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 100.56109480826025** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 12.551004222644357
- top_miner_usd_day: 100.56109480826025 (uid 5, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 79  |  gini: 0.5217450616293964  |  top1_share: 0.03008700961685239  |  top10_share: 0.3008700961685239
...
- status: **ok** 
- README: 26823 bytes, sha 21f7a92af329817e
- latest release: SN78 direct bootstrap cutover v1 inputs 2026-09-09T16:23:03Z
- last commit: 2026-09-13T02:33:24Z
- scoring-related commit: Record finalized funding-cap rollout on both validators 2026-09-13T02:33:24Z
...
- net margin: 4.3318 USD/day  |  payback on registration: 8.12 days

## Score

- gate: **OK** 
- score: 51.1 (rank 29), confidence 0.85 - hardware requirement unknown
- components: income 6.61 / freshness 35.0 / resource 11.25 / registration 7.29
...
without scoring the fail
```

_(truncated at 6000 of 26823 chars - read the full file at https://github.com/Umi-BitSign/umi)_
