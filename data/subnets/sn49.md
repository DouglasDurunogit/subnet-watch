...
- subnet age: 281.2 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 43.064640048910896** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 43.064640048910896
- top_miner_usd_day: 4222.504393681228 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.8455 USD/day  |  payback on registration: 0.0 days
...
- components: income 14.14 / freshness 21.0 / resource 11.25 / registration 10.0
