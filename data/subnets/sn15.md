...
- miner_burn: **0.0**
- registration cost: 0.439501609 TAO (101.99074338454001 USD), open=True
...
- **competitive_miner_usd_day: 42.79318199415294** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 24.6735463750071
- top_miner_usd_day: 23445.266394526276 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.6872 USD/day  |  payback on registration: 4.31 days

## Score

- gate: **OK** 
- score: 71.2 (rank 4), confidence 1.0 
- components: income 12.66 / freshness 35.0 / resource 15.0 / registration 8.56
