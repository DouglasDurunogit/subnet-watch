...
- miner_burn: **0.8009330432396382**
- registration cost: 0.99 TAO (194.6043 USD), open=True
...
- **competitive_miner_usd_day: 297.9566624772578** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 748.4205411569419
- top_miner_usd_day: 1198.884419836626 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 289.7375 USD/day  |  payback on registration: 0.67 days
...
- components: income 22.41 / freshness 35.0 / resource 11.25 / registration 9.78
