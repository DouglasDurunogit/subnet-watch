...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (121.98 USD), open=True
...
- **competitive_miner_usd_day: 353.56983319828447** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 10.860506821790306
- top_miner_usd_day: 3536.3687336385096 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -18.7956 USD/day  |  payback on registration: [UNKNOWN] days
