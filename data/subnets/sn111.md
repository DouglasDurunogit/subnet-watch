...
- subnet age: 438.5 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2919.7129403937415
- top_miner_usd_day: 2919.7129403937415 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 9719 bytes, sha ad7da2fa9cfb4350
- latest release: (none) 
- last commit: 2026-08-04T11:35:22Z
- scoring-related commit: Improve agent validation and source grounding 2026-08-04T11:35:22Z
...
[docs/0009-v0-miner-validator.md](./docs
```

_(truncated at 6000 of 9719 chars - read the full file at https://github.com/DeSciClaims/Claims)_
