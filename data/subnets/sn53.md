...
- **competitive_miner_usd_day: 597.2740477238226** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 96.52913902607233
- top_miner_usd_day: 2074.8019108520666 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 86.8735 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.9 (rank 30), confidence 0.85 - hardware from README keywords, not curated
