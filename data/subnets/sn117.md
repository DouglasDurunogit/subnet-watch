...
- subnet age: 417.9 days  |  registered at block 5710859
- weights_version: 1030  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1717.4318921897648
- top_miner_usd_day: 1717.4318921897648 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 9.6 (rank 87), confidence 0.85 - hardware from README keywords, not curated
