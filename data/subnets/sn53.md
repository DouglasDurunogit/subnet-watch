...
- subnet age: 676.7 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4292.396150451813** (uid 168) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5471156905808187
- top_miner_usd_day: 6168.182295608149 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.6721 USD/day  |  payback on registration: [UNKNOWN] days
