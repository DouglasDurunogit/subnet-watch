...
- miner_burn: **0.0**
- registration cost: 0.250120573 TAO (49.94157481091 USD), open=True
...
- **competitive_miner_usd_day: 12317.287406561301** (uid 104) <- the only figure quotable as achievable
- median_miner_usd_day: 10.160312771679468
- top_miner_usd_day: 12317.287406561301 (uid 104, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.0744 USD/day  |  payback on registration: 5.5 days

## Score

- gate: **OK** 
- score: 67.3 (rank 13), confidence 1.0 
- components: income 9.12 / freshness 35.0 / resource 15.0 / registration 8.17
