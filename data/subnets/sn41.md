...
- subnet age: 786.2 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 95.23504818081405** (uid 167) <- the only figure quotable as achievable
- median_miner_usd_day: 42.401206897404684
- top_miner_usd_day: 95.23504818081405 (uid 167, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 80  |  gini: 0.3226809298419726  |  top1_share: 0.029269409878616686  |  top10_share: 0.25189709138102145
...
- net margin: 41.4149 USD/day  |  payback on registration: 0.56 days

## Score

- gate: **OK** 
- score: 50.1 (rank 33), confidence 1.0 
- components: income 14.8 / freshness 10.5 / resource 15.0 / registration 9.81
