...
- miner_burn: **0.0**
- registration cost: 0.326133387 TAO (65.08317870972 USD), open=True
...
- **competitive_miner_usd_day: 12480.059472654464** (uid 149) <- the only figure quotable as achievable
- median_miner_usd_day: 12.206791468683269
- top_miner_usd_day: 12480.059472654464 (uid 149, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 82  |  gini: 0.9403329987952904  |  top1_share: 0.928803725475227  |  top10_share: 0.943720894724788
...
- net margin: 11.2205 USD/day  |  payback on registration: 5.8 days

## Score

- gate: **OK** 
- score: 68.0 (rank 12), confidence 1.0 
- components: income 9.89 / freshness 35.0 / resource 15.0 / registration 8.07
