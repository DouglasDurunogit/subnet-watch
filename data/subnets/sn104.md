...
- **competitive_miner_usd_day: 13.91393689912921** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 5.475010673325991
- top_miner_usd_day: 2602.2766895812215 (uid 36, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.6948 USD/day  |  payback on registration: 32.86 days

## Score

- gate: **OK** 
- score: 15.9 (rank 73), confidence 0.85 - hardware requirement unknown
