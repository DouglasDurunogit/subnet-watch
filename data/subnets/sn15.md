...
- miner_burn: **0.0**
- registration cost: 0.269827991 TAO (52.86739827663 USD), open=True
...
- **competitive_miner_usd_day: 12594.388981639568** (uid 149) <- the only figure quotable as achievable
- median_miner_usd_day: 12.662058342618147
- top_miner_usd_day: 12594.388981639568 (uid 149, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.6758 USD/day  |  payback on registration: 4.53 days

## Score

- gate: **OK** 
- score: 68.5 (rank 11), confidence 1.0 
- components: income 10.03 / freshness 35.0 / resource 15.0 / registration 8.49
