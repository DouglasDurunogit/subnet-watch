...
- **competitive_miner_usd_day: 53.62557982798385** (uid 180) <- the only figure quotable as achievable
- median_miner_usd_day: 2682.6708003412928
- top_miner_usd_day: 5311.716020854602 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 45.4064 USD/day  |  payback on registration: 0.25 days
...
- components: income 15.16 / freshness 21.0 / resource 11.25 / registration 9.92
