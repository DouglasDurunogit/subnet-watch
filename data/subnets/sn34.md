...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (95.965 USD), open=True
...
- **competitive_miner_usd_day: 20.057430656410485** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 8.931824589182794
- top_miner_usd_day: 2755.494002209059 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.7094 USD/day  |  payback on registration: [UNKNOWN] days
