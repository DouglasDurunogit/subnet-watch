...
- **competitive_miner_usd_day: 598.7596158403202** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 221.65266316352097
- top_miner_usd_day: 598.7596158403202 (uid 4, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.4267194677165833  |  top1_share: 0.1612873689511514  |  top10_share: 0.9545544720658028
...
- net margin: 261.9563 USD/day  |  payback on registration: 0.0 days
