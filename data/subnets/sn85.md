...
- **competitive_miner_usd_day: 409.06929433968884** (uid 165) <- the only figure quotable as achievable
- median_miner_usd_day: 136.33909212415105
- top_miner_usd_day: 1431.794548156146 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 128.1199 USD/day  |  payback on registration: 0.0 days
