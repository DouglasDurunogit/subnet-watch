...
- registration cost: 0.1 TAO (21.892 USD), open=True
...
- **competitive_miner_usd_day: 25.40110760567297** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9474203441632054
- top_miner_usd_day: 2726.419690949229 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.8327 USD/day  |  payback on registration: [UNKNOWN] days
