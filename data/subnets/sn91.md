...
- subnet age: 198.7 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2823.2260108662404** (uid 165) <- the only figure quotable as achievable
- median_miner_usd_day: 705.8065027165601
- top_miner_usd_day: 2823.2260108662404 (uid 165, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-14T03:59:07Z
- scoring-related commit: feat(funding): miner-chosen submission label (`cascade fund --label`) 2026-09-14T02:21:06Z
...
- net margin: 1050.4906 USD/day  |  payback on registration: 0.02 days

## Score

- gate: **OK** 
- score: 71.2 (rank 2), confidence 0.85 - hardware requirement unknown
