...
- subnet age: 282.9 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3012.8299298202446
- top_miner_usd_day: 3012.8299298202446 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-07-29T19:10:48Z
- scoring-related commit: fix(agent-challenge): supply LLM_MODEL to the evaluated agent 2026-07-29T19:04:37Z
