...
- **competitive_miner_usd_day: 651.8975565584943** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 140.49858588666058
- top_miner_usd_day: 651.8975565584943 (uid 4, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 255.3078 USD/day  |  payback on registration: 0.0 days
