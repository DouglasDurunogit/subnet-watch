...
- subnet age: 102.1 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 77.33032590938777** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 53.164599062704085
- top_miner_usd_day: 1624.2909206809766 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 40.5394 USD/day  |  payback on registration: 0.49 days

## Score

- gate: **OK** 
- score: 70.8 (rank 3), confidence 1.0 
- components: income 14.72 / freshness 35.0 / resource 11.25 / registration 9.84
