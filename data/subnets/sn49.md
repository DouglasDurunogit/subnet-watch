...
- subnet age: 294.6 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 62.61689727342826** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 62.61689727342826
- top_miner_usd_day: 6139.610677238752 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 54.3977 USD/day  |  payback on registration: 0.2 days
...
- components: income 15.86 / freshness 21.0 / resource 11.25 / registration 9.93
