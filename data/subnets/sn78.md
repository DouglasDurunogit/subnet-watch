...
- miner_burn: **0.3063829429447651**
- registration cost: 0.75 TAO (240.3675 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 110  |  free: 0
- subnet age: 164.6 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 52.17764553176747** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 30.364248570326225
- top_miner_usd_day: 1167.9183578448467 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 107  |  gini: 0.5406891354872594  |  top1_share: 0.3066045659311293  |  top10_share: 0.408139268534779
...
- net margin: 21.767 USD/day  |  payback on registration: 11.04 days

## Score

- gate: **OK** 
- score: 55.2 (rank 24), confidence 0.85 - hardware requirement unknown
- components: income 12.34 / freshness 35.0 / resource 11.25 / registration 6.32
