...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (98.825 USD), open=True
...
- **competitive_miner_usd_day: 27.835245610412244** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 9.63944303239957
- top_miner_usd_day: 2857.49916318874 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.9496 USD/day  |  payback on registration: [UNKNOWN] days
