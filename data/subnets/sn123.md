...
- **competitive_miner_usd_day: 115.82305804301862** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 2.624509669548831
- top_miner_usd_day: 608.4090597590472 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.6212 USD/day  |  payback on registration: [UNKNOWN] days
