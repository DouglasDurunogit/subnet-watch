...
- **competitive_miner_usd_day: 118.09112610780282** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 2.654329649534791
- top_miner_usd_day: 609.5668040156646 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.671 USD/day  |  payback on registration: [UNKNOWN] days
