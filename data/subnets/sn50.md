...
- registration cost: 0.8 TAO (153.848 USD), open=True
...
- **competitive_miner_usd_day: 43.01824710809605** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 9.179052726886734
- top_miner_usd_day: 43.01824710809605 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.7362 USD/day  |  payback on registration: 88.61 days

## Score

- gate: **OK** 
- score: 30.8 (rank 57), confidence 0.85 - hardware requirement unknown
- components: income 3.98 / freshness 21.0 / resource 11.25 / registration 0.0
