...
- registration cost: 0.1 TAO (24.107 USD), open=True
...
- **competitive_miner_usd_day: 183.85674136390114** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 4.1106182012254315
- top_miner_usd_day: 2879.407972980469 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.9622 USD/day  |  payback on registration: 25.05 days

## Score

- gate: **OK** 
- score: 19.3 (rank 73), confidence 1.0 
- components: income 2.66 / freshness 0.0 / resource 15.0 / registration 1.65
