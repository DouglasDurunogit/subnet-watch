...
- registration cost: 0.1 TAO (19.673000000000002 USD), open=True
...
- **competitive_miner_usd_day: 10.121562593708168** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.414317682902866
- top_miner_usd_day: 2476.4863632376155 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.522 USD/day  |  payback on registration: [UNKNOWN] days
