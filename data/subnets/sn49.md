...
- subnet age: 312.3 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.13707376495579** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 2708.2587726050483
- top_miner_usd_day: 5362.380471445141 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 45.9179 USD/day  |  payback on registration: 0.29 days
...
- components: income 15.2 / freshness 10.5 / resource 11.25 / registration 9.9
