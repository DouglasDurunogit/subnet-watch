...
- miner_burn: **0.657882991945371**
- registration cost: 0.05 TAO (9.691500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 91
- subnet age: 246.4 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 331.1908586034731** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 331.1908586034731
- top_miner_usd_day: 1205.0774477027715 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.3310546179591256  |  top1_share: 0.6578875087740714  |  top10_share: 1.0
- owner_incentive_share: 0.6578875087740714 (independent check on miner_burn; disagreement 0.0)
...
- latest release: (none) 
- last commit: 2026-08-19T14:31:17Z
- scoring-related commit: docs(miner): say which architectures the image can actually load (#8) 2026-08-19T14:31:17Z
...
- net margin: 305.111 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 47.3 (rank 34), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 22.61 / freshness 35.0 / resource 11.25 / registration 9.99
