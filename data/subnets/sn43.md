...
- miner_burn: **0.7636335510760546**
- registration cost: 0.1 TAO (19.442 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 25  |  free: 0
- subnet age: 740.8 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.200449072868935** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.8790674836824108
- top_miner_usd_day: 2350.901328835064 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.899425432772903  |  top1_share: 0.7637623429940631  |  top10_share: 0.9972528730369488
- owner_incentive_share: 0.7637623429940631 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.7049 USD/day  |  payback on registration: 27.58 days

## Score

- gate: **OK** 
- score: 17.9 (rank 62), confidence 1.0 
- components: income 2.11 / freshness 0.0 / resource 15.0 / registration 0.81
