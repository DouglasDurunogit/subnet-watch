...
- miner_burn: **0.0**
- registration cost: 0.139669629 TAO (31.313930821799996 USD), open=True
...
- **competitive_miner_usd_day: 148.09696294593425** (uid 68) <- the only figure quotable as achievable
- median_miner_usd_day: 22.497090843478848
- top_miner_usd_day: 148.09696294593425 (uid 68, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 14.7044 USD/day  |  payback on registration: 2.13 days

## Score

- gate: **OK** 
- score: 26.7 (rank 70), confidence 0.85 - hardware requirement unknown
- components: income 10.88 / freshness 0.0 / resource 11.25 / registration 9.29
