...
- subnet age: 1034.2 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1019.0604295239924** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 15.023987557392301
- top_miner_usd_day: 1019.0604295239924 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.688 USD/day  |  payback on registration: 41.43 days

## Score

- gate: **OK** 
- score: 45.7 (rank 38), confidence 0.85 - hardware requirement unknown
- components: income 7.51 / freshness 35.0 / resource 11.25 / registration 0.0
