...
- subnet age: 163.0 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 147.0981044185205** (uid 61) <- the only figure quotable as achievable
- median_miner_usd_day: 72.40495584156065
- top_miner_usd_day: 1091.1177012034732 (uid 71, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 7  |  gini: 0.6392209694718396  |  top1_share: 0.7131019959714338  |  top10_share: 1.0
...
- net margin: 64.6358 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.5 (rank 3), confidence 1.0 
- components: income 16.53 / freshness 35.0 / resource 15.0 / registration 10.0
