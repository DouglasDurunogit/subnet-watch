...
- subnet age: 566.0 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.08716225137098436** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 2856.0454906730447
- top_miner_usd_day: 5712.003819094718 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.132 USD/day  |  payback on registration: [UNKNOWN] days
