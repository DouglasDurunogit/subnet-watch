...
- registration cost: 0.030141491 TAO (5.95324588741 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 144  |  free: 0
- subnet age: 225.4 days  |  registered at block 7236936
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 419.6808128043744** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 24.667364846958435
- top_miner_usd_day: 419.6808128043744 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 23.6811 USD/day  |  payback on registration: 0.25 days

## Score

- gate: **OK** 
- score: 72.6 (rank 2), confidence 1.0 
- components: income 12.66 / freshness 35.0 / resource 15.0 / registration 9.92
