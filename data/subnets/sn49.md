...
- **competitive_miner_usd_day: 3585.112359078002** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 1810.6533187920422
- top_miner_usd_day: 3585.112359078002 (uid 90, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3576.8932 USD/day  |  payback on registration: 0.0 days
...
- components: income 32.32 / freshness 21.0 / resource 11.25 / registration 10.0
