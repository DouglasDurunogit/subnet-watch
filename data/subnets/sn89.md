...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (13.002500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 120  |  free: 0
- subnet age: 527.5 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 87.3244771356623** (uid 142) <- the only figure quotable as achievable
- median_miner_usd_day: 0.049928231638457575
- top_miner_usd_day: 182.48768663856245 (uid 191, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 112  |  gini: 0.7488281565433361  |  top1_share: 0.11167636769176711  |  top10_share: 0.4776570878592053
...
- latest release: (none) 
- last commit: 2026-09-18T09:24:36Z
...
- net margin: -8.1692 USD/day  |  payback on registration: [UNKNOWN] days
