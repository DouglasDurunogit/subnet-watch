...
- subnet age: 704.3 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2077.585473775052** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 45.402736788659645
- top_miner_usd_day: 57482.05285814377 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 62  |  gini: 0.9228712676726409  |  top1_share: 0.8021649185483748  |  top10_share: 0.924487396754149
...
- last commit: 2026-09-10T11:33:40Z
- scoring-related commit: DAH-3006 - [P1] validator stops serialising every Redis command behin… 2026-09-10T02:42:59Z
...
- net margin: 36.0895 USD/day  |  payback on registration: 3.51 days

## Score

- gate: **OK** 
- score: 58.9 (rank 24), confidence 0.85 - hardware requirement unknown
- components: income 14.27 / freshness 35.0 / resource 11.25 / registration 8.83
