...
- subnet age: 502.6 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 71.81561003292104** (uid 216) <- the only figure quotable as achievable
- median_miner_usd_day: 23.07687468989806
- top_miner_usd_day: 78.2075753238093 (uid 248, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 246  |  gini: 0.3839683009604118  |  top1_share: 0.012718989818693247  |  top10_share: 0.11127587366618766
...
- net margin: 9.2647 USD/day  |  payback on registration: 2.13 days

## Score

- gate: **OK** 
- score: 25.3 (rank 66), confidence 0.85 - hardware requirement unknown
- components: income 9.2 / freshness 0.0 / resource 11.25 / registration 9.29
