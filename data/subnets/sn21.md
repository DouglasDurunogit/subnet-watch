...
- **competitive_miner_usd_day: 1186.4678753419694** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 11.116302538786625
- top_miner_usd_day: 1186.4678753419694 (uid 39, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6.4246 USD/day  |  payback on registration: 3.6 days

## Score

- gate: **OK** 
- score: 66.7 (rank 14), confidence 1.0 
- components: income 7.92 / freshness 35.0 / resource 15.0 / registration 8.8
