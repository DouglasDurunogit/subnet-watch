...
- subnet age: 246.3 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 158.08968915578646** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 158.08968915578646
- top_miner_usd_day: 1516.5638634786958 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 141.3371 USD/day  |  payback on registration: 0.07 days
