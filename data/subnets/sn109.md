...
- subnet age: 203.4 days  |  registered at block 7257480
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1679.6776674359821
- top_miner_usd_day: 1679.6776674359821 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- on-chain URL: `https://github.com/fx-integral/guardarena`
- resolved URL: `https://github.com/fx-integral/guardarena`
...
>  AI guard models that read policies and conversations, then predict exactly which rules were broken. Decentralized compliance auditing for the EU AI Act era.
