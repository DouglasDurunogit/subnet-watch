...
- miner_burn: **0.0**
- registration cost: 0.459493231 TAO (104.92068436654 USD), open=True
...
- **competitive_miner_usd_day: 39.71806913852279** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 22.84667693808833
- top_miner_usd_day: 21343.01410822461 (uid 146, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 21.5089 USD/day  |  payback on registration: 4.88 days

## Score

- gate: **OK** 
- score: 70.7 (rank 5), confidence 1.0 
- components: income 12.3 / freshness 35.0 / resource 15.0 / registration 8.37
