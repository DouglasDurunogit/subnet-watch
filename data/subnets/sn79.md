...
- miner_burn: **0.0**
- registration cost: 0.111001754 TAO (20.76953819094 USD), open=True
...
- **competitive_miner_usd_day: 562.461617941243** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 3.771168730366309
- top_miner_usd_day: 562.461617941243 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.7849 USD/day  |  payback on registration: 7.46 days

## Score

- gate: **OK** 
- score: 27.8 (rank 37), confidence 1.0 
- components: income 5.26 / freshness 0.0 / resource 15.0 / registration 7.51
