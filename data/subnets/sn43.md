...
- registration cost: 0.1 TAO (19.214 USD), open=True
...
- **competitive_miner_usd_day: 23.669795816211273** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9522331650199939
- top_miner_usd_day: 2381.3991124057166 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8049 USD/day  |  payback on registration: [UNKNOWN] days
