...
- registration cost: 0.1 TAO (23.926000000000002 USD), open=True
...
- **competitive_miner_usd_day: 190.9311821791918** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.59251963057527
- top_miner_usd_day: 2832.861264761375 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2444 USD/day  |  payback on registration: [UNKNOWN] days
