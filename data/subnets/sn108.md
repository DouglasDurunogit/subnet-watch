...
- miner_burn: **0.6565500556025654**
- registration cost: 0.05 TAO (9.963000000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 91
- subnet age: 246.6 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 347.64248654882954** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 347.64248654882954
- top_miner_usd_day: 1257.5042680736856 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.32975249488814984  |  top1_share: 0.6565599536118657  |  top10_share: 1.0
- owner_incentive_share: 0.6565599536118656 (independent check on miner_burn; disagreement 0.0)
...
- latest release: (none) 
- last commit: 2026-08-19T18:37:50Z
- scoring-related commit: feat(miner): refuse an architecture the image cannot load, at render … 2026-08-19T15:01:26Z
...
- net margin: 320.6749 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 47.4 (rank 31), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 22.81 / freshness 35.0 / resource 11.25 / registration 9.99
