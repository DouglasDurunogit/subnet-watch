...
- miner_burn: **0.712284670677036**
- registration cost: 0.0005 TAO (0.11693 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 256  |  free: 0
- subnet age: 993.2 days  |  registered at block 1907637
- weights_version: 1030  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4.991826059609257** (uid 176) <- the only figure quotable as achievable
- median_miner_usd_day: 4.6394618671662515
- top_miner_usd_day: 2741.334689841183 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 247  |  gini: 0.7236603239856512  |  top1_share: 0.7134843482514062  |  top10_share: 0.725177304964539
- owner_incentive_share: 0.7134843482514063 (independent check on miner_burn; disagreement 0.0012)
...
- net margin: -3.5797 USD/day  |  payback on registration: [UNKNOWN] days
