...
- subnet age: 183.6 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 138.47035124102322** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 92.8241513850222
- top_miner_usd_day: 309.76731910538643 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 81.9168 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 77.4 (rank 1), confidence 1.0 
- components: income 17.45 / freshness 35.0 / resource 15.0 / registration 9.91
