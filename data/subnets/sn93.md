...
- registration cost: 0.005 TAO (1.02675 USD), open=True
...
- **competitive_miner_usd_day: 24.65532747659917** (uid 152) <- the only figure quotable as achievable
- median_miner_usd_day: 185.83169036423033
- top_miner_usd_day: 2780.7445958098638 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.861 USD/day  |  payback on registration: 0.12 days
...
- components: income 9.04 / freshness 21.0 / resource 11.25 / registration 9.96
