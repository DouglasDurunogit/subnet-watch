...
- miner_burn: **0.5275547837372869**
- registration cost: 0.00838493 TAO (1.6688526179 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 78  |  free: 0
- subnet age: 948.8 days  |  registered at block 2009702
- weights_version: 1000910  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 225.4626904395021** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 10.551285308715117
- top_miner_usd_day: 1061.978419150532 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 68  |  gini: 0.8150428481875513  |  top1_share: 0.527848178570338  |  top10_share: 0.7720083055971173
- owner_incentive_share: 0.5278481785703381 (independent check on miner_burn; disagreement 0.0003)
...
- net margin: 2.0403 USD/day  |  payback on registration: 0.82 days

## Score

- gate: **OK** 
- score: 21.6 (rank 69), confidence 0.85 - hardware requirement unknown
- components: income 4.39 / freshness 0.0 / resource 11.25 / registration 9.73
