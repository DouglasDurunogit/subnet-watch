...
- miner_burn: **0.0**
- registration cost: 0.490771525 TAO (118.99737166675 USD), open=True
...
- **competitive_miner_usd_day: 47.34821314417257** (uid 249) <- the only figure quotable as achievable
- median_miner_usd_day: 28.40892788650354
- top_miner_usd_day: 26099.195961670543 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.2074 USD/day  |  payback on registration: 4.37 days

## Score

- gate: **OK** 
- score: 71.7 (rank 8), confidence 1.0 
- components: income 13.19 / freshness 35.0 / resource 15.0 / registration 8.54
