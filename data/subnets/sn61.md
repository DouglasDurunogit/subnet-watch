...
- miner_burn: **0.0**
- registration cost: 0.000649678 TAO (0.12851930196 USD), open=True
...
- **competitive_miner_usd_day: 754.277594619191** (uid 75) <- the only figure quotable as achievable
- median_miner_usd_day: 26.1947137044197
- top_miner_usd_day: 754.277594619191 (uid 75, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.9755 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 57.7 (rank 21), confidence 0.85 - hardware requirement unknown
- components: income 11.63 / freshness 35.0 / resource 11.25 / registration 10.0
