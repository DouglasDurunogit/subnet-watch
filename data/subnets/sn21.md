...
- miner_burn: **0.45077314344234765**
...
- **competitive_miner_usd_day: 24.904492891887607** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.197298578421106
- top_miner_usd_day: 851.5088246750598 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.211 USD/day  |  payback on registration: 3.69 days

## Score

- gate: **OK** 
- score: 31.0 (rank 42), confidence 1.0 
