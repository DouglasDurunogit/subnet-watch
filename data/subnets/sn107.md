...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (241.7283 USD), open=True
...
- **competitive_miner_usd_day: 44586.89055102425** (uid 99) <- the only figure quotable as achievable
- median_miner_usd_day: 159.44990759727165
- top_miner_usd_day: 44586.89055102425 (uid 99, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 158.4636 USD/day  |  payback on registration: 1.53 days

## Score

- gate: **OK** 
- score: 65.5 (rank 15), confidence 1.0 
- components: income 20.03 / freshness 21.0 / resource 15.0 / registration 9.49
