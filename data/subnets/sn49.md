...
- subnet age: 324.3 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 68.17577432959237** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 3410.5581640576393
- top_miner_usd_day: 6752.940553785686 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 59.9566 USD/day  |  payback on registration: 0.24 days
...
- components: income 16.23 / freshness 35.0 / resource 11.25 / registration 9.92
