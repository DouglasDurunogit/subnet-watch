...
- **competitive_miner_usd_day: 68.02967560804723** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 68.02967560804723
- top_miner_usd_day: 6670.3356588940715 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 59.8105 USD/day  |  payback on registration: 0.19 days
...
- components: income 16.23 / freshness 21.0 / resource 11.25 / registration 9.94
