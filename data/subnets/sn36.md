...
- miner_burn: **0.9505341446492821**
- registration cost: 0.999999999 TAO (218.81999978118 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 4  |  free: 237
- subnet age: 27.2 days  |  registered at block 8884359
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 802.7717507717749** (uid 12) <- the only figure quotable as achievable
- median_miner_usd_day: 8116.1437696818075
- top_miner_usd_day: 15429.515788591842 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 787.9772 USD/day  |  payback on registration: 0.28 days
...
- components: income 26.35 / freshness 35.0 / resource 7.5 / registration 9.91
