...
- miner_burn: **0.4507733976934105**
- registration cost: 0.1 TAO (19.086000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 134  |  free: 0
- subnet age: 778.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.260158550004558** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.036960750290486
- top_miner_usd_day: 829.4784070899128 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.0507 USD/day  |  payback on registration: 3.78 days

## Score

- gate: **OK** 
- score: 30.9 (rank 50), confidence 1.0 
- components: income 7.11 / freshness 0.0 / resource 15.0 / registration 8.74
