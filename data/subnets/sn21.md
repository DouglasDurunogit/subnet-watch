...
- **competitive_miner_usd_day: 1180.4869046532353** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 11.060265387648068
- top_miner_usd_day: 1180.4869046532353 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10.074 USD/day  |  payback on registration: 2.33 days

## Score

- gate: **OK** 
- score: 68.7 (rank 12), confidence 1.0 
- components: income 9.5 / freshness 35.0 / resource 15.0 / registration 9.22
