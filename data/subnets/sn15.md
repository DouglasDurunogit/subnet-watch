...
- miner_burn: **0.0**
- registration cost: 0.443797485 TAO (99.3041252436 USD), open=True
...
- **competitive_miner_usd_day: 21736.33950044421** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 19.183842108611184
- top_miner_usd_day: 21736.33950044421 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.1975 USD/day  |  payback on registration: 5.46 days

## Score

- gate: **OK** 
- score: 69.9 (rank 7), confidence 1.0 
- components: income 11.67 / freshness 35.0 / resource 15.0 / registration 8.18
