...
- subnet age: 809.2 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 875.5196553534208** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 322.1442155422488
- top_miner_usd_day: 875.5196553534208 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 499.3835 USD/day  |  payback on registration: 0.04 days
...
- components: income 24.55 / freshness 0.0 / resource 11.25 / registration 9.99
