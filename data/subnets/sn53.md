...
- subnet age: 660.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 8116.214651138019** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 12.09716170206682
- top_miner_usd_day: 8116.214651138019 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 152  |  gini: 0.9190564256064295  |  top1_share: 0.37920657470632263  |  top10_share: 0.9240486992652337
...
- status: **ok** 
- README: 6503 bytes, sha 89100b8e1880cc62
- latest release: v0.4.5: Merge pull request #42 from hanlinai/release/0.4.5 2026-08-22T04:00:05Z
- last commit: 2026-08-24T10:56:25Z
- scoring-related commit: tee_miner: log the WebSocket close code, and what the dying leg took … 2026-08-24T10:56:25Z
...
- net margin: 3.878 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 53.1 (rank 31), confidence 0.85 - hardware from README keywords, not curated
- components: income 6.26 / freshness 35.0 / resource 11.25 / registration 9.99
...
_(truncated at 6000 of 6503 chars - read the full file at https://github.com/hanlinai/engy)_
