...
- miner_burn: **0.0**
- registration cost: 0.244700738 TAO (48.19870436386 USD), open=True
...
- **competitive_miner_usd_day: 22.236086426713364** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 13.715716861337214
- top_miner_usd_day: 12822.948381999264 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.5216 USD/day  |  payback on registration: 3.85 days

## Score

- gate: **OK** 
- score: 69.0 (rank 10), confidence 1.0 
- components: income 10.29 / freshness 35.0 / resource 15.0 / registration 8.72
