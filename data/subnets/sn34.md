...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (96.595 USD), open=True
...
- **competitive_miner_usd_day: 19.23798442084787** (uid 175) <- the only figure quotable as achievable
- median_miner_usd_day: 9.671555009388
- top_miner_usd_day: 2772.897896550296 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.0226 USD/day  |  payback on registration: [UNKNOWN] days
