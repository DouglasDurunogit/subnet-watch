...
- subnet age: 229.0 days  |  registered at block 7457580
- weights_version: 20  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 25352.297371993012** (uid 75) <- the only figure quotable as achievable
- median_miner_usd_day: 299.62509485195284
- top_miner_usd_day: 25352.297371993012 (uid 75, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.8093941243800074  |  top1_share: 0.7999694772987409  |  top10_share: 0.9417016405951926
...
- net margin: 298.6388 USD/day  |  payback on registration: 0.84 days

## Score

- gate: **OK** 
- score: 68.2 (rank 9), confidence 1.0 
- components: income 22.52 / freshness 21.0 / resource 15.0 / registration 9.72
