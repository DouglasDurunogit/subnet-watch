...
- subnet age: 275.6 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 38.77452394905183** (uid 61) <- the only figure quotable as achievable
- median_miner_usd_day: 1939.7325591428726
- top_miner_usd_day: 3840.690594336693 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 30.5553 USD/day  |  payback on registration: 0.0 days
...
- components: income 13.63 / freshness 35.0 / resource 11.25 / registration 10.0
