...
- registration cost: 0.8 TAO (153.504 USD), open=True
...
- **competitive_miner_usd_day: 43.70792979149942** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 10.03429205140938
- top_miner_usd_day: 43.70792979149942 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.8151 USD/day  |  payback on registration: 84.57 days
