...
- miner_burn: **0.3009658141527325**
- registration cost: 0.1 TAO (22.881 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 796.8 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5.306601287781992** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 7.977590602632261
- top_miner_usd_day: 852.8769589723215 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-21T12:52:46Z
- scoring-related commit: feat(verify): mirror the daily verification feeds to the operator API… 2026-08-21T12:29:40Z
...
- net margin: -0.3495 USD/day  |  payback on registration: [UNKNOWN] days
