...
- **competitive_miner_usd_day: 24.261381750546747** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.037265134684665
- top_miner_usd_day: 829.8571931410972 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.051 USD/day  |  payback on registration: 3.72 days

## Score

- gate: **OK** 
- score: 30.9 (rank 43), confidence 1.0 
- components: income 7.11 / freshness 0.0 / resource 15.0 / registration 8.76
