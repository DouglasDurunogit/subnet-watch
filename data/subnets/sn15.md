...
- miner_burn: **0.0**
- registration cost: 0.785054025 TAO (183.80469887325 USD), open=True
...
- **competitive_miner_usd_day: 44.287326151522876** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 26.097888625004554
- top_miner_usd_day: 24006.10330945495 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 25.1116 USD/day  |  payback on registration: 7.32 days

## Score

- gate: **OK** 
- score: 70.4 (rank 6), confidence 1.0 
- components: income 12.89 / freshness 35.0 / resource 15.0 / registration 7.56
