...
- **competitive_miner_usd_day: 1485.299976130512** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 80.58899644415739
- top_miner_usd_day: 1808.7752535244213 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 67.8927 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.1 (rank 28), confidence 0.85 - hardware from README keywords, not curated
