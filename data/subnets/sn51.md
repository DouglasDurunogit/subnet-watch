...
- subnet age: 696.3 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1800.0042042447005** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 62.465899325386864
- top_miner_usd_day: 42941.19618756364 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 54  |  gini: 0.9193860863428469  |  top1_share: 0.7976823012092341  |  top10_share: 0.9357823378526932
...
- last commit: 2026-09-02T05:43:12Z
- scoring-related commit: DAH-2701: withhold incentive from executors running an outdated image… 2026-09-02T05:43:12Z
...
- net margin: 48.9042 USD/day  |  payback on registration: 2.22 days

## Score

- gate: **OK** 
- score: 60.3 (rank 23), confidence 0.85 - hardware requirement unknown
- components: income 15.44 / freshness 35.0 / resource 11.25 / registration 9.26
