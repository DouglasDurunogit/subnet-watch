...
- registration cost: 0.05 TAO (11.8175 USD), open=True
...
- **competitive_miner_usd_day: 54.33645777380552** (uid 117) <- the only figure quotable as achievable
- median_miner_usd_day: 2718.2331478996725
- top_miner_usd_day: 5382.12983802554 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 46.1173 USD/day  |  payback on registration: 0.26 days
...
- components: income 15.22 / freshness 10.5 / resource 11.25 / registration 9.91
