...
- **competitive_miner_usd_day: 10989.925644818779** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 1.015673483086052
- top_miner_usd_day: 10989.925644818779 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -7.2035 USD/day  |  payback on registration: [UNKNOWN] days
