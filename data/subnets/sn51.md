...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (111.995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 78  |  free: 0
- subnet age: 711.0 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2092.007179209563** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 36.863562629243404
- top_miner_usd_day: 48940.06574658354 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 68  |  gini: 0.9269555900046524  |  top1_share: 0.8108223654075182  |  top10_share: 0.9204812654594314
...
- last commit: 2026-09-17T05:33:07Z
- scoring-related commit: DAH-3264 - [P2] validator names a GPU benchmark that could not alloca… 2026-09-17T05:33:07Z
...
- net margin: 26.8012 USD/day  |  payback on registration: 4.18 days

## Score

- gate: **OK** 
- score: 57.8 (rank 14), confidence 0.85 - hardware requirement unknown
- components: income 13.13 / freshness 35.0 / resource 11.25 / registration 8.61
