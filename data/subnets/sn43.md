...
- registration cost: 0.1 TAO (19.936000000000003 USD), open=True
...
- **competitive_miner_usd_day: 10.633262353819937** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.5877408383190112
- top_miner_usd_day: 2487.1482944585377 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4923 USD/day  |  payback on registration: [UNKNOWN] days
