...
- miner_burn: **0.15056649409234524**
- registration cost: 0.1 TAO (22.948 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 35  |  free: 0
- subnet age: 811.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 26.691983712026094** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 10.009493892009786
- top_miner_usd_day: 1068.3357087362574 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-04T20:32:29Z
- scoring-related commit: feat(scoring): measurement resolution applied from a published date 2026-09-04T20:27:20Z
...
- net margin: -0.3846 USD/day  |  payback on registration: [UNKNOWN] days
