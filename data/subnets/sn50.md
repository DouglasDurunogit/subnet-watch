...
- registration cost: 0.8 TAO (157.24 USD), open=True
...
- **competitive_miner_usd_day: 45.42494738682822** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.109106303928975
- top_miner_usd_day: 45.42494738682822 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.8899 USD/day  |  payback on registration: 54.41 days

## Score

- gate: **OK** 
- score: 32.0 (rank 53), confidence 0.85 - hardware requirement unknown
- components: income 5.37 / freshness 21.0 / resource 11.25 / registration 0.0
