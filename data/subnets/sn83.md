...
- subnet age: 498.2 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 46.31981897531293** (uid 135) <- the only figure quotable as achievable
- median_miner_usd_day: 35.50233038745693
- top_miner_usd_day: 46.60574378380252 (uid 243, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 246  |  gini: 0.352355043754079  |  top1_share: 0.0074760354079713804  |  top10_share: 0.0718708434619089
...
- net margin: 7.602 USD/day  |  payback on registration: 2.63 days

## Score

- gate: **OK** 
- score: 24.5 (rank 65), confidence 0.85 - hardware requirement unknown
- components: income 8.5 / freshness 0.0 / resource 11.25 / registration 9.12
