...
- registration cost: 0.8 TAO (151.536 USD), open=True
...
- **competitive_miner_usd_day: 41.82071700462484** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 8.820857869283827
- top_miner_usd_day: 41.82071700462484 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.139 USD/day  |  payback on registration: 133.04 days

## Score

- gate: **OK** 
- score: 30.0 (rank 57), confidence 0.85 - hardware requirement unknown
- components: income 3.0 / freshness 21.0 / resource 11.25 / registration 0.0
