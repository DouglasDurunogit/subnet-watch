...
- miner_burn: **0.16689731972292066**
- registration cost: 0.1 TAO (23.836000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 29  |  free: 0
- subnet age: 804.9 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1392.703207720466** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 11.728794411613112
- top_miner_usd_day: 1392.703207720466 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7874748183871558  |  top1_share: 0.49563518710701426  |  top10_share: 0.9987027653989379
- owner_incentive_share: 0.16691593919785117 (independent check on miner_burn; disagreement 0.0)
...
- last commit: 2026-08-29T15:04:15Z
- scoring-related commit: feat(scoring): honour the reference exemption on the lineage path 2026-08-29T14:49:37Z
...
- net margin: 2.2514 USD/day  |  payback on registration: 10.59 days

## Score

- gate: **OK** 
- score: 61.1 (rank 21), confidence 1.0 
- components: income 4.66 / freshness 35.0 / resource 15.0 / registration 6.47
