...
- miner_burn: **0.5192725795786828**
- registration cost: 0.0005 TAO (0.101745 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 58  |  free: 0
- subnet age: 944.9 days  |  registered at block 2009702
- weights_version: 1000910  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 134.83141515668916** (uid 37) <- the only figure quotable as achievable
- median_miner_usd_day: 16.27752720598881
- top_miner_usd_day: 1046.127008158261 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 48  |  gini: 0.7474752967694993  |  top1_share: 0.5194547480575782  |  top10_share: 0.7612309383157028
- owner_incentive_share: 0.5194547480575782 (independent check on miner_burn; disagreement 0.0002)
...
- net margin: 6.8748 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 25.0 (rank 63), confidence 0.85 - hardware requirement unknown
