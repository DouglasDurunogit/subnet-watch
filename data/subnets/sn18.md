...
- **competitive_miner_usd_day: 1598.6572904128695** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.1750309103849865
- top_miner_usd_day: 1598.6572904128695 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.0641 USD/day  |  payback on registration: [UNKNOWN] days
