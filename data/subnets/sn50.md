...
- subnet age: 557.8 days  |  registered at block 4763204
- weights_version: 100  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 37.02723323228252** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 7.960178642506533
- top_miner_usd_day: 37.02723323228252 (uid 151, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 226  |  gini: 0.40358140846167934  |  top1_share: 0.012550446373975786  |  top10_share: 0.11049284578696343
...
- net margin: -0.259 USD/day  |  payback on registration: [UNKNOWN] days
