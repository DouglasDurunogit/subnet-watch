...
- miner_burn: **0.0**
- registration cost: 0.290008149 TAO (56.71399361844 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 79  |  free: 0
- subnet age: 207.4 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 22.03497313958532** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 13.694632839088072
- top_miner_usd_day: 12687.819907504589 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.6054 USD/day  |  payback on registration: 4.5 days

## Score

- gate: **OK** 
- score: 68.8 (rank 10), confidence 1.0 
- components: income 10.31 / freshness 35.0 / resource 15.0 / registration 8.5
