...
- miner_burn: **0.0**
- registration cost: 0.076305428 TAO (17.06494591792 USD), open=True
...
- **competitive_miner_usd_day: 402.6459700524257** (uid 27) <- the only figure quotable as achievable
- median_miner_usd_day: 6.488539627195102
- top_miner_usd_day: 402.6459700524257 (uid 27, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.5022 USD/day  |  payback on registration: 3.1 days

## Score

- gate: **OK** 
- score: 31.4 (rank 58), confidence 1.0 
- components: income 7.39 / freshness 0.0 / resource 15.0 / registration 8.97
