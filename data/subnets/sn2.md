...
- subnet age: 842.6 days  |  registered at block 2734060
- weights_version: 11003  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 116.5503707952225** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 20.155905708480724
- top_miner_usd_day: 2082.520486750279 (uid 14, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.975 USD/day  |  payback on registration: 0.01 days
