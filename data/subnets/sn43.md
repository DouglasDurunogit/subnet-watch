...
- miner_burn: **0.7739210689906031**
- registration cost: 0.1 TAO (19.505000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 25  |  free: 0
- subnet age: 740.3 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12.499950635084982** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.792445751446148
- top_miner_usd_day: 2392.3490426801513 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.9015249302194823  |  top1_share: 0.7740251812285387  |  top10_share: 0.9973597863410911
- owner_incentive_share: 0.7740251812285388 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.6646 USD/day  |  payback on registration: 29.35 days

## Score

- gate: **OK** 
- score: 17.2 (rank 66), confidence 1.0 
- components: income 2.01 / freshness 0.0 / resource 15.0 / registration 0.22
