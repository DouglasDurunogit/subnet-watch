...
- subnet age: 436.9 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 359.93496832848** (uid 105) <- the only figure quotable as achievable
- median_miner_usd_day: 899.8236901822922
- top_miner_usd_day: 1439.712412036104 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 351.7158 USD/day  |  payback on registration: 0.56 days
...
- components: income 23.17 / freshness 35.0 / resource 11.25 / registration 9.81
