...
- registration cost: 0.99 TAO (195.9507 USD), open=True
...
- **competitive_miner_usd_day: 301.44088641630566** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 753.5907168080481
- top_miner_usd_day: 1205.7405471997906 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 293.2217 USD/day  |  payback on registration: 0.67 days
...
- components: income 22.45 / freshness 35.0 / resource 11.25 / registration 9.78
