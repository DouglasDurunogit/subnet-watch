...
- miner_burn: **0.0**
- registration cost: 0.084457962 TAO (16.24042151298 USD), open=True
...
- **competitive_miner_usd_day: 392.39784139335325** (uid 161) <- the only figure quotable as achievable
- median_miner_usd_day: 6.407051778873581
- top_miner_usd_day: 392.39784139335325 (uid 161, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 209  |  gini: 0.7275852015349278  |  top1_share: 0.08800868315651084  |  top10_share: 0.47610603234781546
...
- net margin: 5.4208 USD/day  |  payback on registration: 3.0 days

## Score

- gate: **OK** 
- score: 31.3 (rank 48), confidence 1.0 
- components: income 7.35 / freshness 0.0 / resource 15.0 / registration 9.0
