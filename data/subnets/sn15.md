...
- miner_burn: **0.0**
- registration cost: 0.333468336 TAO (65.32311233904 USD), open=True
...
- **competitive_miner_usd_day: 22.106607882442717** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 11.640205035445502
- top_miner_usd_day: 11876.139275323609 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.5561 USD/day  |  payback on registration: 6.19 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 1.0 
- components: income 9.67 / freshness 35.0 / resource 15.0 / registration 7.94
