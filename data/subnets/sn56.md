...
- subnet age: 667.2 days  |  registered at block 4312927
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5352.757015710067** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 1.2166278541654822
- top_miner_usd_day: 5352.757015710067 (uid 148, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 34  |  gini: 0.8769004328071599  |  top1_share: 0.4028814309479114  |  top10_share: 0.9978022984295591
...
- latest release: (none) 
- last commit: 2026-09-21T13:49:51Z
...
- net margin: -7.0026 USD/day  |  payback on registration: [UNKNOWN] days
