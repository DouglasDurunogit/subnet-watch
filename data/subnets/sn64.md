...
- **competitive_miner_usd_day: 9996.244618039143** (uid 21) <- the only figure quotable as achievable
- median_miner_usd_day: 2656.740990745697
- top_miner_usd_day: 9996.244618039143 (uid 21, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2336.8404 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 37.7 (rank 47), confidence 0.85 - hardware from README keywords, not curated
