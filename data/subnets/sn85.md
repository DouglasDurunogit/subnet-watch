...
- subnet age: 521.3 days  |  registered at block 5258781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 839.8085024603364** (uid 23) <- the only figure quotable as achievable
- median_miner_usd_day: 209.9521256150841
- top_miner_usd_day: 839.8085024603364 (uid 23, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 180.7077 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 53.4 (rank 25), confidence 0.85 - hardware requirement unknown
- components: income 20.55 / freshness 21.0 / resource 11.25 / registration 10.0
