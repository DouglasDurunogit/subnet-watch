...
- miner_burn: **0.7963956850580871**
- registration cost: 0.1 TAO (20.197000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 16  |  free: 0
- subnet age: 751.8 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.628084600760054** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 16.47004733944601
- top_miner_usd_day: 2550.706945676636 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 11  |  gini: 0.8372986695892235  |  top1_share: 0.7964443766213948  |  top10_share: 0.9999694796276514
- owner_incentive_share: 0.7964443766213948 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 2.6303 USD/day  |  payback on registration: 7.68 days

## Score

- gate: **OK** 
- score: 27.5 (rank 59), confidence 1.0 
- components: income 5.09 / freshness 0.0 / resource 15.0 / registration 7.44
