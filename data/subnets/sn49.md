...
- subnet age: 306.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 56.25644501047699** (uid 117) <- the only figure quotable as achievable
- median_miner_usd_day: 2814.282341463053
- top_miner_usd_day: 5572.3082379156285 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 48.0373 USD/day  |  payback on registration: 0.24 days
...
- components: income 15.38 / freshness 10.5 / resource 11.25 / registration 9.92
