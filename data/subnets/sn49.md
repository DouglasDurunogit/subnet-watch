...
- subnet age: 293.1 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 52.66898455674434** (uid 69) <- the only figure quotable as achievable
- median_miner_usd_day: 2692.3628969903934
- top_miner_usd_day: 5332.056809424042 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.49021881771294273  |  top1_share: 0.9902188177129428  |  top10_share: 1.0
...
- net margin: 44.4498 USD/day  |  payback on registration: 0.26 days
...
- components: income 15.08 / freshness 21.0 / resource 11.25 / registration 9.91
