...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (174.4624 USD), open=True
...
- **competitive_miner_usd_day: 820.1475548099102** (uid 140) <- the only figure quotable as achievable
- median_miner_usd_day: 622.5393486708434
- top_miner_usd_day: 3649.661868856442 (uid 130, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 323.9857 USD/day  |  payback on registration: 0.54 days

## Score

- gate: **OK** 
- score: 70.3 (rank 7), confidence 0.85 - hardware from README keywords, not curated
- components: income 22.85 / freshness 35.0 / resource 15.0 / registration 9.82
