...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (101.165 USD), open=True
...
- **competitive_miner_usd_day: 294.496170686501** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 10.158889891005153
- top_miner_usd_day: 2945.184979170306 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.6534 USD/day  |  payback on registration: [UNKNOWN] days
