...
- subnet age: 650.1 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 244.63113673018432** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 45.505667132081726
- top_miner_usd_day: 12511.00438970287 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 35.454 USD/day  |  payback on registration: 0.0 days
