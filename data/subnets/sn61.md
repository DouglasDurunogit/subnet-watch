...
- miner_burn: **0.0**
- registration cost: 0.000638518 TAO (0.1254049352 USD), open=True
...
- **competitive_miner_usd_day: 443.9956687806791** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 25.36343059782709
- top_miner_usd_day: 443.9956687806791 (uid 34, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.1443 USD/day  |  payback on registration: 0.01 days
