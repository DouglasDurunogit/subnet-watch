...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (197.2377 USD), open=True
...
- **competitive_miner_usd_day: 34921.73003048353** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 116.58132917600541
- top_miner_usd_day: 34921.73003048353 (uid 45, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 115.595 USD/day  |  payback on registration: 1.71 days

## Score

- gate: **OK** 
- score: 78.2 (rank 2), confidence 1.0 
- components: income 18.8 / freshness 35.0 / resource 15.0 / registration 9.43
