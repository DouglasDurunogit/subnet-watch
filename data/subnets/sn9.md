...
- subnet age: 1036.7 days  |  registered at block 1489797
- weights_version: 4062  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 203.66610292097045** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 10188.591136506015
- top_miner_usd_day: 20173.516170091058 (uid 128, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 195.4469 USD/day  |  payback on registration: 0.0 days
...
- components: income 20.86 / freshness 21.0 / resource 11.25 / registration 10.0
