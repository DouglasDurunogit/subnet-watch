...
- miner_burn: **0.0**
- registration cost: 0.000859219 TAO (0.16731571587 USD), open=True
...
- **competitive_miner_usd_day: 2092.3166628924473** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 97.3440042553119
- top_miner_usd_day: 2092.3166628924473 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 144  |  gini: 0.5375692397375003  |  top1_share: 0.11030501122600156  |  top10_share: 0.3140073007193805
...
- net margin: 88.4005 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 51.0 (rank 26), confidence 0.85 - hardware from README keywords, not curated
