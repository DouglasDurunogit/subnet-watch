...
- miner_burn: **0.0**
- registration cost: 0.112893402 TAO (21.27363267288 USD), open=True
...
- **competitive_miner_usd_day: 440.09738224808** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 5.406761800857112
- top_miner_usd_day: 440.09738224808 (uid 126, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 222  |  gini: 0.7423052409141442  |  top1_share: 0.1032774856304268  |  top10_share: 0.5150880518527577
...
- net margin: 4.4205 USD/day  |  payback on registration: 4.81 days

## Score

- gate: **OK** 
- score: 30.1 (rank 45), confidence 1.0 
- components: income 6.68 / freshness 0.0 / resource 15.0 / registration 8.4
