...
- miner_burn: **0.0**
- registration cost: 0.449960096 TAO (99.2836951824 USD), open=True
...
- **competitive_miner_usd_day: 21460.16444768797** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 18.940098280157233
- top_miner_usd_day: 21460.16444768797 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.9538 USD/day  |  payback on registration: 5.53 days

## Score

- gate: **OK** 
- score: 69.8 (rank 7), confidence 1.0 
- components: income 11.62 / freshness 35.0 / resource 15.0 / registration 8.16
