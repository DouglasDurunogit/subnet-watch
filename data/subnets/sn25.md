...
- subnet age: 839.9 days  |  registered at block 2998801
- weights_version: 20502  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 6785.061832587639
- top_miner_usd_day: 6785.061832587639 (uid 1, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-11T18:36:44Z
- scoring-related commit: Observe provisional validator intents from the retained V2 state 2026-09-11T17:13:28Z
