...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (22.46499977535 USD), open=True
...
- **competitive_miner_usd_day: 134.3596611343017** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 90.0685339019766
- top_miner_usd_day: 300.5714339023819 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 75.2941 USD/day  |  payback on registration: 0.3 days

## Score

- gate: **OK** 
- score: 77.0 (rank 1), confidence 1.0 
- components: income 17.12 / freshness 35.0 / resource 15.0 / registration 9.9
