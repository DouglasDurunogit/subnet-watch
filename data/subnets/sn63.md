...
- subnet age: 564.2 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.08770503552188202** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 2873.830898945509
- top_miner_usd_day: 5747.574092855495 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1315 USD/day  |  payback on registration: [UNKNOWN] days
