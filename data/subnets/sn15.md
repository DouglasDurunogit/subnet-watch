...
- miner_burn: **0.0**
- registration cost: 0.511820381 TAO (113.79302530773002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 75  |  free: 0
- subnet age: 213.1 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21858.91768950355** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 19.292025946318805
- top_miner_usd_day: 21858.91768950355 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.3057 USD/day  |  payback on registration: 6.22 days

## Score

- gate: **OK** 
- score: 69.6 (rank 8), confidence 1.0 
- components: income 11.69 / freshness 35.0 / resource 15.0 / registration 7.93
