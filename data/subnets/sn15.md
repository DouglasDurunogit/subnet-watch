...
- miner_burn: **0.0**
- registration cost: 0.217642124 TAO (42.45762554992 USD), open=True
...
- **competitive_miner_usd_day: 10590.939932605175** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 12.58890388700531
- top_miner_usd_day: 10590.939932605175 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.6026 USD/day  |  payback on registration: 3.66 days

## Score

- gate: **OK** 
- score: 68.8 (rank 7), confidence 1.0 
- components: income 10.01 / freshness 35.0 / resource 15.0 / registration 8.78
