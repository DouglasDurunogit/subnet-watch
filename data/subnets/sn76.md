...
- **competitive_miner_usd_day: 203.81835762010334** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 114.0223078900355
- top_miner_usd_day: 271.3794898311206 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 104.7714 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 78.4 (rank 1), confidence 1.0 
- components: income 18.41 / freshness 35.0 / resource 15.0 / registration 10.0
