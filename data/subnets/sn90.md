...
- miner_burn: **0.047732099425047636**
- registration cost: 0.0005 TAO (0.156365 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 9  |  free: 157
- subnet age: 73.6 days  |  registered at block 8618670
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 10907.828089318735** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 7727.06253845714
- top_miner_usd_day: 10907.828089318735 (uid 56, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.33978291166926056  |  top1_share: 0.5574053163243508  |  top10_share: 1.0
- owner_incentive_share: 0.047730948820459605 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 9238.5412 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 40.2 (rank 46), confidence 0.6 - hardware from README keywords, not curated; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 36.07 / freshness 21.0 / resource 0.0 / registration 10.0
