...
- subnet age: 325.8 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 59.33509325344186** (uid 220) <- the only figure quotable as achievable
- median_miner_usd_day: 3187.267214156606
- top_miner_usd_day: 6315.19933505977 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.4906918546098207  |  top1_share: 0.9906918546098209  |  top10_share: 1.0
...
- net margin: 51.1159 USD/day  |  payback on registration: 0.31 days

## Score

- gate: **OK** 
- score: 43.1 (rank 47), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 15.62 / freshness 35.0 / resource 11.25 / registration 9.9
