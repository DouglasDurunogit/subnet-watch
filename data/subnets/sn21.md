...
- **competitive_miner_usd_day: 34.89367698420679** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.541832667241295
- top_miner_usd_day: 859.1805293729917 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.5555 USD/day  |  payback on registration: 2.65 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 1.0 
- components: income 8.48 / freshness 35.0 / resource 15.0 / registration 9.12
