...
- miner_burn: **0.0**
- registration cost: 0.305486422 TAO (60.12889244226 USD), open=True
...
- **competitive_miner_usd_day: 12364.427057549825** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 11.730004262887013
- top_miner_usd_day: 12364.427057549825 (uid 13, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 66  |  gini: 0.94357377938032  |  top1_share: 0.9414063692711674  |  top10_share: 0.9555128087691979
...
- net margin: 10.844 USD/day  |  payback on registration: 5.54 days

## Score

- gate: **OK** 
- score: 67.9 (rank 10), confidence 1.0 
- components: income 9.76 / freshness 35.0 / resource 15.0 / registration 8.15
