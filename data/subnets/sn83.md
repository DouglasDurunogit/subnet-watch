...
- **competitive_miner_usd_day: 79.56242808276534** (uid 131) <- the only figure quotable as achievable
- median_miner_usd_day: 22.785926149147
- top_miner_usd_day: 89.3547269237211 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.8589 USD/day  |  payback on registration: 2.0 days

## Score

- gate: **OK** 
- score: 25.5 (rank 66), confidence 0.85 - hardware requirement unknown
- components: income 9.42 / freshness 0.0 / resource 11.25 / registration 9.33
