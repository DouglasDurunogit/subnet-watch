...
- miner_burn: **0.0**
- registration cost: 0.019848224 TAO (3.81026356128 USD), open=True
...
- **competitive_miner_usd_day: 3093.4903622065713** (uid 197) <- the only figure quotable as achievable
- median_miner_usd_day: 3093.4903622065713
- top_miner_usd_day: 3093.4903622065713 (uid 197, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3085.2712 USD/day  |  payback on registration: 0.0 days
...
- components: income 31.74 / freshness 35.0 / resource 11.25 / registration 10.0
