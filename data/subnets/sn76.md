...
- subnet age: 175.8 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 189.50780333177414** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 96.23459782457829
- top_miner_usd_day: 473.75885583908513 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.3653 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.6 (rank 3), confidence 1.0 
- components: income 14.61 / freshness 35.0 / resource 15.0 / registration 10.0
