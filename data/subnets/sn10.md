...
- subnet age: 861.6 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4778.292142934885
- top_miner_usd_day: 4778.292142934885 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-09-15T10:10:42Z
- scoring-related commit: feat: add campaign context coverage and reliability scoring for SGLan… 2026-09-15T10:10:42Z
