...
- **competitive_miner_usd_day: 900.9627745585027** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 62.69253165866195
- top_miner_usd_day: 34401.39569686185 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 41.5471 USD/day  |  payback on registration: 2.3 days

## Score

- gate: **OK** 
- score: 59.8 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 14.81 / freshness 35.0 / resource 11.25 / registration 9.23
