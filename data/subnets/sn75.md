...
- subnet age: 521.3 days  |  registered at block 5102795
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 10769.22379012672** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9129977779683538
- top_miner_usd_day: 10769.22379012672 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -7.3062 USD/day  |  payback on registration: [UNKNOWN] days
