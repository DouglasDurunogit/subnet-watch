...
- **competitive_miner_usd_day: 5.534556945085858** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 3.689704630057238
- top_miner_usd_day: 10440.354678440599 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.6133 USD/day  |  payback on registration: [UNKNOWN] days
