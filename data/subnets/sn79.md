...
- miner_burn: **0.0**
- registration cost: 0.030341106 TAO (8.82895843494 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 200  |  free: 0
- subnet age: 547.8 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 267.6612813773696** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 3.939212480795261
- top_miner_usd_day: 267.6612813773696 (uid 192, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 199  |  gini: 0.744500887112342  |  top1_share: 0.09975226327379494  |  top10_share: 0.5203082945926106
...
- net margin: 2.9529 USD/day  |  payback on registration: 2.99 days

## Score

- gate: **OK** 
- score: 50.4 (rank 30), confidence 1.0 
- components: income 5.43 / freshness 21.0 / resource 15.0 / registration 9.0
