...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (109.235 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 74  |  free: 0
- subnet age: 709.7 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1816.0997740302282** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 39.15158748521805
- top_miner_usd_day: 48519.49459986294 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 64  |  gini: 0.9309343747614323  |  top1_share: 0.8325521032139859  |  top10_share: 0.9319031987174593
...
- latest release: executor-v1.128 2026-09-14T13:02:06Z
- last commit: 2026-09-15T10:31:03Z
- scoring-related commit: DAH-2834 - [P0] validator consumes the executor's one-call /verify an… 2026-09-15T10:31:03Z
...
- net margin: 29.1528 USD/day  |  payback on registration: 3.75 days

## Score

- gate: **OK** 
- score: 58.2 (rank 17), confidence 0.85 - hardware requirement unknown
- components: income 13.45 / freshness 35.0 / resource 11.25 / registration 8.75
