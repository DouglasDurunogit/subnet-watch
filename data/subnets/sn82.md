...
- miner_burn: **0.0**
- registration cost: 0.000595766 TAO (0.1433412996 USD), open=True
...
- **competitive_miner_usd_day: 2217.867630672813** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2217.867630672813
- top_miner_usd_day: 2217.867630672813 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2209.6485 USD/day  |  payback on registration: 0.0 days
