...
- miner_burn: **0.0**
- registration cost: 0.153713938 TAO (35.08213206974 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 33  |  free: 0
- subnet age: 239.4 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5.505652371076639** (uid 37) <- the only figure quotable as achievable
- median_miner_usd_day: 3.3033914226459835
- top_miner_usd_day: 17977.056122039445 (uid 158, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 21  |  gini: 0.9500015988325614  |  top1_share: 0.9966424516207801  |  top10_share: 0.9989011659849825
...
- last commit: 2026-09-17T21:02:27Z
- scoring-related commit: fix(validator): delete orphaned retry_queue.add_progress on logs_s3_k… 2026-09-17T21:02:27Z
...
- net margin: 2.1794 USD/day  |  payback on registration: 16.1 days

## Score

- gate: **OK** 
- score: 59.2 (rank 17), confidence 1.0 
- components: income 4.57 / freshness 35.0 / resource 15.0 / registration 4.63
