...
- registration cost: 0.1 TAO (19.85 USD), open=True
...
- **competitive_miner_usd_day: 24.035316904140718** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.793398810427946
- top_miner_usd_day: 2456.4093876031816 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.823 USD/day  |  payback on registration: [UNKNOWN] days
