...
- miner_burn: **0.0**
- registration cost: 0.202782389 TAO (47.17529497696 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 51  |  free: 0
- subnet age: 151.1 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 89.55061549362429** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 89.55061549362429
- top_miner_usd_day: 89.55061549362429 (uid 5, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 45  |  gini: 0.1727996199879549  |  top1_share: 0.027162378807542558  |  top10_share: 0.2716237880754256
...
- status: **ok** 
- README: 26479 bytes, sha e23ea37f5b88d114
- latest release: SN78 direct bootstrap cutover v1 inputs 2026-09-09T16:23:03Z
- last commit: 2026-09-12T20:29:58Z
- scoring-related commit: Document live-miner bridge activation and finalized reward evidence 2026-09-12T20:29:58Z
...
- net margin: 81.3314 USD/day  |  payback on registration: 0.58 days

## Score

- gate: **OK** 
- score: 62.5 (rank 15), confidence 0.85 - hardware requirement unknown
- components: income 17.42 / freshness 35.0 / resource 11.25 / registration 9.81
...
deliberately low-accuracy and is a replacement target for m
```

_(truncated at 6000 of 26479 chars - read the full file at https://github.com/Umi-BitSign/umi)_
