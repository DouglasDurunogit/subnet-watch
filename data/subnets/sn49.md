...
- subnet age: 311.6 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 58.02099292606791** (uid 135) <- the only figure quotable as achievable
- median_miner_usd_day: 2902.555534669416
- top_miner_usd_day: 5747.090076412765 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 49.8018 USD/day  |  payback on registration: 0.26 days
...
- components: income 15.52 / freshness 10.5 / resource 11.25 / registration 9.91
