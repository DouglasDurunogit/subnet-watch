...
- registration cost: 0.119847626 TAO (27.79625989818 USD), open=True
...
- **competitive_miner_usd_day: 1621.0610607830831** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 41.77543805303768
- top_miner_usd_day: 2455.177307242069 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 31.1194 USD/day  |  payback on registration: 0.89 days

## Score

- gate: **OK** 
- score: 59.2 (rank 20), confidence 0.85 - hardware requirement unknown
- components: income 13.7 / freshness 35.0 / resource 11.25 / registration 9.7
