...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (104.6 USD), open=True
...
- **competitive_miner_usd_day: 29.941086382432655** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 9.673274062016704
- top_miner_usd_day: 3037.6383715223405 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.0309 USD/day  |  payback on registration: [UNKNOWN] days
