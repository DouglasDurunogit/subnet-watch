...
- subnet age: 297.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 68.5624247302625** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 68.5624247302625
- top_miner_usd_day: 6722.571913666639 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 60.3432 USD/day  |  payback on registration: 0.19 days
...
- components: income 16.26 / freshness 21.0 / resource 11.25 / registration 9.94
