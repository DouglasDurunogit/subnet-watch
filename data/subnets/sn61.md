...
- miner_burn: **0.0**
- registration cost: 0.000572153 TAO (0.12906055221 USD), open=True
...
- **competitive_miner_usd_day: 293.633913483867** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 26.406186289776812
- top_miner_usd_day: 293.633913483867 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.187 USD/day  |  payback on registration: 0.01 days
