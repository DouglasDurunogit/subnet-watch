...
- miner_burn: **0.7985708934720606**
- registration cost: 0.1 TAO (25.958 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 779.2 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 168.51806925123824
- top_miner_usd_day: 2864.314594411921 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.636751510712324  |  top1_share: 0.79860220960752  |  top10_share: 1.0
- owner_incentive_share: 0.79860220960752 (independent check on miner_burn; disagreement 0.0)
