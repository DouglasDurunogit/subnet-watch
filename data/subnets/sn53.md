...
- subnet age: 652.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 217.87279402515256** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 40.528147702556474
- top_miner_usd_day: 11142.520608290108 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 30.677 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.4 (rank 19), confidence 0.85 - hardware from README keywords, not curated
- components: income 13.65 / freshness 35.0 / resource 11.25 / registration 10.0
