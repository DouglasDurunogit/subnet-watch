...
- **competitive_miner_usd_day: 2409.6465820367075** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 35.894994421531266
- top_miner_usd_day: 2409.6465820367075 (uid 10, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 27.133 USD/day  |  payback on registration: 0.73 days
