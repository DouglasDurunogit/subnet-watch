...
- miner_burn: **0.0**
- registration cost: 0.489397881 TAO (113.97587250608998 USD), open=True
...
- **competitive_miner_usd_day: 21790.105547062994** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 23.325266963523838
- top_miner_usd_day: 21790.105547062994 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.339 USD/day  |  payback on registration: 5.1 days

## Score

- gate: **OK** 
- score: 70.7 (rank 4), confidence 1.0 
- components: income 12.44 / freshness 35.0 / resource 15.0 / registration 8.3
