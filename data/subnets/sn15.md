...
- miner_burn: **0.0**
- registration cost: 0.218227893 TAO (42.9036037638 USD), open=True
...
- **competitive_miner_usd_day: 20.17565000784391** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 9.645376538837658
- top_miner_usd_day: 10823.705291050155 (uid 74, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.5706 USD/day  |  payback on registration: 5.01 days

## Score

- gate: **OK** 
- score: 67.3 (rank 11), confidence 1.0 
- components: income 8.92 / freshness 35.0 / resource 15.0 / registration 8.33
