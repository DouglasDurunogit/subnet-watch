...
- registration cost: 0.002511483 TAO (0.49503841413000005 USD), open=True
...
- **competitive_miner_usd_day: 2.234539712578645** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 0.910368031050559
- top_miner_usd_day: 2446.489942353234 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.0759 USD/day  |  payback on registration: [UNKNOWN] days
