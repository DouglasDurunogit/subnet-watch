...
- registration cost: 0.1 TAO (20.413 USD), open=True
...
- **competitive_miner_usd_day: 23.66072035253324** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7678935611369813
- top_miner_usd_day: 2551.902277048473 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.8423 USD/day  |  payback on registration: [UNKNOWN] days
