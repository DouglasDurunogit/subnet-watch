...
- registration cost: 0.00144853 TAO (0.3368846221 USD), open=True
...
- **competitive_miner_usd_day: 2.500174057288647** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1539264879793756
- top_miner_usd_day: 2839.765006646911 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1676 USD/day  |  payback on registration: 2.01 days

## Score

- gate: **OK** 
- score: 45.9 (rank 38), confidence 1.0 
- components: income 0.61 / freshness 21.0 / resource 15.0 / registration 9.33
