...
- registration cost: 0.1 TAO (19.224000000000004 USD), open=True
...
- **competitive_miner_usd_day: 23.096682215066025** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7683827742781261
- top_miner_usd_day: 2381.7154063418575 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8055 USD/day  |  payback on registration: [UNKNOWN] days
