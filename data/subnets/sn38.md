...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (207.3702 USD), open=True
- tempo: 1440.0  |  max_uids: 256  |  active: 17  |  free: 0
- subnet age: 257.4 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1621.6806309726674** (uid 121) <- the only figure quotable as achievable
- median_miner_usd_day: 342.24191859603275
- top_miner_usd_day: 7216.711625460069 (uid 131, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 183.8921 USD/day  |  payback on registration: 1.13 days

## Score

- gate: **OK** 
- score: 68.2 (rank 8), confidence 0.85 - hardware from README keywords, not curated
- components: income 20.62 / freshness 35.0 / resource 15.0 / registration 9.62
