...
- miner_burn: **0.0**
- registration cost: 0.02 TAO (3.8416 USD), open=True
...
- **competitive_miner_usd_day: 4074.0501075805905** (uid 163) <- the only figure quotable as achievable
- median_miner_usd_day: 4074.0501075805905
- top_miner_usd_day: 4074.0501075805905 (uid 163, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4073.0638 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 67.0 (rank 11), confidence 0.85 - income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 32.83 / freshness 21.0 / resource 15.0 / registration 10.0
