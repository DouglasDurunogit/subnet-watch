...
- miner_burn: **0.0**
- registration cost: 0.000996345 TAO (0.23136127245000002 USD), open=True
...
- **competitive_miner_usd_day: 288.8745325736124** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 28.719162622883196
- top_miner_usd_day: 288.8745325736124 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 20.5 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 46.2 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 12.12 / freshness 21.0 / resource 11.25 / registration 10.0
