...
- **competitive_miner_usd_day: 35.03591111486412** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.576651013963405
- top_miner_usd_day: 862.6535616799722 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.5903 USD/day  |  payback on registration: 2.6 days
