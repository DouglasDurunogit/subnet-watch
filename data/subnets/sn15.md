...
- miner_burn: **0.0**
- registration cost: 0.373513385 TAO (76.271433217 USD), open=True
...
- **competitive_miner_usd_day: 17447.42775657486** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 19.44633706004551
- top_miner_usd_day: 17447.42775657486 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.46 USD/day  |  payback on registration: 4.13 days

## Score

- gate: **OK** 
- score: 70.3 (rank 5), confidence 1.0 
- components: income 11.72 / freshness 35.0 / resource 15.0 / registration 8.62
