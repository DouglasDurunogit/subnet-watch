...
- miner_burn: **0.0**
- registration cost: 0.273845183 TAO (52.65769023906999 USD), open=True
...
- **competitive_miner_usd_day: 19.563172159666387** (uid 73) <- the only figure quotable as achievable
- median_miner_usd_day: 11.871668575524046
- top_miner_usd_day: 9973.539256237442 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 93  |  gini: 0.9281009112322365  |  top1_share: 0.9108650836069329  |  top10_share: 0.9263953577155074
...
- net margin: 10.8854 USD/day  |  payback on registration: 4.84 days

## Score

- gate: **OK** 
- score: 68.2 (rank 11), confidence 1.0 
- components: income 9.78 / freshness 35.0 / resource 15.0 / registration 8.39
