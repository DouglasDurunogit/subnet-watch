...
- **competitive_miner_usd_day: 3.1542377364576213** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 2.2710511702494873
- top_miner_usd_day: 7936.692992474666 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.0649 USD/day  |  payback on registration: [UNKNOWN] days
