...
- **competitive_miner_usd_day: 5256.687367870657** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 62.33866122378571
- top_miner_usd_day: 35242.39300951448 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.8797 USD/day  |  payback on registration: 3.28 days

## Score

- gate: **OK** 
- score: 58.8 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 14.03 / freshness 35.0 / resource 11.25 / registration 8.91
