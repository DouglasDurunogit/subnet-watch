...
- miner_burn: **0.0**
- registration cost: 0.476769464 TAO (118.0719577596 USD), open=True
...
- **competitive_miner_usd_day: 42.49332259040111** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 24.500654466537572
- top_miner_usd_day: 23291.70029770436 (uid 146, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.1315 USD/day  |  payback on registration: 5.1 days

## Score

- gate: **OK** 
- score: 70.9 (rank 4), confidence 1.0 
- components: income 12.57 / freshness 35.0 / resource 15.0 / registration 8.3
