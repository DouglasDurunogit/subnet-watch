...
- subnet age: 116.3 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 291.5272466407477** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 28.627770977158722
- top_miner_usd_day: 2040.824189286992 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 20.4638 USD/day  |  payback on registration: 1.15 days

## Score

- gate: **OK** 
- score: 54.0 (rank 29), confidence 1.0 
- components: income 12.11 / freshness 21.0 / resource 11.25 / registration 9.62
