...
- **competitive_miner_usd_day: 901.4875163495657** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 8.432630975933423
- top_miner_usd_day: 901.4875163495657 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.0421 USD/day  |  payback on registration: 533.92 days

## Score

- gate: **OK** 
- score: 50.2 (rank 31), confidence 1.0 
- components: income 0.16 / freshness 35.0 / resource 15.0 / registration 0.0
