...
- subnet age: 502.2 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 120.77759594134238** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 10.889375673591593
- top_miner_usd_day: 120.77759594134238 (uid 218, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.7448 USD/day  |  payback on registration: 4.21 days

## Score

- gate: **OK** 
- score: 51.1 (rank 30), confidence 0.85 - hardware requirement unknown
- components: income 5.22 / freshness 35.0 / resource 11.25 / registration 8.6
