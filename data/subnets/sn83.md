...
- miner_burn: **0.0**
- registration cost: 0.141479826 TAO (29.21699886726 USD), open=True
...
- **competitive_miner_usd_day: 71.94161006461138** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 20.224351392992666
- top_miner_usd_day: 135.71474730382914 (uid 153, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.3813 USD/day  |  payback on registration: 2.81 days

## Score

- gate: **OK** 
- score: 25.4 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 9.61 / freshness 0.0 / resource 11.25 / registration 9.06
