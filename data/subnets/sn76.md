...
- tempo: 360.0  |  max_uids: 256  |  active: 7  |  free: 135
- subnet age: 17.6 days  |  registered at block 9003844
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 958.1056703545541** (uid 120) <- the only figure quotable as achievable
- median_miner_usd_day: 2899.090266922862
- top_miner_usd_day: 4840.0748634911715 (uid 102, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.33475753044221324  |  top1_share: 0.8347575304422132  |  top10_share: 1.0
...
- status: **ok** 
- README: 13526 bytes, sha 95ecd854f01c78a3
- latest release: (none) 
- last commit: 2026-09-16T22:54:39Z
- scoring-related commit: feat(client): optional chosen miner_id on registration — receipts, pr… 2026-09-16T14:56:09Z
...
- net margin: 949.8865 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.0 (rank 39), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
...
_(truncated at 6000 of 13526 chars - read the full file at https://github.com/heroncovelabs/ormas-subnet)_
