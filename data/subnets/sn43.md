...
- **competitive_miner_usd_day: 11.584134645916869** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.760788466179364
- top_miner_usd_day: 2419.87939099345 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.9055330428321855  |  top1_share: 0.797008775276612  |  top10_share: 0.9973597863410911
- owner_incentive_share: 0.797008775276612 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.4038 USD/day  |  payback on registration: 47.38 days

## Score

- gate: **OK** 
- score: 16.3 (rank 67), confidence 1.0 
- components: income 1.34 / freshness 0.0 / resource 15.0 / registration 0.0
