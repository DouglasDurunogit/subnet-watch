...
- **competitive_miner_usd_day: 35.042675524516696** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.578306914411247
- top_miner_usd_day: 862.8201148505271 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.592 USD/day  |  payback on registration: 2.58 days
