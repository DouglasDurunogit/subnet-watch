...
- **competitive_miner_usd_day: 288.2171887007824** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 720.5319769709724
- top_miner_usd_day: 1152.8467652411628 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 279.998 USD/day  |  payback on registration: 0.68 days
...
- components: income 22.27 / freshness 35.0 / resource 11.25 / registration 9.77
