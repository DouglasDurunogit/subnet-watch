...
- subnet age: 807.0 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 932.2708991556182** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 343.1068093230474
- top_miner_usd_day: 932.2708991556182 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 924.0517 USD/day  |  payback on registration: 0.02 days
...
- components: income 26.98 / freshness 0.0 / resource 11.25 / registration 9.99
