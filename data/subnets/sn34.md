...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (95.685 USD), open=True
...
- **competitive_miner_usd_day: 22.07781339328415** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 8.956094112369986
- top_miner_usd_day: 2747.021517396459 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.685 USD/day  |  payback on registration: [UNKNOWN] days
