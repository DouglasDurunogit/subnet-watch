...
- **competitive_miner_usd_day: 1133.081217104148** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 2.808980143231399
- top_miner_usd_day: 1133.081217104148 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.4102 USD/day  |  payback on registration: [UNKNOWN] days
