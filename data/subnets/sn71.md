...
- subnet age: 522.4 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2284.0503729519846
- top_miner_usd_day: 2284.0503729519846 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-09T22:02:33Z
- scoring-related commit: Close and verify dev snapshot request sets 2026-08-09T20:10:42Z
