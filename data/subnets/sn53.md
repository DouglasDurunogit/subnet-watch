...
- miner_burn: **0.0**
- registration cost: 0.001051537 TAO (0.24407225307 USD), open=True
...
- **competitive_miner_usd_day: 316.0206086200458** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 44.50573788694406
- top_miner_usd_day: 12236.090956635322 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 35.9879 USD/day  |  payback on registration: 0.01 days
