...
- **competitive_miner_usd_day: 948.2535598976862** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7219995343808524
- top_miner_usd_day: 948.2535598976862 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.3945 USD/day  |  payback on registration: [UNKNOWN] days
