...
- **competitive_miner_usd_day: 101.77109102033144** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 21.821441463037086
- top_miner_usd_day: 101.77109102033144 (uid 57, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8.6025 USD/day  |  payback on registration: 2.28 days

## Score

- gate: **OK** 
- score: 25.0 (rank 68), confidence 0.85 - hardware requirement unknown
- components: income 8.93 / freshness 0.0 / resource 11.25 / registration 9.24
