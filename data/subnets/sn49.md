...
- **competitive_miner_usd_day: 68.7222711971219** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 68.7222711971219
- top_miner_usd_day: 6738.244920752303 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 60.5031 USD/day  |  payback on registration: 0.19 days
...
- components: income 16.27 / freshness 21.0 / resource 11.25 / registration 9.94
