...
- **competitive_miner_usd_day: 10.992629196024865** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 5.070069792452284
- top_miner_usd_day: 2801.1911263927523 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -3.1491 USD/day  |  payback on registration: [UNKNOWN] days
