...
- **competitive_miner_usd_day: 202.0979622457169** (uid 80) <- the only figure quotable as achievable
- median_miner_usd_day: 26.7799174513924
- top_miner_usd_day: 2270.3514582746375 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.4746 USD/day  |  payback on registration: 1.3 days

## Score

- gate: **OK** 
- score: 67.5 (rank 11), confidence 1.0 
- components: income 11.73 / freshness 35.0 / resource 11.25 / registration 9.57
