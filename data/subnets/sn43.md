...
- miner_burn: **0.7964779166504741**
- registration cost: 0.1 TAO (19.875 USD), open=True
...
- **competitive_miner_usd_day: 32.4370402361921** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 16.290602429732033
- top_miner_usd_day: 2508.320280308917 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 11  |  gini: 0.8378885684200887  |  top1_share: 0.7965480932106396  |  top10_share: 0.9999694791618978
- owner_incentive_share: 0.7965480932106396 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 2.2334 USD/day  |  payback on registration: 8.9 days

## Score

- gate: **OK** 
- score: 26.7 (rank 62), confidence 1.0 
- components: income 4.64 / freshness 0.0 / resource 15.0 / registration 7.03
