...
- subnet age: 137.6 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 426.68636109046224** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 27.92707277002833
- top_miner_usd_day: 1830.5745764095996 (uid 126, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.7730810315885854  |  top1_share: 0.6821913627346254  |  top10_share: 1.0
...
- net margin: 22.4293 USD/day  |  payback on registration: 1.2 days

## Score

- gate: **OK** 
- score: 43.8 (rank 39), confidence 1.0 
- components: income 12.46 / freshness 10.5 / resource 11.25 / registration 9.6
