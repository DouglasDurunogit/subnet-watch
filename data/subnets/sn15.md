...
- miner_burn: **0.0**
- registration cost: 0.278026719 TAO (54.67673455854 USD), open=True
...
- **competitive_miner_usd_day: 12192.517460225845** (uid 149) <- the only figure quotable as achievable
- median_miner_usd_day: 12.1756124776123
- top_miner_usd_day: 12192.517460225845 (uid 149, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.1893 USD/day  |  payback on registration: 4.89 days

## Score

- gate: **OK** 
- score: 68.2 (rank 13), confidence 1.0 
- components: income 9.88 / freshness 35.0 / resource 15.0 / registration 8.37
