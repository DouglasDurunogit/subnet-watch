...
- miner_burn: **0.9027309454977512**
- registration cost: 0.038166027 TAO (8.098449269129999 USD), open=True
...
- **competitive_miner_usd_day: 2.14936682859541** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1404803580302176
- top_miner_usd_day: 2595.031460810295 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 239  |  gini: 0.92827059016659  |  top1_share: 0.9045594935934681  |  top10_share: 0.9113024066542308
- owner_incentive_share: 0.9045594935934681 (independent check on miner_burn; disagreement 0.0018)
...
- net margin: 0.1542 USD/day  |  payback on registration: 52.52 days

## Score

- gate: **OK** 
- score: 36.6 (rank 50), confidence 1.0 
- components: income 0.57 / freshness 21.0 / resource 15.0 / registration 0.0
