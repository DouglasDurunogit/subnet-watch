...
- subnet age: 841.8 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4687.241819725207
- top_miner_usd_day: 4687.241819725207 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-25T20:05:38Z
- scoring-related commit: feat(chain): validator-side set_weights with permit check (PAR-104) 2026-08-25T10:50:13Z
