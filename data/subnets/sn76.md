...
- subnet age: 172.4 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 208.43189955788395** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 132.149996839103
- top_miner_usd_day: 521.1040077284573 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 68.8549 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.8 (rank 2), confidence 1.0 
- components: income 16.77 / freshness 35.0 / resource 15.0 / registration 10.0
