...
- subnet age: 684.7 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1664.4582165834088** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 99.25668264029503
- top_miner_usd_day: 42106.04213235695 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 49.4685 USD/day  |  payback on registration: 2.35 days

## Score

- gate: **OK** 
- score: 60.3 (rank 18), confidence 0.85 - hardware requirement unknown
- components: income 15.49 / freshness 35.0 / resource 11.25 / registration 9.22
