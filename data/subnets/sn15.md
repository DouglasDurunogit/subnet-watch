...
- miner_burn: **0.0**
- registration cost: 0.483470291 TAO (112.21828924401001 USD), open=True
...
- **competitive_miner_usd_day: 43.41425177972233** (uid 97) <- the only figure quotable as achievable
- median_miner_usd_day: 23.217186821329765
- top_miner_usd_day: 22681.49270589128 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.2309 USD/day  |  payback on registration: 5.05 days

## Score

- gate: **OK** 
- score: 70.7 (rank 6), confidence 1.0 
- components: income 12.42 / freshness 35.0 / resource 15.0 / registration 8.32
