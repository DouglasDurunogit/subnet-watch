...
- miner_burn: **0.0**
- registration cost: 0.05645521 TAO (13.4075478229 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 75  |  free: 0
- subnet age: 505.5 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 97.80131695789228** (uid 211) <- the only figure quotable as achievable
- median_miner_usd_day: 11.276987425858316
- top_miner_usd_day: 104.70404692932574 (uid 45, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 68  |  gini: 0.6188627067769121  |  top1_share: 0.06322716584725319  |  top10_share: 0.4846092771856964
...
- latest release: (none) 
- last commit: 2026-08-29T16:20:07Z
- scoring-related commit: HF: grade the band the miner declared, not the board's 2026-08-29T16:20:07Z
...
- net margin: 1.4649 USD/day  |  payback on registration: 9.15 days

## Score

- gate: **OK** 
- score: 48.2 (rank 41), confidence 0.85 - hardware requirement unknown
- components: income 3.56 / freshness 35.0 / resource 11.25 / registration 6.95
