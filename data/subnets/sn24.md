...
- subnet age: 864.8 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1029.4239437966385** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 744.197846276243
- top_miner_usd_day: 1029.4239437966385 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 306.9376 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 27.7 (rank 58), confidence 0.85 - hardware from README keywords, not curated
- components: income 22.63 / freshness 0.0 / resource 0.0 / registration 10.0
