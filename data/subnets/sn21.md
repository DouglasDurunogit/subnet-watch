...
- miner_burn: **0.15057248435914516**
- registration cost: 0.1 TAO (25.415000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 803.2 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1277.7861682996424** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 11.971885562094748
- top_miner_usd_day: 1277.7861682996424 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826492537313434  |  top1_share: 0.4471202270854317  |  top10_share: 0.9986875438757133
...
- net margin: 0.9763 USD/day  |  payback on registration: 26.03 days

## Score

- gate: **OK** 
- score: 54.0 (rank 28), confidence 1.0 
- components: income 2.69 / freshness 35.0 / resource 15.0 / registration 1.32
