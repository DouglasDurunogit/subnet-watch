...
- miner_burn: **0.9999768557026982**  <- 100% burn: miners earn NOTHING here
- registration cost: 0.999999999 TAO (191.04999980895002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 4  |  free: 251
- subnet age: 67.2 days  |  registered at block 8238082
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3872.0317107418496
- top_miner_usd_day: 3872.0317107418496 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- on-chain URL: `https://github.com/CookingTao`
- resolved URL: `(none)`
- status: **org_only** - points at an org/user, not a repository: 'https://github.com/CookingTao'
