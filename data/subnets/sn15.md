...
- miner_burn: **0.0**
- registration cost: 0.353230173 TAO (80.15145855543 USD), open=True
...
- **competitive_miner_usd_day: 23183.378310815064** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 20.46095521510364
- top_miner_usd_day: 23183.378310815064 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.4747 USD/day  |  payback on registration: 4.12 days

## Score

- gate: **OK** 
- score: 70.6 (rank 5), confidence 1.0 
- components: income 11.93 / freshness 35.0 / resource 15.0 / registration 8.63
