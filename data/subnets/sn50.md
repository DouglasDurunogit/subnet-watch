...
- registration cost: 0.8 TAO (166.808 USD), open=True
...
- **competitive_miner_usd_day: 47.28372680978967** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 14.837130345308594
- top_miner_usd_day: 47.28372680978967 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 6.618 USD/day  |  payback on registration: 25.21 days

## Score

- gate: **OK** 
- score: 35.6 (rank 55), confidence 0.85 - hardware requirement unknown
- components: income 8.02 / freshness 21.0 / resource 11.25 / registration 1.6
