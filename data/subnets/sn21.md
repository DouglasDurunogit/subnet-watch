...
- **competitive_miner_usd_day: 23.650152005176956** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.912538001294239
- top_miner_usd_day: 904.6489491099426 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.9262 USD/day  |  payback on registration: 4.12 days

## Score

- gate: **OK** 
- score: 65.7 (rank 15), confidence 1.0 
- components: income 7.03 / freshness 35.0 / resource 15.0 / registration 8.63
