...
- subnet age: 494.2 days  |  registered at block 5370681
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 60.35598956243703** (uid 153) <- the only figure quotable as achievable
- median_miner_usd_day: 34.4575148235429
- top_miner_usd_day: 9595.569352831066 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.3399 USD/day  |  payback on registration: 3.47 days

## Score

- gate: **OK** 
- score: 35.9 (rank 55), confidence 0.85 - hardware requirement unknown
- components: income 1.16 / freshness 21.0 / resource 11.25 / registration 8.84
