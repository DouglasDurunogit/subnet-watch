...
- **competitive_miner_usd_day: 3167.7516661321133** (uid 168) <- the only figure quotable as achievable
- median_miner_usd_day: 150.2400738772535
- top_miner_usd_day: 3167.7516661321133 (uid 168, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 149.2538 USD/day  |  payback on registration: 0.97 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 0.85 - hardware from README keywords, not curated
