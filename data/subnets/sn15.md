...
- miner_burn: **0.0**
- registration cost: 0.406714826 TAO (90.87229357318 USD), open=True
...
- **competitive_miner_usd_day: 22861.182921894182** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 20.17659521653744
- top_miner_usd_day: 22861.182921894182 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.1903 USD/day  |  payback on registration: 4.74 days

## Score

- gate: **OK** 
- score: 70.3 (rank 5), confidence 1.0 
- components: income 11.87 / freshness 35.0 / resource 15.0 / registration 8.42
