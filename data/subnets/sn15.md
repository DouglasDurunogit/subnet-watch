...
- miner_burn: **0.0**
- registration cost: 0.331107093 TAO (63.65202755832001 USD), open=True
...
- **competitive_miner_usd_day: 14959.167667951993** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 16.074489972175225
- top_miner_usd_day: 14959.167667951993 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.0882 USD/day  |  payback on registration: 4.22 days

## Score

- gate: **OK** 
- score: 69.6 (rank 6), confidence 1.0 
- components: income 10.97 / freshness 35.0 / resource 15.0 / registration 8.59
