...
- registration cost: 0.1 TAO (21.228 USD), open=True
...
- **competitive_miner_usd_day: 24.55200862158178** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7952067569743088
- top_miner_usd_day: 2644.26126862882 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.8372 USD/day  |  payback on registration: [UNKNOWN] days
