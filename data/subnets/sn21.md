...
- **competitive_miner_usd_day: 26.751360625752714** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.656877933491705
- top_miner_usd_day: 914.6240658388137 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 25.7651 USD/day  |  payback on registration: 0.73 days
