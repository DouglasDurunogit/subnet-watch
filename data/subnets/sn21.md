...
- miner_burn: **0.1505634868517518**
- registration cost: 0.1 TAO (23.754 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 812.4 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 111.26122858952414** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 10.423620221100471
- top_miner_usd_day: 1112.5363396641226 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.7225 USD/day  |  payback on registration: 32.88 days

## Score

- gate: **OK** 
- score: 52.1 (rank 30), confidence 1.0 
- components: income 2.15 / freshness 35.0 / resource 15.0 / registration 0.0
