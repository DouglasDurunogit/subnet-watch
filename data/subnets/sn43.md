...
- registration cost: 0.1 TAO (19.234 USD), open=True
...
- **competitive_miner_usd_day: 22.422881732649** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.726247181624259
- top_miner_usd_day: 2413.0470418443037 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.8274 USD/day  |  payback on registration: [UNKNOWN] days
