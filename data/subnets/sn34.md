...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (96.355 USD), open=True
...
- **competitive_miner_usd_day: 20.440054322058167** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 9.119408851379799
- top_miner_usd_day: 2764.858014630402 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.522 USD/day  |  payback on registration: [UNKNOWN] days
