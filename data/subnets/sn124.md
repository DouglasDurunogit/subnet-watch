...
- subnet age: 404.1 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 714.5877200750845** (uid 81) <- the only figure quotable as achievable
- median_miner_usd_day: 355.61581806482263
- top_miner_usd_day: 714.5877200750845 (uid 81, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 347.3966 USD/day  |  payback on registration: 0.28 days
