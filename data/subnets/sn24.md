...
- **competitive_miner_usd_day: 2802.62141680264** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 2032.7482073236035
- top_miner_usd_day: 2802.62141680264 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1595.4879 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 33.3 (rank 44), confidence 0.85 - hardware from README keywords, not curated
