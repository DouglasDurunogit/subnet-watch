...
- miner_burn: **0.45059751672670245**
...
- **competitive_miner_usd_day: 22.59736639302774** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.649341598256935
- top_miner_usd_day: 864.3492645333114 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.663 USD/day  |  payback on registration: 4.1 days

## Score

- gate: **OK** 
- score: 65.5 (rank 13), confidence 1.0 
- components: income 6.85 / freshness 35.0 / resource 15.0 / registration 8.63
