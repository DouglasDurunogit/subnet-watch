...
- **competitive_miner_usd_day: 372.39239965368154** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 6.966524483317171
- top_miner_usd_day: 744.9392676994544 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.3307 USD/day  |  payback on registration: 14.92 days

## Score

- gate: **OK** 
- score: 58.4 (rank 20), confidence 1.0 
- components: income 3.34 / freshness 35.0 / resource 15.0 / registration 5.03
