...
- miner_burn: **0.15056590782478452**
- registration cost: 0.1 TAO (22.75 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 29  |  free: 0
- subnet age: 802.0 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1173.8890577408788** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 10.99844857498366
- top_miner_usd_day: 1173.8890577408788 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.7383 USD/day  |  payback on registration: 13.09 days

## Score

- gate: **OK** 
- score: 59.6 (rank 20), confidence 1.0 
- components: income 3.98 / freshness 35.0 / resource 15.0 / registration 5.64
