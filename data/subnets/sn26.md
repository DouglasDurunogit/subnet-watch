...
- subnet age: 128.3 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 369.6945160955479** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 24.201263591809266
- top_miner_usd_day: 1725.2661476467106 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 16.8421 USD/day  |  payback on registration: 1.39 days

## Score

- gate: **OK** 
- score: 53.2 (rank 27), confidence 1.0 
- components: income 11.38 / freshness 21.0 / resource 11.25 / registration 9.54
