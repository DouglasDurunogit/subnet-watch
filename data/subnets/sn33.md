...
- miner_burn: **0.0**
- registration cost: 0.051355913 TAO (10.317402921700001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 253  |  free: 0
- subnet age: 818.4 days  |  registered at block 2943950
- weights_version: 2388  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 18.400616072907578** (uid 217) <- the only figure quotable as achievable
- median_miner_usd_day: 14.689128171838153
- top_miner_usd_day: 18.400616072907578 (uid 217, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.10111746034939828  |  top1_share: 0.005400429579625652  |  top10_share: 0.05190242405645904
...
- net margin: 6.47 USD/day  |  payback on registration: 1.59 days

## Score

- gate: **OK** 
- score: 24.4 (rank 64), confidence 0.85 - hardware requirement unknown
- components: income 7.94 / freshness 0.0 / resource 11.25 / registration 9.47
