...
- miner_burn: **0.0**
- registration cost: 0.030747194 TAO (5.90130894442 USD), open=True
...
- **competitive_miner_usd_day: 380.45898509004144** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 27.5265615874109
- top_miner_usd_day: 380.45898509004144 (uid 34, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.3074 USD/day  |  payback on registration: 0.31 days

## Score

- gate: **OK** 
- score: 45.9 (rank 37), confidence 0.85 - hardware requirement unknown
- components: income 11.89 / freshness 21.0 / resource 11.25 / registration 9.9
