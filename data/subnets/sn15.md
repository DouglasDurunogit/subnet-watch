...
- miner_burn: **0.0**
- registration cost: 0.39135557 TAO (87.9728185803 USD), open=True
...
- **competitive_miner_usd_day: 40.66960857391858** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 23.449143682259365
- top_miner_usd_day: 22281.815998326885 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.4628 USD/day  |  payback on registration: 3.92 days

## Score

- gate: **OK** 
- score: 71.2 (rank 5), confidence 1.0 
- components: income 12.46 / freshness 35.0 / resource 15.0 / registration 8.69
