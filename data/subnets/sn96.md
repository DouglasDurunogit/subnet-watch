...
- registration cost: 0.106772071 TAO (24.00022611938 USD), open=True
...
- **competitive_miner_usd_day: 450.3522405344634** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 26.116668466833445
- top_miner_usd_day: 2259.797100662112 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.8547 USD/day  |  payback on registration: 1.34 days

## Score

- gate: **OK** 
- score: 67.4 (rank 10), confidence 1.0 
- components: income 11.6 / freshness 35.0 / resource 11.25 / registration 9.55
