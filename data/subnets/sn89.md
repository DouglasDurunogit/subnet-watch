...
- **competitive_miner_usd_day: 120.72087821085717** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 6.808227010854892
- top_miner_usd_day: 120.72087821085717 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -1.411 USD/day  |  payback on registration: [UNKNOWN] days
