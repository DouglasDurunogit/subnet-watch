...
- miner_burn: **0.0**
- registration cost: 0.001735488 TAO (0.36221370048 USD), open=True
...
- **competitive_miner_usd_day: 1706.5321722734093** (uid 109) <- the only figure quotable as achievable
- median_miner_usd_day: 426.5939824546493
- top_miner_usd_day: 1706.5321722734093 (uid 109, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 418.3748 USD/day  |  payback on registration: 0.0 days
