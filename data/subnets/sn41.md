...
- miner_burn: **0.6946641223039478**
- registration cost: 0.1 TAO (19.721000000000004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 83  |  free: 0
- subnet age: 759.4 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.60050831681619** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 11.142054949203954
- top_miner_usd_day: 2020.8402769225531 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 75  |  gini: 0.7815340142805522  |  top1_share: 0.6950547353313892  |  top10_share: 0.7751042032459501
- owner_incentive_share: 0.6950547353313892 (independent check on miner_burn; disagreement 0.0004)
...
- net margin: 9.7118 USD/day  |  payback on registration: 2.03 days

## Score

- gate: **OK** 
- score: 68.7 (rank 11), confidence 1.0 
- components: income 9.37 / freshness 35.0 / resource 15.0 / registration 9.32
