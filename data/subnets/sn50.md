...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (181.01600000000002 USD), open=True
...
- **competitive_miner_usd_day: 76.33072147710138** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 10.519779380580266
- top_miner_usd_day: 76.33072147710138 (uid 24, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.3006 USD/day  |  payback on registration: 78.68 days

## Score

- gate: **OK** 
- score: 31.4 (rank 60), confidence 0.85 - hardware requirement unknown
- components: income 4.72 / freshness 21.0 / resource 11.25 / registration 0.0
