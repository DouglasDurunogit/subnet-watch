...
- registration cost: 0.999999999 TAO (219.75999978024 USD), open=True
...
- **competitive_miner_usd_day: 1411.560037847112** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 3.7871325975613885
- top_miner_usd_day: 1411.560037847112 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.5153 USD/day  |  payback on registration: [UNKNOWN] days
