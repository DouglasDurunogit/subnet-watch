...
- **competitive_miner_usd_day: 189.8284398735832** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 106.31278332102542
- top_miner_usd_day: 253.11742271813824 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 97.7306 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 78.1 (rank 1), confidence 1.0 
- components: income 18.14 / freshness 35.0 / resource 15.0 / registration 10.0
