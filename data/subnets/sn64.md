...
- subnet age: 603.7 days  |  registered at block 4531295
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5589.046590354519** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 1486.8883496105025
- top_miner_usd_day: 11992.69655182655 (uid 21, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 15  |  gini: 0.5533434055173185  |  top1_share: 0.27005661788270485  |  top10_share: 0.9362247623117189
...
- net margin: 871.4219 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 34.4 (rank 54), confidence 0.85 - hardware from README keywords, not curated
- components: income 26.75 / freshness 0.0 / resource 3.75 / registration 10.0
