...
- miner_burn: **0.0**
- registration cost: 0.494367401 TAO (114.87120929636 USD), open=True
...
- **competitive_miner_usd_day: 43.27955668422399** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 24.953978628741762
- top_miner_usd_day: 23711.738380129707 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.9677 USD/day  |  payback on registration: 4.79 days

## Score

- gate: **OK** 
- score: 71.1 (rank 4), confidence 1.0 
- components: income 12.71 / freshness 35.0 / resource 15.0 / registration 8.4
