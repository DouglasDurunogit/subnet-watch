...
- miner_burn: **0.15056042140349746**
- registration cost: 0.1 TAO (23.684 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 48  |  free: 0
- subnet age: 818.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 134.19570269798774** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 35.15717963659656
- top_miner_usd_day: 838.8353456272209 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 53.9561 USD/day  |  payback on registration: 0.44 days

## Score

- gate: **OK** 
- score: 75.7 (rank 2), confidence 1.0 
- components: income 15.83 / freshness 35.0 / resource 15.0 / registration 9.85
