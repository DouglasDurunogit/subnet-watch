...
- **competitive_miner_usd_day: 5.917506648287162** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.895984994591698
- top_miner_usd_day: 950.943318379747 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2762 USD/day  |  payback on registration: [UNKNOWN] days
