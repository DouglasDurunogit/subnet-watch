...
- **competitive_miner_usd_day: 5.5210167590940475** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.29992852783805
- top_miner_usd_day: 887.3378135215954 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.3238 USD/day  |  payback on registration: [UNKNOWN] days
