...
- subnet age: 585.8 days  |  registered at block 4703386
- weights_version: 1002  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 584.2564058421051** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 58.43777089472317
- top_miner_usd_day: 584.2564058421051 (uid 108, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 69.6877 USD/day  |  payback on registration: 0.0 days
