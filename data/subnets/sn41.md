...
- **competitive_miner_usd_day: 24.61743826534458** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.18513761527598
- top_miner_usd_day: 2378.054422953677 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.9764 USD/day  |  payback on registration: 2.02 days

## Score

- gate: **OK** 
- score: 55.1 (rank 24), confidence 1.0 
- components: income 9.81 / freshness 21.0 / resource 15.0 / registration 9.33
