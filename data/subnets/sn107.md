...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (192.2679 USD), open=True
...
- **competitive_miner_usd_day: 28205.98722015182** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 94.03427734121792
- top_miner_usd_day: 28205.98722015182 (uid 50, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.9037174948113782  |  top1_share: 0.9017671834940788  |  top10_share: 0.9881424734464656
...
- net margin: 93.048 USD/day  |  payback on registration: 2.07 days

## Score

- gate: **OK** 
- score: 42.3 (rank 14), confidence 1.0 
- components: income 17.95 / freshness 0.0 / resource 15.0 / registration 9.31
