...
- miner_burn: **0.0**
- registration cost: 0.499199574 TAO (110.29315387956 USD), open=True
...
- **competitive_miner_usd_day: 37.74573420947292** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 19.046012674504684
- top_miner_usd_day: 21580.171233632416 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.7134 USD/day  |  payback on registration: 6.23 days

## Score

- gate: **OK** 
- score: 69.5 (rank 7), confidence 1.0 
- components: income 11.57 / freshness 35.0 / resource 15.0 / registration 7.92
