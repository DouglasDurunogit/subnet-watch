...
- **competitive_miner_usd_day: 1319.8366297629118** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 2.441269824821506
- top_miner_usd_day: 1319.8366297629118 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.7121 USD/day  |  payback on registration: [UNKNOWN] days
