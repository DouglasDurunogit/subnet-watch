...
- subnet age: 532.4 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.07038208684965828** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07038208684965828
- top_miner_usd_day: 4612.208533344956 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.6666361476914937  |  top1_share: 0.9999694810248272  |  top10_share: 1.0
...
- latest release: (none) 
- last commit: 2026-07-17T17:04:02Z
- scoring-related commit: Prevent submissions being sent to non-validator 2026-06-26T03:28:30Z

## Resources

- min_compute.yml present: True  |  unmodified template: True
- required: multi-GPU (~85 GB VRAM)  |  basis: **README keywords (GUESS)**
- cheapest satisfying machine: h200-141 at 78.9041 USD/day
- net margin: -78.8337 USD/day  |  payback on registration: [UNKNOWN] days

## Score

- gate: **OK** 
- score: 0.0 (rank 89), confidence 0.85 - hardware from README keywords, not curated
