...
- miner_burn: **0.0**
- registration cost: 0.098312211 TAO (20.00260245006 USD), open=True
...
- **competitive_miner_usd_day: 698.3590121151987** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 1745.9508157307034
- top_miner_usd_day: 4539.600005962326 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 690.1398 USD/day  |  payback on registration: 0.03 days
...
- components: income 25.83 / freshness 35.0 / resource 11.25 / registration 9.99
