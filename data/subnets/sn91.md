...
- subnet age: 177.8 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2874.507027423641** (uid 106) <- the only figure quotable as achievable
- median_miner_usd_day: 718.6267568559102
- top_miner_usd_day: 2874.507027423641 (uid 106, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 710.4076 USD/day  |  payback on registration: 0.03 days
