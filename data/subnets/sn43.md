...
- registration cost: 0.1 TAO (19.646 USD), open=True
...
- **competitive_miner_usd_day: 16.555131105333036** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8810854089673045
- top_miner_usd_day: 2447.3770286136037 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7544 USD/day  |  payback on registration: [UNKNOWN] days
