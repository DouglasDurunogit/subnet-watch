...
- registration cost: 0.012526387 TAO (2.67425836063 USD), open=True
...
- **competitive_miner_usd_day: 2.073520785351653** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.1470540514711272
- top_miner_usd_day: 2605.3126905990744 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1608 USD/day  |  payback on registration: 16.63 days

## Score

- gate: **OK** 
- score: 41.0 (rank 41), confidence 1.0 
- components: income 0.59 / freshness 21.0 / resource 15.0 / registration 4.46
