...
- subnet age: 655.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 322.15745974654556** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 45.37000141988212
- top_miner_usd_day: 12473.705423929336 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 36.8463 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.0 (rank 22), confidence 0.85 - hardware from README keywords, not curated
- components: income 14.35 / freshness 35.0 / resource 11.25 / registration 10.0
