...
- **competitive_miner_usd_day: 11.54713684002272** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 17.04813336037689
- top_miner_usd_day: 3143.100912737858 (uid 59, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.42 USD/day  |  payback on registration: 0.08 days
