...
- subnet age: 501.5 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 121.73030587447317** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 5.616605068357745
- top_miner_usd_day: 121.73030587447317 (uid 218, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.739 USD/day  |  payback on registration: [UNKNOWN] days
