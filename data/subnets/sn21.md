...
- miner_burn: **0.3010429774876684**
- registration cost: 0.1 TAO (24.373 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 27  |  free: 0
- subnet age: 799.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1031.4729903742325** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.649332475809558
- top_miner_usd_day: 1031.4729903742325 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.1904 USD/day  |  payback on registration: 128.01 days

## Score

- gate: **OK** 
- score: 50.7 (rank 28), confidence 1.0 
- components: income 0.69 / freshness 35.0 / resource 15.0 / registration 0.0
