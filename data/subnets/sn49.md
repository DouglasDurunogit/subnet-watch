...
- **competitive_miner_usd_day: 41.301074010757596** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2066.1256368099152
- top_miner_usd_day: 4090.9501996090726 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.0819 USD/day  |  payback on registration: 0.3 days
