...
- subnet age: 682.3 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 956.4356341654943** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 61.7587926757415
- top_miner_usd_day: 34435.64596103859 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 54  |  gini: 0.913722170767757  |  top1_share: 0.79591462856096  |  top10_share: 0.9243076547280998
...
- net margin: 47.2647 USD/day  |  payback on registration: 2.04 days
