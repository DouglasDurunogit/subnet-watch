...
- registration cost: 0.1 TAO (22.627000000000002 USD), open=True
...
- **competitive_miner_usd_day: 27.20572665970179** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0056591566815836
- top_miner_usd_day: 2793.6152784028413 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7746 USD/day  |  payback on registration: [UNKNOWN] days
