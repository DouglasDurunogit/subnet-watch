...
- miner_burn: **0.0**
- registration cost: 0.004215974 TAO (0.86832200504 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 114  |  free: 0
- subnet age: 639.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2050.809232726472** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 91.37268858682302
- top_miner_usd_day: 2050.809232726472 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 103  |  gini: 0.6427192471025212  |  top1_share: 0.09869757073275005  |  top10_share: 0.5057487059685768
...
- net margin: 79.9808 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 50.7 (rank 27), confidence 0.85 - hardware from README keywords, not curated
- components: income 17.36 / freshness 21.0 / resource 11.25 / registration 10.0
