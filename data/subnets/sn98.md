...
- subnet age: 509.3 days  |  registered at block 5445992
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1986.595196461005** (uid 61) <- the only figure quotable as achievable
- median_miner_usd_day: 1986.595196461005
- top_miner_usd_day: 1986.595196461005 (uid 61, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1985.6089 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 55.7 (rank 20), confidence 0.85 - income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 30.0 / freshness 10.5 / resource 15.0 / registration 10.0
