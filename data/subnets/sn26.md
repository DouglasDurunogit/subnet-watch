...
- subnet age: 130.9 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 29.69620928280937** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 23.3327358650645
- top_miner_usd_day: 1663.3503109152587 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.8892 USD/day  |  payback on registration: 1.96 days

## Score

- gate: **OK** 
- score: 51.7 (rank 30), confidence 1.0 
- components: income 10.1 / freshness 21.0 / resource 11.25 / registration 9.35
