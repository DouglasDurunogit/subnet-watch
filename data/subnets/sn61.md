...
- **competitive_miner_usd_day: 309.6904778448876** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 30.66242354899877
- top_miner_usd_day: 309.6904778448876 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.4432 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 46.5 (rank 37), confidence 0.85 - hardware requirement unknown
- components: income 12.46 / freshness 21.0 / resource 11.25 / registration 10.0
