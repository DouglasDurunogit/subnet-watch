...
- **competitive_miner_usd_day: 228.24777680564227** (uid 74) <- the only figure quotable as achievable
- median_miner_usd_day: 136.92985703708908
- top_miner_usd_day: 312.53581552095204 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 135.9436 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 79.4 (rank 1), confidence 1.0 
- components: income 19.43 / freshness 35.0 / resource 15.0 / registration 10.0
