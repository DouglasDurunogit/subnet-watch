...
- subnet age: 174.3 days  |  registered at block 7525773
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 802.2758859022628** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 802.2758859022628
- top_miner_usd_day: 2246.4508325630472 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 473.1317 USD/day  |  payback on registration: 0.08 days
...
- components: income 24.34 / freshness 35.0 / resource 11.25 / registration 9.97
