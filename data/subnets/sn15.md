...
- miner_burn: **0.0**
- registration cost: 0.224020585 TAO (55.8393710171 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 62  |  free: 0
- subnet age: 240.2 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 19692.65532101358** (uid 37) <- the only figure quotable as achievable
- median_miner_usd_day: 9.373064720519883
- top_miner_usd_day: 19692.65532101358 (uid 37, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 50  |  gini: 0.9645390568946828  |  top1_share: 0.978216068511762  |  top10_share: 0.9850245011983452
...
- last commit: 2026-09-18T17:44:07Z
- scoring-related commit: validator: hard-fail generated runs at >=30% harness-failure rate (#322) 2026-09-18T17:44:07Z
...
- net margin: 8.3868 USD/day  |  payback on registration: 6.66 days

## Score

- gate: **OK** 
- score: 66.6 (rank 9), confidence 1.0 
- components: income 8.85 / freshness 35.0 / resource 15.0 / registration 7.78
