...
- miner_burn: **0.0**
- registration cost: 0.02188226 TAO (4.9119109022 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 214  |  free: 0
- subnet age: 153.7 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 19.080939315118357** (uid 2) <- the only figure quotable as achievable
- median_miner_usd_day: 19.080939315118357
- top_miner_usd_day: 19.080939315118357 (uid 2, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 209  |  gini: 0.2615835192209732  |  top1_share: 0.006540242355709723  |  top10_share: 0.06540242355709723
...
- last commit: 2026-09-15T07:13:42Z
- scoring-related commit: Stop miner HTTP service after terminal background failure (#101) 2026-09-15T06:08:40Z
...
- net margin: 10.8618 USD/day  |  payback on registration: 0.45 days

## Score

- gate: **OK** 
- score: 56.0 (rank 26), confidence 0.85 - hardware requirement unknown
- components: income 9.77 / freshness 35.0 / resource 11.25 / registration 9.85
