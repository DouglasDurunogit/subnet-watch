...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (169.497 USD), open=True
...
- **competitive_miner_usd_day: 3487.54011431708** (uid 168) <- the only figure quotable as achievable
- median_miner_usd_day: 165.39145276272745
- top_miner_usd_day: 3487.54011431708 (uid 168, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 164.4052 USD/day  |  payback on registration: 1.03 days

## Score

- gate: **OK** 
- score: 67.9 (rank 10), confidence 0.85 - hardware from README keywords, not curated
- components: income 20.18 / freshness 35.0 / resource 15.0 / registration 9.66
