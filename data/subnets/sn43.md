...
- registration cost: 0.1 TAO (20.276 USD), open=True
...
- **competitive_miner_usd_day: 41.59381811738914** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 4.3656717977882495
- top_miner_usd_day: 2503.880686485322 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.6025 USD/day  |  payback on registration: [UNKNOWN] days
