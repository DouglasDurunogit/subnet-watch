...
- registration cost: 0.1 TAO (23.271 USD), open=True
...
- **competitive_miner_usd_day: 181.2359150436889** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.245555044841501
- top_miner_usd_day: 2764.0280130298574 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.4562 USD/day  |  payback on registration: 51.01 days

## Score

- gate: **OK** 
- score: 16.5 (rank 73), confidence 1.0 
- components: income 1.48 / freshness 0.0 / resource 15.0 / registration 0.0
