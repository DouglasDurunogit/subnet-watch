...
- miner_burn: **0.4505991446785629**
- registration cost: 0.126494009 TAO (24.864927349129996 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 783.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 23.31099150504656** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.82774787626164
- top_miner_usd_day: 891.6756206528819 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-07T19:13:27Z
- scoring-related commit: refactor(scoring): one behavioural detector, not two 2026-08-07T17:32:20Z
...
- net margin: 4.8414 USD/day  |  payback on registration: 5.14 days

## Score

- gate: **OK** 
- score: 65.3 (rank 14), confidence 1.0 
- components: income 6.97 / freshness 35.0 / resource 15.0 / registration 8.29
