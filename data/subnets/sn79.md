...
- miner_burn: **0.0**
- registration cost: 0.133405476 TAO (25.487116189800002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 221  |  free: 0
- subnet age: 492.8 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 649.392345003512** (uid 165) <- the only figure quotable as achievable
- median_miner_usd_day: 2.901206208624961
- top_miner_usd_day: 649.392345003512 (uid 165, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 220  |  gini: 0.8392920061354467  |  top1_share: 0.1453875779435139  |  top10_share: 0.6643996821127278
...
- latest release: (none) 
- last commit: 2026-07-15T15:09:15Z
...
- net margin: 1.9149 USD/day  |  payback on registration: 13.31 days

## Score

- gate: **OK** 
- score: 24.8 (rank 49), confidence 1.0 
- components: income 4.23 / freshness 0.0 / resource 15.0 / registration 5.56
