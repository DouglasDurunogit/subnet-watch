...
- miner_burn: **0.7983812619931996**
- registration cost: 0.1 TAO (19.851 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 23  |  free: 0
- subnet age: 749.0 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.4126898542814** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.0671887589035856
- top_miner_usd_day: 2515.287978013825 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.6001 USD/day  |  payback on registration: 33.08 days

## Score

- gate: **OK** 
- score: 16.9 (rank 66), confidence 1.0 
- components: income 1.86 / freshness 0.0 / resource 15.0 / registration 0.0
