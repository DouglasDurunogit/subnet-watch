...
- registration cost: 0.1 TAO (22.25 USD), open=True
...
- **competitive_miner_usd_day: 190.02670687561246** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0551456489655902
- top_miner_usd_day: 2658.766055269675 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4587 USD/day  |  payback on registration: [UNKNOWN] days
