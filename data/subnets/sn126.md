...
- **competitive_miner_usd_day: 367.56055695296635** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 39.3528419541842
- top_miner_usd_day: 787.7085421988488 (uid 142, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.9685 USD/day  |  payback on registration: [UNKNOWN] days
