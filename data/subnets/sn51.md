...
- **competitive_miner_usd_day: 1467.703287793209** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 18.045532226965683
- top_miner_usd_day: 35810.356174845234 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.158 USD/day  |  payback on registration: 10.79 days

## Score

- gate: **OK** 
- score: 52.5 (rank 26), confidence 0.85 - hardware requirement unknown
- components: income 9.16 / freshness 35.0 / resource 11.25 / registration 6.4
