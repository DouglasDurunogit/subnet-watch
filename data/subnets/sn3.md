...
- miner_burn: **0.0**
- registration cost: 0.004295081 TAO (0.84333915435 USD), open=True
...
- **competitive_miner_usd_day: 3520.680464648433** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 3520.680464648433
- top_miner_usd_day: 3520.680464648433 (uid 110, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3512.4613 USD/day  |  payback on registration: 0.0 days
