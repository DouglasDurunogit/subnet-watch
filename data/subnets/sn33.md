...
- miner_burn: **0.0**
- registration cost: 0.057544208 TAO (11.01223508496 USD), open=True
...
- **competitive_miner_usd_day: 16.443540773494334** (uid 188) <- the only figure quotable as achievable
- median_miner_usd_day: 12.702173350311638
- top_miner_usd_day: 16.443540773494334 (uid 188, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.483 USD/day  |  payback on registration: 2.46 days

## Score

- gate: **OK** 
- score: 52.8 (rank 27), confidence 0.85 - hardware requirement unknown
- components: income 6.72 / freshness 35.0 / resource 11.25 / registration 9.18
