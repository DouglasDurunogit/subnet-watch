...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (183.824 USD), open=True
...
- **competitive_miner_usd_day: 101.20972110895266** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 6.956658634696507
- top_miner_usd_day: 101.20972110895266 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -1.2625 USD/day  |  payback on registration: [UNKNOWN] days
