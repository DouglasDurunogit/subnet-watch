...
- miner_burn: **0.0**
- registration cost: 0.000573256 TAO (0.11227792016 USD), open=True
...
- **competitive_miner_usd_day: 446.00760792249054** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 25.41023946159904
- top_miner_usd_day: 446.00760792249054 (uid 34, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.1911 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 57.5 (rank 22), confidence 0.85 - hardware requirement unknown
- components: income 11.46 / freshness 35.0 / resource 11.25 / registration 10.0
