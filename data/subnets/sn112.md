...
- subnet age: 446.9 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 253.21011580662434** (uid 107) <- the only figure quotable as achievable
- median_miner_usd_day: 633.0156301698071
- top_miner_usd_day: 1012.8211445329897 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 244.9909 USD/day  |  payback on registration: 0.8 days
...
- components: income 21.75 / freshness 21.0 / resource 11.25 / registration 9.73
