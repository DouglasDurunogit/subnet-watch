...
- miner_burn: **0.0**
- registration cost: 0.441650488 TAO (107.17532392295999 USD), open=True
...
- **competitive_miner_usd_day: 47.34210967040672** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 28.14936250672832
- top_miner_usd_day: 25859.45451735523 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 26.9498 USD/day  |  payback on registration: 3.98 days

## Score

- gate: **OK** 
- score: 71.8 (rank 7), confidence 1.0 
- components: income 13.16 / freshness 35.0 / resource 15.0 / registration 8.67
