...
- miner_burn: **0.0**
- registration cost: 0.75 TAO (190.85999999999999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 242  |  free: 0
- subnet age: 158.6 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 11.629871133683839** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 11.629871133683839
- top_miner_usd_day: 11.629871133683839 (uid 1, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.4107 USD/day  |  payback on registration: 55.96 days

## Score

- gate: **OK** 
- score: 44.3 (rank 39), confidence 0.85 - hardware requirement unknown
- components: income 5.86 / freshness 35.0 / resource 11.25 / registration 0.0
