...
- subnet age: 76.6 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2272.4488312078497
- top_miner_usd_day: 2272.4488312078497 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-22T17:15:33Z
- scoring-related commit: Build the validator registry from the permitted set on chain 2026-08-22T16:30:46Z
