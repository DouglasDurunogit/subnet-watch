...
- miner_burn: **0.0**
- registration cost: 0.132513432 TAO (24.879396857999996 USD), open=True
...
- **competitive_miner_usd_day: 567.3639295890825** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 3.804037540971576
- top_miner_usd_day: 567.3639295890825 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 566.3776 USD/day  |  payback on registration: 0.04 days

## Score

- gate: **OK** 
- score: 50.0 (rank 7), confidence 1.0 
- components: income 25.05 / freshness 0.0 / resource 15.0 / registration 9.99
