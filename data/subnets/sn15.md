...
- miner_burn: **0.0**
- registration cost: 0.414597053 TAO (81.3854015039 USD), open=True
...
- **competitive_miner_usd_day: 22.103066652076627** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.862655038041126
- top_miner_usd_day: 12504.25231223535 (uid 13, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.8764 USD/day  |  payback on registration: 7.48 days

## Score

- gate: **OK** 
- score: 67.3 (rank 10), confidence 1.0 
- components: income 9.77 / freshness 35.0 / resource 15.0 / registration 7.51
