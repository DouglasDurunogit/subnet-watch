...
- **competitive_miner_usd_day: 10.054045802746217** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 6.390943843606123
- top_miner_usd_day: 2432.845269245916 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.8282 USD/day  |  payback on registration: [UNKNOWN] days
