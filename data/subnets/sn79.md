...
- miner_burn: **0.0**
- registration cost: 0.140681805 TAO (27.62287241175 USD), open=True
...
- **competitive_miner_usd_day: 394.6149975450591** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 6.293232071244125
- top_miner_usd_day: 394.6149975450591 (uid 39, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.3069 USD/day  |  payback on registration: 5.21 days

## Score

- gate: **OK** 
- score: 30.5 (rank 55), confidence 1.0 
- components: income 7.27 / freshness 0.0 / resource 15.0 / registration 8.26
