...
- miner_burn: **0.0**
- registration cost: 0.284670289 TAO (56.168294722590005 USD), open=True
...
- **competitive_miner_usd_day: 12862.842494285296** (uid 41) <- the only figure quotable as achievable
- median_miner_usd_day: 13.916329400547653
- top_miner_usd_day: 12862.842494285296 (uid 41, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 12.93 USD/day  |  payback on registration: 4.34 days

## Score

- gate: **OK** 
- score: 69.0 (rank 9), confidence 1.0 
- components: income 10.4 / freshness 35.0 / resource 15.0 / registration 8.55
