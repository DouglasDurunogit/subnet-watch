...
- subnet age: 75.3 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2755.062077254596
- top_miner_usd_day: 2755.062077254596 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-21T16:10:35Z
- scoring-related commit: Verify the gguf pin inline, since tests are not published 2026-08-21T11:56:26Z
