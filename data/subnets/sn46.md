...
- subnet age: 688.9 days  |  registered at block 3919107
- weights_version: 62  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2928.682271476746
- top_miner_usd_day: 2928.682271476746 (uid 238, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-19T02:41:53Z
- scoring-related commit: Merge pull request #20 from instant-subnet/dan/p4-final-validator-deploy 2026-08-19T02:41:53Z
