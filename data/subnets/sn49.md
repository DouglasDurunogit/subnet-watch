...
- subnet age: 284.8 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 41.8726915640047** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2094.7213503476987
- top_miner_usd_day: 4147.570009131392 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.6535 USD/day  |  payback on registration: 0.3 days
...
- components: income 14.0 / freshness 21.0 / resource 11.25 / registration 9.9
