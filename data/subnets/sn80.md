...
- subnet age: 268.3 days  |  registered at block 7151800
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 2, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 27.4 (rank 47), confidence 0.85 - hardware requirement unknown
