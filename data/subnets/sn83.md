...
- miner_burn: **0.0**
- registration cost: 0.130329542 TAO (24.9646237701 USD), open=True
...
- **competitive_miner_usd_day: 94.33236947435849** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 19.907508756447385
- top_miner_usd_day: 94.33236947435849 (uid 34, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 8.2639 USD/day  |  payback on registration: 3.02 days

## Score

- gate: **OK** 
- score: 24.7 (rank 68), confidence 0.85 - hardware requirement unknown
- components: income 8.79 / freshness 0.0 / resource 11.25 / registration 8.99
