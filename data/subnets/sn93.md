...
- miner_burn: **0.0**
- registration cost: 0.005 TAO (1.1105 USD), open=True
...
- **competitive_miner_usd_day: 20.018788223204087** (uid 153) <- the only figure quotable as achievable
- median_miner_usd_day: 18.891902793421075
- top_miner_usd_day: 8640.559751306797 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.5458 USD/day  |  payback on registration: 0.12 days

## Score

- gate: **OK** 
- score: 43.8 (rank 38), confidence 0.85 - hardware requirement unknown
- components: income 9.31 / freshness 21.0 / resource 11.25 / registration 9.96
