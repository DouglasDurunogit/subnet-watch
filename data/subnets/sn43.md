...
- miner_burn: **0.789614997105673**
- registration cost: 0.1 TAO (20.846000000000004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 20  |  free: 0
- subnet age: 749.8 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.635112973958844** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.927943755101666
- top_miner_usd_day: 2612.2811292283777 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.8710457353896599  |  top1_share: 0.7897170588773922  |  top10_share: 0.9992522052315111
- owner_incentive_share: 0.7897170588773922 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 1.0077 USD/day  |  payback on registration: 20.69 days

## Score

- gate: **OK** 
- score: 20.9 (rank 66), confidence 1.0 
- components: income 2.75 / freshness 0.0 / resource 15.0 / registration 3.1
