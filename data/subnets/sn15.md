...
- miner_burn: **0.0**
- registration cost: 0.252905932 TAO (49.524039604239995 USD), open=True
...
- **competitive_miner_usd_day: 22.076823586598973** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 13.720642696344221
- top_miner_usd_day: 12712.123876799398 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.6312 USD/day  |  payback on registration: 3.92 days

## Score

- gate: **OK** 
- score: 69.0 (rank 10), confidence 1.0 
- components: income 10.32 / freshness 35.0 / resource 15.0 / registration 8.69
