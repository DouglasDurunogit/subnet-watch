...
- subnet age: 132.8 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1562.2710382776158** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 23.462983051430573
- top_miner_usd_day: 1562.2710382776158 (uid 45, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.7744929880514566  |  top1_share: 0.6883917535212343  |  top10_share: 1.0
...
- net margin: 14.1145 USD/day  |  payback on registration: 1.55 days

## Score

- gate: **OK** 
- score: 52.5 (rank 26), confidence 1.0 
- components: income 10.73 / freshness 21.0 / resource 11.25 / registration 9.48
