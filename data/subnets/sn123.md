...
- **competitive_miner_usd_day: 75.67503202785154** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.100049291511853
- top_miner_usd_day: 667.6203212783031 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.1924 USD/day  |  payback on registration: [UNKNOWN] days
