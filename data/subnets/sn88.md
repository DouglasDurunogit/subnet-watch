...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9635 USD), open=True
...
- **competitive_miner_usd_day: 925.5721984221507** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 3.2701853733496256
- top_miner_usd_day: 925.5721984221507 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.949 USD/day  |  payback on registration: [UNKNOWN] days
