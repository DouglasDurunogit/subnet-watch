...
- **competitive_miner_usd_day: 10.983392089882958** (uid 71) <- the only figure quotable as achievable
- median_miner_usd_day: 8.379570689264154
- top_miner_usd_day: 10.983392089882958 (uid 71, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.0499 USD/day  |  payback on registration: 2.18 days

## Score

- gate: **OK** 
- score: 17.6 (rank 76), confidence 0.85 - hardware requirement unknown
- components: income 0.19 / freshness 0.0 / resource 11.25 / registration 9.27
