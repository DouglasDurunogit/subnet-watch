...
- subnet age: 800.0 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1098.1083616634382** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 404.6497575493884
- top_miner_usd_day: 1098.1083616634382 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 743.1599 USD/day  |  payback on registration: 0.03 days
...
- components: income 26.12 / freshness 0.0 / resource 11.25 / registration 9.99
