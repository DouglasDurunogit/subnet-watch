...
- miner_burn: **0.41773138637654483**
- registration cost: 0.055803323 TAO (10.75274230887 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 37  |  free: 0
- subnet age: 478.1 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 77.88674862953908** (uid 191) <- the only figure quotable as achievable
- median_miner_usd_day: 0.06563029166171398
- top_miner_usd_day: 468.222908287583 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 30  |  gini: 0.7611601192474793  |  top1_share: 0.4355331033851226  |  top10_share: 0.9117853545374073
- owner_incentive_share: 0.4355331033851226 (independent check on miner_burn; disagreement 0.0178)
...
- status: **ok** 
- README: 13791 bytes, sha b77e8a1c7982175b
- latest release: (none) 
- last commit: 2026-08-01T20:36:10Z
- scoring-related commit: hf board: share of the MINER pool, not of the vector; plus LF-parity … 2026-07-30T17:06:44Z
...
_(truncated at 6000 of 13791 chars - read the full file at https://github.com/DeltaCompute24/InfiniteQuant-Subnet)_
