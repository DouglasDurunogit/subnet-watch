...
- subnet age: 961.7 days  |  registered at block 2063528
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 532.4363317582647** (uid 173) <- the only figure quotable as achievable
- median_miner_usd_day: 1331.0705182515496
- top_miner_usd_day: 2129.7047047448345 (uid 188, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 531.45 USD/day  |  payback on registration: 0.04 days
