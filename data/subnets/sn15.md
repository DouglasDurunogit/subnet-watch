...
- miner_burn: **0.0**
- registration cost: 0.331355481 TAO (65.76743586888 USD), open=True
...
- **competitive_miner_usd_day: 15293.840380982898** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 16.58410941252864
- top_miner_usd_day: 15293.840380982898 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.5978 USD/day  |  payback on registration: 4.22 days

## Score

- gate: **OK** 
- score: 69.7 (rank 7), confidence 1.0 
- components: income 11.1 / freshness 35.0 / resource 15.0 / registration 8.59
