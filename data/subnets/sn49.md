...
- subnet age: 325.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 64.40227014246561** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 3221.785016424689
- top_miner_usd_day: 6379.167762706911 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 56.1831 USD/day  |  payback on registration: 0.28 days
...
- components: income 15.98 / freshness 35.0 / resource 11.25 / registration 9.91
