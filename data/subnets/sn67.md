...
- registration cost: 0.046902878 TAO (9.31631865714 USD), open=True
...
- **competitive_miner_usd_day: 299.1055628867248** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 23.251832806095482
- top_miner_usd_day: 299.1055628867248 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.2655 USD/day  |  payback on registration: 0.42 days

## Score

- gate: **OK** 
- score: 72.3 (rank 4), confidence 1.0 
- components: income 12.43 / freshness 35.0 / resource 15.0 / registration 9.86
