...
- **competitive_miner_usd_day: 447.01230946343406** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 26.579110292420403
- top_miner_usd_day: 2275.189100193714 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.3599 USD/day  |  payback on registration: 1.24 days

## Score

- gate: **OK** 
- score: 67.5 (rank 9), confidence 1.0 
- components: income 11.7 / freshness 35.0 / resource 11.25 / registration 9.59
