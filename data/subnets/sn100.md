...
- registration cost: 0.001082444 TAO (0.20771017915999995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 13  |  free: 0
- subnet age: 290.6 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3276.602290466737
- top_miner_usd_day: 3276.602290466737 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: v3.3.2 — miner HTML sandboxing + chain endpoint failover + ops fixes 2026-08-06T11:33:32Z
- last commit: 2026-08-06T11:34:53Z
- scoring-related commit: fix(design): sandbox miner HTML viewer end-to-end 2026-08-06T09:38:47Z
