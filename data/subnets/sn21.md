...
- miner_burn: **0.45065876631997526**
- registration cost: 0.1 TAO (18.991 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 779.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21.613595362910512** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.403398840727628
- top_miner_usd_day: 826.8320101720677 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.4171 USD/day  |  payback on registration: 4.3 days

## Score

- gate: **OK** 
- score: 65.2 (rank 14), confidence 1.0 
- components: income 6.67 / freshness 35.0 / resource 15.0 / registration 8.57
