...
- miner_burn: **0.45076887193135917**
- registration cost: 0.1 TAO (19.275000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 134  |  free: 0
- subnet age: 778.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.882002019546746** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.191701891438138
- top_miner_usd_day: 850.7398398836002 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.2054 USD/day  |  payback on registration: 3.7 days

## Score

- gate: **OK** 
- score: 31.0 (rank 50), confidence 1.0 
- components: income 7.21 / freshness 0.0 / resource 15.0 / registration 8.77
