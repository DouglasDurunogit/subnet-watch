...
- miner_burn: **0.6406389435287565**
- registration cost: 0.15 TAO (35.931 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 23  |  free: 0
- subnet age: 549.0 days  |  registered at block 5086205
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 347.40978391270374** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 45.05027815543483
- top_miner_usd_day: 1545.2539853576602 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 12  |  gini: 0.7740318831291046  |  top1_share: 0.6406738795379286  |  top10_share: 0.9996948009339092
- owner_incentive_share: 0.6406738795379286 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 11.84 USD/day  |  payback on registration: 3.03 days

## Score

- gate: **OK** 
- score: 55.5 (rank 26), confidence 0.85 - hardware from README keywords, not curated
- components: income 10.08 / freshness 35.0 / resource 11.25 / registration 8.99
