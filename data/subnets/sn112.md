...
- **competitive_miner_usd_day: 308.5874371496344** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 771.4568210179348
- top_miner_usd_day: 1234.3262048862352 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 300.3683 USD/day  |  payback on registration: 0.67 days
...
- components: income 22.55 / freshness 35.0 / resource 11.25 / registration 9.78
