...
- **competitive_miner_usd_day: 40.37718189141949** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2019.9070519635766
- top_miner_usd_day: 3999.4369220357335 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 32.158 USD/day  |  payback on registration: 0.31 days
