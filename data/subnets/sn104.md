...
- **competitive_miner_usd_day: 15.520646353328383** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 4.652077023676677
- top_miner_usd_day: 2602.240146810434 (uid 36, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -3.5671 USD/day  |  payback on registration: [UNKNOWN] days
