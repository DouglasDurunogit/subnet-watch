...
- miner_burn: **0.15056746010668576**
- registration cost: 0.1 TAO (23.224000000000004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 29  |  free: 0
- subnet age: 801.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1173.5911824180926** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 10.995657709528514
- top_miner_usd_day: 1173.5911824180926 (uid 39, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826492537313432  |  top1_share: 0.44712022708543175  |  top10_share: 0.9986875438757133
- owner_incentive_share: 0.15058144858529438 (independent check on miner_burn; disagreement 0.0)
...
- last commit: 2026-08-25T13:17:15Z
- scoring-related commit: docs(scoring): retire the no-zero-for-missing rule the absence penalt… 2026-08-24T17:50:10Z
...
- net margin: 6.3441 USD/day  |  payback on registration: 3.66 days

## Score

- gate: **OK** 
- score: 66.7 (rank 12), confidence 1.0 
- components: income 7.88 / freshness 35.0 / resource 15.0 / registration 8.78
