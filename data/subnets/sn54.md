...
- miner_burn: **0.3013610066846013**
- registration cost: 0.0005 TAO (0.09389499999999999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 112  |  free: 0
- subnet age: 552.3 days  |  registered at block 4742549
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 913.3042538827838** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7729788607080853
- top_miner_usd_day: 913.3042538827838 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 104  |  gini: 0.9335819194703097  |  top1_share: 0.35187391184825445  |  top10_share: 0.9715171507987417
- owner_incentive_share: 0.3016127554293045 (independent check on miner_burn; disagreement 0.0003)
...
- status: **ok** 
- README: 8263 bytes, sha 4d66f2255e9583eb
- latest release: (none) 
- last commit: 2026-07-17T04:15:51Z
- scoring-related commit: New validator (#102) 2026-07-17T00:29:12Z
...
- net margin: 905.0851 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 48.1 (rank 5), confidence 1.0 
- components: income 26.9 / freshness 0.0 / resource 11.25 / registration 10.0
...
- Introduce a **Post-Evaluation System** to systematically validate and assess new min
```

_(truncated at 6000 of 8263 chars - read the full file at https://github.com/yanez-compliance/MIID-subnet)_
