...
- subnet age: 117.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 264.9093710020247** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 26.013914274348064
- top_miner_usd_day: 1854.4868740037969 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.3252 USD/day  |  payback on registration: 1.26 days

## Score

- gate: **OK** 
- score: 53.5 (rank 28), confidence 1.0 
- components: income 11.7 / freshness 21.0 / resource 11.25 / registration 9.58
