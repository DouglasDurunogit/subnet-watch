...
- miner_burn: **0.0**
- registration cost: 0.050196004 TAO (9.714432654120001 USD), open=True
...
- **competitive_miner_usd_day: 4367.421622195462** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 1679.7302259884086
- top_miner_usd_day: 4367.421622195462 (uid 125, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1671.511 USD/day  |  payback on registration: 0.01 days
