...
- **competitive_miner_usd_day: 1189.326354022285** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 1.6570203469484992
- top_miner_usd_day: 1189.326354022285 (uid 14, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.4389 USD/day  |  payback on registration: [UNKNOWN] days
