...
- subnet age: 943.2 days  |  registered at block 2009702
- weights_version: 1000910  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 66.83178457343739** (uid 194) <- the only figure quotable as achievable
- median_miner_usd_day: 8.718483027612267
- top_miner_usd_day: 1021.0147035032757 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.4695 USD/day  |  payback on registration: 0.21 days

## Score

- gate: **OK** 
- score: 19.3 (rank 66), confidence 0.85 - hardware requirement unknown
- components: income 1.52 / freshness 0.0 / resource 11.25 / registration 9.93
