...
- subnet age: 1028.7 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1830.8836134557378** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 5.323912394744881
- top_miner_usd_day: 1830.8836134557378 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -2.8706 USD/day  |  payback on registration: [UNKNOWN] days
