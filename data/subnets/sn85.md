...
- subnet age: 485.2 days  |  registered at block 5258781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 523.4639598520864** (uid 112) <- the only figure quotable as achievable
- median_miner_usd_day: 295.3270084987201
- top_miner_usd_day: 523.4639598520864 (uid 112, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.33169540668396125  |  top1_share: 0.17048679993895924  |  top10_share: 1.0
...
- net margin: 434.6073 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 68.2 (rank 9), confidence 0.85 - hardware requirement unknown
- components: income 24.0 / freshness 35.0 / resource 11.25 / registration 10.0
