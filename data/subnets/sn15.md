...
- miner_burn: **0.0**
- registration cost: 0.615849335 TAO (149.3311467508 USD), open=True
...
- **competitive_miner_usd_day: 44.174299873127275** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 26.504579923876364
- top_miner_usd_day: 24297.069683852904 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 25.3175 USD/day  |  payback on registration: 5.9 days

## Score

- gate: **OK** 
- score: 71.0 (rank 7), confidence 1.0 
- components: income 12.92 / freshness 35.0 / resource 15.0 / registration 8.03
