...
- miner_burn: **0.8333055588882416**
- registration cost: 0.005 TAO (0.95525 USD), open=True
...
- median_miner_usd_day: 2912.7637473881864
- top_miner_usd_day: 2912.7637473881864 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 1  |  gini: 0.0  |  top1_share: 1.0  |  top10_share: 1.0
- owner_incentive_share: 1.0 (independent check on miner_burn; disagreement 0.1667)  <- the two burn measures DISAGREE; the burn picture is shifting, treat both as provisional
