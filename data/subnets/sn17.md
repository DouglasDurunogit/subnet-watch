...
- **competitive_miner_usd_day: 5579.692707032007** (uid 74) <- the only figure quotable as achievable
- median_miner_usd_day: 5579.692707032007
- top_miner_usd_day: 5579.692707032007 (uid 74, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5500.7886 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 37.4 (rank 37), confidence 0.85 - hardware from README keywords, not curated
- components: income 34.02 / freshness 0.0 / resource 0.0 / registration 10.0
