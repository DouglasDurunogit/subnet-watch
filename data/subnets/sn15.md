...
- miner_burn: **0.0**
- registration cost: 0.268919627 TAO (53.006747677970004 USD), open=True
...
- **competitive_miner_usd_day: 21.105224269417075** (uid 183) <- the only figure quotable as achievable
- median_miner_usd_day: 12.031950284434032
- top_miner_usd_day: 11990.52881624172 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.8484 USD/day  |  payback on registration: 4.89 days

## Score

- gate: **OK** 
- score: 68.1 (rank 12), confidence 1.0 
- components: income 9.77 / freshness 35.0 / resource 15.0 / registration 8.37
