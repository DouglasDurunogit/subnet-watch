...
- **competitive_miner_usd_day: 94.44298281084522** (uid 140) <- the only figure quotable as achievable
- median_miner_usd_day: 3.5485298608694
- top_miner_usd_day: 1109.6480762177384 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.7358 USD/day  |  payback on registration: [UNKNOWN] days
