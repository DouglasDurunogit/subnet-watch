...
- **competitive_miner_usd_day: 11.281812912015342** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.2843340193750077
- top_miner_usd_day: 2474.073600167993 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4968 USD/day  |  payback on registration: [UNKNOWN] days
