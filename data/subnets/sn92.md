...
- subnet age: 99.7 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 587.7497074427044** (uid 44) <- the only figure quotable as achievable
- median_miner_usd_day: 195.9066039100734
- top_miner_usd_day: 587.7497074427044 (uid 44, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 194.9203 USD/day  |  payback on registration: 0.12 days

## Score

- gate: **OK** 
- score: 80.8 (rank 1), confidence 1.0 
- components: income 20.85 / freshness 35.0 / resource 15.0 / registration 9.96
