...
- **competitive_miner_usd_day: 890.9585420452601** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 8.334141586726101
- top_miner_usd_day: 890.9585420452601 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.0301 USD/day  |  payback on registration: 774.19 days

## Score

- gate: **OK** 
- score: 50.1 (rank 32), confidence 1.0 
- components: income 0.12 / freshness 35.0 / resource 15.0 / registration 0.0
