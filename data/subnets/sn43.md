...
- registration cost: 0.1 TAO (19.773 USD), open=True
...
- **competitive_miner_usd_day: 12.833242709819162** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.9632945936663642
- top_miner_usd_day: 2530.255764130017 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.4981 USD/day  |  payback on registration: 39.7 days

## Score

- gate: **OK** 
- score: 16.6 (rank 67), confidence 1.0 
- components: income 1.6 / freshness 0.0 / resource 15.0 / registration 0.0
