...
- **competitive_miner_usd_day: 318.8458734400566** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 23.47720859160616
- top_miner_usd_day: 318.8458734400566 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.258 USD/day  |  payback on registration: 0.01 days
