...
- registration cost: 0.05 TAO (11.006 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 318.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 44.17196311323159** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2209.744603559175
- top_miner_usd_day: 4375.3172440051185 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 35.9528 USD/day  |  payback on registration: 0.31 days
...
- components: income 14.26 / freshness 10.5 / resource 11.25 / registration 9.9
