...
- **competitive_miner_usd_day: 25.355218644076153** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 10.662456130003854
- top_miner_usd_day: 2489.04579964956 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.5741 USD/day  |  payback on registration: 2.39 days

## Score

- gate: **OK** 
- score: 54.5 (rank 26), confidence 1.0 
- components: income 9.32 / freshness 21.0 / resource 15.0 / registration 9.2
