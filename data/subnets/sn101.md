...
- registration cost: 0.010444829 TAO (2.52378403127 USD), open=True
...
- **competitive_miner_usd_day: 2.313627778112768** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 1.156813889056384
- top_miner_usd_day: 2973.46436117932 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 242  |  gini: 0.9203808199527475  |  top1_share: 0.9044166016491502  |  top10_share: 0.910474704361528
- owner_incentive_share: 0.9044166016491502 (independent check on miner_burn; disagreement 0.0023)
...
- net margin: 0.1705 USD/day  |  payback on registration: 14.8 days

## Score

- gate: **OK** 
- score: 41.7 (rank 38), confidence 1.0 
- components: income 0.62 / freshness 21.0 / resource 15.0 / registration 5.07
