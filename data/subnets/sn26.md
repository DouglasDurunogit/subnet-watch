...
- **competitive_miner_usd_day: 74.5178039438496** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 51.22459566300326
- top_miner_usd_day: 1564.839778562744 (uid 45, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.6994 USD/day  |  payback on registration: 0.49 days

## Score

- gate: **OK** 
- score: 70.6 (rank 3), confidence 1.0 
- components: income 14.54 / freshness 35.0 / resource 11.25 / registration 9.84
