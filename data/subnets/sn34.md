...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (111.82 USD), open=True
...
- **competitive_miner_usd_day: 323.79233814548115** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 10.928144897591132
- top_miner_usd_day: 3238.414534034478 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -18.6609 USD/day  |  payback on registration: [UNKNOWN] days
