...
- miner_burn: **0.15056867711246014**
- registration cost: 0.1 TAO (22.008000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 31  |  free: 0
- subnet age: 808.0 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 523.2298409086649** (uid 244) <- the only figure quotable as achievable
- median_miner_usd_day: 9.804532140721447
- top_miner_usd_day: 1046.4596818173297 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 3.907 USD/day  |  payback on registration: 5.63 days

## Score

- gate: **OK** 
- score: 64.4 (rank 15), confidence 1.0 
- components: income 6.28 / freshness 35.0 / resource 15.0 / registration 8.12
