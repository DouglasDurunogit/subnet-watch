...
- miner_burn: **0.7632869421504438**
- registration cost: 0.1 TAO (19.179 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 25  |  free: 0
- subnet age: 740.9 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.113908318027642** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.853555946010974
- top_miner_usd_day: 2317.9643882840237 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.899355479229788  |  top1_share: 0.7634149319333374  |  top10_share: 0.9972529149624565
...
- net margin: 0.6819 USD/day  |  payback on registration: 28.13 days

## Score

- gate: **OK** 
- score: 17.7 (rank 61), confidence 1.0 
- components: income 2.05 / freshness 0.0 / resource 15.0 / registration 0.62
