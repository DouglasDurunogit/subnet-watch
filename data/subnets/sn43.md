...
- registration cost: 0.1 TAO (18.722 USD), open=True
...
- **competitive_miner_usd_day: 59.292337236514** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.26590841256206
- top_miner_usd_day: 2412.448346552532 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.5317 USD/day  |  payback on registration: 35.21 days
