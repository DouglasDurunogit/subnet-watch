...
- subnet age: 107.5 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 285.5605372928136** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 28.041844307633983
- top_miner_usd_day: 1999.0544922585877 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 19.9844 USD/day  |  payback on registration: 1.23 days

## Score

- gate: **OK** 
- score: 67.9 (rank 9), confidence 1.0 
- components: income 12.02 / freshness 35.0 / resource 11.25 / registration 9.59
