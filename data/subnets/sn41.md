...
- **competitive_miner_usd_day: 32.80763728938586** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.230732220014579
- top_miner_usd_day: 2435.0154659978434 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.1765 USD/day  |  payback on registration: 3.9 days

## Score

- gate: **OK** 
- score: 65.9 (rank 12), confidence 1.0 
- components: income 7.19 / freshness 35.0 / resource 15.0 / registration 8.7
