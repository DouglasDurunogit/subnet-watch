...
- registration cost: 0.002251584 TAO (0.54596408832 USD), open=True
...
- **competitive_miner_usd_day: 2.417261072825838** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0575517193613042
- top_miner_usd_day: 2985.6699421796975 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0713 USD/day  |  payback on registration: 7.66 days

## Score

- gate: **OK** 
- score: 43.7 (rank 37), confidence 1.0 
- components: income 0.27 / freshness 21.0 / resource 15.0 / registration 7.45
