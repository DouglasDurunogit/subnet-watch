...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (238.986 USD), open=True
...
- **competitive_miner_usd_day: 44311.785466653615** (uid 84) <- the only figure quotable as achievable
- median_miner_usd_day: 154.41348289692255
- top_miner_usd_day: 44311.785466653615 (uid 84, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 153.4272 USD/day  |  payback on registration: 1.56 days

## Score

- gate: **OK** 
- score: 65.4 (rank 15), confidence 1.0 
- components: income 19.91 / freshness 21.0 / resource 15.0 / registration 9.48
