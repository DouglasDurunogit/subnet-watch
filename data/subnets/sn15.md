...
- miner_burn: **0.0**
- registration cost: 0.310122338 TAO (59.29228980222 USD), open=True
...
- **competitive_miner_usd_day: 15596.565303361775** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 14.356144082222388
- top_miner_usd_day: 15596.565303361775 (uid 253, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 13.2439 USD/day  |  payback on registration: 4.48 days

## Score

- gate: **OK** 
- score: 69.0 (rank 8), confidence 1.0 
- components: income 10.49 / freshness 35.0 / resource 15.0 / registration 8.51
