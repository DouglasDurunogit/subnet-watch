...
- **competitive_miner_usd_day: 8.01724017063909** (uid 47) <- the only figure quotable as achievable
- median_miner_usd_day: 7.029895322038215
- top_miner_usd_day: 2495.05992620835 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.2288 USD/day  |  payback on registration: [UNKNOWN] days
