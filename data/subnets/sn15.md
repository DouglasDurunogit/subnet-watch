...
- miner_burn: **0.0**
- registration cost: 0.219928032 TAO (43.80526541376 USD), open=True
...
- **competitive_miner_usd_day: 20.32853473892029** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 10.429422170402582
- top_miner_usd_day: 10876.826704526124 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.178 USD/day  |  payback on registration: 4.77 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 1.0 
- components: income 9.16 / freshness 35.0 / resource 15.0 / registration 8.41
