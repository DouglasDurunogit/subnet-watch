...
- miner_burn: **0.797803194494918**
- registration cost: 0.1 TAO (20.373 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 17  |  free: 0
- subnet age: 752.6 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 36.50053998833681** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 15.975037395425923
- top_miner_usd_day: 2531.026833886209 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 11  |  gini: 0.8369690680458595  |  top1_share: 0.7978879257721889  |  top10_share: 0.9999694786961298
- owner_incentive_share: 0.7978879257721889 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 3.2737 USD/day  |  payback on registration: 6.22 days

## Score

- gate: **OK** 
- score: 28.7 (rank 58), confidence 1.0 
- components: income 5.74 / freshness 0.0 / resource 15.0 / registration 7.93
