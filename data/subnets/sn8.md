...
- subnet age: 1061.0 days  |  registered at block 1477264
- weights_version: 199  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 887.3166222526492** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7161554659020576
- top_miner_usd_day: 21865.658684921622 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 24  |  gini: 0.9498128056234718  |  top1_share: 0.9331295843520783  |  top10_share: 0.9996179706601467
...
- net margin: -7.503 USD/day  |  payback on registration: [UNKNOWN] days
