...
- miner_burn: **0.0**
- registration cost: 0.676560949 TAO (130.75893461323 USD), open=True
...
- **competitive_miner_usd_day: 2874.576937994274** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 31.637430530423444
- top_miner_usd_day: 27213.25224504903 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.7855 USD/day  |  payback on registration: 5.74 days

## Score

- gate: **OK** 
- score: 56.8 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 12.52 / freshness 35.0 / resource 11.25 / registration 8.09
