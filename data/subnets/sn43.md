...
- registration cost: 0.1 TAO (22.479 USD), open=True
...
- **competitive_miner_usd_day: 179.93219300281027** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 12.845186993559782
- top_miner_usd_day: 2659.600945771201 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2893 USD/day  |  payback on registration: [UNKNOWN] days
