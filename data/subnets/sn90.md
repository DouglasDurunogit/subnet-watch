...
- **competitive_miner_usd_day: 2792.470448333567** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 10475.200822043043
- top_miner_usd_day: 18157.93119575252 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 2713.5663 USD/day  |  payback on registration: 0.0 days
...
- components: income 31.23 / freshness 35.0 / resource 0.0 / registration 10.0
