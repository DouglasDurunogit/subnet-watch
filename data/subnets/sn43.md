...
- registration cost: 0.1 TAO (22.42 USD), open=True
...
- **competitive_miner_usd_day: 191.42002487701262** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0631633225118393
- top_miner_usd_day: 2678.766558130783 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4547 USD/day  |  payback on registration: [UNKNOWN] days
