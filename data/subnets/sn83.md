...
- miner_burn: **0.0**
- registration cost: 0.188108066 TAO (37.482413231159995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 251  |  free: 0
- subnet age: 506.9 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 77.9034196324018** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 19.1908423972502
- top_miner_usd_day: 147.06645559872928 (uid 153, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.3866405135931894  |  top1_share: 0.023669362853778995  |  top10_share: 0.15134325163223805
...
- net margin: 8.8816 USD/day  |  payback on registration: 4.22 days

## Score

- gate: **OK** 
- score: 24.6 (rank 71), confidence 0.85 - hardware requirement unknown
- components: income 9.05 / freshness 0.0 / resource 11.25 / registration 8.59
