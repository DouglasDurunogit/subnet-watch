...
- **competitive_miner_usd_day: 77.03240240115008** (uid 168) <- the only figure quotable as achievable
- median_miner_usd_day: 22.471693514099194
- top_miner_usd_day: 83.97563964558991 (uid 192, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.5142 USD/day  |  payback on registration: 2.07 days

## Score

- gate: **OK** 
- score: 25.4 (rank 66), confidence 0.85 - hardware requirement unknown
