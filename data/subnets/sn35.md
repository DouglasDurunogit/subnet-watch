...
- **competitive_miner_usd_day: 1135.851253973957** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 418.57741656165814
- top_miner_usd_day: 1135.851253973957 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 650.0011 USD/day  |  payback on registration: 0.03 days
...
- components: income 25.59 / freshness 0.0 / resource 11.25 / registration 9.99
