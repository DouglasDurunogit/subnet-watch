...
- miner_burn: **0.0**
- registration cost: 0.46351549 TAO (104.8657444576 USD), open=True
...
- **competitive_miner_usd_day: 22007.36327713202** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 18.66732157047512
- top_miner_usd_day: 22007.36327713202 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.681 USD/day  |  payback on registration: 5.93 days

## Score

- gate: **OK** 
- score: 69.6 (rank 7), confidence 1.0 
- components: income 11.56 / freshness 35.0 / resource 15.0 / registration 8.02
