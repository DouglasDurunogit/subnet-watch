...
- registration cost: 0.05 TAO (10.4255 USD), open=True
...
- **competitive_miner_usd_day: 364.46492590485155** (uid 155) <- the only figure quotable as achievable
- median_miner_usd_day: 364.46492590485155
- top_miner_usd_day: 1318.496454669073 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 336.5884 USD/day  |  payback on registration: 0.03 days
...
- components: income 23.0 / freshness 35.0 / resource 11.25 / registration 9.99
