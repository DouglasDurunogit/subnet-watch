...
- **competitive_miner_usd_day: 11924.648722858814** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.027844723683187
- top_miner_usd_day: 11924.648722858814 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.1913 USD/day  |  payback on registration: [UNKNOWN] days
