...
- miner_burn: **0.0**
- registration cost: 0.001558159 TAO (0.35016507206999997 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 9  |  free: 0
- subnet age: 134.7 days  |  registered at block 8026517
- weights_version: 1778428951  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2184.690349382046** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2184.690349382046
- top_miner_usd_day: 2184.690349382046 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2176.4712 USD/day  |  payback on registration: 0.0 days
