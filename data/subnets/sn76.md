...
- **competitive_miner_usd_day: 189.0634333812796** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 105.8843439917573
- top_miner_usd_day: 252.09736233191015 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 97.3328 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 78.1 (rank 1), confidence 1.0 
- components: income 18.12 / freshness 35.0 / resource 15.0 / registration 10.0
