...
- miner_burn: **0.0**
- registration cost: 0.000546273 TAO (0.10797632118 USD), open=True
...
- **competitive_miner_usd_day: 1978.215349875166** (uid 102) <- the only figure quotable as achievable
- median_miner_usd_day: 329.68578809084346
- top_miner_usd_day: 1978.215349875166 (uid 102, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 321.4666 USD/day  |  payback on registration: 0.0 days
