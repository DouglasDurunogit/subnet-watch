...
- miner_burn: **0.0**
- registration cost: 0.130807828 TAO (26.544832536039998 USD), open=True
...
- **competitive_miner_usd_day: 684.9721087308961** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 1712.4825358367575
- top_miner_usd_day: 4452.5800267984105 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 676.7529 USD/day  |  payback on registration: 0.04 days
...
- components: income 25.75 / freshness 35.0 / resource 11.25 / registration 9.99
