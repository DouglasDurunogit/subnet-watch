...
- registration cost: 0.005 TAO (1.0304 USD), open=True
...
- **competitive_miner_usd_day: 22.41300100794008** (uid 152) <- the only figure quotable as achievable
- median_miner_usd_day: 22.26714633760641
- top_miner_usd_day: 3121.289945140462 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 13.1242 USD/day  |  payback on registration: 0.08 days
...
- components: income 10.46 / freshness 21.0 / resource 11.25 / registration 9.97
