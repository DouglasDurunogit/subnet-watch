...
- miner_burn: **0.0**
- registration cost: 0.153596856 TAO (30.6195332436 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 213  |  free: 0
- subnet age: 506.3 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 390.44719020170805** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 6.716793225558369
- top_miner_usd_day: 390.44719020170805 (uid 156, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 212  |  gini: 0.7202672915112078  |  top1_share: 0.08886612752816718  |  top10_share: 0.48161680399920503
...
- net margin: 5.7305 USD/day  |  payback on registration: 5.34 days

## Score

- gate: **OK** 
- score: 30.8 (rank 53), confidence 1.0 
- components: income 7.53 / freshness 0.0 / resource 15.0 / registration 8.22
