...
- registration cost: 0.014365881 TAO (3.48329516607 USD), open=True
...
- **competitive_miner_usd_day: 2.3242049606428** (uid 11) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0357869933299433
- top_miner_usd_day: 2992.5149392171984 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 232  |  gini: 0.9253284963391755  |  top1_share: 0.905431642028343  |  top10_share: 0.9117606591961843
- owner_incentive_share: 0.905431642028343 (independent check on miner_burn; disagreement 0.0017)
...
- net margin: 0.0242 USD/day  |  payback on registration: 143.94 days

## Score

- gate: **OK** 
- score: 36.1 (rank 50), confidence 1.0 
- components: income 0.09 / freshness 21.0 / resource 15.0 / registration 0.0
