...
- miner_burn: **0.0**
- registration cost: 0.346146789 TAO (71.14008807528 USD), open=True
...
- **competitive_miner_usd_day: 16256.552933079649** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 17.954539370709618
- top_miner_usd_day: 16256.552933079649 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.9682 USD/day  |  payback on registration: 4.19 days

## Score

- gate: **OK** 
- score: 70.0 (rank 6), confidence 1.0 
- components: income 11.41 / freshness 35.0 / resource 15.0 / registration 8.6
