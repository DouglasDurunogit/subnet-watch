...
- subnet age: 529.9 days  |  registered at block 4958013
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2024.6767209964792
- top_miner_usd_day: 2024.6767209964792 (uid 121, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 34178 bytes, sha 5ca071d11c94101b
- latest release: (none) 
- last commit: 2026-08-04T10:06:54Z
- scoring-related commit: Merge pull request #11 from conjectures-io/fix/missing-task-mode 2026-08-04T08:30:10Z
...
eligibility. It must not make an invalid proof va
```

_(truncated at 6000 of 34178 chars - read the full file at https://github.com/conjectures-io/conjectures-validator)_
