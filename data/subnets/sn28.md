...
- miner_burn: **0.0004085330292582512**
- registration cost: 0.1 TAO (25.590000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 69  |  free: 0
- subnet age: 575.3 days  |  registered at block 4878363
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 335.82393797748887** (uid 62) <- the only figure quotable as achievable
- median_miner_usd_day: 40.70225008048436
- top_miner_usd_day: 12181.029206176237 (uid 72, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 58  |  gini: 0.8702887724407469  |  top1_share: 0.7652896094775732  |  top10_share: 0.8829806723458826
- owner_incentive_share: 0.0003969344447497786 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 20003 bytes, sha c78ec6ade3345382
- latest release: v0.4.14 2026-09-02T17:42:54Z
- last commit: 2026-09-02T17:27:47Z
- scoring-related commit: Add one pre-response upstream retry and JSON 502 to miner envoy (#220) 2026-08-28T16:04:39Z
...
- net margin: 31.8756 USD/day  |  payback on registration: 0.8 days

## Score

- gate: **OK** 
- score: 59.3 (rank 20), confidence 0.85 - hardware requirement unknown
- components: income 13.8 / freshness 35.0 / resource 11.25 / registration 9.73
...
_(truncated at 6000 of 20003 chars - read the full file at https://github.com/taostat/gm-miner)_
