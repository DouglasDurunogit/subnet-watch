...
- subnet age: 1038.4 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1578.4108691093686** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 13.89557387771353
- top_miner_usd_day: 1578.4108691093686 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.342 USD/day  |  payback on registration: 40.15 days

## Score

- gate: **OK** 
- score: 33.6 (rank 58), confidence 0.85 - hardware requirement unknown
- components: income 7.3 / freshness 21.0 / resource 11.25 / registration 0.0
