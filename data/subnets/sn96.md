...
- subnet age: 144.2 days  |  registered at block 7692872
- weights_version: 1000  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 111.25833388712891** (uid 220) <- the only figure quotable as achievable
- median_miner_usd_day: 37.975272638893614
- top_miner_usd_day: 111.25833388712891 (uid 220, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 146  |  gini: 0.34687658970381463  |  top1_share: 0.01752134793700258  |  top10_share: 0.15950995218673145
...
- net margin: 29.7561 USD/day  |  payback on registration: 0.64 days

## Score

- gate: **OK** 
- score: 34.6 (rank 33), confidence 1.0 
- components: income 13.53 / freshness 0.0 / resource 11.25 / registration 9.79
