...
- registration cost: 0.000935508 TAO (0.23191243320000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 455.9 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 5010.5707051059835
- top_miner_usd_day: 5010.5707051059835 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 18290 bytes, sha 725e646e02513f74
- latest release: (none) 
- last commit: 2026-08-20T17:04:54Z
- scoring-related commit: docs(validation): document resilient diagnostic batching 2026-08-20T17:04:54Z
...
_(truncated at 6000 of 18290 chars - read the full file at https://github.com/DeSciClaims/Claims)_
