...
- miner_burn: **0.0**
- registration cost: 0.238378297 TAO ([UNKNOWN] USD), open=True
...
- **competitive_miner_usd_day: [UNKNOWN]** (uid 187) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 224, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
