...
- miner_burn: **0.0**
- registration cost: 0.591039487 TAO (135.47807121014 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 86  |  free: 0
- subnet age: 225.3 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21879.97222357915** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 23.217593584180953
- top_miner_usd_day: 21879.97222357915 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.2313 USD/day  |  payback on registration: 6.09 days

## Score

- gate: **OK** 
- score: 70.4 (rank 6), confidence 1.0 
- components: income 12.42 / freshness 35.0 / resource 15.0 / registration 7.97
