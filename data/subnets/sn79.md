...
- miner_burn: **0.0**
- registration cost: 0.248515995 TAO (47.5808724027 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 227  |  free: 0
- subnet age: 514.4 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 349.93138791270167** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 5.085367288218135
- top_miner_usd_day: 349.93138791270167 (uid 237, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 226  |  gini: 0.731191443912764  |  top1_share: 0.09203044754218637  |  top10_share: 0.47528429933969185
...
- net margin: 4.0991 USD/day  |  payback on registration: 11.61 days

## Score

- gate: **OK** 
- score: 27.6 (rank 61), confidence 1.0 
- components: income 6.43 / freshness 0.0 / resource 15.0 / registration 6.13
