...
- subnet age: 131.8 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 28.604917041527543** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 22.475291961200213
- top_miner_usd_day: 1602.2246207118853 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 13.3868 USD/day  |  payback on registration: 1.68 days

## Score

- gate: **OK** 
- score: 52.2 (rank 31), confidence 1.0 
- components: income 10.53 / freshness 21.0 / resource 11.25 / registration 9.44
