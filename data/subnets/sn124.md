...
- **competitive_miner_usd_day: 725.6748331300142** (uid 206) <- the only figure quotable as achievable
- median_miner_usd_day: 230.3878956436924
- top_miner_usd_day: 725.6748331300142 (uid 206, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 222.1687 USD/day  |  payback on registration: 0.45 days
