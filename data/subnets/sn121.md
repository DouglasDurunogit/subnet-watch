...
- **competitive_miner_usd_day: 1070.3390182475107** (uid 240) <- the only figure quotable as achievable
- median_miner_usd_day: 1436.9565538950376
- top_miner_usd_day: 1803.5740895425643 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.1275673696096684  |  top1_share: 0.6275673696096682  |  top10_share: 1.0
...
- net margin: 1062.1198 USD/day  |  payback on registration: 0.0 days
...
- components: income 27.53 / freshness 0.0 / resource 11.25 / registration 10.0
