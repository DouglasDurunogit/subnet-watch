...
- subnet age: 488.8 days  |  registered at block 5258781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 566.010399347734** (uid 51) <- the only figure quotable as achievable
- median_miner_usd_day: 279.20068453216777
- top_miner_usd_day: 566.010399347734 (uid 51, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.33616358919578815  |  top1_share: 0.17027315733251946  |  top10_share: 1.0
...
- status: **ok** 
- README: 4992 bytes, sha 53c40319a537db3b
- latest release: (none) 
- last commit: 2026-07-28T07:19:51Z
- scoring-related commit: defer scoring commit to DB (#180) 2026-07-28T07:19:51Z
...
- net margin: 557.7912 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 40.3 (rank 36), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 24.99 / freshness 21.0 / resource 11.25 / registration 10.0
