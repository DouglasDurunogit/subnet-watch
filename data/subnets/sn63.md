...
- **competitive_miner_usd_day: 4874.92637018879** (uid 87) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07440363812864455
- top_miner_usd_day: 4874.92637018879 (uid 87, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
