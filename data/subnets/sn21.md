...
- miner_burn: **0.1505162427201867**
- registration cost: 0.1 TAO (22.773 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 35  |  free: 0
- subnet age: 810.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 53.303949506247555** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 9.987668354583587
- top_miner_usd_day: 1066.0789901249514 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826554321119537  |  top1_share: 0.447143925404795  |  top10_share: 0.9986875639049551
...
- last commit: 2026-09-04T04:09:32Z
- scoring-related commit: test(validator): prove burn composition matches the committer branch … 2026-09-04T04:09:32Z
...
- net margin: 0.2326 USD/day  |  payback on registration: 97.91 days

## Score

- gate: **OK** 
- score: 50.8 (rank 35), confidence 1.0 
- components: income 0.83 / freshness 35.0 / resource 15.0 / registration 0.0
