...
- miner_burn: **0.5167850477155298**
- registration cost: 0.0005 TAO (0.11705 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 137  |  free: 0
- subnet age: 964.6 days  |  registered at block 2009702
- weights_version: 1000910  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 114.71299779379143** (uid 66) <- the only figure quotable as achievable
- median_miner_usd_day: 8.063916340361915
- top_miner_usd_day: 1140.295009181783 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 128  |  gini: 0.7202683978510227  |  top1_share: 0.5172666595390466  |  top10_share: 0.6463274937760604
- owner_incentive_share: 0.5172666595390467 (independent check on miner_burn; disagreement 0.0005)
...
- net margin: -0.2058 USD/day  |  payback on registration: [UNKNOWN] days
