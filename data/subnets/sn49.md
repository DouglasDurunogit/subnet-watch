...
- miner_burn: **0.0**
- registration cost: 0.05 TAO (12.6765 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 321.8 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 52.99532165687397** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 2651.141533940137
- top_miner_usd_day: 5249.2877462234 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 44.7761 USD/day  |  payback on registration: 0.28 days
...
- components: income 15.1 / freshness 35.0 / resource 11.25 / registration 9.91
