...
- miner_burn: **0.0**
- registration cost: 0.879439624 TAO (192.61486644848 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 466.7 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2912.0755012957793** (uid 87) <- the only figure quotable as achievable
- median_miner_usd_day: 332.8249521143518
- top_miner_usd_day: 2912.0755012957793 (uid 87, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 324.6058 USD/day  |  payback on registration: 0.59 days

## Score

- gate: **OK** 
- score: 67.1 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 22.85 / freshness 35.0 / resource 11.25 / registration 9.8
