...
- **competitive_miner_usd_day: 8.89089496279085** (uid 26) <- the only figure quotable as achievable
- median_miner_usd_day: 8.024898700181351
- top_miner_usd_day: 2403.0434069344005 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.1943 USD/day  |  payback on registration: [UNKNOWN] days
