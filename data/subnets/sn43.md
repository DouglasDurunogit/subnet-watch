...
- registration cost: 0.1 TAO (19.545 USD), open=True
...
- **competitive_miner_usd_day: 17.287472089237916** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9706869354919685
- top_miner_usd_day: 2432.5414603428735 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
