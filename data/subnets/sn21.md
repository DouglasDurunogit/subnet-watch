...
- miner_burn: **0.45125416084192693**
- registration cost: 0.1 TAO (19.801000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 100  |  free: 0
- subnet age: 790.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 34.01602914734211** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.326987984445111
- top_miner_usd_day: 837.5703696462956 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.3407 USD/day  |  payback on registration: 2.7 days

## Score

- gate: **OK** 
- score: 67.5 (rank 12), confidence 1.0 
- components: income 8.38 / freshness 35.0 / resource 15.0 / registration 9.1
