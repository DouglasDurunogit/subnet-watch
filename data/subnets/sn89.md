...
- subnet age: 487.5 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 238.54752078249413** (uid 191) <- the only figure quotable as achievable
- median_miner_usd_day: 0.06664579645627511
- top_miner_usd_day: 238.54752078249413 (uid 191, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 49  |  gini: 0.786208292840946  |  top1_share: 0.16388888888888892  |  top10_share: 0.8361416361416362
...
- status: **ok** 
- README: 15380 bytes, sha 6a34810943c7c7d9
- latest release: (none) 
- last commit: 2026-08-11T17:49:59Z
- scoring-related commit: HF: one submission counter for both signers — a hotkey's own miner wa… 2026-08-11T17:49:59Z
...
- net margin: -8.1525 USD/day  |  payback on registration: [UNKNOWN] days
...
- **One feed = one hotkey.** Mirroring the same feed from 
```

_(truncated at 6000 of 15380 chars - read the full file at https://github.com/DeltaCompute24/InfiniteQuant-Subnet)_
