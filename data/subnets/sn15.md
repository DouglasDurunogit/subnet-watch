...
- miner_burn: **0.0**
- registration cost: 0.343540114 TAO (67.89039732868001 USD), open=True
...
- **competitive_miner_usd_day: 21.95917823345655** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 11.562576149474909
- top_miner_usd_day: 11796.936936639057 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.4791 USD/day  |  payback on registration: 6.48 days

## Score

- gate: **OK** 
- score: 67.5 (rank 11), confidence 1.0 
- components: income 9.64 / freshness 35.0 / resource 15.0 / registration 7.84
