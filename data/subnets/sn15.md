...
- miner_burn: **0.0**
- registration cost: 0.248811277 TAO (48.08775550579 USD), open=True
...
- **competitive_miner_usd_day: 10337.804419514034** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 12.361919550293875
- top_miner_usd_day: 10337.804419514034 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.3756 USD/day  |  payback on registration: 4.23 days

## Score

- gate: **OK** 
- score: 68.5 (rank 8), confidence 1.0 
- components: income 9.94 / freshness 35.0 / resource 15.0 / registration 8.59
