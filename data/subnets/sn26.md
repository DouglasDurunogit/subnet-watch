...
- subnet age: 120.3 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1769.06869485902** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 24.815706176522205
- top_miner_usd_day: 1769.06869485902 (uid 45, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.6008 USD/day  |  payback on registration: 1.15 days

## Score

- gate: **OK** 
- score: 53.8 (rank 26), confidence 1.0 
- components: income 11.95 / freshness 21.0 / resource 11.25 / registration 9.62
