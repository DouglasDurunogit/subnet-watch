...
- subnet age: 862.4 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2770.5550987832694** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 2008.8355522780885
- top_miner_usd_day: 2770.5550987832694 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.27382768986617423  |  top1_share: 0.38096836708223336  |  top10_share: 1.0
...
- net margin: 1571.5753 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 33.2 (rank 44), confidence 0.85 - hardware from README keywords, not curated
- components: income 29.07 / freshness 0.0 / resource 0.0 / registration 10.0
