...
- **competitive_miner_usd_day: 37.2461705970555** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 15.792756881510126
- top_miner_usd_day: 2482.69749144511 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 11  |  gini: 0.8362543162707974  |  top1_share: 0.7964717911153839  |  top10_share: 0.9999542187428465
...
- net margin: 3.2473 USD/day  |  payback on registration: 6.16 days

## Score

- gate: **OK** 
- score: 28.7 (rank 49), confidence 1.0 
- components: income 5.71 / freshness 0.0 / resource 15.0 / registration 7.95
