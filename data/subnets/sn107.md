...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (197.1882 USD), open=True
- tempo: 360.0  |  max_uids: 90  |  active: 29  |  free: 0
- subnet age: 186.8 days  |  registered at block 7457580
- weights_version: 20  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 34865.89359967358** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 116.39492703285313
- top_miner_usd_day: 34865.89359967358 (uid 45, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.9027286878490981  |  top1_share: 0.9005738180264323  |  top10_share: 0.9876079724078992
...
- net margin: 115.4086 USD/day  |  payback on registration: 1.71 days

## Score

- gate: **OK** 
- score: 78.2 (rank 2), confidence 1.0 
- components: income 18.79 / freshness 35.0 / resource 15.0 / registration 9.43
