...
- miner_burn: **2.8151553124189377e-06**
- registration cost: 0.8 TAO (156.76800000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 246  |  free: 0
- subnet age: 569.1 days  |  registered at block 4763204
- weights_version: 100  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 46.7792622222648** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 10.766655590838724
- top_miner_usd_day: 46.7792622222648 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 238  |  gini: 0.32808911831325815  |  top1_share: 0.015412137057933123  |  top10_share: 0.15263825818387536
...
- net margin: 2.5475 USD/day  |  payback on registration: 61.54 days

## Score

- gate: **OK** 
- score: 31.7 (rank 51), confidence 0.85 - hardware requirement unknown
- components: income 5.0 / freshness 21.0 / resource 11.25 / registration 0.0
