...
- subnet age: 817.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 114.58590822593504** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 10.735096180211322
- top_miner_usd_day: 1145.7808666223364 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 6.1704 USD/day  |  payback on registration: 3.9 days

## Score

- gate: **OK** 
- score: 66.5 (rank 15), confidence 1.0 
- components: income 7.78 / freshness 35.0 / resource 15.0 / registration 8.7
