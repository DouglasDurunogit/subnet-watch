...
- miner_burn: **0.0**
- registration cost: 0.000516625 TAO (0.10185261875000001 USD), open=True
...
- **competitive_miner_usd_day: 2434.1291419969702** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2434.1291419969702
- top_miner_usd_day: 2434.1291419969702 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2425.91 USD/day  |  payback on registration: 0.0 days
