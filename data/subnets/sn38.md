...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (172.7604 USD), open=True
- tempo: 1440.0  |  max_uids: 256  |  active: 17  |  free: 0
- subnet age: 247.2 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1689.5160164237222** (uid 128) <- the only figure quotable as achievable
- median_miner_usd_day: 178.3255482086918
- top_miner_usd_day: 3760.2759537858783 (uid 168, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 123.7423 USD/day  |  payback on registration: 1.4 days

## Score

- gate: **OK** 
- score: 66.8 (rank 7), confidence 0.85 - hardware from README keywords, not curated
- components: income 19.06 / freshness 35.0 / resource 15.0 / registration 9.53
