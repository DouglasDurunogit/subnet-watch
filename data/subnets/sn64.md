...
- subnet age: 625.2 days  |  registered at block 4531295
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 8534.045976477735** (uid 177) <- the only figure quotable as achievable
- median_miner_usd_day: 3439.558252041357
- top_miner_usd_day: 8534.045976477735 (uid 177, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 15  |  gini: 0.3552740813087534  |  top1_share: 0.15463618605786839  |  top10_share: 0.8841411305090954
...
- net margin: 3409.9692 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 39.0 (rank 56), confidence 0.85 - hardware from README keywords, not curated
- components: income 32.13 / freshness 0.0 / resource 3.75 / registration 10.0
