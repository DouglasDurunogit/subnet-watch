...
- registration cost: 0.999999999 TAO (199.45999980054 USD), open=True
...
- **competitive_miner_usd_day: 1030.0629207594043** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 2.621964218691447
- top_miner_usd_day: 1030.0629207594043 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.6166 USD/day  |  payback on registration: [UNKNOWN] days
