...
- **competitive_miner_usd_day: 106.54409375509972** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 2.5533442947845253
- top_miner_usd_day: 592.5564158856007 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.6916 USD/day  |  payback on registration: [UNKNOWN] days
