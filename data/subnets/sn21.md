...
- miner_burn: **0.15275414753705263**
- registration cost: 0.1 TAO (23.674000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 44  |  free: 0
- subnet age: 820.0 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 107.22352897675685** (uid 234) <- the only figure quotable as achievable
- median_miner_usd_day: 32.29225100021145
- top_miner_usd_day: 837.8679264650076 (uid 110, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 21  |  gini: 0.7099696589814866  |  top1_share: 0.3472720335749714  |  top10_share: 0.9480808851583366
- owner_incentive_share: 0.15276611980160246 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 22.3768 USD/day  |  payback on registration: 1.06 days

## Score

- gate: **OK** 
- score: 72.1 (rank 2), confidence 1.0 
- components: income 12.45 / freshness 35.0 / resource 15.0 / registration 9.65
