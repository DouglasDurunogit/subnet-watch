...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (115.16 USD), open=True
...
- **competitive_miner_usd_day: 331.956970546117** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 9.693093186215782
- top_miner_usd_day: 3320.0732427695452 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.0218 USD/day  |  payback on registration: [UNKNOWN] days
