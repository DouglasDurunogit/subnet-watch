...
- miner_burn: **0.0**
- registration cost: 0.18493532 TAO (49.6162970028 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 8  |  free: 0
- subnet age: 575.3 days  |  registered at block 4972413
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 10162.191217915693** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 10162.191217915693
- top_miner_usd_day: 10162.191217915693 (uid 42, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10153.972 USD/day  |  payback on registration: 0.0 days
...
- components: income 36.44 / freshness 10.5 / resource 11.25 / registration 10.0
