...
- subnet age: 132.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 348.01463339386083** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 22.7820362755798
- top_miner_usd_day: 1624.091891384534 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 13.6098 USD/day  |  payback on registration: 1.62 days

## Score

- gate: **OK** 
- score: 52.3 (rank 29), confidence 1.0 
- components: income 10.59 / freshness 21.0 / resource 11.25 / registration 9.46
