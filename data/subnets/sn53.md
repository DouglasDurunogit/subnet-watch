...
- miner_burn: **0.0**
- registration cost: 0.000716787 TAO (0.16271781686999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 164  |  free: 0
- subnet age: 656.5 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6541.855242782839** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 10.703959845352896
- top_miner_usd_day: 7181.489167595684 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 2.4848 USD/day  |  payback on registration: 0.07 days

## Score

- gate: **OK** 
- score: 52.0 (rank 29), confidence 0.85 - hardware from README keywords, not curated
- components: income 4.93 / freshness 35.0 / resource 11.25 / registration 9.98
