...
- registration cost: 0.1 TAO (20.266000000000002 USD), open=True
...
- **competitive_miner_usd_day: 41.23770397168583** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 4.363524490027222
- top_miner_usd_day: 2502.5532212584685 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.6027 USD/day  |  payback on registration: [UNKNOWN] days
