...
- **competitive_miner_usd_day: 29.623567093078883** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.204008255196582
- top_miner_usd_day: 2477.2536283941777 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.1032 USD/day  |  payback on registration: 4.0 days

## Score

- gate: **OK** 
- score: 51.8 (rank 29), confidence 1.0 
- components: income 7.14 / freshness 21.0 / resource 15.0 / registration 8.67
