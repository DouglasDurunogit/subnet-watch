...
- **competitive_miner_usd_day: 11.127888782170595** (uid 177) <- the only figure quotable as achievable
- median_miner_usd_day: 8.647772807258676
- top_miner_usd_day: 11.127888782170595 (uid 177, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.2654 USD/day  |  payback on registration: 0.42 days

## Score

- gate: **OK** 
- score: 18.7 (rank 76), confidence 0.85 - hardware requirement unknown
- components: income 0.93 / freshness 0.0 / resource 11.25 / registration 9.86
