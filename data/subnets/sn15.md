...
- miner_burn: **0.0**
- registration cost: 0.237858296 TAO (47.4289442224 USD), open=True
...
- **competitive_miner_usd_day: 22.76606950063497** (uid 14) <- the only figure quotable as achievable
- median_miner_usd_day: 11.177935025086539
- top_miner_usd_day: 12409.148675647906 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 88  |  gini: 0.9378824200596327  |  top1_share: 0.9238227569779516  |  top10_share: 0.9385573810541745
...
- net margin: 10.1916 USD/day  |  payback on registration: 4.65 days

## Score

- gate: **OK** 
- score: 68.0 (rank 11), confidence 1.0 
- components: income 9.54 / freshness 35.0 / resource 15.0 / registration 8.45
