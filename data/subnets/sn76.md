...
- **competitive_miner_usd_day: 123.0793183449812** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 82.50671119143654
- top_miner_usd_day: 275.33656222681725 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 68.8899 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.8 (rank 1), confidence 1.0 
- components: income 16.78 / freshness 35.0 / resource 15.0 / registration 10.0
