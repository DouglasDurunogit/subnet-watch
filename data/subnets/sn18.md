...
- **competitive_miner_usd_day: 1078.1264703961795** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 3.814818757525949
- top_miner_usd_day: 1078.1264703961795 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.4463 USD/day  |  payback on registration: [UNKNOWN] days
