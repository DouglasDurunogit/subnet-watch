...
- **competitive_miner_usd_day: 665.7981790762768** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 483.0491436663067
- top_miner_usd_day: 665.7981790762768 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.2736442152165288  |  top1_share: 0.38084047975096896  |  top10_share: 1.0
...
- net margin: 45.7889 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 21.4 (rank 64), confidence 0.85 - hardware from README keywords, not curated
- components: income 15.19 / freshness 0.0 / resource 0.0 / registration 10.0
