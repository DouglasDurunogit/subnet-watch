...
- registration cost: 0.1 TAO (19.863 USD), open=True
...
- **competitive_miner_usd_day: 24.051067126080994** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7472176194510599
- top_miner_usd_day: 2457.8789569818305 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8228 USD/day  |  payback on registration: [UNKNOWN] days
