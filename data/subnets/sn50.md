...
- registration cost: 0.8 TAO (157.256 USD), open=True
...
- **competitive_miner_usd_day: 30.626444189154114** (uid 6) <- the only figure quotable as achievable
- median_miner_usd_day: 9.86421338863051
- top_miner_usd_day: 30.626444189154114 (uid 6, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.645 USD/day  |  payback on registration: 95.6 days

## Score

- gate: **OK** 
- score: 42.6 (rank 35), confidence 0.85 - hardware requirement unknown
- components: income 3.84 / freshness 35.0 / resource 11.25 / registration 0.0
