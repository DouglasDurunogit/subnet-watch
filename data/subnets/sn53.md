...
- subnet age: 643.5 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 564.4726468216246** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 91.22790251662623
- top_miner_usd_day: 1960.8568808781981 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 81.6512 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.7 (rank 25), confidence 0.85 - hardware from README keywords, not curated
