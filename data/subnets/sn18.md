...
- subnet age: 1027.3 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 833.2475267818724** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.059446512583999
- top_miner_usd_day: 833.2475267818724 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.1828 USD/day  |  payback on registration: [UNKNOWN] days
