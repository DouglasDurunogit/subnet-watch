...
- subnet age: 840.4 days  |  registered at block 2869647
- weights_version: 2031  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 4778.309005421592
- top_miner_usd_day: 4778.309005421592 (uid 201, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-24T20:54:54Z
- scoring-related commit: fix(miner): match fee-path test to the single-prompt CLI copy 2026-08-24T13:55:36Z
