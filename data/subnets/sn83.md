...
- miner_burn: **0.0**
- registration cost: 0.29763592 TAO (57.250269212 USD), open=True
...
- **competitive_miner_usd_day: 99.89235902427596** (uid 94) <- the only figure quotable as achievable
- median_miner_usd_day: 19.492310645232905
- top_miner_usd_day: 117.22904943344777 (uid 84, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.5213 USD/day  |  payback on registration: 6.72 days

## Score

- gate: **OK** 
- score: 23.7 (rank 69), confidence 0.85 - hardware requirement unknown
- components: income 8.9 / freshness 0.0 / resource 11.25 / registration 7.76
