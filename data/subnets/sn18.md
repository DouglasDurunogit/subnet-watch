...
- subnet age: 1010.8 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1492.5509390661182** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.20098776576712
- top_miner_usd_day: 1492.5509390661182 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.0582 USD/day  |  payback on registration: [UNKNOWN] days
