...
- miner_burn: **0.1505601112730801**
- registration cost: 0.1 TAO (26.366000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 813.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 125.01022407410493** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 11.711708705918705
- top_miner_usd_day: 1250.0169095300769 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7826507058374665  |  top1_share: 0.44712705074399084  |  top10_share: 0.9986875238458603
- owner_incentive_share: 0.15056848531095002 (independent check on miner_burn; disagreement 0.0)
...
- last commit: 2026-09-06T15:55:15Z
- scoring-related commit: fix(reporting): rows shown with their accuracy are scored rows; audit… 2026-09-05T16:25:15Z
...
- net margin: 0.9337 USD/day  |  payback on registration: 28.24 days

## Score

- gate: **OK** 
- score: 53.2 (rank 28), confidence 1.0 
- components: income 2.6 / freshness 35.0 / resource 15.0 / registration 0.59
