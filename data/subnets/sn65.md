...
- subnet age: 576.0 days  |  registered at block 4950813
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 84.88969731050663** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 95.50090947431997
- top_miner_usd_day: 1273.6304983237826 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 34.2257 USD/day  |  payback on registration: 3.64 days

## Score

- gate: **OK** 
- score: 46.8 (rank 37), confidence 0.85 - hardware requirement unknown
- components: income 14.07 / freshness 21.0 / resource 11.25 / registration 8.79
