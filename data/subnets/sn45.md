...
- miner_burn: **0.3048733174800873**
- registration cost: 0.021913185 TAO (4.4514444009 USD), open=True
...
- **competitive_miner_usd_day: 21.0552559606358** (uid 121) <- the only figure quotable as achievable
- median_miner_usd_day: 3.6930631183803118
- top_miner_usd_day: 479.11498728649514 (uid 189, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 241  |  gini: 0.5652875944527536  |  top1_share: 0.3054472626091211  |  top10_share: 0.3957712241434665
- owner_incentive_share: 0.3054472626091211 (independent check on miner_burn; disagreement 0.0006)
...
- net margin: -4.5381 USD/day  |  payback on registration: [UNKNOWN] days
