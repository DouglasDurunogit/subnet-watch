...
- miner_burn: **0.7969532508868724**
- registration cost: 0.1 TAO (19.923000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 21  |  free: 0
- subnet age: 749.1 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21.374075898388377** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.9914056562078537
- top_miner_usd_day: 2519.921526006836 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 15  |  gini: 0.881253020383455  |  top1_share: 0.7970454926976666  |  top10_share: 0.9991759122193904
- owner_incentive_share: 0.7970454926976667 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.3647 USD/day  |  payback on registration: 54.63 days

## Score

- gate: **OK** 
- score: 16.2 (rank 66), confidence 1.0 
- components: income 1.23 / freshness 0.0 / resource 15.0 / registration 0.0
