...
- subnet age: 1026.7 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 777.0090261917732** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 4.38326137429452
- top_miner_usd_day: 777.0090261917732 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.8793 USD/day  |  payback on registration: [UNKNOWN] days
