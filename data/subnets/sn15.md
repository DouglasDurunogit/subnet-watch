...
- miner_burn: **0.0**
- registration cost: 0.397410725 TAO (96.11378384125 USD), open=True
...
- **competitive_miner_usd_day: 47.66959450040334** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.303821734614488
- top_miner_usd_day: 25799.891159204908 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.3175 USD/day  |  payback on registration: 3.52 days

## Score

- gate: **OK** 
- score: 72.0 (rank 6), confidence 1.0 
- components: income 13.21 / freshness 35.0 / resource 15.0 / registration 8.83
