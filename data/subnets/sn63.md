...
- subnet age: 567.1 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.0863836602063255** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 2830.533393980668
- top_miner_usd_day: 5660.980404301129 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1328 USD/day  |  payback on registration: [UNKNOWN] days
