...
- subnet age: 294.1 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 59.73362098706612** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 2988.2313876079324
- top_miner_usd_day: 5916.7291542287985 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 51.5144 USD/day  |  payback on registration: 0.22 days
...
- components: income 15.65 / freshness 21.0 / resource 11.25 / registration 9.93
