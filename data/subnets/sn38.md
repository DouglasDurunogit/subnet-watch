...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (175.0766 USD), open=True
...
- **competitive_miner_usd_day: 3408.7254240254556** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 581.4417284457817
- top_miner_usd_day: 3408.7254240254556 (uid 130, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 580.4554 USD/day  |  payback on registration: 0.3 days

## Score

- gate: **OK** 
- score: 72.3 (rank 6), confidence 0.85 - hardware from README keywords, not curated
