...
- miner_burn: **0.0**
- registration cost: 0.042802316 TAO (11.466312433239999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 215  |  free: 0
- subnet age: 545.6 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 255.08599805661623** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.475232578203593
- top_miner_usd_day: 255.08599805661623 (uid 138, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 214  |  gini: 0.7407307683297726  |  top1_share: 0.09928470991013019  |  top10_share: 0.5070153451121843
...
- net margin: 2.4889 USD/day  |  payback on registration: 4.61 days

## Score

- gate: **OK** 
- score: 49.4 (rank 35), confidence 1.0 
- components: income 4.94 / freshness 21.0 / resource 15.0 / registration 8.46
