...
- **competitive_miner_usd_day: 58.29944177474354** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 2916.4852040198807
- top_miner_usd_day: 5774.670966265018 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 50.0803 USD/day  |  payback on registration: 0.23 days
...
- components: income 15.54 / freshness 21.0 / resource 11.25 / registration 9.92
