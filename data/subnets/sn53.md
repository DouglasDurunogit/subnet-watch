...
- subnet age: 629.3 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2102.6372870677596** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 128.36255046066663
- top_miner_usd_day: 2299.584401911776 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 91.055 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 63.0 (rank 13), confidence 0.85 - hardware from README keywords, not curated
