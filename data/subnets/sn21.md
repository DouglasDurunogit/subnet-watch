...
- miner_burn: **0.450953611638397**
- registration cost: 0.1 TAO (18.844 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 135  |  free: 0
- subnet age: 774.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.325032178027907** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.053104072078704
- top_miner_usd_day: 832.0343471727532 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.0668 USD/day  |  payback on registration: 3.72 days

## Score

- gate: **OK** 
- score: 30.9 (rank 43), confidence 1.0 
- components: income 7.12 / freshness 0.0 / resource 15.0 / registration 8.76
