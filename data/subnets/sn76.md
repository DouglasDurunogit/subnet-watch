...
- subnet age: 168.2 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 436.0834565106633** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 116.85090261679721
- top_miner_usd_day: 436.0834565106633 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 86.6462 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 77.7 (rank 2), confidence 1.0 
- components: income 17.67 / freshness 35.0 / resource 15.0 / registration 10.0
