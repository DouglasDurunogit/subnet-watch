...
- miner_burn: **0.4507751415949315**
- registration cost: 0.1 TAO (19.421000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 135  |  free: 0
- subnet age: 773.1 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 25.516147198733197** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.349504221906987
- top_miner_usd_day: 872.4218800900201 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.3632 USD/day  |  payback on registration: 3.62 days

## Score

- gate: **OK** 
- score: 31.1 (rank 35), confidence 1.0 
- components: income 7.31 / freshness 0.0 / resource 15.0 / registration 8.79
