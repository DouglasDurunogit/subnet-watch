...
- miner_burn: **0.0**
- registration cost: 0.125324849 TAO (23.489636448069998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 215  |  free: 0
- subnet age: 492.5 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 563.4084357296856** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 3.810364887164385
- top_miner_usd_day: 563.4084357296856 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 213  |  gini: 0.822758578025574  |  top1_share: 0.13109541716347184  |  top10_share: 0.6878840686049711
...
- net margin: 2.8241 USD/day  |  payback on registration: 8.32 days

## Score

- gate: **OK** 
- score: 27.5 (rank 42), confidence 1.0 
- components: income 5.3 / freshness 0.0 / resource 15.0 / registration 7.23
