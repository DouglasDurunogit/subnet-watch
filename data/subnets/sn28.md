...
- **competitive_miner_usd_day: 1751.7682047170838** (uid 52) <- the only figure quotable as achievable
- median_miner_usd_day: 39.97777811446
- top_miner_usd_day: 3955.2208218402843 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 49  |  gini: 0.8070018909716232  |  top1_share: 0.3745382384368799  |  top10_share: 0.8488322393527706
- owner_incentive_share: 0.3745382384368799 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 31.275 USD/day  |  payback on registration: 0.65 days

## Score

- gate: **OK** 
- score: 59.3 (rank 20), confidence 0.85 - hardware requirement unknown
- components: income 13.72 / freshness 35.0 / resource 11.25 / registration 9.78
