...
- subnet age: 305.5 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 51.797296730466925** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 2591.2091938430685
- top_miner_usd_day: 5130.62109095567 (uid 24, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 43.5781 USD/day  |  payback on registration: 0.25 days
...
- components: income 15.0 / freshness 10.5 / resource 11.25 / registration 9.92
