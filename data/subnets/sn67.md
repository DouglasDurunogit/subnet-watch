...
- registration cost: 0.047764766 TAO (9.69529220268 USD), open=True
...
- **competitive_miner_usd_day: 876.4702074799756** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 16.501818389105747
- top_miner_usd_day: 876.4702074799756 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.5155 USD/day  |  payback on registration: 0.62 days

## Score

- gate: **OK** 
- score: 70.9 (rank 6), confidence 1.0 
- components: income 11.08 / freshness 35.0 / resource 15.0 / registration 9.79
