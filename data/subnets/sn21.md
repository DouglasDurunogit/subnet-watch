...
- **competitive_miner_usd_day: 24.703877334682126** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.147376883051686
- top_miner_usd_day: 844.6495837313017 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.1611 USD/day  |  payback on registration: 3.7 days

## Score

- gate: **OK** 
- score: 30.9 (rank 49), confidence 1.0 
- components: income 7.18 / freshness 0.0 / resource 15.0 / registration 8.77
