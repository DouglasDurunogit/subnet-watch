...
- miner_burn: **0.9910606085322797**  <- 100% burn: miners earn NOTHING here
- registration cost: 0.001 TAO (0.22565000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 14  |  free: 97
- subnet age: 271.5 days  |  registered at block 7119664
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1380.6771071181172
- top_miner_usd_day: 1380.6771071181172 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 1  |  gini: 0.0  |  top1_share: 1.0  |  top10_share: 1.0
- owner_incentive_share: 1.0 (independent check on miner_burn; disagreement 0.0089)
...
- last commit: 2026-09-09T15:06:18Z
- scoring-related commit: Merge pull request #24 from TensorUSD/fix/update-scoring-mech 2026-09-03T07:18:00Z
