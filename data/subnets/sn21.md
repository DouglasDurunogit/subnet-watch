...
- **competitive_miner_usd_day: 36.17022857946471** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.854327395805681
- top_miner_usd_day: 890.6429390345628 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.868 USD/day  |  payback on registration: 2.46 days

## Score

- gate: **OK** 
- score: 67.8 (rank 10), confidence 1.0 
- components: income 8.62 / freshness 35.0 / resource 15.0 / registration 9.18
