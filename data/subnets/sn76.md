...
- **competitive_miner_usd_day: 178.75843049600823** (uid 73) <- the only figure quotable as achievable
- median_miner_usd_day: 108.93955432902987
- top_miner_usd_day: 533.4157333177028 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 44.6825 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 75.1 (rank 2), confidence 1.0 
- components: income 15.1 / freshness 35.0 / resource 15.0 / registration 10.0
