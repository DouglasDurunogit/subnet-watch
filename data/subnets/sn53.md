...
- miner_burn: **0.0**
- registration cost: 0.000513649 TAO (0.10738345994000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 156  |  free: 0
- subnet age: 650.4 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 243.47509922058399** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 45.2906239498964
- top_miner_usd_day: 12451.881947030239 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 35.2477 USD/day  |  payback on registration: 0.0 days
