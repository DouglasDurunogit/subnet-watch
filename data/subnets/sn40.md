...
- subnet age: 91.2 days  |  registered at block 8409860
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2390.821820909499
- top_miner_usd_day: 2390.821820909499 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 30139 bytes, sha 3cf5133574121ac4
- latest release: (none) 
- last commit: 2026-09-11T10:52:16Z
...
| **rejected** | **`TQ1_0`, `TQ2_0`** — mainline has no Metal kernel f
```

_(truncated at 6000 of 30139 chars - read the full file at https://github.com/RalphLabsAI/ralph)_
