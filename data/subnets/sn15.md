...
- miner_burn: **0.0**
- registration cost: 0.310688255 TAO (63.68177162735 USD), open=True
...
- **competitive_miner_usd_day: 15715.440493001879** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 17.35690808630691
- top_miner_usd_day: 15715.440493001879 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.3706 USD/day  |  payback on registration: 3.89 days

## Score

- gate: **OK** 
- score: 70.0 (rank 7), confidence 1.0 
- components: income 11.28 / freshness 35.0 / resource 15.0 / registration 8.7
