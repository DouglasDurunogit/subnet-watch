...
- registration cost: 0.218490825 TAO (41.832253354500004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 9  |  free: 101
- subnet age: 245.4 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1807.6264875390443
- top_miner_usd_day: 1807.6264875390443 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 7130 bytes, sha 8bfeaca332502a99
- latest release: (none) 
- last commit: 2026-08-18T13:35:17Z
- scoring-related commit: Docs: the eligible-miner gate is 50 active members, not 500 2026-08-18T13:35:17Z
...
```bash
cp configs/testnet.example.toml ~/prometheon-t
```

_(truncated at 6000 of 7130 chars - read the full file at https://github.com/BitSpaceorganization/prometheon_v2)_
