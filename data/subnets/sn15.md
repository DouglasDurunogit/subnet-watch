...
- miner_burn: **0.0**
- registration cost: 0.228545762 TAO (44.8292512163 USD), open=True
...
- **competitive_miner_usd_day: 10619.954197010016** (uid 94) <- the only figure quotable as achievable
- median_miner_usd_day: 10.163624675559877
- top_miner_usd_day: 10619.954197010016 (uid 94, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.0051 USD/day  |  payback on registration: 4.98 days

## Score

- gate: **OK** 
- score: 67.4 (rank 10), confidence 1.0 
- components: income 9.1 / freshness 35.0 / resource 15.0 / registration 8.34
