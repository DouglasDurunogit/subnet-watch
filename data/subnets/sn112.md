...
- **competitive_miner_usd_day: 287.4752197879401** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 718.6770829931664
- top_miner_usd_day: 1149.8789461983931 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 279.256 USD/day  |  payback on registration: 0.75 days
...
- components: income 22.26 / freshness 21.0 / resource 11.25 / registration 9.75
