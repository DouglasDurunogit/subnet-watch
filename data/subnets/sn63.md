...
- **competitive_miner_usd_day: 4790.003494559855** (uid 87) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07310750144322124
- top_miner_usd_day: 4790.003494559855 (uid 87, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -8.1461 USD/day  |  payback on registration: [UNKNOWN] days
