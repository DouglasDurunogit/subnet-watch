...
- miner_burn: **0.7632760966662318**
- registration cost: 0.1 TAO (19.508000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 25  |  free: 0
- subnet age: 740.6 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 13.159606114209344** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 1.886681880173383
- top_miner_usd_day: 2359.3428582038196 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 19  |  gini: 0.8993506597823535  |  top1_share: 0.7633996703497955  |  top10_share: 0.9972529149624565
- owner_incentive_share: 0.7633996703497955 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.7117 USD/day  |  payback on registration: 27.41 days

## Score

- gate: **OK** 
- score: 18.0 (rank 63), confidence 1.0 
- components: income 2.12 / freshness 0.0 / resource 15.0 / registration 0.86
