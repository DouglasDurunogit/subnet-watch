...
- miner_burn: **0.0**
- registration cost: 0.280523675 TAO (53.45098103449999 USD), open=True
...
- **competitive_miner_usd_day: 29.34627191585202** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 16.240169895180244
- top_miner_usd_day: 17643.37755717608 (uid 253, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 14.969 USD/day  |  payback on registration: 3.57 days

## Score

- gate: **OK** 
- score: 69.8 (rank 5), confidence 1.0 
- components: income 10.94 / freshness 35.0 / resource 15.0 / registration 8.81
