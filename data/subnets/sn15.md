...
- miner_burn: **0.0**
- registration cost: 0.272319481 TAO (51.833290013539994 USD), open=True
...
- **competitive_miner_usd_day: 15237.905566457328** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 13.914208719270128
- top_miner_usd_day: 15237.905566457328 (uid 253, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 12.9279 USD/day  |  payback on registration: 4.01 days

## Score

- gate: **OK** 
- score: 69.1 (rank 7), confidence 1.0 
- components: income 10.4 / freshness 35.0 / resource 15.0 / registration 8.66
