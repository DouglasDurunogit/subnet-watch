...
- registration cost: 0.005 TAO (0.9363 USD), open=True
...
- **competitive_miner_usd_day: 79.5930998882415** (uid 152) <- the only figure quotable as achievable
- median_miner_usd_day: 79.5930998882415
- top_miner_usd_day: 2776.647123068775 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 71.3739 USD/day  |  payback on registration: 0.01 days
