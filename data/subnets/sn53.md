...
- subnet age: 658.9 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6936.331053917727** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 11.349411798299913
- top_miner_usd_day: 7614.535094081001 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 3.1302 USD/day  |  payback on registration: 0.04 days

## Score

- gate: **OK** 
- score: 52.6 (rank 32), confidence 0.85 - hardware from README keywords, not curated
- components: income 5.6 / freshness 35.0 / resource 11.25 / registration 9.99
