...
- **competitive_miner_usd_day: 61.58472040488363** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 3080.8344023004925
- top_miner_usd_day: 6100.084084196102 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 53.3655 USD/day  |  payback on registration: 0.23 days
...
- components: income 15.78 / freshness 21.0 / resource 11.25 / registration 9.92
