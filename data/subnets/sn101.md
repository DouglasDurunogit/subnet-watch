...
- registration cost: 0.001479069 TAO (0.29532570722999996 USD), open=True
...
- **competitive_miner_usd_day: 1.9558213631131833** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0629463929962955
- top_miner_usd_day: 2510.6793802572492 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0766 USD/day  |  payback on registration: 3.86 days

## Score

- gate: **OK** 
- score: 45.0 (rank 33), confidence 1.0 
- components: income 0.29 / freshness 21.0 / resource 15.0 / registration 8.71
