...
- registration cost: 0.032286645 TAO (6.145440009300001 USD), open=True
...
- **competitive_miner_usd_day: 4.779512580641304** (uid 99) <- the only figure quotable as achievable
- median_miner_usd_day: 4.1953499318962555
- top_miner_usd_day: 2505.6329175535334 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 240  |  gini: 0.7343279783863217  |  top1_share: 0.7222213718256822  |  top10_share: 0.7342680892099986
- owner_incentive_share: 0.7222213718256824 (independent check on miner_burn; disagreement 0.0023)
