...
- registration cost: 0.003147994 TAO (0.62119365602 USD), open=True
...
- **competitive_miner_usd_day: 2.0685262984129698** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9515220972699664
- top_miner_usd_day: 2443.6328573671785 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.0348 USD/day  |  payback on registration: [UNKNOWN] days
