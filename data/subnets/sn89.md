...
- miner_burn: **0.0**
- registration cost: 0.062280219 TAO (14.46208965399 USD), open=True
...
- **competitive_miner_usd_day: 118.47529667691816** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 6.737275055500766
- top_miner_usd_day: 118.47529667691816 (uid 218, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -1.4819 USD/day  |  payback on registration: [UNKNOWN] days
