...
- miner_burn: **0.0**
- registration cost: 0.000584405 TAO (0.1362248055 USD), open=True
...
- **competitive_miner_usd_day: 2172.3963817301164** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2172.3963817301164
- top_miner_usd_day: 2172.3963817301164 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2164.1772 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 52.0 (rank 32), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
