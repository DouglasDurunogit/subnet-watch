...
- miner_burn: **0.8108410486020148**
- registration cost: 0.1 TAO (19.55 USD), open=True
...
- **competitive_miner_usd_day: 16.565335374934335** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9690029049404485
- top_miner_usd_day: 2451.946493463122 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 15  |  gini: 0.8795507264070321  |  top1_share: 0.8109205225247222  |  top10_share: 0.9998321328287144
...
- net margin: -0.7787 USD/day  |  payback on registration: [UNKNOWN] days
