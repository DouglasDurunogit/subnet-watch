...
- registration cost: 0.01472873 TAO (3.7795394053000004 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 18  |  free: 0
- subnet age: 601.3 days  |  registered at block 4703386
- weights_version: 1002  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 669.1044884300668** (uid 77) <- the only figure quotable as achievable
- median_miner_usd_day: 66.92434076636243
- top_miner_usd_day: 669.1044884300668 (uid 77, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 81.0017 USD/day  |  payback on registration: 0.05 days

## Score

- gate: **OK** 
- score: 50.7 (rank 35), confidence 0.85 - hardware requirement unknown
- components: income 17.41 / freshness 21.0 / resource 11.25 / registration 9.98
