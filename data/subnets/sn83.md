...
- miner_burn: **0.0**
- registration cost: 0.260344035 TAO (50.0485372884 USD), open=True
...
- **competitive_miner_usd_day: 103.039453274697** (uid 21) <- the only figure quotable as achievable
- median_miner_usd_day: 19.526159739777988
- top_miner_usd_day: 135.67472495244797 (uid 84, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.6943 USD/day  |  payback on registration: 5.76 days

## Score

- gate: **OK** 
- score: 24.1 (rank 69), confidence 0.85 - hardware requirement unknown
- components: income 8.97 / freshness 0.0 / resource 11.25 / registration 8.08
