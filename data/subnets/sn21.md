...
- **competitive_miner_usd_day: 1190.483519153703** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 11.153926070301434
- top_miner_usd_day: 1190.483519153703 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10.1676 USD/day  |  payback on registration: 2.32 days

## Score

- gate: **OK** 
- score: 68.8 (rank 11), confidence 1.0 
- components: income 9.53 / freshness 35.0 / resource 15.0 / registration 9.23
