...
- miner_burn: **0.0**
- registration cost: 0.478759545 TAO (114.70121179110001 USD), open=True
...
- **competitive_miner_usd_day: 46.301337050725465** (uid 249) <- the only figure quotable as achievable
- median_miner_usd_day: 27.78080223043528
- top_miner_usd_day: 25522.138824851703 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 81  |  gini: 0.9363138045287285  |  top1_share: 0.9258088650695494  |  top10_share: 0.9404211137068084
...
- net margin: 26.584 USD/day  |  payback on registration: 4.31 days

## Score

- gate: **OK** 
- score: 71.7 (rank 7), confidence 1.0 
- components: income 13.1 / freshness 35.0 / resource 15.0 / registration 8.56
