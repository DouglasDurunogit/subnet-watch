...
- subnet age: 124.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1984.8896907893563** (uid 64) <- the only figure quotable as achievable
- median_miner_usd_day: 27.843146793890888
- top_miner_usd_day: 1984.8896907893563 (uid 64, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.8219 USD/day  |  payback on registration: 1.32 days

## Score

- gate: **OK** 
- score: 53.8 (rank 23), confidence 1.0 
- components: income 11.99 / freshness 21.0 / resource 11.25 / registration 9.56
