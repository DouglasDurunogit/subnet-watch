...
- subnet age: 37.7 days  |  registered at block 8618670
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4215.242441765323** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 10963.712421759352
- top_miner_usd_day: 17712.182401753384 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4136.3383 USD/day  |  payback on registration: 0.0 days
...
- components: income 32.89 / freshness 35.0 / resource 0.0 / registration 10.0
- freshness basis: README_TASK_DIFF 1.3d ago
