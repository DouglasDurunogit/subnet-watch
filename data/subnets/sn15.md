...
- miner_burn: **0.0**
- registration cost: 0.46725695 TAO (105.7449203545 USD), open=True
...
- **competitive_miner_usd_day: 40.95686342296951** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 23.614768099730174
- top_miner_usd_day: 22439.195425265476 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.6285 USD/day  |  payback on registration: 4.67 days

## Score

- gate: **OK** 
- score: 70.9 (rank 5), confidence 1.0 
- components: income 12.49 / freshness 35.0 / resource 15.0 / registration 8.44
