...
- registration cost: 0.999999999 TAO (223.6999997763 USD), open=True
...
- **competitive_miner_usd_day: 1725.692088876865** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.9048632406951147
- top_miner_usd_day: 1725.692088876865 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.3572 USD/day  |  payback on registration: [UNKNOWN] days
