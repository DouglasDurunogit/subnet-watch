...
- subnet age: 433.3 days  |  registered at block 5683635
- weights_version: 68200  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2158.882141987599
- top_miner_usd_day: 2158.882141987599 (uid 155, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
