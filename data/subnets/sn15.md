...
- miner_burn: **0.0**
- registration cost: 0.452793117 TAO (101.77883683926001 USD), open=True
...
- **competitive_miner_usd_day: 22591.51872911923** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 19.938597678063445
- top_miner_usd_day: 22591.51872911923 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.9523 USD/day  |  payback on registration: 5.37 days

## Score

- gate: **OK** 
- score: 70.0 (rank 6), confidence 1.0 
- components: income 11.82 / freshness 35.0 / resource 15.0 / registration 8.21
