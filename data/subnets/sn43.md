...
- registration cost: 0.1 TAO (22.37 USD), open=True
...
- **competitive_miner_usd_day: 191.54904986579828** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0607937888137564
- top_miner_usd_day: 2670.9777322531513 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4559 USD/day  |  payback on registration: [UNKNOWN] days
