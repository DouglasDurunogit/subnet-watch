...
- miner_burn: **0.0**
- registration cost: 0.507793023 TAO (157.00452478136998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 80  |  free: 0
- subnet age: 716.6 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2370.1569149355028** (uid 246) <- the only figure quotable as achievable
- median_miner_usd_day: 44.33559446542649
- top_miner_usd_day: 62813.95128303033 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 70  |  gini: 0.9330787116813315  |  top1_share: 0.8003939292148898  |  top10_share: 0.9302531529605764
...
- latest release: executor-v1.134 2026-09-22T03:25:19Z
- last commit: 2026-09-22T11:15:37Z
- scoring-related commit: DAH-3678 - [P2] validator: explain add_public_keys failures on exitin… 2026-09-21T08:36:29Z
...
- net margin: 34.9182 USD/day  |  payback on registration: 4.5 days

## Score

- gate: **OK** 
- score: 58.6 (rank 20), confidence 0.85 - hardware requirement unknown
- components: income 14.15 / freshness 35.0 / resource 11.25 / registration 8.5
