...
- **competitive_miner_usd_day: 1866.3106568818614** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 5.002250919286721
- top_miner_usd_day: 1866.3106568818614 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.2842 USD/day  |  payback on registration: [UNKNOWN] days
