...
- **competitive_miner_usd_day: 1141.8763202379293** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 420.7977395683573
- top_miner_usd_day: 1141.8763202379293 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 653.4926 USD/day  |  payback on registration: 0.03 days
...
- components: income 25.61 / freshness 0.0 / resource 11.25 / registration 9.99
