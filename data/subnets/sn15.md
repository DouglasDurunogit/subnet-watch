...
- miner_burn: **0.0**
- registration cost: 0.269929094 TAO (52.9465917881 USD), open=True
...
- **competitive_miner_usd_day: 12627.193416655995** (uid 41) <- the only figure quotable as achievable
- median_miner_usd_day: 13.539970688805065
- top_miner_usd_day: 12627.193416655995 (uid 41, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 12.5537 USD/day  |  payback on registration: 4.22 days

## Score

- gate: **OK** 
- score: 68.9 (rank 8), confidence 1.0 
- components: income 10.3 / freshness 35.0 / resource 15.0 / registration 8.59
