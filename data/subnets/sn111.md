...
- registration cost: 0.000582158 TAO (0.11421357802000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 10  |  free: 0
- subnet age: 450.6 days  |  registered at block 5615562
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3410.8032375621287
- top_miner_usd_day: 3410.8032375621287 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 16968 bytes, sha ab27d779ed01c06c
- latest release: (none) 
- last commit: 2026-08-16T00:43:24Z
- scoring-related commit: Implement resilient batch scoring and winner-takes-most payouts 2026-08-16T00:43:24Z
...
_(truncated at 6000 of 16968 chars - read the full file at https://github.com/DeSciClaims/Claims)_
