...
- subnet age: 497.5 days  |  registered at block 5258781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 664.5039009978731** (uid 23) <- the only figure quotable as achievable
- median_miner_usd_day: 138.42510924458952
- top_miner_usd_day: 664.5039009978731 (uid 23, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.37201281855638624  |  top1_share: 0.1920036624446818  |  top10_share: 1.0
...
- net margin: 656.2847 USD/day  |  payback on registration: 0.0 days
