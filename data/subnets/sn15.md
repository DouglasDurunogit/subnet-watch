...
- miner_burn: **0.0**
- registration cost: 0.446899781 TAO (105.73201918679 USD), open=True
...
- **competitive_miner_usd_day: 21582.090343461266** (uid 249) <- the only figure quotable as achievable
- median_miner_usd_day: 24.35616762829592
- top_miner_usd_day: 21582.090343461266 (uid 249, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 23.5503 USD/day  |  payback on registration: 4.49 days

## Score

- gate: **OK** 
- score: 71.1 (rank 9), confidence 1.0 
- components: income 12.64 / freshness 35.0 / resource 15.0 / registration 8.5
