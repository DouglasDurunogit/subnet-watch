...
- subnet age: 262.3 days  |  registered at block 7105263
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 50.856970957709464** (uid 172) <- the only figure quotable as achievable
- median_miner_usd_day: 159.08524903892248
- top_miner_usd_day: 694.5185330026828 (uid 168, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.3846421486342131  |  top1_share: 0.32864336944910727  |  top10_share: 1.0
...
- net margin: 41.4929 USD/day  |  payback on registration: 0.28 days
...
- components: income 14.81 / freshness 35.0 / resource 11.25 / registration 9.91
