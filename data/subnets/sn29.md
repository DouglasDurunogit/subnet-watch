...
- subnet age: 758.6 days  |  registered at block 3379782
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1845.104457833894** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 1845.104457833894
- top_miner_usd_day: 1845.104457833894 (uid 19, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- on-chain URL: `https://github.com/coldint/hotfloat`
- resolved URL: `https://github.com/coldint/hotfloat`
- status: **ok** 
- README: 5411 bytes, sha 073650d535a99597
- latest release: (none) 
- last commit: 2026-06-15T17:22:41Z
- scoring-related commit: refactor: make structured validator state Postgres-only (#99) 2026-06-14T16:46:18Z
...
- net margin: 1815.5154 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 26.0 (rank 67), confidence 0.6 - hardware from README keywords, not curated; income rests on 1 competitive miner (n<=2: not a distribution)
