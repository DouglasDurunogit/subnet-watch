...
- miner_burn: **0.0**
- registration cost: 0.117934705 TAO (24.7592119677 USD), open=True
...
- **competitive_miner_usd_day: 368.4360408953136** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 5.288707136798811
- top_miner_usd_day: 368.4360408953136 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.3024 USD/day  |  payback on registration: 5.75 days

## Score

- gate: **OK** 
- score: 29.7 (rank 60), confidence 1.0 
- components: income 6.59 / freshness 0.0 / resource 15.0 / registration 8.08
