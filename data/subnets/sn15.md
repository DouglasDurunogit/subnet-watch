...
- miner_burn: **0.0**
- registration cost: 0.247776304 TAO (49.2331516048 USD), open=True
...
- **competitive_miner_usd_day: 21.279336237627216** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 11.030114655283834
- top_miner_usd_day: 11889.877928591266 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.9462 USD/day  |  payback on registration: 4.95 days

## Score

- gate: **OK** 
- score: 67.8 (rank 9), confidence 1.0 
- components: income 9.45 / freshness 35.0 / resource 15.0 / registration 8.35
