...
- miner_burn: **0.15055915690027177**
- registration cost: 0.1 TAO (23.716 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 805.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 607.0621028181731** (uid 160) <- the only figure quotable as achievable
- median_miner_usd_day: 22.81144625265558
- top_miner_usd_day: 1214.0827679501467 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.751647630529618  |  top1_share: 0.4471286645199689  |  top10_share: 0.9987333465594336
...
- last commit: 2026-08-30T05:20:42Z
- scoring-related commit: fix(validator-api): serve the daily feeds without a weekly release 2026-08-30T05:20:42Z
...
- net margin: 14.1799 USD/day  |  payback on registration: 1.67 days

## Score

- gate: **OK** 
- score: 70.2 (rank 8), confidence 1.0 
- components: income 10.74 / freshness 35.0 / resource 15.0 / registration 9.44
