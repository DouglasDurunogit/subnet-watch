...
- **competitive_miner_usd_day: 188.815761234725** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 7.93030578570257
- top_miner_usd_day: 188.815761234725 (uid 218, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.2889 USD/day  |  payback on registration: [UNKNOWN] days
