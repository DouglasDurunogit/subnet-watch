...
- **competitive_miner_usd_day: 102.45627002118351** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.686221062525733
- top_miner_usd_day: 623.3389542364006 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.5872 USD/day  |  payback on registration: [UNKNOWN] days
