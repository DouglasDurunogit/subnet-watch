...
- subnet age: 171.1 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 207.8654214325617** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 131.81827679718265
- top_miner_usd_day: 519.6998471598175 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.5058294800775232  |  top1_share: 0.32777854079873037  |  top10_share: 1.0
...
- net margin: 43.5096 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 75.0 (rank 2), confidence 1.0 
- components: income 14.99 / freshness 35.0 / resource 15.0 / registration 10.0
