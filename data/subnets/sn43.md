...
- registration cost: 0.1 TAO (18.711000000000002 USD), open=True
...
- **competitive_miner_usd_day: 59.25750037562299** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.263989547454797
- top_miner_usd_day: 2411.0309268424544 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.5308 USD/day  |  payback on registration: 35.25 days

## Score

- gate: **OK** 
- score: 16.7 (rank 55), confidence 1.0 
