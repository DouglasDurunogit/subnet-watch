...
- **competitive_miner_usd_day: 332.66596295034606** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 11.290710536236622
- top_miner_usd_day: 3327.542701835904 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -18.6137 USD/day  |  payback on registration: [UNKNOWN] days
