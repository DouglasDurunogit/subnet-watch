...
- miner_burn: **0.0**
- registration cost: 0.010425665 TAO (2.4579547804 USD), open=True
...
- **competitive_miner_usd_day: 2212.6140010932645** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2212.6140010932645
- top_miner_usd_day: 2212.6140010932645 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2204.3948 USD/day  |  payback on registration: 0.0 days
...
- components: income 30.41 / freshness 35.0 / resource 11.25 / registration 10.0
