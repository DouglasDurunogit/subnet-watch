...
- subnet age: 1016.5 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1163.0873821070834** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.782936868998418
- top_miner_usd_day: 1163.0873821070834 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.4801 USD/day  |  payback on registration: [UNKNOWN] days
