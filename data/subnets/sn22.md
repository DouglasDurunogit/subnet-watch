...
- subnet age: 950.0 days  |  registered at block 2009702
- weights_version: 1000910  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 52.76748110390211** (uid 147) <- the only figure quotable as achievable
- median_miner_usd_day: 3.2886670400345075
- top_miner_usd_day: 1019.0701187133175 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -4.9454 USD/day  |  payback on registration: [UNKNOWN] days
