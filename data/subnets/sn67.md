...
- registration cost: 0.06522503 TAO (15.7642375007 USD), open=True
...
- **competitive_miner_usd_day: 167.75550312893225** (uid 193) <- the only figure quotable as achievable
- median_miner_usd_day: 20.363739319490136
- top_miner_usd_day: 167.75550312893225 (uid 193, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.3774 USD/day  |  payback on registration: 0.81 days

## Score

- gate: **OK** 
- score: 71.6 (rank 7), confidence 1.0 
- components: income 11.91 / freshness 35.0 / resource 15.0 / registration 9.73
