...
- subnet age: 504.8 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 108.22403568781485** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 12.015148208452702
- top_miner_usd_day: 108.22403568781485 (uid 45, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 70  |  gini: 0.6235304511335604  |  top1_share: 0.06595000687138299  |  top10_share: 0.4821725786009865
...
- latest release: (none) 
- last commit: 2026-08-28T15:17:15Z
- scoring-related commit: HF board: read the live tail, so a miner sees their own call in seconds 2026-08-24T18:55:25Z
...
- net margin: 3.4076 USD/day  |  payback on registration: 3.45 days

## Score

- gate: **OK** 
- score: 51.8 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 5.86 / freshness 35.0 / resource 11.25 / registration 8.85
