...
- miner_burn: **0.1505602386314422**
- registration cost: 0.1 TAO (23.734 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 46  |  free: 0
- subnet age: 817.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 111.11492558159757** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 10.409913676501205
- top_miner_usd_day: 1111.0734094503912 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.9536 USD/day  |  payback on registration: 3.99 days

## Score

- gate: **OK** 
- score: 66.3 (rank 13), confidence 1.0 
- components: income 7.66 / freshness 35.0 / resource 15.0 / registration 8.67
