...
- subnet age: 233.1 days  |  registered at block 7457580
- weights_version: 20  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 27891.95540944236** (uid 52) <- the only figure quotable as achievable
- median_miner_usd_day: 342.8679063259142
- top_miner_usd_day: 27891.95540944236 (uid 52, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.8037070386423293  |  top1_share: 0.7933276356754776  |  top10_share: 0.9388468347475734
...
- net margin: 341.8816 USD/day  |  payback on registration: 0.84 days

## Score

- gate: **OK** 
- score: 68.8 (rank 5), confidence 1.0 
- components: income 23.06 / freshness 21.0 / resource 15.0 / registration 9.72
