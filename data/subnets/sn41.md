...
- subnet age: 793.9 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 101.94701186085528** (uid 148) <- the only figure quotable as achievable
- median_miner_usd_day: 56.70404580602048
- top_miner_usd_day: 101.94701186085528 (uid 148, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 96  |  gini: 0.3146441587262805  |  top1_share: 0.022004031272904963  |  top10_share: 0.19192829220620572
...
- net margin: 55.7177 USD/day  |  payback on registration: 0.47 days

## Score

- gate: **OK** 
- score: 51.3 (rank 27), confidence 1.0 
- components: income 15.95 / freshness 10.5 / resource 15.0 / registration 9.84
