...
- **competitive_miner_usd_day: 315.9326227876455** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 789.8195049120914
- top_miner_usd_day: 1263.706387036537 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 307.7134 USD/day  |  payback on registration: 0.75 days
...
- components: income 22.64 / freshness 35.0 / resource 11.25 / registration 9.75
