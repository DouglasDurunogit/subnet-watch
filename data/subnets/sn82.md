...
- subnet age: 146.9 days  |  registered at block 8026517
- weights_version: 1778428951  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 51) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 51, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 27.4 (rank 49), confidence 0.85 - hardware requirement unknown
