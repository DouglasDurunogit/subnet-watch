...
- subnet age: 1038.0 days  |  registered at block 1489797
- weights_version: 4062  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 198.69645243045915** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 9939.979628685276
- top_miner_usd_day: 19681.262804940096 (uid 128, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 190.4773 USD/day  |  payback on registration: 0.0 days
...
- components: income 20.76 / freshness 35.0 / resource 11.25 / registration 10.0
