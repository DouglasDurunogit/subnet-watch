...
- miner_burn: **0.0**
- registration cost: 0.63 TAO (145.1016 USD), open=True
...
- **competitive_miner_usd_day: 843.3582057793079** (uid 85) <- the only figure quotable as achievable
- median_miner_usd_day: 289.0592261644288
- top_miner_usd_day: 843.3582057793079 (uid 85, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 280.84 USD/day  |  payback on registration: 0.52 days

## Score

- gate: **OK** 
- score: 66.6 (rank 14), confidence 0.85 - hardware requirement unknown
- components: income 22.28 / freshness 35.0 / resource 11.25 / registration 9.83
