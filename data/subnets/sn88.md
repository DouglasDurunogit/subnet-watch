...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (2.307 USD), open=True
...
- **competitive_miner_usd_day: 923.1470104152232** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 3.854878423281024
- top_miner_usd_day: 923.1470104152232 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.3643 USD/day  |  payback on registration: [UNKNOWN] days
