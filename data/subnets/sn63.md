...
- **competitive_miner_usd_day: 0.07852761638496716** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07852761638496716
- top_miner_usd_day: 5145.12942554305 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1407 USD/day  |  payback on registration: [UNKNOWN] days
