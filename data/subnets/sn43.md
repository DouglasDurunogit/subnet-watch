...
- subnet age: 758.3 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 16.95277672562446** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 3.8529038012782872
- top_miner_usd_day: 2390.840129393215 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7597 USD/day  |  payback on registration: [UNKNOWN] days
