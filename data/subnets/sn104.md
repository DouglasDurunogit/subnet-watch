...
- registration cost: 0.5 TAO (97.845 USD), open=True
...
- **competitive_miner_usd_day: 9.445475443060749** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 8.831135576845416
- top_miner_usd_day: 2397.230950455507 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.612 USD/day  |  payback on registration: 159.88 days

## Score

- gate: **OK** 
- score: 40.9 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 1.89 / freshness 35.0 / resource 11.25 / registration 0.0
