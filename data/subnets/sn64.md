...
- subnet age: 611.4 days  |  registered at block 4531295
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6602.331575396734** (uid 177) <- the only figure quotable as achievable
- median_miner_usd_day: 2203.1076522611374
- top_miner_usd_day: 10278.153153875368 (uid 21, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 18  |  gini: 0.4580026858747406  |  top1_share: 0.1906971065803931  |  top10_share: 0.8621047491148822
...
- net margin: 1440.2461 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 36.1 (rank 50), confidence 0.85 - hardware from README keywords, not curated
- components: income 28.73 / freshness 0.0 / resource 3.75 / registration 10.0
