...
- miner_burn: **0.0**
- registration cost: 0.07840162 TAO (18.193879937200002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 228  |  free: 0
- subnet age: 541.1 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 202.5571099253832** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 3.010179964330906
- top_miner_usd_day: 202.5571099253832 (uid 36, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 227  |  gini: 0.7349475499256579  |  top1_share: 0.08846730057785795  |  top10_share: 0.4697006756963341
...
- net margin: 2.0239 USD/day  |  payback on registration: 8.99 days

## Score

- gate: **OK** 
- score: 47.4 (rank 38), confidence 1.0 
- components: income 4.37 / freshness 21.0 / resource 15.0 / registration 7.0
