...
- subnet age: 809.0 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 886.0126622825007** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 326.0050785910439
- top_miner_usd_day: 886.0126622825007 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 505.467 USD/day  |  payback on registration: 0.04 days
...
- components: income 24.6 / freshness 0.0 / resource 11.25 / registration 9.99
