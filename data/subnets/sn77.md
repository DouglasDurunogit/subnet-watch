...
- **competitive_miner_usd_day: 736.8704145004476** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 143.24528063718563
- top_miner_usd_day: 736.8704145004476 (uid 4, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 167.2 USD/day  |  payback on registration: 0.0 days
