...
- **competitive_miner_usd_day: 990.3342549388685** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.264483488434552
- top_miner_usd_day: 990.3342549388685 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.1435 USD/day  |  payback on registration: 161.62 days

## Score

- gate: **OK** 
- score: 50.5 (rank 28), confidence 1.0 
- components: income 0.53 / freshness 35.0 / resource 15.0 / registration 0.0
