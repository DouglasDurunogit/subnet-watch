...
- miner_burn: **0.0**
- registration cost: 0.218564362 TAO (41.04857282722 USD), open=True
...
- **competitive_miner_usd_day: 10821.329280502172** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 10.877320734776264
- top_miner_usd_day: 10821.329280502172 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.891 USD/day  |  payback on registration: 4.15 days

## Score

- gate: **OK** 
- score: 33.0 (rank 22), confidence 1.0 
- components: income 9.43 / freshness 0.0 / resource 15.0 / registration 8.62
