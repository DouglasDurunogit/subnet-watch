...
- subnet age: 629.0 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1983.1185004626377** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 121.06612498064835
- top_miner_usd_day: 2168.87068390488 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 85.412 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 62.8 (rank 10), confidence 0.85 - hardware from README keywords, not curated
- components: income 17.61 / freshness 35.0 / resource 11.25 / registration 10.0
