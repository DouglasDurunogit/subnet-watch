...
- subnet age: 286.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 37.11542706213872** (uid 119) <- the only figure quotable as achievable
- median_miner_usd_day: 1856.7346542673279
- top_miner_usd_day: 3676.353881472516 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 28.8962 USD/day  |  payback on registration: 0.34 days
...
- components: income 13.42 / freshness 21.0 / resource 11.25 / registration 9.89
