...
- **competitive_miner_usd_day: 66.90554298004352** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 66.90554298004352
- top_miner_usd_day: 6560.114025660053 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 58.6864 USD/day  |  payback on registration: 0.2 days
...
- components: income 16.15 / freshness 21.0 / resource 11.25 / registration 9.93
