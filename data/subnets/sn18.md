...
- **competitive_miner_usd_day: 1566.3706474921582** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 5.055083896890033
- top_miner_usd_day: 1566.3706474921582 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.2346 USD/day  |  payback on registration: [UNKNOWN] days
