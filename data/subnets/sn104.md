...
- miner_burn: **0.9592289824504405**
- registration cost: 0.999999999 TAO (195.03999980496 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 30  |  free: 0
- subnet age: 446.6 days  |  registered at block 5528520
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 10.54744799994103** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 8.724432296247521
- top_miner_usd_day: 2728.5770519353623 (uid 36, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 15  |  gini: 0.8972791503258002  |  top1_share: 0.9592864445834796  |  top10_share: 0.9891043933405563
- owner_incentive_share: 0.9592864445834796 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.5053 USD/day  |  payback on registration: 385.99 days

## Score

- gate: **OK** 
- score: 10.9 (rank 70), confidence 0.85 - hardware requirement unknown
- components: income 1.62 / freshness 0.0 / resource 11.25 / registration 0.0
