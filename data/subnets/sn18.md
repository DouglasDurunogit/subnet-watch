...
- subnet age: 1042.4 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1541.3758458224918** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 12.051271198754307
- top_miner_usd_day: 1541.3758458224918 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.3528 USD/day  |  payback on registration: 78.74 days

## Score

- gate: **OK** 
- score: 32.4 (rank 58), confidence 0.85 - hardware requirement unknown
- components: income 5.81 / freshness 21.0 / resource 11.25 / registration 0.0
