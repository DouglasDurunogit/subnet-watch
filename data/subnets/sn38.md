...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (147.6744 USD), open=True
...
- **competitive_miner_usd_day: 1527.379834346364** (uid 106) <- the only figure quotable as achievable
- median_miner_usd_day: 163.19525178503162
- top_miner_usd_day: 3399.4104786380044 (uid 131, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 111.7686 USD/day  |  payback on registration: 1.32 days

## Score

- gate: **OK** 
- score: 66.5 (rank 16), confidence 0.85 - hardware from README keywords, not curated
