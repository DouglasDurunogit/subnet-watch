...
- **competitive_miner_usd_day: 285.8017339113719** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 10.633473774986502
- top_miner_usd_day: 2858.993882623667 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.0641 USD/day  |  payback on registration: [UNKNOWN] days
