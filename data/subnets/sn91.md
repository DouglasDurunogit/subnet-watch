...
- subnet age: 210.6 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2641.5123164695783** (uid 105) <- the only figure quotable as achievable
- median_miner_usd_day: 660.3780791173946
- top_miner_usd_day: 2641.5123164695783 (uid 105, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-26T02:17:42Z
- scoring-related commit: Merge pull request #315 from TensorLink-AI/fix/promotion-scoring-cfg-… 2026-09-25T05:08:49Z
...
- net margin: 659.3918 USD/day  |  payback on registration: 0.05 days

## Score

- gate: **OK** 
- score: 72.8 (rank 1), confidence 0.85 - hardware from README keywords, not curated
- components: income 25.65 / freshness 35.0 / resource 15.0 / registration 9.98
