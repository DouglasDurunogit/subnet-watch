...
- miner_burn: **0.0**
- registration cost: 0.000628765 TAO (0.15157637855 USD), open=True
...
- **competitive_miner_usd_day: 2202.421440397895** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2202.421440397895
- top_miner_usd_day: 2202.421440397895 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2194.2023 USD/day  |  payback on registration: 0.0 days
