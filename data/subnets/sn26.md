...
- miner_burn: **0.0**
- registration cost: 0.11824317 TAO (23.3234652825 USD), open=True
...
- **competitive_miner_usd_day: 78.62121508237233** (uid 98) <- the only figure quotable as achievable
- median_miner_usd_day: 54.05208536913097
- top_miner_usd_day: 1651.4055039783645 (uid 45, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 41.2655 USD/day  |  payback on registration: 0.57 days

## Score

- gate: **OK** 
- score: 70.8 (rank 4), confidence 1.0 
- components: income 14.79 / freshness 35.0 / resource 11.25 / registration 9.81
