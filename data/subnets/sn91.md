...
- subnet age: 206.4 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2863.3253680419116** (uid 165) <- the only figure quotable as achievable
- median_miner_usd_day: 715.8313420104779
- top_miner_usd_day: 2863.3253680419116 (uid 165, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-22T01:18:06Z
...
- net margin: 714.845 USD/day  |  payback on registration: 0.04 days

## Score

- gate: **OK** 
- score: 73.1 (rank 3), confidence 0.85 - hardware from README keywords, not curated
- components: income 25.96 / freshness 35.0 / resource 15.0 / registration 9.99
