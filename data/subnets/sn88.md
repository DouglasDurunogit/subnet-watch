...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (1.9781 USD), open=True
...
- **competitive_miner_usd_day: 319.4921705065476** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.665047545932929
- top_miner_usd_day: 890.9321132126369 (uid 252, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -5.5765 USD/day  |  payback on registration: [UNKNOWN] days
