...
- subnet age: 251.3 days  |  registered at block 7340355
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1838.349176912129
- top_miner_usd_day: 1838.349176912129 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 19.3 (rank 79), confidence 0.6 - hardware requirement unknown; no README readable; repo unparsable
