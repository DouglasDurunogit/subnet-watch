...
- miner_burn: **0.0**
- registration cost: 0.414186375 TAO (89.97370624125 USD), open=True
...
- **competitive_miner_usd_day: 37.89855998086484** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 18.94927999043242
- top_miner_usd_day: 22332.620302686417 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.6054 USD/day  |  payback on registration: 5.11 days

## Score

- gate: **OK** 
- score: 69.8 (rank 7), confidence 1.0 
- components: income 11.55 / freshness 35.0 / resource 15.0 / registration 8.3
