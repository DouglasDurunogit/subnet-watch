...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (188.8425 USD), open=True
- tempo: 360.0  |  max_uids: 90  |  active: 28  |  free: 0
- subnet age: 181.7 days  |  registered at block 7457580
- weights_version: 13  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 26714.042122097424** (uid 58) <- the only figure quotable as achievable
- median_miner_usd_day: 97.04753329251518
- top_miner_usd_day: 26714.042122097424 (uid 58, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.8994047982418654  |  top1_share: 0.894817166229168  |  top10_share: 0.9867376839020816
...
- net margin: 96.0612 USD/day  |  payback on registration: 1.97 days

## Score

- gate: **OK** 
- score: 77.4 (rank 3), confidence 1.0 
- components: income 18.07 / freshness 35.0 / resource 15.0 / registration 9.34
