...
- miner_burn: **0.15055869310162961**
- registration cost: 0.1 TAO (22.885 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 31  |  free: 0
- subnet age: 806.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1173.566554749242** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 22.050185616896744
- top_miner_usd_day: 1173.566554749242 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 13.6738 USD/day  |  payback on registration: 1.67 days

## Score

- gate: **OK** 
- score: 70.1 (rank 10), confidence 1.0 
- components: income 10.61 / freshness 35.0 / resource 15.0 / registration 9.44
