...
- miner_burn: **0.0**
- registration cost: 0.118984318 TAO (24.57502103972 USD), open=True
...
- **competitive_miner_usd_day: 415.08169407557784** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 6.17430511809514
- top_miner_usd_day: 415.08169407557784 (uid 88, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.188 USD/day  |  payback on registration: 4.74 days

## Score

- gate: **OK** 
- score: 30.6 (rank 54), confidence 1.0 
- components: income 7.2 / freshness 0.0 / resource 15.0 / registration 8.42
