...
- miner_burn: **0.0**
- registration cost: 0.270154558 TAO (56.96749164546 USD), open=True
...
- **competitive_miner_usd_day: 12455.37097778974** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.214579171672135
- top_miner_usd_day: 12455.37097778974 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.0046 USD/day  |  payback on registration: [UNKNOWN] days
