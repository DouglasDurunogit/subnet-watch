...
- registration cost: 0.095020974 TAO (22.045816177739997 USD), open=True
...
- **competitive_miner_usd_day: 943.0678551320398** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 14.68646754261794
- top_miner_usd_day: 943.0678551320398 (uid 25, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 13.7002 USD/day  |  payback on registration: 1.61 days

## Score

- gate: **OK** 
- score: 70.1 (rank 7), confidence 1.0 
- components: income 10.62 / freshness 35.0 / resource 15.0 / registration 9.46
