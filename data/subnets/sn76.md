...
- miner_burn: **0.0**
- registration cost: 0.007791475 TAO (1.4992356194999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 161.0 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 363.62155628046236** (uid 134) <- the only figure quotable as achievable
- median_miner_usd_day: 290.8972450243699
- top_miner_usd_day: 1087.6521707051697 (uid 71, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.40941586681519215  |  top1_share: 0.5993011154685425  |  top10_share: 1.0
...
- status: **ok** 
- README: 6957 bytes, sha d7d3fc1b6de6b8ef
- latest release: (none) 
- last commit: 2026-07-30T06:19:32Z
- scoring-related commit: Evaluate the smaller tracks before skills so a long skills pass canno… 2026-07-30T05:52:31Z
...
- net margin: 217.1866 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 81.3 (rank 2), confidence 1.0 
- components: income 21.27 / freshness 35.0 / resource 15.0 / registration 10.0
...
_(truncated at 6000 of 6957 chars - read the full file at https://github.com/praxi-labs/phylax-subnet)_
