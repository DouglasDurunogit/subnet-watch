...
- subnet age: 439.5 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 295.9668690976835** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 739.905882331868
- top_miner_usd_day: 1183.8448955660526 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 287.7477 USD/day  |  payback on registration: 0.67 days
...
- components: income 22.38 / freshness 35.0 / resource 11.25 / registration 9.78
