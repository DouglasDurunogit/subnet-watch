...
- **competitive_miner_usd_day: 302.5934135562955** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 756.4719906919306
- top_miner_usd_day: 1210.3505678275658 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 294.3742 USD/day  |  payback on registration: 0.75 days
...
- components: income 22.47 / freshness 35.0 / resource 11.25 / registration 9.75
