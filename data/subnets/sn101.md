...
- registration cost: 0.004792803 TAO (1.09002718629 USD), open=True
...
- **competitive_miner_usd_day: 2.2641044752802837** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 1.03771455117013
- top_miner_usd_day: 2784.754166908279 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0514 USD/day  |  payback on registration: 21.21 days

## Score

- gate: **OK** 
- score: 39.1 (rank 47), confidence 1.0 
- components: income 0.2 / freshness 21.0 / resource 15.0 / registration 2.93
