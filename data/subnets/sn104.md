...
- **competitive_miner_usd_day: 10.194575765596051** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 7.541712183470684
- top_miner_usd_day: 2366.0890288976143 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.6775 USD/day  |  payback on registration: [UNKNOWN] days
