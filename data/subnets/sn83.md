...
- miner_burn: **0.0**
- registration cost: 0.142934258 TAO (27.99939179962 USD), open=True
...
- **competitive_miner_usd_day: 78.25875778782961** (uid 112) <- the only figure quotable as achievable
- median_miner_usd_day: 24.000597555456103
- top_miner_usd_day: 78.25875778782961 (uid 112, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 240  |  gini: 0.36479088639200996  |  top1_share: 0.01281051746541313  |  top10_share: 0.10523580218604296
...
- net margin: 12.0459 USD/day  |  payback on registration: 2.32 days

## Score

- gate: **OK** 
- score: 26.0 (rank 68), confidence 0.85 - hardware requirement unknown
- components: income 10.15 / freshness 0.0 / resource 11.25 / registration 9.23
