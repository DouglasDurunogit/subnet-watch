...
- **competitive_miner_usd_day: 23.31699692009902** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.829249230024755
- top_miner_usd_day: 891.9053355576737 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.8429 USD/day  |  payback on registration: 4.07 days

## Score

- gate: **OK** 
- score: 65.6 (rank 14), confidence 1.0 
- components: income 6.97 / freshness 35.0 / resource 15.0 / registration 8.64
