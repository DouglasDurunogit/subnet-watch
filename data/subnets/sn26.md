...
- subnet age: 114.5 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 253.5564262050783** (uid 132) <- the only figure quotable as achievable
- median_miner_usd_day: 24.89906306469829
- top_miner_usd_day: 1775.0110629836352 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.4131 USD/day  |  payback on registration: 1.35 days

## Score

- gate: **OK** 
- score: 53.3 (rank 29), confidence 1.0 
- components: income 11.51 / freshness 21.0 / resource 11.25 / registration 9.55
