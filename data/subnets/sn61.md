...
- miner_burn: **0.0**
- registration cost: 0.005540657 TAO (1.1193235271400002 USD), open=True
...
- **competitive_miner_usd_day: 261.6005633888908** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 28.5226792281343
- top_miner_usd_day: 261.6005633888908 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 20.3035 USD/day  |  payback on registration: 0.06 days

## Score

- gate: **OK** 
- score: 46.2 (rank 35), confidence 0.85 - hardware requirement unknown
- components: income 12.08 / freshness 21.0 / resource 11.25 / registration 9.98
