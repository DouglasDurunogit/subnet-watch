...
- subnet age: 716.7 days  |  registered at block 3613591
- weights_version: 283  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1647.1206826033754
- top_miner_usd_day: 1647.1206826033754 (uid 11, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
