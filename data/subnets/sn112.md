...
- registration cost: 0.99 TAO (221.10660000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 452.7 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 295.5439385953218** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 738.8485722097283
- top_miner_usd_day: 1182.1532058241348 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 287.3248 USD/day  |  payback on registration: 0.77 days
...
- components: income 22.37 / freshness 21.0 / resource 11.25 / registration 9.74
