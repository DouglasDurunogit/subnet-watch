...
- subnet age: 89.6 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 373.89474842000334** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 205.67567489387622
- top_miner_usd_day: 560.8756858928793 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 167.2663 USD/day  |  payback on registration: 0.13 days

## Score

- gate: **OK** 
- score: 80.2 (rank 1), confidence 1.0 
- components: income 20.25 / freshness 35.0 / resource 15.0 / registration 9.96
