...
- registration cost: 0.1 TAO (24.388 USD), open=True
...
- **competitive_miner_usd_day: 202.66571266917165** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0262922549878095
- top_miner_usd_day: 2860.5465915602326 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4732 USD/day  |  payback on registration: [UNKNOWN] days
