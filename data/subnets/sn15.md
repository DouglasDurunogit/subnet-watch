...
- miner_burn: **0.0**
- registration cost: 0.394770995 TAO (85.21921469065 USD), open=True
...
- **competitive_miner_usd_day: 37.711420971184914** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 18.855710485592457
- top_miner_usd_day: 22222.344227576632 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.5136 USD/day  |  payback on registration: 4.87 days

## Score

- gate: **OK** 
- score: 69.9 (rank 6), confidence 1.0 
- components: income 11.53 / freshness 35.0 / resource 15.0 / registration 8.38
