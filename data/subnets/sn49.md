...
- subnet age: 303.8 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 59.69687651974996** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 2986.3932105689273
- top_miner_usd_day: 5913.089544618105 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 51.4777 USD/day  |  payback on registration: 0.22 days
...
- components: income 15.64 / freshness 10.5 / resource 11.25 / registration 9.93
