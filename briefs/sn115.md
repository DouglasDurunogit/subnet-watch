# sn115 — HashiChain · challenge brief
...
**sn115 "HashiChain"** (Ѕ), 421.5 days old. Snapshot 2026-07-28T06:37:33Z b8718699.

- on-chain repo: `https://github.com/hashi115/hashichain`
- resolved: `https://github.com/hashi115/hashichain` — **ok**

On-chain description: _The First Public Blockchain Designed for AI Agents_ [VERIFIED: pack sn115, 2026-07-28]
...
- cheapest satisfying machine: **RTX 4090 (24 GB)** — $250.0/mo, 24 GB VRAM, 8 vCPU, 32 GB RAM, 1000 Mbps [margin:115.rtx4090]
...
**Miners earn nothing here.** `miner_burn` is 1.000 — 100.0% of miner emission is withheld by owner-controlled hotkeys and destroyed. [VERIFIED: pack sn115, 2026-07-28]
...
_Assembled from `data/subnets/sn115.md` and the repo README. Every claim is either quoted with a [VERIFIED] tag or marked [UNKNOWN]. Regenerate when this subnet appears in ALARMS.md under NEW SINCE LAST RUN._
