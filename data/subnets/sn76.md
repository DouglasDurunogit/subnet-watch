...
- subnet age: 167.4 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 527.9953166650721** (uid 8) <- the only figure quotable as achievable
- median_miner_usd_day: 378.39207103426327
- top_miner_usd_day: 527.9953166650721 (uid 8, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.18555057071354475  |  top1_share: 0.35240798388573524  |  top10_share: 1.0
...
- net margin: 293.1904 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 82.5 (rank 1), confidence 1.0 
- components: income 22.45 / freshness 35.0 / resource 15.0 / registration 10.0
