...
- miner_burn: **0.0**
- registration cost: 0.299697299 TAO (57.33808724467999 USD), open=True
...
- **competitive_miner_usd_day: 10186.139381911882** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 12.273267337001409
- top_miner_usd_day: 10186.139381911882 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.287 USD/day  |  payback on registration: 5.08 days

## Score

- gate: **OK** 
- score: 68.2 (rank 9), confidence 1.0 
- components: income 9.91 / freshness 35.0 / resource 15.0 / registration 8.31
