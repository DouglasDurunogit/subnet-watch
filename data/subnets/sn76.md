...
- **competitive_miner_usd_day: 139.3038229086537** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 93.38287243655323
- top_miner_usd_day: 311.63185026110494 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 82.4158 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 77.4 (rank 1), confidence 1.0 
- components: income 17.47 / freshness 35.0 / resource 15.0 / registration 9.91
