...
- miner_burn: **0.0**
- registration cost: 0.486842712 TAO (113.29316750952 USD), open=True
...
- **competitive_miner_usd_day: 41.81219327271811** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 24.791300436036405
- top_miner_usd_day: 22127.16068768622 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.62 USD/day  |  payback on registration: 4.8 days

## Score

- gate: **OK** 
- score: 71.1 (rank 7), confidence 1.0 
- components: income 12.65 / freshness 35.0 / resource 15.0 / registration 8.4
