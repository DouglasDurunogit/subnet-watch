...
- registration cost: 0.999999999 TAO (191.16999980883 USD), open=True
...
- **competitive_miner_usd_day: 1443.4100111746045** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 3.9570741037231985
- top_miner_usd_day: 1443.4100111746045 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.3389 USD/day  |  payback on registration: [UNKNOWN] days
