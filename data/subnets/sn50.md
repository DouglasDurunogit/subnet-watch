...
- registration cost: 0.8 TAO (159.536 USD), open=True
...
- **competitive_miner_usd_day: 31.14529881587167** (uid 205) <- the only figure quotable as achievable
- median_miner_usd_day: 7.558273352805678
- top_miner_usd_day: 31.14529881587167 (uid 205, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.6609 USD/day  |  payback on registration: [UNKNOWN] days
