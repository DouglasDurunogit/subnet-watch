...
- registration cost: 0.99 TAO (224.73989999999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 13  |  free: 0
- subnet age: 458.0 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 450.25275982245677** (uid 105) <- the only figure quotable as achievable
- median_miner_usd_day: 1125.6147235143392
- top_miner_usd_day: 1800.9766872062214 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-08-26T16:13:37Z
- scoring-related commit: feat(scoring): give the JS sandbox the App's own verdict, not just wh… 2026-08-26T09:26:46Z
...
- net margin: 442.0336 USD/day  |  payback on registration: 0.51 days

## Score

- gate: **OK** 
- score: 48.1 (rank 33), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 24.07 / freshness 35.0 / resource 11.25 / registration 9.83
