...
- **competitive_miner_usd_day: 12583.899241150186** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.139986575546535
- top_miner_usd_day: 12583.899241150186 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.0792 USD/day  |  payback on registration: [UNKNOWN] days
