...
- subnet age: 800.5 days  |  registered at block 3037158
- weights_version: 1011  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1111.8691337091695** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 409.7205622772229
- top_miner_usd_day: 1111.8691337091695 (uid 201, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 752.5757 USD/day  |  payback on registration: 0.03 days
...
- components: income 26.17 / freshness 0.0 / resource 11.25 / registration 9.99
