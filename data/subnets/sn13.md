...
- registration cost: 0.073868358 TAO (14.45751502776 USD), open=True
...
- **competitive_miner_usd_day: 5.8056062146487** (uid 86) <- the only figure quotable as achievable
- median_miner_usd_day: 4.710208815658379
- top_miner_usd_day: 2578.7297868330634 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -3.5364 USD/day  |  payback on registration: [UNKNOWN] days
