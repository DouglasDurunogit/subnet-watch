...
- miner_burn: **0.14117670012637973**
...
- **competitive_miner_usd_day: 1511.0651640501392** (uid 44) <- the only figure quotable as achievable
- median_miner_usd_day: 28.573121976735024
- top_miner_usd_day: 1611.9422227362954 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 55  |  gini: 0.761042926054833  |  top1_share: 0.14123465836233745  |  top10_share: 0.7942236062770959
- owner_incentive_share: 0.14123465836233742 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 19.0472 USD/day  |  payback on registration: 1.18 days

## Score

- gate: **OK** 
- score: 57.5 (rank 20), confidence 0.85 - hardware requirement unknown
- components: income 11.84 / freshness 35.0 / resource 11.25 / registration 9.61
