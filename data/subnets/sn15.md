...
- miner_burn: **0.0**
- registration cost: 0.224140549 TAO (42.692050368029996 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 97  |  free: 0
- subnet age: 194.2 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 17.979048043995228** (uid 118) <- the only figure quotable as achievable
- median_miner_usd_day: 9.234692858961182
- top_miner_usd_day: 9935.221949111761 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 86  |  gini: 0.9405202995664173  |  top1_share: 0.9281722400366469  |  top10_share: 0.9427240800122156
...
- net margin: 8.1667 USD/day  |  payback on registration: 5.23 days

## Score

- gate: **OK** 
- score: 67.0 (rank 12), confidence 1.0 
- components: income 8.75 / freshness 35.0 / resource 15.0 / registration 8.26
