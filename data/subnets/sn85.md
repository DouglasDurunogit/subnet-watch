...
- miner_burn: **0.0**
- registration cost: 0.000538988 TAO (0.10516194868 USD), open=True
...
- **competitive_miner_usd_day: 501.8612605670893** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 317.1274946959704
- top_miner_usd_day: 501.8612605670893 (uid 24, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 10  |  gini: 0.3044774752777437  |  top1_share: 0.16000793553900622  |  top10_share: 1.0
...
- latest release: (none) 
- last commit: 2026-08-17T08:37:37Z
- scoring-related commit: reinvite miners rejected with flag INVITATION_DECLINED in comp enroll… 2026-08-17T08:37:37Z
...
- net margin: 493.6421 USD/day  |  payback on registration: 0.0 days
