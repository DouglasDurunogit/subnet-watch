...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (146.32760000000002 USD), open=True
...
- **competitive_miner_usd_day: 1430.392586620071** (uid 106) <- the only figure quotable as achievable
- median_miner_usd_day: 152.83249986392667
- top_miner_usd_day: 3183.4575193301075 (uid 131, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 104.6088 USD/day  |  payback on registration: 1.4 days

## Score

- gate: **OK** 
- score: 66.2 (rank 16), confidence 0.85 - hardware from README keywords, not curated
