...
- miner_burn: **0.0**
- registration cost: 0.109239962 TAO (21.7059804494 USD), open=True
...
- **competitive_miner_usd_day: 670.0972777786319** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 1675.2943234926486
- top_miner_usd_day: 4355.887950791451 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 661.8781 USD/day  |  payback on registration: 0.03 days
...
- components: income 25.66 / freshness 35.0 / resource 11.25 / registration 9.99
