...
- miner_burn: **0.0**
- registration cost: 0.550562864 TAO (131.19362486256 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 33  |  free: 0
- subnet age: 430.7 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2665.5677726130266** (uid 236) <- the only figure quotable as achievable
- median_miner_usd_day: 314.0109339456649
- top_miner_usd_day: 2665.5677726130266 (uid 236, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 13515 bytes, sha d3d90ab579904671
- latest release: (none) 
- last commit: 2026-08-23T17:14:37Z
- scoring-related commit: Remove obsolete repo verify flag from docs 2026-08-23T12:20:55Z
...
- net margin: 305.7918 USD/day  |  payback on registration: 0.43 days
...
None of these worlds exist until t
```

_(truncated at 6000 of 13515 chars - read the full file at https://github.com/swarm-subnet/swarm)_
