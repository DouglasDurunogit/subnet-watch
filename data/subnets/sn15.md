...
- miner_burn: **0.0**
- registration cost: 0.501677687 TAO (117.32234388182002 USD), open=True
...
- **competitive_miner_usd_day: 24998.505643567965** (uid 129) <- the only figure quotable as achievable
- median_miner_usd_day: 26.960221945758587
- top_miner_usd_day: 24998.505643567965 (uid 129, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 25.9739 USD/day  |  payback on registration: 4.52 days

## Score

- gate: **OK** 
- score: 71.5 (rank 7), confidence 1.0 
- components: income 13.01 / freshness 35.0 / resource 15.0 / registration 8.49
