...
- miner_burn: **0.0**
- registration cost: 0.000541068 TAO (0.12277373988 USD), open=True
...
- **competitive_miner_usd_day: 294.47220754591706** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 26.566199648316505
- top_miner_usd_day: 294.47220754591706 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.347 USD/day  |  payback on registration: 0.01 days
