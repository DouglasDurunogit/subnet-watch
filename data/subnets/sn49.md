...
- **competitive_miner_usd_day: 41.32505786350678** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2067.3254519290485
- top_miner_usd_day: 4093.325845994591 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.1059 USD/day  |  payback on registration: 0.3 days
...
- components: income 13.94 / freshness 21.0 / resource 11.25 / registration 9.9
