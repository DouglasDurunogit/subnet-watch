...
- subnet age: 171.4 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2097.722069088253** (uid 81) <- the only figure quotable as achievable
- median_miner_usd_day: 524.3990256178705
- top_miner_usd_day: 2097.722069088253 (uid 81, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 516.1798 USD/day  |  payback on registration: 0.04 days
