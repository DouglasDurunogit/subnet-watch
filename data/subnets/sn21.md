...
- miner_burn: **0.30096060456708074**
...
- **competitive_miner_usd_day: 710.0430057214702** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 6.641558726986541
- top_miner_usd_day: 710.0430057214702 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.4316 USD/day  |  payback on registration: 5.52 days

## Score

- gate: **OK** 
- score: 64.0 (rank 12), confidence 1.0 
- components: income 5.88 / freshness 35.0 / resource 15.0 / registration 8.16
