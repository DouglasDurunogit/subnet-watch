...
- registration cost: 0.000505793 TAO (0.1020184481 USD), open=True
...
- **competitive_miner_usd_day: 1989.578985245454** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 693.8443027109714
- top_miner_usd_day: 2544.2075067683627 (uid 202, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 547.6384 USD/day  |  payback on registration: 0.0 days
