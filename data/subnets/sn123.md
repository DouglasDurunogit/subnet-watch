...
- **competitive_miner_usd_day: 80.29366615297816** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.242973140677548
- top_miner_usd_day: 643.7810142072366 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.0359 USD/day  |  payback on registration: [UNKNOWN] days
