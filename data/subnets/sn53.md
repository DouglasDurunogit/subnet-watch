...
- miner_burn: **0.0**
- registration cost: 0.000722309 TAO (0.15177879016999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 156  |  free: 0
- subnet age: 650.5 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 244.61067710292977** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 45.501861283815906
- top_miner_usd_day: 12509.958036855829 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-20T15:30:56Z
- scoring-related commit: tee_miner: lift the 1 MiB websocket frame cap that 504s long-context … 2026-08-20T15:30:56Z
...
- net margin: 35.4504 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.9 (rank 20), confidence 0.85 - hardware from README keywords, not curated
