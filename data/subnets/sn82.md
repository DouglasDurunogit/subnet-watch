...
- miner_burn: **0.0**
- registration cost: 0.000784654 TAO (0.18634747846 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 9  |  free: 0
- subnet age: 128.6 days  |  registered at block 8026517
- weights_version: 1778428951  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2154.3749653639843** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2154.3749653639843
- top_miner_usd_day: 2154.3749653639843 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2146.1558 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 51.9 (rank 33), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 30.3 / freshness 35.0 / resource 11.25 / registration 10.0
