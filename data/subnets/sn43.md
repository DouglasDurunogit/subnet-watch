...
- registration cost: 0.1 TAO (24.066000000000003 USD), open=True
...
- **competitive_miner_usd_day: 190.3666675445528** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 4.263531188007901
- top_miner_usd_day: 2851.5562468193843 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.0389 USD/day  |  payback on registration: 23.16 days

## Score

- gate: **OK** 
- score: 20.1 (rank 72), confidence 1.0 
- components: income 2.81 / freshness 0.0 / resource 15.0 / registration 2.28
