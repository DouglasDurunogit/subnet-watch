...
- registration cost: 0.003324368 TAO (0.74784982528 USD), open=True
...
- **competitive_miner_usd_day: 2.278429855017024** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.34845848562232
- top_miner_usd_day: 2744.671001063058 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.3622 USD/day  |  payback on registration: 2.06 days

## Score

- gate: **OK** 
- score: 46.5 (rank 39), confidence 1.0 
- components: income 1.22 / freshness 21.0 / resource 15.0 / registration 9.31
