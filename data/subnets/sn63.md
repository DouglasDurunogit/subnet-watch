...
- subnet age: 547.0 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.07417769333794257** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 0.07417769333794257
- top_miner_usd_day: 4860.122467501998 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.145 USD/day  |  payback on registration: [UNKNOWN] days
