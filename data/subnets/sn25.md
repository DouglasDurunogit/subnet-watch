...
- registration cost: 0.000571052 TAO (0.13463121951999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 15  |  free: 0
- subnet age: 833.8 days  |  registered at block 2998801
- weights_version: 20502  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 6419.861528027805
- top_miner_usd_day: 6419.861528027805 (uid 1, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-05T14:47:01Z
- scoring-related commit: validator: add private bounded attempt record store 2026-09-05T13:48:07Z
