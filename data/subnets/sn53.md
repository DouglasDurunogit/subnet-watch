...
- subnet age: 672.8 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3907.6334327071204** (uid 79) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5191833432149233
- top_miner_usd_day: 5853.273011405045 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.7 USD/day  |  payback on registration: [UNKNOWN] days
