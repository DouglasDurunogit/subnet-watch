...
- **competitive_miner_usd_day: 958.081448759623** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8882090068846938
- top_miner_usd_day: 6573.7828947881 (uid 38, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.331 USD/day  |  payback on registration: [UNKNOWN] days
