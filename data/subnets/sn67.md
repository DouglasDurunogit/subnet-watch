...
- registration cost: 0.137906683 TAO (30.48013507666 USD), open=True
...
- **competitive_miner_usd_day: 901.8472136930001** (uid 25) <- the only figure quotable as achievable
- median_miner_usd_day: 20.65411099902851
- top_miner_usd_day: 901.8472136930001 (uid 25, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.2859 USD/day  |  payback on registration: 1.58 days

## Score

- gate: **OK** 
- score: 71.4 (rank 3), confidence 1.0 
- components: income 11.89 / freshness 35.0 / resource 15.0 / registration 9.47
