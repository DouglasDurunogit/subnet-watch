...
- registration cost: 0.8 TAO (156.36 USD), open=True
...
- **competitive_miner_usd_day: 45.8006177571651** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 12.101789244779395
- top_miner_usd_day: 45.8006177571651 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.8826 USD/day  |  payback on registration: 40.27 days

## Score

- gate: **OK** 
- score: 32.7 (rank 53), confidence 0.85 - hardware requirement unknown
- components: income 6.26 / freshness 21.0 / resource 11.25 / registration 0.0
