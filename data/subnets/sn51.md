...
- tempo: 360.0  |  max_uids: 256  |  active: 82  |  free: 0
- subnet age: 717.4 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1837.0293469303417** (uid 246) <- the only figure quotable as achievable
- median_miner_usd_day: 30.234189383317016
- top_miner_usd_day: 67534.71350930288 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 72  |  gini: 0.9469636625219071  |  top1_share: 0.8526820479149807  |  top10_share: 0.9459009634911667
...
- last commit: 2026-09-23T11:44:49Z
- scoring-related commit: DAH-3505 - [P2] validator: keep the Docker SDK's SSH session alive th… 2026-09-23T11:44:49Z
...
- net margin: 18.3869 USD/day  |  payback on registration: 7.98 days

## Score

- gate: **OK** 
- score: 55.5 (rank 27), confidence 0.85 - hardware requirement unknown
- components: income 11.71 / freshness 35.0 / resource 11.25 / registration 7.34
