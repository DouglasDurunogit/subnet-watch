...
- miner_burn: **0.0**
- registration cost: 0.087258016 TAO (21.08415440608 USD), open=True
...
- **competitive_miner_usd_day: 452.0036599355763** (uid 65) <- the only figure quotable as achievable
- median_miner_usd_day: 6.5101850200066265
- top_miner_usd_day: 452.0036599355763 (uid 65, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.5239 USD/day  |  payback on registration: 3.82 days

## Score

- gate: **OK** 
- score: 31.1 (rank 58), confidence 1.0 
- components: income 7.41 / freshness 0.0 / resource 15.0 / registration 8.73
