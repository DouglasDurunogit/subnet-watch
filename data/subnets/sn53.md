...
- subnet age: 659.9 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 7190.534682463023** (uid 10) <- the only figure quotable as achievable
- median_miner_usd_day: 11.765346625884751
- top_miner_usd_day: 7893.593638944949 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 3.5462 USD/day  |  payback on registration: 0.03 days

## Score

- gate: **OK** 
- score: 52.9 (rank 33), confidence 0.85 - hardware from README keywords, not curated
