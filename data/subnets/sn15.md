...
- miner_burn: **0.0**
- registration cost: 0.147895983 TAO (46.58279776551001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 67  |  free: 0
- subnet age: 243.5 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21.502737756602976** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 11.632628622424564
- top_miner_usd_day: 22502.08630643854 (uid 75, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 55  |  gini: 0.9643028147218795  |  top1_share: 0.9745355174572158  |  top10_share: 0.9821229562004794
...
- last commit: 2026-09-22T00:03:29Z
- scoring-related commit: fix(validator): fail fast on invalid preflight config (#328) 2026-09-21T18:14:18Z
...
- net margin: 10.2938 USD/day  |  payback on registration: 4.53 days

## Score

- gate: **OK** 
- score: 68.1 (rank 7), confidence 1.0 
- components: income 9.58 / freshness 35.0 / resource 15.0 / registration 8.49
