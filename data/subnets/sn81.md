...
- **competitive_miner_usd_day: 211.11473002866558** (uid 76) <- the only figure quotable as achievable
- median_miner_usd_day: 80.33453869096982
- top_miner_usd_day: 211.11473002866558 (uid 76, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 71.0712 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 62.2 (rank 18), confidence 0.85 - hardware requirement unknown
- components: income 16.9 / freshness 35.0 / resource 11.25 / registration 10.0
