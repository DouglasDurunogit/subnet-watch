...
- registration cost: 0.1 TAO (20.493000000000002 USD), open=True
...
- **competitive_miner_usd_day: 24.62114955441748** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7679110972138007
- top_miner_usd_day: 2528.971215342925 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8183 USD/day  |  payback on registration: [UNKNOWN] days
