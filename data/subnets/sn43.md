...
- registration cost: 0.1 TAO (19.473 USD), open=True
...
- **competitive_miner_usd_day: 17.226448931871627** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9672605015222034
- top_miner_usd_day: 2423.724516695232 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.779 USD/day  |  payback on registration: [UNKNOWN] days
