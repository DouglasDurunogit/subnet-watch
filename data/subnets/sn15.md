...
- miner_burn: **0.0**
- registration cost: 0.270181982 TAO (53.117777661199995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 74  |  free: 0
- subnet age: 207.1 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12796.839949816978** (uid 41) <- the only figure quotable as achievable
- median_miner_usd_day: 13.844921144518434
- top_miner_usd_day: 12796.839949816978 (uid 41, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 61  |  gini: 0.9448725723371509  |  top1_share: 0.9454512144852749  |  top10_share: 0.9594204668631012
...
- net margin: 12.8586 USD/day  |  payback on registration: 4.13 days

## Score

- gate: **OK** 
- score: 69.0 (rank 8), confidence 1.0 
- components: income 10.38 / freshness 35.0 / resource 15.0 / registration 8.62
