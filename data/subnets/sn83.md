...
- **competitive_miner_usd_day: 76.52801485919177** (uid 168) <- the only figure quotable as achievable
- median_miner_usd_day: 22.779556698554007
- top_miner_usd_day: 78.97540524829262 (uid 192, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.3832 USD/day  |  payback on registration: 2.1 days

## Score

- gate: **OK** 
- score: 25.3 (rank 67), confidence 0.85 - hardware requirement unknown
- components: income 9.24 / freshness 0.0 / resource 11.25 / registration 9.3
