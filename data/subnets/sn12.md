...
- miner_burn: **0.9939632338937372**  <- 100% burn: miners earn NOTHING here
- registration cost: 0.0005 TAO (0.096345 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 18  |  free: 0
- subnet age: 902.7 days  |  registered at block 2256433
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 14.884212739252574** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 15.211852642317881
- top_miner_usd_day: 2972.676840511541 (uid 21, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 8  |  gini: 0.8470666554760344  |  top1_share: 0.9691748943248234  |  top10_share: 1.0
...
- net margin: 1.0249 USD/day  |  payback on registration: 0.09 days
