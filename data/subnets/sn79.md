...
- miner_burn: **0.0**
- registration cost: 0.074847493 TAO (14.53014381609 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 217  |  free: 0
- subnet age: 497.4 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 439.1155580228328** (uid 37) <- the only figure quotable as achievable
- median_miner_usd_day: 6.042554210781901
- top_miner_usd_day: 439.1155580228328 (uid 37, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 216  |  gini: 0.7388642233803551  |  top1_share: 0.09607066986596567  |  top10_share: 0.4941541471168101
...
- net margin: 5.0563 USD/day  |  payback on registration: 2.87 days

## Score

- gate: **OK** 
- score: 31.2 (rank 45), confidence 1.0 
- components: income 7.11 / freshness 0.0 / resource 15.0 / registration 9.04
