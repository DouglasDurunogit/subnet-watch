...
- subnet age: 51.6 days  |  registered at block 8572056
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 2395.030587300854
- top_miner_usd_day: 2395.030587300854 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
