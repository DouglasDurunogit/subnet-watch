...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (95.96 USD), open=True
...
- **competitive_miner_usd_day: 19.831059122373325** (uid 237) <- the only figure quotable as achievable
- median_miner_usd_day: 9.237098591210732
- top_miner_usd_day: 2753.0728761623213 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.6129 USD/day  |  payback on registration: [UNKNOWN] days
