...
- miner_burn: **0.7200707443989813**
- registration cost: 0.1 TAO (21.062 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 84  |  free: 0
- subnet age: 763.0 days  |  registered at block 3394182
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 25.32589416809371** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.427138013580432
- top_miner_usd_day: 2225.518845247996 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 76  |  gini: 0.7738596705514036  |  top1_share: 0.7204757469807778  |  top10_share: 0.7780661709696628
- owner_incentive_share: 0.7204757469807778 (independent check on miner_burn; disagreement 0.0004)
...
- net margin: 11.3701 USD/day  |  payback on registration: 1.85 days

## Score

- gate: **OK** 
- score: 55.3 (rank 23), confidence 1.0 
- components: income 9.94 / freshness 21.0 / resource 15.0 / registration 9.38
