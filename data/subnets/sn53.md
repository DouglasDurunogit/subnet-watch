...
- miner_burn: **0.0**
- registration cost: 0.000596921 TAO (0.11659657893000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 43  |  free: 0
- subnet age: 630.0 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2525.115397197846** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 140.95166601510547
- top_miner_usd_day: 2525.115397197846 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 104.0147 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 63.4 (rank 14), confidence 0.85 - hardware from README keywords, not curated
