...
- registration cost: 0.999999999 TAO (225.4999997745 USD), open=True
...
- **competitive_miner_usd_day: 1207.1668710361207** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.3693215904462384
- top_miner_usd_day: 1207.1668710361207 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.9177 USD/day  |  payback on registration: [UNKNOWN] days
