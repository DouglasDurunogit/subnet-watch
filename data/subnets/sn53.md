...
- miner_burn: **0.0**
- registration cost: 0.001594588 TAO (0.31225222216 USD), open=True
...
- **competitive_miner_usd_day: 601.1737558330921** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 97.1593948821159
- top_miner_usd_day: 2088.348660234051 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 87.4944 USD/day  |  payback on registration: 0.0 days
