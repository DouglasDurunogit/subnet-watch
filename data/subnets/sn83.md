...
- miner_burn: **0.0**
- registration cost: 0.184538244 TAO (36.0679997898 USD), open=True
...
- **competitive_miner_usd_day: 59.17238822676566** (uid 26) <- the only figure quotable as achievable
- median_miner_usd_day: 27.769089278072705
- top_miner_usd_day: 73.89559663594515 (uid 193, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 15.6361 USD/day  |  payback on registration: 2.31 days
