...
- subnet age: 865.0 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1008.6995438846837** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 729.2156284321911
- top_miner_usd_day: 1008.6995438846837 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 291.9554 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 27.6 (rank 57), confidence 0.85 - hardware from README keywords, not curated
- components: income 22.44 / freshness 0.0 / resource 0.0 / registration 10.0
