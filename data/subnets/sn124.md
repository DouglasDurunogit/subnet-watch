...
- miner_burn: **0.0**
- registration cost: 0.601550199 TAO (115.64201025576 USD), open=True
...
- **competitive_miner_usd_day: 600.9412253870199** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 250.63904277145255
- top_miner_usd_day: 600.9412253870199 (uid 157, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 243.954 USD/day  |  payback on registration: 0.47 days

## Score

- gate: **OK** 
- score: 54.2 (rank 24), confidence 0.85 - hardware requirement unknown
- components: income 21.73 / freshness 21.0 / resource 11.25 / registration 9.84
