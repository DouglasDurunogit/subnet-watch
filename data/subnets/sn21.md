...
- **competitive_miner_usd_day: 380.30213966720453** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.114495810100766
- top_miner_usd_day: 760.762028687183 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.3799 USD/day  |  payback on registration: 14.79 days

## Score

- gate: **OK** 
- score: 58.5 (rank 18), confidence 1.0 
- components: income 3.42 / freshness 35.0 / resource 15.0 / registration 5.07
