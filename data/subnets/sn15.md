...
- miner_burn: **0.0**
- registration cost: 0.228156477 TAO (64.92192553035 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 67  |  free: 0
- subnet age: 243.0 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 19.883193903072993** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 10.756481947564078
- top_miner_usd_day: 20807.273488568266 (uid 75, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 55  |  gini: 0.9643028147218797  |  top1_share: 0.9745355174572157  |  top10_share: 0.9821229562004793
...
- latest release: v2.0.28: chore(validator): split hosted and local runtime profiles (#327) 2026-09-21T07:54:54Z
- last commit: 2026-09-21T07:54:54Z
- scoring-related commit: chore(validator): split hosted and local runtime profiles (#327) 2026-09-21T07:54:54Z
...
- net margin: 9.4442 USD/day  |  payback on registration: 6.87 days

## Score

- gate: **OK** 
- score: 67.0 (rank 6), confidence 1.0 
- components: income 9.27 / freshness 35.0 / resource 15.0 / registration 7.71
