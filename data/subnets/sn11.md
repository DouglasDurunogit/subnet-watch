...
- miner_burn: **0.0**
- registration cost: 0.02 TAO (5.4064 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 9  |  free: 0
- subnet age: 858.7 days  |  registered at block 2918568
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6713.653803950633** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 6713.653803950633
- top_miner_usd_day: 6713.653803950633 (uid 17, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 11650 bytes, sha 40ed6b792fafb6da
- latest release: v0.7.0 2026-09-19T11:00:33Z
- last commit: 2026-09-19T11:05:56Z
- scoring-related commit: Season 2 (transition): routing-policy evaluation, policy sidecar + me… 2026-09-19T10:49:24Z
...
- net margin: 6712.6675 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 80.6 (rank 1), confidence 0.85 - income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 34.81 / freshness 35.0 / resource 15.0 / registration 10.0
...
Contributors, miners, and validators share the same emission pool. Users inst
```

_(truncated at 6000 of 11650 chars - read the full file at https://github.com/trajectoryRL/trajectoryRL)_
