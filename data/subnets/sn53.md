...
- miner_burn: **0.0**
- registration cost: 0.000792444 TAO (0.16056500328 USD), open=True
...
- **competitive_miner_usd_day: 2041.045172202183** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 91.03624122568199
- top_miner_usd_day: 2041.045172202183 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 79.6561 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.7 (rank 26), confidence 0.85 - hardware from README keywords, not curated
- components: income 17.34 / freshness 21.0 / resource 11.25 / registration 10.0
