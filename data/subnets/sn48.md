...
- subnet age: 719.5 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 31.268220432569528** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 367.41352451797155
- top_miner_usd_day: 1077.7272434896026 (uid 10, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.39735959999796555  |  top1_share: 0.34449819175072105  |  top10_share: 1.0
...
- net margin: 23.049 USD/day  |  payback on registration: 0.01 days
...
- components: income 12.56 / freshness 0.0 / resource 11.25 / registration 10.0
