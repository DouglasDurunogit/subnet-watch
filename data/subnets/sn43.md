...
- **competitive_miner_usd_day: 17.0754028034054** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 3.8951847243842552
- top_miner_usd_day: 2383.3095371755758 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7598 USD/day  |  payback on registration: [UNKNOWN] days
