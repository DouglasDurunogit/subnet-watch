...
- **competitive_miner_usd_day: 387.3901677098978** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 26.03493348641503
- top_miner_usd_day: 2124.418430598274 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 17.655 USD/day  |  payback on registration: 1.21 days

## Score

- gate: **OK** 
- score: 67.4 (rank 9), confidence 1.0 
- components: income 11.56 / freshness 35.0 / resource 11.25 / registration 9.6
