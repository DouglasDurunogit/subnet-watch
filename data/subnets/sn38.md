...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (143.9744 USD), open=True
...
- **competitive_miner_usd_day: 1508.166002304443** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 159.1843619925773
- top_miner_usd_day: 3356.6537976876366 (uid 187, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 103.1213 USD/day  |  payback on registration: 1.4 days

## Score

- gate: **OK** 
- score: 63.0 (rank 13), confidence 0.85 - hardware requirement unknown
- components: income 18.35 / freshness 35.0 / resource 11.25 / registration 9.53
