...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (24.249999757500003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 16  |  free: 0
- subnet age: 102.8 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 179.22485278993366** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 152.3397573691333
- top_miner_usd_day: 693.0501708678346 (uid 44, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 8  |  gini: 0.49378547885002755  |  top1_share: 0.386681315998291  |  top10_share: 1.0
...
- latest release: v0.4.12 2026-09-18T02:45:06Z
- last commit: 2026-09-18T02:43:45Z
- scoring-related commit: scoring: extraction F1 compares leaf fields, so nested JSON scores ag… 2026-09-18T02:43:45Z
...
- net margin: 61.7547 USD/day  |  payback on registration: 0.39 days

## Score

- gate: **OK** 
- score: 76.2 (rank 3), confidence 1.0 
- components: income 16.35 / freshness 35.0 / resource 15.0 / registration 9.87
