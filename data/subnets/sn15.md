...
- miner_burn: **0.0**
- registration cost: 0.250404719 TAO (49.474964380020005 USD), open=True
...
- **competitive_miner_usd_day: 22.22144762956668** (uid 17) <- the only figure quotable as achievable
- median_miner_usd_day: 13.810525863235366
- top_miner_usd_day: 12819.07548021152 (uid 41, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.7204 USD/day  |  payback on registration: 3.89 days

## Score

- gate: **OK** 
- score: 69.0 (rank 10), confidence 1.0 
- components: income 10.34 / freshness 35.0 / resource 15.0 / registration 8.7
