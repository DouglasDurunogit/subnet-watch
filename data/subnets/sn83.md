...
- miner_burn: **0.0**
- registration cost: 0.133619384 TAO (26.411207441440002 USD), open=True
...
- **competitive_miner_usd_day: 75.90975583229941** (uid 131) <- the only figure quotable as achievable
- median_miner_usd_day: 22.348586499695607
- top_miner_usd_day: 88.45136766546194 (uid 171, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.943 USD/day  |  payback on registration: 2.95 days

## Score

- gate: **OK** 
- score: 24.9 (rank 67), confidence 0.85 - hardware requirement unknown
- components: income 9.07 / freshness 0.0 / resource 11.25 / registration 9.02
