...
- **competitive_miner_usd_day: 1974.8551039107629** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 88.0839817138454
- top_miner_usd_day: 1974.8551039107629 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 78.6414 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.6 (rank 30), confidence 0.85 - hardware from README keywords, not curated
