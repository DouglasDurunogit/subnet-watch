...
- **competitive_miner_usd_day: 467.0644573768389** (uid 38) <- the only figure quotable as achievable
- median_miner_usd_day: 1167.6433260751417
- top_miner_usd_day: 1868.2221947734445 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 458.8453 USD/day  |  payback on registration: 0.5 days
...
- components: income 24.22 / freshness 35.0 / resource 11.25 / registration 9.83
