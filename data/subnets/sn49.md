...
- miner_burn: **0.0**
- registration cost: 0.051424076 TAO (11.7966830344 USD), open=True
...
- **competitive_miner_usd_day: 54.33801151801457** (uid 180) <- the only figure quotable as achievable
- median_miner_usd_day: 2722.467314083767
- top_miner_usd_day: 5390.59661664952 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 46.1188 USD/day  |  payback on registration: 0.26 days
...
- components: income 15.22 / freshness 21.0 / resource 11.25 / registration 9.91
