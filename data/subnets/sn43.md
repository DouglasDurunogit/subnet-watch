...
- registration cost: 0.1 TAO (19.87 USD), open=True
...
- **competitive_miner_usd_day: 29.16607786661162** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 15.808302501013547
- top_miner_usd_day: 2533.2684633995023 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.272 USD/day  |  payback on registration: 15.62 days

## Score

- gate: **OK** 
- score: 23.0 (rank 68), confidence 1.0 
- components: income 3.24 / freshness 0.0 / resource 15.0 / registration 4.79
