...
- registration cost: 0.1 TAO (23.216 USD), open=True
...
- **competitive_miner_usd_day: 185.8314779040503** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.266331294755116
- top_miner_usd_day: 2746.901876345399 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2664 USD/day  |  payback on registration: [UNKNOWN] days
