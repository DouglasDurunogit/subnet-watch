...
- miner_burn: **0.30103889596648514**
...
- **competitive_miner_usd_day: 1030.470887298758** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 9.639957896115742
- top_miner_usd_day: 1030.470887298758 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.1893 USD/day  |  payback on registration: 128.95 days

## Score

- gate: **OK** 
- score: 50.7 (rank 28), confidence 1.0 
- components: income 0.68 / freshness 35.0 / resource 15.0 / registration 0.0
