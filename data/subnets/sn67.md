...
- registration cost: 0.038066424 TAO (8.76898143264 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 138  |  free: 0
- subnet age: 240.8 days  |  registered at block 7236936
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 54.36181221608978** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 27.18090610804489
- top_miner_usd_day: 665.404983795866 (uid 3, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 26.1946 USD/day  |  payback on registration: 0.33 days

## Score

- gate: **OK** 
- score: 72.9 (rank 4), confidence 1.0 
- components: income 13.05 / freshness 35.0 / resource 15.0 / registration 9.89
