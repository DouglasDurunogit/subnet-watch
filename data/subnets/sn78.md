...
- miner_burn: **0.0**
- registration cost: 0.75 TAO (218.2425 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 242  |  free: 0
- subnet age: 160.0 days  |  registered at block 7966145
- weights_version: 4294967296  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 17.46824154320023** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 17.46824154320023
- top_miner_usd_day: 17.46824154320023 (uid 1, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 4910 bytes, sha 2481c3a97370204d
- latest release: Open competition miner bundle v1 (feed config + pinned artifacts) 2026-09-20T17:08:55Z
- last commit: 2026-09-21T17:50:38Z
- scoring-related commit: Validate continuous intake status and readiness in the public monitor… 2026-09-21T17:50:38Z
...
- net margin: 9.2491 USD/day  |  payback on registration: 23.6 days

## Score

- gate: **OK** 
- score: 48.9 (rank 35), confidence 0.85 - hardware requirement unknown
- components: income 9.19 / freshness 35.0 / resource 11.25 / registration 2.13
