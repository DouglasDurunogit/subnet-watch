...
- registration cost: 0.1 TAO (22.978 USD), open=True
...
- **competitive_miner_usd_day: 179.16080355626158** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 3.3064884245193067
- top_miner_usd_day: 2729.480759914346 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.4889 USD/day  |  payback on registration: 47.0 days
