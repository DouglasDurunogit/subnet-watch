...
- subnet age: 643.0 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 572.891017983359** (uid 192) <- the only figure quotable as achievable
- median_miner_usd_day: 92.58844735084588
- top_miner_usd_day: 1990.1004963327646 (uid 222, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 82.9915 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.8 (rank 25), confidence 0.85 - hardware from README keywords, not curated
- components: income 17.5 / freshness 21.0 / resource 11.25 / registration 10.0
