...
- registration cost: 0.1 TAO (23.683000000000003 USD), open=True
...
- **competitive_miner_usd_day: 186.3017395192551** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 4.037498998869306
- top_miner_usd_day: 2808.2640763953686 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.98 USD/day  |  payback on registration: 24.17 days

## Score

- gate: **OK** 
- score: 19.6 (rank 71), confidence 1.0 
- components: income 2.7 / freshness 0.0 / resource 15.0 / registration 1.94
