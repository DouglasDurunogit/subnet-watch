...
- registration cost: 0.029582759 TAO (6.06239480187 USD), open=True
...
- **competitive_miner_usd_day: 2.074877631248209** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0586110363511272
- top_miner_usd_day: 2502.048356636616 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0723 USD/day  |  payback on registration: 83.85 days

## Score

- gate: **OK** 
- score: 36.3 (rank 49), confidence 1.0 
- components: income 0.28 / freshness 21.0 / resource 15.0 / registration 0.0
