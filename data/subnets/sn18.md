...
- **competitive_miner_usd_day: 2090.80674217124** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 4.675626859369587
- top_miner_usd_day: 2090.80674217124 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.6326 USD/day  |  payback on registration: [UNKNOWN] days
