...
- miner_burn: **0.0**
- registration cost: 0.01 TAO (2.0497 USD), open=True
...
- **competitive_miner_usd_day: 854.3394863861082** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 3.991221433898137
- top_miner_usd_day: 854.3394863861082 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.228 USD/day  |  payback on registration: [UNKNOWN] days
