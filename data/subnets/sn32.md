...
- miner_burn: **0.0**
- registration cost: 0.02062255 TAO (4.0731598505 USD), open=True
...
- **competitive_miner_usd_day: 11.224865870531815** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 8.575341692969737
- top_miner_usd_day: 11.224865870531815 (uid 45, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.2849 USD/day  |  payback on registration: 14.3 days

## Score

- gate: **OK** 
- score: 14.9 (rank 69), confidence 0.85 - hardware requirement unknown
- components: income 0.99 / freshness 0.0 / resource 11.25 / registration 5.23
