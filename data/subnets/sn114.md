...
- subnet age: 209.8 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1665.2267981772845** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 1665.2267981772845
- top_miner_usd_day: 4329.71164755892 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1157.4294 USD/day  |  payback on registration: 0.01 days
...
- components: income 27.87 / freshness 35.0 / resource 11.25 / registration 10.0
