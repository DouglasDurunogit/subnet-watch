...
- subnet age: 106.7 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 263.79279836769183** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 25.904267625455468
- top_miner_usd_day: 1846.6703543902784 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.2355 USD/day  |  payback on registration: 1.23 days

## Score

- gate: **OK** 
- score: 67.5 (rank 11), confidence 1.0 
- components: income 11.68 / freshness 35.0 / resource 11.25 / registration 9.59
