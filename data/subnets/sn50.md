...
- registration cost: 0.8 TAO (158.096 USD), open=True
...
- **competitive_miner_usd_day: 36.87678767332729** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.157132601043129
- top_miner_usd_day: 36.87678767332729 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.938 USD/day  |  payback on registration: 53.81 days
