...
- **competitive_miner_usd_day: 36.66743304784521** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.148366659298468
- top_miner_usd_day: 2388.3285734663305 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.1621 USD/day  |  payback on registration: 3.85 days

## Score

- gate: **OK** 
- score: 65.9 (rank 13), confidence 1.0 
- components: income 7.18 / freshness 35.0 / resource 15.0 / registration 8.72
