...
- **competitive_miner_usd_day: 720.4357766240029** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 6.738770019442204
- top_miner_usd_day: 720.4357766240029 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.4963 USD/day  |  payback on registration: 5.5 days
