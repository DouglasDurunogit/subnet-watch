...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (192.88 USD), open=True
...
- **competitive_miner_usd_day: 87.821385043674** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 10.505586642111213
- top_miner_usd_day: 87.821385043674 (uid 151, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.2864 USD/day  |  payback on registration: 84.36 days

## Score

- gate: **OK** 
- score: 31.4 (rank 59), confidence 0.85 - hardware requirement unknown
- components: income 4.7 / freshness 21.0 / resource 11.25 / registration 0.0
