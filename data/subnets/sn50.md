...
- registration cost: 0.8 TAO (156.45600000000002 USD), open=True
...
- **competitive_miner_usd_day: 47.04138117775614** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.490666389382108
- top_miner_usd_day: 47.04138117775614 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.2715 USD/day  |  payback on registration: 47.82 days

## Score

- gate: **OK** 
- score: 32.3 (rank 51), confidence 0.85 - hardware requirement unknown
- components: income 5.74 / freshness 21.0 / resource 11.25 / registration 0.0
