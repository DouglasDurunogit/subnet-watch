...
- subnet age: 105.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 80.94516219144934** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 55.649799006621436
- top_miner_usd_day: 1700.2190340524483 (uid 45, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 42.5727 USD/day  |  payback on registration: 0.49 days

## Score

- gate: **OK** 
- score: 71.0 (rank 6), confidence 1.0 
- components: income 14.91 / freshness 35.0 / resource 11.25 / registration 9.84
