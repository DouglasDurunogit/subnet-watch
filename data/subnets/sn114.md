...
- miner_burn: **0.0**
- registration cost: 0.066912024 TAO (13.28270588424 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 12  |  free: 0
- subnet age: 206.8 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1764.0164891544384** (uid 36) <- the only figure quotable as achievable
- median_miner_usd_day: 1764.0164891544384
- top_miner_usd_day: 4586.5720801142415 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1226.5816 USD/day  |  payback on registration: 0.01 days
...
- components: income 28.1 / freshness 35.0 / resource 11.25 / registration 10.0
