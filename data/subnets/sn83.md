...
- subnet age: 523.0 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 109.82604971364843** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 21.868018748292826
- top_miner_usd_day: 109.82604971364843 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 238  |  gini: 0.3812523710048126  |  top1_share: 0.017274853622368642  |  top10_share: 0.1346674208490667
...
- net margin: 13.6488 USD/day  |  payback on registration: 1.65 days

## Score

- gate: **OK** 
- score: 26.6 (rank 78), confidence 0.85 - hardware requirement unknown
- components: income 10.6 / freshness 0.0 / resource 11.25 / registration 9.45
