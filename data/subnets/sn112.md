...
- subnet age: 430.0 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1480.8019218555091** (uid 127) <- the only figure quotable as achievable
- median_miner_usd_day: 987.1912387019485
- top_miner_usd_day: 1480.8019218555091 (uid 127, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1472.5827 USD/day  |  payback on registration: 0.13 days
...
- components: income 28.82 / freshness 0.0 / resource 11.25 / registration 9.96
