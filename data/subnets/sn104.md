...
- **competitive_miner_usd_day: 11.008664724861625** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 8.391219965104316
- top_miner_usd_day: 2403.199207804233 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.172 USD/day  |  payback on registration: 570.2 days

## Score

- gate: **OK** 
- score: 39.8 (rank 34), confidence 0.85 - hardware requirement unknown
- components: income 0.63 / freshness 35.0 / resource 11.25 / registration 0.0
