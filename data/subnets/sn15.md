...
- miner_burn: **0.0**
- registration cost: 0.547666101 TAO (122.13501718401 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 86  |  free: 0
- subnet age: 225.0 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21424.723962830692** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 22.734513944501508
- top_miner_usd_day: 21424.723962830692 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 21.7482 USD/day  |  payback on registration: 5.62 days

## Score

- gate: **OK** 
- score: 70.5 (rank 5), confidence 1.0 
- components: income 12.34 / freshness 35.0 / resource 15.0 / registration 8.13
