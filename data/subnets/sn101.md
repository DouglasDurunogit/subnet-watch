...
- registration cost: 0.005660193 TAO (1.29646720665 USD), open=True
...
- **competitive_miner_usd_day: 2.3915325115834456** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.2192126529641094
- top_miner_usd_day: 2776.7099243314146 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.2329 USD/day  |  payback on registration: 5.57 days

## Score

- gate: **OK** 
- score: 45.0 (rank 39), confidence 1.0 
- components: income 0.83 / freshness 21.0 / resource 15.0 / registration 8.14
