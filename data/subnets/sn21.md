...
- miner_burn: **0.15056106355041265**
- registration cost: 0.1 TAO (23.173000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 46  |  free: 0
- subnet age: 817.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 107.02319101775096** (uid 254) <- the only figure quotable as achievable
- median_miner_usd_day: 10.026575404222744
- top_miner_usd_day: 1070.1588568048012 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-10T16:56:54Z
...
- net margin: 5.6981 USD/day  |  payback on registration: 4.07 days

## Score

- gate: **OK** 
- score: 66.2 (rank 14), confidence 1.0 
- components: income 7.51 / freshness 35.0 / resource 15.0 / registration 8.64
