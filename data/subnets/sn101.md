...
- **competitive_miner_usd_day: 1.7774111096161493** (uid 242) <- the only figure quotable as achievable
- median_miner_usd_day: 0.992043410018316
- top_miner_usd_day: 2441.584172623412 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.0057 USD/day  |  payback on registration: 17.29 days

## Score

- gate: **OK** 
- score: 54.3 (rank 21), confidence 1.0 
- components: income 0.02 / freshness 35.0 / resource 15.0 / registration 4.24
