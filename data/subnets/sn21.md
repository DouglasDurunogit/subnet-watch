...
- **competitive_miner_usd_day: 590.5822442655607** (uid 244) <- the only figure quotable as achievable
- median_miner_usd_day: 11.06661383376998
- top_miner_usd_day: 1181.1644885311214 (uid 39, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.5369 USD/day  |  payback on registration: 5.12 days

## Score

- gate: **OK** 
- score: 65.1 (rank 14), confidence 1.0 
- components: income 6.76 / freshness 35.0 / resource 15.0 / registration 8.29
