...
- registration cost: 0.8 TAO (156.448 USD), open=True
...
- **competitive_miner_usd_day: 46.35963485928128** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 10.698377275218757
- top_miner_usd_day: 46.35963485928128 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.4792 USD/day  |  payback on registration: 63.1 days

## Score

- gate: **OK** 
- score: 31.6 (rank 52), confidence 0.85 - hardware requirement unknown
- components: income 4.92 / freshness 21.0 / resource 11.25 / registration 0.0
