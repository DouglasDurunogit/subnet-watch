...
- **competitive_miner_usd_day: 62.35846001680838** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 62.35846001680838
- top_miner_usd_day: 6114.937231877256 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 53.8537 USD/day  |  payback on registration: 0.21 days
...
- components: income 15.82 / freshness 21.0 / resource 11.25 / registration 9.93
