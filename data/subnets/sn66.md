...
- subnet age: 539.4 days  |  registered at block 4958013
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1759.114655285564
- top_miner_usd_day: 1759.114655285564 (uid 121, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 43057 bytes, sha 47db8657123d2c9e
- latest release: (none) 
- last commit: 2026-08-13T18:07:33Z
- scoring-related commit: Preserve production task retirements 2026-08-13T00:05:35Z
...
10. The first successful proof to hold the reward target is eligible for a payout priced from the
    ...
    evidence; the intake estimate is not used as the amount-of-r
```

_(truncated at 6000 of 43057 chars - read the full file at https://github.com/conjectures-io/conjectures-validator)_
