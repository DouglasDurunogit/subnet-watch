...
- **competitive_miner_usd_day: [UNKNOWN]** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 4, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 12  |  gini: 0.4733107987812011  |  top1_share: 0.18744372720474903  |  top10_share: 0.9943841657891926
...
- gate: **OK** 
- score: 9.6 (rank 38), confidence 0.85 - hardware requirement unknown
