...
- **competitive_miner_usd_day: 38.47997022110612** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 1924.9972278396708
- top_miner_usd_day: 3811.514485458236 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 30.2608 USD/day  |  payback on registration: 0.33 days
...
- components: income 13.6 / freshness 21.0 / resource 11.25 / registration 9.89
