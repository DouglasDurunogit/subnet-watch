...
- **competitive_miner_usd_day: 464.52876516000134** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 25.252619740562057
- top_miner_usd_day: 2264.119173293164 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 16.6495 USD/day  |  payback on registration: 1.35 days

## Score

- gate: **OK** 
- score: 67.1 (rank 11), confidence 1.0 
- components: income 11.34 / freshness 35.0 / resource 11.25 / registration 9.55
