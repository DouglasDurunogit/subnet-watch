...
- miner_burn: **0.7500000006984919**
- registration cost: 0.0005 TAO (0.125445 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 8  |  free: 0
- subnet age: 564.0 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 771.6126210599717** (uid 40) <- the only figure quotable as achievable
- median_miner_usd_day: 1543.2723404914907
- top_miner_usd_day: 2314.9320599230095 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 17815 bytes, sha 0c8bb5a1423e6d4c
- latest release: v2-cutover-legacy-final-certfix-20260720 2026-07-20T19:10:50Z
- last commit: 2026-09-20T13:36:28Z
- scoring-related commit: test(arena): reject unrelated score failures 2026-09-20T13:21:27Z
...
- net margin: 763.3934 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 49.5 (rank 34), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
...
_(truncated at 6000 of 17815 chars - read the full file at https://github.com/leadpoet/leadpoet)_
