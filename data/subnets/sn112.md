...
- **competitive_miner_usd_day: 258.8606901916557** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 647.1418505767897
- top_miner_usd_day: 1035.4230109619236 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 250.6415 USD/day  |  payback on registration: 0.76 days
...
- components: income 21.84 / freshness 21.0 / resource 11.25 / registration 9.75
