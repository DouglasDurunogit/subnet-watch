...
- registration cost: 0.003448091 TAO (0.77009664394 USD), open=True
...
- **competitive_miner_usd_day: 2.215855134387491** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.3849094589921818
- top_miner_usd_day: 2724.855524215751 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.3986 USD/day  |  payback on registration: 1.93 days

## Score

- gate: **OK** 
- score: 46.7 (rank 39), confidence 1.0 
- components: income 1.33 / freshness 21.0 / resource 15.0 / registration 9.36
