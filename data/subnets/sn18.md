...
- subnet age: 1037.7 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1410.036309327496** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 12.663257618579305
- top_miner_usd_day: 1410.036309327496 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.6308 USD/day  |  payback on registration: 60.17 days

## Score

- gate: **OK** 
- score: 32.6 (rank 58), confidence 0.85 - hardware requirement unknown
- components: income 6.05 / freshness 21.0 / resource 11.25 / registration 0.0
