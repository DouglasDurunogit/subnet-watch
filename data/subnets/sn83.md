...
- subnet age: 540.8 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 159.00651564151667** (uid 31) <- the only figure quotable as achievable
- median_miner_usd_day: 28.09559149187499
- top_miner_usd_day: 159.00651564151667 (uid 31, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.8764 USD/day  |  payback on registration: 1.57 days

## Score

- gate: **OK** 
- score: 27.8 (rank 64), confidence 0.85 - hardware requirement unknown
- components: income 12.0 / freshness 0.0 / resource 11.25 / registration 9.48
