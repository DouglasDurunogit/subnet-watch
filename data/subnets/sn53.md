...
- subnet age: 670.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4456.644543750385** (uid 79) <- the only figure quotable as achievable
- median_miner_usd_day: 0.5921270901149784
- top_miner_usd_day: 6675.640813956266 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.6271 USD/day  |  payback on registration: [UNKNOWN] days

## Score

- gate: **OK** 
- score: 39.3 (rank 53), confidence 0.85 - hardware from README keywords, not curated
