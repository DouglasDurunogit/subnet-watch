...
- miner_burn: **0.0**
- registration cost: 0.000944352 TAO (0.20385726624 USD), open=True
...
- **competitive_miner_usd_day: 293.67043640501464** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 23.223222726207624
- top_miner_usd_day: 293.67043640501464 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.004 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 57.1 (rank 22), confidence 0.85 - hardware requirement unknown
- components: income 10.95 / freshness 35.0 / resource 11.25 / registration 10.0
