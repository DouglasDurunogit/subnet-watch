...
- miner_burn: **0.0**
- registration cost: 0.066073324 TAO (12.40790951396 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 253  |  free: 0
- subnet age: 802.1 days  |  registered at block 2943950
- weights_version: 2388  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 18.755469842708706** (uid 200) <- the only figure quotable as achievable
- median_miner_usd_day: 13.83277434593477
- top_miner_usd_day: 18.755469842708706 (uid 200, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 241  |  gini: 0.09228810045381786  |  top1_share: 0.00584481330347007  |  top10_share: 0.05465897585371093
...
- status: **ok** 
- README: 43626 bytes, sha e32bf4567d7dd4ba
...
- net margin: 10.5363 USD/day  |  payback on registration: 1.18 days

## Score

- gate: **OK** 
- score: 25.9 (rank 67), confidence 0.85 - hardware from README keywords, not curated
- components: income 9.66 / freshness 0.0 / resource 11.25 / registration 9.61
...
_(truncated at 6000 of 43626 chars - read the full file at https://github.com/afterpartyai/bittensor-conversation-genome-project)_
