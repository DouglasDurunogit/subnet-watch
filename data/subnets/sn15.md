...
- miner_burn: **0.0**
- registration cost: 0.650065551 TAO (151.55628256013998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 90  |  free: 0
- subnet age: 212.1 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 39.83238971761454** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 22.9124365632296
- top_miner_usd_day: 21404.445738345043 (uid 146, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 21.5736 USD/day  |  payback on registration: 7.03 days

## Score

- gate: **OK** 
- score: 70.0 (rank 8), confidence 1.0 
- components: income 12.31 / freshness 35.0 / resource 15.0 / registration 7.66
