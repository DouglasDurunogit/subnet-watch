...
- subnet age: 1015.9 days  |  registered at block 1477264
- weights_version: 199  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3166.4551476947586** (uid 210) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7795310555624714
- top_miner_usd_day: 10619.551569927547 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.4396 USD/day  |  payback on registration: [UNKNOWN] days
