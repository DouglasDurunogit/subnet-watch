...
- registration cost: 0.999999999 TAO (231.55999976844 USD), open=True
...
- **competitive_miner_usd_day: 2109.575875285753** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 4.724694009598551
- top_miner_usd_day: 2109.575875285753 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.5836 USD/day  |  payback on registration: [UNKNOWN] days
