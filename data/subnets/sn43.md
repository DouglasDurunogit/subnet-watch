...
- registration cost: 0.1 TAO (18.942 USD), open=True
...
- **competitive_miner_usd_day: 22.842594267692704** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7569670615024874
- top_miner_usd_day: 2344.6386817926455 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8305 USD/day  |  payback on registration: [UNKNOWN] days
