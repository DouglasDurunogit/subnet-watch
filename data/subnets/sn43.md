...
- registration cost: 0.1 TAO (22.94 USD), open=True
...
- **competitive_miner_usd_day: 26.562519427168557** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9659097973515838
- top_miner_usd_day: 2857.4294888430272 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.8253 USD/day  |  payback on registration: [UNKNOWN] days
