...
- subnet age: 407.8 days  |  registered at block 5794330
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 89.21968611946701** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.215847185953077
- top_miner_usd_day: 677.2596841572215 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.0797 USD/day  |  payback on registration: [UNKNOWN] days
