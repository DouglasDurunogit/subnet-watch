...
- subnet age: 859.5 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2357.08919738842** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 1709.671083639171
- top_miner_usd_day: 2357.08919738842 (uid 43, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 4  |  gini: 0.2737288652871881  |  top1_share: 0.38089788195080265  |  top10_share: 1.0
...
- net margin: 1272.4108 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 32.5 (rank 32), confidence 0.85 - hardware from README keywords, not curated
