...
- miner_burn: **0.4512286842800677**
- registration cost: 0.1205494 TAO (24.26056675 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 128  |  free: 0
- subnet age: 786.7 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 28.277547939422607** (uid 81) <- the only figure quotable as achievable
- median_miner_usd_day: 6.837970937832923
- top_miner_usd_day: 882.9940550334379 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.8517 USD/day  |  payback on registration: 4.15 days

## Score

- gate: **OK** 
- score: 66.2 (rank 12), confidence 1.0 
- components: income 7.6 / freshness 35.0 / resource 15.0 / registration 8.62
