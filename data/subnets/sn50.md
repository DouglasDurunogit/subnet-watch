...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (180.4 USD), open=True
...
- **competitive_miner_usd_day: 60.368975769069756** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 11.544067386303903
- top_miner_usd_day: 60.368975769069756 (uid 24, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.3249 USD/day  |  payback on registration: 54.26 days

## Score

- gate: **OK** 
- score: 32.3 (rank 60), confidence 0.85 - hardware requirement unknown
- components: income 5.78 / freshness 21.0 / resource 11.25 / registration 0.0
