...
- **competitive_miner_usd_day: 269.91521667109043** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 26.505484805104025
- top_miner_usd_day: 1889.5300853913632 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.7274 USD/day  |  payback on registration: 1.25 days
