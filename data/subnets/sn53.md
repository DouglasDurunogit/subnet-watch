...
- subnet age: 654.3 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 334.357493611534** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 47.088153637163096
- top_miner_usd_day: 12946.081971452257 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.5529 USD/day  |  payback on registration: 0.0 days
