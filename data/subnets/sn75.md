...
- **competitive_miner_usd_day: 11874.354838876672** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 2.0192920032100705
- top_miner_usd_day: 11874.354838876672 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.1999 USD/day  |  payback on registration: [UNKNOWN] days
