...
- subnet age: 526.9 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 131.65470333889434** (uid 117) <- the only figure quotable as achievable
- median_miner_usd_day: 24.64472279250238
- top_miner_usd_day: 131.65470333889434 (uid 117, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.39222013120768207  |  top1_share: 0.018618159584225007  |  top10_share: 0.12453378171812902
...
- net margin: 16.4255 USD/day  |  payback on registration: 1.58 days

## Score

- gate: **OK** 
- score: 27.2 (rank 75), confidence 0.85 - hardware requirement unknown
- components: income 11.29 / freshness 0.0 / resource 11.25 / registration 9.47
