...
- subnet age: 724.7 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 27.244940216681858** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 310.69630679161094
- top_miner_usd_day: 948.207110197679 (uid 206, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.39496734419825397  |  top1_share: 0.3478605871940426  |  top10_share: 1.0
...
- net margin: 19.0258 USD/day  |  payback on registration: 0.01 days
...
- components: income 11.84 / freshness 0.0 / resource 11.25 / registration 10.0
