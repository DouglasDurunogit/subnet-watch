...
- miner_burn: **0.0**
- registration cost: 0.201751215 TAO (38.56877977155 USD), open=True
...
- **competitive_miner_usd_day: 88.53826931260619** (uid 94) <- the only figure quotable as achievable
- median_miner_usd_day: 19.452966768888835
- top_miner_usd_day: 124.44444629256455 (uid 71, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.0523 USD/day  |  payback on registration: 5.47 days

## Score

- gate: **OK** 
- score: 23.5 (rank 70), confidence 0.85 - hardware requirement unknown
- components: income 8.24 / freshness 0.0 / resource 11.25 / registration 8.18
