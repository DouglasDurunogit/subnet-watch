...
- registration cost: 0.000707246 TAO (0.18353740946 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 6  |  free: 0
- subnet age: 147.2 days  |  registered at block 7966145
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3692.2934905586067
- top_miner_usd_day: 3692.2934905586067 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 24802 bytes, sha 0917f1ae08078c4f
- latest release: (none) 
- last commit: 2026-09-08T19:23:46Z
- scoring-related commit: Fix bootstrap image revision validation 2026-09-08T17:55:55Z
...
signed `linux/amd64` release tar
```

_(truncated at 6000 of 24802 chars - read the full file at https://github.com/Umi-BitSign/umi)_
