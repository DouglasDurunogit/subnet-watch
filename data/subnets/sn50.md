...
- registration cost: 0.8 TAO (166.52 USD), open=True
...
- **competitive_miner_usd_day: 43.8916191128952** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 11.838196697878018
- top_miner_usd_day: 43.8916191128952 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.619 USD/day  |  payback on registration: 46.01 days

## Score

- gate: **OK** 
- score: 32.6 (rank 57), confidence 0.85 - hardware requirement unknown
- components: income 6.04 / freshness 21.0 / resource 11.25 / registration 0.0
