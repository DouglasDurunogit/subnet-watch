...
- subnet age: 103.8 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 75.8266729261052** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 52.13083763669733
- top_miner_usd_day: 1592.7073231740612 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.6936 USD/day  |  payback on registration: 0.49 days

## Score

- gate: **OK** 
- score: 70.7 (rank 3), confidence 1.0 
- components: income 14.64 / freshness 35.0 / resource 11.25 / registration 9.84
