...
- registration cost: 0.8 TAO (164.736 USD), open=True
...
- **competitive_miner_usd_day: 35.10961427986328** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: 9.390818050713113
- top_miner_usd_day: 35.10961427986328 (uid 157, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.1716 USD/day  |  payback on registration: 140.61 days

## Score

- gate: **OK** 
- score: 41.9 (rank 37), confidence 0.85 - hardware requirement unknown
- components: income 3.06 / freshness 35.0 / resource 11.25 / registration 0.0
