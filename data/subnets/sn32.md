...
- miner_burn: **0.0**
- registration cost: 0.002976098 TAO (0.662181805 USD), open=True
...
- **competitive_miner_usd_day: 11.544784085700858** (uid 6) <- the only figure quotable as achievable
- median_miner_usd_day: 8.870924011355974
- top_miner_usd_day: 11.544784085700858 (uid 6, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.2113 USD/day  |  payback on registration: 3.13 days

## Score

- gate: **OK** 
- score: 17.8 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 0.76 / freshness 0.0 / resource 11.25 / registration 8.96
