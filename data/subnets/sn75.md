...
- miner_burn: **0.0**
- registration cost: 1.159882981 TAO (262.09875721657 USD), open=True
...
- **competitive_miner_usd_day: 11809.793220979827** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 1.82548508686738
- top_miner_usd_day: 11809.793220979827 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -6.3937 USD/day  |  payback on registration: [UNKNOWN] days
