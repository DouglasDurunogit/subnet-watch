...
- miner_burn: **0.0**
- registration cost: 0.154973182 TAO (34.71089330436 USD), open=True
...
- **competitive_miner_usd_day: 127.63048406749972** (uid 31) <- the only figure quotable as achievable
- median_miner_usd_day: 23.496825518702877
- top_miner_usd_day: 127.63048406749972 (uid 31, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 13.462 USD/day  |  payback on registration: 2.58 days

## Score

- gate: **OK** 
- score: 26.3 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 10.55 / freshness 0.0 / resource 11.25 / registration 9.14
