...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (194.0004 USD), open=True
...
- **competitive_miner_usd_day: 33212.42762073232** (uid 5) <- the only figure quotable as achievable
- median_miner_usd_day: 119.01669856107264
- top_miner_usd_day: 33212.42762073232 (uid 5, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 118.0304 USD/day  |  payback on registration: 1.64 days

## Score

- gate: **OK** 
- score: 78.3 (rank 1), confidence 1.0 
- components: income 18.88 / freshness 35.0 / resource 15.0 / registration 9.45
