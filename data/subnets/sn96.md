...
- **competitive_miner_usd_day: 352.12407423637836** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 22.636547629481463
- top_miner_usd_day: 2046.8926704961418 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 13.6552 USD/day  |  payback on registration: 1.48 days

## Score

- gate: **OK** 
- score: 66.4 (rank 11), confidence 1.0 
- components: income 10.6 / freshness 35.0 / resource 11.25 / registration 9.51
