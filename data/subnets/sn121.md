...
- **competitive_miner_usd_day: 533.1476754285081** (uid 79) <- the only figure quotable as achievable
- median_miner_usd_day: 1495.049198182792
- top_miner_usd_day: 2456.950720937076 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 524.9285 USD/day  |  payback on registration: 0.0 days
