...
- miner_burn: **0.0**
- registration cost: 0.000768211 TAO (0.17931581162 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 156  |  free: 0
- subnet age: 655.9 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 313.3676541821202** (uid 162) <- the only figure quotable as achievable
- median_miner_usd_day: 44.13211764946683
- top_miner_usd_day: 12133.37046651281 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 144  |  gini: 0.7663467576328427  |  top1_share: 0.6257064304261494  |  top10_share: 0.7043378646708416
...
- net margin: 35.6168 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 59.9 (rank 21), confidence 0.85 - hardware from README keywords, not curated
- components: income 14.22 / freshness 35.0 / resource 11.25 / registration 10.0
