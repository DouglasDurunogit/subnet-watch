...
- **competitive_miner_usd_day: 108.87145290818049** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 5.151868666139051
- top_miner_usd_day: 108.87145290818049 (uid 218, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.0673 USD/day  |  payback on registration: [UNKNOWN] days
