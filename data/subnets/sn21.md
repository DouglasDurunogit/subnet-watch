...
- **competitive_miner_usd_day: 23.992690786098404** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.998172696524601
- top_miner_usd_day: 917.7515011832719 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.0119 USD/day  |  payback on registration: 4.11 days

## Score

- gate: **OK** 
- score: 65.7 (rank 15), confidence 1.0 
- components: income 7.09 / freshness 35.0 / resource 15.0 / registration 8.63
