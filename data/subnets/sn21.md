...
- **competitive_miner_usd_day: 5.389412593025779** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.102083598182087
- top_miner_usd_day: 866.22232136839 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.3396 USD/day  |  payback on registration: [UNKNOWN] days
