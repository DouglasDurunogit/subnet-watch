...
- subnet age: 295.1 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 71.62874300202854** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 71.62874300202854
- top_miner_usd_day: 7023.33494742333 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 63.3549 USD/day  |  payback on registration: 0.18 days

## Score

- gate: **OK** 
- score: 35.2 (rank 54), confidence 0.6 - hardware requirement unknown; income rests on 2 competitive miners (n<=2: not a distribution)
- components: income 16.45 / freshness 21.0 / resource 11.25 / registration 9.94
