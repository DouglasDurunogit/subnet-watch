...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (186.056 USD), open=True
...
- **competitive_miner_usd_day: 71.5581305669627** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 10.343589174492815
- top_miner_usd_day: 71.5581305669627 (uid 24, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.1244 USD/day  |  payback on registration: 87.58 days

## Score

- gate: **OK** 
- score: 31.2 (rank 58), confidence 0.85 - hardware requirement unknown
- components: income 4.5 / freshness 21.0 / resource 11.25 / registration 0.0
