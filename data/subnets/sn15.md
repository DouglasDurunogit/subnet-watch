...
- miner_burn: **0.9973367974162102**  <- 100% burn: miners earn NOTHING here
- registration cost: 0.211903065 TAO (47.46416752935 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 22  |  free: 0
- subnet age: 238.7 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 6.958889268760308** (uid 89) <- the only figure quotable as achievable
- median_miner_usd_day: 4.817692570680213
- top_miner_usd_day: 17493.577023314374 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 12  |  gini: 0.9148785177950065  |  top1_share: 0.9974971002991271  |  top10_share: 0.9999236920822904
- owner_incentive_share: 0.9974971002991271 (independent check on miner_burn; disagreement 0.0002)
...
- status: **ok** 
- README: 6348 bytes, sha 1b5889158669625a
- latest release: v2.0.20 2026-09-17T05:42:00Z
- last commit: 2026-09-17T05:30:31Z
- scoring-related commit: Stop generated runs when miner inference budget is exhausted (#317) 2026-09-17T05:30:31Z
...
- net margin: 3.2961 USD/day  |  payback on registration: 14.4 days

## Score

- gate: **BLOCKED:burn** - miner_burn=0.997 - 99.7% of miner emission is withheld by owner-controlled hotkeys, so miners earn nothing here
...
| Reference | [Agent Interface](https://docs.oroagents.com/docs/miners/agent-interface) | [Configuration](https://docs.oroagents.
```

_(truncated at 6000 of 6348 chars - read the full file at https://github.com/ORO-AI/oro)_
