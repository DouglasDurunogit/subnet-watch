...
- miner_burn: **0.0**
- registration cost: 0.306368641 TAO (60.63341774031 USD), open=True
...
- **competitive_miner_usd_day: 21.107193617435538** (uid 183) <- the only figure quotable as achievable
- median_miner_usd_day: 12.033072996855774
- top_miner_usd_day: 11953.181282696323 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.9481 USD/day  |  payback on registration: 5.54 days

## Score

- gate: **OK** 
- score: 68.0 (rank 13), confidence 1.0 
- components: income 9.8 / freshness 35.0 / resource 15.0 / registration 8.15
