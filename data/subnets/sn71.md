...
- miner_burn: **0.7000032051000744**
- registration cost: 0.0005 TAO (0.15101499999999998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 8  |  free: 0
- subnet age: 568.8 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1048.9737529062645** (uid 172) <- the only figure quotable as achievable
- median_miner_usd_day: 1748.3073734221553
- top_miner_usd_day: 2447.6409939380455 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.20000305185094747  |  top1_share: 0.7000030518509476  |  top10_share: 1.0
- owner_incentive_share: 0.7000030518509476 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 17806 bytes, sha b400872c1c139122
- latest release: v2-cutover-legacy-final-certfix-20260720 2026-07-20T19:10:50Z
- last commit: 2026-09-25T09:57:41Z
- scoring-related commit: Retain verified Greenhouse department metadata for intent review 2026-09-25T08:06:33Z
...
- net margin: 1040.7546 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.2 (rank 36), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
...
do not accept the older `fit_summa
```

_(truncated at 6000 of 17806 chars - read the full file at https://github.com/leadpoet/leadpoet)_
