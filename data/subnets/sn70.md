...
- miner_burn: **0.0**
- registration cost: 0.9 TAO (179.631 USD), open=True
...
- **competitive_miner_usd_day: 101.24947429990128** (uid 27) <- the only figure quotable as achievable
- median_miner_usd_day: 101.24947429990128
- top_miner_usd_day: 405.0817328182589 (uid 26, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 42.3936 USD/day  |  payback on registration: 4.24 days

## Score

- gate: **OK** 
- score: 29.5 (rank 58), confidence 0.85 - hardware requirement unknown
