...
- miner_burn: **0.0**
- registration cost: 0.29084243 TAO (56.836427670599996 USD), open=True
...
- **competitive_miner_usd_day: 21.84330843323522** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.723243516919823
- top_miner_usd_day: 12357.30065345887 (uid 13, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 66  |  gini: 0.9435737793803196  |  top1_share: 0.9414063692711672  |  top10_share: 0.9555128087691979
...
- net margin: 10.7369 USD/day  |  payback on registration: 5.29 days

## Score

- gate: **OK** 
- score: 68.0 (rank 9), confidence 1.0 
- components: income 9.73 / freshness 35.0 / resource 15.0 / registration 8.24
