...
- miner_burn: **0.0**
- registration cost: 0.056700884 TAO (12.89945111 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 248  |  free: 0
- subnet age: 831.6 days  |  registered at block 2943950
- weights_version: 2388  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 19.369123223398514** (uid 219) <- the only figure quotable as achievable
- median_miner_usd_day: 14.347498683998898
- top_miner_usd_day: 19.369123223398514 (uid 219, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 240  |  gini: 0.09141201325092396  |  top1_share: 0.005797279266291429  |  top10_share: 0.05346379767802095
...
- net margin: 6.1283 USD/day  |  payback on registration: 2.1 days

## Score

- gate: **OK** 
- score: 53.8 (rank 26), confidence 0.85 - hardware requirement unknown
- components: income 7.76 / freshness 35.0 / resource 11.25 / registration 9.3
