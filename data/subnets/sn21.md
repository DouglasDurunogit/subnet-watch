...
- miner_burn: **0.3009696376975626**
- registration cost: 0.1 TAO (20.430000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 795.6 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 368.1341321043547** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 6.886863015557655
- top_miner_usd_day: 736.4209662711385 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.724 USD/day  |  payback on registration: 28.22 days

## Score

- gate: **OK** 
- score: 52.7 (rank 29), confidence 1.0 
- components: income 2.15 / freshness 35.0 / resource 15.0 / registration 0.59
