...
- **competitive_miner_usd_day: 452.2315972559879** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 26.92158053148322
- top_miner_usd_day: 2242.474239538847 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.7024 USD/day  |  payback on registration: 1.19 days

## Score

- gate: **OK** 
- score: 67.6 (rank 9), confidence 1.0 
- components: income 11.77 / freshness 35.0 / resource 11.25 / registration 9.6
