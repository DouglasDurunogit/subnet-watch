...
- miner_burn: **0.4512479908298701**
- registration cost: 0.1 TAO (20.335 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 99  |  free: 0
- subnet age: 787.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.80204693006245** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.764197999532358
- top_miner_usd_day: 881.547153884935 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 88  |  gini: 0.6815250005551361  |  top1_share: 0.45145334636052764  |  top10_share: 0.6164661700048852
...
- net margin: 7.7779 USD/day  |  payback on registration: 2.61 days

## Score

- gate: **OK** 
- score: 67.7 (rank 11), confidence 1.0 
- components: income 8.58 / freshness 35.0 / resource 15.0 / registration 9.13
