...
- registration cost: 0.1 TAO (19.589 USD), open=True
...
- **competitive_miner_usd_day: 10.44804738806661** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 3.5366178105623707
- top_miner_usd_day: 2446.8309916292105 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.3853 USD/day  |  payback on registration: [UNKNOWN] days
