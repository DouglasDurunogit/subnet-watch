...
- **competitive_miner_usd_day: 80.41761936456506** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 80.41761936456506
- top_miner_usd_day: 7885.1010474348495 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 72.1371 USD/day  |  payback on registration: 0.17 days
...
- components: income 16.95 / freshness 21.0 / resource 11.25 / registration 9.94
