...
- registration cost: 0.1 TAO (24.163 USD), open=True
...
- **competitive_miner_usd_day: 192.82245904019942** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.727160905859327
- top_miner_usd_day: 2860.922291249231 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2371 USD/day  |  payback on registration: [UNKNOWN] days
