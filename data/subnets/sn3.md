...
- miner_burn: **0.0**
- registration cost: 0.00085368 TAO (0.1676029944 USD), open=True
...
- **competitive_miner_usd_day: 3542.51569560044** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 3542.51569560044
- top_miner_usd_day: 3542.51569560044 (uid 110, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3534.2965 USD/day  |  payback on registration: 0.0 days
...
- components: income 32.27 / freshness 0.0 / resource 11.25 / registration 10.0
