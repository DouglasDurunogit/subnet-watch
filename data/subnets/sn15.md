...
- miner_burn: **0.0**
- registration cost: 0.252274757 TAO (50.32376852636 USD), open=True
...
- **competitive_miner_usd_day: 22.151826590442884** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 10.17786627128457
- top_miner_usd_day: 12338.367844871367 (uid 104, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.992 USD/day  |  payback on registration: 5.6 days

## Score

- gate: **OK** 
- score: 67.2 (rank 12), confidence 1.0 
- components: income 9.09 / freshness 35.0 / resource 15.0 / registration 8.13
