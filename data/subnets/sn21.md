...
- miner_burn: **0.1499966939445585**
- registration cost: 0.1 TAO (21.71 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 32  |  free: 0
- subnet age: 809.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 494.465735559878** (uid 178) <- the only figure quotable as achievable
- median_miner_usd_day: 9.259215799930864
- top_miner_usd_day: 988.931471119756 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 16  |  gini: 0.7827236516802489  |  top1_share: 0.4474254494399169  |  top10_share: 0.9986875438757135
...
- net margin: 0.5316 USD/day  |  payback on registration: 40.84 days

## Score

- gate: **OK** 
- score: 51.7 (rank 33), confidence 1.0 
- components: income 1.68 / freshness 35.0 / resource 15.0 / registration 0.0
