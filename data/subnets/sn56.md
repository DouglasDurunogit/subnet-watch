...
- **competitive_miner_usd_day: 961.5843332559825** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8921456625229467
- top_miner_usd_day: 6579.871642994239 (uid 38, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.327 USD/day  |  payback on registration: [UNKNOWN] days
