...
- miner_burn: **0.0**
- registration cost: 0.000823407 TAO (0.20646107118 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 37  |  free: 0
- subnet age: 642.1 days  |  registered at block 4474225
- weights_version: 6  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1399.9417240359096** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 122.35113826567994
- top_miner_usd_day: 1399.9417240359096 (uid 239, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 23  |  gini: 0.5770559159777282  |  top1_share: 0.17462570395128424  |  top10_share: 0.8993177968041756
...
- latest release: v0.3.5 2026-09-15T23:26:50Z
- last commit: 2026-09-15T22:28:50Z
- scoring-related commit: test: :white_check_mark: Update tests to validate that the baseline o… 2026-09-15T21:51:17Z
...
- net margin: 205.2836 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 65.7 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 21.05 / freshness 35.0 / resource 11.25 / registration 10.0
