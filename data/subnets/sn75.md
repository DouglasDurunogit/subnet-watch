...
- miner_burn: **0.9493678533472121**
- registration cost: 0.1 TAO (19.918000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 170  |  free: 0
- subnet age: 513.9 days  |  registered at block 5102795
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5.305927437338098** (uid 19) <- the only figure quotable as achievable
- median_miner_usd_day: 3.6478251131699424
- top_miner_usd_day: 10316.049420044596 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 157  |  gini: 0.9554149859727796  |  top1_share: 0.9506463343825444  |  top10_share: 0.9550469089019956
- owner_incentive_share: 0.9506463343825443 (independent check on miner_burn; disagreement 0.0013)
...
- last commit: 2026-08-03T13:57:35Z
- scoring-related commit: Merge pull request #32 from thenervelab/feature/staking-rewards-testing 2026-08-03T13:57:35Z
...
- net margin: -4.6543 USD/day  |  payback on registration: [UNKNOWN] days
