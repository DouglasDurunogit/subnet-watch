...
- registration cost: 0.1 TAO (21.943 USD), open=True
...
- **competitive_miner_usd_day: 181.35931246941067** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 12.926467609020161
- top_miner_usd_day: 2576.88645828388 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.2574 USD/day  |  payback on registration: [UNKNOWN] days
