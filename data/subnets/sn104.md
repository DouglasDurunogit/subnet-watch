...
- miner_burn: **0.953974510775879**
- registration cost: 0.5 TAO (98.75 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 31  |  free: 0
- subnet age: 451.8 days  |  registered at block 5528520
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 9.581463830396382** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 8.90838579272391
- top_miner_usd_day: 2475.264279953393 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 15  |  gini: 0.890290155862125  |  top1_share: 0.9540654376754975  |  top10_share: 0.9858075937004029
- owner_incentive_share: 0.9540654376754976 (independent check on miner_burn; disagreement 0.0001)
...
- latest release: (none) 
- last commit: 2026-08-04T06:18:12Z
- scoring-related commit: fix the validator task resolution 2026-08-04T06:17:28Z
...
- net margin: 0.5902 USD/day  |  payback on registration: 167.32 days

## Score

- gate: **OK** 
- score: 40.9 (rank 38), confidence 0.85 - hardware requirement unknown
- components: income 1.83 / freshness 35.0 / resource 11.25 / registration 0.0
