...
- subnet age: 744.0 days  |  registered at block 3379782
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 1812.7928508974555
- top_miner_usd_day: 1812.7928508974555 (uid 19, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 3.2 (rank 97), confidence 0.85 - hardware from README keywords, not curated
