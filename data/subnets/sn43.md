...
- **competitive_miner_usd_day: 57.501610053376396** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 2.374765772052033
- top_miner_usd_day: 2434.9879875530028 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 18  |  gini: 0.9029496694423671  |  top1_share: 0.8058416884127638  |  top10_share: 0.9977872392375894
- owner_incentive_share: 0.8058416884127638 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.3971 USD/day  |  payback on registration: 47.98 days

## Score

- gate: **OK** 
- score: 16.3 (rank 60), confidence 1.0 
- components: income 1.32 / freshness 0.0 / resource 15.0 / registration 0.0
