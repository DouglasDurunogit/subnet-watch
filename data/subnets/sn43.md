...
- registration cost: 0.1 TAO (23.266000000000002 USD), open=True
...
- **competitive_miner_usd_day: 185.7162810106381** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.243364100925078
- top_miner_usd_day: 2754.5166717931875 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2649 USD/day  |  payback on registration: [UNKNOWN] days
