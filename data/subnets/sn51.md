...
- **competitive_miner_usd_day: 2011.4618159098243** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 98.97935541174283
- top_miner_usd_day: 41136.82667883637 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 47.981 USD/day  |  payback on registration: 2.41 days

## Score

- gate: **OK** 
- score: 60.2 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 15.37 / freshness 35.0 / resource 11.25 / registration 9.2
