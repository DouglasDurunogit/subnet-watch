...
- registration cost: 0.1 TAO (23.902 USD), open=True
...
- **competitive_miner_usd_day: 198.73354889328027** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 14.161221185123194
- top_miner_usd_day: 2803.1806466297508 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.2452 USD/day  |  payback on registration: [UNKNOWN] days
