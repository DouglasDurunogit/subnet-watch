...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (110.23 USD), open=True
...
- **competitive_miner_usd_day: 319.1042097588985** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 10.16486674999904
- top_miner_usd_day: 3191.7681594997 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.4242 USD/day  |  payback on registration: [UNKNOWN] days
