...
- **competitive_miner_usd_day: 25.10172471508642** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 10.820549294658612
- top_miner_usd_day: 2352.299682475312 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.7611 USD/day  |  payback on registration: 2.23 days

## Score

- gate: **OK** 
- score: 54.6 (rank 24), confidence 1.0 
- components: income 9.38 / freshness 21.0 / resource 15.0 / registration 9.26
