...
- miner_burn: **0.0**
- registration cost: 0.207973354 TAO (42.7073282439 USD), open=True
...
- **competitive_miner_usd_day: 20.146888252390593** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 10.165861044784243
- top_miner_usd_day: 11392.418388296757 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 71  |  gini: 0.946273128780162  |  top1_share: 0.941022000335883  |  top10_share: 0.9553580970701844
...
- net margin: 8.9023 USD/day  |  payback on registration: 4.8 days

## Score

- gate: **OK** 
- score: 67.5 (rank 13), confidence 1.0 
- components: income 9.06 / freshness 35.0 / resource 15.0 / registration 8.4
