...
- registration cost: 0.1 TAO (22.64 USD), open=True
...
- **competitive_miner_usd_day: 193.30592363870397** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 1.0736377668375519
- top_miner_usd_day: 2705.464921214741 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4239 USD/day  |  payback on registration: [UNKNOWN] days
