...
- subnet age: 327.0 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3420.11240982641
- top_miner_usd_day: 3420.11240982641 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-09-11T20:45:24Z
- scoring-related commit: fix(proof): fail-closed harbor partial scores and forged rewards 2026-09-11T19:56:05Z
