...
- miner_burn: **0.0**
- registration cost: 0.366740116 TAO (72.20746143923999 USD), open=True
...
- **competitive_miner_usd_day: 21.276725299516347** (uid 183) <- the only figure quotable as achievable
- median_miner_usd_day: 12.12972189972427
- top_miner_usd_day: 12087.96384072522 (uid 149, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.9446 USD/day  |  payback on registration: 6.6 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 1.0 
- components: income 9.8 / freshness 35.0 / resource 15.0 / registration 7.8
