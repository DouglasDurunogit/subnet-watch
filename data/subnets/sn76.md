...
- miner_burn: **0.0**
- registration cost: 0.099999999 TAO (24.76499975235 USD), open=True
...
- **competitive_miner_usd_day: 147.98830628452833** (uid 239) <- the only figure quotable as achievable
- median_miner_usd_day: 99.20455045179665
- top_miner_usd_day: 331.0596130207837 (uid 124, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 87.6153 USD/day  |  payback on registration: 0.28 days

## Score

- gate: **OK** 
- score: 77.6 (rank 1), confidence 1.0 
- components: income 17.71 / freshness 35.0 / resource 15.0 / registration 9.91
