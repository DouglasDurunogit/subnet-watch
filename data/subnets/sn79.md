...
- miner_burn: **0.0**
- registration cost: 0.164762392 TAO (30.96050108072 USD), open=True
...
- **competitive_miner_usd_day: 600.1054896402239** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 3.689308093078553
- top_miner_usd_day: 600.1054896402239 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.703 USD/day  |  payback on registration: 11.45 days

## Score

- gate: **OK** 
- score: 26.4 (rank 41), confidence 1.0 
- components: income 5.17 / freshness 0.0 / resource 15.0 / registration 6.18
