...
- miner_burn: **0.43140717851929367**
- registration cost: 0.2 TAO (38.264 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 175.8 days  |  registered at block 7525773
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 210.00972697472787** (uid 145) <- the only figure quotable as achievable
- median_miner_usd_day: 563.8494568487255
- top_miner_usd_day: 2162.4684111914485 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 3  |  gini: 0.44328811438511906  |  top1_share: 0.7364533898951674  |  top10_share: 1.0
- owner_incentive_share: 0.7364533898951674 (independent check on miner_burn; disagreement 0.305)  <- the two burn measures DISAGREE; the burn picture is shifting, treat both as provisional
...
- status: **ok** 
- README: 5053 bytes, sha db6a9d442426454c
- latest release: (none) 
- last commit: 2026-08-06T14:12:18Z
- scoring-related commit: Reduce validator burn default to 30 percent 2026-08-06T14:12:18Z
...
- net margin: 201.7905 USD/day  |  payback on registration: 0.19 days

## Score

- gate: **OK** 
- score: 46.3 (rank 32), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 20.98 / freshness 35.0 / resource 11.25 / registration 9.94
