...
- subnet age: 447.7 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 253.94306196485192** (uid 124) <- the only figure quotable as achievable
- median_miner_usd_day: 638.011985232503
- top_miner_usd_day: 1022.080908500154 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 245.7239 USD/day  |  payback on registration: 0.79 days
...
- components: income 21.76 / freshness 21.0 / resource 11.25 / registration 9.74
