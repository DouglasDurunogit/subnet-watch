...
- subnet age: 148.0 days  |  registered at block 7966145
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3763.0001578401802
- top_miner_usd_day: 3763.0001578401802 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 25110 bytes, sha b1cbff59bbc41020
- latest release: SN78 direct bootstrap cutover v1 inputs 2026-09-09T16:23:03Z
- last commit: 2026-09-09T17:56:18Z
- scoring-related commit: Publish verified bootstrap service state 2026-09-09T17:44:05Z
...
outer memory sandbox when it inspects untrusted media
```

_(truncated at 6000 of 25110 chars - read the full file at https://github.com/Umi-BitSign/umi)_
