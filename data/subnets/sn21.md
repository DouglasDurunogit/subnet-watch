...
- miner_burn: **0.30094910878688097**
- registration cost: 0.1 TAO (24.677000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 797.4 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5.903265845150609** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.874576320543083
- top_miner_usd_day: 948.8122417382403 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2779 USD/day  |  payback on registration: [UNKNOWN] days
