...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (115.865 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 35  |  free: 0
- subnet age: 448.7 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 866.5267863391766** (uid 49) <- the only figure quotable as achievable
- median_miner_usd_day: 273.3974160145295
- top_miner_usd_day: 866.5267863391766 (uid 49, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 25  |  gini: 0.3129589158171051  |  top1_share: 0.1118826689457298  |  top10_share: 0.6322416213906354
...
- latest release: (none) 
- last commit: 2026-09-10T19:26:11Z
- scoring-related commit: Keep leased seeds through a validator restart 2026-09-08T18:12:27Z
...
- net margin: 265.1782 USD/day  |  payback on registration: 0.44 days

## Score

- gate: **OK** 
- score: 66.4 (rank 12), confidence 0.85 - hardware requirement unknown
- components: income 22.06 / freshness 35.0 / resource 11.25 / registration 9.85
