...
- subnet age: 571.0 days  |  registered at block 4848444
- weights_version: 29  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5372.328065672056** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 3358.5506492134973
- top_miner_usd_day: 5372.328065672056 (uid 144, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3350.3315 USD/day  |  payback on registration: 0.0 days
...
- components: income 32.06 / freshness 21.0 / resource 11.25 / registration 10.0
