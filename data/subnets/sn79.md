...
- miner_burn: **0.0**
- registration cost: 0.073012113 TAO (16.65479309643 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 219  |  free: 0
- subnet age: 543.7 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 210.36986932576627** (uid 232) <- the only figure quotable as achievable
- median_miner_usd_day: 2.9844508303510286
- top_miner_usd_day: 210.36986932576627 (uid 232, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 218  |  gini: 0.7478905364615307  |  top1_share: 0.09480940298963715  |  top10_share: 0.48662611194326416
...
- net margin: 1.9981 USD/day  |  payback on registration: 8.34 days

## Score

- gate: **OK** 
- score: 47.6 (rank 34), confidence 1.0 
- components: income 4.34 / freshness 21.0 / resource 15.0 / registration 7.22
