...
- miner_burn: **0.7049904591403902**
- registration cost: 0.049233074 TAO (11.115351116980001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 247  |  free: 0
- subnet age: 983.7 days  |  registered at block 1907637
- weights_version: 1030  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 5.877470868912257** (uid 82) <- the only figure quotable as achievable
- median_miner_usd_day: 5.4025237279900535
- top_miner_usd_day: 2742.879107218335 (uid 162, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 238  |  gini: 0.7402425051909469  |  top1_share: 0.7069020915892712  |  top10_share: 0.7204278042137796
- owner_incentive_share: 0.7069020915892713 (independent check on miner_burn; disagreement 0.0019)
...
- net margin: -2.8167 USD/day  |  payback on registration: [UNKNOWN] days
