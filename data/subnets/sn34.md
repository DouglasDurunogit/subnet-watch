...
- **competitive_miner_usd_day: 328.0100707918943** (uid 196) <- the only figure quotable as achievable
- median_miner_usd_day: 9.939699114905888
- top_miner_usd_day: 3280.349200396816 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.8978 USD/day  |  payback on registration: [UNKNOWN] days
