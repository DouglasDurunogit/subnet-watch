...
- miner_burn: **0.0**
- registration cost: 0.052311581 TAO (10.29648848823 USD), open=True
...
- **competitive_miner_usd_day: 389.9411549812533** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 21.7962259735707
- top_miner_usd_day: 389.9411549812533 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 20.8099 USD/day  |  payback on registration: 0.49 days

## Score

- gate: **OK** 
- score: 72.0 (rank 3), confidence 1.0 
- components: income 12.18 / freshness 35.0 / resource 15.0 / registration 9.84
