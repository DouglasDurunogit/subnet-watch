...
- registration cost: 0.000544203 TAO (0.10536858486000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 8  |  free: 0
- subnet age: 546.8 days  |  registered at block 4848444
- weights_version: 29  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 5894.9116017952765
- top_miner_usd_day: 5894.9116017952765 (uid 29, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-03T12:50:00Z
- scoring-related commit: Merge pull request #74 from latent-to/codex/miner-reward-docs 2026-08-03T12:50:00Z
