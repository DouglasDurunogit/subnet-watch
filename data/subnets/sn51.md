...
- **competitive_miner_usd_day: 1283.9634438792016** (uid 85) <- the only figure quotable as achievable
- median_miner_usd_day: 88.54920302615183
- top_miner_usd_day: 38507.834665997776 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 68.5235 USD/day  |  payback on registration: 1.53 days

## Score

- gate: **OK** 
- score: 61.6 (rank 15), confidence 0.85 - hardware requirement unknown
- components: income 16.75 / freshness 35.0 / resource 11.25 / registration 9.49
