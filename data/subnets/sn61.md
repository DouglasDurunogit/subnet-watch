...
- miner_burn: **0.0**
- registration cost: 0.002034111 TAO (0.47193409310999995 USD), open=True
...
- **competitive_miner_usd_day: 290.8643546644301** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 30.554237050228497
- top_miner_usd_day: 290.8643546644301 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.3351 USD/day  |  payback on registration: 0.02 days

## Score

- gate: **OK** 
- score: 46.5 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 12.44 / freshness 21.0 / resource 11.25 / registration 9.99
