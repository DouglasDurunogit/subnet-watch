...
- miner_burn: **0.5211959681473672**
- registration cost: 0.0005 TAO (0.13256 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 136  |  free: 0
- subnet age: 975.0 days  |  registered at block 2009702
- weights_version: 1000910  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 98.54733075099242** (uid 48) <- the only figure quotable as achievable
- median_miner_usd_day: 8.346700073123644
- top_miner_usd_day: 1281.3028660566797 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 126  |  gini: 0.7152036984105166  |  top1_share: 0.5216806928046677  |  top10_share: 0.6568203687016022
- owner_incentive_share: 0.5216806928046676 (independent check on miner_burn; disagreement 0.0005)
...
- net margin: 0.1088 USD/day  |  payback on registration: 1.22 days

## Score

- gate: **OK** 
- score: 18.1 (rank 81), confidence 0.85 - hardware requirement unknown
- components: income 0.41 / freshness 0.0 / resource 11.25 / registration 9.59
