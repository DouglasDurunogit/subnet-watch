...
- registration cost: 0.1 TAO (21.047 USD), open=True
...
- **competitive_miner_usd_day: 25.2790202164059** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8377063229608193
- top_miner_usd_day: 2598.515736981935 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7892 USD/day  |  payback on registration: [UNKNOWN] days
