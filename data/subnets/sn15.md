...
- miner_burn: **0.0**
- registration cost: 0.27794835 TAO (54.7641634005 USD), open=True
...
- **competitive_miner_usd_day: 12589.058305665805** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 11.943109608222782
- top_miner_usd_day: 12589.058305665805 (uid 13, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.0589 USD/day  |  payback on registration: 4.95 days

## Score

- gate: **OK** 
- score: 68.2 (rank 10), confidence 1.0 
- components: income 9.83 / freshness 35.0 / resource 15.0 / registration 8.35
