...
- miner_burn: **0.7745687495917082**
- registration cost: 0.1 TAO (19.456000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 24  |  free: 0
- subnet age: 739.9 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 12.423440909279327** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.7999800534171206
- top_miner_usd_day: 2388.735924226999 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 18  |  gini: 0.8962362692332477  |  top1_share: 0.7746695968012698  |  top10_share: 0.9974056099868756
- owner_incentive_share: 0.7746695968012698 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: 0.6607 USD/day  |  payback on registration: 29.45 days

## Score

- gate: **OK** 
- score: 17.2 (rank 63), confidence 1.0 
- components: income 2.0 / freshness 0.0 / resource 15.0 / registration 0.18
