...
- registration cost: 0.000538988 TAO (0.14210957608000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 7  |  free: 0
- subnet age: 145.3 days  |  registered at block 7966145
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid [UNKNOWN]) <- the only figure quotable as achievable
- median_miner_usd_day: 3941.531067820051
- top_miner_usd_day: 3941.531067820051 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- status: **ok** 
- README: 23674 bytes, sha 0b42eb4f04dff838
- latest release: (none) 
- last commit: 2026-09-06T03:22:56Z
- scoring-related commit: Add public registered-miner endpoint pilot 2026-09-06T02:58:05Z
...
_(truncated at 6000 of 23674 chars - read the full file at https://github.com/Umi-BitSign/umi)_
