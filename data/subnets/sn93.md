...
- miner_burn: **0.011148203164339066**
- registration cost: 0.005 TAO ([UNKNOWN] USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 16  |  free: 0
- subnet age: 515.7 days  |  registered at block 5370681
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 153) <- the only figure quotable as achievable
...
- earners: 3  |  gini: 0.2696554916352578  |  top1_share: 0.5572917461431645  |  top10_share: 1.0
- owner_incentive_share: 0.5572917461431646 (independent check on miner_burn; disagreement 0.5461)  <- the two burn measures DISAGREE; the burn picture is shifting, treat both as provisional
...
- gate: **OK** 
- score: 27.4 (rank 50), confidence 0.85 - hardware requirement unknown
