...
- miner_burn: **0.0**
- registration cost: 0.99 TAO (230.9967 USD), open=True
...
- **competitive_miner_usd_day: 40986.12513487244** (uid 22) <- the only figure quotable as achievable
- median_miner_usd_day: 124.90930695579986
- top_miner_usd_day: 40986.12513487244 (uid 22, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 123.923 USD/day  |  payback on registration: 1.86 days

## Score

- gate: **OK** 
- score: 64.4 (rank 17), confidence 1.0 
- components: income 19.07 / freshness 21.0 / resource 15.0 / registration 9.38
