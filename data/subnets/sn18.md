...
- subnet age: 1035.4 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1089.4997929905321** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 13.007656400255193
- top_miner_usd_day: 1089.4997929905321 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3.982 USD/day  |  payback on registration: 58.82 days

## Score

- gate: **OK** 
- score: 44.7 (rank 41), confidence 0.85 - hardware requirement unknown
- components: income 6.34 / freshness 35.0 / resource 11.25 / registration 0.0
