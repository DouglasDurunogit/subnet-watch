...
- miner_burn: **0.8431011021602899**
- registration cost: 0.0005 TAO (0.145495 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 29  |  free: 0
- subnet age: 543.8 days  |  registered at block 5203057
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 106.17394897703878** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 35.819782625021965
- top_miner_usd_day: 4734.723994252903 (uid 237, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 23  |  gini: 0.8243178859274614  |  top1_share: 0.843258752785324  |  top10_share: 0.9249107170110802
- owner_incentive_share: 0.843258752785324 (independent check on miner_burn; disagreement 0.0002)
...
- latest release: (none) 
- last commit: 2026-09-19T14:22:53Z
- scoring-related commit: fix(price): publish the target miners are actually held to 2026-09-18T22:15:30Z
...
- net margin: 27.3864 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 59.0 (rank 17), confidence 0.85 - hardware requirement unknown
- components: income 13.22 / freshness 35.0 / resource 11.25 / registration 10.0
