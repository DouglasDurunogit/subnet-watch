...
- subnet age: 175.3 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 187.34766892276136** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 95.13765267275022
- top_miner_usd_day: 468.35864124063465 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 38.9054 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.6 (rank 2), confidence 1.0 
- components: income 14.56 / freshness 35.0 / resource 15.0 / registration 10.0
