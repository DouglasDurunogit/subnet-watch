...
- subnet age: 1023.4 days  |  registered at block 1477264
- weights_version: 199  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3016.643524125194** (uid 210) <- the only figure quotable as achievable
- median_miner_usd_day: 0.523813773940822
- top_miner_usd_day: 11021.827524375807 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.9573 USD/day  |  payback on registration: [UNKNOWN] days
