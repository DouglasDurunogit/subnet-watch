...
- subnet age: 558.9 days  |  registered at block 4885578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 0.08706148992388393** (uid 171) <- the only figure quotable as achievable
- median_miner_usd_day: 0.08706148992388393
- top_miner_usd_day: 5704.878250242342 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1321 USD/day  |  payback on registration: [UNKNOWN] days
