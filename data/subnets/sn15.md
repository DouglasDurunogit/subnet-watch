...
- miner_burn: **0.0**
- registration cost: 0.289157998 TAO (57.12027092492 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 83  |  free: 0
- subnet age: 203.6 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 21.78595176713514** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 10.009761622737766
- top_miner_usd_day: 12134.57886445853 (uid 104, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 69  |  gini: 0.947934948556256  |  top1_share: 0.9439083969465649  |  top10_share: 0.9582442748091603
...
- net margin: 8.8272 USD/day  |  payback on registration: 6.47 days

## Score

- gate: **OK** 
- score: 66.9 (rank 13), confidence 1.0 
- components: income 9.03 / freshness 35.0 / resource 15.0 / registration 7.84
