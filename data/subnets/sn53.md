...
- subnet age: 651.3 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 265.9715058390385** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 49.475348776550234
- top_miner_usd_day: 13602.400420344833 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 39.2639 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.2 (rank 20), confidence 0.85 - hardware from README keywords, not curated
- components: income 14.6 / freshness 35.0 / resource 11.25 / registration 10.0
