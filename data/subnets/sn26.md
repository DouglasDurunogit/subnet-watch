...
- subnet age: 134.2 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 228.29518290692346** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 22.418426705418163
- top_miner_usd_day: 1598.1707951582794 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 15.3834 USD/day  |  payback on registration: 1.48 days

## Score

- gate: **OK** 
- score: 52.8 (rank 26), confidence 1.0 
- components: income 11.05 / freshness 21.0 / resource 11.25 / registration 9.51
