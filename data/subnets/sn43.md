...
- registration cost: 0.1 TAO (21.723 USD), open=True
...
- **competitive_miner_usd_day: 180.40072366202642** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 12.84453152473628
- top_miner_usd_day: 2548.4127827392495 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.2647 USD/day  |  payback on registration: [UNKNOWN] days
