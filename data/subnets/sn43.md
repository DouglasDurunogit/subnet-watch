...
- registration cost: 0.1 TAO (19.576 USD), open=True
...
- **competitive_miner_usd_day: 17.294355274846023** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.9710734245234399
- top_miner_usd_day: 2433.27879389752 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.7782 USD/day  |  payback on registration: [UNKNOWN] days
