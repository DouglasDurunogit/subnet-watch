...
- registration cost: 0.15 TAO (31.65 USD), open=True
...
- **competitive_miner_usd_day: 91.89881255073367** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 91.89881255073367
- top_miner_usd_day: 1945.5233718636532 (uid 53, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 83.6796 USD/day  |  payback on registration: 0.38 days
...
- components: income 17.53 / freshness 35.0 / resource 11.25 / registration 9.87
