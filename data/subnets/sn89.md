...
- subnet age: 487.8 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 245.92476811555056** (uid 191) <- the only figure quotable as achievable
- median_miner_usd_day: 0.06850272092355168
- top_miner_usd_day: 245.92476811555056 (uid 191, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 51  |  gini: 0.7923730550844554  |  top1_share: 0.16437979822646864  |  top10_share: 0.8340786642042766
...
- status: **ok** 
- README: 15390 bytes, sha 701df95715dd483d
- latest release: (none) 
- last commit: 2026-08-12T02:00:03Z
...
- **One feed = one hotkey.** Mirroring the same 
```

_(truncated at 6000 of 15390 chars - read the full file at https://github.com/DeltaCompute24/InfiniteQuant-Subnet)_
