...
- miner_burn: **0.0**
- registration cost: 0.07030175 TAO (13.489499789999998 USD), open=True
...
- **competitive_miner_usd_day: 16.495194199296897** (uid 188) <- the only figure quotable as achievable
- median_miner_usd_day: 12.742074170805186
- top_miner_usd_day: 16.495194199296897 (uid 188, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.09192763458135378  |  top1_share: 0.005463306835272091  |  top10_share: 0.0521162640802922
...
- net margin: 4.5229 USD/day  |  payback on registration: 2.98 days

## Score

- gate: **OK** 
- score: 52.7 (rank 27), confidence 0.85 - hardware requirement unknown
- components: income 6.75 / freshness 35.0 / resource 11.25 / registration 9.01
