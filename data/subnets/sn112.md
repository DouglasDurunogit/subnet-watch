...
- **competitive_miner_usd_day: 248.41514533599567** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 649.1601457233091
- top_miner_usd_day: 1049.9051461106224 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 240.196 USD/day  |  payback on registration: 0.81 days
...
- components: income 21.67 / freshness 21.0 / resource 11.25 / registration 9.73
