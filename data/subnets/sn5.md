...
- miner_burn: **0.0**
- registration cost: 0.167098381 TAO (33.15398977421 USD), open=True
...
- **competitive_miner_usd_day: 35.656831170520256** (uid 247) <- the only figure quotable as achievable
- median_miner_usd_day: 32.88619901875685
- top_miner_usd_day: 35.656831170520256 (uid 247, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 24.667 USD/day  |  payback on registration: 1.34 days

## Score

- gate: **OK** 
- score: 28.6 (rank 56), confidence 0.85 - hardware requirement unknown
- components: income 12.82 / freshness 0.0 / resource 11.25 / registration 9.55
