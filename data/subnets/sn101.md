...
- miner_burn: **0.0**
- registration cost: 0.022995922 TAO (4.3197839476999995 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 253  |  free: 0
- subnet age: 449.9 days  |  registered at block 5481350
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 18.302046906551748** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 10.863018932285167
- top_miner_usd_day: 18.302046906551748 (uid 88, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 244  |  gini: 0.20648405062580588  |  top1_share: 0.006863764216705394  |  top10_share: 0.06715482450776569
...
- latest release: (none) 
- last commit: 2026-07-18T05:44:19Z
- scoring-related commit: Add duplicate tag-set scoring penalty and 0.2.0 release metadata (#2) 2026-07-02T14:49:07Z
...
- net margin: 9.8767 USD/day  |  payback on registration: 0.44 days

## Score

- gate: **OK** 
- score: 34.3 (rank 16), confidence 1.0 
- components: income 9.43 / freshness 0.0 / resource 15.0 / registration 9.85
