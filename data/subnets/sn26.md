...
- subnet age: 130.1 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 26.10287625885573** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 23.927636570617754
- top_miner_usd_day: 1705.7597514227173 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.2678 USD/day  |  payback on registration: 1.93 days

## Score

- gate: **OK** 
- score: 51.8 (rank 29), confidence 1.0 
- components: income 10.21 / freshness 21.0 / resource 11.25 / registration 9.36
