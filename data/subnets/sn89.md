...
- miner_burn: **0.7172762732952833**
- registration cost: 0.05 TAO (9.384500000000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 40  |  free: 0
- subnet age: 473.0 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 152.35228010147188** (uid 191) <- the only figure quotable as achievable
- median_miner_usd_day: 0.06642785267123257
- top_miner_usd_day: 472.93309709284017 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 33  |  gini: 0.853659754767712  |  top1_share: 0.4346061105515368  |  top10_share: 0.9893019564752923
- owner_incentive_share: 0.4346061105515368 (independent check on miner_burn; disagreement 0.2827)  <- the two burn measures DISAGREE; the burn picture is shifting, treat both as provisional
...
- status: **ok** 
- README: 12740 bytes, sha 704dc02438adb825
- latest release: (none) 
- last commit: 2026-07-27T17:17:49Z
- scoring-related commit: scoring: anchor the efficiency multiplier at zero washes, pure penalty 2026-07-26T05:39:31Z
...
- net margin: 144.1331 USD/day  |  payback on registration: 0.07 days

## Score

- gate: **OK** 
- score: 34.8 (rank 46), confidence 0.85 - hardware requirement unknown
- components: income 19.66 / freshness 0.0 / resource 11.25 / registration 9.98
...
- **Second miner? Claim it before registering**
```

_(truncated at 6000 of 12740 chars - read the full file at https://github.com/DeltaCompute24/InfiniteQuant-Subnet)_
