...
- **competitive_miner_usd_day: 10.604227386601147** (uid 7) <- the only figure quotable as achievable
- median_miner_usd_day: 9.3761642885205
- top_miner_usd_day: 2434.0600465259413 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.2213 USD/day  |  payback on registration: 449.01 days

## Score

- gate: **OK** 
- score: 40.0 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 0.79 / freshness 35.0 / resource 11.25 / registration 0.0
