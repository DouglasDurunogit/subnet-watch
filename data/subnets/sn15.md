...
- miner_burn: **0.0**
- registration cost: 0.259705004 TAO (51.089168386880004 USD), open=True
...
- **competitive_miner_usd_day: 12908.78816560067** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 12.24643402451413
- top_miner_usd_day: 12908.78816560067 (uid 13, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 66  |  gini: 0.9435800887610784  |  top1_share: 0.9414207416680661  |  top10_share: 0.9555273965282973
...
- net margin: 11.3648 USD/day  |  payback on registration: 4.5 days

## Score

- gate: **OK** 
- score: 68.4 (rank 12), confidence 1.0 
- components: income 9.93 / freshness 35.0 / resource 15.0 / registration 8.5
