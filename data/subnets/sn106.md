...
- **competitive_miner_usd_day: 308.32621841110586** (uid 30) <- the only figure quotable as achievable
- median_miner_usd_day: 46.81539137680574
- top_miner_usd_day: 308.32621841110586 (uid 30, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 38.3295 USD/day  |  payback on registration: 0.0 days
