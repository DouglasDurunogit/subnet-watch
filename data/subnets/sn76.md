...
- miner_burn: **0.0**
- registration cost: 4.0257e-05 TAO (0.007826765939999999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 15  |  free: 0
- subnet age: 162.1 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 156.57901768707322** (uid 247) <- the only figure quotable as achievable
- median_miner_usd_day: 93.9575681871831
- top_miner_usd_day: 1163.0423305332392 (uid 71, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 7  |  gini: 0.6195061443111982  |  top1_share: 0.6989058613480643  |  top10_share: 1.0
...
- latest release: (none) 
- last commit: 2026-07-31T13:00:17Z
- scoring-related commit: Hold inference keys in the proxy, enforce per task budgets, and refus… 2026-07-31T12:40:54Z
...
- net margin: 77.3032 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 77.2 (rank 2), confidence 1.0 
- components: income 17.22 / freshness 35.0 / resource 15.0 / registration 10.0
