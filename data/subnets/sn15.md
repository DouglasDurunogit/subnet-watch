...
- miner_burn: **0.0**
- registration cost: 0.45890842 TAO (103.21309274219999 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 75  |  free: 0
- subnet age: 213.3 days  |  registered at block 7366897
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 22492.379596614453** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 19.851100449529753
- top_miner_usd_day: 22492.379596614453 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.8648 USD/day  |  payback on registration: 5.47 days

## Score

- gate: **OK** 
- score: 70.0 (rank 6), confidence 1.0 
- components: income 11.81 / freshness 35.0 / resource 15.0 / registration 8.18
