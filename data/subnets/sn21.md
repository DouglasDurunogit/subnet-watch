...
- **competitive_miner_usd_day: 857.7839342576276** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 8.023822009171402
- top_miner_usd_day: 857.7839342576276 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.0078 USD/day  |  payback on registration: [UNKNOWN] days
