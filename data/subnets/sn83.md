...
- subnet age: 528.7 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 98.5314793927533** (uid 238) <- the only figure quotable as achievable
- median_miner_usd_day: 23.492918124831526
- top_miner_usd_day: 98.5314793927533 (uid 238, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 235  |  gini: 0.3626214212782872  |  top1_share: 0.015196220819128279  |  top10_share: 0.1199033801654156
...
- net margin: 15.2737 USD/day  |  payback on registration: 1.58 days

## Score

- gate: **OK** 
- score: 27.0 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 11.02 / freshness 0.0 / resource 11.25 / registration 9.47
