...
- subnet age: 688.7 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2469.7107242953534** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 43.05228215332162
- top_miner_usd_day: 41770.64883075736 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 58  |  gini: 0.9204866636800528  |  top1_share: 0.7702242645375021  |  top10_share: 0.9304612002503703
...
- net margin: 28.6236 USD/day  |  payback on registration: 3.95 days

## Score

- gate: **OK** 
- score: 58.1 (rank 23), confidence 0.85 - hardware requirement unknown
- components: income 13.38 / freshness 35.0 / resource 11.25 / registration 8.68
