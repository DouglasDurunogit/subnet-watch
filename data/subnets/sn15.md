...
- miner_burn: **0.0**
- registration cost: 0.368150197 TAO (81.81769978128001 USD), open=True
...
- **competitive_miner_usd_day: 39.611758961880135** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 19.987584797278966
- top_miner_usd_day: 22647.023807215097 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.6379 USD/day  |  payback on registration: 4.39 days

## Score

- gate: **OK** 
- score: 70.3 (rank 6), confidence 1.0 
- components: income 11.76 / freshness 35.0 / resource 15.0 / registration 8.54
