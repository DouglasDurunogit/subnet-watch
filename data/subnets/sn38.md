...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (144.67 USD), open=True
...
- **competitive_miner_usd_day: 1376.9663554113554** (uid 106) <- the only figure quotable as achievable
- median_miner_usd_day: 145.42634223600345
- top_miner_usd_day: 3064.4691832735098 (uid 131, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 100.6683 USD/day  |  payback on registration: 1.44 days

## Score

- gate: **OK** 
- score: 66.1 (rank 11), confidence 0.85 - hardware from README keywords, not curated
