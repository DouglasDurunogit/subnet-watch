...
- miner_burn: **0.0**
- registration cost: 0.106873664 TAO (23.560299228799998 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 249  |  free: 0
- subnet age: 510.4 days  |  registered at block 5231190
- weights_version: 1  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 455.7080237427401** (uid 128) <- the only figure quotable as achievable
- median_miner_usd_day: 21.132465747482442
- top_miner_usd_day: 455.7080237427401 (uid 128, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 242  |  gini: 0.403527446822354  |  top1_share: 0.06659023159825728  |  top10_share: 0.197508216769854
...
- net margin: 14.901 USD/day  |  payback on registration: 1.58 days

## Score

- gate: **OK** 
- score: 26.9 (rank 70), confidence 0.85 - hardware requirement unknown
- components: income 10.93 / freshness 0.0 / resource 11.25 / registration 9.47
