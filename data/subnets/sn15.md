...
- miner_burn: **0.0**
- registration cost: 0.465944432 TAO (104.4647416544 USD), open=True
...
- **competitive_miner_usd_day: 22023.46213612931** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 19.437247945812004
- top_miner_usd_day: 22023.46213612931 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.4509 USD/day  |  payback on registration: 5.66 days

## Score

- gate: **OK** 
- score: 69.8 (rank 6), confidence 1.0 
- components: income 11.72 / freshness 35.0 / resource 15.0 / registration 8.11
