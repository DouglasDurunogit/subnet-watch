...
- registration cost: 0.1 TAO (23.193 USD), open=True
...
- **competitive_miner_usd_day: 185.64729987610247** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.25318300166974
- top_miner_usd_day: 2744.179415241082 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2671 USD/day  |  payback on registration: [UNKNOWN] days
