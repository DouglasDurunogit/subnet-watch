...
- **competitive_miner_usd_day: 31.208908381241553** (uid 6) <- the only figure quotable as achievable
- median_miner_usd_day: 9.916448192664097
- top_miner_usd_day: 31.208908381241553 (uid 6, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.6973 USD/day  |  payback on registration: 92.57 days

## Score

- gate: **OK** 
- score: 42.6 (rank 35), confidence 0.85 - hardware requirement unknown
- components: income 3.92 / freshness 35.0 / resource 11.25 / registration 0.0
