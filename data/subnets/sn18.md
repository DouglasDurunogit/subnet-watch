...
- subnet age: 1028.1 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 958.8350063877298** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 4.166121079894359
- top_miner_usd_day: 958.8350063877298 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.0755 USD/day  |  payback on registration: [UNKNOWN] days
