...
- subnet age: 219.5 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1392.909926098667** (uid 106) <- the only figure quotable as achievable
- median_miner_usd_day: 147.11019976681743
- top_miner_usd_day: 3099.951953677158 (uid 131, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 101.8454 USD/day  |  payback on registration: 1.42 days

## Score

- gate: **OK** 
- score: 66.2 (rank 12), confidence 0.85 - hardware from README keywords, not curated
- components: income 18.3 / freshness 35.0 / resource 15.0 / registration 9.53
