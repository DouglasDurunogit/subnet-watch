...
- miner_burn: **0.0**
- registration cost: 0.170782878 TAO (33.76035932304 USD), open=True
...
- **competitive_miner_usd_day: 461.0463090376324** (uid 120) <- the only figure quotable as achievable
- median_miner_usd_day: 6.573713794352656
- top_miner_usd_day: 461.0463090376324 (uid 120, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 5.5874 USD/day  |  payback on registration: 6.04 days

## Score

- gate: **OK** 
- score: 30.4 (rank 53), confidence 1.0 
- components: income 7.45 / freshness 0.0 / resource 15.0 / registration 7.99
