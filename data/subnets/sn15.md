...
- miner_burn: **0.0**
- registration cost: 0.478177532 TAO (102.28695587012 USD), open=True
...
- **competitive_miner_usd_day: 18858.757577978926** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 20.30140677644673
- top_miner_usd_day: 18858.757577978926 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.3151 USD/day  |  payback on registration: 5.3 days

## Score

- gate: **OK** 
- score: 70.1 (rank 4), confidence 1.0 
- components: income 11.89 / freshness 35.0 / resource 15.0 / registration 8.23
