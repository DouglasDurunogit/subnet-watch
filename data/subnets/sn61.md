...
- miner_burn: **0.0**
- registration cost: 0.001118365 TAO (0.24883621250000001 USD), open=True
...
- **competitive_miner_usd_day: 290.2796056503763** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 25.28469557733205
- top_miner_usd_day: 290.2796056503763 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 17.0655 USD/day  |  payback on registration: 0.01 days

## Score

- gate: **OK** 
- score: 57.5 (rank 21), confidence 0.85 - hardware requirement unknown
- components: income 11.43 / freshness 35.0 / resource 11.25 / registration 10.0
