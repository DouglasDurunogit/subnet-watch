...
- miner_burn: **0.9011501588393003**
- registration cost: 0.000634876 TAO (0.14552627672000001 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 34  |  free: 0
- subnet age: 547.3 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 18.350404823746466** (uid 56) <- the only figure quotable as achievable
- median_miner_usd_day: 12.233603215830977
- top_miner_usd_day: 2844.3609114728906 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 28  |  gini: 0.886905942698444  |  top1_share: 0.9011642989028428  |  top10_share: 0.9496131719896845
- owner_incentive_share: 0.9011642989028429 (independent check on miner_burn; disagreement 0.0)
...
- status: **ok** 
- README: 13499 bytes, sha c50306b71c2b6380
- latest release: v2-cutover-legacy-final-certfix-20260720 2026-07-20T19:10:50Z
- last commit: 2026-09-03T18:42:37Z
- scoring-related commit: Preserve strict identity boundaries in scoring integration 2026-09-03T18:42:37Z
...
- net margin: 4.0144 USD/day  |  payback on registration: 0.04 days

## Score

- gate: **OK** 
- score: 53.2 (rank 29), confidence 0.85 - hardware requirement unknown
- components: income 6.37 / freshness 35.0 / resource 11.25 / registration 9.99
...
If there are winning improvements, verified compute reimbursement is paid first, capped by the miner's remaining verified spend. If reimbursement demand is larger than available reimbursement capacity, reimbursements are prorated by compute credit. If reimbursement demand is smaller than available capacity, the unused amount flows to winning i
```

_(truncated at 6000 of 13499 chars - read the full file at https://github.com/leadpoet/leadpoet)_
