...
- **competitive_miner_usd_day: 36.640942120599334** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.232967067902681
- top_miner_usd_day: 2380.8598563587975 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.2467 USD/day  |  payback on registration: 3.78 days

## Score

- gate: **OK** 
- score: 66.0 (rank 13), confidence 1.0 
- components: income 7.24 / freshness 35.0 / resource 15.0 / registration 8.74
