...
- miner_burn: **0.0**
- registration cost: 0.569870004 TAO (132.79680703212 USD), open=True
...
- **competitive_miner_usd_day: 21807.25384472255** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 23.343623396906647
- top_miner_usd_day: 21807.25384472255 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.3573 USD/day  |  payback on registration: 5.94 days

## Score

- gate: **OK** 
- score: 70.5 (rank 4), confidence 1.0 
- components: income 12.45 / freshness 35.0 / resource 15.0 / registration 8.02
