...
- miner_burn: **0.0**
- registration cost: 0.000639768 TAO (0.12534974424 USD), open=True
...
- **competitive_miner_usd_day: 439.3259707239179** (uid 34) <- the only figure quotable as achievable
- median_miner_usd_day: 25.029568822364652
- top_miner_usd_day: 439.3259707239179 (uid 34, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.8104 USD/day  |  payback on registration: 0.01 days
