...
- miner_burn: **0.0**
- registration cost: 0.230128185 TAO (45.572284475550006 USD), open=True
...
- **competitive_miner_usd_day: 20.11624364283357** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 10.145583750298671
- top_miner_usd_day: 10777.233800683643 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 8.9844 USD/day  |  payback on registration: 5.07 days

## Score

- gate: **OK** 
- score: 67.4 (rank 12), confidence 1.0 
- components: income 9.09 / freshness 35.0 / resource 15.0 / registration 8.31
