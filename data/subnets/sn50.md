...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (193.352 USD), open=True
...
- **competitive_miner_usd_day: 69.83224026048796** (uid 170) <- the only figure quotable as achievable
- median_miner_usd_day: 8.409675275272177
- top_miner_usd_day: 69.83224026048796 (uid 170, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.1905 USD/day  |  payback on registration: 1014.97 days

## Score

- gate: **OK** 
- score: 28.0 (rank 63), confidence 0.85 - hardware requirement unknown
- components: income 0.69 / freshness 21.0 / resource 11.25 / registration 0.0
