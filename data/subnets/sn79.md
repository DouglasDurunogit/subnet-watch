...
- miner_burn: **0.0**
- registration cost: 0.122934912 TAO (23.0257090176 USD), open=True
...
- **competitive_miner_usd_day: 563.0199027335832** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 3.8077372153157434
- top_miner_usd_day: 563.0199027335832 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.8214 USD/day  |  payback on registration: 8.16 days

## Score

- gate: **OK** 
- score: 27.6 (rank 42), confidence 1.0 
- components: income 5.3 / freshness 0.0 / resource 15.0 / registration 7.28
