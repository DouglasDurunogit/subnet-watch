...
- miner_burn: **0.002204989083111286**
- registration cost: 0.0005 TAO (0.129615 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 52  |  free: 0
- subnet age: 531.6 days  |  registered at block 5203057
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 280.0182126293981** (uid 93) <- the only figure quotable as achievable
- median_miner_usd_day: 104.71787313245794
- top_miner_usd_day: 280.0182126293981 (uid 93, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 47  |  gini: 0.34529909089255706  |  top1_share: 0.05547075344974965  |  top10_share: 0.3973470509219685
- owner_incentive_share: 0.0021980705824887043 (independent check on miner_burn; disagreement 0.0)
...
- latest release: (none) 
- last commit: 2026-09-08T20:22:31Z
- scoring-related commit: fix(environment): bind external imports to verified source bytes 2026-09-05T07:28:36Z
...
- net margin: 96.4987 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 51.3 (rank 31), confidence 0.85 - hardware requirement unknown
- components: income 18.09 / freshness 21.0 / resource 11.25 / registration 10.0
