...
- miner_burn: **0.0**
- registration cost: 0.305496233 TAO (60.36300067847 USD), open=True
...
- **competitive_miner_usd_day: 12255.906960109516** (uid 149) <- the only figure quotable as achievable
- median_miner_usd_day: 12.23891408765723
- top_miner_usd_day: 12255.906960109516 (uid 149, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.2526 USD/day  |  payback on registration: 5.36 days

## Score

- gate: **OK** 
- score: 68.1 (rank 13), confidence 1.0 
- components: income 9.9 / freshness 35.0 / resource 15.0 / registration 8.21
