...
- **competitive_miner_usd_day: 971.4027503492808** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 591.308211037833
- top_miner_usd_day: 6558.582315370126 (uid 38, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 512.5344 USD/day  |  payback on registration: 0.0 days
