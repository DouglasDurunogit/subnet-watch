...
- subnet age: 504.7 days  |  registered at block 5128460
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 693.2890092868183** (uid 4) <- the only figure quotable as achievable
- median_miner_usd_day: 215.70772489332452
- top_miner_usd_day: 693.2890092868183 (uid 4, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 12  |  gini: 0.47087504578195616  |  top1_share: 0.19800695885728237  |  top10_share: 0.9915455988279819
...
- net margin: 76.4716 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 32.7 (rank 46), confidence 0.85 - hardware requirement unknown
- components: income 17.18 / freshness 0.0 / resource 11.25 / registration 10.0
