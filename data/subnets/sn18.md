...
- registration cost: 0.999999999 TAO (224.97999977502 USD), open=True
...
- **competitive_miner_usd_day: 1378.4242137612835** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.808406638467118
- top_miner_usd_day: 1378.4242137612835 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.4966 USD/day  |  payback on registration: [UNKNOWN] days
