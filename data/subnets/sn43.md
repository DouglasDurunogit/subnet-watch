...
- registration cost: 0.1 TAO (20.535 USD), open=True
...
- **competitive_miner_usd_day: 23.07409575369778** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.7599403326082483
- top_miner_usd_day: 2601.554567574783 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.9034 USD/day  |  payback on registration: 22.73 days

## Score

- gate: **OK** 
- score: 20.0 (rank 66), confidence 1.0 
- components: income 2.54 / freshness 0.0 / resource 15.0 / registration 2.42
