...
- miner_burn: **0.05777124408632517**
- registration cost: 0.1 TAO (23.386000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 60  |  free: 0
- subnet age: 560.6 days  |  registered at block 4878363
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3025.7439632998203** (uid 252) <- the only figure quotable as achievable
- median_miner_usd_day: 44.912087415665276
- top_miner_usd_day: 3025.7439632998203 (uid 252, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 49  |  gini: 0.7819142921314572  |  top1_share: 0.24988933494115667  |  top10_share: 0.8280188664845144
- owner_incentive_share: 0.05779005693526476 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 30.9634 USD/day  |  payback on registration: 0.76 days

## Score

- gate: **OK** 
- score: 59.2 (rank 22), confidence 0.85 - hardware requirement unknown
- components: income 13.69 / freshness 35.0 / resource 11.25 / registration 9.75
