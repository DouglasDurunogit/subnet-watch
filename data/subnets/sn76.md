...
- subnet age: 171.2 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 210.48512727437475** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 133.47956854740934
- top_miner_usd_day: 526.2495691684665 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 44.0704 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 75.0 (rank 2), confidence 1.0 
- components: income 15.04 / freshness 35.0 / resource 15.0 / registration 10.0
