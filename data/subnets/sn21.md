...
- miner_burn: **0.45076715596951544**
...
- **competitive_miner_usd_day: 25.466678148306446** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.3371942151457015
- top_miner_usd_day: 870.7304851610193 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.3509 USD/day  |  payback on registration: 3.52 days

## Score

- gate: **OK** 
- score: 31.1 (rank 30), confidence 1.0 
- components: income 7.3 / freshness 0.0 / resource 15.0 / registration 8.83
