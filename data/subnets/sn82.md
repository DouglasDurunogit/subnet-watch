...
- miner_burn: **0.0**
- registration cost: 0.000518619 TAO (0.10136408355 USD), open=True
...
- **competitive_miner_usd_day: 2048.141355134225** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2048.141355134225
- top_miner_usd_day: 2048.141355134225 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2039.9222 USD/day  |  payback on registration: 0.0 days
