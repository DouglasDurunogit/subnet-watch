...
- subnet age: 632.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2336.2499334046665** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 130.40921642887835
- top_miner_usd_day: 2336.2499334046665 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 92.6378 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 63.1 (rank 16), confidence 0.85 - hardware from README keywords, not curated
