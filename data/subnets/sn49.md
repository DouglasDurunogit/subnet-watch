...
- subnet age: 327.0 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 53.44640132382893** (uid 220) <- the only figure quotable as achievable
- median_miner_usd_day: 2673.707224699089
- top_miner_usd_day: 5293.968048074348 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 45.2272 USD/day  |  payback on registration: 0.31 days
...
- components: income 15.14 / freshness 35.0 / resource 11.25 / registration 9.9
