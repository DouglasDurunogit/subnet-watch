...
- miner_burn: **0.0**
- registration cost: 0.9 TAO (187.983 USD), open=True
...
- **competitive_miner_usd_day: 225.65754248577295** (uid 21) <- the only figure quotable as achievable
- median_miner_usd_day: 112.82877124288648
- top_miner_usd_day: 451.4085083686006 (uid 26, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 76.3957 USD/day  |  payback on registration: 2.46 days

## Score

- gate: **OK** 
- score: 32.0 (rank 51), confidence 0.85 - hardware requirement unknown
- components: income 17.18 / freshness 0.0 / resource 11.25 / registration 9.18
