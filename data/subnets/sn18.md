...
- registration cost: 0.999999999 TAO (232.34999976765 USD), open=True
...
- **competitive_miner_usd_day: 1844.8621788667224** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.944762811145181
- top_miner_usd_day: 1844.8621788667224 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.3409 USD/day  |  payback on registration: [UNKNOWN] days
