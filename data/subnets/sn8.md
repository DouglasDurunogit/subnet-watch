...
- subnet age: 1046.2 days  |  registered at block 1477264
- weights_version: 199  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1645.4819032444693** (uid 97) <- the only figure quotable as achievable
- median_miner_usd_day: 0.6465547753416383
- top_miner_usd_day: 19158.064548148082 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 27  |  gini: 0.9540980546859761  |  top1_share: 0.9049706039551042  |  top10_share: 0.9995724211651523
...
- latest release: (none) 
- last commit: 2026-09-05T01:44:51Z
...
- net margin: -7.5726 USD/day  |  payback on registration: [UNKNOWN] days

## Score

- gate: **OK** 
- score: 18.5 (rank 82), confidence 0.85 - hardware requirement unknown
- components: income 0.0 / freshness 10.5 / resource 11.25 / registration 0.0
- freshness basis: SCORING_COMMIT 38d ago
