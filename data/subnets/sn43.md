...
- miner_burn: **0.7983367543201894**
- registration cost: 0.1 TAO (19.878 USD), open=True
...
- **competitive_miner_usd_day: 38.922698595616474** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 4.576365774272483
- top_miner_usd_day: 2468.312418333894 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.8715327814706697  |  top1_share: 0.7984189723320158  |  top10_share: 0.9999084346910433
- owner_incentive_share: 0.7984189723320158 (independent check on miner_burn; disagreement 0.0001)
...
- net margin: -0.255 USD/day  |  payback on registration: [UNKNOWN] days
