...
- **competitive_miner_usd_day: 246.76381640657536** (uid 169) <- the only figure quotable as achievable
- median_miner_usd_day: 45.90238282719068
- top_miner_usd_day: 12620.074580643395 (uid 122, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 35.8348 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 59.9 (rank 18), confidence 0.85 - hardware from README keywords, not curated
- components: income 14.25 / freshness 35.0 / resource 11.25 / registration 10.0
