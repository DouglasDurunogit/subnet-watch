...
- miner_burn: **0.0**
- registration cost: 0.605034945 TAO (184.92893093925 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 36  |  free: 0
- subnet age: 460.7 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1021.6096992271343** (uid 49) <- the only figure quotable as achievable
- median_miner_usd_day: 324.8359308277793
- top_miner_usd_day: 1021.6096992271343 (uid 49, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 25  |  gini: 0.3133176642959614  |  top1_share: 0.11188608406336803  |  top10_share: 0.6330850706632887
...
- status: **ok** 
- README: 14252 bytes, sha 9b95d9100b5a585d
- latest release: (none) 
- last commit: 2026-09-22T09:38:19Z
- scoring-related commit: Merge pull request #159 from swarm-subnet/feature/ali/validator-image 2026-09-21T13:13:22Z
...
- net margin: 317.8013 USD/day  |  payback on registration: 0.58 days

## Score

- gate: **OK** 
- score: 67.0 (rank 13), confidence 0.85 - hardware requirement unknown
- components: income 22.77 / freshness 35.0 / resource 11.25 / registration 9.81
...
The drone sees the world through a single depth camera and knows its own position and speed. Fifty times a second, your model looks at that and decides where to fly next: a direction, a speed, a turn. No map, no GPS, no list of obstacles. Just like a real pilot, it has to re
```

_(truncated at 6000 of 14252 chars - read the full file at https://github.com/swarm-subnet/swarm)_
