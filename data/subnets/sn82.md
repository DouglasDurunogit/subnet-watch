...
- subnet age: 156.4 days  |  registered at block 8026517
- weights_version: 1778428951  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1863.866343053256** (uid 51) <- the only figure quotable as achievable
- median_miner_usd_day: 1863.866343053256
- top_miner_usd_day: 1863.866343053256 (uid 51, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1855.6472 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 36.9 (rank 56), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 29.73 / freshness 10.5 / resource 11.25 / registration 10.0
