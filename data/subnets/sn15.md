...
- miner_burn: **0.0**
- registration cost: 0.590829242 TAO (123.93234180191999 USD), open=True
...
- **competitive_miner_usd_day: 18443.7906707514** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 19.854695907633875
- top_miner_usd_day: 18443.7906707514 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 18.8684 USD/day  |  payback on registration: 6.57 days

## Score

- gate: **OK** 
- score: 69.6 (rank 6), confidence 1.0 
- components: income 11.81 / freshness 35.0 / resource 15.0 / registration 7.81
