...
- subnet age: 113.8 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 386.58644603127135** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 25.307057784447927
- top_miner_usd_day: 1804.0962996173487 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 22.3482 USD/day  |  payback on registration: 1.1 days

## Score

- gate: **OK** 
- score: 54.3 (rank 26), confidence 1.0 
- components: income 12.44 / freshness 21.0 / resource 11.25 / registration 9.63
