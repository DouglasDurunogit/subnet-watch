...
- subnet age: 417.9 days  |  registered at block 5794330
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 73.85524102555489** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.106567146399528
- top_miner_usd_day: 683.5058044657042 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.2505 USD/day  |  payback on registration: [UNKNOWN] days
