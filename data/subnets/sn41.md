...
- **competitive_miner_usd_day: 36.63752169027766** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 6.020851466584093
- top_miner_usd_day: 2278.5293209711144 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.0346 USD/day  |  payback on registration: 3.78 days

## Score

- gate: **OK** 
- score: 65.8 (rank 9), confidence 1.0 
- components: income 7.1 / freshness 35.0 / resource 15.0 / registration 8.74
