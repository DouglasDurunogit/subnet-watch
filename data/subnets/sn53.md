...
- **competitive_miner_usd_day: 12892.695890013762** (uid 122) <- the only figure quotable as achievable
- median_miner_usd_day: 46.89397504240329
- top_miner_usd_day: 12892.695890013762 (uid 122, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 38.6748 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 60.2 (rank 19), confidence 0.85 - hardware from README keywords, not curated
- components: income 14.54 / freshness 35.0 / resource 11.25 / registration 10.0
