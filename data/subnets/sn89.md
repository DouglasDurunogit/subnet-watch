...
- subnet age: 505.7 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 100.03389093996175** (uid 211) <- the only figure quotable as achievable
- median_miner_usd_day: 10.675801503625213
- top_miner_usd_day: 101.46402181118769 (uid 45, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 68  |  gini: 0.6181913552081799  |  top1_share: 0.06174799975569536  |  top10_share: 0.4773712819886398
...
- latest release: (none) 
- last commit: 2026-08-29T22:06:52Z
- scoring-related commit: scoring: the points gate is per competition, not per chain 2026-08-29T22:05:27Z
...
- net margin: 0.5874 USD/day  |  payback on registration: 20.07 days

## Score

- gate: **OK** 
- score: 43.7 (rank 46), confidence 0.85 - hardware requirement unknown
- components: income 1.83 / freshness 35.0 / resource 11.25 / registration 3.31
