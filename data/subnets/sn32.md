...
- miner_burn: **0.0**
- registration cost: 0.011835273 TAO (2.42646767046 USD), open=True
...
- **competitive_miner_usd_day: 10.245669455372228** (uid 220) <- the only figure quotable as achievable
- median_miner_usd_day: 8.258362879976753
- top_miner_usd_day: 10.245669455372228 (uid 220, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 240  |  gini: 0.1062251367796696  |  top1_share: 0.005338242061665901  |  top10_share: 0.05267679091885259
...
- net margin: -0.005 USD/day  |  payback on registration: [UNKNOWN] days
