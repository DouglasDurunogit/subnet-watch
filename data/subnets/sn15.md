...
- miner_burn: **0.0**
- registration cost: 0.34021748 TAO (65.3659844324 USD), open=True
...
- **competitive_miner_usd_day: 15025.291812209467** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 16.145544185710285
- top_miner_usd_day: 15025.291812209467 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 15.1592 USD/day  |  payback on registration: 4.31 days

## Score

- gate: **OK** 
- score: 69.6 (rank 7), confidence 1.0 
- components: income 10.99 / freshness 35.0 / resource 15.0 / registration 8.56
