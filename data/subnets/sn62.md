...
- miner_burn: **0.0**
- registration cost: 0.00058328 TAO (0.1141012336 USD), open=True
...
- **competitive_miner_usd_day: 2167.7054222563515** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 680.8432833275594
- top_miner_usd_day: 2772.1140641070665 (uid 202, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 466.1081 USD/day  |  payback on registration: 0.0 days
