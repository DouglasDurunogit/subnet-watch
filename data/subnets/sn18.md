...
- **competitive_miner_usd_day: 1355.5297731932087** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.111051232364438
- top_miner_usd_day: 1355.5297731932087 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.1081 USD/day  |  payback on registration: [UNKNOWN] days
