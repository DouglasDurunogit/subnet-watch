...
- subnet age: 859.3 days  |  registered at block 2538424
- weights_version: 2  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2143.3920264464873** (uid 48) <- the only figure quotable as achievable
- median_miner_usd_day: 1681.2747740588716
- top_miner_usd_day: 2317.8757634577055 (uid 43, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 781.8972 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 30.9 (rank 35), confidence 0.85 - hardware from README keywords, not curated
- components: income 26.32 / freshness 0.0 / resource 0.0 / registration 10.0
