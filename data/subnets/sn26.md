...
- subnet age: 127.8 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 362.8798858994953** (uid 45) <- the only figure quotable as achievable
- median_miner_usd_day: 23.755158349575304
- top_miner_usd_day: 1693.4640778996388 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 16.4771 USD/day  |  payback on registration: 1.41 days

## Score

- gate: **OK** 
- score: 53.1 (rank 30), confidence 1.0 
- components: income 11.3 / freshness 21.0 / resource 11.25 / registration 9.53
