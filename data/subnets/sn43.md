...
- registration cost: 0.1 TAO (19.814 USD), open=True
...
- **competitive_miner_usd_day: 10.521290759101209** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 3.624000150357083
- top_miner_usd_day: 2474.981676878706 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.3784 USD/day  |  payback on registration: [UNKNOWN] days
