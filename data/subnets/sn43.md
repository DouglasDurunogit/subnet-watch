...
- registration cost: 0.1 TAO (19.67 USD), open=True
...
- **competitive_miner_usd_day: 14.531663915783431** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 1.880295171211594
- top_miner_usd_day: 2455.5726395198126 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4756 USD/day  |  payback on registration: [UNKNOWN] days
