...
- **competitive_miner_usd_day: 6.2878727336950595** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 9.452768676321572
- top_miner_usd_day: 1010.628824911028 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2318 USD/day  |  payback on registration: [UNKNOWN] days
