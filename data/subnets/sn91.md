...
- miner_burn: **0.0**
- registration cost: 0.120317508 TAO (23.159917114920002 USD), open=True
...
- **competitive_miner_usd_day: 1460.1535271315431** (uid 246) <- the only figure quotable as achievable
- median_miner_usd_day: 730.0342207790129
- top_miner_usd_day: 2920.3921398366033 (uid 49, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.47927240542643945  |  top1_share: 0.5237673772718255  |  top10_share: 1.0
...
- net margin: 511.8664 USD/day  |  payback on registration: 0.05 days

## Score

- gate: **OK** 
- score: 68.7 (rank 10), confidence 0.85 - hardware requirement unknown
- components: income 24.65 / freshness 35.0 / resource 11.25 / registration 9.98
