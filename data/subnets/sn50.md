...
- **competitive_miner_usd_day: 32.194557603388446** (uid 6) <- the only figure quotable as achievable
- median_miner_usd_day: 9.833663012987175
- top_miner_usd_day: 32.194557603388446 (uid 6, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.6145 USD/day  |  payback on registration: 97.33 days

## Score

- gate: **OK** 
- score: 42.5 (rank 35), confidence 0.85 - hardware requirement unknown
- components: income 3.8 / freshness 35.0 / resource 11.25 / registration 0.0
