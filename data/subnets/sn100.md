...
- miner_burn: **0.0**
- registration cost: 0.011730564 TAO (2.34329746464 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 14  |  free: 0
- subnet age: 297.3 days  |  registered at block 6693448
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 448.6767239926862** (uid 47) <- the only figure quotable as achievable
- median_miner_usd_day: 448.6767239926862
- top_miner_usd_day: 1794.8712263543339 (uid 56, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 5  |  gini: 0.30002288992995685  |  top1_share: 0.5000228899299568  |  top10_share: 1.0
...
- last commit: 2026-08-13T05:39:25Z
- scoring-related commit: fix(deploy): never enable updater profile on validator (#134) 2026-08-12T15:55:32Z
...
- net margin: 440.4575 USD/day  |  payback on registration: 0.01 days
