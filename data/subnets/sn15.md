...
- miner_burn: **0.0**
- registration cost: 0.544673044 TAO (124.90986918052002 USD), open=True
...
- **competitive_miner_usd_day: 21205.556028470444** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 22.69953463078586
- top_miner_usd_day: 21205.556028470444 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 21.7132 USD/day  |  payback on registration: 5.75 days

## Score

- gate: **OK** 
- score: 70.4 (rank 6), confidence 1.0 
- components: income 12.34 / freshness 35.0 / resource 15.0 / registration 8.08
