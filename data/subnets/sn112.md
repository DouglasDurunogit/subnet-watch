...
- subnet age: 431.5 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1442.90902971895** (uid 105) <- the only figure quotable as achievable
- median_miner_usd_day: 961.9295675937586
- top_miner_usd_day: 1442.90902971895 (uid 105, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1434.6899 USD/day  |  payback on registration: 0.13 days
...
- components: income 28.71 / freshness 0.0 / resource 11.25 / registration 9.96
