...
- registration cost: 0.999999999 TAO (223.33999977666002 USD), open=True
...
- **competitive_miner_usd_day: 1402.6554333092197** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.130726206403455
- top_miner_usd_day: 1402.6554333092197 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.111 USD/day  |  payback on registration: [UNKNOWN] days
