...
- miner_burn: **0.0**
- registration cost: 0.308926995 TAO (59.622910035 USD), open=True
...
- **competitive_miner_usd_day: 12536.602037138728** (uid 253) <- the only figure quotable as achievable
- median_miner_usd_day: 11.539358526578619
- top_miner_usd_day: 12536.602037138728 (uid 253, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 10.3506 USD/day  |  payback on registration: 5.76 days

## Score

- gate: **OK** 
- score: 67.7 (rank 10), confidence 1.0 
- components: income 9.6 / freshness 35.0 / resource 15.0 / registration 8.08
