...
- subnet age: 439.2 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 293.9081623619489** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 734.7591940271593
- top_miner_usd_day: 1175.6102256923698 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 285.689 USD/day  |  payback on registration: 0.67 days
...
- components: income 22.35 / freshness 35.0 / resource 11.25 / registration 9.78
