...
- **competitive_miner_usd_day: 205.02601030159872** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 129.99059486940862
- top_miner_usd_day: 512.5888881853633 (uid 132, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 67.7136 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 76.7 (rank 3), confidence 1.0 
- components: income 16.71 / freshness 35.0 / resource 15.0 / registration 10.0
