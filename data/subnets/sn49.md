...
- registration cost: 0.05 TAO (11.842 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 11  |  free: 0
- subnet age: 314.4 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 48.89375460034136** (uid 112) <- the only figure quotable as achievable
- median_miner_usd_day: 2445.95672822807
- top_miner_usd_day: 4843.019701855799 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 40.6746 USD/day  |  payback on registration: 0.29 days
...
- components: income 14.73 / freshness 10.5 / resource 11.25 / registration 9.9
