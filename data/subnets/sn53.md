...
- subnet age: 638.2 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1906.6588272582928** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 85.04223977859507
- top_miner_usd_day: 1906.6588272582928 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 76.2325 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 50.5 (rank 27), confidence 0.85 - hardware from README keywords, not curated
