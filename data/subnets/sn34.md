...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (98.75 USD), open=True
...
- **competitive_miner_usd_day: 21.00218346312577** (uid 73) <- the only figure quotable as achievable
- median_miner_usd_day: 9.965321745258654
- top_miner_usd_day: 2826.4009857493284 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -19.7309 USD/day  |  payback on registration: [UNKNOWN] days
