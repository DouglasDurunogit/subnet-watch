...
- miner_burn: **0.15055893710814416**
- registration cost: 0.1 TAO (23.911 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 805.8 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1227.3333621647482** (uid 133) <- the only figure quotable as achievable
- median_miner_usd_day: 23.060412159858494
- top_miner_usd_day: 1227.3333621647482 (uid 133, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 14  |  gini: 0.7516476305296185  |  top1_share: 0.4471286645199689  |  top10_share: 0.9987333465594336
...
- last commit: 2026-08-30T13:19:36Z
- scoring-related commit: docs(validator): stop implying a second validator can run the scorer 2026-08-30T11:29:22Z
...
- net margin: 14.3454 USD/day  |  payback on registration: 1.67 days

## Score

- gate: **OK** 
- score: 70.2 (rank 9), confidence 1.0 
- components: income 10.79 / freshness 35.0 / resource 15.0 / registration 9.44
