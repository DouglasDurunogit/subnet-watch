...
- subnet age: 647.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2202.0899479623245** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 102.45115238373593
- top_miner_usd_day: 2202.0899479623245 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 93.4697 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 51.2 (rank 28), confidence 0.85 - hardware from README keywords, not curated
