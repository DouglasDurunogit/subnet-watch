...
- registration cost: 0.999999999 TAO (196.73999980326002 USD), open=True
...
- **competitive_miner_usd_day: 1016.0013333491363** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 2.5861712799255865
- top_miner_usd_day: 1016.0013333491363 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -5.6522 USD/day  |  payback on registration: [UNKNOWN] days
