...
- **competitive_miner_usd_day: 10.170439147685817** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.4259763104571674
- top_miner_usd_day: 2488.44520045144 (uid 102, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.5198 USD/day  |  payback on registration: [UNKNOWN] days
