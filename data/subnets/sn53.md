...
- miner_burn: **0.0**
- registration cost: 0.000582158 TAO (0.11253696298000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 43  |  free: 0
- subnet age: 629.6 days  |  registered at block 4203869
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2358.944457556585** (uid 222) <- the only figure quotable as achievable
- median_miner_usd_day: 131.6760222913679
- top_miner_usd_day: 2358.944457556585 (uid 222, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 96.6289 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 63.2 (rank 12), confidence 0.85 - hardware from README keywords, not curated
