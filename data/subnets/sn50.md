...
- registration cost: 0.8 TAO (153.616 USD), open=True
...
- **competitive_miner_usd_day: 44.799757723417514** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 10.870195021215011
- top_miner_usd_day: 44.799757723417514 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.651 USD/day  |  payback on registration: 57.95 days

## Score

- gate: **OK** 
- score: 31.8 (rank 52), confidence 0.85 - hardware requirement unknown
- components: income 5.12 / freshness 21.0 / resource 11.25 / registration 0.0
