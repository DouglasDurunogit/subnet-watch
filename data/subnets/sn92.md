...
- subnet age: 79.6 days  |  registered at block 8352006
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 127.01687408034175** (uid 6) <- the only figure quotable as achievable
- median_miner_usd_day: 127.01687408034175
- top_miner_usd_day: 3164.7230254892015 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 78.114 USD/day  |  payback on registration: 0.29 days

## Score

- gate: **OK** 
- score: 65.6 (rank 16), confidence 0.85 - income rests on 2 competitive miners (n<=2: not a distribution)
