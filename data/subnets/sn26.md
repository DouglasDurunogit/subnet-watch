...
- subnet age: 129.6 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 237.87686021264838** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 23.35934069080409
- top_miner_usd_day: 1665.2469228437405 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 18.2769 USD/day  |  payback on registration: 1.3 days

## Score

- gate: **OK** 
- score: 53.5 (rank 25), confidence 1.0 
- components: income 11.69 / freshness 21.0 / resource 11.25 / registration 9.57
