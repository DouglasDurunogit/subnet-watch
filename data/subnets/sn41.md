...
- registration cost: 0.11487701 TAO (26.6009204356 USD), open=True
...
- **competitive_miner_usd_day: 25.68203702333362** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 10.929076117575576
- top_miner_usd_day: 2513.635832923623 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.8653 USD/day  |  payback on registration: 2.7 days

## Score

- gate: **OK** 
- score: 54.5 (rank 26), confidence 1.0 
- components: income 9.42 / freshness 21.0 / resource 15.0 / registration 9.1
