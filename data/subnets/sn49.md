...
- **competitive_miner_usd_day: 41.67580997178931** (uid 130) <- the only figure quotable as achievable
- median_miner_usd_day: 2084.8721608330084
- top_miner_usd_day: 4128.068511694227 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 33.4566 USD/day  |  payback on registration: 0.3 days
...
- components: income 13.98 / freshness 21.0 / resource 11.25 / registration 9.9
