...
- miner_burn: **0.15056450571864843**
...
- **competitive_miner_usd_day: 110.3799284717718** (uid 125) <- the only figure quotable as achievable
- median_miner_usd_day: 10.341054732253024
- top_miner_usd_day: 1103.723940056645 (uid 42, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.709 USD/day  |  payback on registration: 33.34 days

## Score

- gate: **OK** 
- score: 52.1 (rank 29), confidence 1.0 
- components: income 2.12 / freshness 35.0 / resource 15.0 / registration 0.0
