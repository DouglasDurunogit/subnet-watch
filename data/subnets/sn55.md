...
- registration cost: 0.001606378 TAO (0.31619944552 USD), open=True
...
- **competitive_miner_usd_day: 487.4342986919273** (uid 131) <- the only figure quotable as achievable
- median_miner_usd_day: 48.75354996259442
- top_miner_usd_day: 487.4342986919273 (uid 131, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 56.7771 USD/day  |  payback on registration: 0.01 days
