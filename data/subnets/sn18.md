...
- subnet age: 1027.4 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 926.2600222363543** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 3.988153119596299
- top_miner_usd_day: 926.2600222363543 (uid 141, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.231 USD/day  |  payback on registration: [UNKNOWN] days
