...
- miner_burn: **0.0**
- registration cost: 0.005705302 TAO (1.25813319704 USD), open=True
...
- **competitive_miner_usd_day: 11.005444350333688** (uid 71) <- the only figure quotable as achievable
- median_miner_usd_day: 8.667177137089986
- top_miner_usd_day: 11.005444350333688 (uid 71, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 0.3856 USD/day  |  payback on registration: 3.26 days

## Score

- gate: **OK** 
- score: 18.2 (rank 73), confidence 0.85 - hardware requirement unknown
- components: income 1.29 / freshness 0.0 / resource 11.25 / registration 8.91
