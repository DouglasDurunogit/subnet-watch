...
- registration cost: 0.1 TAO (19.716 USD), open=True
...
- **competitive_miner_usd_day: 11.30821486085263** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.280257317620489
- top_miner_usd_day: 2468.029527346993 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4744 USD/day  |  payback on registration: [UNKNOWN] days
