...
- subnet age: 130.0 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 25.47570050345197** (uid 141) <- the only figure quotable as achievable
- median_miner_usd_day: 23.352725461497638
- top_miner_usd_day: 1664.7753346087688 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.9019 USD/day  |  payback on registration: 1.97 days

## Score

- gate: **OK** 
- score: 51.7 (rank 30), confidence 1.0 
- components: income 10.1 / freshness 21.0 / resource 11.25 / registration 9.34
