...
- registration cost: 0.1 TAO (18.714 USD), open=True
...
- **competitive_miner_usd_day: 58.027120015035024** (uid 123) <- the only figure quotable as achievable
- median_miner_usd_day: 3.218619969138235
- top_miner_usd_day: 2424.494462181285 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 57.0408 USD/day  |  payback on registration: 0.33 days
