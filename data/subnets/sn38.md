...
- subnet age: 216.6 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3164.880132906809** (uid 131) <- the only figure quotable as achievable
- median_miner_usd_day: 151.93617052275113
- top_miner_usd_day: 3164.880132906809 (uid 131, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 150.9499 USD/day  |  payback on registration: 0.96 days
