...
- subnet age: 662.7 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 4142.32653754581** (uid 0) <- the only figure quotable as achievable
- median_miner_usd_day: 14.402689761033296
- top_miner_usd_day: 23145.96966302527 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 42  |  gini: 0.9069420670657029  |  top1_share: 0.6255056094024268  |  top10_share: 0.9734869877127375
...
- net margin: 5.9011 USD/day  |  payback on registration: 16.34 days

## Score

- gate: **OK** 
- score: 49.7 (rank 23), confidence 0.85 - hardware requirement unknown
- components: income 7.63 / freshness 35.0 / resource 11.25 / registration 4.55
