...
- miner_burn: **0.20002200501039624**
- registration cost: 0.2 TAO (38.804 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 30  |  free: 0
- subnet age: 168.9 days  |  registered at block 7525773
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 521.3013680921265** (uid 195) <- the only figure quotable as achievable
- median_miner_usd_day: 39.06649870666533
- top_miner_usd_day: 781.9769352583852 (uid 142, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.9703 USD/day  |  payback on registration: [UNKNOWN] days
