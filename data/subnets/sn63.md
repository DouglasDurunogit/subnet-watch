...
- **competitive_miner_usd_day: 5862.147527570026** (uid 87) <- the only figure quotable as achievable
- median_miner_usd_day: 0.08946155825186604
- top_miner_usd_day: 5862.147527570026 (uid 87, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -8.1297 USD/day  |  payback on registration: [UNKNOWN] days
