...
- miner_burn: **0.0**
- registration cost: 1.209557799 TAO (232.98502324338 USD), open=True
- tempo: 360.0  |  max_uids: 90  |  active: 28  |  free: 0
- subnet age: 179.6 days  |  registered at block 7457580
- weights_version: 13  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 27918.211324836262** (uid 65) <- the only figure quotable as achievable
- median_miner_usd_day: 94.09992241450328
- top_miner_usd_day: 27918.211324836262 (uid 65, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.9012178000244171  |  top1_share: 0.8964717372726163  |  top10_share: 0.9875167867171286
...
- net margin: 93.1136 USD/day  |  payback on registration: 2.5 days

## Score

- gate: **OK** 
- score: 77.1 (rank 2), confidence 1.0 
- components: income 17.95 / freshness 35.0 / resource 15.0 / registration 9.17
...
_(truncated at 6000 of 35651 chars - read the full file at https://github.com/minos-protocol/minos_subnet)_
