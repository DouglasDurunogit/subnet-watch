...
- registration cost: 0.999999999 TAO (190.53999980946 USD), open=True
...
- **competitive_miner_usd_day: 1601.2945175722705** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 4.020370731094149
- top_miner_usd_day: 1601.2945175722705 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.2754 USD/day  |  payback on registration: [UNKNOWN] days
