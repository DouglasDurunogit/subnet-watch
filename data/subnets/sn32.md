...
- miner_burn: **0.0**
- registration cost: 0.0007108 TAO (0.136445168 USD), open=True
...
- **competitive_miner_usd_day: 10.187020561397594** (uid 70) <- the only figure quotable as achievable
- median_miner_usd_day: 8.090520473485658
- top_miner_usd_day: 10.187020561397594 (uid 70, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.3116 USD/day  |  payback on registration: [UNKNOWN] days
