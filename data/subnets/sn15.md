...
- miner_burn: **0.0**
- registration cost: 0.356044888 TAO (70.674910268 USD), open=True
...
- **competitive_miner_usd_day: 15389.53946845748** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 16.996966910571533
- top_miner_usd_day: 15389.53946845748 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.0107 USD/day  |  payback on registration: 4.41 days

## Score

- gate: **OK** 
- score: 69.7 (rank 7), confidence 1.0 
- components: income 11.19 / freshness 35.0 / resource 15.0 / registration 8.53
