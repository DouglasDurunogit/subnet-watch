...
- miner_burn: **0.45123421191237867**
...
- **competitive_miner_usd_day: 35.14096816457282** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.602368559853794
- top_miner_usd_day: 865.2402744334576 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.6161 USD/day  |  payback on registration: 2.57 days
