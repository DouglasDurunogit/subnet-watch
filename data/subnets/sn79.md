...
- miner_burn: **0.0**
- registration cost: 0.075664272 TAO (16.655219552640002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 227  |  free: 0
- subnet age: 541.9 days  |  registered at block 5173967
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 194.93510510273208** (uid 165) <- the only figure quotable as achievable
- median_miner_usd_day: 2.855822808295799
- top_miner_usd_day: 194.93510510273208 (uid 165, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 226  |  gini: 0.7402620644242164  |  top1_share: 0.08868576319892392  |  top10_share: 0.4694445293632111
...
- latest release: (none) 
- last commit: 2026-09-15T15:29:48Z
...
- net margin: 1.8695 USD/day  |  payback on registration: 8.91 days

## Score

- gate: **OK** 
- score: 47.2 (rank 39), confidence 1.0 
- components: income 4.16 / freshness 21.0 / resource 15.0 / registration 7.03
