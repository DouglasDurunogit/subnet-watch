...
- **competitive_miner_usd_day: 25.529593981202908** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.35285035411878
- top_miner_usd_day: 872.8520905147385 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.3665 USD/day  |  payback on registration: 3.51 days

## Score

- gate: **OK** 
- score: 31.1 (rank 30), confidence 1.0 
- components: income 7.31 / freshness 0.0 / resource 15.0 / registration 8.83
