...
- miner_burn: **0.0**
- registration cost: 0.042025389 TAO (8.28698645691 USD), open=True
...
- **competitive_miner_usd_day: 383.2156644150803** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 21.371747936998485
- top_miner_usd_day: 383.2156644150803 (uid 186, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 20.3854 USD/day  |  payback on registration: 0.41 days

## Score

- gate: **OK** 
- score: 72.0 (rank 2), confidence 1.0 
- components: income 12.1 / freshness 35.0 / resource 15.0 / registration 9.86
