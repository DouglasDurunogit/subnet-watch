...
- **competitive_miner_usd_day: 36.28926397085634** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.91289012855504
- top_miner_usd_day: 2236.4745212340467 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.9028 USD/day  |  payback on registration: 1.75 days

## Score

- gate: **OK** 
- score: 69.5 (rank 7), confidence 1.0 
- components: income 10.1 / freshness 35.0 / resource 15.0 / registration 9.42
