...
- miner_burn: **0.0**
- registration cost: 0.465088978 TAO (110.7376856618 USD), open=True
...
- **competitive_miner_usd_day: 47.28414209357416** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.07495936805966
- top_miner_usd_day: 25591.275368626655 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.0887 USD/day  |  payback on registration: 4.09 days

## Score

- gate: **OK** 
- score: 71.8 (rank 6), confidence 1.0 
- components: income 13.17 / freshness 35.0 / resource 15.0 / registration 8.64
