...
- **competitive_miner_usd_day: 32.08755910575253** (uid 69) <- the only figure quotable as achievable
- median_miner_usd_day: 1838.1347014304079
- top_miner_usd_day: 3644.1818437550633 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 23.8684 USD/day  |  payback on registration: 0.41 days
