...
- miner_burn: **0.45060222200118005**
- registration cost: 0.1 TAO (20.543000000000003 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 150  |  free: 0
- subnet age: 784.3 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 23.935605659762693** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 5.983901414940673
- top_miner_usd_day: 915.5679211564667 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 4.9976 USD/day  |  payback on registration: 4.11 days

## Score

- gate: **OK** 
- score: 65.7 (rank 14), confidence 1.0 
- components: income 7.08 / freshness 35.0 / resource 15.0 / registration 8.63
