...
- miner_burn: **0.0**
- registration cost: 0.000521625 TAO (0.104012025 USD), open=True
...
- **competitive_miner_usd_day: 2467.3902986049975** (uid 15) <- the only figure quotable as achievable
- median_miner_usd_day: 2467.3902986049975
- top_miner_usd_day: 2467.3902986049975 (uid 15, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2459.1711 USD/day  |  payback on registration: 0.0 days
...
- components: income 30.84 / freshness 0.0 / resource 11.25 / registration 10.0
