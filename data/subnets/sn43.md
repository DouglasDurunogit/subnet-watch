...
- registration cost: 0.1 TAO (19.767 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 23  |  free: 0
- subnet age: 756.0 days  |  registered at block 3408582
- weights_version: 130  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 11.337409913842679** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.286144385918895
- top_miner_usd_day: 2474.44803370601 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4731 USD/day  |  payback on registration: [UNKNOWN] days
