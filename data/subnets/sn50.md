...
- miner_burn: **0.0**
- registration cost: 0.8 TAO (181.12 USD), open=True
...
- **competitive_miner_usd_day: 119.55034218933805** (uid 151) <- the only figure quotable as achievable
- median_miner_usd_day: 7.530321293420512
- top_miner_usd_day: 119.55034218933805 (uid 151, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.6889 USD/day  |  payback on registration: [UNKNOWN] days
