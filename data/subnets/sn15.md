...
- miner_burn: **0.0**
- registration cost: 0.465316962 TAO (108.57240674346001 USD), open=True
...
- **competitive_miner_usd_day: 41.0556095137913** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 24.342706525876267
- top_miner_usd_day: 21726.77388428956 (uid 249, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 91  |  gini: 0.9274111800337579  |  top1_share: 0.913130449388447  |  top10_share: 0.9281100642856053
...
- net margin: 23.1747 USD/day  |  payback on registration: 4.68 days

## Score

- gate: **OK** 
- score: 71.0 (rank 9), confidence 1.0 
- components: income 12.58 / freshness 35.0 / resource 15.0 / registration 8.44
