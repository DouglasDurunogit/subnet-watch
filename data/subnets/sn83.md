...
- miner_burn: **0.0**
- registration cost: 0.150714077 TAO (35.03047291711 USD), open=True
...
- **competitive_miner_usd_day: 311.4457898225399** (uid 2) <- the only figure quotable as achievable
- median_miner_usd_day: 25.935460927584213
- top_miner_usd_day: 311.4457898225399 (uid 2, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 22.8373 USD/day  |  payback on registration: 1.53 days

## Score

- gate: **OK** 
- score: 28.3 (rank 61), confidence 0.85 - hardware requirement unknown
- components: income 12.53 / freshness 0.0 / resource 11.25 / registration 9.49
