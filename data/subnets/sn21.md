...
- miner_burn: **0.4507755043450743**
- registration cost: 0.1 TAO (19.504 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 134  |  free: 0
- subnet age: 776.0 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.901124932716247** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.196460486729158
- top_miner_usd_day: 851.3936708765863 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.2102 USD/day  |  payback on registration: 3.74 days

## Score

- gate: **OK** 
- score: 31.0 (rank 51), confidence 1.0 
- components: income 7.21 / freshness 0.0 / resource 15.0 / registration 8.75
