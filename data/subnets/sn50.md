...
- registration cost: 0.8 TAO (157.728 USD), open=True
...
- **competitive_miner_usd_day: 36.70302396860318** (uid 228) <- the only figure quotable as achievable
- median_miner_usd_day: 10.915397462781616
- top_miner_usd_day: 36.70302396860318 (uid 228, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 2.6962 USD/day  |  payback on registration: 58.5 days

## Score

- gate: **OK** 
- score: 31.8 (rank 49), confidence 0.85 - hardware requirement unknown
- components: income 5.16 / freshness 21.0 / resource 11.25 / registration 0.0
