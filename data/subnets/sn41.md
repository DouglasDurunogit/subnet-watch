...
- **competitive_miner_usd_day: 25.37419800337794** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 12.43233797755867
- top_miner_usd_day: 2455.539607182316 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 11.2422 USD/day  |  payback on registration: 2.04 days

## Score

- gate: **OK** 
- score: 55.2 (rank 23), confidence 1.0 
- components: income 9.89 / freshness 21.0 / resource 15.0 / registration 9.32
