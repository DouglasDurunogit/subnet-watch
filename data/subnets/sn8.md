...
- **competitive_miner_usd_day: 2893.545158792361** (uid 210) <- the only figure quotable as achievable
- median_miner_usd_day: 0.513495147966701
- top_miner_usd_day: 11025.767817141006 (uid 117, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.7057 USD/day  |  payback on registration: [UNKNOWN] days
