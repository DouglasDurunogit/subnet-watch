...
- miner_burn: **0.0**
- registration cost: 0.566156568 TAO (136.80041152584 USD), open=True
...
- **competitive_miner_usd_day: 47.22435887401476** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 28.039463081446268
- top_miner_usd_day: 25558.919302376366 (uid 136, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 27.0532 USD/day  |  payback on registration: 5.06 days

## Score

- gate: **OK** 
- score: 71.5 (rank 6), confidence 1.0 
- components: income 13.17 / freshness 35.0 / resource 15.0 / registration 8.31
