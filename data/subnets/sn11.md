...
- miner_burn: **0.0**
- registration cost: 0.02 TAO (4.1 USD), open=True
...
- **competitive_miner_usd_day: 4578.065179844245** (uid 139) <- the only figure quotable as achievable
- median_miner_usd_day: 4578.065179844245
- top_miner_usd_day: 4578.065179844245 (uid 139, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4577.0789 USD/day  |  payback on registration: 0.0 days
