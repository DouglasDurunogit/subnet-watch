...
- **competitive_miner_usd_day: 303.47059810699085** (uid 182) <- the only figure quotable as achievable
- median_miner_usd_day: 21.014257302724417
- top_miner_usd_day: 2048.194762325467 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 12.4088 USD/day  |  payback on registration: 1.65 days

## Score

- gate: **OK** 
- score: 66.0 (rank 11), confidence 1.0 
- components: income 10.25 / freshness 35.0 / resource 11.25 / registration 9.45
