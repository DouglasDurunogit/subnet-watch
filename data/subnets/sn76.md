...
- subnet age: 176.7 days  |  registered at block 7574784
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 192.85160562129167** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 97.93262536159351
- top_miner_usd_day: 482.11817360322243 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 40.0773 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 74.7 (rank 2), confidence 1.0 
- components: income 14.68 / freshness 35.0 / resource 15.0 / registration 10.0
