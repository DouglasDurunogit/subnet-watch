...
- subnet age: 724.8 days  |  registered at block 3856677
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 26.627139315059114** (uid 230) <- the only figure quotable as achievable
- median_miner_usd_day: 297.0387279079308
- top_miner_usd_day: 915.4702745607367 (uid 206, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 6  |  gini: 0.39802790536794275  |  top1_share: 0.3441729868306603  |  top10_share: 1.0
...
- net margin: 18.408 USD/day  |  payback on registration: 0.01 days
...
- components: income 11.71 / freshness 0.0 / resource 11.25 / registration 10.0
