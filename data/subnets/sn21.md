...
- miner_burn: **0.4507718759123236**
- registration cost: 0.1 TAO (18.994 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 134  |  free: 0
- subnet age: 778.4 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 24.163398459026272** (uid 204) <- the only figure quotable as achievable
- median_miner_usd_day: 6.012882718391954
- top_miner_usd_day: 826.1700855070545 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 5.0266 USD/day  |  payback on registration: 3.78 days

## Score

- gate: **OK** 
- score: 30.8 (rank 51), confidence 1.0 
- components: income 7.09 / freshness 0.0 / resource 15.0 / registration 8.74
