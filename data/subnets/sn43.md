...
- registration cost: 0.1 TAO (20.608000000000004 USD), open=True
...
- **competitive_miner_usd_day: 24.824813682582832** (uid 108) <- the only figure quotable as achievable
- median_miner_usd_day: 2.5423001964090854
- top_miner_usd_day: 2584.8712624430723 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.4593 USD/day  |  payback on registration: 44.87 days
