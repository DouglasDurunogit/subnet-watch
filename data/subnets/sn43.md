...
- **competitive_miner_usd_day: 186.0115884220094** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 13.264422370825862
- top_miner_usd_day: 2758.896628054964 (uid 20, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.2637 USD/day  |  payback on registration: [UNKNOWN] days
