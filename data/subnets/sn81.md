...
- **competitive_miner_usd_day: 665.501420308844** (uid 24) <- the only figure quotable as achievable
- median_miner_usd_day: 91.41854284742045
- top_miner_usd_day: 665.501420308844 (uid 24, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 88.5268 USD/day  |  payback on registration: 0.0 days
