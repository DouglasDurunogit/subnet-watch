...
- registration cost: 0.1 TAO (19.711000000000002 USD), open=True
...
- **competitive_miner_usd_day: 11.30234160975787** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.279072999498501
- top_miner_usd_day: 2466.7476842531223 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4747 USD/day  |  payback on registration: [UNKNOWN] days
