...
- miner_burn: **0.0**
- registration cost: 0.230734217 TAO (47.54970743936 USD), open=True
...
- **competitive_miner_usd_day: 20.861317595330487** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 11.396460538189803
- top_miner_usd_day: 11856.954808071912 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.4102 USD/day  |  payback on registration: 4.57 days

## Score

- gate: **OK** 
- score: 68.1 (rank 11), confidence 1.0 
- components: income 9.62 / freshness 35.0 / resource 15.0 / registration 8.48
