...
- subnet age: 167.5 days  |  registered at block 7525773
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 522.81259429061** (uid 195) <- the only figure quotable as achievable
- median_miner_usd_day: 39.179750502924
- top_miner_usd_day: 784.2438466910127 (uid 142, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -7.9696 USD/day  |  payback on registration: [UNKNOWN] days
