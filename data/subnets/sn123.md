...
- **competitive_miner_usd_day: 75.490742464716** (uid 213) <- the only figure quotable as achievable
- median_miner_usd_day: 2.165718021528738
- top_miner_usd_day: 622.237142883881 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -6.1108 USD/day  |  payback on registration: [UNKNOWN] days
