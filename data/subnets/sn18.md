...
- **competitive_miner_usd_day: 1400.7684137703332** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 3.7581793045904917
- top_miner_usd_day: 1400.7684137703332 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.5436 USD/day  |  payback on registration: [UNKNOWN] days
