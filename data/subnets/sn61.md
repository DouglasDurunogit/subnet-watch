...
- miner_burn: **0.0**
- registration cost: 0.002975539 TAO (0.64938163136 USD), open=True
...
- **competitive_miner_usd_day: 276.1018072298834** (uid 184) <- the only figure quotable as achievable
- median_miner_usd_day: 29.48521114015344
- top_miner_usd_day: 276.1018072298834 (uid 184, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 21.266 USD/day  |  payback on registration: 0.03 days
