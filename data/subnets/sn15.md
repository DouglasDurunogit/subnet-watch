...
- miner_burn: **0.0**
- registration cost: 0.539294198 TAO (128.69177446874 USD), open=True
...
- **competitive_miner_usd_day: 46.71392406818456** (uid 249) <- the only figure quotable as achievable
- median_miner_usd_day: 28.02835444091074
- top_miner_usd_day: 25749.5642904573 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 26.8297 USD/day  |  payback on registration: 4.8 days

## Score

- gate: **OK** 
- score: 71.5 (rank 7), confidence 1.0 
- components: income 13.14 / freshness 35.0 / resource 15.0 / registration 8.4
