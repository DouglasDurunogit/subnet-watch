...
- miner_burn: **0.709262014599517**
- registration cost: 0.002098603 TAO (0.54460846453 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 84  |  free: 0
- subnet age: 552.4 days  |  registered at block 5048438
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 30.26697181120099** (uid 12) <- the only figure quotable as achievable
- median_miner_usd_day: 15.103870473299907
- top_miner_usd_day: 2753.109817527267 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 78  |  gini: 0.7626554195795299  |  top1_share: 0.7096010869731157  |  top10_share: 0.7661328488771507
- owner_incentive_share: 0.7096010869731157 (independent check on miner_burn; disagreement 0.0003)
...
- status: **ok** 
- README: 13019 bytes, sha f7dc370a889aae50
- latest release: v2-cutover-legacy-final-certfix-20260720 2026-07-20T19:10:50Z
- last commit: 2026-09-08T22:20:17Z
- scoring-related commit: Merge remote-tracking branch 'origin/main' into codex/arena-miner-rep… 2026-09-08T20:17:47Z
...
- net margin: 6.8847 USD/day  |  payback on registration: 0.08 days

## Score

- gate: **OK** 
- score: 54.7 (rank 27), confidence 0.85 - hardware requirement unknown
- components: income 8.16 / freshness 35.0 / resource 11.25 / registration 9.97
...
Submit the local source directory. No Dockerfile, public
```

_(truncated at 6000 of 13019 chars - read the full file at https://github.com/leadpoet/leadpoet)_
