...
- **competitive_miner_usd_day: 8.906836724029185** (uid 39) <- the only figure quotable as achievable
- median_miner_usd_day: 7.897687735592381
- top_miner_usd_day: 2739.2252390042663 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.497 USD/day  |  payback on registration: [UNKNOWN] days
