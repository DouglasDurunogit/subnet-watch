...
- subnet age: 215.2 days  |  registered at block 7312241
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 637.1375264465985** (uid 144) <- the only figure quotable as achievable
- median_miner_usd_day: 0.09725805624280236
- top_miner_usd_day: 4141.1507767622825 (uid 125, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1219 USD/day  |  payback on registration: [UNKNOWN] days
