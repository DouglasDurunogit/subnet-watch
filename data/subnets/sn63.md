...
- miner_burn: **0.0**
- registration cost: 0.000500944 TAO (0.105699184 USD), open=True
...
- **competitive_miner_usd_day: 0.078398109753853** (uid 88) <- the only figure quotable as achievable
- median_miner_usd_day: 0.078398109753853
- top_miner_usd_day: 5136.644151072449 (uid 87, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -8.1408 USD/day  |  payback on registration: [UNKNOWN] days
