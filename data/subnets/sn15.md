...
- miner_burn: **0.0**
- registration cost: 0.206559946 TAO (41.80360187148 USD), open=True
...
- **competitive_miner_usd_day: 20.705231764199077** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 11.311191426738382
- top_miner_usd_day: 11751.177601727615 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 75  |  gini: 0.9430753492633024  |  top1_share: 0.9358729674020917  |  top10_share: 0.9501641346667684
...
- net margin: 10.229 USD/day  |  payback on registration: 4.09 days

## Score

- gate: **OK** 
- score: 68.2 (rank 11), confidence 1.0 
- components: income 9.55 / freshness 35.0 / resource 15.0 / registration 8.64
