...
- registration cost: 0.1 TAO (19.231 USD), open=True
...
- **competitive_miner_usd_day: 23.105083519695107** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.7686622697354538
- top_miner_usd_day: 2382.5817436141174 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8054 USD/day  |  payback on registration: [UNKNOWN] days
