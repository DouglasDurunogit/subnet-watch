...
- miner_burn: **0.0**
- registration cost: 0.000829745 TAO (0.16408207375 USD), open=True
...
- **competitive_miner_usd_day: 758.7716325127743** (uid 75) <- the only figure quotable as achievable
- median_miner_usd_day: 24.991443664414536
- top_miner_usd_day: 758.7716325127743 (uid 75, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 16.7723 USD/day  |  payback on registration: 0.01 days
