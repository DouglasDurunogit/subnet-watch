...
- subnet age: 322.7 days  |  registered at block 6783158
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 51.126816585109296** (uid 218) <- the only figure quotable as achievable
- median_miner_usd_day: 2557.6677848004215
- top_miner_usd_day: 5064.208753015734 (uid 213, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 42.9076 USD/day  |  payback on registration: 0.29 days
...
- components: income 14.94 / freshness 35.0 / resource 11.25 / registration 9.9
