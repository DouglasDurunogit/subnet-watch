...
- registration cost: 0.1 TAO (20.651 USD), open=True
...
- **competitive_miner_usd_day: 24.9566038817571** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8254129688518884
- top_miner_usd_day: 2555.6242126775974 (uid 177, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.8164 USD/day  |  payback on registration: [UNKNOWN] days
