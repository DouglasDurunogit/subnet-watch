...
- **competitive_miner_usd_day: 1622.7459865909932** (uid 53) <- the only figure quotable as achievable
- median_miner_usd_day: 16.208721459598262
- top_miner_usd_day: 3724.633022571498 (uid 3, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.0526 USD/day  |  payback on registration: 3.43 days

## Score

- gate: **OK** 
- score: 53.8 (rank 28), confidence 0.85 - hardware requirement unknown
- components: income 8.24 / freshness 35.0 / resource 11.25 / registration 8.86
