...
- registration cost: 0.1 TAO (19.873 USD), open=True
...
- **competitive_miner_usd_day: 11.301440621817504** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.297803279954596
- top_miner_usd_day: 2492.5538314168703 (uid 155, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.5174 USD/day  |  payback on registration: [UNKNOWN] days
