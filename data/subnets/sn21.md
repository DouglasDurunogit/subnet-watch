...
- miner_burn: **0.30096157849766314**
- registration cost: 0.1 TAO (20.518 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 28  |  free: 0
- subnet age: 795.5 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 383.05611445719535** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 7.166015746648213
- top_miner_usd_day: 766.2711206160903 (uid 154, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 1.3971 USD/day  |  payback on registration: 14.69 days

## Score

- gate: **OK** 
- score: 58.6 (rank 20), confidence 1.0 
- components: income 3.45 / freshness 35.0 / resource 15.0 / registration 5.1
