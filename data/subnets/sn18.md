...
- subnet age: 1014.3 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1397.8508126402453** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.876173140302971
- top_miner_usd_day: 1397.8508126402453 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.4301 USD/day  |  payback on registration: [UNKNOWN] days
