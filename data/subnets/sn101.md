...
- registration cost: 0.001834345 TAO (0.3528179173 USD), open=True
...
- **competitive_miner_usd_day: 2.0258059736003777** (uid 29) <- the only figure quotable as achievable
- median_miner_usd_day: 0.8508385089121585
- top_miner_usd_day: 2394.097499600926 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.1355 USD/day  |  payback on registration: [UNKNOWN] days
