...
- subnet age: 450.3 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 246.58015039819043** (uid 43) <- the only figure quotable as achievable
- median_miner_usd_day: 616.4409695656905
- top_miner_usd_day: 986.3017887331906 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 238.361 USD/day  |  payback on registration: 0.79 days
...
- components: income 21.64 / freshness 21.0 / resource 11.25 / registration 9.74
