...
- miner_burn: **0.0**
- registration cost: 0.153342245 TAO (29.386507831799996 USD), open=True
- tempo: 360.0  |  max_uids: 64  |  active: 7  |  free: 0
- subnet age: 530.2 days  |  registered at block 4972413
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 7915.1845872706435** (uid 42) <- the only figure quotable as achievable
- median_miner_usd_day: 7915.1845872706435
- top_miner_usd_day: 7915.1845872706435 (uid 42, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 7906.9654 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 34.0 (rank 47), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
