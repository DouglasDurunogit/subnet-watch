...
- **competitive_miner_usd_day: 19.240919349803356** (uid 247) <- the only figure quotable as achievable
- median_miner_usd_day: 9.779914807634853
- top_miner_usd_day: 2803.965357402006 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -20.128 USD/day  |  payback on registration: [UNKNOWN] days
