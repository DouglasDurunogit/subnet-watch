...
- miner_burn: **0.20000000181607902**
- registration cost: 0.05 TAO (10.0945 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 63  |  free: 0
- subnet age: 486.4 days  |  registered at block 5313364
- weights_version: 0  |  mechanisms: 2

## Income (miner side)

- **competitive_miner_usd_day: 265.87215576825105** (uid 191) <- the only figure quotable as achievable
- median_miner_usd_day: 0.04522404418578859
- top_miner_usd_day: 265.87215576825105 (uid 191, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 55  |  gini: 0.803289228941217  |  top1_share: 0.17953337812251877  |  top10_share: 0.8242380748793746
...
- net margin: -8.174 USD/day  |  payback on registration: [UNKNOWN] days
