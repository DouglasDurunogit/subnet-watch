...
- **competitive_miner_usd_day: 35.076483589551216** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.586582993612037
- top_miner_usd_day: 863.6525364085086 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 7.6003 USD/day  |  payback on registration: 2.6 days

## Score

- gate: **OK** 
- score: 67.6 (rank 13), confidence 1.0 
- components: income 8.5 / freshness 35.0 / resource 15.0 / registration 9.13
