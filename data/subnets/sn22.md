...
- miner_burn: **0.5146083205472678**
- registration cost: 0.0005 TAO (0.11811 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 137  |  free: 0
- subnet age: 964.4 days  |  registered at block 2009702
- weights_version: 1000910  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 90.95263209840657** (uid 66) <- the only figure quotable as achievable
- median_miner_usd_day: 8.459919832836473
- top_miner_usd_day: 1145.792515833643 (uid 19, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 128  |  gini: 0.720137984595292  |  top1_share: 0.5151297600317716  |  top10_share: 0.6470282737867933
- owner_incentive_share: 0.5151297600317717 (independent check on miner_burn; disagreement 0.0005)
...
- net margin: 0.2407 USD/day  |  payback on registration: 0.49 days

## Score

- gate: **OK** 
- score: 18.6 (rank 80), confidence 0.85 - hardware requirement unknown
- components: income 0.85 / freshness 0.0 / resource 11.25 / registration 9.84
