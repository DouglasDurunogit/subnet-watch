...
- registration cost: 0.105545685 TAO (24.58053457965 USD), open=True
...
- **competitive_miner_usd_day: 25.8291181703531** (uid 60) <- the only figure quotable as achievable
- median_miner_usd_day: 10.991666987987285
- top_miner_usd_day: 2528.0314371803947 (uid 210, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 9.9274 USD/day  |  payback on registration: 2.48 days

## Score

- gate: **OK** 
- score: 54.6 (rank 25), confidence 1.0 
- components: income 9.45 / freshness 21.0 / resource 15.0 / registration 9.17
