...
- miner_burn: **0.0**
- registration cost: 0.243031283 TAO (50.19568119082 USD), open=True
...
- **competitive_miner_usd_day: 20.903067109460782** (uid 156) <- the only figure quotable as achievable
- median_miner_usd_day: 11.419268143131355
- top_miner_usd_day: 11880.683994880932 (uid 94, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 10.433 USD/day  |  payback on registration: 4.81 days

## Score

- gate: **OK** 
- score: 68.0 (rank 12), confidence 1.0 
- components: income 9.62 / freshness 35.0 / resource 15.0 / registration 8.4
