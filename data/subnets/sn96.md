...
- miner_burn: **0.4036997191142291**
- registration cost: 0.1 TAO (23.754 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 88  |  free: 0
- subnet age: 182.4 days  |  registered at block 7692872
- weights_version: 1000  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 490.41689678604655** (uid 211) <- the only figure quotable as achievable
- median_miner_usd_day: 35.21999083592207
- top_miner_usd_day: 2272.6343355003764 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 81  |  gini: 0.6627837849350975  |  top1_share: 0.40392073040398185  |  top10_share: 0.6327368774619073
- owner_incentive_share: 0.4039207304039818 (independent check on miner_burn; disagreement 0.0002)
...
- net margin: 26.9579 USD/day  |  payback on registration: 0.88 days

## Score

- gate: **OK** 
- score: 69.1 (rank 9), confidence 1.0 
- components: income 13.16 / freshness 35.0 / resource 11.25 / registration 9.71
