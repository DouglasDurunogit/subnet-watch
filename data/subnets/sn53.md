...
- miner_burn: **0.0**
- registration cost: 0.000576617 TAO ([UNKNOWN] USD), open=True
...
- **competitive_miner_usd_day: [UNKNOWN]** (uid 157) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 157, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 9.6 (rank 49), confidence 0.85 - hardware requirement unknown
