...
- subnet age: 191.2 days  |  registered at block 7457580
- weights_version: 20  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 30446.70209012563** (uid 72) <- the only figure quotable as achievable
- median_miner_usd_day: 106.50580975336445
- top_miner_usd_day: 30446.70209012563 (uid 72, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 20  |  gini: 0.902182406446493  |  top1_share: 0.8987393931994384  |  top10_share: 0.9881264880043953
...
- net margin: 105.5195 USD/day  |  payback on registration: 1.87 days

## Score

- gate: **OK** 
- score: 77.8 (rank 1), confidence 1.0 
- components: income 18.44 / freshness 35.0 / resource 15.0 / registration 9.38
