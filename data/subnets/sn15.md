...
- miner_burn: **0.0**
- registration cost: 0.472208619 TAO (115.47861777645001 USD), open=True
...
- **competitive_miner_usd_day: 44.68503355218628** (uid 50) <- the only figure quotable as achievable
- median_miner_usd_day: 27.014133920185344
- top_miner_usd_day: 24550.769888726638 (uid 129, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 25.8247 USD/day  |  payback on registration: 4.47 days

## Score

- gate: **OK** 
- score: 71.5 (rank 8), confidence 1.0 
- components: income 12.99 / freshness 35.0 / resource 15.0 / registration 8.51
