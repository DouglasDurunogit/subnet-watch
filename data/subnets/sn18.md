...
- subnet age: 1016.0 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1084.830041302437** (uid 245) <- the only figure quotable as achievable
- median_miner_usd_day: 4.438025571640795
- top_miner_usd_day: 1084.830041302437 (uid 245, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -3.8044 USD/day  |  payback on registration: [UNKNOWN] days
