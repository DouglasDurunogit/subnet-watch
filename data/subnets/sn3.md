...
- subnet age: 659.3 days  |  registered at block 4165565
- weights_version: 2000  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 3876.475312551012** (uid 110) <- the only figure quotable as achievable
- median_miner_usd_day: 3876.475312551012
- top_miner_usd_day: 3876.475312551012 (uid 110, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 3868.2561 USD/day  |  payback on registration: 0.0 days

## Score

- gate: **OK** 
- score: 45.8 (rank 36), confidence 0.85 - hardware requirement unknown
- components: income 32.63 / freshness 0.0 / resource 11.25 / registration 10.0
