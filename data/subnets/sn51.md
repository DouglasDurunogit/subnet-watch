...
- miner_burn: **0.0**
- registration cost: 0.5 TAO (131.365 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 79  |  free: 0
- subnet age: 713.6 days  |  registered at block 3966206
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 2046.2551923654676** (uid 201) <- the only figure quotable as achievable
- median_miner_usd_day: 37.68613345819926
- top_miner_usd_day: 54836.379814122476 (uid 47, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 69  |  gini: 0.9356829570191545  |  top1_share: 0.8219792970777734  |  top10_share: 0.9368530336804177
...
- status: **ok** 
- README: 10144 bytes, sha 7195b0fe4c9c3242
- latest release: watchtower-v1.1.0 2026-09-18T06:30:39Z
- last commit: 2026-09-18T10:18:14Z
- scoring-related commit: DAH-3519 - [P2] validator: a node whose scrape lists fewer GPUs than … 2026-09-17T07:44:39Z
...
- net margin: 28.4484 USD/day  |  payback on registration: 4.62 days

## Score

- gate: **OK** 
- score: 57.9 (rank 19), confidence 0.85 - hardware requirement unknown
- components: income 13.36 / freshness 35.0 / resource 11.25 / registration 8.46
...
- `lium_protocol/` — the validator↔backend wire protocol as one versioned package: every WebSocket message in both directions and every backend HTTP body the validator reads, as pydantic models, with a committed JSON-schema snapshot (`lium_protocol/lium_protocol/snapshots/lium_protocol.v1.json`) that CI compares with the models. Consumers pin it by tag (`lium_protocol/README.md`); `neu
```

_(truncated at 6000 of 10144 chars - read the full file at https://github.com/Datura-ai/lium-io)_
