...
- registration cost: 0.003170617 TAO (0.7271175966100001 USD), open=True
...
- **competitive_miner_usd_day: 2.4878503786367574** (uid 16) <- the only figure quotable as achievable
- median_miner_usd_day: 1.17351432954564
- top_miner_usd_day: 2771.7000246672565 (uid 0, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 0.1872 USD/day  |  payback on registration: 3.88 days

## Score

- gate: **OK** 
- score: 45.4 (rank 38), confidence 1.0 
- components: income 0.68 / freshness 21.0 / resource 15.0 / registration 8.71
