...
- **competitive_miner_usd_day: 5.444443310187824** (uid 90) <- the only figure quotable as achievable
- median_miner_usd_day: 8.184813109649028
- top_miner_usd_day: 875.030928813387 (uid 133, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -0.333 USD/day  |  payback on registration: [UNKNOWN] days
