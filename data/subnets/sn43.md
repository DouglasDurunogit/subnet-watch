...
- registration cost: 0.1 TAO (24.267 USD), open=True
...
- **competitive_miner_usd_day: 192.6038769144515** (uid 138) <- the only figure quotable as achievable
- median_miner_usd_day: 4.245453760112073
- top_miner_usd_day: 2873.419836701676 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 1.0827 USD/day  |  payback on registration: 22.41 days

## Score

- gate: **OK** 
- score: 20.4 (rank 72), confidence 1.0 
- components: income 2.9 / freshness 0.0 / resource 15.0 / registration 2.53
