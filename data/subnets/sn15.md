...
- miner_burn: **0.0**
- registration cost: 0.241293243 TAO (46.69748131779 USD), open=True
...
- **competitive_miner_usd_day: 10350.063049239043** (uid 136) <- the only figure quotable as achievable
- median_miner_usd_day: 12.376578387732447
- top_miner_usd_day: 10350.063049239043 (uid 136, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 11.3903 USD/day  |  payback on registration: 4.1 days

## Score

- gate: **OK** 
- score: 68.6 (rank 8), confidence 1.0 
- components: income 9.94 / freshness 35.0 / resource 15.0 / registration 8.63
