...
- **competitive_miner_usd_day: 95.92662425994979** (uid 57) <- the only figure quotable as achievable
- median_miner_usd_day: 21.578778934703827
- top_miner_usd_day: 95.92662425994979 (uid 57, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 9.025 USD/day  |  payback on registration: 2.19 days

## Score

- gate: **OK** 
- score: 25.2 (rank 66), confidence 0.85 - hardware requirement unknown
- components: income 9.1 / freshness 0.0 / resource 11.25 / registration 9.27
