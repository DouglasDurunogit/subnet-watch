...
- registration cost: 0.5 TAO (97.71 USD), open=True
...
- **competitive_miner_usd_day: 9.427926069511026** (uid 1) <- the only figure quotable as achievable
- median_miner_usd_day: 7.128431906215652
- top_miner_usd_day: 2392.776976519721 (uid 25, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: -1.0907 USD/day  |  payback on registration: [UNKNOWN] days
