...
- miner_burn: **0.0**
- registration cost: 0.74 TAO (196.18880000000001 USD), open=True
- tempo: 1440.0  |  max_uids: 256  |  active: 19  |  free: 0
- subnet age: 242.4 days  |  registered at block 7284230
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1417.0919705075219** (uid 128) <- the only figure quotable as achievable
- median_miner_usd_day: 149.57165250069602
- top_miner_usd_day: 3153.954629138053 (uid 168, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- latest release: (none) 
- last commit: 2026-09-07T12:36:00Z
- scoring-related commit: Update validator image to the latest version in docker-compose.valida… 2026-09-07T12:36:00Z
...
- net margin: 103.6306 USD/day  |  payback on registration: 1.89 days
