...
- miner_burn: **0.0**
- registration cost: 0.465175124 TAO (101.83613814607999 USD), open=True
...
- **competitive_miner_usd_day: 19955.559435928644** (uid 146) <- the only figure quotable as achievable
- median_miner_usd_day: 20.347745827276963
- top_miner_usd_day: 19955.559435928644 (uid 146, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 19.3614 USD/day  |  payback on registration: 5.26 days

## Score

- gate: **OK** 
- score: 70.2 (rank 4), confidence 1.0 
- components: income 11.9 / freshness 35.0 / resource 15.0 / registration 8.25
