...
- **competitive_miner_usd_day: 61.03708089791004** (uid 186) <- the only figure quotable as achievable
- median_miner_usd_day: 61.03708089791004
- top_miner_usd_day: 5984.802265018891 (uid 38, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 52.7713 USD/day  |  payback on registration: 0.21 days
...
- components: income 15.74 / freshness 21.0 / resource 11.25 / registration 9.93
