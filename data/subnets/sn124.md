...
- miner_burn: **0.0**
- registration cost: 0.593496977 TAO ([UNKNOWN] USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 35  |  free: 0
- subnet age: 454.2 days  |  registered at block 5813454
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: [UNKNOWN]** (uid 49) <- the only figure quotable as achievable
- median_miner_usd_day: [UNKNOWN]
- top_miner_usd_day: [UNKNOWN] (uid 49, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- gate: **OK** 
- score: 27.4 (rank 55), confidence 0.85 - hardware requirement unknown
