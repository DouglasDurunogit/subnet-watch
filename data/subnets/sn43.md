...
- registration cost: 0.1 TAO (19.841 USD), open=True
...
- **competitive_miner_usd_day: 11.376879629475232** (uid 3) <- the only figure quotable as achievable
- median_miner_usd_day: 2.294103299770726
- top_miner_usd_day: 2482.9688653069525 (uid 74, owner=True, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -0.4713 USD/day  |  payback on registration: [UNKNOWN] days
