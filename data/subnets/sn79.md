...
- miner_burn: **0.0**
- registration cost: 0.14078557 TAO (27.7755851053 USD), open=True
...
- **competitive_miner_usd_day: 421.1871352185753** (uid 92) <- the only figure quotable as achievable
- median_miner_usd_day: 5.844158378315179
- top_miner_usd_day: 421.1871352185753 (uid 92, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: 4.8579 USD/day  |  payback on registration: 5.72 days

## Score

- gate: **OK** 
- score: 30.1 (rank 54), confidence 1.0 
- components: income 6.98 / freshness 0.0 / resource 15.0 / registration 8.09
