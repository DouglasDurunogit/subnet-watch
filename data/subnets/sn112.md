...
- miner_burn: **0.25618330389261246**
- registration cost: 0.99 TAO (188.6841 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 13  |  free: 0
- subnet age: 430.3 days  |  registered at block 5633022
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1362.9391169275834** (uid 83) <- the only figure quotable as achievable
- median_miner_usd_day: 916.1659632455203
- top_miner_usd_day: 1362.9391169275834 (uid 83, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted

## Incentive structure (display only - never scored)

- earners: 2  |  gini: 0.24382763145847974  |  top1_share: 0.7438276314584796  |  top10_share: 1.0
- owner_incentive_share: 0.2561723685415204 (independent check on miner_burn; disagreement 0.0)
...
- net margin: 1354.7199 USD/day  |  payback on registration: 0.14 days

## Score

- gate: **OK** 
- score: 29.8 (rank 47), confidence 0.6 - hardware requirement unknown; income rests on 1 competitive miner (n<=2: not a distribution)
- components: income 28.49 / freshness 0.0 / resource 11.25 / registration 9.95
