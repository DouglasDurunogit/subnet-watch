...
- subnet age: 206.2 days  |  registered at block 7633645
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1420.1895725797701** (uid 126) <- the only figure quotable as achievable
- median_miner_usd_day: 710.0947862898851
- top_miner_usd_day: 2840.3791451595403 (uid 165, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 531.5848 USD/day  |  payback on registration: 0.05 days

## Score

- gate: **OK** 
- score: 72.1 (rank 3), confidence 0.85 - hardware from README keywords, not curated
- components: income 24.8 / freshness 35.0 / resource 15.0 / registration 9.98
