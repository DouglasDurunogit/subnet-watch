...
- subnet age: 105.8 days  |  registered at block 8123781
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 246.72776277550804** (uid 105) <- the only figure quotable as achievable
- median_miner_usd_day: 24.228493109421546
- top_miner_usd_day: 1727.2072927763854 (uid 64, owner=False, validator_permitted=True) <- NOT achievable if owner or permitted
...
- net margin: 16.8644 USD/day  |  payback on registration: 1.24 days
