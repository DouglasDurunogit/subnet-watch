...
- subnet age: 1024.7 days  |  registered at block 1604679
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 1088.590184630082** (uid 224) <- the only figure quotable as achievable
- median_miner_usd_day: 3.9598739293864984
- top_miner_usd_day: 1088.590184630082 (uid 224, owner=False, validator_permitted=False) <- NOT achievable if owner or permitted
...
- net margin: -4.301 USD/day  |  payback on registration: [UNKNOWN] days
