...
- miner_burn: **0.451235621701926**
- registration cost: 0.1 TAO (19.586000000000002 USD), open=True
- tempo: 360.0  |  max_uids: 256  |  active: 100  |  free: 0
- subnet age: 791.6 days  |  registered at block 3156578
- weights_version: 0  |  mechanisms: 1

## Income (miner side)

- **competitive_miner_usd_day: 35.001515345609306** (uid 13) <- the only figure quotable as achievable
- median_miner_usd_day: 8.568231067118347
- top_miner_usd_day: 861.8066696794443 (uid 135, owner=True, validator_permitted=True) <- NOT achievable if owner or permitted
...
- last commit: 2026-08-15T12:28:10Z
...
- net margin: 7.5819 USD/day  |  payback on registration: 2.58 days

## Score

- gate: **OK** 
- score: 67.6 (rank 12), confidence 1.0 
- components: income 8.49 / freshness 35.0 / resource 15.0 / registration 9.14
